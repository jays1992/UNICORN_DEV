...
class VendorQuotationDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF) {
    ...
    */
    public function collection()
    {
      ...
      M.PENDING_QTY AS PENDING_QTY,
      M.QUOTATION_QTY-M.PENDING_QTY AS CONSUMED_QTY,
      M.QUOTATION_QTY  AS ITEM_QTY,
      M.RATEP_UOM AS RATEP_UOM,
      M.RATEP_UOM *M.QUOTATION_QTY AS GROSS_AMOUNT,    
      
      
          ((M.QUOTATION_QTY*M.RATEP_UOM)+(case when M.CGST IS not NULL then convert(numeric(14,2),((M.QUOTATION_QTY*M.RATEP_UOM*M.CGST)/100)) else  0 end)+
