...
class PurchaseOrderDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID) {
    ...
    */
    public function collection()
    {
      ...
      M.PENDING_QTY,
      (M.PO_QTY-M.PENDING_QTY) AS CONSUMED_QTY,
      M.PO_QTY,
      M.RATEP_UOM,
      
      (M.RATEP_UOM * M.PO_QTY) AS GROSS_AMOUNT,
      
      
      
      ((M.PO_QTY*M.RATEP_UOM)+(case when M.CGST IS not NULL then convert(numeric(14,2),((M.PO_QTY*M.RATEP_UOM*M.CGST)/100)) else  0 end)+
