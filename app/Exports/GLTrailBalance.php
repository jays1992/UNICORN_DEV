    ...
    */
    public function collection()
    {
      ...
      return collect( $data=DB::select("SELECT D.BG_DESC,D.BRNAME,D.NOGNAME,D.AGNAME,D.ASGNAME, D.GLCODE,D.GLNAME,D.SGLCODE,D.SLNAME,SUM(D.OPENING_DR) OPENING_DR,SUM(D.OPENING_CR) OPENING_CR,SUM(D.DR_AMT) DR_AMT,
		...
		AND A.SGLID_REF = 'S'
		AND G.GLID IN ($GLID) AND G.ASGID_REF IN ($ASGID) AND AG.AGID IN ($AGID)
		...
		AND G.GLID IN ($GLID) AND G.ASGID_REF IN ($ASGID) AND AG.AGID IN ($AGID)
		GROUP BY G.GLCODE,G.GLNAME,A.GLID_REF,A.SGLID_REF,ASG.ASGNAME,AG.AGNAME,BG.BG_DESC,B.BRNAME,N.NOGNAME
		UNION ALL
		select BG.BG_DESC,B.BRNAME,N.NOGNAME,AG.AGNAME,ASG.ASGNAME,
		G.GLCODE,G.GLNAME,
		IIF(A.SGLID_REF='S',DBO.FN_GLBYSL(A.GLID_REF),A.GLID_REF) AS GLID_REF,
		...
		GROUP BY G.GLCODE,G.GLNAME,G.GLID,ASG.ASGNAME,AG.AGNAME,BG.BG_DESC,B.BRNAME,N.NOGNAME
		UNION ALL
		select BG.BG_DESC,B.BRNAME,N.NOGNAME,AG.AGNAME,ASG.ASGNAME,
		G.GLCODE,G.GLNAME,
		G.GLID AS GLID_REF,
		...
		AND G.ASGID_REF IN ($ASGID) AND AG.AGID IN ($AGID)
		GROUP BY G.GLCODE,G.GLNAME,G.GLID,ASG.ASGNAME,AG.AGNAME,N.NOGNAME,SL.SGLID,BG.BG_DESC,B.BRNAME,SL.SGLCODE,SL.SLNAME
		) AS D GROUP BY D.GLID_REF,D.GLCODE,D.GLNAME,D.ASGNAME,D.AGNAME,D.NOGNAME,D.SGLID_REF,D.BG_DESC,D.BRNAME,D.SGLCODE,D.SLNAME
		) AS D GROUP BY D.GLCODE,D.GLNAME,D.ASGNAME,D.AGNAME,D.NOGNAME,D.BG_DESC,D.BRNAME,D.SGLCODE,D.SLNAME
