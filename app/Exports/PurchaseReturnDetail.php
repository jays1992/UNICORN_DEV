...
class PurchaseReturnDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF,$SGLID) {
    ...
    */
    public function collection()
    {
      ...
      M.RETURN_QTY_MU,
      M.RATEPUOM_MU,
      (M.RATEPUOM_MU * M.RETURN_QTY_MU) AS GROSS_AMOUNT,
       
      ((M.RETURN_QTY_MU*M.RATEPUOM_MU)+(case when M.CGST_RATE IS not NULL then convert(numeric(14,2),((M.RETURN_QTY_MU*M.RATEPUOM_MU*M.CGST_RATE)/100)) else  0 end)+
