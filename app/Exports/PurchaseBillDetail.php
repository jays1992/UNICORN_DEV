...
class PurchaseBillDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID) {
    ...
    */
    public function collection()
    {
      ...
      ((TBL_TRN_PRPB01_MAT.BILL_QTY*TBL_TRN_PRPB01_MAT.BILL_RATEPUOM)+(case when TBL_TRN_PRPB01_MAT.CGST IS not NULL then convert(numeric(14,2),((TBL_TRN_PRPB01_MAT.BILL_QTY*TBL_TRN_PRPB01_MAT.BILL_RATEPUOM*TBL_TRN_PRPB01_MAT.CGST)/100)) else  0 end)+
