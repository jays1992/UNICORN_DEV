...
class SPODetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID) {
    ...
    */
    public function collection()
    {
      ...
      TBL_TRN_PROR04_MAT.PENDING_QTY,
      TBL_TRN_PROR04_MAT.SPO_QTY-TBL_TRN_PROR04_MAT.PENDING_QTY as CONSUMED_QTY,
      TBL_TRN_PROR04_MAT.SPO_QTY AS ACTUAL_QTY,
      TBL_TRN_PROR04_MAT.SPO_RATE,
      TBL_TRN_PROR04_MAT.SPO_QTY*TBL_TRN_PROR04_MAT.SPO_QTY AS GROSS_QTY,
      
      ((TBL_TRN_PROR04_MAT.SPO_QTY*TBL_TRN_PROR04_MAT.SPO_RATE)+(case when TBL_TRN_PROR04_MAT.CGST IS not NULL then convert(numeric(14,2),((TBL_TRN_PROR04_MAT.SPO_QTY*TBL_TRN_PROR04_MAT.SPO_RATE*TBL_TRN_PROR04_MAT.CGST)/100)) else  0 end)+
