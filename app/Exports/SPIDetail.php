...
class SPIDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF) {
    ...
    */
    public function collection()
    {
      ...
      I.CUSTOMER_PART_NO,
      I.OEM_PART_NO,
      M.BILL_QTY AS ITEM_QTY,
      M.BILL_RATEPUOM AS BILL_RATEPUOM,
      M.BILL_QTY*M.BILL_RATEPUOM AS GROSS_AMOUNT,
      
      
      ((M.BILL_QTY*M.BILL_RATEPUOM)+(case when M.CGST IS not NULL then convert(numeric(14,2),((M.BILL_QTY*M.BILL_RATEPUOM*M.CGST)/100)) else  0 end)+
