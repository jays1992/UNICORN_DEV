...
class SalesChallanDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF) {
    ...
    */
    public function collection()
    {
      ...
      TBL_TRN_SLSC01_MAT.PENDING_QTY AS PENDING_QTY,
      TBL_TRN_SLSC01_MAT.CHALLAN_MAINQTY-TBL_TRN_SLSC01_MAT.PENDING_QTY AS CONSUMED_QTY,
      TBL_TRN_SLSC01_MAT.CHALLAN_MAINQTY AS ITEM_QTY,
      CASE
