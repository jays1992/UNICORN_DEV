...
class IPODetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID_REF) {
    ...
    */
    public function collection()
    {
      ...
      M.IPO_MAIN_QTY AS ACTUAL_QTY,
      M.RATE_ASP_MU AS RATE,
      (M.RATE_ASP_MU*M.IPO_MAIN_QTY) AS GROSS_AMOUNT,
      
          ((M.IPO_MAIN_QTY*M.RATE_ASP_MU)+
