...
class SalesOrderDetail implements FromCollection, WithHeadings
{
 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$EMPID,$ITEMGID,$ITEMID,$STATUS,$CYID) {
    ...
    */
    public function collection()
    {
      ...
      return collect( $data=DB::select("SELECT   TBL_TRN_SLSO01_HDR.SONO, TBL_TRN_SLSO01_HDR.SODT,TBL_TRN_SLSO01_HDR.OVFDT,TBL_TRN_SLSO01_HDR.OVTDT,BG.BG_DESC AS BRANCH_GROUP,BR.BRNAME,C.CCODE AS CUSTOMER_CODE,
      C.NAME AS CUSTOMER_NAME,C.SAP_CUSTOMER_CODE,C.SAP_CUSTOMER_NAME,TBL_MST_ITEMGROUP.GROUPNAME, TBL_MST_ITEM.NAME AS ITEM_NAME, MU.DESCRIPTIONS,TBL_MST_BUSINESSUNIT.BUCODE,
      TBL_MST_ITEM.ALPS_PART_NO AS ALPS_PART_NO,TBL_MST_ITEM.CUSTOMER_PART_NO AS CUSTOMER_PART_NO,TBL_MST_ITEM.OEM_PART_NO AS OEM_PART_NO,
	  TBL_TRN_SLSO01_MAT.PENDING_QTY AS PENDING_QTY,
	  TBL_TRN_SLSO01_MAT.SO_QTY-TBL_TRN_SLSO01_MAT.PENDING_QTY AS CONSUMED_QTY,
      TBL_TRN_SLSO01_MAT.SO_QTY AS ITEM_QTY, TBL_TRN_SLSO01_MAT.RATEPUOM, 	
	   TBL_TRN_SLSO01_MAT.SO_QTY*TBL_TRN_SLSO01_MAT.RATEPUOM as GROSS_AMOUNT,
	((TBL_TRN_SLSO01_MAT.SO_QTY*TBL_TRN_SLSO01_MAT.RATEPUOM)+(case when TBL_TRN_SLSO01_MAT.CGST IS not NULL then convert(numeric(14,2),((TBL_TRN_SLSO01_MAT.SO_QTY*TBL_TRN_SLSO01_MAT.RATEPUOM*TBL_TRN_SLSO01_MAT.CGST)/100)) else  0 end)+
