 ...
 function __construct($SGLID,$From_Date,$To_Date,$BranchGroup,$BranchName,$ITEMGID,$ITEMID,$STATUS,$CYID) {
    ...
    */
    public function collection()
    {
      ...
      SUM((TBL_TRN_SLSI02_MAT.RATE_PRUOM * TBL_TRN_SLSI02_MAT.SSI_QTY)) AS GROSS_AMOUNT,
      
      SUM(((TBL_TRN_SLSI02_MAT.SSI_QTY*TBL_TRN_SLSI02_MAT.RATE_PRUOM)+(case when TBL_TRN_SLSI02_MAT.CGST IS not NULL then convert(numeric(14,2),((TBL_TRN_SLSI02_MAT.SSI_QTY*TBL_TRN_SLSI02_MAT.RATE_PRUOM*TBL_TRN_SLSI02_MAT.CGST)/100)) else  0 end)+
