...
class MstFrm119Controller extends Controller
{
    ...
    public function index(){
        ...
        $objDataList=DB::select("SELECT * FROM TBL_MST_CUSTOMERGROUP WHERE CYID_REF='$CYID_REF' ORDER BY CGID");
    ...
    public function add(){ 
        ...
        return view('masters.Sales.CustomerGroup.mstfrm119add',compact(['docarray']));
    }
