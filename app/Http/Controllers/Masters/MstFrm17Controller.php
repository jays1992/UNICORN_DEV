...
class MstFrm17Controller extends Controller
{
    ...
    public function index(){
        ...
        $objDataList=DB::select("SELECT * FROM TBL_MST_INDUSTRYTYPE ORDER BY INDSID  DESC");

        return view('masters.PreSales.IndustryType.mstfrm17',compact(['objRights','objDataList']));
    ...
    public function add(){ 
        ...
        return view('masters.PreSales.IndustryType.mstfrm17add',compact(['docarray']));
    }
   ...
   public function save(Request $request){
    ...
    public function edit($id){
        ...
        if(!is_null($id))
        {
            ...
            return view('masters.PreSales.IndustryType.mstfrm17edit',compact(['objResponse','user_approval_level','objRights']));
        }
    ...
    public function view($id){
        ...
        {
            $objResponse = TblMstFrm17::where('INDSID','=',$id)->first();
            return view('masters.PreSales.IndustryType.mstfrm17view',compact(['objResponse']));
        }
    ...
    public function printdata(Request $request){
        ...
        return view('masters.PreSales.IndustryType.mstfrm17print',compact(['objResponse']));
   }//print
    ...
    public function attachment($id){
        ...
        if(!is_null($id))
        {
            ...
            return view('masters.PreSales.IndustryType.mstfrm17attachment',compact(['objResponse','objMstVoucherType','objAttachments']));
        }
