...
class RptFrm507Controller extends Controller{

    protected $form_id  =   507;
    protected $vtid_ref =   577;  
    protected $view_ref =   "CUSTOMERDETAILRPT";
    protected $repo_nam =   "Customer Detail Report";
    ...
    public function index(){ 
        ...
        $VendorList          =  DB::select("SELECT SLID_REF,CCODE,NAME FROM TBL_MST_CUSTOMER
        ...
        return view('reports.Accounts.'.$this->view_ref.'.rptfrm'.$FORM_ID,compact(['FORM_ID','REPO_NAM','objRights','objBranchGroup','objBranch','VendorList']));        
    }  
