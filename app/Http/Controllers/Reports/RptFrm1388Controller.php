...
class RptFrm1388Controller extends Controller
{
    protected $form_id = 1388;
    protected $vtid_ref   = 1473;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){   
        ...
        return view('reports.Accounts.PNL.rptfrm1388',compact(['objRights','objBranchGroup','objBranch','ObjGeneralLedger','ObjAccountGroup']));        
    }  
