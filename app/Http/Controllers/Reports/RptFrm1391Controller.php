...
class RptFrm1391Controller extends Controller
{
    protected $form_id = 1391;
    protected $vtid_ref   = 1475;  //voucher type id
    ...
    public function index(){    
        ...
        return view('reports.Accounts.TDS.rptfrm1391',compact(['objRights','objBranchGroup','objBranch','ObjVendorGroup','ObjVendor']));        
    }  
