...
class RptFrm555Controller extends Controller
{
    ...
    public function index(){    
        ...
        ->where('TBL_MST_BANK.BRID_REF','=',Session::get('BRID_REF'))
        ...
        return view('reports.Accounts.BankReconcileRpt.rptfrm555',compact(['objRights','objBranchGroup','objBranch','ObjBank']));        
    }  
   ...
   public function ViewReport($request) {
    ...
    else
    {
        ...
        $Flag            = $myValue['Flag'];
        $CYID_REF        = Auth::user()->CYID_REF;
		$RECONCILE       = Session::get('RECONCILE');
    }
        ...
        $result = $ssrs->loadReport(Session::get('ssrs_config')['INSTANCE_NAME'].'/Bank_Reconcile_Report');
        ...
        $ssrs->setSessionId($result->executionInfo->ExecutionID)
            ...
            if($Flag == 'H')
            {
				...
				Session::put('RECONCILE', $RECONCILE);
