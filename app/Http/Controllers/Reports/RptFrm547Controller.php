...
//use App\Exports\ItemMasterReport;
...
class RptFrm547Controller extends Controller
{
    ...
    public function index(){   
        ...
        ->where('TBL_MST_ITEMGROUP.DEACTIVATED','=','0')
        ->where('TBL_MST_ITEMGROUP.DODEACTIVATED','=',NULL)
        ...
        ->leftJoin('TBL_MST_ITEMGROUP', 'TBL_MST_ITEMSUBGROUP.ITEMGID_REF','=','TBL_MST_ITEMGROUP.ITEMGID')
        ->where('TBL_MST_ITEMGROUP.CYID_REF','=',Auth::user()->CYID_REF)
        ->where('TBL_MST_ITEMGROUP.STATUS','=','A')
        ->where('TBL_MST_ITEMGROUP.DEACTIVATED','=','0')
        ->where('TBL_MST_ITEMGROUP.DODEACTIVATED','=',NULL)
      ...
      // dd($ObjItemSubGrp);
       ...
       ->where('TBL_MST_ITEMCATEGORY.DEACTIVATED','=','0')
       ->where('TBL_MST_ITEMCATEGORY.DODEACTIVATED','=',NULL)
    ...
    public function ViewReport($request) {
        ...
        {
           // return Excel::download(new ItemMasterReport($From_Date,$To_Date,$ITEMGID,$ISGID,$ICID,$CYID_REF), 'ItemMasterReport.xlsx');
