...
class RptFrm551Controller extends Controller
{
    ...
    protected $view     = "reports.Payroll.UserListingReport.rptfrm";
    ...
    public function index(){   
       ...
       // ->where('TBL_MST_MODULE.BRID_REF','=',Session::get('BRID_REF'))
        ...
        //dd($company_check); 
        return view($this->view.$FormId,compact(['objRights','objBranchGroup','objBranch','ObjModule','company_check','FormId']));     
    }  
    ...
    public function ViewReport($request) {
        ...
        {
           // return Excel::download(new UserRoleListingReport($From_Date,$To_Date,$BranchGroup,$BranchName,$CYID_REF), 'UserRoleListingReport.xlsx');
