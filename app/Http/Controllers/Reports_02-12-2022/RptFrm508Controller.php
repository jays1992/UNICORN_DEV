...
class RptFrm508Controller extends Controller{

    protected $form_id  =   508;
    protected $vtid_ref =   578;  
    protected $view_ref =   "VENDORDETAILRPT";
    protected $repo_nam =   "Vendor Detail Report";
