...
class RptFrm1387Controller extends Controller
{
    protected $form_id = 1387;
    protected $vtid_ref   = 1472;  //voucher type id
    // //validation messages
    // 
    /**
    ...
    public function index(){    
        ...
        return view('reports.Accounts.GSTR2.rptfrm1387',compact(['objRights','objBranchGroup','objBranch','ObjCustomer']));        
    }  
