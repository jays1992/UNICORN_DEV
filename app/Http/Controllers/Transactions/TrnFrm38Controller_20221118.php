...
class TrnFrm38Controller extends Controller
{
    ...
    public function add(){    
		...
		->leftJoin('TBL_MST_EMP_BRANCH_MAP', 'TBL_MST_EMPLOYEE.EMPID','=','TBL_MST_EMP_BRANCH_MAP.EMPID_REF')
        ->where('TBL_MST_EMPLOYEE.STATUS','=',$Status)
        ->where('TBL_MST_EMPLOYEE.SALES_PERSON','=','1')
        ->where('TBL_MST_EMPLOYEE.CYID_REF','=',Auth::user()->CYID_REF)
        ->where('TBL_MST_EMP_BRANCH_MAP.MAPBRID_REF','=',Session::get('BRID_REF'))
