    ...
    public function edit($id=NULL){
        ...
        if(!is_null($id)){
            ...
            $objSQTNC = DB::table('TBL_TRN_SLQT01_TNC')  
						->leftJoin('TBL_MST_TNC_DETAILS', 'TBL_TRN_SLQT01_TNC.TNCDID_REF','=','TBL_MST_TNC_DETAILS.TNCDID')
                        ->where('TBL_TRN_SLQT01_TNC.SQID_REF','=',$id)
                        ->select('TBL_TRN_SLQT01_TNC.*','TBL_MST_TNC_DETAILS.TNC_NAME','TBL_MST_TNC_DETAILS.VALUE_TYPE')
