                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input type="text" name=<?php echo e("txtLISTPOP1_popup_".$key); ?> id=<?php echo e("txtLISTPOP1_popup_".$key); ?>  value="<?php echo e($row->VCODE); ?>" class="form-control CLS_LISTPOP1"  autocomplete="off"  readonly style="width:100px;" /></td>
                              ...
                              <td width="140px"> 
                                <select name=<?php echo e("VHEADING_".$key); ?> id=<?php echo e("VHEADING_".$key); ?> class="form-control" style="width: 100px;" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Module\ModuleVoucherMapping\mstfrm208edit.blade.php ENDPATH**/ ?>