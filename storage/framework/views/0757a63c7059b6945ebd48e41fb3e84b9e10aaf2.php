...
<?php $helper = app('App\Helpers\Helper'); ?>     
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->PAYMENTID); ?>" value="<?php echo e($val->PAYMENTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->PAYMENT_NO) && $val->PAYMENT_NO !=''?$val->PAYMENT_NO:''); ?></td>
                <td><?php echo e(isset($val->PAYMENT_DT) && $val->PAYMENT_DT !=''?$val->PAYMENT_DT:''); ?></td>
                <td><?php echo e(isset($val->PAYMENT_FOR) && $val->PAYMENT_FOR !=''?$val->PAYMENT_FOR:''); ?></td>
                <td><?php echo e(isset($Name) && $Name !=''?$Name:''); ?></td>
                <td><?php echo e(isset($val->PAYMENT_TYPE) && $val->PAYMENT_TYPE !=''?$val->PAYMENT_TYPE:''); ?></td>
                <td><?php echo e(isset($val->NARRATION) && $val->NARRATION !=''?$val->NARRATION:''); ?></td></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Payment Voucher Print</p></div>
        <div class="row">
...
$('#btnAdd').on('click', function() {
  ...
  //   });
  //     $.ajax({
  //         url:'<?php echo e(route("transaction",[$FormId,"downloadFile"])); ?>',
  //         type:'POST',
  //         // dataType: 'json',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&PAYMENTID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[301,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[301,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/PaymentEntry/trnfrm301.blade.php ENDPATH**/ ?>