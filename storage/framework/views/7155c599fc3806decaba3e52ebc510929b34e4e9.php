...
<!-- <form id="frm_rpt_posvw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[269,'index'])); ?>" class="btn singlebt">Purchase Order Summary Vendor Wise</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_posvw"  method="POST">   
            <?php echo csrf_field(); ?>
...
//                 });
//                 $.ajax({
//                     url:'<?php echo e(route("report",[269,"GetPurchaseOrder"])); ?>',
//                     type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\POVendorwise\rptfrm269.blade.php ENDPATH**/ ?>