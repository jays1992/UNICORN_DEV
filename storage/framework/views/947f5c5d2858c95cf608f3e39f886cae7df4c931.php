...
<form id="frm_trn_edit"  method="POST">   
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->PRRID[0]) ? method_field('PUT') : ''); ?>
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="<?php echo e(isset($objResponse->PRR_NO) && $objResponse->PRR_NO !=''?$objResponse->PRR_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
			
			  <div class="col-lg-2 pl"><p>Date*</p></div>
			  <div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="PRR_DT" id="PRR_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->PRR_DT) && $objResponse->PRR_DT !=''?$objResponse->PRR_DT:''); ?>" class="form-control mandatory" >
        </div>

        <div class="col-lg-1 pl"><p>PRO NO</p></div>
        <div class="col-lg-2 pl">
        <input type="text" <?php echo e($ActionStatus); ?> name="Productionpopup" id="txtProductionpopup" class="form-control mandatory" value="<?php echo e(isset($objPRO->PRO_NO) && $objPRO->PRO_NO !=''?$objPRO->PRO_NO:''); ?>"  autocomplete="off"  readonly/>
        <input type="hidden" name="PRID_REF" id="PRID_REF" class="form-control" value="<?php echo e(isset($objResponse->PROID_REF) && $objResponse->PROID_REF !=''?$objResponse->PROID_REF:''); ?>" autocomplete="off" />
        </div>   
    ...
    <div class="table-responsive table-wrapper-scroll-y" style="height:280px;margin-top:10px;" >
      <table id="Main_example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
        <thead id="thead1"  style="position: sticky;top: 0">
            ...
            <th>Item Code <input class="form-control" type="hidden" name="Main_Row_Count1" id ="Main_Row_Count1" value="<?php echo e(isset($Main_objMAT)?count($Main_objMAT):1); ?>" ></th>
            <th>Item Name</th>
        ...
        <tbody>
        <?php if(!empty($Main_objMAT)): ?>
        <?php $__currentLoopData = $Main_objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $store_value  = 0;
        if($row->BATCH_QTY !=''){
        ...
        ?>
            <tr  class="Main_participantRow">
                <td><input <?php echo e($ActionStatus); ?>  type="text" name=<?php echo e("Main_popupITEMID_".$key); ?> id=<?php echo e("Main_popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly/></td>
                <td hidden><input type="hidden" name=<?php echo e("Main_ITEMID_REF_".$key); ?> id=<?php echo e("Main_ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->ITEMID_REF); ?>" autocomplete="off" /></td>

                <td><input <?php echo e($ActionStatus); ?>  type="text" name=<?php echo e("Main_ItemName_".$key); ?> id=<?php echo e("Main_ItemName_".$key); ?> class="form-control" value="<?php echo e($row->ITEM_NAME); ?>"  autocomplete="off"   readonly/></td>

                <td <?php echo e($AlpsStatus['hidden']); ?>><input  type="text" name="Main_Alpspartno_<?php echo e($key); ?>" id="Main_Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->ALPS_PART_NO)?$row->ALPS_PART_NO:''); ?>" readonly/></td>
                <td <?php echo e($AlpsStatus['hidden']); ?>><input  type="text" name="Main_Custpartno_<?php echo e($key); ?>" id="Main_Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->CUSTOMER_PART_NO)?$row->CUSTOMER_PART_NO:''); ?>" readonly/></td>
                <td <?php echo e($AlpsStatus['hidden']); ?>><input  type="text" name="Main_OEMpartno_<?php echo e($key); ?>" id="Main_OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->OEM_PART_NO)?$row->OEM_PART_NO:''); ?>" readonly/></td>


                <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Main_Itemspec_".$key); ?> id=<?php echo e("Main_Itemspec_".$key); ?> value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off"    /></td>

                
                <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Main_SE_QTY_".$key); ?> id=<?php echo e("Main_SE_QTY_".$key); ?> class="form-control three-digits" readonly onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="<?php echo e($row->ISSUEQTY); ?>" autocomplete="off"  /></td>

                <td align="center"><a <?php echo e($ActionStatus); ?> class="btn checkstore"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
                  <td hidden ><input type="text" name="Main_TotalHiddenQty_<?php echo e($key); ?>" id="Main_TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->RETURNQTY); ?>" ></td>

                <td hidden ><input type="text" name="Main_HiddenRowId_<?php echo e($key); ?>" id="Main_HiddenRowId_<?php echo e($key); ?>" value="<?php echo e($row->BATCH_QTY); ?>" ></td>
                          
              <td hidden><input type="text" name="Main_PO_PENDING_QTY_<?php echo e($key); ?>" id="Main_PO_PENDING_QTY_<?php echo e($key); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>                       

                      
                    
                  <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Main_popupMUOM_".$key); ?> id=<?php echo e("Main_popupMUOM_".$key); ?> class="form-control" value="<?php echo e($row->MAIN_UOM_CODE); ?>"  autocomplete="off"  readonly/></td>
                  <td hidden><input type="hidden" name=<?php echo e("Main_MAIN_UOMID_REF_".$key); ?> id=<?php echo e("Main_MAIN_UOMID_REF_".$key); ?> value="<?php echo e($row->UOMID_REF); ?>" class="form-control"   autocomplete="off" /></td>
                    
                  <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="Main_STOCK_INHAND_<?php echo e($key); ?>" id="Main_STOCK_INHAND_<?php echo e($key); ?>" value="" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                  <td><input readonly <?php echo e($ActionStatus); ?> type="text" name="Main_RECEIVED_QTY_MU_<?php echo e($key); ?>" id="Main_RECEIVED_QTY_MU_<?php echo e($key); ?>" value="<?php echo e($row->RETURNQTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
                    
                  <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="Main_popupALTUOM_<?php echo e($key); ?>" id="Main_popupALTUOM_<?php echo e($key); ?>" class="form-control" value=""  autocomplete="off"  readonly/></td>

                  <td hidden><input type="hidden" name="Main_ALT_UOMID_REF_<?php echo e($key); ?>" id="Main_ALT_UOMID_REF_<?php echo e($key); ?>" value="" class="form-control"  autocomplete="off" /></td>
                    
                  <td hidden><input type="text" name="Main_RECEIVED_QTY_AU_<?php echo e($key); ?>" id="Main_RECEIVED_QTY_AU_<?php echo e($key); ?>"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly maxlength="13"  autocomplete="off"   /></td>
                    
                  <td hidden><input type="text" name="Main_SHORT_QTY_<?php echo e($key); ?>" id="Main_SHORT_QTY_<?php echo e($key); ?>"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  readonly  /></td>
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="Main_STORE_NAME_<?php echo e($key); ?>" id="Main_STORE_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->STORE_NAME)?$row->STORE_NAME:''); ?>"  class="form-control w-100" autocomplete="off" readonly  ></td>
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="Main_STORE_VALUE_<?php echo e($key); ?>" id="Main_STORE_VALUE_<?php echo e($key); ?>" value="<?php echo e(isset($store_value)?$store_value:''); ?>" class="form-control w-100" autocomplete="off" readonly ></td>
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="Main_REASON_RETURN_QTY_<?php echo e($key); ?>" id="Main_REASON_RETURN_QTY_<?php echo e($key); ?>" value="<?php echo e($row->REASON_RETURN); ?>" class="form-control"   autocomplete="off"   /></td>
                  <td hidden><input type="hidden" name=<?php echo e("Main_SO_FQTY_".$key); ?> id=<?php echo e("Main_SO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
               
              
                  <td><input <?php echo e($ActionStatus); ?>  type="text" name="Main_REMARKS_<?php echo e($key); ?>" id="Main_REMARKS_<?php echo e($key); ?>" value="<?php echo e($row->REMARKS); ?>" class="form-control w-100" autocomplete="off" ></td>
            ...
            ?>
                <tr  class="participantRow">
                  <td><input <?php echo e($ActionStatus); ?>  type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly  /></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly  /></td>
                   ...
                   <td hidden><input type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off" readonly   /></td>  

                  <td><input <?php echo e($ActionStatus); ?> type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"  autocomplete="off"  readonly /></td>
                ...
                <td hidden><input type="text" name="popupALTUOM_<?php echo e($key); ?>" id="popupALTUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly /></td>
                ...
                <td><input <?php echo e($ActionStatus); ?> type="text"   name="QTY_<?php echo e($key); ?>" id="QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURNQTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="text-align:right;"  /></td>

                <td><input <?php echo e($ActionStatus); ?> type="text" name="STORE_NAME_<?php echo e($key); ?>" id="STORE_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->STORE_NAME)?$row->STORE_NAME:''); ?>"  class="form-control w-100" autocomplete="off" readonly  ></td>
                <td><input <?php echo e($ActionStatus); ?> type="text" name="STORE_VALUE_<?php echo e($key); ?>" id="STORE_VALUE_<?php echo e($key); ?>" value="<?php echo e(isset($store_value)?$store_value:''); ?>" class="form-control w-100" autocomplete="off" readonly ></td>

                <td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->RETURNQTY); ?>" ></td>
                ...
                <td hidden><input <?php echo e($ActionStatus); ?> type="text"  type="text" name="RATE_<?php echo e($key); ?>" id="RATE_<?php echo e($key); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="text-align:right;"  /></td>  
       
                <td><input <?php echo e($ActionStatus); ?> type="text" name="REASON_<?php echo e($key); ?>" id="REASON_<?php echo e($key); ?>" value="<?php echo e($row->REASON_RETURN); ?>" class="form-control"   autocomplete="off"   /></td>
...
<td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?>><input type="text" id="Main_ItemAPNsearch" class="form-control" autocomplete="off" onkeyup="Main_ItemAPNFunction()"></td>
<td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?>><input type="text" id="Main_ItemCPNsearch" class="form-control" autocomplete="off" onkeyup="Main_ItemCPNFunction()"></td>
<td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?>><input type="text" id="Main_ItemOEMPNsearch" class="form-control" autocomplete="off" onkeyup="Main_ItemOEMPNFunction()"></td>
...
else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#PRR_DT").val(),0) ==0){
  $("#YesBtn").hide();
  $("#NoBtn").hide();
  $("#OkBtn").hide();
  $("#OkBtn1").show();
...
$('#txtProductionpopup').on('click',function(event){     
          $("#PROresult").html('');
            ...
            $("#Data_seach").show();
            $.ajax({
                url:'<?php echo e(route("transaction",[$FormId,"get_production"])); ?>',
                type:'POST',
                data:{},
                success:function(data) {                                
                  $("#Data_seach").hide();
...
function Main_getStoreDetails(ROW_ID){
  ...
  $.ajax({
  url:'<?php echo e(route("transaction",[$FormId,"Main_getStoreDetails"])); ?>',
  type:'POST',
  data:{
    ROW_ID:ROW_ID,
    //RGP_NO:RGP_NO,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionReturn\trnfrm401edit.blade.php ENDPATH**/ ?>