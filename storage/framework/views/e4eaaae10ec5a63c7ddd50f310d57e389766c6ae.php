            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                    ...
                    <input type="hidden" id="objlastPSEDT"  value="<?php echo e(isset($objPSE->PSEDT)?$objPSE->PSEDT:''); ?>">
                                <input <?php echo e($ActionStatus); ?> type="date" name="PSEDT" id="PSEDT" value="<?php echo e(isset($objPSE->PSEDT)?$objPSE->PSEDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
        ...
        <div class="col-lg-2 pl">
          ...
          <span class="text-danger" id="ERROR_TIME"></span>
                ...
                <div class="col-lg-2 pl"><p>From Store</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="FromStore_popup" <?php echo e($ActionStatus); ?>  id="txtFromStore_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objPSE->STCODE)?$objPSE->STCODE:''); ?>-<?php echo e(isset($objPSE->NAME)?$objPSE->NAME:''); ?>"  readonly/>
                ...
                <div class="col-lg-2 pl"><p>Actual Physical Stock taking By</p></div>
                            ...
                            <input type="text" name="TAKING_BY" id="TAKING_BY" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($objPSE->ACTUAL_STOCK_TAKEN_BY)?$objPSE->ACTUAL_STOCK_TAKEN_BY:''); ?>" class="form-control mandatory"  autocomplete="off" >
                            </div>  
            ...
            <div class="col-lg-2 pl"><p>Item Group</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="ItemGID_popup" <?php echo e($ActionStatus); ?> id="txtItemGID_popup" value="<?php echo e(isset($objPSE->GROUPCODE)?$objPSE->GROUPCODE:''); ?>-<?php echo e(isset($objPSE->GROUPNAME)?$objPSE->GROUPNAME:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\PhysicalStockEntry\trnfrm311view.blade.php ENDPATH**/ ?>