...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[342,'index'])); ?>" class="btn singlebt">Daily Production Plan Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Daily Production Plan No</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="DPP_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="DPP_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjDailyProductionPlan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->DPPID); ?>" selected><?php echo e($GRow->DPP_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
                        <div class="row">                          
                            ...
                            <div class="col-lg-3 pl" id="div_sono">
                                <select name="SONO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SONO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSalesOrer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Iindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($IRow->SOID); ?>" selected><?php echo e($IRow->SONO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[342,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var DPP_NO = [];
        $("select[name='DPP_NO[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                DPP_NO.push(value5);
            }
        ...
        else if(DPP_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Daily Production Plan.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[342,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\DPPRegister\rptfrm342.blade.php ENDPATH**/ ?>