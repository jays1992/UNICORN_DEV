...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt"><?php if($checkCompany ==''): ?>Service Purchase Invoice <?php else: ?> Service GRN <?php endif; ?></a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SPIID); ?>" value="<?php echo e($val->SPIID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SPI_DT) && $val->SPI_DT !='' && $val->SPI_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SPI_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->SPI_NO) && $val->SPI_NO !=''?$val->SPI_NO:''); ?></td>
              ...
              <td><?php echo e(isset($val->VENDOR_INNO) && $val->VENDOR_INNO !=''?$val->VENDOR_INNO:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Sales Purchase Invoice Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&SPIID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[201,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[201,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\ServicePurchaseInvoice\trnfrm201.blade.php ENDPATH**/ ?>