...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Employee-Branch Mapping</a>
      </div>
...
<form id="frm_mst_edit" method="POST"  enctype="multipart/form-data" > 
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->DOC_ID) ? method_field('PUT') : ''); ?>
  ...
  <div class="inner-form">
      ...
      <div class="row">    
        ...
        <div class="col-lg-2 pl">
          <input disabled type="text" name="DOC_NO" id="DOC_NO"  value="<?php echo e(isset($objResponse->DOC_NO) && $objResponse->DOC_NO !=''?$objResponse->DOC_NO:''); ?>" class="form-control" required autocomplete="off" maxlength="15" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" readonly />
          <span class="text-danger" id="ERROR_DOC_NO"></span> 
        </div>
		
        <div class="col-lg-1 pl"><p>Date</p></div>
        <div class="col-lg-2 pl">
        <input disabled type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(isset($objResponse->DOC_DT) && $objResponse->DOC_DT !=''?date('Y-m-d',strtotime($objResponse->DOC_DT)):''); ?>" class="form-control" autocomplete="off" required />
      ...
      <div class="col-lg-1 pl"><p>Branch</p></div>
        <div class="col-lg-2 pl">
          ...
          <input disabled type="text"  value="<?php echo e(isset($getBranch->FID) && $getBranch->FID !=''?$getBranch->BRCODE.'-'.$getBranch->BRNAME:''); ?>" class="form-control" required readonly >
      ...
      <div class="row">
        <div class="col-lg-8 pl">
          <div class=" table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:470px;" >
            <table id="examp2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input disabled type="checkbox" name="DATA_ID[<?php echo e($key); ?>]" <?php echo e($row->DATA_ID ==$row->DATA_ID_REF?'checked':''); ?> value="<?php echo e($row->DATA_ID); ?>" class="checkbox" ></td>
                    <td><input disabled type="text" name="DATA_CODE_<?php echo e($key); ?>" id="DATA_CODE_<?php echo e($key); ?>" value="<?php echo e($row->DATA_CODE); ?>" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                    <td><input  disabled type="text" id ="DATA_DESCRIPTION_<?php echo e($key); ?>"  id ="DATA_DESCRIPTION_<?php echo e($key); ?>" value="<?php echo e($row->DATA_DESCRIPTION); ?>" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
                    <td><input disabled  type="checkbox" name="DEACTIVATED_<?php echo e($key); ?>" id ="DEACTIVATED_<?php echo e($key); ?>" <?php echo e($row->DEACTIVATED ==1?'checked':''); ?>  value="1" onclick="DateEnableDisabled('<?php echo e($key); ?>')"  autocomplete="off" style="width:100%;"  ></td>
                    <td><input disabled  type="date" name="DODEACTIVATED_<?php echo e($key); ?>" id ="DODEACTIVATED_<?php echo e($key); ?>" value="<?php echo e(isset($row->DODEACTIVATED) && $row->DODEACTIVATED !=''?date('Y-m-d',strtotime($row->DODEACTIVATED)):''); ?>" <?php echo e($row->DEACTIVATED ==1?'':'disabled'); ?> class="form-control w-100"  autocomplete="off" style="width:100%;" ></td>
                    <td hidden><input  type="text" name="HID_DODEACTIVATED_<?php echo e($key); ?>" id ="HID_DODEACTIVATED_<?php echo e($key); ?>" value="<?php echo e(isset($row->DODEACTIVATED) && $row->DODEACTIVATED !=''?date('Y-m-d',strtotime($row->DODEACTIVATED)):''); ?>" ></td>
                    <td hidden><input  type="text" name="AUTO_MAP_ID_<?php echo e($key); ?>" id ="AUTO_MAP_ID_<?php echo e($key); ?>" value="<?php echo e($row->AUTO_MAP_ID); ?>" ></td>
                </tr>
...
function validateForm(ActionType,ActionMsg){
  ...
  if(DOC_NO ===""){
    ...
    $('#examp2').find('.participantRow').each(function(){
...
$.validator.addMethod("LessDate", function(value, element) {
  ...
  var today = new Date("<?php echo e(isset($objResponse->DOC_DT) && $objResponse->DOC_DT !=''?date('Y-m-d',strtotime($objResponse->DOC_DT)):''); ?>"); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EmployeeBranchMapping\mstfrm205view.blade.php ENDPATH**/ ?>