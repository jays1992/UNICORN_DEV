...
<form id="frm_trn_edit"  method="POST">   
	...
	<div class="inner-form">
        ...
        <input type="hidden" name="MISRID" id="MISRID" value="<?php echo e(isset($objResponse->MISRID) && $objResponse->MISRID !=''?$objResponse->MISRID:''); ?>" class="form-control"  >
          <input type="text" name="MISRNO" id="MISRNO" value="<?php echo e(isset($objResponse->MISRNO) && $objResponse->MISRNO !=''?$objResponse->MISRNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      </div>
			
			<div class="col-lg-1 pl"><p>MISR Date*</p></div>
			<div class="col-lg-2 pl">
			    <input type="date" name="MISRDT" id="MISRDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->MISRDT) && $objResponse->MISRDT !=''?$objResponse->MISRDT:''); ?>" class="form-control mandatory" >
      </div>

      <div class="col-lg-2 pl"><p>RPR No*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="rpr_popup" id="txtrpr_popup" value="<?php echo e(isset($objRPRDtl->RPR_NO) && $objRPRDtl->RPR_NO !=''?$objRPRDtl->RPR_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly disabled/>
    ...
    <div class="row">          
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="store_popup" value="<?php echo e(isset($objStoreDtl->STCODE) && $objStoreDtl->STCODE !=''?$objStoreDtl->STCODE.'-'.$objStoreDtl->NAME:''); ?>" id="txtstore_popup" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="stage_popup" value="<?php echo e(isset($objPStageDtl->PSTAGE_CODE) && $objPStageDtl->PSTAGE_CODE !=''?$objPStageDtl->PSTAGE_CODE.'-'.$objPStageDtl->DESCRIPTIONS:''); ?>" id="txtpstage_popup" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="employee_popup" value="<?php echo e(isset($objEmployeeDtl->EMPCODE) && $objEmployeeDtl->EMPCODE !=''?$objEmployeeDtl->EMPCODE.'-'.$objEmployeeDtl->FNAME.' '.$objEmployeeDtl->LNAME:''); ?>" id="txtemployee_popup" class="form-control mandatory"  autocomplete="off" readonly/>
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><input  type="text" name="popupFGI_<?php echo e($key); ?>" id="popupFGI_<?php echo e($key); ?>" value="<?php echo e($row->MAINITEMID_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                ...
                <td><input type="text" name="FGIName_<?php echo e($key); ?>" id="FGIName_<?php echo e($key); ?>" value="<?php echo e($row->MAINITEMID_NAME); ?>"  class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                ...
                <td>    <input style="width:100px;" type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control"  value="<?php echo e($row->ICODE); ?>" autocomplete="off"  readonly/></td>
                ...
                <td><input style="width:200px;" type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->ITEM_NAME); ?>"  autocomplete="off"   readonly/></td>
                ...
                <td><input type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  value="<?php echo e($row->MAIN_UOM_CODE); ?>" autocomplete="off" style="width: 100px;" readonly/></td>
                ...
                <td align="center"><a class="btn checkstore"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
                ...
                <td ><input type="text" name="PENDING_QTY_<?php echo e($key); ?>" id="PENDING_QTY_<?php echo e($key); ?>" class="form-control three-digits" value="<?php echo e($row->TOTAL_PENDING); ?>"  autocomplete="off" readonly  /></td>
                         
                  
                  <td><input type="text" name="STOCK_INHAND_<?php echo e($key); ?>" id="STOCK_INHAND_<?php echo e($key); ?>" value="<?php echo e($row->TOTAL_STOCK); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                  <td><input type="text" name="RECEIVED_QTY_MU_<?php echo e($key); ?>" id="RECEIVED_QTY_MU_<?php echo e($key); ?>" value="<?php echo e($row->ISSUED_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                  
                  <td><input type="text" name="popupALTUOM_<?php echo e($key); ?>" id="popupALTUOM_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->AULT_UOM_CODE); ?>"  autocomplete="off"  readonly/></td>
                  ...
                  <td><input type="text" name="REASON_SHORT_QTY_<?php echo e($key); ?>" id="REASON_SHORT_QTY_<?php echo e($key); ?>" value="<?php echo e($row->REASON_SHORT_QTY); ?>" class="form-control"   autocomplete="off"   /></td>
                  <td><input style="width:200px;" type="text" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e($row->REMARKS); ?>" class="form-control w-100" autocomplete="off" ></td>
              ...
              <?php $__currentLoopData = $objUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    <td><input type="text" name=<?php echo e("popupSEID_".$uindex); ?> id=<?php echo e("popupSEID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFMISRID_REF); ?>" autocomplete="off"  readonly/></td>
  ...
  if(MISRNO ===""){
    ...
    $('#example2').find('.participantRow').each(function(){
      ...
      highlighFocusBtn('activeOk');
          ...
          else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#MISRDT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
function checkIssueQty(itemDetails){
  ...
  var posts = $.ajax({
                url:'<?php echo e(route("transaction",[$FormId,"checkIssueQty"])); ?>',
                type:'POST',
                async: false,
                dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\MaterialIssueSlipRPR\trnfrm305edit.blade.php ENDPATH**/ ?>