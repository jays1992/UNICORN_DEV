<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->SGLID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
            ...
            <div class="col-lg-2 pl"><p>GL Code</p></div>
                ...
                <input type="text" name="GLID_REF_POPUP" id="GLID_REF_POPUP" class="form-control mandatory" readonly tabindex="1" value="<?php echo e($objGlName->GLCODE); ?> - <?php echo e($objGlName->GLNAME); ?>" />
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="SGLID" id="SGLID" value="<?php echo e($objResponse->SGLID); ?>" />
                    <input type="hidden" name="SGLCODE" id="SGLCODE" value="<?php echo e($objResponse->SGLCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SLNAME" id="SLNAME" class="form-control mandatory" value="<?php echo e(old('SLNAME',$objResponse->SLNAME)); ?>" maxlength="200" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SALIAS" id="SALIAS" class="form-control" value="<?php echo e(old('SALIAS',$objResponse->SALIAS)); ?>" maxlength="100" tabindex="3"  />
                  ...
                  <div class="col-lg-1 pl">
                    <div class="col-lg-11 pl">
                      <select name="CC" id="CC" class="form-control" tabindex="4">
                          <option <?php echo e(isset($objResponse->CC) && $objResponse->CC=='0'?'selected="selected"':''); ?> value="0">No</option>
                          <option <?php echo e(isset($objResponse->CC) && $objResponse->CC=='1'?'selected="selected"':''); ?> value="1">Yes</option>
                      </select>
                  </div> 
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?>
                 ...
                 value='<?php echo e($objResponse->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="5"  >
                </div>
                
                <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''); ?>" tabindex="6" placeholder="dd/mm/yyyy"  />
                </div>
             </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[129,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[129,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '<?php echo e(route("master",[129,"index"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\SubLedgerMaster\mstfrm129edit.blade.php ENDPATH**/ ?>