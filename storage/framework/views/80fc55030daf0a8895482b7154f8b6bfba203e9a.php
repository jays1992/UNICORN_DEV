...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[252,'index'])); ?>" class="btn singlebt">Sales Service Invoice Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Sales Service Invoice</p></div>
                            <div class="col-lg-3 pl" id="div_ssiid">
                                <select name="SSIID[]" id="SSIID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSSINO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->SSIID); ?>" selected><?php echo e($GRow->SSI_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[252,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SSIID = [];
        $("select[name='SSIID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                SSIID.push(value5);
            }
        ...
        else if(SSIID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Sales Service Invoice.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[252,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/sales/SalesServiceInvoiceRegister/rptfrm252.blade.php ENDPATH**/ ?>