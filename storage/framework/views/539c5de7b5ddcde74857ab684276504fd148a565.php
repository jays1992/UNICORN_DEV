                    ...
                    <div class="inner-form">
                        <div class="row">
                          ...
                          <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="LOB_DT" id="LOB_DT" value="<?php echo e(isset($HDR->LOB_DT)?$HDR->LOB_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                                <td hidden><input type="hidden" name="LEAVE_OPBLID" id="LEAVE_OPBLID" value="<?php echo e($HDR->LEAVE_OPBLID); ?>" class="form-control" autocomplete="off" /></td>
                              </div>  
                            ...
                            <div class="col-lg-2 pl">
                              <select name="FYID_REF" id="FYID_REF" class="form-control mandatory" tabindex="4">
                                <option value="" selected >Select</option>
                                  ...
                                  <option <?php echo e(isset($HDR->FYID_REF) && $HDR->FYID_REF == $val-> YRID ?'selected="selected"':''); ?> value="<?php echo e($val-> YRID); ?>"><?php echo e($val->YRCODE); ?></option>
                                            ...
                                            ?>
                                              <?php if(isset($objMAT) && !empty($objMAT)): ?>
                                                ...
                                                <tr  class="participantRow">
                                                    <td><input type="text" name="popupEMPLYID_<?php echo e($key); ?>" id="popupEMPLYID_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name="EMPLY_REF_<?php echo e($key); ?>" id="EMPLY_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="LEAVE_OPBLID_REF_<?php echo e($key); ?>" id="LEAVE_OPBLID_REF_<?php echo e($key); ?>" value="<?php echo e($row->LEAVE_OPBLID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="EMPID_REF_<?php echo e($key); ?>" id="EMPID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                    <td hidden><input type="hidden" name="LTID_REF_<?php echo e($key); ?>" id="LTID_REF_<?php echo e($key); ?>" value="<?php echo e($row->LTID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                    <td><input type="text" name="EMPLYSPECI_<?php echo e($key); ?>" id="EMPLYSPECI_<?php echo e($key); ?>" value="<?php echo e($row->FNAME); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td><input type="text" name="EMPLYDES_<?php echo e($key); ?>" id="EMPLYDES_<?php echo e($key); ?>"  value="<?php echo e($row->DESGCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name="UOMID_REF_<?php echo e($key); ?>" id="UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off" /></td>
                                                    
                                                    <td><input type="text" name="EmplyName_<?php echo e($key); ?>" id="EmplyName_<?php echo e($key); ?>" value="<?php echo e($row->DCODE); ?>" class="form-control" maxlength="200" autocomplete="off" readonly /></td>
                                                    <td hidden><input type="hidden" name="DEPID_REF_<?php echo e($key); ?>" id="DEPID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off" /></td>
                                                    
                                                    <td><input name="leavetypecode_popup_<?php echo e($key); ?>" id="leavetypecode_popup_<?php echo e($key); ?>" value="<?php echo e($row->LEAVETYPE_CODE); ?>" class="form-control" autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="text" name="hdnleavetypecode_popup_<?php echo e($key); ?>" id="hdnleavetypecode_popup_<?php echo e($key); ?>" value="<?php echo e($row->LTID); ?>" class="form-control" /> </td>

                                                    <td><input  class="form-control w-100" type="text" name="leavetypedesciption_<?php echo e($key); ?>" id="txtleavetypedesciption_<?php echo e($key); ?>" value="<?php echo e($row->LEAVETYPE_DESC); ?>"  maxlength="50" readonly></td>
                                                                                                        
                                                    <td hidden><input type="hidden" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control" maxlength="13"  autocomplete="off" /></td>
                                                    <td><input type="text" name="OPNGBALANCE_<?php echo e($key); ?>" id="OPNGBALANCE_<?php echo e($key); ?>" value="<?php echo e($row->LEAVE_OPBL); ?>" class="form-control" maxlength="13"  autocomplete="off" /></td>
...
$.ajax({
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[390,"Approve"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveOpeningBalance\mstfrm390edit.blade.php ENDPATH**/ ?>