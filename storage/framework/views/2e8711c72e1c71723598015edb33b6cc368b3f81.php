	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="MRS_NO" id="MRS_NO" value="<?php echo e(isset($objResponse->MRSP_NO) && $objResponse->MRSP_NO !=''?$objResponse->MRSP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MRS_DT" id="MRS_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->MRSP_DT) && $objResponse->MRSP_DT !=''?$objResponse->MRSP_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\AdditionalMaterialRequisition\trnfrm386edit.blade.php ENDPATH**/ ?>