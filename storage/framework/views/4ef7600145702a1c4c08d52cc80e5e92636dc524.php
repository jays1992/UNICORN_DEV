<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->AGID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->AGCODE); ?> </label>
                    <input type="hidden" name="AGID" id="AGID" value="<?php echo e($objResponse->AGID); ?>" />
                    <input type="hidden" name="AGCODE" id="AGCODE" value="<?php echo e($objResponse->AGCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="AGNAME" id="AGNAME" class="form-control mandatory" value="<?php echo e(old('AGNAME',$objResponse->AGNAME)); ?>" maxlength="200" tabindex="1"  />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                      <select name="NOGID_REF" id="NOGID_REF" class="form-control mandatory" >
                        ...
                        <option <?php echo e(isset($objResponse->NOGID_REF) && $objResponse->NOGID_REF==$Nog->NOGID?'selected="selected"':''); ?> value="<?php echo e($Nog->NOGID); ?>"><?php echo e($Nog->NOGCODE.' - '.$Nog->NOGNAME); ?></option>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[127,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[127,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\AccountGroup\mstfrm127edit.blade.php ENDPATH**/ ?>