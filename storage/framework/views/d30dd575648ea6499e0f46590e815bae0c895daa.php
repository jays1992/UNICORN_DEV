                      ...
                      <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-1 pl">
                            <input type="text" name="SOANO" id="SOANO" value="<?php echo e($MAXSOANO); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            <input type="hidden" name="SOID_REF" id="SOID_REF" value="<?php echo e($objSO->SOID); ?>" class="form-control" maxlength="15"  autofocus readonly >
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 pl">
                                <input type="text" name="SONO" id="SONO" value="<?php echo e($objSO->SONO); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-1 pl col-md-offset-1"><p>SO Date</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" value="<?php echo e($objSO->SODT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly>
                            </div>
                            
                            <div class="col-lg-2 pl"><p>GL</p></div>
                            <div class="col-lg-1 pl">
                            <input type="text" name="GLID_popup" id="txtgl_popup" class="form-control mandatory" value="<?php echo e($objglcode2->GLCODE); ?>"  autocomplete="off" disabled />
                            <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="<?php echo e($objSO->GLID_REF); ?>" />
                               
                            </div>
                            
                            <div class="col-lg-1 pl"><p>SL</p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e($objsubglcode->SGLCODE); ?>"  autocomplete="off" disabled/>
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="<?php echo e($objSO->SLID_REF); ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 pl">
                                <input type="checkbox" name="LBLSOFC" id="LBLSOFC" class="form-checkbox" value="<?php echo e($objSO->SOFC == 1 ? 1 : 0); ?>"  <?php echo e($objSO->SOFC == 1 ? 'checked' : ''); ?> disabled >
                                <input type="hidden" name="SOFC" id="SOFC" value="<?php echo e($objSO->SOFC == 1 ? 1 : 0); ?>" class="form-control">
                            </div>
                            
                            <div class="col-lg-1 pl col-md-offset-1"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <?php if(count($objsocurrency) > 0): ?>
                                <input type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objsocurrency[0]); ?>"   disabled/>
                                <?php else: ?>
                                <input type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                                <?php endif; ?>
                                <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e($objSO->CRID_REF); ?>" />
                                
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e($objSO->CONVFACT); ?>" readonly/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e($objSO->OVFDT); ?>" readonly>
                            </div>
                            
                            <div class="col-lg-1 pl"><p>To </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e($objSO->OVTDT); ?>" min="<?php echo e($objSO->OVFDT); ?>" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Customer PO No</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" class="form-control" autocomplete="off" style="text-transform:uppercase" value="<?php echo e($objSO->CUSTOMERPONO); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">	
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="CUSTOMERDT" id="CUSTOMERDT" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e($objSO->CUSTOMERDT); ?>">
                            </div>
                            
                            <div class="col-lg-1 pl"><p>Sales Person</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="SPID_popup" id="txtSPID_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e($objSPID[0]); ?>"  readonly/>
                                <input type="hidden" name="SPID_REF" id="SPID_REF" class="form-control" autocomplete="off" value="<?php echo e($objSO->SPID_REF); ?>" />
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Ref No </p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e($objSO->REFNO); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>
                            
                            <div class="col-lg-1 pl"><p>Credit Days</p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e($objSO->CREDITDAYS); ?>">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                <input type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly disabled />
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly disabled />
                            ...
                            <div class="col-lg-3 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e($objSO->REMARKS); ?>"  >
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                <?php $__currentLoopData = $objSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        ...
                                                        <input type="text" name=<?php echo e("txtSQ_popup_".$key); ?> id=<?php echo e("txtSQ_popup_".$key); ?> class="form-control sqpopup"           value="<?php echo e($row->SQNO); ?>" autocomplete="off" style="width: 100px" disabled readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control itempopup"     value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly disabled/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ItemName); ?>" readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("SQMUOM_".$key); ?> id=<?php echo e("SQMUOM_".$key); ?> class="form-control"  autocomplete="off"     value="<?php echo e($row->SQMUOM); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SQMUOMQTY_".$key); ?> id=<?php echo e("SQMUOMQTY_".$key); ?> class="form-control" maxlength="13"    value="<?php echo e($row->SQMUOMQTY); ?>"  autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SQAUOM_".$key); ?> id=<?php echo e("SQAUOM_".$key); ?> class="form-control"  autocomplete="off"     value="<?php echo e($row->SQAUOM); ?>"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SQAUOMQTY_".$key); ?> id=<?php echo e("SQAUOMQTY_".$key); ?> class="form-control" maxlength="13"    value="<?php echo e($row->SQAUOMQTY); ?>"  autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control" autocomplete="off"value="<?php echo e($row->popupMUOM); ?>"  readonly/></td>
                                                        ...
                                                        <td hidden><input type="text" name=<?php echo e("TOTAL_CONSUMED_QTY_".$key); ?> id=<?php echo e("TOTAL_CONSUMED_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->TOTAL_CONSUMED); ?>"  autocomplete="off" readonly /></td>
                                                        <td><input type="text" name=<?php echo e("SO_QTY_".$key); ?> id=<?php echo e("SO_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->SO_QTY); ?>"  autocomplete="off"  /></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupAUOM); ?>"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits"  value="<?php echo e($row->ALT_UOMID_QTY); ?>" maxlength="13" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATEPUOM); ?>"  autocomplete="off" /></td>
                                                        <td><input type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->DISCPER); ?>"  autocomplete="off" style="width: 50px;" /></td>
                                                        <td><input type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DISCOUNT_AMT); ?>" maxlength="15"  autocomplete="off"  /></td>
                                                        ...
                                                        <td align="center"><button class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button> <button class="btn remove dmaterial <?php if($row->CAN_DELETE==false): ?> notdelete <?php endif; ?>" title="Delete" data-toggle="tooltip" type="button" <?php if($row->CAN_DELETE==false): ?> disabled   <?php endif; ?>><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input type="text" name=<?php echo e("popupUDFSOID_".$Ukey); ?> id=<?php echo e("popupUDFSOID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="glnamesearch" onkeyup="GLNameFunction()">
      ...
      <table id="GlCodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="glidcode_<?php echo e($index); ?>" class="clsglid">
          <td width="50%"><?php echo e($glRow-> GLCODE); ?>

          <input type="hidden" id="txtglidcode_<?php echo e($index); ?>" data-desc="<?php echo e($glRow-> GLCODE); ?>"  value="<?php echo e($glRow-> GLID); ?>"/>
          </td>
          <td><?php echo e($glRow-> GLNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
      ...
      $(".clsctid").dblclick(function(){
        ...
        if(customid!=''){
          ...
          $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[38,"getcalculationdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
  ...
  var customid = $('#GLID_REF').val();
        if(customid!=''){
          ...
          $('#tbody_subglacct').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[38,"getsubledger"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
      ...
      $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        if(SalesQuotationID!=''){
                $("#tbody_ItemID").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[38,"getItemDetailsQuotationwiseAmend"])); ?>',
                      type:'POST',
        ...
        else
        {
                $("#tbody_ItemID").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[38,"getItemDetailswithoutQuotationAmend"])); ?>',
                      type:'POST',
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[38,"saveamendment"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ReleaseOrder\trnfrm315amendment.blade.php ENDPATH**/ ?>