...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[261,'index'])); ?>" class="btn singlebt">Sales Return Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Sales Return</p></div>
                            <div class="col-lg-3 pl" id="div_SRID">
                                <select name="SRID[]" id="SRID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSRNO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->SRID); ?>" selected><?php echo e($GRow->SRNO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[261,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SRID = [];
        $("select[name='SRID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                SRID.push(value5);
            }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[261,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesReturnRegister\rptfrm261.blade.php ENDPATH**/ ?>