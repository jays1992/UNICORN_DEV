...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[72,'index'])); ?>" class="btn singlebt">Item Master</a></div>
    <div class="col-lg-10 topnav-pd">
      <a href="<?php echo e(route('master',[72,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?> ><i class="fa fa-plus"></i> Add</a>
      ...
      <button class="btn topnavbt" id="btnImport" <?php echo e(isset($objRights->AMENDMENT) && $objRights->AMENDMENT != 1 ? 'disabled' : ''); ?> > <i class="fa fa-file"></i> Import</button>
    ...
    <table id="custlist" class="display nowrap table table-striped table-bordered" style="width:100%;">
      <thead id="thead1" >
        ...
        <th><span style="position:relative;bottom:10px;left:5px;">&#10004;</span></th>
          ...
          <th <?php echo e($AlpsStatus['hidden']); ?>>
...
function load_country_data(limit, start,indexno){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[72,"getListingData"])); ?>',
    method:"POST",
...
$(document).ready(function(){
  ...
  $('.js-selectall').on('change', function() {
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[72,"edit",":rcdId"])); ?>';
      ...
      $('#btnCopy').on('click', function() {
        ...
        if(seletedRecord==0){
          ...
          var recordId = countryIdsData[0];
              ...
              if(is_approve==0){
                    var editURL = '<?php echo e(route("master",[72,"copy",":rcdId"])); ?>';
                    editURL = editURL.replace(":rcdId",recordId);
                    window.location.href=editURL;
              }else if(is_approve==2){
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[72,"view",":rcdId"])); ?>';
    ...
    $('#btnAmendment').on('click', function() {
      ...
      if(seletedRecord==0){
        ...
        if(is_approve==1){
          ...
          var editURL = '<?php echo e(route("master",[72,"amendment",":rcdId"])); ?>';
              editURL = editURL.replace(":rcdId",recordId);
              window.location.href=editURL;
        }else if(is_approve==2){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[72,"attachment",":rcdId"])); ?>';
    ...
    $('#btnImport').on('click', function() {
        var impURL =  '<?php echo e(route("master",[72,"importdata"])); ?>';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[72,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[72,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/inventory/itemmasters/mstfrm72.blade.php ENDPATH**/ ?>