...
<div class="container-fluid purchase-order-view filter">     
  <form id="frm_mst_edit" method="POST"> 
    <?php echo csrf_field(); ?>
    <?php echo e(isset($HDR->TRYID) ? method_field('PUT') : ''); ?>

   <div class="inner-form">
         <div class="row">
           <div class="col-lg-2 pl"><p>Doc No*</p></div>
           <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="TRYDOC_NO" id="TRYDOC_NO" value="<?php echo e(isset($HDR->TRYDOC_NO) && $HDR->TRYDOC_NO !=''?$HDR->TRYDOC_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" >
             <span class="text-danger" id="ERROR_TRYDOC_NO"></span>
           </div>

           <div class="col-lg-2 pl"><p>Date*</p></div>
           <div class="col-lg-2 pl">
           <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(isset($HDR->DOC_DT) && $HDR->DOC_DT !=''?$HDR->DOC_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
           </div>
         </div>
         ...
         <div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($HDR->DEACTIVATED == 1 ? "checked" : ""); ?>
                     ...
                     <tbody>
                      ...
                      <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       ...
                       <tr  class="participantRow">
                         ...
                         <td><input <?php echo e($ActionStatus); ?> class="form-control"          type="text" name="TERTORYCODE[]"    id ="TERTORYCODE_<?php echo e($key); ?>"      value="<?php echo e(isset($row->TRY_CODE) && $row->TRY_CODE !=''?$row->TRY_CODE:''); ?>"  autocomplete="off"></td>
                         <td><input <?php echo e($ActionStatus); ?> class="form-control"          type="text" name="TERTORYNAME[]"    id ="TERTORYNAME_<?php echo e($key); ?>"      value="<?php echo e(isset($row->TRY_NAME) && $row->TRY_NAME !=''?$row->TRY_NAME:''); ?>"  autocomplete="off"></td>                                
...
if(TRYDOC_NO ===""){
 ...
 alertMsg('DOC_DT','Please Select Date.');
}
else{
 event.preventDefault();
   var allblank1 = [];
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\PROJECTS\UNICORN_DEV\resources\views/masters/PreSales/TerritoryMaster/mstfrm557edit.blade.php ENDPATH**/ ?>