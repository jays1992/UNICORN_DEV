...
<!-- <form id="frm_rpt_sop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('report',[297,'index'])); ?>" class="btn singlebt">Sales Order Print</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SONO" id="SONO" class="form-control mandatory">
                                    ...
                                    <?php $__currentLoopData = $objSono; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SOID); ?>" ><?php echo e($Row->SONO); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesOrderPrint\rptfrm297.blade.php ENDPATH**/ ?>