         ...
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <?php echo e(isset($objResponse->MACHINEID) ? method_field('PUT') : ''); ?>
            ...
            <div class="inner-form">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <input type="text" name="MACHINE_popup" id="txtmachine_popup" value="<?php echo e(isset($ObjMachine[0]->MACHINE_NO) ? $ObjMachine[0]->MACHINE_NO :''); ?>" class="form-control mandatory clsclear"  autocomplete="off" readonly/>
                    <input type="hidden" name="MACHINEID_REF" id="MACHINEID_REF" value="<?php echo e(isset($ObjMachine[0]->MACHINEID) ? $ObjMachine[0]->MACHINEID :''); ?>" class="form-control clsclear" autocomplete="off" />
                    <input type="hidden" name="MWITEMID" id="MWITEMID"  value="<?php echo e(isset($ObjTBLMWIH[0]->MWITEMID) ? $ObjTBLMWIH[0]->MWITEMID :''); ?>" class="form-control clsclear" autocomplete="off" />
                </div>              
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-7 pl">
                      ...
                      <input type="hidden" name="MOULD_CODE" id="MOULD_CODE" value="<?php echo e($objResponse->MOULD_CODE); ?>" />
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">                 
                    <input type="text" name="txtPRODITEMPOP_popup" id="txtPRODITEMPOP_popup"  value="<?php echo e(isset($ObjProdItem[0]->ICODE) ? $ObjProdItem[0]->ICODE :''); ?>" class="form-control clsclear"  autocomplete="off"  readonly />
                    <input type="hidden" name="PRODUCE_ITEMID_REF" id="hdnPRODITEMPOPID"        value="<?php echo e(isset($ObjProdItem[0]->ITEMID) ? $ObjProdItem[0]->ITEMID :''); ?>"  class="form-control clsclear" autocomplete="off" />
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
                <input type="text" name="EXP_PRODUCE_QTY" id="EXP_PRODUCE_QTY" value="<?php echo e($objResponse->EXP_PRODUCE_QTY); ?>" class="form-control three-digits clsclear" maxlength="13"  autocomplete="off" />
            </div>

            <div class="col-lg-2 pl"><p>UOM</p></div>
            <div class="col-lg-2 pl">
                <input type="text" name="txtMainUOM_popup_0" id="txtMainUOM_popup_0"  value="<?php echo e(isset($ObjEXPUOM[0]->UOMCODE) ? $ObjEXPUOM[0]->UOMCODE :''); ?>-<?php echo e(isset($ObjEXPUOM[0]->DESCRIPTIONS) ? $ObjEXPUOM[0]->DESCRIPTIONS :''); ?>"  class="form-control mandatory clsclear"  autocomplete="off" readonly/>
                <input type="hidden" name="EXP_PRODUCE_UOMID_REF" id="MainUOM_REF_0" value="<?php echo e(isset($ObjEXPUOM[0]->UOMID) ? $ObjEXPUOM[0]->UOMID :''); ?>"  class="form-control clsclear" autocomplete="off" />
            </div>              
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
                <input type="text" name="PRODUCE_QTY" id="PRODUCE_QTY" value="<?php echo e($objResponse->PRODUCE_QTY); ?>" class="form-control three-digits clsclear" maxlength="13"  autocomplete="off" />
            </div>

            <div class="col-lg-2 pl"><p>UOM</p></div>
            <div class="col-lg-2 pl">
                <input type="text" name="txtMainUOM_popup_1" id="txtMainUOM_popup_1"  value="<?php echo e(isset($ObjPRODUOM[0]->UOMCODE) ? $ObjPRODUOM[0]->UOMCODE :''); ?>-<?php echo e(isset($ObjPRODUOM[0]->DESCRIPTIONS) ? $ObjPRODUOM[0]->DESCRIPTIONS :''); ?>"  class="form-control mandatory clsclear"  autocomplete="off" readonly/>
                <input type="hidden" name="PRODUCE_UOMID_REF" id="MainUOM_REF_1"        value="<?php echo e(isset($ObjPRODUOM[0]->UOMID) ? $ObjPRODUOM[0]->UOMID :''); ?>" class="form-control clsclear" autocomplete="off" />
            </div>      
          </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[161,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[161,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\MachineWiseMouldInfo\mstfrm161edit.blade.php ENDPATH**/ ?>