<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->URMID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="" id="" class="form-control mandatory" autocomplete="off" tabindex="1" readonly value="<?php echo e(isset($objUserName->UCODE) && $objUserName->UCODE !=''?$objUserName->UCODE:''); ?>" />
                    <input type="hidden" name="USERID_REF" id="USERID_REF"  value="<?php echo e($objResponse->USERID_REF); ?>" />
                    <input type="hidden" name="user_approval_level" id="user_approval_level" value="<?php echo e($user_approval_level); ?>"  />
                    <input type="hidden" name="URMID" id="URMID" value="<?php echo e($objResponse->URMID); ?>" />
                    <span class="text-danger" id="ERROR_USERID_REF"></span> 
                   
                  </div>

                  <div class="col-lg-3 pl">
                    <input type="text" id="USER_DETAILS" class="form-control" readonly value="<?php echo e(isset($objUserName->DESCRIPTIONS) && $objUserName->DESCRIPTIONS !=''?$objUserName->DESCRIPTIONS:''); ?>" />
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                      <input type="text" name="ROLLID_REF_POPUP" id="ROLLID_REF_POPUP" class="form-control mandatory" autocomplete="off" tabindex="2" readonly value="<?php echo e(isset($objRoleName->RCODE) && $objRoleName->RCODE !=''?$objRoleName->RCODE:''); ?>"  />
                      <input type="hidden" name="ROLLID_REF" id="ROLLID_REF" value="<?php echo e(old('ROLLID_REF',$objResponse->ROLLID_REF)); ?>" />
                    <span class="text-danger" id="ERROR_ROLLID_REF"></span> 
                  </div>

                  <div class="col-lg-3 pl">
                    <input type="text" id="ROLL_DETAILS" class="form-control" readonly  value="<?php echo e(isset($objRoleName->DESCRIPTIONS) && $objRoleName->DESCRIPTIONS !=''?$objRoleName->DESCRIPTIONS:''); ?>" />
                  </div>
                </div>
                ...
                <div class="col-lg-2 pl"><p>Effective Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="EFDATE" id="EFDATE" class="form-control mandatory"  tabindex="3" autocomplete="off"  value="<?php echo e(isset($objResponse->EFDATE) && $objResponse->EFDATE !="" && $objResponse->EFDATE !="1900-01-01" ? $objResponse->EFDATE:''); ?>" placeholder="dd/mm/yyyy" />
                    <span class="text-danger" id="ERROR_EFDATE"></span> 
                  </div>

                  <div class="col-lg-1 pl"><p>End Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="ENDDATE" id="ENDDATE" class="form-control mandatory"  tabindex="4" autocomplete="off"  value="<?php echo e(isset($objResponse->ENDDATE) && $objResponse->ENDDATE !="" && $objResponse->ENDDATE !="1900-01-01" ? $objResponse->ENDDATE:''); ?>" placeholder="dd/mm/yyyy" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="REASONOED" id="REASONOED" class="form-control mandatory" value="<?php echo e(old('REASONOED',$objResponse->REASONOED)); ?>" tabindex="5" maxlength="100" autocomplete="off"  />
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="user_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_USERID_REF[]" id="userref_<?php echo e($val->USERID); ?>" class="clsuserref" value="<?php echo e($val->USERID); ?>" /></td>
          <td  class="ROW2" style="width: 39%"><?php echo e($val->UCODE); ?>

          <input type="hidden" id="txtuserref_<?php echo e($val->USERID); ?>" data-code="<?php echo e($val->UCODE); ?>" data-desc="<?php echo e($val->DESCRIPTIONS); ?>" value="<?php echo e($val-> USERID); ?>"/>
          </td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="role_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        <tbody>
        <?php $__currentLoopData = $objRoleList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ROLLID_REF[]" id="roleref_<?php echo e($val->ROLLID); ?>" class="clsroleref" value="<?php echo e($val->ROLLID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($val->RCODE); ?>

          <input type="hidden" id="txtroleref_<?php echo e($val->ROLLID); ?>" data-code="<?php echo e($val->RCODE); ?>" data-desc="<?php echo e($val->DESCRIPTIONS); ?>" value="<?php echo e($val-> ROLLID); ?>"/>
          </td>
          <td  class="ROW3" style="width: 39%"><?php echo e($val->DESCRIPTIONS); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[149,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[149,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '<?php echo e(route("master",[149,"index"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserRoleMapping\mstfrm149edit.blade.php ENDPATH**/ ?>