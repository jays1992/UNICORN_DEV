...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[321,'index'])); ?>" class="btn singlebt">Journal Book</a>
                </div><!--col-2-->
						...
						<div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="TYPE" data-hide-disabled="hide" data-actions-box="true" id="TYPE"  class="form-control selectpicker" data-live-search="true"  >
									...
									<option value="AUTOJV" selected>AUTO JV</option>
									<option value="MANUALJV" >MANUAL JV</option>
                                </select>
                            </div> 
                        </div>
                    </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[321,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
		...
		else if(TYPE ==="")
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[321,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\JournalBook\rptfrm321.blade.php ENDPATH**/ ?>