<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[194,'index'])); ?>" class="btn singlebt">Leave Encashment Provision</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->LEPID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <label style="margin-left: 17px;"> <?php echo e($objResponse->LEAVE_TYPE_CODE); ?> </label>
                    <input type="hidden" name="LEPID" id="LEPID" value="<?php echo e($objResponse->LEPID); ?>" />
                    <input type="hidden" name="LEAVE_TYPE_CODE" id="LEAVE_TYPE_CODE" value="<?php echo e($objResponse->LEAVE_TYPE_CODE); ?>" autocomplete="off"  maxlength="20"   />
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="LEAVE_TYPE_DESC" id="LEAVE_TYPE_DESC" class="form-control mandatory" value="<?php echo e($objResponse->LEAVE_TYPE_DESC); ?>" maxlength="200" tabindex="2"  />
            ...
            <div class="col-lg-1">
            <input type="radio" name="PROVISION" value="Quater" <?php echo e($objResponse->PROVISION == 'Quater' ? 'checked' : ''); ?> >
            </div>

            <div class="col-lg-1"><p>Half Yearly</p></div>
            <div class="col-lg-1">
              <input type="radio" name="PROVISION" value="Half Yearly" <?php echo e($objResponse->PROVISION == 'Half Yearly' ? 'checked' : ''); ?>  >
            </div>

            <div class="col-lg-1"><p>Yearly</p></div>
            <div class="col-lg-1">
              <input type="radio" name="PROVISION" value="Yearly" <?php echo e($objResponse->PROVISION == 'Yearly' ? 'checked' : ''); ?>  >
            </div>
              ...
              <div class="row">
                ...
                <input type="checkbox"   name="DEACTIVATED" style="margin-left: 17px; id="deactive-checkbox_0" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[194,"add"])); ?>';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[194,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[194,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '<?php echo e(route("master",[194,"index"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveEncashmentProvision\mstfrm194edit.blade.php ENDPATH**/ ?>