...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[298,'index'])); ?>" class="btn singlebt">Stock Ledger</a>
                </div><!--col-2-->
                        ...
                        <div class="row">    
                            ...
                            <div class="col-lg-3 pl" id="">
                                <select name="ReportType" id="ReportType" class="form-control">
                                        ...
                                        <option value="WithoutStore">Without Store </option> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[298,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(STOREID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[298,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\Stock_Ledger\rptfrm298.blade.php ENDPATH**/ ?>