...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[251,'index'])); ?>" class="btn singlebt">Daily Sales Plan Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_dsp"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Daily Sales Plan No</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="DSPNO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="DSPNO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjDailySalesPlan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->DSPID); ?>" selected><?php echo e($GRow->DSPNO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[251,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var DSPNO = [];
        $("select[name='DSPNO[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                DSPNO.push(value5);
            }
        ...
        else if(DSPNO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Daily Sales Plan.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[251,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\DSPRegister\rptfrm251.blade.php ENDPATH**/ ?>