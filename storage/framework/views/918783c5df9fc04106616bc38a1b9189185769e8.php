...
<!-- <form id="frm_rpt_poscw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[281,'index'])); ?>" class="btn singlebt">Purchase Order Summary City Wise</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_poscw"  method="POST">   
            <?php echo csrf_field(); ?>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl">
                                <select name="CITY[]" id="CITY" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <?php $__currentLoopData = $objCity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->CITYID); ?>" selected><?php echo e($Row->CITYCODE); ?>-<?php echo e($Row->NAME); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
//                 });
//                 $.ajax({
//                     url:'<?php echo e(route("report",[281,"GetPurchaseOrder"])); ?>',
//                     type:'POST',
...
$('#btnView').on('click', function() {
    var From_Date       = $('#From_Date').val();
        ...
        else if(CITY  == '')
        {
            ...
            var trnsoForm = $("#frm_rpt_poscw");
            var formData = trnsoForm.serialize();
            var consultURL = '<?php echo e(route("report",[281,"ViewReport",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\POCitywise\rptfrm281.blade.php ENDPATH**/ ?>