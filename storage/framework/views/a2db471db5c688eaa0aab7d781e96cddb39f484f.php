<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Lead Source</a>
                </div>
          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> <?php echo e($objResponse->LEAD_SOURCECODE); ?> </label>
                    <input type="hidden" name="LEAD_SOURCECODE" id="LEAD_SOURCECODE" value="<?php echo e($objResponse->ID); ?>" />
                    <input type="hidden" name="LEAD_SOURCECODE" id="LEAD_SOURCECODE" value="<?php echo e($objResponse->LEAD_SOURCECODE); ?>" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="LEAD_SOURCENAME" id="LEAD_SOURCENAME" class="form-control mandatory" value="<?php echo e(old('LEAD_SOURCENAME',$objResponse->LEAD_SOURCENAME)); ?>" maxlength="200" tabindex="1"  />
                  </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\LeadSource\mstfrm440edit.blade.php ENDPATH**/ ?>