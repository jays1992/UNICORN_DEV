...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="NRGP_NO" id="NRGP_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="NRGP_DT" id="NRGP_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("NRGP_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('NRGP_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFNRGPID); ?>" autocomplete="off"   /></td>
...
//  } 
  ...
  $('#example3').find('.participantRow3').each(function(){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#NRGP_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\NonReturnableGatePass\trnfrm91add.blade.php ENDPATH**/ ?>