  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="PRO_NO" id="PRO_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PRO_DT" id="PRO_DT" value="<?php echo e(old('PRO_DT')); ?>" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("PRO_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
function validateForm(){
  ...
  if(PRO_NO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#PRO_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionOrder\trnfrm239add.blade.php ENDPATH**/ ?>