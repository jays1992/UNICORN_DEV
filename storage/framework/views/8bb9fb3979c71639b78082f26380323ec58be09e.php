...
<!-- <form id="frm_mst_edit" onsubmit="return validateForm()"  method="POST"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[112,'index'])); ?>" class="btn singlebt">UDF for Return from <br/>Production Floor (RPF)</a>
                </div><!--col-2-->
    ...
    <?php echo csrf_field(); ?>
          ...
          <?php echo e(isset($objUdfResponse->UDFRPFID[0]) ? method_field('PUT') : ''); ?>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <?php $__currentLoopData = $objUdfResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr  class="participantRow">
                        <td hidden>
                        <input  class="form-control" type="hidden" name=<?php echo e("UDFRPFID_".$key); ?> id =<?php echo e("txtID_".$key); ?> maxlength="100" value="<?php echo e($row->UDFRPFID); ?>" autocomplete="off"   >
                        </td>
                        <td>
                        <input  class="form-control" type="text" name=<?php echo e("LABEL_".$key); ?> id =<?php echo e("txtlabel_".$key); ?> maxlength="100" value="<?php echo e($row->LABEL); ?>"  autocomplete="off" style="text-transform:uppercase" >
                        </td>
                        <td>
                            <select class="form-control selvt" name=<?php echo e("VALUETYPE_".$key); ?> id=<?php echo e("drpvalue_".$key); ?> >
                        ...
                        <td style="text-align:center;" ><input type="checkbox" name=<?php echo e("ISMANDATORY_".$key); ?> id=<?php echo e("chkmdtry_".$key); ?>  <?php echo e($row->ISMANDATORY == 1 ? 'checked' : ''); ?>  ></td>
                        <td style="text-align:center;" ><input type="checkbox" name=<?php echo e("DEACTIVATED_".$key); ?>  id=<?php echo e("deactive-checkbox_".$key); ?> <?php echo e($row->DEACTIVATED == 1 ? 'checked' : ''); ?> <?php echo e(isset($n) && $n ==1?'disabled':''); ?> ></td>
                        <td style="text-align:center;" >
                        <input type="date" name=<?php echo e("DODEACTIVATED_".$key); ?> class="form-control" placeholder="dd/mm/yyyy" id=<?php echo e("decativateddate_".$key); ?> value="<?php echo e(($row->DODEACTIVATED)=='1900-01-01'?'':$row->DODEACTIVATED); ?>" ></td>                    
                        <td align="center" ><button class="btn add" title="add" data-toggle="tooltip">
                        <i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip"  <?php echo e(isset($n) && $n ==1?'disabled':''); ?> >
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[112,"add"])); ?>';
...
window.fnSaveData = function (){
            ...
            event.preventDefault();
                            ...
                            $.ajax({
                                url:'<?php echo e(route("mastermodify",[112,"update"])); ?>',
                                type:'POST',
                                data:formData,
                                success:function(data) {
                                    ...
                                    if(data.success) {                   
                                        ...
                                        // window.location.href="<?php echo e(route('master',[112,'index'])); ?>";
                                    }
                                    else if(data.cancel) {                   
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[112,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\UDFRPF\mstfrm112edit.blade.php ENDPATH**/ ?>