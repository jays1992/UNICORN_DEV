                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="SOSNO" id="SOSNO" value="<?php echo e(isset($objSOS->SBP_NO)?$objSOS->SBP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            </div>
                            <div class="col-lg-2 pl"><p>SBP Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objSOS->SBP_DT)?$objSOS->SBP_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
                            <div class="col-lg-2 pl"><p>Vendor*</p></div>
                            <div class="col-lg-2 pl">
                            <input <?php echo e($ActionStatus); ?> type="text" name="GLID_popup" id="txtgl_popup" class="form-control mandatory" value="<?php echo e(isset($objglcode2->VCODE)?$objglcode2->VCODE:''); ?> <?php echo e(isset($objglcode2->NAME)?'-'.$objglcode2->NAME:''); ?>" autocomplete="off" readonly/>
                            <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off"  value="<?php echo e(isset($objSOS->VID_REF)?$objSOS->VID_REF:''); ?>" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="OSOID_popup" id="OSOID_popup" class="form-control mandatory" value="<?php echo e(isset($objOSO->BPO_NO)?$objOSO->BPO_NO:''); ?>" autocomplete="off" readonly/>
                                <input type="hidden" name="OSOID_REF" id="OSOID_REF" class="form-control" value="<?php echo e(isset($objSOS->BPOID_REF)?$objSOS->BPOID_REF:''); ?>" autocomplete="off" />
                            </div>   
                            <div class="col-lg-2 pl"><p>Title</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="TITLE" id="TITLE" class="form-control" value="<?php echo e(isset($objSOS->TITLE)?$objSOS->TITLE:''); ?>" maxlength="100" autocomplete="off"/>
                            </div>                           
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                <div id="Material" class="tab-pane fade in active">
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <?php if(!empty($objSOSMAT)): ?>
                                                <?php $__currentLoopData = $objSOSMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="participantRow">
                                                    <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("SOSMATID_".$key); ?> id =<?php echo e("SOSMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SBPMATID); ?>" autocomplete="off"   >
                                                    </td>
                                                    ...
                                                    <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Alpspartno_".$key); ?> id=<?php echo e("Alpspartno_".$key); ?> class="form-control" value="<?php echo e($row->ALPS_PART_NO); ?>"  autocomplete="off"  readonly/></td>
                                                    <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Custpartno_".$key); ?> id=<?php echo e("Custpartno_".$key); ?> class="form-control" value="<?php echo e($row->CUSTOMER_PART_NO); ?>"  autocomplete="off"  readonly/></td>
                                                    <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("OEMpartno_".$key); ?> id=<?php echo e("OEMpartno_".$key); ?> class="form-control" value="<?php echo e($row->OEM_PART_NO); ?>"  autocomplete="off"  readonly/></td>
                                                    <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUOM_".$key); ?> id=<?php echo e("popupUOM_".$key); ?> class="form-control"  value="<?php echo e($row->MAIN_UOM_CODE); ?>" autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("UOMID_REF_".$key); ?> id=<?php echo e("UOMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->UOMID_REF); ?>" autocomplete="off" readonly /></td>
                                                    <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ITEMSPECI_".$key); ?> id=<?php echo e("ITEMSPECI_".$key); ?> class="form-control" maxlength="200" value="<?php echo e($row->ITEMSPECI); ?>" autocomplete="off" readonly  /></td>
                                                    <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATE); ?>"  autocomplete="off" readonly /></td>
                                ...
                                <div id="Schedule" class="tab-pane fade">
                                  <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                    ...
                                    <div class="col-lg-2 pl">
                                          <input <?php echo e($ActionStatus); ?> type="text" name="SchITEM" id="SchITEM" class="form-control"  value="<?php echo e(isset($objSOSSCH->ICODE)?$objSOSSCH->ICODE:''); ?>"  autocomplete="off"  readonly/>
                                          <input type="hidden" name="Sch_ITEMID" id="Sch_ITEMID" class="form-control" value="<?php echo e(isset($objSOSSCH->ITEMID_REF)?$objSOSSCH->ITEMID_REF:''); ?>" autocomplete="off" />
                                    </div>
                                    <div class="col-lg-2 pl"><p>Item Name</p></div>
                                    <div class="col-lg-2 pl">
                                          <input <?php echo e($ActionStatus); ?> type="text" name="Sch_Item_Name" id="Sch_Item_Name" class="form-control" value="<?php echo e(isset($objSOSSCH->ITEM_NAME)?$objSOSSCH->ITEM_NAME:''); ?>"  autocomplete="off"  readonly/>
                                    </div>
                                    <?php if(strpos($objCOMPANY->NAME,"ALPS") == false): ?>   
                                      ...
                                      <div class="col-lg-2 pl" hidden>
                                            <input <?php echo e($ActionStatus); ?> type="text" name="Alps_Part_No" id="Alps_Part_No" class="form-control" value="<?php echo e(isset($objSOSSCH->ALPS_PART_NO)?$objSOSSCH->ALPS_PART_NO:''); ?>" autocomplete="off"  readonly/>
                                      </div>
                                    <?php endif; ?>
                                  </div>
                                  ...
                                  <?php if(strpos($objCOMPANY->NAME,"ALPS") == false): ?>
                                    ...
                                    <div class="col-lg-2 pl" hidden>
                                          <input <?php echo e($ActionStatus); ?> type="text" name="Cust_Part_No" id="Cust_Part_No" class="form-control" value="<?php echo e(isset($objSOSSCH->CUSTOMER_PART_NO)?$objSOSSCH->CUSTOMER_PART_NO:''); ?>"  autocomplete="off"  readonly/>
                                    </div>
                                  <?php endif; ?>
                                    <div class="col-lg-2 pl"><p>UoM</p></div>
                                    <div class="col-lg-2 pl">
                                    <input <?php echo e($ActionStatus); ?> type="text" name="SchUOM" id="SchUOM" class="form-control" value="<?php echo e(isset($objSOSSCH->MAIN_UOM_CODE)?$objSOSSCH->MAIN_UOM_CODE:''); ?>"  autocomplete="off"  readonly/>
                                          <input type="hidden" name="Sch_UOMID_REF" id="Sch_UOMID_REF" class="form-control" value="<?php echo e(isset($objSOSSCH->UOMID_REF)?$objSOSSCH->UOMID_REF:''); ?>" autocomplete="off" />
                                    </div>
                                    <div class="col-lg-2 pl"><p>Schedule Qty*</p></div>
                                    <div class="col-lg-2 pl">
                                      <input <?php echo e($ActionStatus); ?> type="text" name="Sch_SOQTY" id="Sch_SOQTY" class="form-control three-digits" value="<?php echo e(isset($total_qty)?$total_qty:''); ?>" autocomplete="off" />
                                    </div>
                                  </div>
                                  <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:60%;">
                                    <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                      ...
                                      <tbody>
                                    <?php if(!empty($objSCHDET)): ?>
                                        <?php $__currentLoopData = $objSCHDET; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skey => $srow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr  class="participantRow3">
                                        <td> <input <?php echo e($ActionStatus); ?> type="date" name=<?php echo e("SCHDT_".$skey); ?>  id=<?php echo e("SCHDT_".$skey); ?> class="form-control " autocomplete="off" value="<?php echo e($srow->DATE); ?>" placeholder="dd/mm/yyyy" > </td>
                                        <td> <input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SCHQTY_".$skey); ?> id=<?php echo e("SCHQTY_".$skey); ?>   class="form-control three-digits" value="<?php echo e(number_format(floatVal($srow->QTY),3,'.','')); ?>" autocomplete="off" /> </td>
                                        <td>
                                          <input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("PopupSHIPTO_".$skey); ?> id=<?php echo e("PopupSHIPTO_".$skey); ?> class="form-control"  autocomplete="off" readonly  />
                                          
                                        </td>
                                        <td hidden><input type="hidden" name=<?php echo e("txtSHIPTO_".$skey); ?> id=<?php echo e("txtSHIPTO_".$skey); ?> class="form-control" value="<?php echo e($srow->DELIVERYINS); ?>"  autocomplete="off" /></td>
                                        <td align="center" >
      ...
      var customid = $('#GLID_REF').val();
        if(customid!=''){
          $('#tbody_subglacct').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[68,"getsubledger"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
$(document).ready(function(e) {
    ...
    $('#example3').find('.participantRow3').each(function(){
        ...
        if(id!=''){
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[68,"getShipAddressIDwise"])); ?>',
              type:'POST',
              data:{'id':id},
              success:function(data) {
                $('#'+txtid).val(data);                 
    ...
    return false;
        ...
        var arrdate=[];
            ...
            if(jQuery.inArray("false", allblank) !== -1){
                ...
                else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#SOSDT").val(),0) ==0){
                  $("#YesBtn").hide();
                  $("#NoBtn").hide();
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[68,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$("#btnSaveSOS").prop("disabled", true);
$.ajax({
    url:'<?php echo e(route("transactionmodify",[68,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
      $(".buttonload_approve").hide();  
      $("#btnSaveSOS").prop("disabled", false);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Purchase/ScheduleBlanketPurchaseOrder/trnfrm68edit.blade.php ENDPATH**/ ?>