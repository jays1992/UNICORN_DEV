...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <input type="text" name="MRS_NO" id="MRS_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <span class="text-danger" id="ERROR_MRS_NO"></span> 
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="MRS_DT" id="MRS_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("MRS_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)'  value="<?php echo e(old('MRS_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
            
      </div>

      <div class="col-lg-1 pl"><p>MRS Type</p></div>
			<div class="col-lg-2 pl" >
        <select name="MRS_TYPE" id="MRS_TYPE" class="form-control" >
      ...
      <div class="col-lg-1 pl"><p>Request User</p></div>
			<div class="col-lg-2 pl">
                <input type="text" name="REQUEST_USER_popup" id="txtREQUEST_USER_popup" class="form-control mandatory"  autocomplete="off"  readonly/>
                <input type="hidden" name="REQUEST_USER" id="REQUEST_USER" class="form-control" autocomplete="off" />
			</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialRequisitionSlip\trnfrm88add.blade.php ENDPATH**/ ?>