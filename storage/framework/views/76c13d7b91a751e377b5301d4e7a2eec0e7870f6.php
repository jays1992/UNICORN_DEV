...
<form id="trn_form" onsubmit="return validateForm(actionType)" method="POST"  class="needs-validation"> 
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DT" id="DOC_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("DOC_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('DOC_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ExtendedWarranty\trnfrm497add.blade.php ENDPATH**/ ?>