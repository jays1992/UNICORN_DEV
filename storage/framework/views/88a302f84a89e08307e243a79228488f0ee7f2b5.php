...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[400,'index'])); ?>" class="btn singlebt">Inventory Aging Report</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_stock"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">     
                            <div class="col-lg-3 pl"><p>Date As On</p></div>
                            <div class="col-lg-3 pl">
                                <input type="date" name="DATEASON" id="DATEASON" value="<?php echo e(old('DATEASON')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
                            </div>                                                       
                        </div>
                        <div class="row"> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[400,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[400,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\InventoryAging\rptfrm400.blade.php ENDPATH**/ ?>