...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[277,'index'])); ?>" class="btn singlebt">Management Quarterly Net Sales Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_srs"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="BranchGroup[]" id="BranchGroup"  class="form-control selectpicker" data-hide-disabled="hide" multiple data-actions-box="true" multiple data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl">
                                <select name="BranchName[]" id="BranchName"  class="form-control selectpicker" data-hide-disabled="hide" multiple data-actions-box="true" multiple data-live-search="true"  >
                        ...
                        <div class="row">                  
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="ITEMGID[]" id="ITEMGID" class="form-control selectpicker" data-hide-disabled="hide" multiple data-actions-box="true" multiple data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl" id="div_itemid">
                                <select name="ITEMID[]" id="ITEMID" class="form-control selectpicker" data-hide-disabled="hide" multiple data-actions-box="true" multiple data-live-search="true"  >
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[277,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[277,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\MGMT_QNS\rptfrm277.blade.php ENDPATH**/ ?>