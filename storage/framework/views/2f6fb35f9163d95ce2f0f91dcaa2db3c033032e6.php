...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="DPPDT" id="DPPDT" onchange="checkPeriodClosing(230,this.value,1)" value="<?php echo e($objDPP->DPP_DT); ?>" class="form-control mandatory DPPDT"  placeholder="dd/mm/yyyy" >         
    </div>
...
<tr  class="participantRow">
  <td style="text-align:center;">
    <input type="text" name="SubGl_popup_<?php echo e($key); ?>" id="txtsubgl_popup_<?php echo e($key); ?>" value="<?php echo e($row->SL_CODE); ?>" class="form-control mandatory" style="width:140px" readonly />
  </td>
  <td  hidden>
  ...
  <td > 
    <input type="text" name="SaleOrd_Popup_<?php echo e($key); ?>" id="txtSORD_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SONO); ?>" readonly data-dayno="1"  class="form-control"  style="width:140px;"  />
  </td>
  <td  hidden>
  ...
  <td><input type="text" name="BAL_SOQTY_<?php echo e($key); ?>" id="BALSO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->totalppqty); ?>" class="form-control" readonly style="width:130px;" autocomplete="off"  /></td>
  <td><input type="text" name="PRO_PLANQTY_<?php echo e($key); ?>" id="PROPLAN_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->PRO_PLAN_QTY); ?>"  class="form-control three-digits" style="width:130px;" maxlength="13" autocomplete="off"  /></td>
  <td>
    <select id="dpp_priority_<?php echo e($key); ?>" name="dpp_priority_<?php echo e($key); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\DailyProductionPlan\trnfrm230edit.blade.php ENDPATH**/ ?>