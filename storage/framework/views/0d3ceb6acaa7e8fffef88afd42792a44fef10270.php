  ...
  <div class="inner-form">
      ...
      <div class="row">    
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="DOC_NO" id="DOC_NO"  value="<?php echo e(isset($objResponse->DOC_NO) && $objResponse->DOC_NO !=''?$objResponse->DOC_NO:''); ?>" class="form-control" required autocomplete="off" maxlength="15" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" readonly />
          <span class="text-danger" id="ERROR_DOC_NO"></span> 
        </div>
		
        <div class="col-lg-1 pl"><p>Date</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(isset($objResponse->DOC_DT) && $objResponse->DOC_DT !=''?date('Y-m-d',strtotime($objResponse->DOC_DT)):''); ?>" class="form-control" autocomplete="off" required />
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input type="checkbox" name="DATA_ID[<?php echo e($key); ?>]" <?php echo e($row->DATA_ID ==$row->DATA_ID_REF?'checked':''); ?> value="<?php echo e($row->DATA_ID); ?>" class="checkbox" ></td>
                    ...
                    <td><input  type="checkbox" name="DEACTIVATED_<?php echo e($key); ?>" id ="DEACTIVATED_<?php echo e($key); ?>" <?php echo e($row->DEACTIVATED ==1?'checked':''); ?>  value="1" onclick="DateEnableDisabled('<?php echo e($key); ?>')"  autocomplete="off" style="width:100%;"  ></td>
                    <td><input  type="date" name="DODEACTIVATED_<?php echo e($key); ?>" id ="DODEACTIVATED_<?php echo e($key); ?>" value="<?php echo e(isset($row->DODEACTIVATED) && $row->DODEACTIVATED !=''?date('Y-m-d',strtotime($row->DODEACTIVATED)):''); ?>" <?php echo e($row->DEACTIVATED ==1?'':'disabled'); ?> class="form-control w-100"  autocomplete="off" style="width:100%;" ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserBranchMapping\mstfrm204edit.blade.php ENDPATH**/ ?>