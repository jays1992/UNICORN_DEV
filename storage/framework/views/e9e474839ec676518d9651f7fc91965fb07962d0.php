             ...
             <div class="row">            
               ...
               <div class="col-lg-2 pl">
                 <select name="ASGID_REF" id="ASGID_REF" class="form-control mandatory" tabindex="4" disabled>
                   ...
                   <?php $__currentLoopData = $HDR; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <tr>   
                     ...
                     <tbody>
                       ...
                       <tr  class="participantRow">
                           ...
                           <td><input disabled class="form-control" type="text" name="SUBLCODE[]"   id =<?php echo e("SUBLCODE_0"); ?>  value="<?php echo e($HDRR->CATEGORY); ?>" autocomplete="off" style="width: 98%"></td>
                           <td><input disabled class="form-control" type="text" name="SUBLDES[]"   id =<?php echo e("SUBLDES_0"); ?>    value="<?php echo e($HDRR->DESCRIPTIONS); ?>" autocomplete="off" style="width: 98%"></td>
                           <td><select disabled name="INACTIVE[]" id =<?php echo e("INACTIVE_0"); ?> class="form-control mandatory" tabindex="4">
                             <option value="" selected >Select</option>
                           ...
                           <td>
                           <input disabled class="form-control" type="date" name="INACTIVEDATE[]" id =<?php echo e("INACTIVEDATE_0"); ?>  value="<?php echo e($HDRR->ACTIVEDATE); ?>" autocomplete="off">
                           <td align="center" >
...
$(function() { 
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetCategory\mstfrm407view.blade.php ENDPATH**/ ?>