...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Purchase Invoice Import (PII)</a>
                </div><!--col-2-->
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input type="text" name="PII_NO" id="PII_NO" value="<?php echo e($objHDR->PII_NO); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PII_DT" id="PII_DT" value="<?php echo e($objHDR->PII_DT); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor</p></div>
        <div class="col-lg-2 pl">
                <input type="text" name="txtvendor" id="txtvendor" class="form-control" value="<?php echo e($objPBVID->VCODE); ?>-<?php echo e($objPBVID->NAME); ?>" readonly  />
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" <?php echo e($objHDR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          <?php if(count($objsocurrency) > 0): ?>
          <input type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objsocurrency[0]); ?>" readonly   />
          <?php else: ?>
      ...
      <div class="col-lg-2 pl">
          <input type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e($objHDR->CONV_FACTOR); ?>" />
      </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="<?php echo e($objHDR->VENDOR_INVOICE_NO); ?>" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p>Vendor Invoice Date</p></div>
        <div class="col-lg-2 pl">
                <input type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="<?php echo e($objHDR->VENDOR_INVOICE_DT); ?>" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
        <div class="col-lg-2 pl"><p>Bill To </p></div>
        <div class="col-lg-2 pl" id="div_billto">
            <input type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly  />
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e($objShpAddress[0]); ?>"  readonly  />
        ...
        <div class="col-lg-6 pl">
            <input type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="<?php echo e($objHDR->REMARKS); ?>" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="BOE_NO" id="BOE_NO" value="<?php echo e($objHDR->BOE_NO); ?>" class="form-control" autocomplete="off" >
      </div>

      <div class="col-lg-2 pl"><p>BOE Date</p></div>
      <div class="col-lg-2 pl">
        <input type="date" name="BOE_DT" id="BOE_DT" value="<?php echo e($objHDR->BOE_DT); ?>" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" >
      </div>
	</div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<input type="text" name="REF_NO" id="REF_NO" value="<?php echo e($objHDR->REF_NO); ?>" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="Credit_days" id="Credit_days" value="<?php echo e($objHDR->CREDIT_DAYS); ?>" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="<?php echo e($objHDR->DUE_DATE); ?>"  placeholder="dd/mm/yyyy"  />                        
        </div>
        ...
        <div  class="col-lg-1 pl">
            <input type="checkbox" name="GST_Reverse" id="GST_Reverse"  <?php echo e($objHDR->REVERSE_GST == 1 ? 'checked' : ''); ?>    />                          
        </div>
    ...
    <div class="row">
        ...
        <div  class="col-lg-1 pl">
            <input type="checkbox" name="GST_N_Avail" id="GST_N_Avail"  <?php echo e($objHDR->GST_INPUT_NOT_AVAIL == 1 ? 'checked' : ''); ?>   />
        </div> 
    </div>
                  ...
                  <tr>
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      <?php $__currentLoopData = $objPBMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><input type="text" name="txtGRN_NO_<?php echo e($key); ?>" id="txtGRN_NO_<?php echo e($key); ?>" value="<?php echo e($row->GRN_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:120px;" /></td>
                        ...
                        <td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        ...
                        <td><input type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td><input type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off"  /></td>
                        
                        <td><input type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        ...
                        <td><input type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_MAIN_QTY); ?>"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly  /></td>
                        ...
                        <td><input type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" value="<?php echo e($row->AULT_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        ...
                        <td><input type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>"  class="form-control three-digits" maxlength="13" autocomplete="off"  readonly/></td>
                      
                        <td><input type="text" name="BILL_QTY_<?php echo e($key); ?>" id="BILL_QTY_<?php echo e($key); ?>" value="<?php echo e($row->BILL_QTY); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
                        <td><input type="text" name="UOM_OF_BILL_QTY_<?php echo e($key); ?>" id="UOM_OF_BILL_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->MAIN_UOM_CODE); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" readonly /></td>

                        <td><input type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_ASP_MU); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
                        <td><input type="text" name="DISC_PER_<?php echo e($key); ?>" id="DISC_PER_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;" /></td>
                        <td><input type="text" name="DISC_AMT_<?php echo e($key); ?>" id="DISC_AMT_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                        <td><input type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>"  class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                        
                        <td><input type="text" name="FREIGHT_AMT_<?php echo e($key); ?>"           id="FREIGHT_AMT_<?php echo e($key); ?>"            value="<?php echo e(intval($row->FREIGHT_AMT) > 0 ? $row->FREIGHT_AMT:'0.00'); ?>"      onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
                        <td><input type="text" name="INSURANCE_AMT_<?php echo e($key); ?>"         id="INSURANCE_AMT_<?php echo e($key); ?>"          value="<?php echo e(intval($row->INSURANCE_AMT) > 0 ? $row->INSURANCE_AMT:'0.00'); ?>"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
                        <td><input type="text" name="ASSESSABLE_VALUE_<?php echo e($key); ?>"      id="ASSESSABLE_VALUE_<?php echo e($key); ?>"       value="<?php echo e($row->ASSESSABLE_VALUE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>"  value="<?php echo e($row->CUSTOME_DUTY_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>"  value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="SWS_RATE_PER_<?php echo e($key); ?>"          id="SWS_RATE_PER_<?php echo e($key); ?>"           value="<?php echo e($row->SWS_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="SWS_RATE_AMT_<?php echo e($key); ?>"          id="SWS_RATE_AMT_<?php echo e($key); ?>"           value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"    id="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"     value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="TAXABLE_VALUE_<?php echo e($key); ?>"         id="TAXABLE_VALUE_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="IGST_RATE_PER_<?php echo e($key); ?>"         id="IGST_RATE_PER_<?php echo e($key); ?>"          value="<?php echo e($row->IGST); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="IGST_RATE_AMT_<?php echo e($key); ?>"         id="IGST_RATE_AMT_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input type="text" name="VALUE_AFTER_GST_<?php echo e($key); ?>"       id="VALUE_AFTER_GST_<?php echo e($key); ?>"        value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                ...
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                  ...
                  <?php if(!empty($objPBCAL)): ?>
                    <?php $__currentLoopData = $objPBCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      ?>        
                            <td><input type="text" name=<?php echo e("AMTIGST_".$Ckey); ?> id=<?php echo e("AMTIGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($IGSTAMT); ?>"  readonly/></td>
                      ...
                      ?>       
                            <td><input type="text" name=<?php echo e("AMTCGST_".$Ckey); ?> id=<?php echo e("AMTCGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($CGSTAMT); ?>" readonly/></td>
                      ...
                      ?>
                            <td><input type="text" name=<?php echo e("AMTSGST_".$Ckey); ?> id=<?php echo e("AMTSGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($SGSTAMT); ?>" readonly/></td>
                      <?php
                          $TOTGSTAMT=number_format(($IGSTAMT+$CGSTAMT+$SGSTAMT),2, '.', '');
                      ?>      
                            <td><input type="text" name=<?php echo e("TOTGSTAMT_".$Ckey); ?> id=<?php echo e("TOTGSTAMT_".$Ckey); ?> class="form-control two-digits"  maxlength="15" autocomplete="off" value="<?php echo e($TOTGSTAMT); ?>" readonly/></td>
                            <td style="text-align:center;"><input type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?>  <?php echo e($Crow->ACTUAL == 1 ? 'checked' : ''); ?> /></td>
                    ...
                    <?php if(!empty($objPBPSLB)): ?>
                      <?php $__currentLoopData = $objPBPSLB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pkey => $Prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow6">
                              ...
                              <td> <input type="text" class="form-control" id=<?php echo e("DUE_DATE_".$Pkey); ?> name=<?php echo e("DUE_DATE_".$Pkey); ?> value="<?php echo e($Prow->DUE_DATE); ?>" autocomplete="off"  /> </td>
                    ...
                    <?php if(!empty($objPBTDS)): ?>
                      <?php $__currentLoopData = $objPBTDS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tkey => $trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr  class="participantRow7">
                            ...
                            <input type="text" name=<?php echo e("txtTDS_".$tkey); ?> id=<?php echo e("txtTDS_".$tkey); ?> class="form-control" value="<?php echo e($trow->CODE); ?>" autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name=<?php echo e("TDSLedger_".$tkey); ?> id=<?php echo e("TDSLedger_".$tkey); ?> class="form-control" value="<?php echo e($trow->CODE_DESC); ?>" autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name=<?php echo e("ASSESSABLE_VL_TDS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_TDS_".$tkey); ?> class="form-control two-digits" value="<?php echo e($trow->ASSESSABLE_VL_TDS); ?>" maxlength="15"  autocomplete="off"  /></td>
                            <td><input type="text" name=<?php echo e("TDS_RATE_".$tkey); ?> id=<?php echo e("TDS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->TDS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input type="text" name=<?php echo e("TDS_AMT_".$tkey); ?> id=<?php echo e("TDS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15"  autocomplete="off"  value="<?php echo e($trow->TDS_AMT); ?>" readonly/></td>
                            <td><input type="text" name=<?php echo e("ASSESSABLE_VL_SURCHARGE_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_SURCHARGE_".$tkey); ?> class="form-control two-digits" value="<?php echo e($trow->ASSESSABLE_VL_SURCHARGE); ?>" maxlength="15"  autocomplete="off" /></td>
                            <td><input type="text" name=<?php echo e("SURCHARGE_RATE_".$tkey); ?> id=<?php echo e("SURCHARGE_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->SURCHARGE_RATE); ?>"  autocomplete="off"  /></td>
                            ...
                            <td><input type="text" name=<?php echo e("SURCHARGE_AMT_".$tkey); ?> id=<?php echo e("SURCHARGE_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->SURCHARGE_AMT); ?>" autocomplete="off"  readonly/></td>
                            <td><input type="text" name=<?php echo e("ASSESSABLE_VL_CESS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_CESS_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->ASSESSABLE_VL_CESS); ?>" autocomplete="off" /></td>
                            <td><input type="text" name=<?php echo e("CESS_RATE_".$tkey); ?> id=<?php echo e("CESS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->CESS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input type="text" name=<?php echo e("CESS_AMT_".$tkey); ?> id=<?php echo e("CESS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->CESS_AMT); ?>" autocomplete="off"  readonly/></td>
                            <td><input type="text" name=<?php echo e("ASSESSABLE_VL_SPCESS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_SPCESS_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->ASSESSABLE_VL_SPCESS); ?>"  autocomplete="off" /></td>
                            <td><input type="text" name=<?php echo e("SPCESS_RATE_".$tkey); ?> id=<?php echo e("SPCESS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->SPCESS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input type="text" name=<?php echo e("SPCESS_AMT_".$tkey); ?> id=<?php echo e("SPCESS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->SPCESS_AMT); ?>"  autocomplete="off"  readonly/></td>
                  <?php
                    $TotalTDS=number_format(($trow->TDS_AMT+$trow->SURCHARGE_AMT+$trow->CESS_AMT+$trow->SPCESS_AMT),2, '.', '');
                  ?>
                            <td><input type="text" name=<?php echo e("TOT_TD_AMT_".$tkey); ?> id=<?php echo e("TOT_TD_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($TotalTDS); ?>"  autocomplete="off"  readonly/></td>
                    ...
                    <?php if(!empty($objPBUDF)): ?>
                      <?php $__currentLoopData = $objPBUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input type="text" name=<?php echo e("popupUDFPBID_".$Ukey); ?> id=<?php echo e("popupUDFPBID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoiceImport - Copy\trnfrm300edit.blade.php ENDPATH**/ ?>