...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[269,'index'])); ?>" class="btn singlebt">Purchase Indent Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>PI NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="PIID[]" id="PIID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objPINo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dindex=>$DRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($DRow->PIID); ?>" selected><?php echo e($DRow->PI_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnView').on('click', function() {
        ...
        var PIID  = [];
        $("select[name='PIID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                PIID.push(value7);
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\Purchase_Indent_Register\rptfrm269.blade.php ENDPATH**/ ?>