...
<form id="frm_trn_add" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  <div class="container-fluid filter">
	  <div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="date" name="GE_DT" id="GE_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("GE_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('GE_DT')); ?>" class="form-control mandatory" autocomplete="off" >
        </div>
            ...
            <div class="row">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFGEJID); ?>" autocomplete="off"   /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkGateEntry\trnfrm356add.blade.php ENDPATH**/ ?>