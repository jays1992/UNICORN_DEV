<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->DESGID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->DESGCODE); ?> </label>
                    <input type="hidden" name="DESGID" id="DESGID" value="<?php echo e($objResponse->DESGID); ?>" />
                    <input type="hidden" name="DESGCODE" id="DESGCODE" value="<?php echo e($objResponse->DESGCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" class="form-control mandatory" value="<?php echo e(old('DESCRIPTIONS',$objResponse->DESCRIPTIONS)); ?>" maxlength="200" tabindex="1"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="PLID_REF_POPUP" id="PLID_REF_POPUP" readonly onkeypress="return AlphaNumaric(event,this)" value="<?php echo e(old('DESCRIPTIONS',$objResponse->PDESCRCRIPTIONS)); ?>" class="form-control mandatory" autocomplete="off" maxlength="120" tabindex="1" style="text-transform:uppercase" />
                        <input type="hidden" name="PLID_REF" id="PLID_REF"  value="<?php echo e(old('PLID_REF',$objResponse->PLID_REF)); ?>" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[171,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[171,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\DesignationMaster\mstfrm171edit.blade.php ENDPATH**/ ?>