...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[408,'index'])); ?>" class="btn singlebt">Quality Inspection Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_grn"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>GRN NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="GRNID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="GRNID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objGRNNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->GRNID); ?>" selected><?php echo e($GRow->GRN_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[408,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var GRNID  = [];
        $("select[name='GRNID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                GRNID.push(value7);
            }
        ...
        else if(GRNID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select NRGP NO.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[408,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\QualityInspection\rptfrm408.blade.php ENDPATH**/ ?>