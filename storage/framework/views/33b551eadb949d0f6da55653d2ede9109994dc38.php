<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[135,'index'])); ?>" class="btn singlebt">QC Parameter Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->QCPID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->QCP_CODE); ?> </label>
                    <input type="hidden" name="QCPID" id="QCPID" value="<?php echo e($objResponse->QCPID); ?>" />
                    <input type="hidden" name="QCP_CODE" id="QCP_CODE" value="<?php echo e($objResponse->QCP_CODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="QCP_DESC" id="QCP_DESC" class="form-control mandatory" value="<?php echo e(old('QCP_DESC',$objResponse->QCP_DESC)); ?>" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[135,"add"])); ?>';
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[135,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[135,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '<?php echo e(route("master",[135,"index"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\QCParameterMaster\mstfrm135edit.blade.php ENDPATH**/ ?>