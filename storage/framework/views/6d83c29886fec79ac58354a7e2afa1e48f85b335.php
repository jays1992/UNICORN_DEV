                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="SOSNO" id="SOSNO" value="<?php echo e(isset($objSOS->SOSNO)?$objSOS->SOSNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            </div>
                            <div class="col-lg-1 pl"><p>SOS Date</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SOSDT" id="SOSDT" value="<?php echo e(isset($objSOS->SOSDT)?$objSOS->SOSDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>  
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ScheduleOpenSalesOrder\trnfrm41view.blade.php ENDPATH**/ ?>