    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnSaveSE" ><i class="fa fa-edit"></i> Save</button>
...
<div class="inner-form">
  ...
  <div class="row">
    <div class="col-lg-1 pl"><p>AFPA No</p></div>
    <div class="col-lg-1 pl">
      <input type="text" name="AFSANO" id="AFSANO" value="<?php echo e($ANumber); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e($objSE->AFP_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly >
      <input type="hidden" name="AFSID_REF" id="AFSID_REF" value="<?php echo e($objSE->AFPID); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
    </div>    
    <div class="col-lg-1 pl col-md-offset-1"><p>AFPA Date</p></div>
    <div class="col-lg-2 pl">
          <input type="date" name="AFSADT" id="AFSADT"  onchange="checkPeriodClosing(220,this.value,1)" value="<?php echo e($objSE->AFP_DT); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
          </div>
    
 
    
    <div class="col-lg-2 pl"><p>Reason to amend AFP</p></div>
    <div class="col-lg-4 pl">
    
      <input type="text" name="REASON_AFSA" id="REASON_AFSA" value="" class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
              <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e($objSE->AFP_NO); ?>" class="form-control mandatory" disabled  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
           
    </div>
    
    <div class="col-lg-1 pl col-md-offset-1"><p>AFP Date</p></div>
    <div class="col-lg-2 pl">
          <input type="date" name="AFSDT" id="AFSDT" value="<?php echo e($objSE->AFP_DT); ?>" class="form-control mandatory " disabled placeholder="dd/mm/yyyy" >
          </div>
    
    <div class="col-lg-1 pl"><p> Department	</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="DEPTID_NAME" id="DEPTID_NAME" value="<?php echo e($objSE->NAME); ?>"  class="form-control mandatory" disabled autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="DEPID_REF" id="DEPID_REF" value="<?php echo e($objSE->DEPID_REF); ?>" class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
    
    <div class="col-lg-1 pl"><p>Financial Year</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="FYID_NAME" id="FYID_NAME" value="<?php echo e($objSE->FYDESCRIPTION); ?>" disabled class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="FYID_REF" id="FYID_REF" value="<?php echo e($objSE->FYID_REF); ?>" class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
  </div>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="tab-content">
                         ...
                         <td hidden> <input type="text" name=<?php echo e("REF_BUID_".$key); ?> id=<?php echo e("REF_BUID_".$key); ?> value="<?php echo e($row->BUID_REF); ?>" /></td>
                                ...
                                <input type="text" name=<?php echo e("CID_REF_".$key); ?> id=<?php echo e("CID_REF_".$key); ?>  class="form-control mandatory" value="<?php echo e($row->CID_REF); ?>" style="width:91px" readonly tabindex="1" />                       
                                                            </td>
  ...
  <td hidden><input type="text" name=<?php echo e("itemuom_".$key); ?> id=<?php echo e("itemuom_".$key); ?>   class="form-control"  autocomplete="off" value="<?php echo e($row->UOMID_REF); ?>" readonly/></td>
  <td><input type="text" name=<?php echo e("itemmain_uom".$key); ?> id=<?php echo e("itemmain_uom".$key); ?> value="<?php echo e($row->UOMCODE); ?> - <?php echo e($row->DESCRIPTIONS); ?>" class="form-control"  autocomplete="off"  readonly/></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH1_OP_".$key); ?> id=<?php echo e("MONTH1_OP_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_OP); ?>" readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_SL_".$key); ?> id=<?php echo e("MONTH1_SL_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_SL); ?>" readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_PR_".$key); ?> id=<?php echo e("MONTH1_PR_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_PR); ?>" readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_AP_".$key); ?> id=<?php echo e("MONTH1_AP_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_AP); ?>"          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_TP_".$key); ?> id=<?php echo e("MONTH1_TP_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_TP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_IV_".$key); ?> id=<?php echo e("MONTH1_IV_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_IV); ?>" readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_ND_".$key); ?> id=<?php echo e("MONTH1_ND_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_ND); ?>" readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_RT_".$key); ?> id=<?php echo e("MONTH1_RT_".$key); ?> class="form-control five-digits"  value="<?php echo e($row->MONTH1_RT); ?>"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH1_PV_".$key); ?> id=<?php echo e("MONTH1_PV_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                            
  
  <td><input type="text" name=<?php echo e("MONTH2_OP_".$key); ?>  id=<?php echo e("MONTH2_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH2_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_SL_".$key); ?>  id=<?php echo e("MONTH2_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH2_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_PR_".$key); ?>  id=<?php echo e("MONTH2_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH2_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_AP_".$key); ?>  id=<?php echo e("MONTH2_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_TP_".$key); ?>  id=<?php echo e("MONTH2_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_IV_".$key); ?>  id=<?php echo e("MONTH2_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_ND_".$key); ?>  id=<?php echo e("MONTH2_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_RT_".$key); ?>  id=<?php echo e("MONTH2_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH2_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH2_PV_".$key); ?>  id=<?php echo e("MONTH2_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                   
  <td><input type="text" name=<?php echo e("MONTH3_OP_".$key); ?>  id=<?php echo e("MONTH3_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH3_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_SL_".$key); ?>  id=<?php echo e("MONTH3_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH3_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_PR_".$key); ?>  id=<?php echo e("MONTH3_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH3_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_AP_".$key); ?>  id=<?php echo e("MONTH3_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_TP_".$key); ?>  id=<?php echo e("MONTH3_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_IV_".$key); ?>  id=<?php echo e("MONTH3_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_ND_".$key); ?>  id=<?php echo e("MONTH3_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_RT_".$key); ?>  id=<?php echo e("MONTH3_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH3_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH3_PV_".$key); ?>  id=<?php echo e("MONTH3_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                
  <td><input type="text" name=<?php echo e("MONTH4_OP_".$key); ?>  id=<?php echo e("MONTH4_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH4_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_SL_".$key); ?>  id=<?php echo e("MONTH4_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH4_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_PR_".$key); ?>  id=<?php echo e("MONTH4_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH4_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_AP_".$key); ?>  id=<?php echo e("MONTH4_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_TP_".$key); ?>  id=<?php echo e("MONTH4_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_IV_".$key); ?>  id=<?php echo e("MONTH4_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_ND_".$key); ?>  id=<?php echo e("MONTH4_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_RT_".$key); ?>  id=<?php echo e("MONTH4_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH4_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH4_PV_".$key); ?>  id=<?php echo e("MONTH4_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
                                                      
  <td><input type="text" name=<?php echo e("MONTH5_OP_".$key); ?>  id=<?php echo e("MONTH5_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH5_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_SL_".$key); ?>  id=<?php echo e("MONTH5_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH5_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_PR_".$key); ?>  id=<?php echo e("MONTH5_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH5_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_AP_".$key); ?>  id=<?php echo e("MONTH5_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_TP_".$key); ?>  id=<?php echo e("MONTH5_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_IV_".$key); ?>  id=<?php echo e("MONTH5_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_ND_".$key); ?>  id=<?php echo e("MONTH5_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_RT_".$key); ?>  id=<?php echo e("MONTH5_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH5_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH5_PV_".$key); ?>  id=<?php echo e("MONTH5_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    
  <td><input type="text" name=<?php echo e("MONTH6_OP_".$key); ?>  id=<?php echo e("MONTH6_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH6_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_SL_".$key); ?>  id=<?php echo e("MONTH6_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH6_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_PR_".$key); ?>  id=<?php echo e("MONTH6_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH6_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_AP_".$key); ?>  id=<?php echo e("MONTH6_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_TP_".$key); ?>  id=<?php echo e("MONTH6_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_IV_".$key); ?>  id=<?php echo e("MONTH6_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_ND_".$key); ?>  id=<?php echo e("MONTH6_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_RT_".$key); ?>  id=<?php echo e("MONTH6_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH6_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH6_PV_".$key); ?>  id=<?php echo e("MONTH6_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    

  <td><input type="text" name=<?php echo e("MONTH7_OP_".$key); ?>  id=<?php echo e("MONTH7_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH7_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_SL_".$key); ?>  id=<?php echo e("MONTH7_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH7_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_PR_".$key); ?>  id=<?php echo e("MONTH7_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH7_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_AP_".$key); ?>  id=<?php echo e("MONTH7_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_TP_".$key); ?>  id=<?php echo e("MONTH7_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_IV_".$key); ?>  id=<?php echo e("MONTH7_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_ND_".$key); ?>  id=<?php echo e("MONTH7_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_RT_".$key); ?>  id=<?php echo e("MONTH7_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH7_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH7_PV_".$key); ?>  id=<?php echo e("MONTH7_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    

  <td><input type="text" name=<?php echo e("MONTH8_OP_".$key); ?>  id=<?php echo e("MONTH8_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH8_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_SL_".$key); ?>  id=<?php echo e("MONTH8_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH8_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_PR_".$key); ?>  id=<?php echo e("MONTH8_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH8_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_AP_".$key); ?>  id=<?php echo e("MONTH8_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_TP_".$key); ?>  id=<?php echo e("MONTH8_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_IV_".$key); ?>  id=<?php echo e("MONTH8_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_ND_".$key); ?>  id=<?php echo e("MONTH8_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_RT_".$key); ?>  id=<?php echo e("MONTH8_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH8_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH8_PV_".$key); ?>  id=<?php echo e("MONTH8_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    

  <td><input type="text" name=<?php echo e("MONTH9_OP_".$key); ?>  id=<?php echo e("MONTH9_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH9_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_SL_".$key); ?>  id=<?php echo e("MONTH9_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH9_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_PR_".$key); ?>  id=<?php echo e("MONTH9_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH9_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_AP_".$key); ?>  id=<?php echo e("MONTH9_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_TP_".$key); ?>  id=<?php echo e("MONTH9_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_IV_".$key); ?>  id=<?php echo e("MONTH9_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_ND_".$key); ?>  id=<?php echo e("MONTH9_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_RT_".$key); ?>  id=<?php echo e("MONTH9_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH9_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_PV_".$key); ?>  id=<?php echo e("MONTH9_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    
  <td><input type="text" name=<?php echo e("MONTH10_OP_".$key); ?>  id=<?php echo e("MONTH10_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH10_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_SL_".$key); ?>  id=<?php echo e("MONTH10_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH10_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_PR_".$key); ?>  id=<?php echo e("MONTH10_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH10_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_AP_".$key); ?>  id=<?php echo e("MONTH10_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_TP_".$key); ?>  id=<?php echo e("MONTH10_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_IV_".$key); ?>  id=<?php echo e("MONTH10_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_ND_".$key); ?>  id=<?php echo e("MONTH10_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_RT_".$key); ?>  id=<?php echo e("MONTH10_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH10_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH10_PV_".$key); ?>  id=<?php echo e("MONTH10_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    
  <td><input type="text" name=<?php echo e("MONTH11_OP_".$key); ?>  id=<?php echo e("MONTH11_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH11_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_SL_".$key); ?>  id=<?php echo e("MONTH11_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH11_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_PR_".$key); ?>  id=<?php echo e("MONTH11_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH11_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_AP_".$key); ?>  id=<?php echo e("MONTH11_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_TP_".$key); ?>  id=<?php echo e("MONTH11_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_IV_".$key); ?>  id=<?php echo e("MONTH11_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_ND_".$key); ?>  id=<?php echo e("MONTH11_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_RT_".$key); ?>  id=<?php echo e("MONTH11_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH11_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH11_PV_".$key); ?>  id=<?php echo e("MONTH11_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
    
  <td><input type="text" name=<?php echo e("MONTH12_OP_".$key); ?>  id=<?php echo e("MONTH12_OP_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH12_OP); ?>"  readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_SL_".$key); ?>  id=<?php echo e("MONTH12_SL_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH12_SL); ?>"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_PR_".$key); ?>  id=<?php echo e("MONTH12_PR_".$key); ?>  class="form-control three-digits" value="<?php echo e($row->MONTH12_PR); ?>"    readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_AP_".$key); ?>  id=<?php echo e("MONTH12_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_AP); ?>"                             maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_TP_".$key); ?>  id=<?php echo e("MONTH12_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_TP); ?>"      readonly  style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_IV_".$key); ?>  id=<?php echo e("MONTH12_IV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_IV); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_ND_".$key); ?>  id=<?php echo e("MONTH12_ND_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_ND); ?>"  readonly   style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_RT_".$key); ?>  id=<?php echo e("MONTH12_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH12_RT); ?>"    maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH12_PV_".$key); ?>  id=<?php echo e("MONTH12_PV_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_PV); ?>"  readonly      maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
...
<div id="ITEMIDpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <td>
    <input type="text" id="Itempartsearch" onkeyup="ItemPartnoFunction()">
    </td>
    <td>
  ...
  $('#Material').on('focus','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[220,"getAltUOM"])); ?>',
                      type:'POST',
                      data:{'id':ItemID},
                      success:function(data) {
      ...
      $(".clsaltuom").dblclick(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[220,"getaltuomqty"])); ?>',
                      type:'POST',
...
$(document).ready(function() {
  ...
  $('#AFSADT').attr("min",today);
  $('#AFSADT').attr("max",today);
  $('#AFSADT').val(today);
...
function validateForm(){
       $("#FocusId").val('');
        var AFSNO          =   $.trim($("#AFSANO").val());
        var AFSDT          =   $.trim($("#AFSADT").val());
        var DEPID_REF          =   $.trim($("#DEPID_REF").val());
        var FYID_REF          =   $.trim($("#FYID_REF").val());
        var REASONAFSA          =   $.trim($("#REASON_AFSA").val());
        ...
        if(AFSNO ===""){
            ...
            $("#NoBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please enter value in AFPA Number.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            $("#NoBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please select AFPA Date.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }  
        else if(REASONAFSA ===""){
            $("#FocusId").val($("#REASONAFSA"));
            $("#AFSDT").val();  
            $("#ProceedBtn").focus();
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please enter data for Reason to amend AFP.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }  
        ...
        if(jQuery.inArray("false", allblank) !== -1){
          ...
          else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#AFSDT").val(),0) ==0){
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[220,"saveamendment"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $(".buttonload").hide(); 
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[220,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\AnnualForecastPurchase\trnfrm220amendment.blade.php ENDPATH**/ ?>