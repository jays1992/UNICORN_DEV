         ...
         <form id="frm_mst_state" method="POST"  > 
          ...
          <div class="inner-form">
				...
				<div class="row">
					...
					<div class="col-lg-1 pl">
						<select name="CTRYID_REF" id="CTRYID_REF" class="form-control mandatory" onchange="getCountryName(this.value)" tabindex="1"  >
							...
							<option value="<?php echo e($countryList->CTRYID); ?>"><?php echo e($countryList->CTRYCODE.' - '.$countryList->NAME); ?></option>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                    <input type="text" name="STCODE" id="STCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Common/State/mstfrm3add.blade.php ENDPATH**/ ?>