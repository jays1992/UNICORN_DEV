...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[244,'index'])); ?>" class="btn singlebt">Sales Enquiry Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="SGLID[]" id="SGLID" class="form-control selectpicker" data-hide-disabled="hide"
                                                            multiple data-actions-box="true" multiple data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl" id="div_sperson">
                                <select name="EMPID[]" id="EMPID" class="form-control selectpicker" data-hide-disabled="hide" multiple data-actions-box="true" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSalesPerson; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pindex=>$PRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($PRow->EMPID); ?>" selected><?php echo e($PRow->FNAME); ?> <?php echo e($PRow->LNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="ITEMGID[]" id="ITEMGID" class="form-control selectpicker" data-hide-disabled="hide"
                                                            multiple data-actions-box="true" multiple data-live-search="true"  >
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <option value="Date" selected>Sales Enquiry Date</option>
                                    <option value="Customer" >Customer Name</option>
                                    <option value="SalesPersons" >Sales Person</option>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="Quantity" id="Quantity" class="form-control selectpicker" multiple data-live-search="true"  >
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[244,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[244,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesEnquiryRpt\rptfrm244.blade.php ENDPATH**/ ?>