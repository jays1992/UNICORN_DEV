  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->ST_ADJUSTID); ?>" value="<?php echo e($val->ST_ADJUSTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->ST_ADJUST_DOCDT) && $val->ST_ADJUST_DOCDT !='' && $val->ST_ADJUST_DOCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ST_ADJUST_DOCDT)):''); ?>" ></td>
                <td><?php echo e(isset($val->ST_ADJUST_DOCNO) && $val->ST_ADJUST_DOCNO !=''?$val->ST_ADJUST_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->ST_ADJUST_DOCDT) && $val->ST_ADJUST_DOCDT !='' && $val->ST_ADJUST_DOCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ST_ADJUST_DOCDT)):''); ?></td>
                <td><?php echo e(isset($val->ST_ADJUST_TYPE) && $val->ST_ADJUST_TYPE !=''?$val->ST_ADJUST_TYPE:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:60%; height:60%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" id='ReportViewclosePopup' >&times;</button>          
      </div>
    <div class="modal-body">
	  <div class="tablename"><p>Stock Adjustment Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      {
            var ITEMID = soIdsData[0];
            var Flag = 'P';
            var formData = 'SO='+ ITEMID + '&ST_ADJUSTID='+ ITEMID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/inventory/StockAdjustment/trnfrm234.blade.php ENDPATH**/ ?>