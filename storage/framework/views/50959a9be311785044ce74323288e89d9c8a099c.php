...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Machine Wise Item Info</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tbody> 
              ...
              ?>
              <tr>
                  <td><input type="checkbox" id="chkId<?php echo e($val->MWITEMID); ?>" value="<?php echo e($val->MWITEMID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("master",[220,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
                            window.location.href=editURL;
                      }else if(is_approve==2){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\MachineWiseItemInfo\mstfrm238.blade.php ENDPATH**/ ?>