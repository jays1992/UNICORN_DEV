...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Commercial Invoice</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->CINV_ID); ?>" value="<?php echo e($val->CINV_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->CINV_DT) && $val->CINV_DT !='' && $val->CINV_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->CINV_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->CINV_NO) && $val->CINV_NO !=''?$val->CINV_NO:''); ?></td>
              <td><?php echo e(isset($val->CINV_DT) && $val->CINV_DT !='' && $val->CINV_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->CINV_DT)):''); ?></td>
              <td><?php echo e(isset($val->CINV_STATUS) && $val->CINV_STATUS !=''?$val->CINV_STATUS:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\CommercialInvoice\trnfrm489.blade.php ENDPATH**/ ?>