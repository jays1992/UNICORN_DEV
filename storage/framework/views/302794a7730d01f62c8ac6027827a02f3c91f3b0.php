...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                    <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">Customer Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="Customers[]" data-hide-disabled="hide" multiple data-actions-box="true" id="Customers" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjCustomer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cRow->CID); ?>" selected><?php echo e($cRow->CCODE); ?>-<?php echo e($cRow->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
$(document).ready(function(e) {
    ...
    $('#btnView').on('click', function() {
        ...
        var Customers = [];
        $("select[name='Customers[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                Customers.push(value3);
            }
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\CustomerReport\rptfrm552.blade.php ENDPATH**/ ?>