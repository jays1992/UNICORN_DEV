...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->NRGPID); ?>" value="<?php echo e($val->NRGPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->NRGP_DT) && $val->NRGP_DT !='' && $val->NRGP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->NRGP_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->NRGP_NO) && $val->NRGP_NO !=''?$val->NRGP_NO:''); ?></td>
                <td><?php echo e(isset($val->NRGP_DT) && $val->NRGP_DT !='' && $val->NRGP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->NRGP_DT)):''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Non Returnable Gate Pass Print</p></div>
        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\NonReturnableGatePass\trnfrm91.blade.php ENDPATH**/ ?>