...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
      ...
      <input type="hidden" name="ASFDT" id="ASFDT" class="form-control" autocomplete="off" />
            ...
            <input type="date" name="AFSDT" id="AFSDT" onchange='checkPeriodClosing(168,this.value,1),getDocNoByEvent("AFSNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('AFSDT')); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[168,'add'])); ?>";
}//fnUndoYes
...
$(".buttonload").show(); 
$.ajax({
    url:'<?php echo e(route("transaction",[168,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\AnnualForecastSales\trnfrm168add.blade.php ENDPATH**/ ?>