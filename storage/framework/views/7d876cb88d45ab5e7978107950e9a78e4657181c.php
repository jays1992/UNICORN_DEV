  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->JWCID); ?>" value="<?php echo e($val->JWCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->JWCDT) && $val->JWCDT !='' && $val->JWCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWCDT)):''); ?>" ></td>
          <td><?php echo e(isset($val->JWCNO) && $val->JWCNO !=''?$val->JWCNO:''); ?></td>
          <td><?php echo e(isset($val->JWCDT) && $val->JWCDT !='' && $val->JWCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWCDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkChallan\trnfrm355.blade.php ENDPATH**/ ?>