                ...
                <div class="inner-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                            <div class="col-lg-12 pl">
                                <input type="text" name="CTCODE" id="txtctcode" value="<?php echo e($objCalculation->CTCODE); ?>"  tabindex="1" class="form-control "    readonly style="text-transform:uppercase"  >
                            </div>
                        </div>

                        <div class="col-lg-2 pl"><p>Module</p></div>
                        <div class="col-lg-2 pl">
                            <input type="text" name="MODULE_Details" id="MODULE_Details" value="<?php echo e(isset($objCalculation->MODULE_NAME)?$objCalculation->MODULE_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                            <input type="hidden" name="MODULE" id="MODULE" value="<?php echo e(isset($objCalculation->MODULEID_REF)?$objCalculation->MODULEID_REF:''); ?>" class="form-control" autocomplete="off" />
                        ...
                        <div class="col-lg-2 pl">
                            <select name="TYPE" id="TYPE" class="form-control"  autocomplete="off" >
                              <option <?php echo e(isset($objCalculation->TYPE) && $objCalculation->TYPE ==='OTHER'?'selected="selected"':''); ?> value='OTHER'>OTHER</option>
                              <option <?php echo e(isset($objCalculation->TYPE) && $objCalculation->TYPE ==='DISCOUNT'?'selected="selected"':''); ?> value='DISCOUNT'>DISCOUNT</option>
                            </select>
                            <span class="text-danger" id="ERROR_MODULE"></span> 
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 pl">
                            <input type="text" name="CTDESCRIPTION" id="txtctdesc" value="<?php echo e($objCalculation->CTDESCRIPTION); ?>" autocomplete="off" tabindex="2" class="form-control"  maxlength="200"     >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                            <input type="checkbox" name="DEACTIVATED" id="deactive"  tabindex="3" <?php echo e($objCalculation->DEACTIVATED == 1 ? 'checked' : ''); ?> >
                        </div>
                        
                        <div class="col-lg-2 pl col-md-offset-1"><p>Date of De-Activated</p></div>
                        <div class="col-lg-2 pl">
                        <div class="col-lg-8 pl">
                        <input type="date" name="DODEACTIVATED" id="decativateddate" value="<?php echo e($objCalculation->DODEACTIVATED); ?>" tabindex="4"  class="form-control datepicker" placeholder="dd/mm/yyyy" disabled>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist dataTable" style="height:auto !important;">
                            <thead id="thead1"   style="position: sticky;top: 0; white-space:none;">
                                <tr>
                                    <th style="vertical-align:middle; font-family: 'Roboto',sans-serif; font-size:11px; font-weight: 600;">Calculation Component Name <input class="form-control" type="hidden" name="Row_Count" id ="Row_Count" value="<?php echo e($objCount); ?>">  </th>
                                ...
                                <?php if(!empty($objCalculationtemp)): ?>
                                    <?php $__currentLoopData = $objCalculationtemp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr  class="participantRow">
                                            <td hidden>
                                            <input  class="form-control" type="hidden" name=<?php echo e("TID_".$key); ?> id =<?php echo e("txtID_".$key); ?> maxlength="100" value="<?php echo e($row->TID); ?>" autocomplete="off"   >
                                            </td>
                                            <td style="width:10%;"><input  class="form-control" type="text" name=<?php echo e("COMPONENT_".$key); ?> id=<?php echo e("txtcmpt_".$key); ?> maxlength="200"  value="<?php echo e($row->COMPONENT); ?>" style="text-transform:uppercase" autocomplete="off" ></td>
                                            <td style="width:1%;"><input  class="form-control" type="text" name=<?php echo e("SQNO_".$key); ?> id=<?php echo e("txtsqno_".$key); ?> maxlength="4"  value="<?php echo e($row->SQNO); ?>" readonly  ></td>
                                            <td style="width:15%;">
                                            <input name=<?php echo e("BASIS_popup_".$key); ?> id=<?php echo e("txtbasis_popup_".$key); ?> class="form-control selvt" autocomplete="off" readonly/>
                                            </td>
                                            <td style="width:15%;" hidden>
                                            <input type="hidden" name=<?php echo e("BASIS_".$key); ?> id=<?php echo e("hdnbasis_popup_".$key); ?> class="form-control" autocomplete="off" />
                                            </td>
                                            <td style="width:15%;">
                                            <input type="text" name=<?php echo e("GLID_popup_".$key); ?> id=<?php echo e("txtgl_popup_".$key); ?> class="form-control"  autocomplete="off"readonly/>
                                            </td>
                                            <td style="width:15%;" hidden>
                                            <input type="hidden" name=<?php echo e("GLID_REF_".$key); ?> id=<?php echo e("hdngl_popup_".$key); ?> class="form-control" autocomplete="off" />
                                            </td>   
                                            <td  style="text-align:center;" ><input type="checkbox" name=<?php echo e("FORMULAYESNO_".$key); ?> id=<?php echo e("chkfrm_".$key); ?> <?php echo e($row->FORMULAYESNO == 1 ? 'checked' : ''); ?>   style="float: revert;"  ></td>
                                            <td><input  class="form-control four-digits" type="text" name=<?php echo e("RATEPERCENTATE_".$key); ?> id=<?php echo e("txtprct_".$key); ?> maxlength="9" value="<?php echo e($row->RATEPERCENTATE); ?>" autocomplete="off" style="text-align: right;"></td>
                                            <td style="width:15%;"><input  class="form-control" type="text" name=<?php echo e("FORMULA_".$key); ?> id=<?php echo e("txtfrm_".$key); ?> maxlength="200" value="<?php echo e($row->FORMULA); ?>" autocomplete="off" disabled="disabled" ></td>
                                            <td style="width:10%;"><input  class="form-control two-digits" type="text" name=<?php echo e("AMOUNT_".$key); ?> id=<?php echo e("txtamt_".$key); ?> value="<?php echo e($row->AMOUNT); ?>" autocomplete="off" style="text-align: right;"  ></td>
                                            <td style="text-align:center;" ><input type="checkbox" name=<?php echo e("GST_".$key); ?> id=<?php echo e("chkgst_".$key); ?>   style="float: revert;"  <?php echo e($row->GST == 1 ? 'checked' : ''); ?>></td>
                                            <td style="text-align:center;" ><input type="checkbox" name=<?php echo e("ACTUAL_".$key); ?> id=<?php echo e("chkact_".$key); ?>    style="float: revert;"  <?php echo e($row->ACTUAL == 1 ? 'checked' : ''); ?>></td>
                                            <td style="text-align:center;" ><input type="checkbox" name=<?php echo e("LANDEDCOST_".$key); ?> id=<?php echo e("chklndc_".$key); ?>    style="float: revert;"  <?php echo e($row->LANDEDCOST == 1 ? 'checked' : ''); ?>></td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tr>
      ...
      <table id="example23" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_GLID_REF[]"  id="glidcode_<?php echo e($index); ?>" class="clsglid" value="<?php echo e($index); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($glRow-> GLCODE); ?>

          <input type="hidden" id="txtglidcode_<?php echo e($index); ?>" data-desc="<?php echo e($glRow-> GLCODE); ?>"  value="<?php echo e($glRow->GLID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($glRow-> GLNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[1,"add"])); ?>';
...
window.fnSaveData = function (){
            ...
            event.preventDefault();
                            ...
                            $.ajax({
                                url:'<?php echo e(route("mastermodify",[1,"update"])); ?>',
                                type:'POST',
                                data:formData,
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[1,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn1").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("master",[1,"index"])); ?>';
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\CalculationTemplate\mstfrm1edit.blade.php ENDPATH**/ ?>