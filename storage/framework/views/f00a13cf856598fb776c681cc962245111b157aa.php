	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="MRS_NO" id="MRS_NO" value="<?php echo e(isset($objResponse->MRS_NO) && $objResponse->MRS_NO !=''?$objResponse->MRS_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MRS_DT" id="MRS_DT" value="<?php echo e(isset($objResponse->MRS_DT) && $objResponse->MRS_DT !=''?$objResponse->MRS_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
...
$('#btnPdf').on('click', function() {
  ...
  var consultURL = '<?php echo e(route("transaction",[88,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[88,"ViewReport"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialRequisitionSlip\trnfrm88view.blade.php ENDPATH**/ ?>