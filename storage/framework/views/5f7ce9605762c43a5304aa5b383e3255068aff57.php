...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('report',[286,'index'])); ?>" class="btn singlebt">Purchase Invoice Print</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pop"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">
                            <div class="col-lg-3 pl"><p>Purchase Invoice Number</p></div>
                            <div class="col-lg-3 pl">
                                <select name="PB_DOCNO" id="PB_DOCNO" class="form-control mandatory">
                                    <option value="">select</option>
                                    <?php $__currentLoopData = $ObjPI; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->PBID); ?>" ><?php echo e($Row->PB_DOCNO); ?></option>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[286,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        if(PB_DOCNO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Purchase Invoice.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'<?php echo e(route("report",[286,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\PurchaseInvoicePrint\rptfrm286.blade.php ENDPATH**/ ?>