      ...
      <div class="tab-content">
        ...
        <div id="Account" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="txtbnkcsh" id="txtbnkcsh" class="form-control" value="<?php echo e(isset($objRCPTCASHBANK->BCODE)?$objRCPTCASHBANK->BCODE:''); ?> <?php echo e(isset($objRCPTCASHBANK->NAME)?'-'.$objRCPTCASHBANK->NAME:''); ?>" readonly  />
                ...
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="text" name="BANK_AMOUNT" id="BANK_AMOUNT" value="<?php echo e(isset($objRCPTHDR->BANK_AMOUNT)?$objRCPTHDR->BANK_AMOUNT:''); ?>" class="form-control"  readonly autocomplete="off"  />
                </div>
        ...
        <?php $__currentLoopData = $objBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bkRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr >
              ...
              <td style="width:20%;"><?php echo e($bkRow-> BCODE); ?>
                ...
                <input type="hidden" id="txtbkidcode_<?php echo e($index); ?>" data-desc="<?php echo e($bkRow-> BCODE); ?>" data-desc2="<?php echo e($bkRow-> NAME); ?>"  data-glid_ref="<?php echo e($bkRow->GLID_REF); ?>"  data-desc3="<?php echo e($bkRow-> BANK_CASH); ?>" value="<?php echo e($bkRow-> BID); ?>"/>
              </td>
         ...
         <?php $__currentLoopData = $objBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bkRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr >
               ...
               <td style="width:20%;"><?php echo e($bkRow-> BCODE); ?>
                ...
                <input type="hidden" id="txtbkidcode2_<?php echo e($index); ?>" data-desc="<?php echo e($bkRow-> BCODE); ?>"  data-glid_ref="<?php echo e($bkRow->GLID_REF); ?>" data-desc2="<?php echo e($bkRow-> NAME); ?>"  value="<?php echo e($bkRow-> BID); ?>"/>
               </td>
               <td style="width:20%;"><?php echo e($bkRow-> NAME); ?></td>
               <td style="width:10%;"><?php echo e($bkRow-> BRANCH); ?></td>
               <td style="width:10%;"><?php echo e($bkRow-> IFSC); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/ReceiptEntry/trnfrm302view.blade.php ENDPATH**/ ?>