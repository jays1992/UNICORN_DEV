...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Knock Off</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->KNOWOFFID); ?>" value="<?php echo e($val->KNOWOFFID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->KNOCKOFF_NO) && $val->KNOCKOFF_NO !=''?$val->KNOCKOFF_NO:''); ?></td>
                <td><?php echo e(isset($val->KNOCKOFF_DT) && $val->KNOCKOFF_DT !='' && $val->KNOCKOFF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->KNOCKOFF_DT)):''); ?></td>
                <td><?php echo e(isset($val->VENDOR_CUSTOMER) && $val->VENDOR_CUSTOMER !=''?$val->VENDOR_CUSTOMER:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/inventory/KnowkOff/trnfrm313.blade.php ENDPATH**/ ?>