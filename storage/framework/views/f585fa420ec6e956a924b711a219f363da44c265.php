...
$(document).ready(function(e) {
  ...
  $('#btnAdd').on('click', function() {
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[94,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[94,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
$('#example2').on("change",'[id*="decativateddate"]', function( event ) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[94,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\Terms&ConditionTemplate\mstfrm94add.blade.php ENDPATH**/ ?>