...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Stock To Stock Transafer</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="ST_ST_DOCNO" id="ST_ST_DOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="ST_ST_DOCDT" id="ST_ST_DOCDT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("ST_ST_DOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('ST_ST_DOCDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                ...
                <tr>
                    ...
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Alpspartno_0" id="Alpspartno_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Custpartno_0" id="Custpartno_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="OEMpartno_0"  id="OEMpartno_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
                    ...
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Alpspartno_IN_0" id="Alpspartno_IN_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Custpartno_IN_0" id="Custpartno_IN_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
                    <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="OEMpartno_IN_0"  id="OEMpartno_IN_0" class="form-control"  autocomplete="off"  readonly style="width:150px;" /></td>
...
function validateForm(){
  ...
  if(ST_ST_DOCNO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#ST_ST_DOCDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockToStockTransafer\trnfrm378add.blade.php ENDPATH**/ ?>