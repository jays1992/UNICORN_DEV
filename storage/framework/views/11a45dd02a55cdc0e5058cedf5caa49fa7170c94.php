<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->MTID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->MTCODE); ?> </label>
                    <input type="hidden" name="MTID" id="MTID" value="<?php echo e($objResponse->MTID); ?>" />
                    <input type="hidden" name="MTCODE" id="MTCODE" value="<?php echo e($objResponse->MTCODE); ?>" autocomplete="off"  maxlength="2"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    <input type="text" name="MTDESCRIPTION" id="MTDESCRIPTION" class="form-control mandatory" value="<?php echo e(old('MTDESCRIPTION',$objResponse->MTDESCRIPTION)); ?>" maxlength="30" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[121,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[121,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\MonthMaster\mstfrm121edit.blade.php ENDPATH**/ ?>