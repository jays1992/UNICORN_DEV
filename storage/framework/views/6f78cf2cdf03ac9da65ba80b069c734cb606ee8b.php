...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[323,'index'])); ?>" class="btn singlebt">Goods Receipt Note Against Returnable Gate Pass</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="GRN_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="GRN_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjGRN; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vindex=>$vRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($vRow->GRN_NO); ?>" selected><?php echo e($vRow->GRN_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>  
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[323,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var GRN_NO = [];
        $("select[name='GRN_NO[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                GRN_NO.push(value3);
            }
        ...
        else if(GRN_NO  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[323,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\GRNRGP\rptfrm323.blade.php ENDPATH**/ ?>