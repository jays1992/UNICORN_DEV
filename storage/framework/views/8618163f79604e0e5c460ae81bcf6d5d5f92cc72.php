...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Annual Forecast Sales(AFS)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th width="15%">AFS No</th>
                        <th width="15%">AFS Date</th>
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->AFSID); ?>" value="<?php echo e($val->AFSID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->AFSDT) && $val->AFSDT !=''?$val->AFSDT:''); ?>" ></td>
                <td><?php echo e(isset($val->AFSNO) && $val->AFSNO !=''?$val->AFSNO:''); ?></td>
                <td><?php echo e(isset($val->AFSDT) && $val->AFSDT !=''?$val->AFSDT:''); ?></td>
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("transaction",[168,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\AnnualForecastSales\trnfrm168.blade.php ENDPATH**/ ?>