  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>	
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->QIPID); ?>" value="<?php echo e($val->QIPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->QIPDT) && $val->QIPDT !='' && $val->QIPDT !='1900-01-01' ? date('d-m-Y',strtotime($val->QIPDT)):''); ?>" ></td>
          <td><?php echo e(isset($val->QIPNO) && $val->QIPNO !=''?$val->QIPNO:''); ?></td>
          <td><?php echo e(isset($val->QIPDT) && $val->QIPDT !='' && $val->QIPDT !='1900-01-01' ? date('d-m-Y',strtotime($val->QIPDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Quality\QualityInspectionAgainstPro\trnfrm389.blade.php ENDPATH**/ ?>