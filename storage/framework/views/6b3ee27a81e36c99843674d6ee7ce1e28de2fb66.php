         ...
         <form id="frm_mst_add" method="POST"> 
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="TEAMHEAD" id="TEAMHEAD" onclick="getTeamHead()" class="form-control mandatory" value="<?php echo e(old('TEAMHEAD')); ?>" readonly/>
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="TEAMNAME" id="TEAMNAME" class="form-control mandatory" value="<?php echo e(old('TEAMNAME')); ?>"  readonly/>
                  </div>
                </div>                
          </div>
        </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/PreSales/TeamMaster/mstfrm504add.blade.php ENDPATH**/ ?>