...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Sales Service Invoice (SSI)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SSIID); ?>" value="<?php echo e($val->SSIID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SSI_DT) && $val->SSI_DT !='' && $val->SSI_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SSI_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->SSI_NO) && $val->SSI_NO !=''?$val->SSI_NO:''); ?></td>
                ...
                <td><?php echo e(isset($val->DUE_DT) && $val->DUE_DT !='' && $val->DUE_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DUE_DT)):''); ?></td>
...
if(seletedRecord==0){
  ...
  if(is_approve ==1){
    var editURL = '<?php echo e(route("transaction",[156,"invoice",":rcdId"])); ?>';
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[156,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[156,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesServiceInvoice\trnfrm156.blade.php ENDPATH**/ ?>