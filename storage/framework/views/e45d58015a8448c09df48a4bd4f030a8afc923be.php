  ...
  <div class="multiple table-responsive  ">
    <table id="rpro_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->RPRID); ?>" value="<?php echo e($val->RPRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->RPR_DT) && $val->RPR_DT !='' && $val->RPR_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RPR_DT)):''); ?>" ></td>
          <td><?php echo e(isset($val->RPR_NO) && $val->RPR_NO !=''?$val->RPR_NO:''); ?></td>
          <td><?php echo e(isset($val->RPR_DT) && $val->RPR_DT !='' && $val->RPR_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RPR_DT)):''); ?></td>
          <td><?php echo e(isset($val->PRO_NO) && $val->PRO_NO !=''?$val->PRO_NO:''); ?></td>
          <td><?php echo e(isset($val->PRO_TITLE) && $val->PRO_TITLE !=''?$val->PRO_TITLE:''); ?></td>
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[273,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[273,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\RequisitionAgainstPRO\trnfrm273.blade.php ENDPATH**/ ?>