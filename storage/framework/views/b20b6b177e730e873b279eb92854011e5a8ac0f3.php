...
<?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->ST_ADJUSTID[0]) ? method_field('PUT') : ''); ?>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="BDCL_DOCNO" id="BDCL_DOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BDCL_DATE" id="BDCL_DATE" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("BDCL_DOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('BDCL_DATE')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      ...
      <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Complaint By</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_BY" id="COMPLAINT_BY" maxlength="50" value="<?php echo e(old('COMPLAINT_BY')); ?>" class="form-control mandatory"  placeholder="" >
               ...
               <div class="col-lg-2 pl"><p>Complaint To</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_TO" id="COMPLAINT_TO" maxlength="50" value="<?php echo e(old('COMPLAINT_TO')); ?>" class="form-control mandatory"  placeholder="" >
        ...
        <div class="row">
               <div class="col-lg-2 pl"><p>Machine / Genset  Code</p></div>
                ...
                <input type="text" name="PROBLEM_LOG_DET" id="PROBLEM_LOG_DET" maxlength="50" value="<?php echo e(old('PROBLEM_LOG_DET')); ?>" class="form-control mandatory"  placeholder="" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\BreakdownComplaintLog\trnfrm364add.blade.php ENDPATH**/ ?>