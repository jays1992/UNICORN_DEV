...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="PII_NO" id="PII_NO" value="<?php echo e(isset($objHDR->PII_NO)?$objHDR->PII_NO:''); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="PII_DT" id="PII_DT" value="<?php echo e(isset($objHDR->PII_DT)?$objHDR->PII_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        ...
        <div class="col-lg-2 pl">
                ...
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="<?php echo e(isset($objHDR->VID_REF)?$objHDR->VID_REF:''); ?>" />
        </div>
    </div>
    ...
    <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="checkbox" <?php echo e($ActionStatus); ?> name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objHDR->FC) && $objHDR->FC == 1 ? 'checked' : ''); ?> >
          </div>
          ...
          <div class="col-lg-2 pl" id="divcurrency" >
              ...
              <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="<?php echo e(isset($objHDR->CRDESCRIPTION) && $objHDR->CRDESCRIPTION !=''? $objHDR->CRCODE.'-'.$objHDR->CRDESCRIPTION:''); ?>"/>
          
              <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objHDR->CRID_REF)?$objHDR->CRID_REF:''); ?>" />
              
          </div>
          
          <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
          <div class="col-lg-2 pl">
              <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objHDR->CONV_FACTOR)?$objHDR->CONV_FACTOR:''); ?>"  />
          </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="<?php echo e(isset($objHDR->VENDOR_INVOICE_NO)?$objHDR->VENDOR_INVOICE_NO:''); ?>" maxlength="30" class="form-control" autocomplete="off" readonly />
        </div>
        <div class="col-lg-2 pl"><p>Vendor Invoice Date</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="<?php echo e(isset($objHDR->VENDOR_INVOICE_DT)?$objHDR->VENDOR_INVOICE_DT:''); ?>" class="form-control"  placeholder="dd/mm/yyyy" readonly  />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_billto">
            ...
            <input  type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objHDR->BILL_TO)?$objHDR->BILL_TO:''); ?>" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            ...
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objHDR->SHIP_TO)?$objHDR->SHIP_TO:''); ?>" />
        ...
        <div class="col-lg-6 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="<?php echo e(isset($objHDR->REMARKS)?$objHDR->REMARKS:''); ?>" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <select <?php echo e($ActionStatus); ?>  name="FOB" id="FOB" class="form-control" autocomplete="off" >
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="BOE_NO" id="BOE_NO" value="<?php echo e(isset($objHDR->BOE_NO)?$objHDR->BOE_NO:''); ?>" class="form-control" autocomplete="off" readonly >
      </div>

      <div class="col-lg-2 pl"><p>BOE Date</p></div>
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="date" name="BOE_DT" id="BOE_DT" value="<?php echo e(isset($objHDR->BOE_DT)?$objHDR->BOE_DT:''); ?>" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" readonly >
      </div>
	</div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<select <?php echo e($ActionStatus); ?>  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" onchange="changeDuty()" >
		...
		<div class="col-lg-2 pl">
			<input <?php echo e($ActionStatus); ?> type="text" name="REF_NO" id="REF_NO" value="<?php echo e(isset($objHDR->REF_NO)?$objHDR->REF_NO:''); ?>" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="Credit_days" id="Credit_days" value="<?php echo e(isset($objHDR->CREDIT_DAYS)?$objHDR->CREDIT_DAYS:''); ?>" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="<?php echo e(isset($objHDR->DUE_DATE)?$objHDR->DUE_DATE:''); ?>"  placeholder="dd/mm/yyyy"  />                        
        </div>

        <div class="col-lg-2 pl"><p>Total Amount</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="tot_amt" id="tot_amt" value="<?php echo e(isset($objHDR->NET_TOTAL)?$objHDR->NET_TOTAL:''); ?>" class="form-control"  autocomplete="off" readonly  />
        </div>

        <div  class="col-lg-2 pl"><p>Reverse GST</p></div>
        <div  class="col-lg-1 pl">
            <input <?php echo e($ActionStatus); ?> type="checkbox" name="GST_Reverse" id="GST_Reverse"  <?php echo e(isset($objHDR->REVERSE_GST) && $objHDR->REVERSE_GST == 1 ? 'checked' : ''); ?>    />                          
        </div>
    ...
    <div class="row">
        ...
        <div  class="col-lg-1 pl">
            <input <?php echo e($ActionStatus); ?> type="checkbox" name="GST_N_Avail" id="GST_N_Avail"  <?php echo e(isset($objHDR->GST_INPUT_NOT_AVAIL) && $objHDR->GST_INPUT_NOT_AVAIL == 1 ? 'checked' : ''); ?>   />
        </div> 

        <div class="col-lg-2 col-md-offset-1 pl"><p>CHA</p></div>
        <div class="col-lg-2 pl">
          <input  <?php echo e($ActionStatus); ?> type="text" name="txtvendor2" id="txtvendor2" class="form-control" value="<?php echo e(isset($CHA_VENDOR_NAME)?$CHA_VENDOR_NAME:''); ?>"  readonly  />
          <input type="hidden" name="VID2_REF" id="VID2_REF"  class="form-control " value="<?php echo e(isset($CHA_VENDOR_ID)?$CHA_VENDOR_ID:''); ?>"  />
        </div>
    ...
    <div class="row">	
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="GLpopup" id="txtGLpopup" value="<?php echo e(isset($objHDR->GLCODE)?$objHDR->GLCODE:''); ?><?php echo e(isset($objHDR->GLNAME)?'-'.$objHDR->GLNAME:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
        <input type="hidden" name="ROUNDOFF_GLID_REF" id="ROUNDOFF_GLID_REF" value="<?php echo e(isset($objHDR->ROUNDOFF_GLID_REF)?$objHDR->ROUNDOFF_GLID_REF:''); ?>" class="form-control" autocomplete="off" />
        <input type="hidden" name="tot_amt1" id="tot_amt1" value="<?php echo e(isset($objHDR->ROUNDOFF_TOTAL_AMT)?$objHDR->ROUNDOFF_TOTAL_AMT:''); ?>" class="form-control"  autocomplete="off" readonly />
      </div>       

      <div class="col-lg-2 pl"><p>Round of Amount</p></div>
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" value="<?php echo e(isset($objHDR->ROUNDOFF_AMT)?number_format($objHDR->ROUNDOFF_AMT, 2, '.', ''):''); ?>" class="form-control"  autocomplete="off" onkeyup="round_calculation()" onkeypress="return isNumberDecimalKey(event,this)"   />
      </div>

      <div class="col-lg-2 pl"><p>Round of Mode</p></div>
      <div class="col-lg-2 pl">
        <select <?php echo e($ActionStatus); ?> name="ROUNDOFF_MODE" id="ROUNDOFF_MODE" class="form-control" onchange="round_calculation()" >
          <option <?php echo e(isset($objHDR->ROUNDOFF_MODE) && $objHDR->ROUNDOFF_MODE =="Positive"?"selected='selected'":''); ?> value="Positive">Debit</option>
          <option <?php echo e(isset($objHDR->ROUNDOFF_MODE) && $objHDR->ROUNDOFF_MODE =="Negative"?"selected='selected'":''); ?> value="Negative">Credit</option>
        </select>                                  
      </div>
    </div>
                  ...
                  <tr>
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      <?php $__currentLoopData = $objPBMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="txtGRN_NO_<?php echo e($key); ?>" id="txtGRN_NO_<?php echo e($key); ?>" value="<?php echo e($row->GRN_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td  hidden><input type="text" name="GRNID_REF_<?php echo e($key); ?>" id="GRNID_REF_<?php echo e($key); ?>" value="<?php echo e($row->GRNID_REF); ?>" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td  hidden><input type="text" name="IPO_ID_REF_<?php echo e($key); ?>" id="IPO_ID_REF_<?php echo e($key); ?>" value="<?php echo e($row->IPO_ID_REF); ?>" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                      
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td hidden><input type="hidden" name="ITEMID_REF_<?php echo e($key); ?>" id="ITEMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ITEMID_REF); ?>" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off" style="width:130px;"  /></td>
                        
                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" value="<?php echo e($row->ALPS_PART_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" value="<?php echo e($row->CUSTOMER_PART_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name="OEMpartno_<?php echo e($key); ?>" id="OEMpartno_<?php echo e($key); ?>"   value="<?php echo e($row->OEM_PART_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>

                        <td><input <?php echo e($ActionStatus); ?> type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td hidden><input type="hidden" name="MAIN_UOMID_REF_<?php echo e($key); ?>" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOMID_REF); ?>" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_MAIN_QTY); ?>"  onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                        <td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" value="<?php echo e($row->AULT_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                        <td hidden><input type="hidden" name="ALT_UOMID_REF_<?php echo e($key); ?>" id="ALT_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ALT_UOMID_REF); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>"  class="form-control three-digits" maxlength="13" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                      
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="BILL_QTY_<?php echo e($key); ?>" id="BILL_QTY_<?php echo e($key); ?>" value="<?php echo e($row->BILL_QTY); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control " maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="UOM_OF_BILL_QTY_<?php echo e($key); ?>" id="UOM_OF_BILL_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->MAIN_UOM_CODE); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control" maxlength="13"  autocomplete="off" readonly style="width:130px;" /></td>

                        <td><input <?php echo e($ActionStatus); ?> type="text"                      name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_ASP_MU); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'5')" class="form-control four-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text"  <?php echo e($AlpsStatus['disabled']); ?>  name="DISC_PER_<?php echo e($key); ?>" id="DISC_PER_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text"  <?php echo e($AlpsStatus['disabled']); ?>  name="DISC_AMT_<?php echo e($key); ?>" id="DISC_AMT_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>"  class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="FREIGHT_AMT_<?php echo e($key); ?>"           id="FREIGHT_AMT_<?php echo e($key); ?>"            value="<?php echo e(intval($row->FREIGHT_AMT) > 0 ? $row->FREIGHT_AMT:'0.00'); ?>"      onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="INSURANCE_AMT_<?php echo e($key); ?>"         id="INSURANCE_AMT_<?php echo e($key); ?>"          value="<?php echo e(intval($row->INSURANCE_AMT) > 0 ? $row->INSURANCE_AMT:'0.00'); ?>"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="ASSESSABLE_VALUE_<?php echo e($key); ?>"      id="ASSESSABLE_VALUE_<?php echo e($key); ?>"       value="<?php echo e($row->ASSESSABLE_VALUE); ?>"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>"  value="<?php echo e($row->CUSTOME_DUTY_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>"  value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="SWS_RATE_PER_<?php echo e($key); ?>"          id="SWS_RATE_PER_<?php echo e($key); ?>"           value="<?php echo e($row->SWS_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="SWS_RATE_AMT_<?php echo e($key); ?>"          id="SWS_RATE_AMT_<?php echo e($key); ?>"           value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"    id="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"     value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="TAXABLE_VALUE_<?php echo e($key); ?>"         id="TAXABLE_VALUE_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="IGST_RATE_PER_<?php echo e($key); ?>"         id="IGST_RATE_PER_<?php echo e($key); ?>"          value="<?php echo e($row->IGST); ?>"  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="IGST_RATE_AMT_<?php echo e($key); ?>"         id="IGST_RATE_AMT_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="VALUE_AFTER_GST_<?php echo e($key); ?>"       id="VALUE_AFTER_GST_<?php echo e($key); ?>"        value=""  class="form-control four-digits" readonly  autocomplete="off" style="width:130px;text-align:right;" /></td>
                  ...
                  <?php if(!empty($objPBCAL)): ?>
                    ...
                    <tr  class="participantRow5">
                        ...
                        <td style="text-align:center;">
                          <input <?php echo e($ActionStatus); ?> type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
...
function loadVendor2(CODE,NAME){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getVendor2"])); ?>',
    type:'POST',
    data:{'CODE':CODE,'NAME':NAME},
    success:function(data) {
  ...
  if(PII_NO ===""){
    ...
    var allblank0 	= [];
        ...
        if(jQuery.inArray("false", allblank0) !== -1){
          ...
          else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#PII_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
$('#txtGLpopup').on('click',function(event){     
  $("#GLresult").html('');
    ...
    $("#item_seach").show();
    $.ajax({
        url:'<?php echo e(route("transaction",[300,"get_gl_detail"])); ?>',
        type:'POST',
        data:{},
        success:function(data) {                                
          $("#item_seach").hide();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoiceImport\trnfrm300edit.blade.php ENDPATH**/ ?>