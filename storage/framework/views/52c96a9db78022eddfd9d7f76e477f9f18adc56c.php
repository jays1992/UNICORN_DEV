...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Purchase Return (PRR)</a>
                </div><!--col-2-->
      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input disabled type="text" name="PRR_NO" id="PRR_NO" value="<?php echo e($objSO->PRR_NO); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
          </div>
            
            <div class="col-lg-2 pl"><p>PRR Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="PRR_DT" id="PRR_DT" value="<?php echo e($objSO->PRR_DT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            
            <div hidden class="col-lg-2 pl"><p>GL</p></div>
            <div hidden class="col-lg-2 pl">
            <input disabled type="text" name="GLID_popup" id="txtgl_popup"  class="form-control mandatory"  autocomplete="off" readonly/>
            ...
            <div class="col-lg-2 pl">
                <input disabled type="text" name="SubGl_popup" id="txtsubgl_popup"  value="<?php echo e($objsubglcode->VCODE); ?> - <?php echo e($objsubglcode->NAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e($objSO->VID_REF); ?>" class="form-control" autocomplete="off" />
                <input type="hidden" name="hdnmaterial" id="hdnmaterial" class="form-control" autocomplete="off" />                                                                
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e($objSO->BILLTO); ?>" />
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e($objSO->SHIPTO); ?>" />
                            ...
                            <div class="col-lg-2 pl">
                              <input disabled type="text" name="VCL_NO" id="VCL_NO" value="<?php echo e($objSO->VCL_NO); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="<?php echo e(isset($objSO)?$objSO->TRANSPORTER_CODE:''); ?> - <?php echo e(isset($objSO)?$objSO->TRANSPORTER_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                                <input type="hidden" name="TRASPORTER_NAME" id="TRASPORTER_NAME" value="<?php echo e($objSO->TRASPORTER_NAME); ?>" class="form-control" autocomplete="off" />                                                              
                            </div>

                            <div class="col-lg-2 pl"><p>Driver Name</p></div>
                            <div class="col-lg-2 pl">
                              <input disabled type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="<?php echo e($objSO->DRIVER_NAME); ?>" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>
...
<td><input disabled type="text" name="txtSQ_popup_<?php echo e($key); ?>" id="txtSQ_popup_<?php echo e($key); ?>" value="<?php echo e($row->PB_DOCNO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td hidden><input type="hidden" name="SQA_<?php echo e($key); ?>" id="SQA_<?php echo e($key); ?>" value="<?php echo e($row->PBID_REF); ?>" class="form-control" autocomplete="off" /></td>
<td hidden><input type="hidden" name="SEQID_REF_<?php echo e($key); ?>" id="SEQID_REF_<?php echo e($key); ?>" value="<?php echo e($row->PBID_REF); ?>" class="form-control" autocomplete="off" /></td>
...
<td hidden><input type="hidden" name="ITEMID_REF_<?php echo e($key); ?>" id="ITEMID_REF_<?php echo e($key); ?>" value="<?php echo e($ITEMID_REF); ?>" class="form-control" autocomplete="off" /></td>
...
<td><input disabled type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input disabled type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
...
<td><input disabled type="text" name="SQAUOM_<?php echo e($key); ?>" id="SQAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input disabled type="text" name="SQAUOMQTY_<?php echo e($key); ?>" id="SQAUOMQTY_<?php echo e($key); ?>" value="<?php echo (($row->RETURN_QTY_MU*$row->TO_QTY)/$row->FROM_QTY); ?>" class="form-control" autocomplete="off"  readonly/></td>


<td><input disabled type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td hidden><input type="hidden" name="MAIN_UOMID_REF_<?php echo e($key); ?>" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOMID_REF); ?>" class="form-control"  autocomplete="off" style="width:75px;" /></td>
<td><input disabled type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_MU); ?>" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off"  style="width:75px;" /></td>
<td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_MU); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>

<td><input disabled type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td hidden><input type="hidden" name="ALT_UOMID_REF_<?php echo e($key); ?>" id="ALT_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ALT_UOMID_REF); ?>" class="form-control"  autocomplete="off"  readonly  style="width:75px;"  /></td>
<td><input disabled type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_AU); ?>"  class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>

<td style="text-align:center;" ><a disabled class="btn checkstore" id="store_<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
<td  hidden><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_MU); ?>" ></td>
...
<td><input disabled type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATEPUOM_MU); ?>" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input disabled type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input disabled type="checkbox" value="<?php echo e($row->TAX_IMPACT); ?>" name='flagtype_<?php echo e($key); ?>' id="flagtype_<?php echo e($key); ?>" <?php echo e($GST_FLAGE_CHECKED); ?> ></td>


<td><input disabled type="text" name="IGST_<?php echo e($key); ?>" id="IGST_<?php echo e($key); ?>" value="<?php echo e($row->IGST_RATE); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="IGSTAMT_<?php echo e($key); ?>" id="IGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGST_<?php echo e($key); ?>" id="CGST_<?php echo e($key); ?>" value="<?php echo e($row->CGST_RATE); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGSTAMT_<?php echo e($key); ?>" id="CGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGST_<?php echo e($key); ?>" id="SGST_<?php echo e($key); ?>" value="<?php echo e($row->SGST_RATE); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGSTAMT_<?php echo e($key); ?>" id="SGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TGST_AMT_<?php echo e($key); ?>" id="TGST_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TOT_AMT_<?php echo e($key); ?>" id="TOT_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            ...
                                            <?php $__currentLoopData = $objUdfSOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$uindex); ?> id=<?php echo e("UDFSOID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFPRRID); ?>" autocomplete="off"   /></td>
                                            ...
                                            <?php if(!empty($objSOCAL)): ?>
                                                <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td align="center" ><button  disabled class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                <?php else: ?>
    ...
    <input type="text" id="UDFSOIDnamesearch" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_<?php echo e($udfindex); ?>" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->UDFPRRID); ?>"/>
          </td>
...
// $('#udf').on('focus','[id*="popupUDFSOID"]',function(){
//      $("#udfsoidpopup").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseReturn\trnfrm310view.blade.php ENDPATH**/ ?>