                ...
                <div class="row">
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    <div class="col-lg-2 pl">
                          ...
                          <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(old('DOC_NO')); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" style="text-transform:uppercase" autofocus >
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                  ...
                  <div class="row">
                    ...
                    <input type="text" name="EMPID_REF" id="txtitem_popup"  class="form-control mandatory"  autocomplete="off" readonly/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AdjustmentVoucherEmployeeWise\trnfrm420add.blade.php ENDPATH**/ ?>