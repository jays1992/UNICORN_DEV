<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[177,'index'])); ?>" class="btn singlebt">Salutation Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SAID); ?>" value="<?php echo e($val->SAID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->SACODE) && $val->SACODE !=''?$val->SACODE:''); ?></td>
        ...
        <form id="masterForm177Print" action="<?php echo e(route('mastergetlist',[177,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[177,"add"])); ?>';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[177,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[177,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[177,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[177,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                            window.location.href="<?php echo e(route('master',[177,'index'])); ?>";
                        }               
                    },
                    error:function(data){
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[177,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\SalutationMaster\mstfrm177.blade.php ENDPATH**/ ?>