...
<?php $__env->startSection('content'); ?>
  ...
  <div class="container-fluid purchase-order-view filter">     
    ...
    <div class="row">
      ...
      <input type="text" name="COMPANY_WORK_CODE" id="COMPANY_WORK_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >

      <!-- <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
        <input type="text" name="COMPANY_WORK_CODE" id="COMPANY_WORK_CODE" value="<?php echo e(isset($objAutoGenNo)?$objAutoGenNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
        <input type="text" name="COMPANY_WORK_CODE" id="COMPANY_WORK_CODE" value="<?php echo e(old('COMPANY_WORK_CODE')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
      <?php else: ?>
        <input type="text" name="COMPANY_WORK_CODE" id="COMPANY_WORK_CODE" value="<?php echo e(isset($objAutoGenNo)?$objAutoGenNo:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      <?php endif; ?> -->
      </div>
      <div class="col-lg-2 pl"><p>Company Working Date*</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="COMPANY_WORK_DATE"  id="COMPANY_WORK_DATE" value="<?php echo e(old('COMPANY_WORK_DATE')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\CompanyWorkingDay\mstfrm423add.blade.php ENDPATH**/ ?>