          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="LEAD_SOURCECODE" id="LEAD_SOURCECODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="LEAD_SOURCENAME" id="LEAD_SOURCENAME" class="form-control mandatory" value="<?php echo e(old('LEAD_SOURCENAME')); ?>" maxlength="200" tabindex="2"  />
                  </div>
                </div>
          </div>
        </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\LeadSource\mstfrm440add.blade.php ENDPATH**/ ?>