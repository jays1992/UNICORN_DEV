...
<div class="container-fluid filter">
	...
	<div class="inner-form">
		<div class="row">
				...
				<div class="col-lg-2 pl">
					<select name="TYPE" id="TYPE" class="form-control" >
						   <option value="PURCHASE" <?php echo e(isset($objPBHDR->TYPE) && $objPBHDR->TYPE == 'PURCHASE' ? 'selected' : ''); ?>>PURCHASE</option>
						   <option value="TRANSFER" <?php echo e(isset($objPBHDR->TYPE) && $objPBHDR->TYPE == 'TRANSFER' ? 'selected' : ''); ?>>STOCK TRANSFER</option>
					</select>
				</div>
		</div>
		<div class="row">
        ...
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="PB_DOCDT" id="PB_DOCDT" value="<?php echo e(isset($objPBHDR->PB_DOCDT)?$objPBHDR->PB_DOCDT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input type="checkbox" <?php echo e($ActionStatus); ?> name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objPBHDR->FC) && $objPBHDR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      ...
      <div class="col-lg-2 pl" id="divcurrency" >
          ...
          <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="<?php echo e(isset($objPBHDR->CRDESCRIPTION) && $objPBHDR->CRDESCRIPTION !=''? $objPBHDR->CRCODE.'-'.$objPBHDR->CRDESCRIPTION:''); ?>"/>
      
          <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objPBHDR->CRID_REF)?$objPBHDR->CRID_REF:''); ?>" />
          
      </div>
      
      <div class="col-lg-1 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objPBHDR->CONVFACT)?$objPBHDR->CONVFACT:''); ?>"  />
      </div>
  </div>
    ...
    <div class="row">	
      ...
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text"   name="ROUNDOFF_GLCODE_NAME"  id="ROUNDOFF_GLCODE_NAME" value="<?php echo e(isset($objPBHDR->GLCODE)?$objPBHDR->GLCODE:''); ?><?php echo e(isset($objPBHDR->GLNAME)?'-'.$objPBHDR->GLNAME:''); ?>"  class="form-control mandatory"  autocomplete="off"  readonly/>
      <input type="hidden" name="ROUNDOFF_GLID_REF"     id="ROUNDOFF_GLID_REF"    value="<?php echo e(isset($objPBHDR->ROUNDOFF_GLID_REF)?$objPBHDR->ROUNDOFF_GLID_REF:''); ?>" class="form-control" autocomplete="off" />
      <input type="hidden" name="ROUNDOFF_TOTAL_AMT"    id="ROUNDOFF_TOTAL_AMT"   value="<?php echo e(isset($objPBHDR->ROUNDOFF_TOTAL_AMT)?$objPBHDR->ROUNDOFF_TOTAL_AMT:''); ?>" class="form-control"  autocomplete="off" readonly />
      </div>       

      <div class="col-lg-2 pl"><p>Round of Amount</p></div>
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" value="<?php echo e(isset($objPBHDR->ROUNDOFF_AMT)?number_format($objPBHDR->ROUNDOFF_AMT, 2, '.', ''):''); ?>" class="form-control"  autocomplete="off" onkeyup="round_calculation()" onkeypress="return isNumberDecimalKey(event,this)"   />
      </div>
      ...
      <select <?php echo e($ActionStatus); ?> name="ROUNDOFF_MODE" id="ROUNDOFF_MODE" class="form-control" onchange="round_calculation()" >
        <option <?php echo e(isset($objPBHDR->ROUNDOFF_MODE) && $objPBHDR->ROUNDOFF_MODE =="Positive"?"selected='selected'":''); ?> value="Positive">Debit</option>
        <option <?php echo e(isset($objPBHDR->ROUNDOFF_MODE) && $objPBHDR->ROUNDOFF_MODE =="Negative"?"selected='selected'":''); ?> value="Negative">Credit</option>
      </select>                                  
      </div>
    </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      ...
                      ?>
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("IGST_AMT_".$key); ?> id=<?php echo e("IGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($row->IGSTAMT); ?>" onkeyup="getTaxRowTotal(this.id)"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CGST_AMT_".$key); ?> id=<?php echo e("CGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($row->CGSTAMT); ?>" onkeyup="getTaxRowTotal(this.id)"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SGST_AMT_".$key); ?> id=<?php echo e("SGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($row->SGSTAMT); ?>" onkeyup="getTaxRowTotal(this.id)"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                      <?php
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoice\trnfrm236edit.blade.php ENDPATH**/ ?>