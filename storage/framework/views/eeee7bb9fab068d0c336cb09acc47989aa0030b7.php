      ...
      <div id="TaskAllocation" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="TASK_TYPE" id="TASK_TYPE" onclick="getData('<?php echo e(route('transaction',[$FormId,'getTaskType'])); ?>','Task Type','TASK_REF')" class="form-control mandatory" autocomplete="off" readonly>
          ...
          <div class="col-lg-2 pl"><p>Assigned To*</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="ASSIGN_TO" id="ASSIGN_TO" onclick="getData('<?php echo e(route('transaction',[$FormId,'getAssignedTo'])); ?>','Assigned To','ASSIGN_TO_REF')" class="form-control mandatory" autocomplete="off" readonly>
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="PRIORITY_NAME" id="PRIORITY_NAME" onclick="getData('<?php echo e(route('transaction',[$FormId,'getPriority'])); ?>','Priority','PRIORITY_REF')" class="form-control mandatory" autocomplete="off" readonly>
                  ...
                  <table id="example3" class="display nowrap table table-striped table-bordered">
                   ...
                   <tbody>
                     ...
                     <tr  class="participantRow">   
                       <td><?php echo e(isset($row->TASK_TYPECODE) && $row->TASK_TYPECODE !=''?$row->TASK_TYPECODE:''); ?><input type="hidden" name="TASK_TYPE"                   id ="TASK_TYPE_<?php echo e($key); ?>"                value="<?php echo e(isset($row->TASK_TYPECODE) && $row->TASK_TYPECODE !=''?$row->TASK_TYPECODE:''); ?>" class="form-control mandatory" autocomplete="off"></td>
                       <td><?php echo e(isset($row->EMPCODE) && $row->EMPCODE !=''?$row->EMPCODE:''); ?>                  <input type="hidden" name="ASSIGN_TO"                   id ="ASSIGN_TO_<?php echo e($key); ?>"                value="<?php echo e(isset($row->EMPCODE) && $row->EMPCODE !=''?$row->EMPCODE:''); ?>" class="form-control mandatory" autocomplete="off"></td>
                       <td><?php echo e(isset($row->PRIORITYCODE) && $row->PRIORITYCODE !=''?$row->PRIORITYCODE:''); ?><input type="hidden"    name="PRIORITY_NAME"               id ="PRIORITY_NAME_<?php echo e($key); ?>"            value="<?php echo e(isset($row->PRIORITYCODE) && $row->PRIORITYCODE !=''?$row->PRIORITYCODE:''); ?>" class="form-control mandatory" autocomplete="off"></td>
                       ...
                       <td><?php echo e(isset($row->SUBJECT) && $row->SUBJECT !=''?$row->SUBJECT:''); ?><input type="hidden" name="TASK_SUBJECT"                                  id ="TASK_SUBJECT_<?php echo e($key); ?>"             value="<?php echo e(isset($row->SUBJECT) && $row->SUBJECT !=''?$row->SUBJECT:''); ?>"    class="form-control mandatory" autocomplete="off"></td>
                       ...
                       <td hidden><input type="hidden" name="ASSIGN_TO_REF"         id ="ASSIGN_TO_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->ADDITIONAL_EMPLOYEE_ID) && $row->ADDITIONAL_EMPLOYEE_ID !=''?$row->ADDITIONAL_EMPLOYEE_ID:''); ?>" class="form-control mandatory" autocomplete="off"></td>
...
/************************************* All Search End  ************************** */
  ...
  function validateForm(actionType){
      ...
      else if(checkPeriodClosing('<?php echo e($FormId); ?>','<?php echo e(isset($objResponse->LEAD_DT) && $objResponse->LEAD_DT !=''?date('d-m-Y',strtotime($objResponse->LEAD_DT)):''); ?>',0) ==0){
        $("#YesBtn").hide();
        $("#NoBtn").hide();
        $("#OkBtn").hide();
        $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PreSales\TaskAllocation\trnfrm484add.blade.php ENDPATH**/ ?>