...
<?php $__env->startSection('content'); ?> 
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="MISRNO" id="MISRNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
			...
			<div class="col-lg-2 pl">
        <input type="date" name="MISRDT" id="MISRDT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("MISRNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('MISRDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFPMISID); ?>" autocomplete="off"   /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\MaterialIssueSlipRPR\trnfrm305add.blade.php ENDPATH**/ ?>