...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Production Return</a>
        </div>
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="<?php echo e(isset($objResponse->PRR_NO) && $objResponse->PRR_NO !=''?$objResponse->PRR_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			  ...
			  <div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="PRR_DT" id="PRR_DT" value="<?php echo e(isset($objResponse->PRR_DT) && $objResponse->PRR_DT !=''?$objResponse->PRR_DT:''); ?>" class="form-control mandatory" >
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionReturn\trnfrm401view.blade.php ENDPATH**/ ?>