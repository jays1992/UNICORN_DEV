...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('report',[370,'index'])); ?>" class="btn singlebt">Service Purchase Order Print</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pop"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">
                            <div class="col-lg-3 pl"><p>Service Purchase Order Number</p></div>
                            <div class="col-lg-3 pl">
                                <select name="SPO_NO" id="SPO_NO" class="form-control mandatory">
                                    <option value="">select</option>
                                    <?php $__currentLoopData = $ObjSPO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SPO_NO); ?>" ><?php echo e($Row->SPO_NO); ?></option>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[370,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        if(SPO_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Service Purchase Order.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'<?php echo e(route("report",[370,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\SPOPrint\rptfrm370.blade.php ENDPATH**/ ?>