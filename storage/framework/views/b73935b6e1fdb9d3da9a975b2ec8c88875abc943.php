...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Forget Password</a></div>    
...
let User = "#UserOrderTable2";
  ...
  $('#txtUserpopup').on('click',function(event){           
                $("#Dataresult_user").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("master",[$FormId,"get_User"])); ?>',
                      type:'POST',
                      data:{},
                      success:function(data) {                                
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserManagement\mstfrm540add.blade.php ENDPATH**/ ?>