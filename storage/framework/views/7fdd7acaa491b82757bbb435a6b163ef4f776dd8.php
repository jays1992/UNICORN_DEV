...
<div class="container-fluid topnav">
  <div class="row">
      ...
      <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[3,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="statemst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
          ...
          ?>
          <tr>
            <td><input type="checkbox" id="chkId<?php echo e($val->STID); ?>" value="<?php echo e($val->STID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
            <td><?php echo e(isset($val->STCODE) && $val->STCODE !=''?$val->STCODE:''); ?></td>
            <td><?php echo e(isset($val->NAME) && $val->NAME !=''?$val->NAME:''); ?></td>
            <td><?php echo e(isset($val->STDCODE) && $val->STDCODE !=''?$val->STDCODE:''); ?></td>
            <td><?php echo e(isset($val->LANG) && $val->LANG !=''?$val->LANG:''); ?></td>
            <td><?php echo e(isset($val->NEWSC) && $val->NEWSC !=''?$val->NEWSC:''); ?></td>
            <td><?php echo e(isset($val->CAPITAL) && $val->CAPITAL !=''?$val->CAPITAL:''); ?></td>
            <td><?php echo e(isset($val->STTYPE) && $val->STTYPE !=''?$val->STTYPE:''); ?></td>
        ...
        <form id="masterForm3Print" action="<?php echo e(route('mastergetlist',[3,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<style>
  #custom_dropdown, #statemst_filter {
...
<script>
  ...
  $(document).ready(function(){
    ...
    var mststateTable =  $('#statemst').DataTable({});
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[3,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viweRecordId = countryIdsData[0];
            var viewURL = '<?php echo e(route("master",[3,"view",":rcdId"])); ?>';
    ...
    $('#btnApprove').on('click', function() {
            var countryIdsData = getSeletectedCBox();
            var seletedRecord = countryIdsData.length;
            var countryIdsDataID = getSeletectedCBoxID();
    ...
    $('#btnAttach').on('click', function() {
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[3,"attachment",":rcdId"])); ?>';
      ...
      function getSeletectedCBox(){       
        selectedIds=[];
            var checkedcollection = mststateTable.$(".js-selectall1:checked", { "page": "all" });
...
var recordId = countryIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[3,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[3,"cancel"])); ?>',
                            type:'POST',
    ...
    $('#btnPrint').on('click', function() {
          ...
          if(seletedRecord==0){
              ...
              var recordsIds = countryIdsData;
               $("#massPrintIds").val(recordsIds);
               $("#masterForm3Print").submit()
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Common/State/mstfrm3.blade.php ENDPATH**/ ?>