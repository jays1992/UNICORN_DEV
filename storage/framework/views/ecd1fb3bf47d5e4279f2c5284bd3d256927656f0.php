<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->NOGID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="NOGID" id="NOGID" value="<?php echo e($objResponse->NOGID); ?>" />
                    <input type="hidden" name="NOGCODE" id="NOGCODE" value="<?php echo e($objResponse->NOGCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="NOGNAME" id="NOGNAME" class="form-control mandatory" value="<?php echo e(old('NOGNAME',$objResponse->NOGNAME)); ?>" maxlength="200" tabindex="1"  />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <select name="NOG_TYPE" id="NOG_TYPE" class="form-control mandatory" autocomplete="off"tabindex="2" >
                          ...
                          <option <?php echo e(isset($objResponse) && $objResponse->NOG_TYPE==$val->NOGTID?"selected='selected'":''); ?> value="<?php echo e($val->NOGTID); ?>"><?php echo e($val->NOG_TYPE); ?></option>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[2,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[2,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\NatureOfGroup\mstfrm2edit.blade.php ENDPATH**/ ?>