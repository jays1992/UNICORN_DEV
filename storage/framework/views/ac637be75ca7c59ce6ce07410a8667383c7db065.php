...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">User-Branch Mapping</a></div>
      ...
      <div class="row">    
        ...
        <div class="col-lg-2 pl">
          <select name="MAPBRID_REF" id="MAPBRID_REF" class="form-control" required onchange="selectBranch(this.value)" >
              ...
              <option value="<?php echo e($val->FID); ?>"><?php echo e($val->BRCODE.'-'.$val->BRNAME); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserBranchMapping\mstfrm204add.blade.php ENDPATH**/ ?>