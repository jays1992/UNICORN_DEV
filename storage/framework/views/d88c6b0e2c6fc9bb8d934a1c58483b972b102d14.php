...
<form id="frm_trn_edit"  method="POST">   
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="DC_DATE" id="DC_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->DC_DATE)?$objResponse->DC_DATE:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" readonly >
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\DealerCommission\trnfrm500edit.blade.php ENDPATH**/ ?>