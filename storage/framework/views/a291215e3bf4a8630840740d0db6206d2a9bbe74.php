...
<div class="container-fluid topnav">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->EMPID); ?>" value="<?php echo e($val->EMPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->EMPCODE) && $val->EMPCODE !=''?$val->EMPCODE:''); ?></td>
                <td><?php echo e(isset($val->FNAME) && $val->FNAME !=''?$val->FNAME:''); ?></td>
                <td><?php echo e(isset($val->MNAME) && $val->MNAME !=''?$val->MNAME:''); ?></td>
                <td><?php echo e(isset($val->LNAME) && $val->LNAME !=''?$val->LNAME:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EmployeeMaster\mstfrm179.blade.php ENDPATH**/ ?>