...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Scheme Master</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SCHEME_NO" id="SCHEME_NO" value="<?php echo e(isset($objResponse->SCHEME_NO)?$objResponse->SCHEME_NO:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          <input type="hidden" name="SCHEMEID" id="SCHEMEID" value="<?php echo e(isset($objResponse->SCHEMEID)?$objResponse->SCHEMEID:''); ?>" >
        </div>
              
        <div class="col-lg-1 pl"><p>Scheme Date</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="SCHEME_DATE" id="SCHEME_DATE" value="<?php echo e(isset($objResponse->SCHEME_DATE)?$objResponse->SCHEME_DATE:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>

        <div class="col-lg-1 pl"><p>Scheme Name</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SCHEME_NAME" id="SCHEME_NAME" value="<?php echo e(isset($objResponse->SCHEME_NAME)?$objResponse->SCHEME_NAME:''); ?>" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Scheme Type</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="SCHEME_TYPE" id="SCHEME_TYPE" class="form-control" >
            <option <?php echo e(isset($objResponse) && $objResponse->SCHEME_TYPE=='QUANTITY'?'selected="selected"':''); ?> value="QUANTITY">QUANTITY</option>
          </select>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="EFF_FROM_DATE" id="EFF_FROM_DATE" value="<?php echo e(isset($objResponse->EFF_FROM_DATE)?$objResponse->EFF_FROM_DATE:''); ?>" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Effective To Date</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="EFF_TO_DATE" id="EFF_TO_DATE" value="<?php echo e(isset($objResponse->EFF_TO_DATE)?$objResponse->EFF_TO_DATE:''); ?>" class="form-control" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>Item Code</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"    name="MAIN_ITEMID_NAME" id="MAIN_ITEMID_NAME" value="<?php echo e(isset($objResponse->ICODE)?$objResponse->ICODE:''); ?>" class="form-control" onclick="getMainItem()" readonly >
          <input type="hidden"  name="MAIN_ITEMID_REF"  id="MAIN_ITEMID_REF" value="<?php echo e(isset($objResponse->ITEMID_REF)?$objResponse->ITEMID_REF:''); ?>" class="form-control" >
          <input type="hidden"  id="HIDDEN_ITEM_FIELD"  class="form-control" >
        </div>

        <div class="col-lg-1 pl"><p>Item Name</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="ITEM_NAME" id="ITEM_NAME"  value="<?php echo e(isset($objResponse->ITEM_NAME)?$objResponse->ITEM_NAME:''); ?>" class="form-control" autocomplete="off" readonly >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="MAIN_UOM" id="MAIN_UOM" value="<?php echo e(isset($objResponse->UOMCODE)?$objResponse->UOMCODE:''); ?><?php echo e(isset($objResponse->DESCRIPTIONS)?'-'.$objResponse->DESCRIPTIONS:''); ?>" class="form-control" readonly >
          <input type="hidden" name="MAIN_UOM_REF" id="MAIN_UOM_REF" value="<?php echo e(isset($objResponse->UOMID_REF)?$objResponse->UOMID_REF:''); ?>" class="form-control" readonly >
        </div>

        <div class="col-lg-1 pl"><p>Qty</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="MAIN_QTY" id="MAIN_QTY" value="<?php echo e(isset($objResponse->QTY)?$objResponse->QTY:''); ?>" class="form-control" onkeypress="return isNumberKey(event,this)" >
        </div>

        <div class="col-lg-1 pl"><p>Remarks</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($objResponse->REMARKS)?$objResponse->REMARKS:''); ?>" class="form-control" >
        </div>
      </div>
    </div>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><input <?php echo e($ActionStatus); ?>  type="text" name="popupITEMID[]" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" onclick="getItem(this.id)" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input type="hidden" name="ITEMID_REF[]" id="ITEMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ITEMID_REF); ?>" class="form-control" autocomplete="off" /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="ItemName[]" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="popupMUOM[]" id="popupMUOM_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"  autocomplete="off"  readonly /></td>
                    <td hidden><input type="hidden" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->UOMID_REF); ?>" class="form-control"  autocomplete="off" /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"  name="QTY[]" id="QTY_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" /></td>
                    
                    <td>
                      <select <?php echo e($ActionStatus); ?> name="COST[]" id="COST_<?php echo e($key); ?>" class="form-control" autocomplete="off" onchange="getCost(this)" >
                        <option <?php echo e(isset($row->COST) && $row->COST=='FREE'?'selected="selected"':''); ?> value="FREE">FREE</option>
                        <option <?php echo e(isset($row->COST) && $row->COST=='DISC'?'selected="selected"':''); ?> value="DISC">DISC</option>
                      </select>
                    </td>

                    <td><input <?php echo e($ActionStatus); ?> type="text" name="PER[]" id="PER_<?php echo e($key); ?>" value="<?php echo e(isset($row->PER)?$row->PER:''); ?>" class="form-control"  autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" <?php echo e(isset($row->COST) && $row->COST=='FREE'?'readonly':''); ?>   /></td>
                    
                    <td>
                      <select <?php echo e($ActionStatus); ?> name="PERCENTAGE_BASED_ON[]" id="PERCENTAGE_BASED_ON_<?php echo e($key); ?>" class="form-control" autocomplete="off">
                        <option value="">Select</option>
                        <option <?php echo e(isset($row->PER_BASE) && $row->PER_BASE=='NA'?'selected="selected"':''); ?> value="NA">NA</option>
                        <option <?php echo e(isset($row->PER_BASE) && $row->PER_BASE=='DP'?'selected="selected"':''); ?> value="DP">DP</option>
                        <option <?php echo e(isset($row->PER_BASE) && $row->PER_BASE=='CP'?'selected="selected"':''); ?> value="CP">CP</option>
                        <option <?php echo e(isset($row->PER_BASE) && $row->PER_BASE=='MRP'?'selected="selected"':''); ?> value="MRP">MRP</option>
                        <option <?php echo e(isset($row->PER_BASE) && $row->PER_BASE=='MSP'?'selected="selected"':''); ?> value="MSP">MSP</option>
                      </select>
                    </td>
          ...
          <table id="ItemIDTable" class="display nowrap table  table-striped table-bordered" style="width:100%" >
            ...
            <tbody>
              <tr>
                ...
                <td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemAPNsearch" class="form-control" autocomplete="off" onkeyup="searchItem(event)"></td>
                <td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemCPNsearch" class="form-control" autocomplete="off" onkeyup="searchItem(event)"></td>
                <td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemOEMPNsearch" class="form-control" autocomplete="off" onkeyup="searchItem(event)"></td>
              </tr>
            </tbody>
          </table>
...
function loadItem(){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[$FormId,"loadItem"])); ?>',
    type:'POST',
    ...
    success:function(data) {
      ...
      if(data.length > 0){
        $.each(data, function(key, value) {
          ...
          html +='<td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> >'+value.ALPS_PART_NO+'</td>';
          html +='<td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> >'+value.CUSTOMER_PART_NO+'</td>';
          html +='<td style="width:9%;" <?php echo e($AlpsStatus['hidden']); ?> >'+value.OEM_PART_NO+'</td>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\SchemeMaster\mstfrm498edit.blade.php ENDPATH**/ ?>