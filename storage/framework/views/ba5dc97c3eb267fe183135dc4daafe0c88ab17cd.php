            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="VQ_NO" id="VQ_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VQ_DT" id="VQ_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("VQ_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)'  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits blurDISCPER" maxlength="8"  autocomplete="off" style="width: 50px;"  onkeypress="return isNumberDecimalKey(event,this)" <?php echo e($AlpsStatus['disabled']); ?> /></td>
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" class="form-control two-digits blurDISCOUNT_AMT" maxlength="15"  autocomplete="off"  onkeypress="return isNumberDecimalKey(event,this)"  <?php echo e($AlpsStatus['disabled']); ?>  /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\VendorQuotation\trnfrm61add.blade.php ENDPATH**/ ?>