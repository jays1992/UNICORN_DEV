  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->BRCOID); ?>" value="<?php echo e($val->BRCOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->BRC_OUT_DT) && $val->BRC_OUT_DT !='' && $val->BRC_OUT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BRC_OUT_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->BRC_OUT_NO) && $val->BRC_OUT_NO !=''?$val->BRC_OUT_NO:''); ?></td>
                <td><?php echo e(isset($val->BRC_OUT_DT) && $val->BRC_OUT_DT !='' && $val->BRC_OUT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BRC_OUT_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\BarcodeOut\trnfrm419.blade.php ENDPATH**/ ?>