...
$(function() { 
  ...
  function getItems(pfrom){
        ...
        $.ajax({
          url:'<?php echo e(route("master",[50,"getItems"])); ?>',
            type:'POST',
...
function checkDuplicateCode(){
	...
	$.ajax({
		url:'<?php echo e(route("master",[50,"codeduplicate"])); ?>',
		type:'POST',
		data:{'PL_NO': codedata},
		success:function(data) {
			if(data.exists) {
...
//----------------------------
 ...
 window.fnConfirm = function(){
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[50,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "<?php echo e(route('master',[50,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorItemPriceList\mstfrm50add.blade.php ENDPATH**/ ?>