...
<!-- <form id="frm_rpt_ledger" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[1391,'index'])); ?>" class="btn singlebt">TDS Detail Report for Customer/Vendor</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_ledger"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>MODE</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select  data-hide-disabled="hide" name="MODE" id="MODE" class="form-control" >
                        ...
                        <div class="col-lg-3 pl"><p>Customer/Vendor</p></div>
                            <div class="col-lg-3 pl" id="div_vdg">
                                <select name="VD[]" data-hide-disabled="hide" multiple data-actions-box="true" id="VD" class="form-control selectpicker VD" multiple data-live-search="true"  >
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[1391,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(VD  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[1391,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
$('#frm_rpt_ledger').on('change','#MODE',function(e){
        var mode = $('#MODE').val();
        if(mode!=''){
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
            url:'<?php echo e(route("report",[1391,"get_customervendor"])); ?>',
            type:'POST',
            data:{'mode':mode},
            success:function(data) {            
                
                $("#VD").html(data);  
                $("#VD").selectpicker("refresh");
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\TDS\rptfrm1391.blade.php ENDPATH**/ ?>