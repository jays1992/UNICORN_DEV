...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[555,'index'])); ?>" class="btn singlebt">Bank Reconcilation Report</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_sis"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Bank</p></div>
                            <div class="col-lg-3 pl" id="div_bank">
                                <select name="BANK[]" data-hide-disabled="hide" multiple data-actions-box="true" id="BANK" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->BID); ?>" selected><?php echo e($cRow->BCODE); ?>-<?php echo e($cRow->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
							 <div class="col-lg-3 pl"><p>Reconcilation Type</p></div>
                            <div class="col-lg-3 pl" id="div_bank2">
                                <select name="RECONCILE" data-hide-disabled="hide"  data-actions-box="true" id="RECONCILE" class="form-control selectpicker"  data-live-search="true"  >
									<option value="" >Select</option>
									<option value="RECONCILE" selected>RECONCILE</option>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[555,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(BANK  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Bank.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
		else if(RECONCILE  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Reconcilation Type.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[555,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/Accounts/BankReconcileRpt/rptfrm555.blade.php ENDPATH**/ ?>