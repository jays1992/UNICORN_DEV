...
<div class="container-fluid filter">
	<form id="form_data" method="POST"  > 
      ...
      <div class="row">
        ...
        <input type="text" name="PL_NO" id="PL_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >

          <span class="text-danger" id="ERROR_PL_NO"></span>
        </div>			
        <div class="col-lg-2 pl"><p>PL Date</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="PL_DT" id="PL_DT" value="<?php echo e(\Carbon\Carbon::now()->format('d/m/Y')); ?>" class="form-control mandatory"  tabindex="2" required readonly> 
        </div>			
...
$(function() { 
  ...
  function getItems(pfrom){
        ...
        $.ajax({
          url:'<?php echo e(route("master",[148,"getItems"])); ?>',
            type:'POST',
...
function checkDuplicateCode(){
	...
	$.ajax({
		url:'<?php echo e(route("master",[148,"codeduplicate"])); ?>',
		type:'POST',
		data:{'PL_NO': codedata},
		success:function(data) {
			if(data.exists) {
...
//----------------------------
 ...
 window.fnConfirm = function(){
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[148,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "<?php echo e(route('master',[148,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\PriceList\mstfrm148add.blade.php ENDPATH**/ ?>