...
<!-- <form id="frm_mst_se" onsubmit="return validateForm()"  method="POST"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Company Holiday</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_comp_edit" method="POST"> 
        <?php echo csrf_field(); ?>
        <?php echo e(isset($HDR->CP_WORKINGID) ? method_field('PUT') : ''); ?>
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="COMPANY_WORKING_CODE" id="COMPANY_WORKING_CODE" value="<?php echo e($HDR->COMPANY_WORKING_CODE); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" disabled >
            <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="COMPANY_WORKING_CODE" id="COMPANY_WORKING_CODE" value="<?php echo e(old('COMPANY_WORKING_CODE')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase" disabled >
            <?php else: ?>
          <input type="text" name="COMPANY_WORKING_CODE" id="COMPANY_WORKING_CODE" value="<?php echo e($HDR->COMPANY_WORKING_CODE); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" disabled >
          <?php endif; ?>
          <input type="hidden" name="CP_WORKINGID"  id="CP_WORKINGID" value="<?php echo e($HDR->CP_WORKINGID); ?>" disabled>
        </div>

        <div class="col-lg-2 pl"><p>Company Working Date*</p></div>
          <div class="col-lg-2 pl">
          <input type="date" name="COMPANY_WORKING_DATE"  id="COMPANY_WORKING_DATE" value="<?php echo e(isset($HDR->COMPANY_WORKING_DATE)?$HDR->COMPANY_WORKING_DATE:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" disabled>
          </div> 
          
          <div class="col-lg-2 pl"><p>Year*</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="YRIDREF" id="YRIDREF"     value="<?php echo e(isset($HDR->YRDESCRIPTION)?$HDR->YRDESCRIPTION:''); ?>" class="form-control mandatory"  autocomplete="off" readonly disabled />
            <input type="hidden" name="YRID_REF" id="YRID_REF" value="<?php echo e(isset($HDR->YRID_REF)?$HDR->YRID_REF:''); ?>" class="form-control" autocomplete="off" disabled/>
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="MTID_popup" id="MTID_popup" value="<?php echo e(isset($HDR->MTCODE)?$HDR->MTCODE:''); ?> - <?php echo e(isset($HDR->MTDESCRIPTION)?$HDR->MTDESCRIPTION:''); ?>" class="form-control mandatory"  autocomplete="off" readonly disabled/>
            <input type="hidden" name="MTID_REF" id="MTID_REF"   value="<?php echo e(isset($HDR->MTID_REF)?$HDR->MTID_REF:''); ?>" class="form-control" autocomplete="off" disabled/>
          ...
          <thead id="thead1" style="position: sticky;top: 0; white-space:none;">
            ...
            <tbody id="MTIDMaterialBdy">
              ...
              <tr class="participantRow">
                  <td><input type="text" name="popupMENU[]" id="popupMENU_<?php echo e($key); ?>" value="<?php echo e($row->WORIDAY_DATE); ?>"  class="form-control"  autocomplete="off"  readonly disabled/></td>
                  <td><input type="checkbox" name="Weeklyoff[]" id="Weeklyoff_<?php echo e($key); ?>" <?php echo e(isset($row->CP_WORKINGID_REF) && $row->CP_WORKINGID_REF == 8 ? 'checked' : ''); ?>  autocomplete="off"  readonly disabled/></td>
                </tr>
                <tr>
              </tr>
      ...
      $('#MTID_popup').click(function(event){
          ...
          $("#emp_closePopup").click(function(event){
            ...
            function loadItem_prod_code(taxstate,CODE,FORMID){
              ...
              $.ajax({
                url:'<?php echo e(route("master",[$FormId,"getMTID"])); ?>',
                type:'POST',
  ...
  $("#YRIDREF").focus(function(event){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[$FormId,"getyearCode"])); ?>',
        type:'POST',
        success:function(data) {
            $('#tbody_subglacct').html(data);
            bindYearEvents();
  ...
  function getmonthyearwisedate(){
    ...
    if(month !='' && year !=''){
      ...
      $.ajax({
          url:'<?php echo e(route("master",[$FormId,"getMTIDMaterial"])); ?>',
          type:'POST',
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\CompanyWorkingDay\mstfrm423view.blade.php ENDPATH**/ ?>