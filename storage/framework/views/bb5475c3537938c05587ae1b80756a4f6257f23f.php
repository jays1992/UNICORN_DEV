<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button id="btnSaveCountryAttachment"   class="btn topnavbt" tabindex="7"><i class="fa fa-save"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_country_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[4,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objCountry->CTRYID); ?>" class="form-control" maxlength="50" >
			</div>
...
<script>  
 ...
 var formCountryMst = $( "#frm_country_attachment" );
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\country\mstfrm4attachment.blade.php ENDPATH**/ ?>