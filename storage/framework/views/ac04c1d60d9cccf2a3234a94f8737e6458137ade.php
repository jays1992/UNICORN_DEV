            ...
            <div id="LeadClosure" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  <div class="col-lg-2 pl">
                    <textarea name="REMARKSNAME" id="REMARKS" style="width: 357px; height: 40px;" class="form-control mandatory"><?php echo e(isset($objResponse->REMARKS) && $objResponse->REMARKS !=''?$objResponse->REMARKS:''); ?></textarea>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <select name="LEAD_FINALSTATUS" id="LEAD_FINALSTATUS" class="form-control">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PreSales\LeadClosure\trnfrm488add.blade.php ENDPATH**/ ?>