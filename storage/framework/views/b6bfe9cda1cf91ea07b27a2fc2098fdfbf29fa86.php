...
<form id="transaction_form"  method="POST">   
    <?php echo csrf_field(); ?>
    <?php echo e(isset($objResponse->MRSID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="MRS_NO" id="MRS_NO" value="<?php echo e(isset($objResponse->MRS_NO) && $objResponse->MRS_NO !=''?$objResponse->MRS_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
      </div>
			
			<div class="col-lg-1 pl"><p>MRS Date</p></div>
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MRS_DT" id="MRS_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->MRS_DT) && $objResponse->MRS_DT !=''?$objResponse->MRS_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>

      <div class="col-lg-1 pl"><p>MRS Type</p></div>
			<div class="col-lg-2 pl" >
        <select <?php echo e($ActionStatus); ?> name="MRS_TYPE" id="MRS_TYPE" class="form-control" >
          <option <?php echo e(isset($objResponse->MRS_TYPE) && $objResponse->MRS_TYPE =='DIRECT'?'selected="selected"':''); ?> value='DIRECT'>DIRECT</option>
          <option <?php echo e(isset($objResponse->MRS_TYPE) && $objResponse->MRS_TYPE =='RGP'?'selected="selected"':''); ?>  value='RGP'>RGP</option>
          <option <?php echo e(isset($objResponse->MRS_TYPE) && $objResponse->MRS_TYPE =='NRGP'?'selected="selected"':''); ?> value='NRGP'>NRGP</option>
        </select>
      </div>

      <div class="col-lg-1 pl"><p>Request User</p></div>
			<div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="REQUEST_USER_popup" id="txtREQUEST_USER_popup" value="<?php echo e(isset($objUserName->EMPCODE) && $objUserName->EMPCODE !=''?$objUserName->EMPCODE.' - '.$objUserName->FNAME.' '.$objUserName->MNAME.' '.$objUserName->LNAME:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
          <input type="hidden" name="REQUEST_USER" id="REQUEST_USER" class="form-control" autocomplete="off" value="<?php echo e(isset($objResponse->REQUEST_USER) && $objResponse->REQUEST_USER !=''?$objResponse->REQUEST_USER:''); ?>" />
			</div>
		</div>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tbody>
      ...
      <table id="RequestUserTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_REQUEST_USER[]" id="spidcode_<?php echo e($key); ?>" class="clssrequestuser" value="<?php echo e($val-> EMPID); ?>" ></td>  
  ...
  <div class="modal-dialog modal-md" style="width:90%;">
    ...
    <tbody>
                <tr>
                  ...
                  <td style="width:10%;"><input type="text" id="Itemcodesearch" class="form-control" autocomplete="off" onkeyup="ItemCodeFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:10%;"><input type="text" id="Itemnamesearch" class="form-control" autocomplete="off" onkeyup="ItemNameFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:8%;"><input type="text" id="ItemUOMsearch" class="form-control"  autocomplete="off" onkeyup="ItemUOMFunction('<?php echo e($FormId); ?>',event)"></td>
                  ...
                  <td style="width:8%;"><input type="text" id="ItemGroupsearch" class="form-control" autocomplete="off" onkeyup="ItemGroupFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:8%;"><input type="text" id="ItemCategorysearch" class="form-control" autocomplete="off" onkeyup="ItemCategoryFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:8%;"><input type="text" id="ItemBUsearch" class="form-control" autocomplete="off" onkeyup="ItemBUFunction('<?php echo e($FormId); ?>',event)" readonly></td>
                  <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemAPNsearch" class="form-control" autocomplete="off" onkeyup="ItemAPNFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemCPNsearch" class="form-control" autocomplete="off" onkeyup="ItemCPNFunction('<?php echo e($FormId); ?>',event)"></td>
                  <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemOEMPNsearch" class="form-control" autocomplete="off" onkeyup="ItemOEMPNFunction('<?php echo e($FormId); ?>',event)"></td>
...
// $('#MRS_DT').attr('max',sodate);
  ...
  var lastdt = <?php echo json_encode($objlastdt[0]->MRS_DT); ?>;
    ...
    if(lastdt < mrs.MRS_DT)
    {
  	$('#MRS_DT').attr('min',lastdt);
    }
    else
    {
	    $('#MRS_DT').attr('min',mrs.MRS_DT);
    }
    $('#MRS_DT').attr('max',sodate);
...
function validateForm(actionType){
  ...
  if(jQuery.inArray("false", allblank) !== -1){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#MRS_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialRequisitionSlip\trnfrm88edit.blade.php ENDPATH**/ ?>