...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Prospect Master</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                        <button class="btn topnavbt" id="btnAdd" disabled="disabled"><i class="fa fa-plus"></i> Add</button>
                        <button class="btn topnavbt" id="btnEdit" disabled="disabled"><i class="fa fa-pencil-square-o"></i> Edit</button>
                        <button class="btn topnavbt" id="btnSaveCountryAttachment" ><i class="fa fa-floppy-o"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_calculation_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[$FormId,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
...
?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label> <?php echo e($objCondition->PCODE); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objCondition->PID); ?>" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> <?php echo e(date("d/m/Y", strtotime($objCondition->INDATE) )); ?> </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='<?php echo e(date("Y-m-d", strtotime($objCondition->INDATE))); ?>'   />
						...
						<tbody>
                            ...
                            <?php
                              ...
                              if(isset($row->FILESNAME) && !empty($row->FILESNAME)){
                                ...
                                $docpath    =   "docs/company".Auth::user()->CYID_REF."/ProspectMaster/".$row->FILESNAME;     
                                $docpath    =   str_replace(' ', '/', $docpath);

                              }
                            ?>
                            <tr  class="participantRow">
                              <td><?php echo e(isset($row->FILESNAME)?$row->FILESNAME:''); ?></td>
...
<script>  
 ...
 var formCalculationMst = $( "#frm_calculation_attachment" );
    ...
    //validate
    $( "#btnSaveCountryAttachment" ).click(function() {
    ...
    window.fnSaveData = function (){
       ...
       $("#frm_calculation_attachment").submit();
       return true;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\ProspectMaster\mstfrm441attachment.blade.php ENDPATH**/ ?>