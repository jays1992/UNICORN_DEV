            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Voucher No</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="PAYMENTID" onchange="getVoucherDetails(this.value)" data-hide-disabled="hide"  data-actions-box="false" id="PAYMENTID" class="form-control selectpicker"  data-live-search="true"  >
                                <option value="">Select</option>
                                <?php $__currentLoopData = $VouList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->VOUCHER_ID); ?>"><?php echo e($val->VOUCHER_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="col-lg-3 pl"><p>Voucher Date</p></div>
                            <div class="col-lg-3 pl">
                                <input type="text" id="VoucherDate" class="form-control mandatory" readonly />
                            </div>  

                        </div>

                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Cheque No</p></div>
                            <div class="col-lg-3 pl">
                                <input type="text" id="ChequeNo" class="form-control mandatory" readonly />
                            </div>
                            
                            <div class="col-lg-3 pl"><p>Cheque Date</p></div>
                            <div class="col-lg-3 pl">
                                <input type="text" id="ChequeDate" class="form-control mandatory" readonly />
                            </div>
                        </div>

                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Cheque Amount</p></div>
                            <div class="col-lg-3 pl">
                                <input type="text" id="ChequeAmount" class="form-control mandatory" readonly />
                            </div>
                            
                            <div class="col-lg-3 pl"><p>Payee</p></div>
                            <div class="col-lg-3 pl">
                                <input type="text" id="Payee" class="form-control mandatory" readonly />
                            </div>
                        </div>
...
$('#btnView').on('click', function() {
        ...
        else if(PAYMENTID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Voucher No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
function getVoucherDetails(PAYMENTID){
    $.ajaxSetup({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        }
    ...
    $.ajax({
        url:'<?php echo e(route("report",[$FORM_ID,"getVoucherDetails"])); ?>',
        type:'POST',
        data:{PAYMENTID:PAYMENTID},
        success:function(data){
            if(data.length > 0){
                $("#VoucherDate").val(data[0].VOUCHER_DATE);
                $("#ChequeNo").val(data[0].CHEQUE_NO);
                $("#ChequeDate").val(data[0].CHEQUE_DATE);
                $("#ChequeAmount").val(data[0].CHEQUE_AMOUNT);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\ChequePrintingReport\rptfrm519.blade.php ENDPATH**/ ?>