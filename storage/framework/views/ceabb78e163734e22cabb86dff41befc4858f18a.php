  ...
  <div class="container-fluid purchase-order-view">    
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="date" name="QIGDT" id="QIGDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" VALUE="<?php echo e(isset($HDR->QIPDT)?$HDR->QIPDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Quality\QualityInspectionAgainstPro\trnfrm389edit.blade.php ENDPATH**/ ?>