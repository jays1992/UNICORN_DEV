            ...
            <div class="inner-form">
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input type="text" onkeypress="return AlphaNumaric(event,this)" name="DOCNO" id="DOCNO" value="<?php echo e(old('DOCNO')); ?>" class="form-control mandatory" autocomplete="off" style="text-transform: uppercase;" autofocus />
                    </div>
...
<script>
    ...
    $('#DOCNO').focusout(function(){
          ...
          if(DOCNO ===""){
            ...
            $.ajax({
                url:'<?php echo e(route("master",[237,"checkdocno"])); ?>',
                type:'POST',
                data:formData,
	...
	if(name){
	  ...
	  el.attr('name', prefix1+(+i+1));
        ...
        window.fnUndoYes = function (){
          //reload form
          window.location.href = "<?php echo e(route('master',[237,'add'])); ?>";
       }//fnUndoYes
...
<script>
    ...
    $.ajax({
        url:'<?php echo e(route("master",[237,"save"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\CustomDuty\mstfrm237add.blade.php ENDPATH**/ ?>