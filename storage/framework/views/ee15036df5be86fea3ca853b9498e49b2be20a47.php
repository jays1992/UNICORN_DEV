...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                    <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">Chart Of Account</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pbs"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>General Ladger</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="GLedger[]" data-hide-disabled="hide" multiple data-actions-box="true" id="GLedger" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjGenLadger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function(e) {
    ...
    $('#btnView').on('click', function() {
        ...
        var GLedger = [];
        $("select[name='GLedger[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                GLedger.push(value4);
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\ChartOfAccount\rptfrm553.blade.php ENDPATH**/ ?>