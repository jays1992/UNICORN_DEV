...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[282,'index'])); ?>" class="btn singlebt">NRGP Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_nrgp"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>NRGP NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="NRGPID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="NRGPID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objNRGPNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dindex=>$DRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($DRow->NRGPID); ?>" selected><?php echo e($DRow->NRGP_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[282,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var NRGPID  = [];
        $("select[name='NRGPID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                NRGPID.push(value7);
            }
        ...
        else if(NRGPID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[282,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\NRGP\rptfrm282.blade.php ENDPATH**/ ?>