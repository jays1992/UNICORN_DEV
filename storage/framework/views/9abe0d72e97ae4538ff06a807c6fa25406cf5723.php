          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="GLCODE" id="GLCODE" value="<?php echo e(old('GLCODE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
                    <span class="text-danger" id="ERROR_GLCODE"></span> 
                  </div>
               
                  <div class="col-lg-1 pl col-md-offset-1"><p>Name</p></div>
                  <div class="col-lg-4 pl">
                    <input type="text" name="GLNAME" id="GLNAME" class="form-control mandatory" value="<?php echo e(old('GLNAME')); ?>" maxlength="100" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="ALIAS" id="ALIAS" value="<?php echo e(old('ALIAS')); ?>" class="form-control" autocomplete="off" maxlength="50" tabindex="3" />
...
"use strict";
 ...
 var formResponseMst = $( "#frm_mst_generalledger" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[93,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[93,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[93,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\GENERALLEDGER\mstfrm93add.blade.php ENDPATH**/ ?>