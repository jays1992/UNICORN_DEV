  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->PROID); ?>" value="<?php echo e($val->PROID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PRO_DT) && $val->PRO_DT !='' && $val->PRO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PRO_DT)):''); ?>" ></td>
          <td><?php echo e(isset($val->PRO_NO) && $val->PRO_NO !=''?$val->PRO_NO:''); ?></td>
          <td><?php echo e(isset($val->PRO_DT) && $val->PRO_DT !='' && $val->PRO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PRO_DT)):''); ?></td>
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[239,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[239,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionOrder\trnfrm239.blade.php ENDPATH**/ ?>