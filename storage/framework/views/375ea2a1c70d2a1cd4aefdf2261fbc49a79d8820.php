...
<div class="container-fluid topnav">
        <div class="row">
            <div class="col-lg-2">
            <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Goods Receipt Note <br/>against RGP</a>
            </div>
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="GRN_NO" id="GRN_NO" value="<?php echo e(isset($objResponse->GRN_NO) && $objResponse->GRN_NO !=''?$objResponse->GRN_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="GRN_DT" id="GRN_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->GRN_DT) && $objResponse->GRN_DT !=''?$objResponse->GRN_DT:''); ?>" class="form-control mandatory" >
      </div>
      ...
      <div class="col-lg-1 pl"><p id='fieldtype' ><?php echo e($objResponse->TYPE); ?></p></div>
			<div class="col-lg-2 pl">
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="txtRGP_popup_<?php echo e($key); ?>" id="txtRGP_popup_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                  <td hidden><input type="hidden" name="RGP_NO_<?php echo e($key); ?>" id="RGP_NO_<?php echo e($key); ?>" value="<?php echo e($row->RGPID_REF); ?>"  class="form-control" autocomplete="off" /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SE_QTY_".$key); ?> id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="<?php echo e($row->BILL_CH_QTY); ?>" autocomplete="off"  /></td>
                  ...
                  <td>
                    <select <?php echo e($ActionStatus); ?> name="NATURE_<?php echo e($key); ?>" id="NATURE_<?php echo e($key); ?>" class="form-control"  autocomplete="off" >
                      <option <?php echo e(isset($row->NATURE) && $row->NATURE ==='Fresh'?'selected="selected"':''); ?> value="Fresh">Fresh</option>
                      <option <?php echo e(isset($row->NATURE) && $row->NATURE ==='Defective'?'selected="selected"':''); ?> value="Defective">Defective</option>
                    </select>
                  </td>

                  <td><input <?php echo e($ActionStatus); ?> type="text" name="RECEIVED_QTY_MU_<?php echo e($key); ?>" id="RECEIVED_QTY_MU_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_QTY_MU); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
                  ...
                  <!--
                  <td><input  class="form-control w-100" type="date" name=<?php echo e("EDD_".$key); ?> id=<?php echo e("EDD_".$key); ?>  ></td>
                  -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\GrnReturnableGatePass\trnfrm158edit.blade.php ENDPATH**/ ?>