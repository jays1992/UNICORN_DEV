...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <input type="text" name="RCODE" id="RCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
			</div>
      ...
      <div class="row">
        ...
        <div class="col-lg-11">
          <ul >
              ...
              <li style="list-style: none; padding: 6px 0; display: inline-table;padding-right: 15px;"><input style="margin-right: 5px;" type="checkbox" name="MODULE_NAME_<?php echo e($mod_row->MODULEID_REF); ?>"  id="MODULE_NAME_<?php echo e($mod_row->MODULEID_REF); ?>" value="<?php echo e($mod_row->MODULEID_REF); ?>"><?php echo e($mod_row->MODULENAME); ?> </li>     
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('master',[198,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("master",[198,"save"])); ?>',
    type:'POST',
    data:formData,
...
$('#selectAMOUNT').click(function(){ 
      ...
      function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[198,"codeduplicate"])); ?>',
            type:'POST',
            data:{'RCODE':RCODE},
            success:function(data) {
                if(data.exists) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\RoleMaster\mstfrm198add.blade.php ENDPATH**/ ?>