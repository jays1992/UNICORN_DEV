...
<!-- <form id="frm_rpt_sos" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[253,'index'])); ?>" class="btn singlebt">Dispatch Summary State Wise</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl" id="div_state">
                                <select name="STID1[]" id="STID1" class="form-control selectpicker" multiple data-live-search="true"  >
                                </select>
                            </div>
                        </div>
                        <div class="row">
...
$(document).ready(function(e) {
   ...
   $('#To_Date').change(function(){
       ...
       if(From_Date != '' && To_Date != '')
       {
                ...
                $.ajax({
                    url:'<?php echo e(route("report",[253,"GetState"])); ?>',
                    type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\DispatchSummaryStatewise\rptfrm253.blade.php ENDPATH**/ ?>