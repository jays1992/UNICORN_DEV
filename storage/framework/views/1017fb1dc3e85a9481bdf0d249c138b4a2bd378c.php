...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Job Work Return (JWR)</a>
                </div><!--col-2-->
      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input disabled type="text" name="JWRNO" id="JWRNO" value="<?php echo e(isset($DATA_HDR->JWRNO)?$DATA_HDR->JWRNO:NULL); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
          </div>
            
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="date" name="JWRDT" id="JWRDT" value="<?php echo e(isset($DATA_HDR->JWRDT)?$DATA_HDR->JWRDT:NULL); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-2 pl"><p>Vendor</p></div>
          <div class="col-lg-2 pl">
              <input disabled type="text" name="txtVID_popup" id="txtVID_popup"  value="<?php echo e(isset($objsubglcode->VCODE)?$objsubglcode->VCODE:''); ?> - <?php echo e(isset($objsubglcode->NAME)?$objsubglcode->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
              <input type="hidden" name="VID_REF" id="VID_REF" value="<?php echo e(isset($DATA_HDR->VID_REF)?$DATA_HDR->VID_REF:NULL); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="VENDOR_INVOICE_NO" id="VENDOR_INVOICE_NO" value="<?php echo e(isset($DATA_HDR->Vendor_Invoice_No)?$DATA_HDR->Vendor_Invoice_No:NULL); ?>" autocomplete="off" class="form-control" maxlength="200"  >
          </div>

          <div class="col-lg-2 pl"><p>Mode Of Transport</p></div>
          <div class="col-lg-2 pl">
            <select disabled  name="TRANSPORT_MODE" id="TRANSPORT_MODE" class="form-control" autocomplete="off" >
              <option value="">Select</option>
              <option <?php echo e(isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Road'?'selected="selected"':''); ?> value="By Road">By Road</option>
              <option <?php echo e(isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Sea'?'selected="selected"':''); ?> value="By Sea">By Sea</option>
              <option <?php echo e(isset($DATA_HDR->TRANSPORT_MODE) && $DATA_HDR->TRANSPORT_MODE =='By Air'?'selected="selected"':''); ?> value="By Air">By Air</option>
            </select>
          </div>

          <div class="col-lg-2 pl"><p>Vehicle No</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="text" name="VCL_NO" id="VCL_NO" value="<?php echo e(isset($DATA_HDR->VECHILE_NO)?$DATA_HDR->VECHILE_NO:NULL); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="<?php echo e(isset($DATA_HDR->TRANSPORTER_CODE)?$DATA_HDR->TRANSPORTER_CODE:NULL); ?> - <?php echo e(isset($DATA_HDR->TRANSPORTER_NAME)?$DATA_HDR->TRANSPORTER_NAME:NULL); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="TRASPORTER_NAME" id="TRASPORTER_NAME" value="<?php echo e(isset($DATA_HDR->TRANSPORTERID_REF)?$DATA_HDR->TRANSPORTERID_REF:NULL); ?>" class="form-control" autocomplete="off" />                                                              
          </div>

          <div class="col-lg-2 pl"><p>Driver Name</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="<?php echo e(isset($DATA_HDR->DRIVER_NAME)?$DATA_HDR->DRIVER_NAME:NULL); ?>" autocomplete="off" class="form-control" maxlength="200"  >
          </div>

          <div class="col-lg-2 pl"><p>Purpose</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="text" name="PURPOSE" id="PURPOSE" value="<?php echo e(isset($DATA_HDR->PURPOSE)?$DATA_HDR->PURPOSE:NULL); ?>"  autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        </div>
...
<tbody>
<?php if(!empty($DATA_MAT)): ?>
<?php $__currentLoopData = $DATA_MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<td hidden><input type="hidden" id="exist_<?php echo e($key); ?>" name="exist_<?php echo e($key); ?>" value="<?php echo e($item_unique_row_id); ?>" > </td>
...
<td><input disabled type="text" name="txtJWID_popup_<?php echo e($key); ?>" id="txtJWID_popup_<?php echo e($key); ?>" value="<?php echo e($row->JWINO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td hidden><input type="hidden" name="JWID_REF_<?php echo e($key); ?>" id="JWID_REF_<?php echo e($key); ?>"  value="<?php echo e($row->JWIID_REF); ?>" class="form-control" autocomplete="off" /></td>

<td hidden><input type="text" name="GEJID_REF_<?php echo e($key); ?>" id="GEJID_REF_<?php echo e($key); ?>" value="<?php echo e($row->GEJID_REF); ?>" class="form-control" autocomplete="off" /></td>      
<td hidden><input type="text" name="GRJID_REF_<?php echo e($key); ?>" id="GRJID_REF_<?php echo e($key); ?>" value="<?php echo e($row->GRJID_REF); ?>" class="form-control" autocomplete="off" /></td>      
<td hidden><input type="text" name="JWCID_REF_<?php echo e($key); ?>" id="JWCID_REF_<?php echo e($key); ?>" value="<?php echo e($row->JWCID_REF); ?>" class="form-control" autocomplete="off" /></td>
<td hidden><input type="text" name="JWOID_REF_<?php echo e($key); ?>" id="JWOID_REF_<?php echo e($key); ?>" value="<?php echo e($row->JWOID_REF); ?>" class="form-control" autocomplete="off" /></td>
<td hidden><input type="text" name="PROID_REF_<?php echo e($key); ?>" id="PROID_REF_<?php echo e($key); ?>" value="<?php echo e($row->PROID_REF); ?>" class="form-control" autocomplete="off" /></td>
...
<td hidden><input type="hidden" name="SSO_DATE_<?php echo e($key); ?>" id="SSO_DATE_<?php echo e($key); ?>" class="form-control" ></td>
<td hidden><input type="hidden" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" class="form-control" ></td>
<td hidden><input type="hidden" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>"   class="form-control" ></td>

<td hidden><input type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input disabled type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" value="<?php echo e($row->RECV_QTY); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
<td hidden><input type="text" name="SI_RATE_<?php echo e($key); ?>" id="SI_RATE_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text"   name="GRNNO_<?php echo e($key); ?>" id="GRNNO_<?php echo e($key); ?>" value="<?php echo e($row->GRNNO); ?>" class="form-control"   autocomplete="off" style="width:150px;" readonly /></td>  

<td align="center"><a disabled class="btn checkstore" onclick="getStore(this.id)"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
<td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY); ?>" ></td>
...
<td><input disabled type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY); ?>" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off" readonly  style="width:75px;" /></td>
<td><input disabled type="text"   name="STORE_NAME_<?php echo e($key); ?>" id="STORE_NAME_<?php echo e($key); ?>" value="<?php echo e($row->STORE_NAME); ?>" class="form-control"   autocomplete="off" style="width:200px;" readonly /></td>  
<td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
...
<td><input disabled type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_PUOM); ?>" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input disabled type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>" value="<?php echo e($TaxAmt); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input disabled type="checkbox" value="<?php echo e($row->GST); ?>" name='flagtype_<?php echo e($key); ?>' id="flagtype_<?php echo e($key); ?>" <?php echo e($GST_FLAGE_CHECKED); ?> ></td>

<td><input disabled type="text" name="IGST_<?php echo e($key); ?>" id="IGST_<?php echo e($key); ?>" value="<?php echo e($row->IGST); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="IGSTAMT_<?php echo e($key); ?>" id="IGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($IGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGST_<?php echo e($key); ?>" id="CGST_<?php echo e($key); ?>" value="<?php echo e($row->CGST); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGSTAMT_<?php echo e($key); ?>" id="CGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($CGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGST_<?php echo e($key); ?>" id="SGST_<?php echo e($key); ?>" value="<?php echo e($row->SGST); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGSTAMT_<?php echo e($key); ?>" id="SGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($SGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TGST_AMT_<?php echo e($key); ?>" id="TGST_AMT_<?php echo e($key); ?>" value="<?php echo e($TOTGST); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TOT_AMT_<?php echo e($key); ?>" id="TOT_AMT_<?php echo e($key); ?>" value="<?php echo e($TOTAL); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <!--
                                                    <td hidden><input type="hidden" name="SSI_UDFID_<?php echo e($Ukey); ?>" id="SSI_UDFID_<?php echo e($Ukey); ?>"  class="form-control" autocomplete="off" /></td>
                                                    -->
                                                    <td><input disabled type="text" name=<?php echo e("popupUDFSOID_".$Ukey); ?> id=<?php echo e("popupUDFSOID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$Ukey); ?>  id=<?php echo e("UDFSOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFJWRID_REF); ?>" autocomplete="off" /></td>
                                            ...
                                            <?php $__currentLoopData = $objUdfSOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <!--
                                                  <td hidden><input type="hidden" name="SSI_UDFID_<?php echo e($uindex); ?>" id="SSI_UDFID_<?php echo e($uindex); ?>"  class="form-control" autocomplete="off" /></td>
                                                  -->
                                                  <td><input disabled type="text" name=<?php echo e("popupUDFSOID_".$uindex); ?> id=<?php echo e("popupUDFSOID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                                            ...
                                            <?php if(!empty($objSOCAL)): ?>
                                                <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        <!--
                                                        <td hidden><input type="hidden" name="SSI_CALID_<?php echo e($Ckey); ?>" id="SSI_CALID_<?php echo e($Ckey); ?>"  class="form-control" autocomplete="off" /></td>
                                                        -->
                                                        ...
                                                        <td><input disabled type="text" name=<?php echo e("AMTIGST_".$Ckey); ?> id=<?php echo e("AMTIGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input disabled type="text" name=<?php echo e("AMTCGST_".$Ckey); ?> id=<?php echo e("AMTCGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input disabled type="text" name=<?php echo e("AMTSGST_".$Ckey); ?> id=<?php echo e("AMTSGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input disabled type="text" name=<?php echo e("TOTGSTAMT_".$Ckey); ?> id=<?php echo e("TOTGSTAMT_".$Ckey); ?> class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td style="text-align:center;"><input disabled type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?>  ></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td style="text-align:center;"><input disabled type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                                                    <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            <?php endif; ?> 
...
$( "#btnSaveData" ).click(function() {
  var formSalesOrder = $("#frm_trn_view");
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkReturn\trnfrm360view.blade.php ENDPATH**/ ?>