...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->BPOID); ?>" value="<?php echo e($val->BPOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->BPO_DT) && $val->BPO_DT !='' && $val->BPO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BPO_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->BPO_NO) && $val->BPO_NO !=''?$val->BPO_NO:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Purchase/BlanketPurchaseOrder/trnfrm67.blade.php ENDPATH**/ ?>