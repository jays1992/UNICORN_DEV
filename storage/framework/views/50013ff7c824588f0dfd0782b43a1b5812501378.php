...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <input <?php echo e($ActionStatus); ?> type="text" name="PI_NO" id="PI_NO" value="<?php echo e(isset($objMstResponse->PI_NO)?$objMstResponse->PI_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
				    <input <?php echo e($ActionStatus); ?> type="date" name="PI_DT" id="PI_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)"  class="form-control mandatory" value="<?php echo e(isset($objMstResponse->PI_DT)?$objMstResponse->PI_DT:''); ?>"  placeholder="dd-mm-yyyy" >
      </div>
...
$("#btnSaveFormData").click(function() {
    ...
    if(formItemMst.valid()){
      ...
      if(commonvalidation()){
        ...
        if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#PI_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseIndent\trnfrm59edit.blade.php ENDPATH**/ ?>