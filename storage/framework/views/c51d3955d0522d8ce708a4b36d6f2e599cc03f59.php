...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->CP_WORKINGID); ?>" value="<?php echo e($val->CP_WORKINGID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->COMPANY_WORKING_CODE) && $val->COMPANY_WORKING_CODE !=''?$val->COMPANY_WORKING_CODE:''); ?></td>
                <td><?php echo e(isset($val->COMPANY_WORKING_DATE) && $val->COMPANY_WORKING_DATE !=''?$val->COMPANY_WORKING_DATE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\CompanyWorkingDay\mstfrm423.blade.php ENDPATH**/ ?>