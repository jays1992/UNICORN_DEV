...
<?php $__env->startSection('content'); ?>
  ...
  <?php echo csrf_field(); ?>  
  <?php echo e(isset($objMstResponse->DSPID) ? method_field('PUT') : ''); ?>
  ...
  <div class="container-fluid filter">
	...
	<div class="inner-form">
        ...
        <input <?php echo e($InputStatus); ?> type="text" name="DSPNO" id="DSPNO" value="<?php echo e(isset($objMstResponse->DSPNO)?$objMstResponse->DSPNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			</div>
			
			<div class="col-lg-2 pl "><p>Daily Sales Plan Date*</p></div>
			<div class="col-lg-2 pl">
				    <input <?php echo e($InputStatus); ?> type="date" name="DSPDT" id="DSPDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objMstResponse->DSPDT)?$objMstResponse->DSPDT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
			<div class="col-lg-2 pl"><p>Customer*</p></div>
			<div class="col-lg-2 pl">
                <input <?php echo e($InputStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e(isset($objslcode2->SGLCODE)?$objslcode2->SGLCODE:''); ?> <?php echo e(isset($objslcode2->SLNAME)?'-'.$objslcode2->SLNAME:''); ?>"  autocomplete="off" readonly/>
                <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e(isset($objMstResponse->SLID_REF)?$objMstResponse->SLID_REF:''); ?>" class="form-control" autocomplete="off" />
                <input type="hidden" name="GLID_REF" id="GLID_REF"  value="<?php echo e(isset($objMstResponse->GLID_REF)?$objMstResponse->GLID_REF:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
					<div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
						<table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
							<thead id="thead1"  style="position: sticky;top: 0">
								  <tr>
									<th>SO No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objList1Count); ?>"></th>
									<th>Item Code</th>
									<th>Item Name</th>
                ...
                <?php if(!empty($objList1)): ?>
                  ...
                  ?>
                    ...
                    <td hidden><input type="text" name="recordId_<?php echo e($key); ?>" id="txtrecordId_<?php echo e($key); ?>" class="form-control" value="<?php echo e($CustomId); ?>"  autocomplete="off"  readonly/></td>
                    
                    <td hidden><input type="text" name="SQA_REF_<?php echo e($key); ?>" id="txtSQA_REF_<?php echo e($key); ?>" value="<?php echo e($row->SQID_REF); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input type="text" name="SEQID_REF_<?php echo e($key); ?>" id="txtSEQID_REF_<?php echo e($key); ?>" value="<?php echo e($row->SEID_REF); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                    
                    <td><input <?php echo e($InputStatus); ?> type="text" name="SOrd_popup_<?php echo e($key); ?>" id="txtSOrd_popup_<?php echo e($key); ?>" value="<?php echo e($row->SONO); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input type="text" name="SOrdID_<?php echo e($key); ?>" id="HDNSOrdID_<?php echo e($key); ?>" value="<?php echo e($row->SOID_REF); ?>" class="form-control" autocomplete="off" /></td>
                    <td><input <?php echo e($InputStatus); ?> type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>                    
                    ...
                    <td><input <?php echo e($InputStatus); ?> type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->NAME); ?>"   autocomplete="off"  readonly/></td>
                    ...
                    <td><input <?php echo e($InputStatus); ?> type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->UOMCODE); ?> - <?php echo e($row->DESCRIPTIONS); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                    ...
                    <td><input <?php echo e($InputStatus); ?> type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEMSPECI); ?>"  class="form-control"  autocomplete="off"  /></td>
                    <td><input <?php echo e($InputStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->SO_QTY); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly /></td>
                    <td ><input <?php echo e($InputStatus); ?> type="text" name="BAL_SOQTY_<?php echo e($key); ?>" id="BAL_SOQTY_<?php echo e($key); ?>" value="<?php echo e($row->BAL_SOQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
                    <td ><input <?php echo e($InputStatus); ?> type="text" name="EXP_DIS_QTY_<?php echo e($key); ?>" id="EXP_DIS_QTY_<?php echo e($key); ?>" value="<?php echo e($row->EXPDPQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  /></td>
                    <td align="center" >
              ...
              <?php $__currentLoopData = $objUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfkey => $udfrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr  class="participantRow2">
                    <td>
                      <input <?php echo e($InputStatus); ?> name=<?php echo e("udffie_popup_".$udfkey); ?> id=<?php echo e("txtudffie_popup_".$udfkey); ?> value="<?php echo e($udfrow->LABEL); ?>" class="form-control <?php if($udfrow->ISMANDATORY==1): ?> mandatory <?php endif; ?>" autocomplete="off" maxlength="100" disabled/>
                    </td>

                    <td hidden>
                      <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDF_DSPID_REF); ?>" class="form-control" maxlength="100" />
                    </td>
...
$("#btnSaveFormData").click(function() {
  ...
  if(formItemMst.valid()){
    ...
    if(commonvalidation()){
      ...
      if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#DSPDT").val(),0) ==0){
        $("#YesBtn").hide();
        $("#NoBtn").hide();
        $("#OkBtn").hide();
        $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\DailySalesPlan\trnfrm42edit.blade.php ENDPATH**/ ?>