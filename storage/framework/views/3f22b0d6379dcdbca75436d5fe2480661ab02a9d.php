...
<div class="container-fluid purchase-order-view filter">     
    ...
    <div class="row">
      ...
      <input type="text" name="COMPANY_HOLIDAY_CODE" id="COMPANY_HOLIDAY_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >

      <!-- <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
        <input type="text" name="COMPANY_HOLIDAY_CODE" id="COMPANY_HOLIDAY_CODE" value="<?php echo e(isset($objAutoGenNo)?$objAutoGenNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      ...
      <div class="col-lg-2 pl"><p>Company Holiday Date*</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="COMPANY_HOLIDAY_DATE" id="COMPANY_HOLIDAY_DATE" value="<?php echo e(old('COMPANY_HOLIDAY_DATE')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div> 
        ...
        <div class="col-lg-2 pl">
          <select name="FYID_REF" id="FYID_REF" class="form-control mandatory">
            ...
            <?php $__currentLoopData = $objFnlyearList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table id="example2" class="display nowrap table table-striped table-bordered itemlist itemlistscroll w-150" style="height:auto !important;">
              ...
              <td style="width:16%;"><select class="form-control" name="HOLIDAYTYPEID_REF_0" id="txtdesc_0" >
								<option value="" selected="">Select</option>
                <?php $__currentLoopData = $objHldTypeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($val->HOLIDAYTYPEID); ?>"><?php echo e($val->HOLIDAY_TYPE); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
              </td>
...
$(document).ready(function(e) {
  ...
  $('#btnAdd').on('click', function() {
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[268,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\CompanyHoliday\mstfrm268add.blade.php ENDPATH**/ ?>