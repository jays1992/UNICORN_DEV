...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->VQCID); ?>" value="<?php echo e($val->VQCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->VQC_DT) && $val->VQC_DT !='' && $val->VQC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->VQC_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->VQC_NO) && $val->VQC_NO !=''?$val->VQC_NO:''); ?></td>
              <td><?php echo e(isset($val->VQC_DT) && $val->VQC_DT !='' && $val->VQC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->VQC_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\VendorQuotationComparision\trnfrm62.blade.php ENDPATH**/ ?>