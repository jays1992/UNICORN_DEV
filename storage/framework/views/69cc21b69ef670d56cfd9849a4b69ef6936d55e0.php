...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[349,'index'])); ?>" class="btn singlebt">Debit Note Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_debitnote"  method="POST">   
            <?php echo csrf_field(); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                <?php $__currentLoopData = $ObjVendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row"> 
                        <div class="col-lg-3 pl"><p>DSV NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="DSVID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="DSVID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objDSVNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dindex=>$DRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($DRow->DSVID); ?>" selected><?php echo e($DRow->DSV_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[349,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var DSVID  = [];
        $("select[name='DSVID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                DSVID.push(value7);
            }
        ...
        else if(DSVID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select DSV NO.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            $('#Flag').val('H');
            var trnsoForm = $("#frm_rpt_debitnote");
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[349,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\Debit_Note_Register\rptfrm349.blade.php ENDPATH**/ ?>