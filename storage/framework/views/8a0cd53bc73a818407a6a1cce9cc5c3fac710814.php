          ...
          <?php echo csrf_field(); ?>
              ...
              <div class="inner-form">
                <div class="inner-form">
                  ...
                  ?>
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="CHECKLIST_DT" id="CHECKLIST_DT" disabled class="form-control mandatory" value="<?php echo e(old('CHECKLIST_DT', $chklist_date )); ?>" placeholder="dd/mm/yyyy"/>
              ...
              <div class="row">
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="CHECKLIST_DESC" id="CHECKLIST_DESC" disabled class="form-control " value="<?php echo e(old('CHECKLIST_DESC',  $objMstHeader->CHECKLIST_DESC)); ?>" maxlength="200"  />
              ...
              <div class="row">
                ...
                <input type="checkbox"   name="HDR_DEACTIVATED"  disabled  id="deactive-checkbox_0" <?php echo e($objMstHeader->DEACTIVATED == 1 ? "checked" : ""); ?>
                ...
                <div class="col-lg-2 pl">
                  <input type="date" name="HDR_DODEACTIVATED"  disabled  class="form-control" id="HDR_DODEACTIVATED" <?php echo e($objMstHeader->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objMstHeader->DODEACTIVATED) && $objMstHeader->DODEACTIVATED !="" && $objMstHeader->DODEACTIVATED !="1900-01-01" ? $objMstHeader->DODEACTIVATED:''); ?>" placeholder="dd/mm/yyyy"  />
                </div>
              </div>
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input type="text" disabled  name=<?php echo e("txtFORM_popup_".$key); ?> id=<?php echo e("txtFORM_popup_".$key); ?> class="form-control" value="<?php echo e($row->MP_CODE); ?>"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              ...
                              <td><input  disabled  class="form-control" style="width: 100%" type="text" name=<?php echo e("FORMNAME_".$key); ?> id =<?php echo e("FORMNAME_".$key); ?> value="<?php echo e($row->MP_DESC); ?>"  style="width:200px;" autocomplete="off" readonly></td>
                              ...
                              <td><input disabled  type="text" name=<?php echo e("txtLISTPOP1_popup_".$key); ?> id=<?php echo e("txtLISTPOP1_popup_".$key); ?>  value="<?php echo e($row->MSP_CODE); ?>" class="form-control "  autocomplete="off"  readonly style="width:100px;" /></td>
                              <td><input  disabled  class="form-control w-100" type="text" name=<?php echo e("DESC2_".$key); ?>       id =<?php echo e("DESC2_".$key); ?>  value="<?php echo e($row->MSP_DESC); ?>"  style="width:100%;"  autocomplete="off" readonly></td>
                              
                              <td align="center"><input disabled  type="checkbox" name=<?php echo e("DEACTIVATED_".$key); ?>    id =<?php echo e("CHKDEACTIVATED_".$key); ?> value="<?php echo e($row->DEACTIVATED == 1 ? "1" : "0"); ?>" <?php echo e($row->DEACTIVATED == 1 ? "checked" : ""); ?> ></td>
                              <td><input  class="form-control" disabled  type="date" name=<?php echo e("DODEACTIVATED_".$key); ?>  id =<?php echo e("DODEACTIVATED_".$key); ?>  value="<?php echo e($deactivate_date); ?>" ></td>
                              <td align="center" >
                                  <button class="btn add"  disabled  title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                                  <button class="btn remove"  disabled  title="Delete" data-toggle="tooltip" <?php echo e(isset($n) && $n ==1?'disabled':''); ?>  ><i class="fa fa-trash" ></i></button>
                              </td>
                          </tr>
                          <?php $n++; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\MaintenanceChecklist\mstfrm227view.blade.php ENDPATH**/ ?>