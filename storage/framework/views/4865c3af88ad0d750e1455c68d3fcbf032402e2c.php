...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Assembling/Dissembling</a>
        </div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(isset($objResponse->ADSMNO)?$objResponse->ADSMNO:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          <input type="hidden" name="ADSMID" id="ADSMID" value="<?php echo e(isset($objResponse->ADSMID)?$objResponse->ADSMID:''); ?>" >
        </div>
              
        <div class="col-lg-1 pl"><p>Doc Date</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($objResponse->ADSMDT)?$objResponse->ADSMDT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>

        <div class="col-lg-1 pl"><p>Type</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="TYPE" id="TYPE" class="form-control" >
            <option <?php echo e(isset($objResponse) && $objResponse->TYPE=='ASSEMBLING'?'selected="selected"':''); ?> value="ASSEMBLING">ASSEMBLING</option><!-- OUT -->
            <option <?php echo e(isset($objResponse) && $objResponse->TYPE=='DISSEMBLING'?'selected="selected"':''); ?> value="DISSEMBLING">DISSEMBLING</option><!-- IN -->
          </select>
        </div>

        <div class="col-lg-1 pl"><p>Item</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"    name="MAIN_ITEMID_NAME" id="MAIN_ITEMID_NAME" value="<?php echo e(isset($objResponse->ICODE)?$objResponse->ICODE:''); ?>" class="form-control" readonly >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="STID_REF_NAME" id="STID_REF_NAME" value="<?php echo e(isset($objResponse->STCODE)?$objResponse->STCODE:''); ?><?php echo e(isset($objResponse->STNAME)?'-'.$objResponse->STNAME:''); ?>" onclick="modal('show')" class="form-control mandatory"  autocomplete="off" readonly/>
          <input type="hidden" name="STID_REF" id="STID_REF" value="<?php echo e(isset($objResponse->STID_REF)?$objResponse->STID_REF:''); ?>" class="form-control" autocomplete="off" />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="AMOUNT" id="AMOUNT" value="<?php echo e(isset($objResponse->AMOUNT)?$objResponse->AMOUNT:''); ?>" class="form-control" readonly >
        </div>
      </div>
    </div>
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  <tr>
                    <th>Item Code <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e(isset($objMAT)?count($objMAT):1); ?>" ></th>
                    <th>Item Name</th>
                    <th>UOM</th>
                    <th>Store</th>
                    <th>Qty</th>
                  ...
                  <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_QTY); ?>" ></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text"  name="QTY_<?php echo e($key); ?>" id="QTY_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"  type="text" name="RATE_<?php echo e($key); ?>" id="RATE_<?php echo e($key); ?>" value="<?php echo e($row->RATEPUOM); ?>" class="form-control three-digits" onkeyup="getValue()" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  <?php echo e(isset($objResponse) && $objResponse->TYPE=='DISSEMBLING'?'readonly':''); ?> /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"  name="VALUE_<?php echo e($key); ?>" id="VALUE_<?php echo e($key); ?>" value="<?php echo e($row->VALUE); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)"   autocomplete="off" readonly /></td>
          ...
          <table id="ItemIDTable" class="display nowrap table  table-striped table-bordered" style="width:100%" >
            ...
            <tbody>
              <tr>
                ...
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemAPNsearch" class="form-control" autocomplete="off" onkeyup="ItemSearch(this.id,8)"></td>
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemCPNsearch" class="form-control" autocomplete="off" onkeyup="ItemSearch(this.id,9)"></td>
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="ItemOEMPNsearch" class="form-control" autocomplete="off" onkeyup="ItemSearch(this.id,10)"></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\AssemblingDissembling\trnfrm490view.blade.php ENDPATH**/ ?>