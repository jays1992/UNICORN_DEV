...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <input <?php echo e($ActionStatus); ?> type="text" name="RFQ_NO" id="RFQ_NO" value="<?php echo e(isset($objMstResponse->RFQ_NO)?$objMstResponse->RFQ_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
				    <input <?php echo e($ActionStatus); ?> type="date" name="RFQ_DT" id="RFQ_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objMstResponse->RFQ_DT)?$objMstResponse->RFQ_DT:''); ?>" class="form-control mandatory"  placeholder="dd-mm-yyyy" >
      </div>
...
$("#btnSaveFormData").click(function() {
    ...
    if(formItemMst.valid()){
      ...
      if(commonvalidation()){
        ...
        if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#RFQ_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\RequestForQuotation\trnfrm60edit.blade.php ENDPATH**/ ?>