...
<div class="container-fluid purchase-order-view filter">     
    ...
    <div class="row">
        ...
        <input type="text" name="LEAD_NO" id="LEAD_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
      ...
      <div class="col-lg-2 pl"><p>Lead Date*</p></div>
        <div class="col-lg-2 pl">
        <input type="date" name="LEAD_DT" id="LEAD_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("LEAD_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('LEAD_DT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
      </div> 
    ...
    <div class="row">
      <div class="col-lg-2 pl"><p id="CUSTOMER_TITLE">Customer</p></div>
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="DEALER" id="DEALER" onclick="getData('<?php echo e(route('transaction',[$FormId,'getDealerCode'])); ?>','Dealer Details')" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">      
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="COMPANY_NAME" id="COMPANY_NAME" value="<?php echo e(old('COMPANY_NAME')); ?>" class="form-control mandatory" autocomplete="off">                            
        </div>

        <input type="hidden" name="FNAME" id="FNAME" value="<?php echo e(old('FNAME')); ?>" class="form-control mandatory" autocomplete="off"> 
        <input type="hidden" name="LNAME" id="LNAME" value="<?php echo e(old('LNAME')); ?>" class="form-control mandatory" autocomplete="off">                           

      <div class="col-lg-2 pl"><p>Contact Person</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="CONTACT_PERSON" id="CONTACT_PERSON" value="<?php echo e(old('CONTACT_PERSON')); ?>" class="form-control mandatory" autocomplete="off">                            
      </div> 
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="COUNTRY" id="COUNTRY" onclick="getData('<?php echo e(route('transaction',[$FormId,'getCountryCode'])); ?>','Country Details')" class="form-control mandatory"  autocomplete="off" readonly/>
    ...
    <div class="row">      
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="PINCODE" id="PINCODE" value="<?php echo e(old('PINCODE')); ?>" onkeypress="return onlyNumberKey(event)" maxlength="6" class="form-control mandatory" autocomplete="off" readonly>                             
      </div>
    
      <div class="col-lg-2 pl"><p>Lead Owner*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="LOWNER" id="LOWNER" onclick="getData('<?php echo e(route('transaction',[$FormId,'getLeadOwnerCode'])); ?>','Lead Owner Details')" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="INTYPE" id="INTYPE" onclick="getData('<?php echo e(route('transaction',[$FormId,'getIndustryTypeCode'])); ?>','Industry Type Details')" class="form-control mandatory"  autocomplete="off" readonly/>
    ...
    <div class="row">    
      ...
      <div class="col-lg-2 pl">
        <select name="DESIGNID_REF" id="DESIGNID_REF" class="form-control mandatory">
          ...
          <option value="<?php echo e($val->DESGID); ?>"><?php echo e($val->DESGCODE); ?> - <?php echo e($val->DESCRIPTIONS); ?></option>  
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="LEAD_DETAILS" id="LEAD_DETAILS" value="<?php echo e(old('LEAD_DETAILS')); ?>" class="form-control mandatory" autocomplete="off">                            
      </div>

      <div class="col-lg-2 pl"><p>Website</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="WEBSITENAME" id="WEBSITENAME" value="<?php echo e(old('WEBSITENAME')); ?>" class="form-control">                            
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="LANDNUMBER" id="LANDNUMBER" value="<?php echo e(old('LANDNUMBER')); ?>" onkeypress="return onlyNumberKey(event)" class="form-control mandatory" autocomplete="off">                            
      </div>

      <div class="col-lg-2 pl"><p>Mobile Number*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="MOBILENUMBER" id="MOBILENUMBER" value="<?php echo e(old('MOBILENUMBER')); ?>" onkeypress="return onlyNumberKey(event)" maxlength="12" class="form-control mandatory" autocomplete="off">                           
      </div>

      <div class="col-lg-2 pl"><p>E-Mail*</p></div>
      <div class="col-lg-2 pl">
        <input type="email" name="EMAIL" id="EMAIL" value="<?php echo e(old('EMAIL')); ?>" class="form-control mandatory" autocomplete="off">                            
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="LSOURCE" id="LSOURCE" onclick="getData('<?php echo e(route('transaction',[$FormId,'getLeadSourceCode'])); ?>','Lead Source Details')" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="col-lg-2 pl">
        <input type="text" name="LSTATUS" id="LSTATUS" onclick="getData('<?php echo e(route('transaction',[$FormId,'getLeadStatusCode'])); ?>','Lead Status Details')" value="<?php echo e(isset($DataStatus->LEAD_STATUSCODE) && $DataStatus->LEAD_STATUSCODE !=''?$DataStatus->LEAD_STATUSCODE:''); ?><?php echo e(isset($DataStatus->LEAD_STATUSNAME) && $DataStatus->LEAD_STATUSNAME !=''?'-'.$DataStatus->LEAD_STATUSNAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
        <input type="hidden" name="LSTATUSID_REF" id="LSTATUSID_REF" value="<?php echo e(isset($DataStatus->ID) && $DataStatus->ID !=''?$DataStatus->ID:''); ?>" class="form-control" autocomplete="off" />
      </div>

      <div class="col-lg-2 pl"><p>Transfer Leads*</p></div>
      <div class="col-lg-2 pl">
        <input type="text" name="ASSIGTO" id="ASSIGTO" onclick="getData('<?php echo e(route('transaction',[$FormId,'getAssignedToHrd'])); ?>','Assigned To Details')" class="form-control mandatory"  autocomplete="off" readonly/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PreSales\LeadGeneration\trnfrm439add.blade.php ENDPATH**/ ?>