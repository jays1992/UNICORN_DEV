...
<?php $helper = app('App\Helpers\Helper'); ?>    
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[233,'index'])); ?>" class="btn singlebt">AR Debit/Credit Note</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid filter">
      ...
      <?php echo csrf_field(); ?>
      <?php echo e(isset($objARDRCR->ARDRCRID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="hidden" name="ARDRCRID" id="ARDRCRID" value="<?php echo e(isset($objARDRCR->ARDRCRID)?$objARDRCR->ARDRCRID:''); ?>" />
              <input <?php echo e($ActionStatus); ?> type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="<?php echo e(isset($objARDRCR->AR_DOC_NO)?$objARDRCR->AR_DOC_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
         </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="AR_DOC_DT" id="AR_DOC_DT" value="<?php echo e(isset($objARDRCR->AR_DOC_DT)?$objARDRCR->AR_DOC_DT:''); ?>" onchange="checkPeriodClosing(233,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-2 pl"><p>Customer</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="txtcustomer" id="txtcustomer" class="form-control"   value="<?php echo e(isset($objARDRCRSL->SGLCODE)?$objARDRCRSL->SGLCODE.'-'.$objARDRCRSL->SLNAME:''); ?>"  readonly />
                <input type="hidden" name="CID_REF" id="CID_REF"  class="form-control " value="<?php echo e(isset($objARDRCR->SLID_REF)?$objARDRCR->SLID_REF:''); ?>" />
                <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" autocomplete="off" value="<?php echo e($objtaxstate); ?>" />
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="AR_TYPE" id="AR_TYPE"  class="form-control mandatory">
                        <option <?php echo e(isset($objARDRCR->AR_TYPE) && $objARDRCR->AR_TYPE =='Credit Note'?'selected="selected"':''); ?> value="Credit Note">Credit Note</option>
                        <option <?php echo e(isset($objARDRCR->AR_TYPE) && $objARDRCR->AR_TYPE =='Debit Note'?'selected="selected"':''); ?> value="Debit Note">Debit Note</option>
                  </select>
        </div>
        <div class="col-lg-2 pl"><p> Reference No</p></div> 
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="REF_NO" id="REF_NO" value="<?php echo e(isset($objARDRCR->REF_NO)?$objARDRCR->REF_NO:''); ?>" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p>Reference Date</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="date" name="REF_DT" id="REF_DT" value="<?php echo e(isset($objARDRCR->REF_DT)?$objARDRCR->REF_DT:''); ?>" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input type="checkbox" <?php echo e($ActionStatus); ?> name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objARDRCR->FC) && $objARDRCR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      ...
      <div class="col-lg-2 pl" id="divcurrency" >
          ...
          <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="<?php echo e(isset($objARDRCR->CRDESCRIPTION) && $objARDRCR->CRDESCRIPTION !=''? $objARDRCR->CRCODE.'-'.$objARDRCR->CRDESCRIPTION:''); ?>"/>
      
          <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objARDRCR->CRID_REF)?$objARDRCR->CRID_REF:''); ?>" />
          
      </div>
      
      <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objARDRCR->CONVFACT)?$objARDRCR->CONVFACT:''); ?>"  />
      </div>
  </div>
    ...
    <div class="row">		
        ...
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REASON_DRCR_NOTE" id="REASON_DRCR_NOTE" value="<?php echo e(isset($objARDRCR->REASON_DRCR_NOTE)?$objARDRCR->REASON_DRCR_NOTE:''); ?>" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    
          <div class="col-lg-2 pl"><p>Common Narration</p></div>
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="COMMON_NARRATION" id="COMMON_NARRATION" class="form-control" value="<?php echo e(isset($objARDRCR->COMMON_NARRATION)?$objARDRCR->COMMON_NARRATION:''); ?>" autocomplete="off"  />                          
          </div>
      ...
      <div id="Accounting" class="tab-pane fade in active">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody>
                    <?php if(!empty($objARDRCRACC)): ?>
                      <?php $__currentLoopData = $objARDRCRACC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow">
								  ...
								  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ACCOUNT_BALANCE_".$key); ?> id=<?php echo e("ACCOUNT_BALANCE_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($helper->getBalance_show($row->GLID_REF)); ?>" readonly/></td>
                      ...
                      ?>
                                  ...
                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("REMARKS_".$key); ?> id=<?php echo e("REMARKS_".$key); ?> class="form-control" maxlength="200" value="<?php echo e($row->REMARKS); ?>" autocomplete="off" /></td>
            ...
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option <?php echo e(isset($objARDRCR->TDS) && $objARDRCR->TDS =='1'?'selected="selected"':''); ?> value="Yes">Yes</option>
                      <option <?php echo e(isset($objARDRCR->TDS) && $objARDRCR->TDS =='0'?'selected="selected"':''); ?> value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tbody id="tbody_tds">
                    <?php if(!empty($objARDRCRTDS)): ?>
                      <?php $__currentLoopData = $objARDRCRTDS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tkey => $trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="udf" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <tbody>
                    <?php if(!empty($objJVUDF)): ?>
                        <?php $__currentLoopData = $objJVUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow4">
                                <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDF_ARID_".$Ukey); ?> id=<?php echo e("popupUDF_ARID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                <td hidden><input type="hidden" name=<?php echo e("UDF_ARID_REF_".$Ukey); ?>  id=<?php echo e("UDF_ARID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFJVID_REF); ?>" autocomplete="off" /></td>
                    ...
                    <?php else: ?>
                      <?php if($objUdfARData): ?>
                        <?php $__currentLoopData = $objUdfARData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDF_ARID_".$uindex); ?> id=<?php echo e("popupUDF_ARID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDF_ARID_REF_".$uindex); ?> id=<?php echo e("UDF_ARID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFJVID); ?>" autocomplete="off"   /></td>
                      ...
                      <?php else: ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name="popupUDF_ARID_0" id="popupUDF_ARID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
        ...
        <div id="CostCenter" class="tab-pane fade" >
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <tbody>
                    <?php if(!empty($objARDRCRCCD)): ?>
                        <?php $__currentLoopData = $objARDRCRCCD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cckey => $ccrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tbody>
      ...
      <table id="GL_TABLE_2" class="display nowrap table  table-striped table-bordered" >
        ...
        <?php $__currentLoopData = $objgeneralledger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$glRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
              <td class="ROW1"> <input type="checkbox" name="SELECT_GLID_REF[]" id="glidcode_<?php echo e($glRow-> GLID); ?>" class="clsglid" value="<?php echo e($glRow-> GLID); ?>" ></td>
              <td class="ROW2"><?php echo e($glRow-> GLCODE); ?>

                <input type="hidden" id="txtglidcode_<?php echo e($glRow-> GLID); ?>" data-desc="<?php echo e($glRow-> GLCODE); ?>" data-desc2="<?php echo e($glRow-> GLNAME); ?>"  value="<?php echo e($glRow-> GLID); ?>"/>
              </td>
      ...
      <table id="CostTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;">
        ...
        <tbody id="tbody_cc"> 
          <tr class="participantRow2">
            ...
            <td style="width:15%"><button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
  ...
  $(".clssubgl").click(function(){
    ...
    var customid = txtval;
        $.ajaxSetup({
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[233,"getShipTo"])); ?>',
              type:'POST',
              data:{'id':customid},
              success:function(data) {
                $("#Tax_State").val(data);
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[233,"getTDSApplicability"])); ?>',
              type:'POST',
              data:{'id':customid},
              success:function(data) {
                if(data == 1)
                {
                  $('#drpTDS').val('Yes');
                      ...
                      $.ajax({
                          url:'<?php echo e(route("transaction",[233,"getTDSDetails"])); ?>',
                          type:'POST',
                          data:{'id':customid},
                          success:function(data) {
                            $("#tbody_tds").html('');
...
//------------------------
  ...
  $(".clshsnid").click(function(){
      ...
      var customid = txtid;
        ...
        $.ajax({
              url:'<?php echo e(route("transaction",[233,"gettaxCode"])); ?>',
              type:'POST',
        ...
        $.ajaxSetup({
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[233,"gettax"])); ?>',
              type:'POST',
              data:{'id':customid,'taxstate':taxstate},
              success:function(data) {
                if(taxstate == 'WithinState')
                {
                  ...
                  var TaxCode1 = $('#hdn_hsnID6').val();
                    ...
                    $.ajax({
                          url:'<?php echo e(route("transaction",[233,"gettax2"])); ?>',
                          type:'POST',
  ...
  $('#costpopup').on('click','[id*="CostCenter"]',function(event){
    ...
    var fieldid = $(this).parent().parent().find('[id*="hdnCCID"]').attr('id');
      $("#tbody_ppcost").html('');
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[233,"getCostCenter"])); ?>',
            type:'POST',
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("transaction",[233,"add"])); ?>';
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[233,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[233,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transaction",[233,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[233,"index"])); ?>';
});
...
function getBalance(bankid,fieldid,fieldidshow){
  ...
  url:'<?php echo e(route("transaction",[233,"getBalance"])); ?>',
  async: false,
  dataType: 'json',
  data: {id:bankid},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ARDebitNote\trnfrm233edit.blade.php ENDPATH**/ ?>