...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->STTOSTID); ?>" value="<?php echo e($val->STTOSTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->STTOST_DOCDT) && $val->STTOST_DOCDT !=''?$val->STTOST_DOCDT:''); ?>" ></td>
                <td style="text-transform:uppercase"><?php echo e(isset($val->STTOST_DOCNO) && $val->STTOST_DOCNO !=''?$val->STTOST_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->STTOST_DOCDT) && $val->STTOST_DOCDT !=''?$val->STTOST_DOCDT:''); ?></td>
        ...
        <form id="transactionForm270Print" action="<?php echo e(route('transactiongetlist',[270,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[270,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("transaction",[270,"view",":rcdId"])); ?>';
          ...
          var resultIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  else if(checkPeriodClosing(270,$('#chkId'+recordId).data("docdate"),0) ==0){
                    $("#YesBtn").hide();
                    $("#NoBtn").hide();
                    $("#OkBtn").hide();
                    $("#OkBtn1").show();
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[270,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[270,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[270,"cancel"])); ?>',
                            type:'POST',
    ...
    $('#btnPrint').on('click', function() {
          ...
          if(seletedRecord==0){
              ...
              var recordsIds = resultIdsData;
               ...
               $("#transactionForm270Print").submit()
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StoretoStoreTransafer\trnfrm270.blade.php ENDPATH**/ ?>