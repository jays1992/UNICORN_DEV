...
<form id="frm_trn" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >
    <?php echo csrf_field(); ?>
    <?php echo e(isset($objDPP->DPPID) ? method_field('PUT') : ''); ?>
...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
      <label> <?php echo e($objDPP->DPP_NO); ?> </label>
      <input type="hidden" name="DPPID" id="DPPID" value="<?php echo e($objDPP->DPPID); ?>" />
      <input type="hidden" name="DPP_NO" id="DPP_NO" value="<?php echo e($objDPP->DPP_NO); ?>"   />
    </div>
    
    <div class="col-lg-1 pl col-md-offset-1"><p>Date</p></div>
    <div class="col-lg-2 pl">
          <input type="date" name="DPPDT" id="DPPDT" value="<?php echo e($objDPP->DPP_DT); ?>" class="form-control mandatory DPPDT"  placeholder="dd/mm/yyyy" readonly>         
    </div>
...
<tbody>
<?php if(!empty($objDPPMAT)): ?>
<?php $__currentLoopData = $objDPPMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
<tr  class="participantRow">
  <td style="text-align:center;">
    <input type="text" name="SubGl_popup_<?php echo e($key); ?>" id="txtsubgl_popup_<?php echo e($key); ?>" value="<?php echo e($row->SL_CODE); ?>" class="form-control mandatory" style="width:140px" readonly disabled/>
  </td>
  <td  hidden>
    <input type="text" name="SLID_REF_<?php echo e($key); ?>" id="hdnSLIDREF_<?php echo e($key); ?>" value="<?php echo e($row->SLID_REF); ?>" class="form-control"/> 
  </td> 
  <td > 
    <input type="text" name="SaleOrd_Popup_<?php echo e($key); ?>" id="txtSORD_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SONO); ?>" readonly data-dayno="1"  class="form-control"  style="width:140px;" disabled />
  </td>
  <td  hidden>
    <input type="text" name="SOID_REF_<?php echo e($key); ?>" id="hdnSOID_<?php echo e($key); ?>" value="<?php echo e($row->SOID); ?>"   class="form-control" />
  </td>
  <td hidden>
    <input type="text" name="SQA_REFID_<?php echo e($key); ?>" id="hdnSQAID_<?php echo e($key); ?>" value="<?php echo e($row->SQID_REF); ?>" class="form-control" />
  </td>  
  <td hidden>
    <input type="text" name="SEQ_REFID_<?php echo e($key); ?>" id="hdnSEQID_<?php echo e($key); ?>"  value="<?php echo e($row->SEQID_REF); ?>"  class="form-control" />
  </td>  

  <td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>"  class="form-control"  autocomplete="off" style="width:150px;"  readonly disabled /></td>
  ...
  <td>  <input type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->SO_QTY); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;"/></td>

  <td><input type="text" name="BAL_SOQTY_<?php echo e($key); ?>" id="BALSO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->totalppqty); ?>" class="form-control" readonly style="width:130px;" autocomplete="off" disabled /></td>
  <td><input type="text" name="PRO_PLANQTY_<?php echo e($key); ?>" id="PROPLAN_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->PRO_PLAN_QTY); ?>" disabled class="form-control three-digits" style="width:130px;" maxlength="13" autocomplete="off"  /></td>
  <td>
    <select id="dpp_priority_<?php echo e($key); ?>" name="dpp_priority_<?php echo e($key); ?>" class="form-control" disabled>
      ...
      <?php $__currentLoopData = $objPriority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pindex=>$prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($prow->PRIORITYID); ?>" <?php if($prow->PRIORITYID==$row->PRIORITYID_REF): ?> selected="selected" <?php endif; ?> ><?php echo e($prow->PRIORITYCODE); ?> - <?php echo e($prow->DESCRIPTIONS); ?></option> 
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[230,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[230,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\DailyProductionPlan\trnfrm230view.blade.php ENDPATH**/ ?>