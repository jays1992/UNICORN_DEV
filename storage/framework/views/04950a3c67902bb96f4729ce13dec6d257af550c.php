...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->PIID); ?>" value="<?php echo e($val->PIID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PI_DT) && $val->PI_DT !='' && $val->PI_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PI_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->PI_NO) && $val->PI_NO !=''?$val->PI_NO:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Purchase Indent Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ ITEMID + '&PINo='+ ITEMID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Purchase/PurchaseIndent/trnfrm59.blade.php ENDPATH**/ ?>