...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->PBID); ?>" value="<?php echo e($val->PBID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PB_DOCDT) && $val->PB_DOCDT !=''?$val->PB_DOCDT:''); ?>" ></td>
                <td><?php echo e(isset($val->PB_DOCNO) && $val->PB_DOCNO !=''?$val->PB_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->PB_DOCDT) && $val->PB_DOCDT !=''?$val->PB_DOCDT:''); ?></td>
                <td><?php echo e(isset($val->DCODE) && $val->DCODE !=''?$val->DCODE:''); ?></td>
                ...
                <td><?php echo e(isset($val->REMARKS) && $val->REMARKS !=''?$val->REMARKS:''); ?></td></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Purchase Invoice Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&PBID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoice\trnfrm236.blade.php ENDPATH**/ ?>