...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[259,'index'])); ?>" class="btn singlebt">Sales Invoice Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Sales Invoice No</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="SINO[]" id="SINO" data-hide-disabled="hide" multiple data-actions-box="true" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSINO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->SIID); ?>" selected><?php echo e($GRow->SINO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[259,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SINO = [];
        $("select[name='SINO[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                SINO.push(value5);
            }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[259,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesInvoiceRegister\rptfrm259.blade.php ENDPATH**/ ?>