  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
            <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control" autocomplete="off" readonly style="text-transform:uppercase"  >
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="DOC_NO" id="DOC_NO" class="form-control" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
          ...
          <span class="text-danger" id="ERROR_DOC_NO"></span>
			  ...
			  <div class="col-lg-2 pl">
				  <input type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(date('Y-m-d')); ?>" class="form-control"  placeholder="dd/mm/yyyy" >
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\BankReconcilation\trnfrm394add.blade.php ENDPATH**/ ?>