          ...
          <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-7 pl">
                          <input type="text" name="AC_SET_CODE" id="AC_SET_CODE" onkeypress="return AlphaNumaric(event,this)" value="<?php echo e(old('AC_SET_CODE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="10" tabindex="3" style="text-transform:uppercase" />
...
function getCountryWiseState(SALES_AC){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[165,"getCountryWiseState"])); ?>',
        type:'POST',
...
$("#stidref_close").on("click",function(event){ 
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[165,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
                if(data.exists) {
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[165,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[165,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\SalesAccountSet\mstfrm165add.blade.php ENDPATH**/ ?>