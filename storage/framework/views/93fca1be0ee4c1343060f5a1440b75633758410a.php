...
<!-- <form id="frm_rpt_positw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-3">
                <a href="<?php echo e(route('report',[253,'index'])); ?>" class="btn singlebt">Purchase Indent Register</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_prs"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Purchase Indent No</p></div>
                            <div class="col-lg-3 pl" id="div_store">
                                <select name="PI_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="PI_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjPINO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->PIID); ?>" selected><?php echo e($cRow->PI_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>                            
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[253,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var PI_NO = [];
        $("select[name='PI_NO[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                PI_NO.push(value3);
            }
        ...
        else if(PI_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Purchase Indent.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        ...
        else if(ITEMID  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[253,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\PurchaseIndentRegister\rptfrm253.blade.php ENDPATH**/ ?>