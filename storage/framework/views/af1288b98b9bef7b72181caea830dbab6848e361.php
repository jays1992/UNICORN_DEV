...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input type="text" name="VQC_NO" id="VQC_NO" value="<?php echo e(isset($objMstResponse->VQC_NO)?$objMstResponse->VQC_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                              <input type="hidden" name="VQCID" id="VQCID" value="<?php echo e(isset($objMstResponse->VQCID)?$objMstResponse->VQCID:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>VQC Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="VQC_DT" id="VQC_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objMstResponse->VQC_DT)?$objMstResponse->VQC_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                                <input type="hidden" id="LAST_DATE" value="<?php echo e(isset($objlastVQC_DT[0]->VQC_DT)?$objlastVQC_DT[0]->VQC_DT:''); ?>">
                            </div>
                  ...
                  <div class="col-lg-2 pl">
                      <input type="text" name="VID_REF1" id="VID_REF1_popup" class="form-control mandatory" value="<?php echo e(isset($objMstResponse->VID_REF1) && $objMstResponse->VID_REF1 !=''  ? $objMstResponse->VENDOR_CODE1.'-'.$objMstResponse->VENDOR_NAME1 : ''); ?>" onclick="get_vendor('VID_REF1');"  autocomplete="off" readonly/>
                      <input type="hidden" name="VID_REF1" id="VID_REF1" class="form-control" value="<?php echo e(isset($objMstResponse->VID_REF1)?$objMstResponse->VID_REF1:''); ?>" autocomplete="off" />
                  ...
                  <div class="col-lg-2 pl">
                  <input type="text" name="VID_REF2" id="VID_REF2_popup" class="form-control mandatory" value="<?php echo e(isset($objMstResponse->VID_REF2) && $objMstResponse->VID_REF2 !=''  ? $objMstResponse->VENDOR_CODE2.'-'.$objMstResponse->VENDOR_NAME2 : ''); ?>" onclick="get_vendor('VID_REF2');"    autocomplete="off" readonly/>
                    <input type="hidden" name="VID_REF2" id="VID_REF2" value="<?php echo e(isset($objMstResponse->VID_REF2)?$objMstResponse->VID_REF2:''); ?>" class="form-control" autocomplete="off" />
                  ...
                  <div class="col-lg-2 pl">
                  <input type="text" name="VID_REF3" id="VID_REF3_popup" class="form-control mandatory" value="<?php echo e(isset($objMstResponse->VID_REF3) && $objMstResponse->VID_REF3 !=''  ? $objMstResponse->VENDOR_CODE3.'-'.$objMstResponse->VENDOR_NAME3 : ''); ?>" onclick="get_vendor('VID_REF3');"  autocomplete="off" readonly/>
                  <input type="hidden" name="VID_REF3" id="VID_REF3" value="<?php echo e(isset($objMstResponse->VID_REF3)?$objMstResponse->VID_REF3:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="VQID_REF1" id="VQID_REF1_popup" value="<?php echo e(isset($objMstResponse->VQ_NO1)?$objMstResponse->VQ_NO1:''); ?>" class="form-control mandatory" onclick="get_vendor_quotation('VQID_REF1');"  autocomplete="off" readonly/>
            <input type="hidden" name="VQID_REF1" id="VQID_REF1" value="<?php echo e(isset($objMstResponse->VQID_REF1)?$objMstResponse->VQID_REF1:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="VQID_REF2" id="VQID_REF2_popup" value="<?php echo e(isset($objMstResponse->VQ_NO2)?$objMstResponse->VQ_NO2:''); ?>" class="form-control mandatory" onclick="get_vendor_quotation('VQID_REF2');"  autocomplete="off" readonly/>
            <input type="hidden" name="VQID_REF2" id="VQID_REF2" value="<?php echo e(isset($objMstResponse->VQID_REF2)?$objMstResponse->VQID_REF2:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="col-lg-2 pl">
        <input type="text" name="VQID_REF3" id="VQID_REF3_popup" value="<?php echo e(isset($objMstResponse->VQ_NO3)?$objMstResponse->VQ_NO3:''); ?>" class="form-control mandatory" onclick="get_vendor_quotation('VQID_REF3');"  autocomplete="off" readonly/>
            <input type="hidden" name="VQID_REF3" id="VQID_REF3" value="<?php echo e(isset($objMstResponse->VQID_REF3)?$objMstResponse->VQID_REF3:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div id="Material" class="tab-pane fade in active">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:500px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <tr  class="participantRow<?php echo e($row->QID_REF); ?>"  >
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:15px;height:240px;width:70%;">
             ...
             <th>Terms & Conditions Description</th>
                 ...
                 <tr>
                    ...
                    <tr  class="participantRow3<?php echo e($row->QID_REF); ?>"  >
             ...
             <tr>                                                                                         
                 ...
                 <tr>                    
                  ...
                  <?php if(!empty($objList3)): ?>
                    ...
                    <tr  class="participantRow5<?php echo e($row->QID_REF); ?>" >
  ...
  $("#FocusId").val('VID_'+REF+'_popup');
    ...
    return false;
              ...
              $("#VendorQuotationResult").html('');
                ...
                $("#item_seach").show();
                $.ajax({
                    url:'<?php echo e(route("transaction",[62,"get_vendor_quotations"])); ?>',
                    type:'POST',
...
$('#example5').find('.participantRow5'+VID_REF).each(function(){
      ...
      if(vqid!=''){    
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[$FormId,"get_items"])); ?>',
              type:'POST',
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[$FormId,"get_terms_conditions"])); ?>',
              type:'POST',
              data:{'id':vqid,'VENDOR_TYPE':VENDOR_TYPE,'VID_REF':VID_REF},
              success:function(data) {
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[$FormId,"get_calculations_temp"])); ?>',
              type:'POST',
              data:{'id':vqid,'VENDOR_TYPE':VENDOR_TYPE,'VID_REF':VID_REF},
              success:function(data) {
...
function validateForm(saveAction){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#VQC_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\VendorQuotationComparision\trnfrm62edit.blade.php ENDPATH**/ ?>