...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Stock Transfer</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>            
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->STID); ?>" value="<?php echo e($val->STID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->STDT) && $val->STDT !='' && $val->STDT !='1900-01-01' ? date('d-m-Y',strtotime($val->STDT)):''); ?>" ></td>
                <td><?php echo e(isset($val->STNO) && $val->STNO !=''?$val->STNO:''); ?></td>
                <td><?php echo e(isset($val->STDT) && $val->STDT !='' && $val->STDT !='1900-01-01' ? date('d-m-Y',strtotime($val->STDT)):''); ?></td>
                <td><?php echo e(isset($val->NATURE) && $val->NATURE !=''?$val->NATURE:''); ?></td>
                <td><?php echo e(isset($val->CUST_ADDRESS) && $val->CUST_ADDRESS !=''?$val->CUST_ADDRESS:''); ?></td>
                <td><?php echo e(isset($val->GSTIN_NO) && $val->GSTIN_NO !=''?$val->GSTIN_NO:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockTransfer\trnfrm482.blade.php ENDPATH**/ ?>