                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="CUSTOMER_ID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="CUSTOMER_ID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $CustomerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->CUSTOMER_ID); ?>" selected><?php echo e($val->CUSTOMER_CODE); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="PDC_TYPE" data-hide-disabled="hide" multiple data-actions-box="true" id="PDC_TYPE" class="form-control selectpicker" multiple data-live-search="true"  >
                                <option value="PDC" selected>PDC</option>
                                <option value="ECH">EMI</option>
                                </select>
                            </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="PDC_STATUS" data-hide-disabled="hide" multiple data-actions-box="true" id="PDC_STATUS" class="form-control selectpicker" multiple data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl"><p>Bank Name</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="BANK_ID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="BANK_ID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $BankList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->BANK_ID); ?>" selected><?php echo e($val->BANK_NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$('#btnView').on('click', function() {
        ...
        var PDC_TYPE        = $('#PDC_TYPE').val();
        var PDC_STATUS      = $('#PDC_STATUS').val();
        ...
        else if(PDC_TYPE  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Bank Name.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\PdcEmiReport\rptfrm518.blade.php ENDPATH**/ ?>