...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[283,'index'])); ?>" class="btn singlebt">Service Purchase Order Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" class="form-control selectpicker"  data-live-search="true"  >
                                    <option value="DATE" selected>Service Purchase Order Date</option>
                            ...
                            <div class="col-lg-3 pl">
                                <select name="OrderBy" id="OrderBy" class="form-control selectpicker"  data-live-search="true"  >
                                    <option value="SPO_DT" selected>Service Purchase Order Date</option>
                                    <option value="SLNAME" >Vendor Name</option>
                                    <option value="ITEMGROUP" >Item Group</option>
                                </select>
                            </div> 
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 pl">
                                <div class="col-lg-6 pl">
                                &nbsp;<input type="radio" name="chk_Detail" id="chk_Detail"   checked /> &nbsp; <label>Service Purchase Order Detail</label>
                                </div>
                                <div class="col-lg-6 pl">
                                    <input type="radio" name="chk_Summary" id="chk_Summary"   /> &nbsp; <label>Service Purchase Order Summary</label>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[283,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[283,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/purchase/SPORpt/rptfrm283.blade.php ENDPATH**/ ?>