        ...
        <div class="inner-form">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" VALUE="<?php echo e(isset($objResponse->LOAN_DISB_DOCNO)?$objResponse->LOAN_DISB_DOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" disabled>
                  <span class="text-danger" id="ERROR_LEAVE_APP_NO"></span> 
                </div>

                <div class="col-lg-2 pl"><p>LD Date*</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" value="<?php echo e($objResponse->LOAN_DISB_DOCDT); ?>" class="form-control" disabled maxlength="100" > 
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl"><p>Description*</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" id="LOANTYPE_DESC" value="<?php echo e($objLoanTyName->LOANTYPE_DESC); ?>" class="form-control" readonly  maxlength="100" disabled>
                <input type="hidden" id="focusid" >
                <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
              </div>
              ...
              <div class="col-lg-2 pl"><p>Disbursed Loan Amount</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="LOAN_DISB_AMT" id="LOAN_DISB_AMT" value="<?php echo e($objResponse->LOAN_DISB_AMT); ?>" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100" disabled>
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="NO_OF_INSTALL" id="NO_OF_INSTALL" value="<?php echo e($objResponse->NO_OF_INSTALL); ?>" class="form-control" onkeyup="disLAount(this.id)" onkeypress="return onlyNumberKey(event)"  maxlength="100" disabled>   
              </div>
            
              <div class="col-lg-2 pl"><p>EMI Amount*</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="EMI_AMT" id="EMI_AMT" value="<?php echo e($objResponse->EMI_AMT); ?>" class="form-control" readonly  maxlength="100" disabled> 
              <input type="hidden" id="focusid" >
              <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="REMARKS" id="REMARKS" value="<?php echo e($objResponse->REMARKS); ?>" class="form-control"  maxlength="100" disabled> 
              </div>
            </div>
        </div>
      </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LoanDisbursement\trnfrm403view.blade.php ENDPATH**/ ?>