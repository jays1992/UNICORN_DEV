...
<!-- <form id="frm_rpt_sop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('report',[378,'index'])); ?>" class="btn singlebt">Open Sales Order Print</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_sop"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">
                            <div class="col-lg-3 pl"><p>Open Sales Order Number</p></div>
                            <div class="col-lg-3 pl">
                                <select name="OSONO" id="OSONO" class="form-control mandatory">
                                    <option value="">select</option>
                                    <?php $__currentLoopData = $objOSO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->OSOID); ?>" ><?php echo e($Row->OSONO); ?></option>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[378,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        if(OSONO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Open Sales Order.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'<?php echo e(route("report",[378,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\OSOPrint\rptfrm378.blade.php ENDPATH**/ ?>