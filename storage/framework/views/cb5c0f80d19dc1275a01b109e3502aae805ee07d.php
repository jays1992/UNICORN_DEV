...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnSaveCountryAttachment" ><i class="fa fa-save"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_calculation_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[1,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label> <?php echo e($objCalculation->CTCODE); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objCalculation->CTID); ?>" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> <?php echo e(date("d/m/Y", strtotime($objCalculation->INDATE) )); ?> </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='<?php echo e(date("Y-m-d", strtotime($objCalculation->INDATE))); ?>'   />
					...
					<table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
						...
						<tbody>
							<tr  class="participantRow">
								...
								<td><input type="text" style="width: 100%"  name="REMARKS[]" id="REMARKS_0" 	class="form-control w-100"  maxlength="200" ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\CalculationTemplate\mstfrm1attachment.blade.php ENDPATH**/ ?>