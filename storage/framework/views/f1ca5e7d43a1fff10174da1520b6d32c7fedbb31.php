...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[168,'index'])); ?>" class="btn singlebt">Annual Forecast Sales Amendment (AFSA)</a>
                </div><!--col-2-->
...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
              ...
              <input type="text" name="AFSANO" id="AFSANO" value="<?php echo e($ANumber); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              <input type="hidden" name="AFSID_REF" id="AFSID_REF" value="<?php echo e($objSE->AFSID); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="AFSADT" id="AFSADT" value="<?php echo e($objSE->AFSDT); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
          </div>
...
$("#btnApprove").prop("disabled", true);
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[168,"saveamendment"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\AnnualForecastSales\trnfrm168amendment.blade.php ENDPATH**/ ?>