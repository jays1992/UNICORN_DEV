...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->LEAD_ID); ?>" value="<?php echo e($val->LEAD_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->LEAD_DT) && $val->LEAD_DT !=''?$val->LEAD_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->LEAD_NO) && $val->LEAD_NO !=''?$val->LEAD_NO:''); ?></td>
                <td><?php echo e(isset($val->LEAD_DT) && $val->LEAD_DT !=''?$val->LEAD_DT:''); ?></td>
                <?php if($val->CUSTOMER_TYPE=='Customer'){?>
                <td><?php echo e(isset($val->CUSTNAME) && $val->CUSTNAME !=''?$val->CUSTNAME:''); ?></td>
                <?php }elseif($val->CUSTOMER_TYPE=='Prospect'){?>
                <td><?php echo e(isset($val->PROSPTNAME) && $val->PROSPTNAME !=''?$val->PROSPTNAME:''); ?></td>
                <?php } ?>
                <td><?php echo e(isset($val->FNAME) && $val->FNAME !=''?$val->FNAME:''); ?> <?php echo e(isset($val->MNAME) && $val->MNAME !=''?$val->MNAME:''); ?> <?php echo e(isset($val->LNAME) && $val->LNAME !=''?$val->LNAME:''); ?></td>
                <td><?php echo e(isset($val->COMPANY_NAME) && $val->COMPANY_NAME !=''?$val->COMPANY_NAME:''); ?></td>
                <td><?php echo e(isset($val->CONTACT_PERSON) && $val->CONTACT_PERSON !=''?$val->CONTACT_PERSON:''); ?></td>
                <td><?php echo e(isset($val->MOBILE_NUMBER) && $val->MOBILE_NUMBER !=''?$val->MOBILE_NUMBER:''); ?></td>
        ...
        <form id="masterForm268Print" action="<?php echo e(route('mastergetlist',[$FormId,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
        ...
        if(seletedRecord==0){
          ...
          var recordId = resultIdsData[0];
              ...
              if(is_approve==0){
                ...
                var addURL = '<?php echo e(route("transaction",[$FormId,"add",":rcdId"])); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PreSales\TaskAllocation\trnfrm484.blade.php ENDPATH**/ ?>