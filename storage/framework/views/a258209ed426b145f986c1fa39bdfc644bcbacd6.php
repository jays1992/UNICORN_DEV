<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->CCOMPONENTID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->CCOMPONENT_CODE); ?> </label>
                    <input type="hidden" name="CCOMPONENTID" id="CCOMPONENTID" value="<?php echo e($objResponse->CCOMPONENTID); ?>" />
                    <input type="hidden" name="CCOMPONENT_CODE" id="CCOMPONENT_CODE" value="<?php echo e($objResponse->CCOMPONENT_CODE); ?>" autocomplete="off"  maxlength="20"   />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[138,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[138,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\CostComponent\mstfrm138edit.blade.php ENDPATH**/ ?>