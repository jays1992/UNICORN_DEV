<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->LEAVE_APPID); ?>" value="<?php echo e($val->LEAVE_APPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->LEAVE_APP_DT) && $val->LEAVE_APP_DT !=''?$val->LEAVE_APP_DT:''); ?>" ></td>
              <td><?php echo e(isset($val->LEAVE_APP_NO) && $val->LEAVE_APP_NO !=''?$val->LEAVE_APP_NO:''); ?></td>
              <td><?php echo e(isset($val->LEAVE_APP_DT) && $val->LEAVE_APP_DT !=''?$val->LEAVE_APP_DT:''); ?></td>
        ...
        <form id="transactionForm399Print" action="<?php echo e(route('transactiongetlist',[402,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[402,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("transaction",[402,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[402,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[402,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[402,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LeaveApply\trnfrm402.blade.php ENDPATH**/ ?>