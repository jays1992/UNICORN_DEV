...
<!-- <form id="frm_rpt_sospw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[246,'index'])); ?>" class="btn singlebt">Sales Order Summary Sales Person Wise</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_sospw"  method="POST">   
            <?php echo csrf_field(); ?>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl" id="div_sp">
                                <select name="SPID1[]" id="SPID1" class="form-control selectpicker" multiple data-live-search="true"  >
                                </select>
                            </div>
                        </div>
                        <div class="row">
...
$(document).ready(function(e) {
   ...
   $('#To_Date').change(function(){
       ...
       if(From_Date != '' && To_Date != '')
       {
                ...
                $.ajax({
                    url:'<?php echo e(route("report",[246,"GetSP"])); ?>',
                    type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesOrderSummarySPwise\rptfrm246.blade.php ENDPATH**/ ?>