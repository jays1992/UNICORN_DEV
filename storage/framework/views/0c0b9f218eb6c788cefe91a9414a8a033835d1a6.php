...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[449,'index'])); ?>" class="btn singlebt">PF Month Wise Head Wise Summary</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                     ...
                     <div class="row"> 
                            <div class="col-lg-3 pl"><p>PF Head</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="EARNING_HEADID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="EARNING_HEADID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjEarningHead; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->EARNING_HEADID); ?>" selected><?php echo e($Row->EARNING_HEADCODE); ?>-<?php echo e($Row->EARNING_HEAD_DESC); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>                            
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[449,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var EARNING_HEADID = [];
        $("select[name='EARNING_HEADID[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                EARNING_HEADID.push(value3);
            }
        });
        ...
        else if(EARNING_HEADID  == '')
        {
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select PF Head.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[449,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Payroll\PFMonthWiseHeadWiseSummary\rptfrm449.blade.php ENDPATH**/ ?>