          ...
          <div class="inner-form">              
                <div class="row">
                  ...
                  <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="REMB_DT" id="REMB_DT" onchange='checkPeriodClosing(413,this.value,1),getDocNoByEvent("CLAIM_DOC_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control"  maxlength="100" > 
                    </div>
...
function validateForm(){
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[413,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\Reimbursement\trnfrm413add.blade.php ENDPATH**/ ?>