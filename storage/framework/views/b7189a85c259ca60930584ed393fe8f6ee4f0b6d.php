    ...
    <div class="container-fluid purchase-order-view filter">    
          ...
          <div class="col-lg-2 pl"><p>Gratuity Code</p></div>
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="GRATUITY_DESC" id="GRATUITY_DESC" disabled class="form-control mandatory" value="<?php echo e($objResponse->GRATUITY_DESC); ?>" maxlength="200" tabindex="2"  />
                ...
                <input type="radio" name="GratuityType" id="gratuity_type1" value="1" style="margin-right: 10;" disabled <?php echo e($objResponse->GRATUITY_TYPE == 1 ? "checked" : ""); ?> >
            ...
            <div class="row" style="margin-left: 221px;">
                <input type="radio" name="GratuityType" id="gratuity_type2" disabled value="2" style="margin-right: 10;" <?php echo e($objResponse->GRATUITY_TYPE == 2 ? "checked" : ""); ?> >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\GratuityMaster\mstfrm196view.blade.php ENDPATH**/ ?>