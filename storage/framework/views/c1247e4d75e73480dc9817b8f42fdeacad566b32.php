...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Additional Material Requisition (AMR)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MRSPID); ?>" value="<?php echo e($val->MRSPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MRSP_DT) && $val->MRSP_DT !='' && $val->MRSP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MRSP_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->MRSP_NO) && $val->MRSP_NO !=''?$val->MRSP_NO:''); ?></td>
                <td><?php echo e(isset($val->MRSP_DT) && $val->MRSP_DT !='' && $val->MRSP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MRSP_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\AdditionalMaterialRequisition\trnfrm386.blade.php ENDPATH**/ ?>