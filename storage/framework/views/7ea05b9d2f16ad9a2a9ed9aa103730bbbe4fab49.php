...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="PII_NO" id="PII_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
            <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
        </div>
        <div class="col-lg-2 pl"><p>PII Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PII_DT" id="PII_DT" value="<?php echo e(old('PII_DT')); ?>" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("PII_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
	...
	<div class="row">	
		...
		<div class="col-lg-2 pl">
			<select  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" onchange="changeDuty()">
				...
				<option value="<?php echo e($val->IMPORT_DUTYID); ?>" <?php if($val->IMPORT_DUTYID==1): ?> selected="selected" <?php endif; ?>><?php echo e($val->IMPORT_DUTY_CODE); ?></option>
		...
		<div id="Material" class="tab-pane fade in active">
			<div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:400px;margin-top:10px;" >
              ...
              <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'5')" class="form-control" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
							<td><input type="text" <?php echo e($AlpsStatus['disabled']); ?> name="DISC_PER_0" id="DISC_PER_0" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
							<td><input type="text" <?php echo e($AlpsStatus['disabled']); ?> name="DISC_AMT_0" id="DISC_AMT_0" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/PurchaseInvoiceImport/trnfrm300add.blade.php ENDPATH**/ ?>