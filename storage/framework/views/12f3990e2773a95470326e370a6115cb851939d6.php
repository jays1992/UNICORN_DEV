...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[414,'index'])); ?>" class="btn singlebt">Stock Over Report</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
						...
						<div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemcat">
                                ...
                                <?php $__currentLoopData = $ObjItemCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Cindex=>$CRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($CRow->ICID); ?>" selected><?php echo e($CRow->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemsubgrp">
                                ...
                                <?php $__currentLoopData = $ObjItemSubGrp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Sindex=>$SRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($SRow->ISGID); ?>" selected><?php echo e($SRow->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
						...
						<div class="row">
                            ...
                            <div class="col-lg-3 pl" id="">
                                <select name="STOREID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="STOREID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjStore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->STID); ?>" selected><?php echo e($GRow->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-lg-3 pl"><p>Store/Without Store</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="ReportType" id="ReportType" class="form-control">
                                        <option value="WithStore">With Store </option>
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[414,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(STOREID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[414,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\Stock_OverHead\rptfrm414.blade.php ENDPATH**/ ?>