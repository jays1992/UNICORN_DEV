...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Energy Meter Consumption </a>
        </div>
...
<form id="edit_trn_form" method="POST"  >
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                  ...
                  <input type="text" name="EMC_NO" id="EMC_NO" value="<?php echo e($objResponse->EMC_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              ...
              <div class="col-lg-2 pl">
                  <input type="date" name="EMC_DATE" id="EMC_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($objResponse->EMC_DATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
              </div>
             ...
             <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      ...
                      <input type="text"  name="EnergyMeter_popup" id="txtEnergyMeter_popup" class="form-control mandatory" value="<?php echo e($objResponse->METER_CODE); ?>"  autocomplete="off"  readonly/>
                    ...
                    <div class="col-lg-2 pl">
                      <input type="text" name="METER_DESC" id="METER_DESC" class="form-control mandatory"  value="<?php echo e($objResponse->METER_DESC); ?>" readonly maxlength="200"  />
              ...
              <div class="col-lg-2 pl"><p>From Date</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="FROMDATE" class="form-control " id="FROMDATE" value="<?php echo e($objResponse->FROM_DATE); ?>"  placeholder="dd/mm/yyyy"  />
                </div>
                  <div class="col-lg-2 pl"><p>To Date</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="TODATE" class="form-control " id="TODATE" value="<?php echo e($objResponse->TO_DATE); ?>"  placeholder="dd/mm/yyyy"  />
                </div>
              </div>
              ...
              <div class="col-lg-2 pl"><p>Power Factor</p></div>
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="POWER_FACTOR" id="POWER_FACTOR" class="form-control " value="<?php echo e($objResponse->POWER_FACTOR); ?>" readonly autocomplete="off" maxlength="100" />                 
                  </div>
                <div class="col-lg-2 pl"><p>Meter Company</p></div>
                <div class="col-lg-2 pl">                 
                  <input type="text" name="METER_COMPANY" id="METER_COMPANY" class="form-control " value="<?php echo e($objResponse->METER_COMPANY); ?>"  readonly autocomplete="off" maxlength="100" />                 
                </div>
            ...
            <div class="col-lg-2 pl"><p>Brand</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="BRAND" id="BRAND" class="form-control " readonly value="<?php echo e($objResponse->BRAND); ?>" autocomplete="off" maxlength="100" />
                </div>
              <div class="col-lg-2 pl"><p>Model</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="MODEL" id="MODEL" class="form-control " readonly value="<?php echo e($objResponse->MODEL); ?>" autocomplete="off" maxlength="100" />
              </div>
            ...
            <div class="col-lg-2 pl"><p>Serial No</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SERIAL_NO" id="SERIAL_NO" class="form-control " value="<?php echo e($objResponse->SERIAL_NO); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
              <div class="col-lg-2 pl"><p>Load Sanction</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SANCTION_LOAD" id="SANCTION_LOAD" class="form-control " value="<?php echo e($objResponse->SANCTION_LOAD); ?>" readonly  autocomplete="off" maxlength="50" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_STARTED" id="KWH_STARTED" class="form-control " value="<?php echo e($objResponse->METER_READING_START_KWH); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_ENDED" id="KWH_ENDED" class="form-control " value="<?php echo e($objResponse->METER_READING_END_KWH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_CONSUMED" id="KWH_CONSUMED" class="form-control " value="<?php echo e($CONSUME1); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_STARTED" id="KVARH_STARTED" class="form-control " value="<?php echo e($objResponse->METER_READING_START_KVARH); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_ENDED" id="KVARH_ENDED" class="form-control " value="<?php echo e($objResponse->METER_READING_END_KVARH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_CONSUMED" id="KVARH_CONSUMED" class="form-control " value="<?php echo e($CONSUME2); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl"> 
                <input type="text" name="KVAH_STARTED" id="KVAH_STARTED" class="form-control " value="<?php echo e($objResponse->METER_READING_START_KVAH); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KVAH_ENDED" id="KVAH_ENDED" class="form-control " value="<?php echo e($objResponse->METER_READING_END_KVAH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KVAH_CONSUMED" id="KVAH_CONSUMED" class="form-control" value="<?php echo e($CONSUME3); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="MD_STARTED" id="MD_STARTED" class="form-control " value="<?php echo e($objResponse->METER_READING_START_MD); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="MD_ENDED" id="MD_ENDED" class="form-control "  value="<?php echo e($objResponse->METER_READING_END_MD); ?>" autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="MD_CONSUMED" id="MD_CONSUMED" class="form-control " value="<?php echo e($CONSUME4); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="REMARKS" id="REMARKS" class="form-control " value="<?php echo e($objResponse->REMARKS); ?>"  autocomplete="off" maxlength="20" />
              </div>
...
else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#EMC_DATE").val(),0) ==0){
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn").hide();
    $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\EnergyMeterConsumption\trnfrm368edit.blade.php ENDPATH**/ ?>