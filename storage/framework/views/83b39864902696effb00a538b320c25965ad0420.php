...
<div class="container-fluid topnav">
        <div class="row">
            <div class="col-lg-2">
            <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Returnable Gate Pass</a>
            </div>
...
<form id="frm_trn_edit"  method="POST">   
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="RGP_NO" id="RGP_NO" value="<?php echo e(isset($objResponse->RGP_NO) && $objResponse->RGP_NO !=''?$objResponse->RGP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      </div>
			
			<div class="col-lg-1 pl"><p>RGP Date</p></div>
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="RGP_DT" id="RGP_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->RGP_DT) && $objResponse->RGP_DT !=''?$objResponse->RGP_DT:''); ?>" class="form-control mandatory" >
      </div>
      ...
      <div class="col-lg-1 pl"><p>Type</p></div>
        ...
        <select name="TYPE" id="TYPE" class="form-control"  autocomplete="off" onchange="getType(this.value)" >
          ...
          <option <?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE =='Customer'?'selected="selected"':''); ?> value="Customer">Customer</option>
          <option <?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE =='Employee'?'selected="selected"':''); ?> value="Employee">Employee</option>
        </select>
			</div>
    ...
    <div class="row">
      ...
      <div class="col-lg-1 pl"><p>EDA</p></div>
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="EDA" id="EDA" value="<?php echo e(isset($objResponse->EDA) && $objResponse->EDA !=''?$objResponse->EDA:''); ?>" class="form-control mandatory" >
      </div>
      ...
      <div class="col-lg-1 pl"><p>Direct</p></div>
			<div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="checkbox" id="RGP_STATUS" <?php echo e(isset($objResponse->RGP_STATUS) && $objResponse->RGP_STATUS =='0'?'checked':''); ?> value='0' onchange="direct()" disabled >
        <input type="hidden" name="RGP_STATUS" value="<?php echo e(isset($objResponse->RGP_STATUS)?$objResponse->RGP_STATUS:''); ?>" >
    ...
    <div class="row">
      <div class="col-lg-1 pl"><p>Issue Type</p></div>
			<div class="col-lg-2 pl">
        <select name="ISSUE_TYPE" id="ISSUE_TYPE" class="form-control"  autocomplete="off" >
          <option <?php echo e(isset($objResponse->ISSUE_TYPE) && $objResponse->ISSUE_TYPE =='DEMO'?'selected="selected"':''); ?> value="DEMO">DEMO</option>
          <option <?php echo e(isset($objResponse->ISSUE_TYPE) && $objResponse->ISSUE_TYPE =='OTHER'?'selected="selected"':''); ?> value="OTHER">OTHER</option>
        </select>
			</div>
    </div>
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->ISSUE_QTY); ?>" ></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SE_QTY_".$key); ?> id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="<?php echo e($row->ISSUE_QTY); ?>" autocomplete="off"  /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?>  class="form-control w-100" type="date" name=<?php echo e("EDD_".$key); ?> id=<?php echo e("EDD_".$key); ?>  value="<?php echo e($row->EDA); ?>" ></td>
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e($row->REMARKS); ?>" class="form-control w-100" autocomplete="off" ></td>
                  <td align="center" >
...
function validateForm(actionType){
 ...
 if(RGP_NO ===""){
  ...
  if(jQuery.inArray("false", allblank13) !== -1){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#RGP_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\ReturnableGatePass\trnfrm157edit.blade.php ENDPATH**/ ?>