...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[51,'index'])); ?>" class="btn singlebt">Vendor - Item Info</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
                ...
                ?>
                <tr>
                  <td><input type="checkbox" id="chkId<?php echo e($val->VIINFOID); ?>" value="<?php echo e($val->VIINFOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                  <td><?php echo e(isset($val->VIINFONO) && $val->VIINFONO !=''?$val->VIINFONO:''); ?></td>
                  <td><?php echo e(isset($val->VIINFODT) && $val->VIINFODT !='' && $val->VIINFODT !='1900-01-01' ? date('d-m-Y',strtotime($val->VIINFODT)):''); ?></td>
...
//*******************************************{ Select CheckBox Edit Validation  }****************************************** *//
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[51,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[51,"view",":rcdId"])); ?>';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[51,"Approve"])); ?>',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                           // window.location.href="<?php echo e(route('master',[51,'index'])); ?>";
                        }               
                    },
                    error:function(data){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[51,"attachment",":rcdId"])); ?>';
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[51,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorItemInfo\mstfrm51.blade.php ENDPATH**/ ?>