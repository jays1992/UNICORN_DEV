...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="text" name="JV_NO" id="JV_NO" value="<?php echo e(isset($objJV->JV_NO)?$objJV->JV_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         </div>
        <div class="col-lg-1 pl col-md-offset-1"><p>JV Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="<?php echo e(isset($objJV->JV_DT)?$objJV->JV_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-1 pl"><p> Reverse	</p></div> 
        <div class="col-lg-1 pl">
                  <input type="checkbox" name="REVERSE" id="REVERSE" <?php echo e(isset($objJV->REVERSE) && $objJV->REVERSE == 1 ? 'checked' : ''); ?> />
        </div>
        <div class="col-lg-1 pl"><p>Reverse Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="REVERSE_DT" id="REVERSE_DT" value="<?php echo e(isset($objJV->REVERSE_DT)?$objJV->REVERSE_DT:''); ?>" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    <div class="row">
        <div class="col-lg-1 pl"><p>Remarks</p></div>
        <div class="col-lg-5 pl">
            <input type="text" name="REMARKS" id="REMARKS" class="form-control" value="<?php echo e(isset($objJV->REMARKS)?$objJV->REMARKS:''); ?>"  autocomplete="off"   />
        </div>
        <div class="col-lg-1 pl"><p>Source Doc No</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="SOURCE_DOCNO" id="SOURCE_DOCNO" class="form-control"  value="<?php echo e(isset($objJV->SOURCE_DOCNO)?$objJV->SOURCE_DOCNO:''); ?>"   autocomplete="off" disabled  />
        </div>
        
        <div class="col-lg-1 pl"><p>Source Doc Date</p></div>
        <div class="col-lg-2 pl">
            <input type="date" name="SOURCE_DOCDT" id="SOURCE_DOCDT" autocomplete="off"  value="<?php echo e(isset($objJV->SOURCE_DOCDT)?$objJV->SOURCE_DOCDT:''); ?>"  class="form-control"disabled  >
        </div>
    </div>
    <div class="row">
          <div class="col-lg-1 pl"><p>Common Narration</p></div>
          <div class="col-lg-5 pl">
              <input type="text" name="NARRATION" id="NARRATION" class="form-control"  value="<?php echo e(isset($objJV->NARRATION)?$objJV->NARRATION:''); ?>"   autocomplete="off"  />                          
          </div>                            
                    ...
                    <?php if(!empty($objJVACC)): ?>
                      <?php $__currentLoopData = $objJVACC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr  class="participantRow">
                            ...
                            <input type="text" name=<?php echo e("txtGLID_".$key); ?> id=<?php echo e("txtGLID_".$key); ?> class="form-control" value="<?php echo e($row->GLCODE); ?>"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name=<?php echo e("Description_".$key); ?> id=<?php echo e("Description_".$key); ?> class="form-control" value="<?php echo e($row->NAME); ?>"  autocomplete="off"  readonly/></td>
                            <td><input type="text" name=<?php echo e("DR_AMT_".$key); ?> id=<?php echo e("DR_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DR_AMT); ?>" maxlength="15"  autocomplete="off"  /></td>
                            <td><input type="text" name=<?php echo e("CR_AMT_".$key); ?> id=<?php echo e("CR_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->CR_AMT); ?>" maxlength="15"  autocomplete="off"  /></td>
                            <td><input type="text" name=<?php echo e("NARRATION_".$key); ?> id=<?php echo e("NARRATION_".$key); ?> class="form-control" value="<?php echo e($row->NARRATION); ?>"  autocomplete="off"  /></td>
                            <td><input type="text" name=<?php echo e("txtCostCenter_".$key); ?> id=<?php echo e("txtCostCenter_".$key); ?> class="form-control" value="<?php echo e($row->CostCenter); ?>" autocomplete="off"  readonly/></td>
                ...
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <?php if(!empty($objJVUDF)): ?>
                        <?php $__currentLoopData = $objJVUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow4">
                                <td><input type="text" name=<?php echo e("popupUDFJVID_".$Ukey); ?> id=<?php echo e("popupUDFJVID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $objUdfJVData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input type="text" name=<?php echo e("popupUDFJVID_".$uindex); ?> id=<?php echo e("popupUDFJVID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
...
<div id="costpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <td></td>
    <td>
    <input type="text" id="cccodesearch" autocomplete="off" onkeyup="CCCodeFunction()">
    </td>
    <td>
    <input type="text" id="ccnamesearch" autocomplete="off" onkeyup="CCNameFunction()">
    </td>
    </tr>
    </tbody>
    </table>
...
//------------------------
  ...
  $('#Accounting').on('click','[id*="txtCostCenter"]',function(event){
...
$("[id*='DR_AMT']").ForceNumericOnly();
$("[id*='CR_AMT']").ForceNumericOnly();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoice\trnfrm236amendment.blade.php ENDPATH**/ ?>