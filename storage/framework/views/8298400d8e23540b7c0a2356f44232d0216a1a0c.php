...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="RFQ_NO" id="RFQ_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="RFQ_DT" id="RFQ_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("RFQ_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)'  class="form-control mandatory"  placeholder="dd-mm-yyyy" >
      </div>
  ...
  if(formItemMst.valid()){
          ...
          event.preventDefault();
              ...
              if(jQuery.inArray("true", allblank1) !== -1 && $("#DIRECT_RFQ").prop("checked")==false){
                ...
                else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#RFQ_DT").val(),0) ==0){
                  $("#YesBtn").hide();
                  $("#NoBtn").hide();
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\RequestForQuotation\trnfrm60add.blade.php ENDPATH**/ ?>