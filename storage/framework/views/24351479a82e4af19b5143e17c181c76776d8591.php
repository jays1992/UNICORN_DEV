...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Serial No & Barcode (OUT)</a>
        </div>
...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  ...
  <div class="container-fluid filter">
      ...
      <div class="col-lg-2 pl"><p>Doc No*</p></div>
        ...
        <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="date" name="BRC_OUT_DT" id="BRC_OUT_DT" value="<?php echo e(isset($objResponse->BRC_OUT_DT) && $objResponse->BRC_OUT_DT !=''?$objResponse->BRC_OUT_DT:''); ?>" class="form-control mandatory" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\BarcodeOut\trnfrm419view.blade.php ENDPATH**/ ?>