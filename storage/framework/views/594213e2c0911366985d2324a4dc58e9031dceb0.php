...
$("#txtcostcat_popup").focus(function(event){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[207,"getcategory"])); ?>',
        type:'POST',
...
$(document).ready(function(e) {
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[207,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\CostCentre\mstfrm207add.blade.php ENDPATH**/ ?>