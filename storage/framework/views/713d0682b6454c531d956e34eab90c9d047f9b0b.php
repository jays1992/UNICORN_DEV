          ...
          <div class="inner-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input type="text" name="COSTCAT_popup" id="txtcostcat_popup" class="form-control mandatory" value="<?php echo e(isset($objResponse[0]->MODULECODE) ? $objResponse[0]->MODULECODE : ''); ?>"  autocomplete="off" readonly/>
                        <input type="hidden" name="MODID_REF" id="MODID_REF" value="<?php echo e(isset($objResponse[0]->MODULEID_REF) ? $objResponse[0]->MODULEID_REF : ''); ?>" class="form-control" autocomplete="off" />
                    ...
                    <div class="col-lg-2 pl">
                        <input type="text" name="MODNAME" id="MODNAME" class="form-control" value="<?php echo e(isset($objResponse[0]->MODULENAME) ? $objResponse[0]->MODULENAME : ''); ?>"  autocomplete="off" readonly/>
                    </div>
                </div>   
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr  class="participantRow">
                              <td hidden><input  class="form-control w-100" type="text" name=<?php echo e("MVMID_".$key); ?>   id =<?php echo e("HDNMVMID_".$key); ?> value="<?php echo e($row->MVMID); ?>" ></td>
                              <td hidden ><input type="text" name=<?php echo e("LISTPOP1ID_".$key); ?> id=<?php echo e("hdnLISTPOP1ID_".$key); ?> value="<?php echo e($row->VTID); ?>"class="form-control" autocomplete="off" /></td>
                              <td><input type="text" name=<?php echo e("txtLISTPOP1_popup_".$key); ?> id=<?php echo e("txtLISTPOP1_popup_".$key); ?>  value="<?php echo e($row->VCODE); ?>" class="form-control CLS_LISTPOP1"  autocomplete="off"  readonly style="width:100px;" disabled/></td>
                              <td><input  class="form-control w-100" type="text" name=<?php echo e("DESC2_".$key); ?>       id =<?php echo e("DESC2_".$key); ?>  value="<?php echo e($row->DESCRIPTIONS); ?>"  style="width: 200px;"  autocomplete="off" readonly></td>
                              <td width="140px"> 
                                <select name=<?php echo e("VHEADING_".$key); ?> id=<?php echo e("VHEADING_".$key); ?> class="form-control" style="width: 100px;" disabled>
                                  <option value="" >--Please select--</option>
                                  <option value="Master" <?php if(strtolower($row->HEADING) == "master"): ?> selected="selected" <?php endif; ?>  >Master</option>
                                  <option value="Transactions" <?php if(strtolower($row->HEADING) == "transactions"): ?> selected="selected" <?php endif; ?>>Transactions</option>
                                  <option value="Report" <?php if(strtolower($row->HEADING) == "report"): ?> selected="selected" <?php endif; ?>>Report</option>
                                  <option value="MIS" <?php if(strtolower($row->HEADING) == "mis"): ?> selected="selected" <?php endif; ?> >MIS</option>
                                </select> 
                              </td>
                              <td><input  class="form-control w-100" type="text" name=<?php echo e("REMARKS_".$key); ?>  id =<?php echo e("REMARKS_".$key); ?> value="<?php echo e(isset($objResponse[0]->MODULENAME) ? $objResponse[0]->MODULENAME : ''); ?>" autocomplete="off" style="width:100%;" readonly  ></td>
...
$(document).ready(function(e) {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[208,"update"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[208,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Module\ModuleVoucherMapping\mstfrm208view.blade.php ENDPATH**/ ?>