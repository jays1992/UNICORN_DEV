...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
        <input type="text" name="MACHINENAME" id="MACHINENAME" class="form-control"  value="<?php echo e($objMachineNo->MACHINE_DESC); ?>"  autocomplete="off" readonly/>
    </div>
  </div>    
   ...
   <div class="row">
    ...
    value='<?php echo e($objMWI->DEACTIVATED == 1 ? 1 : 0); ?>'  >
    </div>
    
    <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
    <div class="col-lg-2 pl">
      <input type="date" name="HDR_DODEACTIVATED" class="form-control" id="HDR_DODEACTIVATED" <?php echo e($objMWI->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objMWI->DODEACTIVATED) && $objMWI->DODEACTIVATED !="" && $objMWI->DODEACTIVATED !="1900-01-01" ? $objMWI->DODEACTIVATED:''); ?>" placeholder="dd/mm/yyyy"  />
    </div>
  </div>
...
<tr  class="participantRow">
  ...
  <td><input type="text" name="PRODUCE_QTY_<?php echo e($key); ?>"      id="PRODUCE_QTY_<?php echo e($key); ?>"      value="<?php echo e($row->PRODUCE_QTY); ?>"      class="form-control three-digits" style="width:130px;" maxlength="13" autocomplete="off"  /></td>
  <td><input type="text" name="CYCLE_TIME_<?php echo e($key); ?>"       id="CYCLE_TIME_<?php echo e($key); ?>"       value="<?php echo e($row->CYCLE_TIME); ?>"      class="form-control"  maxlength="30" autocomplete="off"  /> </td>
  <td><input type="text" name="REQ_OPERATORS_NO_<?php echo e($key); ?>" id="REQ_OPERATORS_NO_<?php echo e($key); ?>" value="<?php echo e($row->REQ_OPERATORS_NO); ?>"   class="form-control" style="width:130px;" maxlength="4" autocomplete="off"  /> </td>
  <td><input type="text" name="REMARKS_<?php echo e($key); ?>"          id="REMARKS_<?php echo e($key); ?>"          value="<?php echo e($row->REMARKS); ?>" class="form-control" style="width:100%;" maxlength="200" autocomplete="off"  /> </td>
...
$("#txtmachine_popup").focus(function(event){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[238,"getmachines"])); ?>',
        type:'POST',
  ...
  $('#Material').on('focus','[id*="popupITEMID"]',function(event){
    ...
    else
    {
        ...
        $("#tbody_ItemID").html('Loading...');
          ...
          $.ajax({
              url:'<?php echo e(route("master",[238,"getItemDetails"])); ?>',
              type:'POST',
              data:{},
              success:function(data) {
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("master",[238,"add"])); ?>';
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[238,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[238,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("master",[238,"index"])); ?>';
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\MachineWiseItemInfo\mstfrm238edit.blade.php ENDPATH**/ ?>