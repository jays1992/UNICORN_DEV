...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[346,'index'])); ?>" class="btn singlebt">Material Issues Slip Against RPR Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_mis"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>MIS NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="MISID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="MISID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objMISNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->MISID); ?>" selected><?php echo e($Row->MIS_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                            <div class="col-lg-3 pl"><p>MRS NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="MRSID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="MRSID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objMRSNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->MRSID); ?>" selected><?php echo e($Row->MRS_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[346,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var MISID  = [];
        $("select[name='MISID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                MISID.push(value7);
            }
        ...
        var MRSID  = [];
        $("select[name='MRSID[]']").each(function() {
            var value8 = $(this).val();
            if (value8) {
                MRSID.push(value8);
            }
        ...
        else if(MISID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select MIS NO.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        } 
        else if(MRSID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[346,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\MIS_Register\rptfrm346.blade.php ENDPATH**/ ?>