...
<div class="container-fluid topnav">
	<div class="row">
      ...
      <button class="btn topnavbt" onclick="submitData('fnApproveData')"  id="btnApprove" <?php echo e((isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?> ><i class="fa fa-lock"></i> Approved</button>
    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->DOC_DT) && $objResponse->DOC_DT !=''?$objResponse->DOC_DT:''); ?>" class="form-control mandatory" >
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  $TOTALTAX=@number_format(isset($row->EXTW_TAX) && $row->EXTW_TAX !=''?$row->EXTW_TAX:'');
                    ...
                    <td><input  type="text" name="popupInvNo[]" id="popupInvNo_<?php echo e($key); ?>" value="<?php echo e(isset($row->SINO) && $row->SINO !=''?$row->SINO:''); ?>" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    ...
                    <td><input type="date" name="INVDATE[]" id="INVDATE_<?php echo e($key); ?>" value="<?php echo e(isset($row->SIDT) && $row->SIDT !=''?$row->SIDT:''); ?>" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    
                    <td hidden><input type="text" name="INVIDNO[]" id="INVIDNO_<?php echo e($key); ?>" value="<?php echo e(isset($row->SIID_REF) && $row->SIID_REF !=''?$row->SIID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                    <td hidden><input type="text" name="SEID_REF[]" id="SEID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->SEID_REF) && $row->SEID_REF !=''?$row->SEID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                    
                    <td><input  type="text" name="popupITEMID[]" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e(isset($row->ICODE) && $row->ICODE !=''?$row->ICODE:''); ?>" class="form-control"  autocomplete="off"  readonly style="width: 120px"/></td>
                    ...
                    <td><input type="text" name="ItemName[]" id="ItemName_<?php echo e($key); ?>" value="<?php echo e(isset($row->NAME) && $row->NAME !=''?$row->NAME:''); ?>" class="form-control"  autocomplete="off"  readonly style="width: 150px"/></td>
                    
                    <td><input type="text" name="EXTENDEDWNTMONTH[]" id="EXTENDEDWNTMONTH_<?php echo e($key); ?>" value="<?php echo e(isset($row->EXTWA_MONTH) && $row->EXTWA_MONTH !=''?$row->EXTWA_MONTH:''); ?>" onkeyup="getExtnFromDate(this.id,this.value)" class="form-control"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /></td>
                    
                    <td hidden><input type="hidden" name="popupMUOM[]" id="popupMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                    <td hidden><input type="text" name="MAIN_UOMID_REF[]" id="MAIN_UOMID_REF_<?php echo e($key); ?>" class="form-control"  autocomplete="off" /></td>
                    
                    <td><input type="date"   name="STARTFROM[]" id="STARTFROM_<?php echo e($key); ?>" value="<?php echo e(isset($row->EW_STARTFROM) && $row->EW_STARTFROM !=''?$row->EW_STARTFROM:''); ?>" class="form-control" autocomplete="off"   /></td>
                    <td><input type="date"   name="STARTTO[]" id="STARTTO_<?php echo e($key); ?>" value="<?php echo e(isset($row->EW_STARTTO) && $row->EW_STARTTO !=''?$row->EW_STARTTO:''); ?>" class="form-control" autocomplete="off" /></td>
                    <td><input type="text"   name="WARRANTYAMT[]" id="WARRANTYAMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->EXTWA_AMOUNT) && $row->EXTWA_AMOUNT !=''?$row->EXTWA_AMOUNT:''); ?>" class="form-control" maxlength="200" onkeyup="getWatnTaxDetails(this.id,this.value)"  onkeypress="return onlyNumberKey(event)" autocomplete="off" /></td>
                    
                    <td><input type="text"   name="TOTALTAX[]" id="TOTALTAX_<?php echo e($key); ?>" value="<?php echo e(isset($TOTALTAX) && $TOTALTAX !=''?$TOTALTAX:''); ?>" class="form-control" onkeyup="getWatnTaxDetails(this.id,this.value)" autocomplete="off" readonly style="width: 120px"/></td>
                    <td><input type="text"   name="TAXAMT[]" id="TAXAMT_<?php echo e($key); ?>" value="<?php echo e(isset($TAXAMT) && $TAXAMT !=''?$TAXAMT:''); ?>" class="form-control" autocomplete="off"  style="width: 120px" readonly/></td>
                    <td><input type="text"   name="TOTALAMT[]" id="TOTALAMT_<?php echo e($key); ?>" value="<?php echo e(isset($row->EXTOTAL_AMOUNT) && $row->EXTOTAL_AMOUNT !=''?$row->EXTOTAL_AMOUNT:''); ?>" class="form-control" maxlength="200"  autocomplete="off" readonly style="width: 100px" /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ExtendedWarranty\trnfrm497edit.blade.php ENDPATH**/ ?>