<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->ASSETTRANID); ?>" value="<?php echo e($val->ASSETTRANID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->ASSETTRANDATE) && $val->ASSETTRANDATE !=''?$val->ASSETTRANDATE:''); ?>" ></td>
              <td><?php echo e(isset($val->ASSETTRANCODE) && $val->ASSETTRANCODE !=''?$val->ASSETTRANCODE:''); ?></td>
              <td><?php echo e(isset($val->ASSETTRANDATE) && $val->ASSETTRANDATE !=''?$val->ASSETTRANDATE:''); ?></td>
        ...
        <form id="transactionForm399Print" action="<?php echo e(route('transactiongetlist',[$FormId,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Asset\AssetTransfer\trnfrm411.blade.php ENDPATH**/ ?>