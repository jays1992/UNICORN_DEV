                     ...
                     <tbody>
                       <tr  class="participantRow">
                           <td>
                             ...
                             ?>
                             <select name="FYID_REF[]" id="FYID_REF_0" class="form-control mandatory" onchange="getFYearName(this.id,this.value)" tabindex="4" disabled>
                             <option value="" selected="">Select</option>
                             <?php $__currentLoopData = $objYearList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <td><input type="text" id="YRDESCRIPTION_0" value="<?php echo e($objFyDesList->YRDESCRIPTION); ?>" class="form-control" disabled  maxlength="100" readonly  ></td>
                           <td>
                             <select name="FR_PAYPID_REF[]" id="FR_PAYPID_REF_0" class="form-control mandatory" tabindex="4" disabled>
                               <option value="" selected="">Select</option>
                               ...
                               <option <?php echo e(isset($objResponse->FR_PAYPID_REF) && $objResponse->FR_PAYPID_REF == $val-> PAYPERIODID ?'selected="selected"':''); ?> value="<?php echo e($val-> PAYPERIODID); ?>"><?php echo e($val->PAY_PERIOD_CODE); ?>-<?php echo e($val->PAY_PERIOD_DESC); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             </select>                           
                           <td>                                
                             <select name="TO_PAYPID_REF[]" id="TO_PAYPID_REF_0" class="form-control mandatory" tabindex="4" disabled>
                               <option value="" selected="">Select</option>
                               <?php $__currentLoopData = $obPeriodList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option <?php echo e(isset($objResponse->TO_PAYPID_REF) && $objResponse->TO_PAYPID_REF == $val-> PAYPERIODID ?'selected="selected"':''); ?> value="<?php echo e($val-> PAYPERIODID); ?>"><?php echo e($val->PAY_PERIOD_CODE); ?>-<?php echo e($val->PAY_PERIOD_DESC); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             </select> 
                           <td><input  class="form-control" type="text" name="CAP_LIMIT[]" id ="CAP_LIMIT_0" value="<?php echo e($objResponse->CAP_LIMIT); ?>"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%" ondrop="return false;oncopy="return false" oncut="return false" onpaste="return false" disabled></td>
                           <td><input  class="form-control txtCal" type="text" name="EMP_ESI_RATE[]" id ="EMP_ESI_RATE_0" value="<?php echo e($objResponse->EMP_ESI_RATE); ?>" onkeyup="totalVlaue(this.id,this.value)"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%" ondrop="return false;oncopy="return false" oncut="return false" onpaste="return false" disabled></td>
                           <td><input  class="form-control txtCal" type="text" name="EMPR_ESI_RATE[]" id ="EMPR_ESI_RATE_0" value="<?php echo e($objResponse->EMPR_ESI_RATE); ?>" onkeyup="totalVlaue(this.id,this.value)"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%" ondrop="return false;"oncopy="return false" oncut="return false" onpaste="return false" disabled></td>
                           <td><input type="text" id="total_sum_value_0" value="<?php echo e($total); ?>%" class="form-control"  maxlength="100" readonly ></td>
                           <td><input type="checkbox"   name="DEACTIVATED[]"  id="deactive-checkbox_0" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?> value='<?php echo e($objResponse->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2" disabled ></td>
                           <td><input type="date" name="DODEACTIVATED[]" class="form-control" id="DODEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  /></td>
...
window.fnSaveData = function (){
     ...
     $.ajax({
         url:'<?php echo e(route("mastermodify",[294,"update"])); ?>',
         type:'POST',
         data:formData,
         success:function(data) {
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[294,"Approve"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\ESIRules\mstfrm294view.blade.php ENDPATH**/ ?>