         ...
         <form id="frm_mst_add" method="POST"  > 
          ...
          <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Effective Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="EFDATE" id="EFDATE" class="form-control mandatory" value="<?php echo e(old('EFDATE')); ?>" tabindex="3" autocomplete="off" placeholder="dd/mm/yyyy" />
                    <span class="text-danger" id="ERROR_EFDATE"></span> 
                  </div>

                  <div class="col-lg-1 pl"><p>End Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="ENDDATE" id="ENDDATE" class="form-control mandatory" value="<?php echo e(old('ENDDATE')); ?>" tabindex="4" autocomplete="off" placeholder="dd/mm/yyyy" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="REASONOED" id="REASONOED" class="form-control mandatory" value="<?php echo e(old('REASONOED')); ?>" tabindex="5" maxlength="100" autocomplete="off" />
...
"use strict";
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[149,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[149,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        window.location.href = "<?php echo e(route('master',[149,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserRoleMapping\mstfrm149add.blade.php ENDPATH**/ ?>