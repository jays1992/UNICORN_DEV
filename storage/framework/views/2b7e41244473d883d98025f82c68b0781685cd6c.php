      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="DSPNO" id="DSPNO" value="<?php echo e($objMstResponse->DSPNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus disabled>
          </div>
          
          <div class="col-lg-2 pl "><p>Daily Sales Plan Date*</p></div>
          <div class="col-lg-2 pl">
                <input type="date" name="DSPDT" id="DSPDT" value="<?php echo e($objMstResponse->DSPDT); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" disabled>
          </div>
          <div class="col-lg-2 pl"><p>Customer*</p></div>
          <div class="col-lg-2 pl">
                    <input type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e($objslcode2->SGLCODE); ?> - <?php echo e($objslcode2->SLNAME); ?>"  autocomplete="off" readonly/>
                    <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e($objMstResponse->SLID_REF); ?>" class="form-control" autocomplete="off" />
                    <input type="hidden" name="GLID_REF" id="GLID_REF"  value="<?php echo e($objMstResponse->GLID_REF); ?>" class="form-control" autocomplete="off" />
                    <input type="hidden" name="hdnmaterial" id="hdnmaterial" class="form-control" autocomplete="off" value='<div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;">	<table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200 dataTable" width="100%" style="height:auto !important;"><thead id="thead1" style="position: sticky;top: 0"><tr><th>SO No<input class="form-control" type="hidden" name="Row_Count1" id="Row_Count1"></th><th>Item Code</th><th>Item Name</th><th>UOM</th><th>Item Specification</th><th>SO Qty</th><th>Balance SO Qty</th><th>Expected Dispatch Qty</th><th>Action</th></tr></thead><tbody><tr class="participantRow"><td hidden=""><input type="text" name="recordId_0" id="txtrecordId_0" class="form-control" autocomplete="off" readonly=""></td><td hidden=""><input type="text" name="SQA_REF_0" id="txtSQA_REF_0" class="form-control" autocomplete="off" readonly=""></td><td hidden=""><input type="text" name="SEQID_REF_0" id="txtSEQID_REF_0" class="form-control" autocomplete="off" readonly=""></td><td><input type="text" name="SOrd_popup_0" id="txtSOrd_popup_0" class="form-control" autocomplete="off" readonly=""></td><td hidden=""><input type="text" name="SOrdID_0" id="HDNSOrdID_0" class="form-control" autocomplete="off"></td><td><input type="text" name="popupITEMID_0" id="popupITEMID_0" class="form-control" autocomplete="off" readonly=""></td><td hidden=""><input type="text" name="ITEMID_REF_0" id="ITEMID_REF_0" class="form-control" autocomplete="off"></td><td><input type="text" name="ItemName_0" id="ItemName_0" class="form-control" autocomplete="off" readonly=""></td><td><input type="text" name="popupMUOM_0" id="popupMUOM_0" class="form-control" autocomplete="off" readonly=""></td><td hidden=""><input type="hidden" name="MAIN_UOMID_REF_0" id="MAIN_UOMID_REF_0" class="form-control" autocomplete="off"></td><td><input type="text" name="Itemspec_0" id="Itemspec_0" class="form-control" autocomplete="off"></td><td><input type="text" name="SO_QTY_0" id="SO_QTY_0" class="form-control three-digits" maxlength="13" autocomplete="off" readonly=""></td><td><input type="text" name="BAL_SOQTY_0" id="BAL_SOQTY_0" class="form-control three-digits" maxlength="13" autocomplete="off" readonly=""></td><td><input type="text" name="EXP_DIS_QTY_0" id="EXP_DIS_QTY_0" class="form-control three-digits" maxlength="13" autocomplete="off"></td><td align="center"><button class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash"></i></button></td></tr></tbody>  </table></div>'/>   
          </div>
        </div>		
                  ...
                  <tbody>
                    <?php if(!empty($objList1)): ?>
                      ...
                      <tr  class="participantRow">
                        <td hidden><input type="text" name="recordId_<?php echo e($key); ?>" id="txtrecordId_<?php echo e($key); ?>" class="form-control" value="<?php echo e($CustomId); ?>"  autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="SOrd_popup_<?php echo e($key); ?>" id="txtSOrd_popup_<?php echo e($key); ?>" value="<?php echo e($row->SONO); ?>" class="form-control"  autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  disabled/></td>                    
                        ...
                        <td><input type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->NAME); ?>"   autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->UOMCODE); ?> - <?php echo e($row->DESCRIPTIONS); ?>"  class="form-control"  autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEMSPECI); ?>"  class="form-control"  autocomplete="off"  disabled /></td>
                        <td><input type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->SO_QTY); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled /></td>
                        <td ><input type="text" name="BAL_SOQTY_<?php echo e($key); ?>" id="BAL_SOQTY_<?php echo e($key); ?>" value="<?php echo e($row->BAL_SOQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled/></td>
                        <td ><input type="text" name="EXP_DIS_QTY_<?php echo e($key); ?>" id="EXP_DIS_QTY_<?php echo e($key); ?>" value="<?php echo e($row->EXPDPQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled/></td>
...
<div class="modal-dialog modal-md column3_modal">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Sub Ledger Account</p></div>
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
    <table id="SubGLTable" class="display nowrap table  table-striped table-bordered">
    <thead>
    <tr>
    ...
    <tbody>
      <tr>
        ...
        <td class="ROW2"><input type="text" id="subglcodesearch" class="form-control" onkeyup="SubGLCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="subglnamesearch" class="form-control" onkeyup="SubGLNameFunction()"></td>
      </tr>
    </tbody>
    </table>
      <table id="SubGLTable2" class="display nowrap table  table-striped table-bordered">
        <thead id="thead2">
...
function ItemOEMPNFunction() {
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\DailySalesPlan\trnfrm42view.blade.php ENDPATH**/ ?>