...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="udfforsemst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
    ...
    $('#btnExit').on('click', function() {
      var viewURL = '<?php echo e(route('home')); ?>';
        ...
        // Data table for serverside
         var mstudfforseTable =  $('#udfforsemst').DataTable({
            "processing": true,
            "serverSide": true,
            initComplete: function() {
                      ...
                      $('.dataTables_filter input').bind('keyup', function(e){
                          ...
                          if (code == 13) { 
                            mstudfforseTable.search(this.value).draw();
                          }
                      });
                   },
            "ajax":{

                     "url": "<?php echo e(route('mastergetlist',[90,'getsalesenquiry'])); ?>",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
      ...
      var htmlDD =  '<div id="custom_dropdown"><div id="udfforsemst_dropdown" class="dataTables_filter">'
        ...
        +'</select></div></div>';
          ...
          $( htmlDD ).insertBefore( "#udfforsemst_wrapper #udfforsemst_filter" ); 
      ...
      $('#btnView').on('click', function() {
          var udfseIdsData = getSeletectedCBox();
            var seletedRecord = udfseIdsData.length;
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var recordId = udfseIdsData[0];
                  var viewURL = '<?php echo e(route("master",[90,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[90,"attachment",":rcdId"])); ?>';
      ...
      $('#btnEdit').on('click', function() {
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[90,"edit",":rcdId"])); ?>';
        ...
        $('#btnApprove').on('click', function() {
          ...
          var udfseIdsData = getSeletectedCBox();
          var seletedRecord = udfseIdsData.length;
          var udfseIdsDataID = getSeletectedCBoxID();
...
function getSeletectedCBox(){       
        selectedIds=[];
            var checkedcollection = mstudfforseTable.$(".js-selectall1:checked", { "page": "all" });
...
var recordId = udfseIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[90,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[90,"cancel"])); ?>',
                            type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\UDFSE\mstfrm90.blade.php ENDPATH**/ ?>