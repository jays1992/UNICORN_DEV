                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <?php if(!empty($objSQTNC)): ?>
                                                <?php $__currentLoopData = $objSQTNC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Tkey => $Trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  ...
                                                  <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->TNC_NAME); ?>"  autocomplete="off"  readonly/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesQuotation_1\trnfrm36view.blade.php ENDPATH**/ ?>