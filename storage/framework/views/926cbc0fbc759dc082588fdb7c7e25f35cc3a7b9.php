...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
		<div class="row">
            ...
            <input type="text" name="ENQNO" id="ENQNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
			</div>
			<div class="col-lg-2 pl"><p>Sales Enquiry Date *</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="ENQDT" id="ENQDT" onchange='checkPeriodClosing(35,this.value,1),getDocNoByEvent("ENQNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('ENQDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>			
				...
				<div id="udf" class="tab-pane fade">
					<div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:500px;width:50%;">
						<table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
							...
							<tbody>
              <?php $__currentLoopData = $objUdfSEData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("SEID_REF_".$uindex); ?> id=<?php echo e("SEID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFSEID); ?>" autocomplete="off"   /></td>
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[35,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[35,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesEnquiry\trnfrm35add.blade.php ENDPATH**/ ?>