...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[237,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->VCDID); ?>" value="<?php echo e($val->VCDID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td style="text-transform:uppercase"><?php echo e(isset($val->VCD_DOCNO) && $val->VCD_DOCNO !=''?$val->VCD_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->VCD_DOCDT) && $val->VCD_DOCDT !=''?$val->VCD_DOCDT:''); ?></td>
        ...
        <form id="masterForm237Print" action="<?php echo e(route('mastergetlist',[237,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[237,"add"])); ?>';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[237,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[237,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[237,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[237,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[237,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\CustomDuty\mstfrm237.blade.php ENDPATH**/ ?>