...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
            <td><input type="checkbox" id="chkId<?php echo e($val->PII_ID); ?>" value="<?php echo e($val->PII_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PII_DT) && $val->PII_DT !='' && $val->PII_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PII_DT)):''); ?>" ></td>
            <td><?php echo e(isset($val->PII_NO) && $val->PII_NO !=''?$val->PII_NO:''); ?></td>
            <td><?php echo e(isset($val->PII_DT) && $val->PII_DT !='' && $val->PII_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PII_DT)):''); ?></td>
            <td><?php echo e(isset($val->VENDOR_INVOICE_NO) && $val->VENDOR_INVOICE_NO !=''?$val->VENDOR_INVOICE_NO:''); ?></td>
            <td><?php echo e(isset($val->BOE_NO) && $val->BOE_NO !=''?$val->BOE_NO:''); ?></td>
            <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !=''?$val->SLNAME:''); ?></td>
            <td><?php echo e(isset($val->GRN_NO) && $val->GRN_NO !=''?$val->GRN_NO:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Import Purchase Invoice Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&PII_ID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/PurchaseInvoiceImport/trnfrm300.blade.php ENDPATH**/ ?>