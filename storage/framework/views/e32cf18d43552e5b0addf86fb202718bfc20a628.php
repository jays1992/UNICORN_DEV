...
<form id="frm_trn_so"  method="POST">   
      <?php echo csrf_field(); ?>
      <?php echo e(isset($objSO->SPOID[0]) ? method_field('PUT') : ''); ?>
      ...
      <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select name="TYPE" id="TYPE" class="form-control" >
                 <option value="INVOICE" <?php echo e(isset($objSO->TYPE) && $objSO->TYPE == 'INVOICE' ? 'selected' : ''); ?>>INVOICE</option>
                 <option value="DEBIT" <?php echo e(isset($objSO->TYPE) && $objSO->TYPE == 'DEBIT' ? 'selected' : ''); ?>>DEBIT</option>
            </select>
          </div>
      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="text" name="SONO" id="SONO" value="<?php echo e(isset($objSO->SPI_NO)?$objSO->SPI_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
          ...
          <input type="hidden" name="SPIID" id="SPIID" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->SPIID)?$objSO->SPIID:''); ?>" />
                      </div>
                      
                      <div class="col-lg-2 pl"><p>SPI Date*</p></div>
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(201,this.value,1)" value="<?php echo e(isset($objSO->SPI_DT)?$objSO->SPI_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                      </div>
                      
                      <div class="col-lg-2 pl"><p>Department*</p></div>
                      <div class="col-lg-2 pl">
                        <input <?php echo e($ActionStatus); ?> type="text" name="GLID_popup" id="txtgl_popup" class="form-control mandatory" value="<?php echo e(isset($objglcode2->DCODE)?$objglcode2->DCODE:''); ?> <?php echo e(isset($objglcode2->NAME)?'-'.$objglcode2->NAME:''); ?>"  autocomplete="off" readonly/>
                        <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->DEPID_REF)?$objSO->DEPID_REF:''); ?>" />
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e(isset($objData2->SPO_NO)?$objData2->SPO_NO:''); ?>"  autocomplete="off" readonly/>
                        <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e(isset($objSO->SPOID_REF)?$objSO->SPOID_REF:''); ?>" class="form-control"  autocomplete="off" />
                    ...
                    <div class="col-lg-2 pl">
                      <input <?php echo e($ActionStatus); ?> type="text" name="vendor_name" id="vendor_name" class="form-control" autocomplete="off" value="<?php echo e(isset($VENDOR_CODE)?$VENDOR_CODE:''); ?>  <?php echo e(isset($VENDOR_NAME)?'-'.$VENDOR_NAME:''); ?>" readonly/>                                                             
                      <input type="hidden" name="VID_REF" id="VID_REF" class="form-control" value="<?php echo e(isset($objSO->VID_REF)?$objSO->VID_REF:''); ?>" autocomplete="off" />                                                             
                      <input type="hidden" name="VTDS_APPLICABLE" id="VTDS_APPLICABLE" value="<?php echo e(isset($TDS_APPLICABLE)?$TDS_APPLICABLE:''); ?>" class="form-control" autocomplete="off" />                                                             
                      <input type="hidden" name="Tax_State" id="Tax_State" value="<?php echo e(isset($TAXSTATE[0])?$TAXSTATE[0]:''); ?>" class="form-control" autocomplete="off" />                                                             
                    </div>

                    <div class="col-lg-2 pl"><p>Credit Days</p></div>
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->CREADIT_DAYS)?$objSO->CREADIT_DAYS:''); ?>"  readonly />
                    </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objSO->VENDOR_INNO)?$objSO->VENDOR_INNO:''); ?>" autocomplete="off" onkeyup="checkDuplicateVendorBillNo(this.value,'')" style="text-transform:uppercase"  />
                      </div>


                      <div class="col-lg-2 pl"><p>Vendor Bill Date*</p></div>
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="<?php echo e(isset($objSO->VENDOR_INDT)?$objSO->VENDOR_INDT:''); ?>" autocomplete="off" placeholder="dd/mm/yyyy"  />
                      </div> 
                      <div class="col-lg-2 pl"><p>Remarks</p></div>
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" maxlength="200" value="<?php echo e(isset($objSO->REMARKS)?$objSO->REMARKS:''); ?>" >
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                        <input <?php echo e($ActionStatus); ?> type="checkbox" name="GST_Reverse" id="GST_Reverse" <?php echo e(isset($objSO->REVERSE_GST) && $objSO->REVERSE_GST =='1' ?'checked':''); ?>   />                          
                      </div>

                      <div class="col-lg-2 pl"><p>GST Input Not Avail</p></div>
                      <div class="col-lg-2 pl">
                        <input <?php echo e($ActionStatus); ?> type="checkbox" name="GST_N_Avail" id="GST_N_Avail" <?php echo e(isset($objSO->GST_INPUT) && $objSO->GST_INPUT =='1' ?'checked':''); ?>   />
                      </div> 
                      ...
                      <div class="col-lg-2 pl" hidden>
                            <input <?php echo e($ActionStatus); ?> type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"   checked="checked"  >
                      </div>

                      <div class="col-lg-1 pl" hidden><p>SPO Based on</p></div>
                      <div class="col-lg-2 pl" hidden>
                        <select <?php echo e($ActionStatus); ?> name="PO_BASED" id="PO_BASED" class="form-control"  disabled >
                     ...
                     <div class="col-lg-2 pl"><p id="currency_section"><?php echo e(Session::get('default_currency')); ?></p></div>
                      <div class="col-lg-2 pl">
                          <input <?php echo e($ActionStatus); ?> type="text" name="TotalValue" id="TotalValue" class="form-control" value="0.00" autocomplete="off" readonly  />
                      ...
                      <div class="col-lg-1 pl">
                            <input <?php echo e($ActionStatus); ?> type="checkbox" name="BOE" id="BOE" class="form-checkbox" value="1" onchange="showHideItemTab()" <?php echo e(isset($objSO->BOE) && $objSO->BOE =='1' ?'checked':''); ?> >
                      </div>
                  ...
                  <div class="col-lg-1 pl"><p>DPB</p></div>
                      <div class="col-lg-2 pl">
                        <input <?php echo e($ActionStatus); ?> type="checkbox" name="DPB_CHECKBOX" id="DPB_CHECKBOX" class="form-checkbox" value="1" onchange="getDPB(),showHideItemTab()" <?php echo e(isset($objSO->DPB) && $objSO->DPB =='1' ?'checked':''); ?> >
                        <input type="hidden" name="DPB" id="DPB" value="<?php echo e(isset($objSO->DPB)?$objSO->DPB:''); ?>" >
                      ...
                      <div class="tab-content">
                                      ...
                                      <?php if(!empty($objSOMAT)): ?>
                                          <?php $__currentLoopData = $objSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow">
                                                  <td hidden>
                                                  <input  class="form-control" type="hidden" name=<?php echo e("SOMATID_".$key); ?> id =<?php echo e("SOMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SPISRVID); ?>" autocomplete="off" style="width:130px;"   >
                                                  </td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                  <td  hidden><input type="text" name=<?php echo e("ITEMID_REF_".$key); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control"   value="<?php echo e($row->SRVID_REF); ?>" autocomplete="off" style="width:130px;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->ITEM_NAME); ?>" autocomplete="off"  readonly style="width:130px;"/></td>
                                                  <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Alpspartno_".$key); ?> id=<?php echo e("Alpspartno_".$key); ?> class="form-control" value="<?php echo e($row->ALPS_PART_NO); ?>" autocomplete="off"  readonly style="width:130px;"/></td>
                                                  <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Custpartno_".$key); ?> id=<?php echo e("Custpartno_".$key); ?> class="form-control" value="<?php echo e($row->CUSTOMER_PART_NO); ?>" autocomplete="off"  readonly style="width:130px;" /></td>
                                                  <td <?php echo e($AlpsStatus['hidden']); ?> ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("OEMpartno_".$key); ?> id=<?php echo e("OEMpartno_".$key); ?> class="form-control" value="<?php echo e($row->OEM_PART_NO); ?>" autocomplete="off"  readonly style="width:130px;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control" value="<?php echo e($row->MAIN_UOM_CODE); ?>"  autocomplete="off"  readonly disabled style="width:130px;" /></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("MAIN_UOMID_REF_".$key); ?> id=<?php echo e("MAIN_UOMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->UOMID_REF); ?>" autocomplete="off" style="width:130px;text-align:right;"  /></td>

                                                  <td ><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("txtBOE_popup_".$key); ?> id=<?php echo e("txtBOE_popup_".$key); ?> class="form-control boedpb" value="<?php echo e(isset($row->DOC_CODE)?$row->DOC_CODE:''); ?>" autocomplete="off" style="width:130px;" readonly /></td>                                              
                                                  <td  hidden><input type="text"  name=<?php echo e("BOEID_REF_".$key); ?> id=<?php echo e("BOEID_REF_".$key); ?> value="<?php echo e($row->BOE_NO_REF); ?>"  class="form-control boedpb" autocomplete="off" /></td>                          
                                                  <td hidden><input type="text"  name=<?php echo e("BOE_REF_".$key); ?> id=<?php echo e("BOE_REF_".$key); ?> style=" width: 171px;" class="form-control boedpb"  autocomplete="off"  readonly /></td>


                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SPO_QTY_".$key); ?> id=<?php echo e("SPO_QTY_".$key); ?> value="<?php echo e($row->SPO_QTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SPO_RATE_".$key); ?> id=<?php echo e("SPO_RATE_".$key); ?>  value="<?php echo e($row->SPO_RATE); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                              
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SO_QTY_".$key); ?> id=<?php echo e("SO_QTY_".$key); ?> value="<?php echo e($row->BILL_QTY); ?>" class="form-control three-digits" maxlength="13"   autocomplete="off"  style="width:130px;text-align:right;"  /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SHORT_QTY_".$key); ?> id=<?php echo e("SHORT_QTY_".$key); ?> value="<?php echo e($row->SHORT_QTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->BILL_RATEPUOM); ?>"  autocomplete="off"  style="width:130px;text-align:right;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->DIS_PER); ?>"  autocomplete="off" style="width: 50px;" <?php echo e($AlpsStatus['disabled']); ?> style="width:130px;text-align:right;"  /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DISCOUNT); ?>" maxlength="15"  autocomplete="off" <?php echo e($AlpsStatus['disabled']); ?> style="width:130px;text-align:right;"  /></td>
                                                  <?php
                                                  ...
                                                  ?>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> class="form-control " maxlength="15" value="<?php echo e($TaxAmt); ?>" autocomplete="off"   readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input type="text" name="TOT_BAL_AMT_<?php echo e($key); ?>" id="TOT_BAL_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15"  value="<?php echo e(isset($row->TOT_BAL_AMT)?$row->TOT_BAL_AMT:''); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ASSESSABLE_VALUE_".$key); ?> id=<?php echo e("ASSESSABLE_VALUE_".$key); ?> class="form-control " maxlength="15" value="<?php echo e($row->ASSESSABLE_VALUE); ?>" autocomplete="off"  style="width:130px;text-align:right;" /></td>
                                                  
                                                  
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"  onkeyup="taxGstCalculation(this.id,this.value)"  /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($IGSTAMT); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($CGSTAMT); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($SGSTAMT); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  ...
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($TOTAMT); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                  <td align="center">
                                  ...
                                  <?php if(!empty($objSOUDF)): ?>
                                      <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr  class="participantRow4">
                                              ...
                                              <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$Ukey); ?>  id=<?php echo e("UDFSOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFSPIID_REF); ?>" autocomplete="off" /></td>
                                      ...
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                      <?php else: ?>
                                      <?php $__currentLoopData = $objUdfSOData2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr  class="participantRow4">
                                      ...
                                      <?php if(!empty($objSOCAL)): ?>
                                          <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow5">
                                                  ...
                                                  <td style="text-align:center;" hidden><input <?php echo e($ActionStatus); ?> type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?> value=""  ></td>
                                      ...
                                      <?php if(!empty($objSOPSLB)): ?>
                                          <?php $__currentLoopData = $objSOPSLB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pkey => $Prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow6">
                                                  <td hidden> <input type="text" class="form-control" id=<?php echo e("PSLBID_".$Pkey); ?> name=<?php echo e("PSLBID_".$Pkey); ?> value="<?php echo e($Prow->PSLB_SPIID); ?>" autocomplete="off"  /> </td>
                                                  ...
                                                  <td> <input <?php echo e($ActionStatus); ?> type="date" class="form-control" id=<?php echo e("DUE_DATE_".$Pkey); ?> name=<?php echo e("DUE_DATE_".$Pkey); ?> value="<?php echo e($Prow->DUE_DATE); ?>" autocomplete="off"  readonly /> </td>
                                                  <td align="center" >
                          ...
                          <div id="TDSApplicableSlabs" class="tab-pane fade">
                            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                ...
                                <div class="col-lg-2 pl">
                                 <select <?php echo e($ActionStatus); ?> name="TDS_APPLICABLE" id="TDS_APPLICABLE" class="form-control " >
                                  <option value="1" <?php if(isset($objSO->TDS_CAL) && $objSO->TDS_CAL==1): ?> selected <?php endif; ?> > Yes </option>
                                  <option value="0" <?php if(isset($objSO->TDS_CAL) && is_null($objSO->TDS_CAL) || isset($objSO->TDS_CAL) &&  $objSO->TDS_CAL==0): ?> selected <?php endif; ?> > No </option>
                                </select>
                                </div>
                            </div>
                                ...
                                <table id="example8" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                                    <thead id="thead1"  style="position: sticky;top: 0">
                                        <tr>
                                            ...
                                            <th >Code Description <input class="form-control" type="hidden" name="Row_Count8" id ="Row_Count8" value="<?php echo e($ObjTDSDataCount); ?>"></th>
                                            <th>Section</th>
                                    ...
                                    <?php if(!empty($ObjTDSData) ): ?>
                                      <?php $__currentLoopData = $ObjTDSData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dindex=>$dataRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!($dataRow->EXPIRE)): ?>
                                        <tr class="participantRow8">
                                          <td hidden><input type="hidden" name=<?php echo e("HOLDINGID_".$dindex); ?> id=<?php echo e("HOLDINGID_".$dindex); ?> value="<?php echo e($dataRow->HOLDINGID); ?>" class="form-control" autocomplete="off" /></td>
                                          <td hidden><input type="hidden" name=<?php echo e("ASSESSEEID_REF_".$dindex); ?> id=<?php echo e("ASSESSEEID_REF_".$dindex); ?> value="<?php echo e($dataRow->ASSESSEEID_REF); ?>"  class="form-control five-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                          <td hidden><input type="hidden" name=<?php echo e("BASE_TYPE_".$dindex); ?> id=<?php echo e("BASE_TYPE_".$dindex); ?> value="<?php echo e($dataRow->BASE_TYPE); ?>" class="form-control" autocomplete="off" /></td>
                                          <td hidden><input type="hidden" name=<?php echo e("APPLICABLE_FRDT_".$dindex); ?> id=<?php echo e("APPLICABLE_FRDT_".$dindex); ?> value="<?php echo e($dataRow->APPLICABLE_FRDT); ?>" class="form-control" autocomplete="off" /></td>
                      
                                          <td style="text-align:center;" ><input <?php echo e($ActionStatus); ?> type="checkbox" class="filter-none" name=<?php echo e("calTDS_".$dindex); ?> id=<?php echo e("calTDS_".$dindex); ?>  value="<?php echo e($dataRow->HOLDINGID); ?>"  /></td>
                                          <td hidden><input type="text" name=<?php echo e("popupHID_".$dindex); ?> id=<?php echo e("popupHID_".$dindex); ?> class="form-control"  autocomplete="off"  value="" readonly/></td>
                                          <td ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CODE_DESC_".$dindex); ?> id=<?php echo e("CODE_DESC_".$dindex); ?> class="form-control"  value="<?php echo e($dataRow->CODE_DESC); ?>" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SECTIONID_REF_".$dindex); ?> id=<?php echo e("SECTIONID_REF_".$dindex); ?> value="<?php echo e($dataRow->SECTION_NAME); ?>"  class="form-control" style="width:100px" readonly/></td>
                                          
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ASSEVAL_TDS_RATE_".$dindex); ?> id=<?php echo e("ASSEVAL_TDS_RATE_".$dindex); ?> value="-1"  class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ACT_TDS_RATE_".$dindex); ?> id=<?php echo e("ACT_TDS_RATE_".$dindex); ?> value="<?php echo e($dataRow->TDS_RATE); ?>"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("TDS_EXEMP_LIMIT_".$dindex); ?> id=<?php echo e("TDS_EXEMP_LIMIT_".$dindex); ?> value="0.00" class="form-control two-digits" maxlength="13" autocomplete="off" style="width:100px"  readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("TDS_RATE_AMT_".$dindex); ?> id=<?php echo e("TDS_RATE_AMT_".$dindex); ?> value="0.00" class="form-control two-digits" maxlength="13" autocomplete="off" style="width:100px"  readonly/></td>
                                          
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ASSEVAL_SURCHARGE_RAGE_".$dindex); ?> id=<?php echo e("ASSEVAL_SURCHARGE_RAGE_".$dindex); ?> value="0"  class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ACT_SURCHARGE_RAGE_".$dindex); ?> id=<?php echo e("ACT_SURCHARGE_RAGE_".$dindex); ?> value="<?php echo e($dataRow->SURCHARGE_RAGE); ?>"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SURCHARGE_EXEMP_LIMIT_".$dindex); ?> id=<?php echo e("SURCHARGE_EXEMP_LIMIT_".$dindex); ?> value="0.00"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SURCHARGE_RAGE_AMT_".$dindex); ?> id=<?php echo e("SURCHARGE_RAGE_AMT_".$dindex); ?> value="0.00"  class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ASSEVAL_CESS_RATE_".$dindex); ?> id=<?php echo e("ASSEVAL_CESS_RATE_".$dindex); ?> value="0" class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ACT_CESS_RATE_".$dindex); ?> id=<?php echo e("ACT_CESS_RATE_".$dindex); ?> value="<?php echo e($dataRow->CESS_RATE); ?>" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CESS_EXEMP_LIMIT_".$dindex); ?> id=<?php echo e("CESS_EXEMP_LIMIT_".$dindex); ?> value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CESS_RATE_AMT_".$dindex); ?> id=<?php echo e("CESS_RATE_AMT_".$dindex); ?> value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ASSEVAL_SP_CESS_RATE_".$dindex); ?> id=<?php echo e("ASSEVAL_SP_CESS_RATE_".$dindex); ?>  value="0" class="form-control five-digits" maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ACT_SP_CESS_RATE_".$dindex); ?> id=<?php echo e("ACT_SP_CESS_RATE_".$dindex); ?>  value="<?php echo e($dataRow->SP_CESS_RATE); ?>" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SP_CESS_EXEMP_LIMIT_".$dindex); ?> id=<?php echo e("SP_CESS_EXEMP_LIMIT_".$dindex); ?>  value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SP_CESS_RATE_AMT_".$dindex); ?>   id=<?php echo e("SP_CESS_RATE_AMT_".$dindex); ?>  value="0.00" class="form-control " maxlength="13" autocomplete="off" style="width:100px" readonly/></td>
                                          
                                          <td><input <?php echo e($ActionStatus); ?> type="text"  name=<?php echo e("TOT_TDS_AMT_".$dindex); ?> id=<?php echo e("TOT_TDS_AMT_".$dindex); ?> value="0.00" class="form-control "   autocomplete="off" style="width:100px" readonly/></td>
                              ...
                              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                  <table id="Additional_example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                      ...
                                      <?php if(!empty($objItem)): ?>
                                          <?php $__currentLoopData = $objItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="Additional_participantRow">
                                                  <td hidden>
                                                  <input <?php echo e($ActionStatus); ?>  class="form-control" type="hidden" name=<?php echo e("SPIITEMID_".$key); ?> id =<?php echo e("SPIITEMID_".$key); ?> maxlength="100" value="<?php echo e($row->SPIITEMID); ?>" autocomplete="off"   >
                                                  <input type="hidden" name="rowcountitem[]" id="rowcountitem[]" class="form-control" autocomplete="off">
                                                  </td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("A_popupITEMID_".$key); ?> id=<?php echo e("A_popupITEMID_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ICODE); ?>" readonly/></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("A_ITEMID_REF_".$key); ?> id=<?php echo e("A_ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->ITEMID_REF); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("A_ItemName_".$key); ?> id=<?php echo e("A_ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEM_NAME); ?>" readonly/></td>
                                                  
                                                  <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($ActionStatus); ?> type="text" name="A_Alpspartno_<?php echo e($key); ?>" id="A_Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->ALPS_PART_NO)?$row->ALPS_PART_NO:''); ?>" readonly/></td>
                                                  <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($ActionStatus); ?> type="text" name="A_Custpartno_<?php echo e($key); ?>" id="A_Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->CUSTOMER_PART_NO)?$row->CUSTOMER_PART_NO:''); ?>" readonly/></td>
                                                  <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($ActionStatus); ?> type="text" name="A_OEMpartno_<?php echo e($key); ?>"  id="A_OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  value="<?php echo e(isset($row->OEM_PART_NO)?$row->OEM_PART_NO:''); ?>" readonly/></td>

                                                  
                                                  <td ><input  <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("A_popupUOM_".$key); ?> id=<?php echo e("A_popupUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->DESCRIPTIONS); ?>"  readonly/></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("A_UOMID_REF_".$key); ?> id=<?php echo e("A_UOMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->UOMID_REF); ?>" autocomplete="off" /></td>
                                                  <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("A_ITEMSPECI_".$key); ?> id=<?php echo e("A_ITEMSPECI_".$key); ?> class="form-control" maxlength="200"  autocomplete="off"  value="<?php echo e($row->ITEM_SPECS); ?>"/></td>
                                                  <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("A_RATEPUOM_".$key); ?> id=<?php echo e("A_RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value=""  autocomplete="off" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ITEM_AMOUNT_".$key); ?> id=<?php echo e("ITEM_AMOUNT_".$key); ?> class="form-control" maxlength="200" autocomplete="off"  value="<?php echo e($row->ITEM_VALUE); ?>"/></td>
                                                  <td><input  type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("txtSTR_popup_".$key); ?> id=<?php echo e("txtSTR_popup_".$key); ?>  class="form-control"  autocomplete="off" value="<?php echo e($row->STCODE!=''? $row->STCODE .'-'.$row->STORE_NAME :''); ?>"  readonly /></td>
                                            <td  hidden><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("STRID_REF_".$key); ?> id=<?php echo e("STRID_REF_".$key); ?>   class="form-control " autocomplete="off" value="<?php echo e($row->STID_REF); ?>" /></td>    
                                                  <td align="center">
                                                    <button <?php echo e($ActionStatus); ?> class="btn A_add A_material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                    <button <?php echo e($ActionStatus); ?> class="btn A_remove A_dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
                                                  </td>
                                              </tr>
                                              <tr></tr>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
...
<table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
  ...
  <?php $__currentLoopData = $objUdfSOData2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfindex=>$udfRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function bindSubLedgerEvents(){
  $('.clssubgl').click(function(){
      ...
      //--tds end
        ...
        //     });
        //     $.ajax({
        //         url:'<?php echo e(route("transaction",[201,"getcreditdays"])); ?>',
        //         type:'POST',
        //         data:{'id':customid},
        //         success:function(data) {
        //           $("#CREDITDAYS").val(data);                        
...
$.ajax({
url:'<?php echo e(route("transactionmodify",[201,"update"])); ?>',
type:'POST',
data:formData,
success:function(data) {
$(".buttonload").hide(); 
...
$.ajax({
url:'<?php echo e(route("transactionmodify",[201,"Approve"])); ?>',
type:'POST',
data:formData,
success:function(data) {
$("#btnApprove").show();  
...
var checkDuplicateVendorBillNo = $.ajax({type: 'POST',url:'<?php echo e(route("transaction",[$FormId,"checkDuplicateVendorBillNoEdit"])); ?>',async: false,dataType: 'json',data: {REFNO:REFNO,VID_REF:VID_REF,SPIID:SPIID},done: function(response) {return response;}}).responseText;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\ServicePurchaseInvoice\trnfrm201view.blade.php ENDPATH**/ ?>