          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="PAY_PERIOD_CODE" id="PAY_PERIOD_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="PAY_PERIOD_DESC" id="PAY_PERIOD_DESC" class="form-control mandatory" value="<?php echo e(old('PAY_PERIOD_DESC')); ?>" maxlength="200" tabindex="2"  required/>
                    ...
                    <div class="col-lg-2 pl">
                      <select name="MTID_REF" id="MTID_REF" class="form-control mandatory" tabindex="3" required >
                        ...
                        <?php $__currentLoopData = $objMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($row->MTID); ?>" ><?php echo e($row->MTCODE); ?> - <?php echo e($row->MTDESCRIPTION); ?> </option>
                    ...
                    <div class="col-lg-2 pl">
                      <select name="YRID_REF" id="YRID_REF" class="form-control mandatory" tabindex="4" required >
                        ...
                        <?php $__currentLoopData = $objYear; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($row->YRID); ?>" ><?php echo e($row->YRCODE); ?> - ( <?php echo e($row->YRDESCRIPTION); ?> ) </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[178,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[178,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[178,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\PayPeriod\mstfrm178add.blade.php ENDPATH**/ ?>