...
<div class="container-fluid filter">
    ...
    <?php echo e(isset($objMstCust->CID) ? method_field('PUT') : ''); ?>
      ...
      <div class="row">
        ...
        <div class="PROSPECT_ACTION">
          ...
          <input type="hidden" name="CID_REF" id="CID_REF" value="<?php echo e(isset($objMstCust->CID) && $objMstCust->CID !=''?$objMstCust->CID:''); ?>" class="form-control" readonly>
          ...
          <span class="text-danger" id="ERROR_CUSTOMER_LEGAL_NAME"></span>
			...
			<div class="row">
			  ...
			  <div class="col-lg-2 pl">
				<input type="text" name="OLD_REFCODE" id="OLD_REFCODE" value="<?php echo e($objMstCust->OLD_REFCODE); ?>"  class="form-control"  maxlength="20" tabindex="5" >
			  </div>
			...
			<div class="row">
				...
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL1" id="REGADDL1" class="form-control mandatory" value="<?php echo e($objMstCust->REGADDL1); ?>"   maxlength="200" required tabindex="7" >
          <span class="text-danger" id="ERROR_REGADDL1"></span>
        </div>
				
					<div class="col-lg-2 pl"><p>Registered Address Line 2</p></div>
				<div class="col-lg-4 pl">
					<input type="text" name="REGADDL2" id="REGADDL2" class="form-control" value="<?php echo e($objMstCust->REGADDL2); ?>"   maxlength="200" tabindex="8" >
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control " value="<?php echo e($objMstCust->REGPIN); ?>" onkeyup="bind_country_state_city_pincode()"   maxlength="10" tabindex="12"  autocomplete="off" >
			</div>
    ...
    <div class="row">
      ...
      <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objMstCust->DEACTIVATED == 1 ? "checked" : ""); ?>
       ...
       value='<?php echo e($objMstCust->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="13"  >
      </div>
      ...
      <?php echo e($objMstCust->DEACTIVATED == 1 ? "" : "disabled"); ?>
         ...
         tabindex="14" value="<?php echo e((!is_null($objMstCust->DODEACTIVATED) && $objMstCust->DODEACTIVATED!='1900-01-01')? \Carbon\Carbon::parse($objMstCust->DODEACTIVATED)->format('Y-m-d') : ''); ?>" />
      </div>
	...
	<div class="container-fluid">
			...
			<div class="tab-content">
				<div id="material" class="tab-pane fade in active">
					<div class="table-wrapper-scroll-x">
						<div class="row" style="margin-top:10px;">
							...
							<div class="col-lg-4">
								<input type="text" name="CORPADDL1" id="CORPADDL1" class="form-control " tabindex="15" value="<?php echo e($objMstCust->CORPADDL1); ?>"  maxlength="200"  >
							</div>
							
							<div class="col-lg-2"><p>Corporate Address Line 2</p></div>
							<div class="col-lg-4">
								<input type="text" name="CORPADDL2" id="CORPADDL2" class="form-control" tabindex="16" value="<?php echo e($objMstCust->CORPADDL2); ?>"  maxlength="200" >
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-2">	
								<input type="text" name="CORPCTRYID_REF_POPUP" id="CORPCTRYID_REF_POPUP" tabindex="17" class="form-control" value="<?php if(isset($objCorpCountry)): ?><?php echo e($objCorpCountry->CTRYCODE); ?> - <?php echo e($objCorpCountry->NAME); ?> <?php endif; ?>" readonly  />
							...
							<div class="col-lg-2">		
								<input type="text" name="CORPSTID_REF_POPUP" id="CORPSTID_REF_POPUP" tabindex="18" value="<?php if(isset($objCorpState)): ?><?php echo e($objCorpState->STCODE); ?> - <?php echo e($objCorpState->NAME); ?><?php endif; ?>" class="form-control" readonly  />
							...
							<div class="col-lg-2">
								<input type="text" name="CORPCITYID_REF_POPUP" id="CORPCITYID_REF_POPUP" tabindex="19" value="<?php if(isset($objCorpCity)): ?><?php echo e($objCorpCity->CITYCODE); ?> - <?php echo e($objCorpCity->NAME); ?><?php endif; ?>" class="form-control" readonly  />
					...
					<div class="col-lg-2">
						<input type="text" name="CORPPIN" id="CORPPIN" class="form-control " tabindex="20" value="<?php echo e($objMstCust->CORPPIN); ?>"  maxlength="10"  >
					</div>
					
						<div class="col-lg-2"><p>Email ID</p></div>
						<div class="col-lg-2">
							<input type="text" name="EMAILID" id="EMAILID" class="form-control " tabindex="21" value="<?php echo e($objMstCust->EMAILID); ?>"  maxlength="50"  >
						</div>
						
						<div class="col-lg-2"><p>Website</p></div>
						<div class="col-lg-2">
							<input type="text" name="WEBSITE" id="WEBSITE" class="form-control " tabindex="22" value="<?php echo e($objMstCust->WEBSITE); ?>"  maxlength="50"  >
						</div>
					...
					<div class="col-lg-2 "><p>Phone No</p></div>
						<div class="col-lg-2">
							<input type="text" name="PHNO" id="PHNO" class="form-control " tabindex="23" value="<?php echo e($objMstCust->PHNO); ?>" maxlength="15"  >
						</div>
						
						<div class="col-lg-2"><p>Mobile No</p></div>
						<div class="col-lg-2">
							<input type="text" name="MONO" id="MONO" class="form-control " tabindex="24" value="<?php echo e($objMstCust->MONO); ?>" maxlength="15"  >
						</div>
						
						<div class="col-lg-2"><p>Contact Person</p></div>
						<div class="col-lg-2 ">
							<input type="text" name="CPNAME" id="CPNAME"  class="form-control" tabindex="25" value="<?php echo e($objMstCust->CPNAME); ?>" maxlength="50"  >
						</div>
					...
					<div class="col-lg-2 "><p>Skype</p></div>
						<div class="col-lg-2">
							<input type="text" name="SKYPEID" id="SKYPEID" class="form-control" tabindex="26" value="<?php echo e($objMstCust->SKYPEID); ?>" maxlength="30"  >
						</div>
					</div>
				...
				<div id="statutory" class="tab-pane fade"> 
					 ...
					 <div class="table-wrapper-scroll-x" style="margin-top:10px;">
						...
						<div class="col-lg-2">
							<input type="text" name="INDSID_REF_POPUP" id="INDSID_REF_POPUP" tabindex="27" class="form-control" value="<?php if(isset($objIndType)): ?><?php echo e($objIndType->INDSCODE); ?> - <?php echo e($objIndType->DESCRIPTIONS); ?><?php endif; ?>" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" name="INDSVID_REF_POPUP" id="INDSVID_REF_POPUP" tabindex="28" class="form-control"  value="<?php if(isset($objIndVer)): ?><?php echo e($objIndVer->INDSVCODE); ?> - <?php echo e($objIndVer->DESCRIPTIONS); ?><?php endif; ?>" readonly  />
						...
						<div class="col-lg-2">
							<input type="text" name="DEALSIN" id="DEALSIN" class="form-control  " tabindex="29" value="<?php echo e($objMstCust->DEALSIN); ?>"   maxlength="50"  >
						</div>
                ...
                <option value="<?php echo e($Currency-> CRID); ?>"  <?php if($objMstCust->DEFCRID_REF==$Currency-> CRID): ?> selected <?php endif; ?>) >
                  <?php echo e($Currency->CRCODE); ?> - <?php echo e($Currency->CRDESCRIPTION); ?></option>
						...
						<div class="col-lg-2">
							<input type="text" name="GSTIN" id="GSTIN" class="form-control  " tabindex="32"  value="<?php echo e($objMstCust->GSTIN); ?>"  maxlength="15"  >
						</div>
				...
				<div class="row">
					<div class="col-lg-2"><p>Credit Limit</p></div>
						<div class="col-lg-2">
							<input type="text" name="CREDITLIMIT" id="CREDITLIMIT" class="form-control  " tabindex="33" style="text-align: right" value="<?php echo e($objMstCust->CREDITLIMIT); ?>" maxlength="18"  autocomplete="off">
						</div>
						
						<div class="col-lg-2"><p>CIN </p></div>
						<div class="col-lg-2">
							<input type="text" name="CIN" id="CIN" class="form-control  "  maxlength="30"  tabindex="34" value="<?php echo e($objMstCust->CIN); ?>" autocomplete="off">
						</div>
						
						<div class="col-lg-1"><p>Credit Days </p></div>
						<div class="col-lg-1">
							<input type="text" name="CREDITDAY" id="CREDITDAY" class="form-control" tabindex="35" style="text-align: right" value="<?php echo e($objMstCust->CREDITDAY); ?>" maxlength="4"  autocomplete="off">
						</div>
				...
				<div class="col-lg-2"><p>PAN No </p></div>
						<div class="col-lg-2">
							<input type="text" name="PANNO" id="PANNO" class="form-control  " tabindex="36" value="<?php echo e($objMstCust->PANNO); ?>" maxlength="10"  autocomplete="off">
						</div>
            <div class="col-lg-2"><p>MSME No </p></div>
          <div class="col-lg-2">
            <input type="text" name="MSME_NO" id="MSME_NO" value="<?php echo e($objMstCust->MSMENO); ?>" tabindex="37" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
          <div class="col-lg-1"><p>Factory No</p></div>
          <div class="col-lg-2">
            <input type="text" name="FACTORY_ACT_NO" id="FACTORY_ACT_NO" value="<?php echo e($objMstCust->FACTORY_NO); ?>" tabindex="38" class="form-control  "  maxlength="30"  autocomplete="off" style="text-transform:uppercase">
          </div>
				</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2">
            <input type="checkbox" name="TDS_APPLICABLE" id="TDS_APPLICABLE" value="1" tabindex="39" onChange="TdsApplicable()" <?php echo e(isset($objMstCust->TDS_APPLICABLE) && $objMstCust->TDS_APPLICABLE ==1?'checked':''); ?> >
          </div>

          <div class="col-lg-2"><p>Exceptional for GST</p></div>
          <div class="col-lg-2"> 
            <input type="checkbox" name="EXEGST" id="EXEGST" class="filter-none" value="1"  tabindex="40"  <?php echo e(isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':''); ?> > 
          </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2">
            <input type="text" name="CERTIFICATE_NO" id="CERTIFICATE_NO" tabindex="41" value="<?php echo e($objMstCust->CERTIFICATE_NO); ?>" class="form-control"  maxlength="30"  autocomplete="off">
          </div>

          <div class="col-lg-2"><p>Expiry Date</p></div>
          <div class="col-lg-2">
            <input type="date" name="EXPIRY_DT" id="EXPIRY_DT" tabindex="42" value="<?php echo e($objMstCust->EXPIRY_DT); ?>" class="form-control"   autocomplete="off">
          </div>
        </div>
        ...
        <div class="row TDS_ACTION" style="display:none;">
          ...
          <div class="col-lg-2 "><p>Exceptional for GST</p></div>
          <div class="col-lg-2"><input type="checkbox" name="EXE_GST" id="EXE_GST" tabindex="45" class="filter-none"  value="1" <?php echo e(isset($objMstCust->EXE_GST) && $objMstCust->EXE_GST =='1'?'checked':''); ?> > </div> 
            ...
            <tbody>
              <?php if(!empty($objPOC)): ?>
                ...
                <tr  class="participantRow">
                  <td><input  class="form-control w-100" type="text" name="POC_NAME_<?php echo e($key); ?>" tabindex="46" id="POC_NAME_<?php echo e($key); ?>" value="<?php echo e($row->NAME); ?>" maxlength="100" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_DESIG_<?php echo e($key); ?>" tabindex="47" id="POC_DESIG_<?php echo e($key); ?>" value="<?php echo e($row->DESIG); ?>" maxlength="50" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_MONO_<?php echo e($key); ?>" tabindex="48" id="POC_MONO_<?php echo e($key); ?>" value="<?php echo e($row->MONO); ?>"  maxlength="15" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_EMAIL_<?php echo e($key); ?>" tabindex="49" id="POC_EMAIL_<?php echo e($key); ?>" value="<?php echo e($row->EMAIL); ?>"  maxlength="50" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_LLNO_<?php echo e($key); ?>" tabindex="50" id="POC_LLNO_<?php echo e($key); ?>" value="<?php echo e($row->LLNO); ?>"  maxlength="20" ></td>
                  <td><input  class="form-control w-100" type="text" name="POC_AUTHLEVEL_<?php echo e($key); ?>" tabindex="51" id="POC_AUTHLEVEL_<?php echo e($key); ?>" value="<?php echo e($row->AUTHLEVEL); ?>"  maxlength="30" ></td>
                  <td style="text-align:center;" ><input type="date" placeholder="dd/mm/yyyy" tabindex="52"  name="POC_DOB_<?php echo e($key); ?>" id="POC_DOB_<?php echo e($key); ?>" value="<?php echo e((!is_null($row->DOB) && $row->DOB!='1900-01-01')? $row->DOB : ''); ?>" class="form-control" ></td>
                  <td align="center" >
            ...
            <?php if(!empty($objBANK)): ?>
             <?php $__currentLoopData = $objBANK; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="participantRow">
                ...
                <td>
                  <input  class="form-control w-100" type="text" name="BANK_ACNO_<?php echo e($key); ?>" tabindex="64" id="BANK_ACNO_<?php echo e($key); ?>" value="<?php echo e($row->ACNO); ?>" maxlength="30" ></td>
                <td align="center" >
                  <a class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
                  <button class="btn remove" title="Delete" data-toggle="tooltip" type="button" <?php if($loop->iteration-1==0): ?> disabled <?php endif; ?>><i class="fa fa-trash" <?php if($loop->iteration-1==0): ?> disabled <?php endif; ?> ></i></button>
                </td>
            ...
            <?php if(!empty($objLOC)): ?>
              ...
              <tr  class="participantRow">
                <td><input  class="form-control w-100" type="text" tabindex="69" name="LOC_NAME_<?php echo e($key); ?>" id="LOC_NAME_<?php echo e($key); ?>" value="<?php echo e($row->NAME); ?>"  maxlength="50" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="70" name="LOC_CADD_<?php echo e($key); ?>" id="LOC_CADD_<?php echo e($key); ?>" value="<?php echo e($row->CADD); ?>" maxlength="200" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="71" name="LOC_CTRYID_REF_<?php echo e($key); ?>" id="TXTLOC_CTRYID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->COU_CTRYCODE); ?> - <?php echo e($row->COU_NAME); ?>" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="72" name="HDNLOC_CTRYID_REF_<?php echo e($key); ?>" id="HDNLOC_CTRYID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->COU_CTRYID); ?>" maxlength="100" ></td>

                <td><input  class="form-control w-100" type="text" tabindex="73" name="LOC_STID_REF_<?php echo e($key); ?>" id="TXTLOC_STID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->STA_STCODE); ?> - <?php echo e($row->STA_NAME); ?>" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="74" name="HDNLOC_STID_REF_<?php echo e($key); ?>" id="HDNLOC_STID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->STA_STID); ?>" maxlength="100" readonly></td>

                <td><input  class="form-control w-100" type="text" tabindex="75" name="LOC_CITYID_REF_<?php echo e($key); ?>" id="TXTLOC_CITYID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->CIT_CITYCODE); ?> - <?php echo e($row->CIT_NAME); ?>" maxlength="100" readonly></td>
                <td hidden><input  class="form-control w-100" type="text" tabindex="76" name="HDNLOC_CITYID_REF_<?php echo e($key); ?>" value="<?php echo e($row->CIT_CITYID); ?>" id="HDNLOC_CITYID_REF_POPUP_<?php echo e($key); ?>" maxlength="100" readonly></td>


                <td><input  class="form-control w-100" type="text" tabindex="77" name="LOC_PIN_<?php echo e($key); ?>" id="LOC_PIN_<?php echo e($key); ?>" maxlength="20" value="<?php echo e($row->PIN); ?>" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="78" name="LOC_GSTIN_<?php echo e($key); ?>" id="LOC_GSTIN_<?php echo e($key); ?>" maxlength="30" value="<?php echo e($row->GSTIN); ?>"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="79" name="LOC_CPNAME_<?php echo e($key); ?>" id="LOC_CPNAME_<?php echo e($key); ?>" maxlength="30" value="<?php echo e($row->CPNAME); ?>"  ></td>
                <td><input  class="form-control w-100" type="text" tabindex="80" name="LOC_CPDESIGNATION_<?php echo e($key); ?>" id="LOC_CPDESIGNATION_<?php echo e($key); ?>" maxlength="20" value="<?php echo e($row->CPDESIGNATION); ?>" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="81" name="LOC_EMAIL_<?php echo e($key); ?>" id="LOC_EMAIL_<?php echo e($key); ?>" maxlength="50" value="<?php echo e($row->EMAIL); ?>" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="82" name="LOC_MONO_<?php echo e($key); ?>" id="LOC_MONO_<?php echo e($key); ?>" maxlength="15" value="<?php echo e($row->MONO); ?>" ></td>
                <td><input  class="form-control w-100" type="text" tabindex="83" name="LOC_SPINSTRACTION_<?php echo e($key); ?>" id="LOC_SPINSTRACTION_<?php echo e($key); ?>" maxlength="50" value="<?php echo e($row->SPINSTRACTION); ?>"  ></td>
                
                <td style="text-align:center;" ><input type="checkbox" name="LOC_BILLTO_<?php echo e($key); ?>" tabindex="84" id="LOC_BILLTO_<?php echo e($key); ?>" class="filter-none"  value="1" <?php echo e(($row->BILLTO == 1 || $row->BILLTO=='on')?'checked':''); ?>></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="85" name="LOC_DEFAULT_BILLTO_<?php echo e($key); ?>" id="LOC_DEFAULT_BILLTO_<?php echo e($key); ?>" class="filter-none"  value="1" <?php echo e(($row->DEFAULT_BILLTO == 1 || $row->DEFAULT_BILLTO=='on')?'checked':''); ?> ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="86" name="LOC_SHIPTO_<?php echo e($key); ?>" id="LOC_SHIPTO_<?php echo e($key); ?>" class="filter-none"  value="1" <?php echo e(($row->SHIPTO == 1 || $row->SHIPTO=='on')?'checked':''); ?> ></td>
                <td style="text-align:center;" ><input type="checkbox" tabindex="87" name="LOC_DEFAULT_SHIPTO_<?php echo e($key); ?>" id="LOC_DEFAULT_SHIPTO_<?php echo e($key); ?>" class="filter-none"  value="1" <?php echo e(($row->DEFAULT_SHIPTO == 1 || $row->DEFAULT_SHIPTO=='on')?'checked':''); ?> ></td>
        ...
        <div id="ALPSSpecific" class="tab-pane fade">
                    ...
                    <div class="inner-form" style="margin-top:10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_CODE" id="SAP_CUSTOMER_CODE" tabindex="107" value="<?php echo e($objMstCust->SAP_CUSTOMER_CODE); ?>"  class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD2) && $TabSetting->FIELD2 !=''?$TabSetting->FIELD2:'Add. Customer Name'); ?></p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_NAME" id="SAP_CUSTOMER_NAME" tabindex="108" value="<?php echo e($objMstCust->SAP_CUSTOMER_NAME); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD3) && $TabSetting->FIELD3 !=''?$TabSetting->FIELD3:'Add. Account Group'); ?></p></div>
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_ACCOUNT_GROUP" id="SAP_ACCOUNT_GROUP" tabindex="109" value="<?php echo e($objMstCust->SAP_ACCOUNT_GROUP); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_CODE" id="SAP_CUSTOMER_GROUP_CODE" tabindex="110" value="<?php echo e($objMstCust->SAP_CUSTOMER_GCODE); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_CUSTOMER_GROUP_NAME" id="SAP_CUSTOMER_GROUP_NAME" tabindex="111" value="<?php echo e($objMstCust->SAP_CUSTOMER_GNAME); ?>" class="form-control" >
                        </div>
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_GLOBAL_GROUP_CODE" id="SAP_GLOBAL_GROUP_CODE" tabindex="112" value="<?php echo e($objMstCust->SAP_GLOBAL_GACODE); ?>"class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                        <input type="text" name="SAP_GLOBAL_GRUOUP_NAME" id="SAP_GLOBAL_GRUOUP_NAME" tabindex="113" value="<?php echo e($objMstCust->SAP_GLOBAL_GANAME); ?>" class="form-control">
                        </div>
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="OUR_CODE" id="OUR_CODE" tabindex="114" value="<?php echo e($objMstCust->OUR_CODE_INCBOOK); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
			...
			<div id="udf" class="tab-pane fade">
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tr  class="participantRow">
                    <td>
                      <input name=<?php echo e("udffie_popup_".$udfkey); ?> id=<?php echo e("txtudffie_popup_".$udfkey); ?> value="<?php echo e($udfrow->LABEL); ?>" tabindex="115" class="form-control <?php if($udfrow->ISMANDATORY==1): ?> mandatory <?php endif; ?>" autocomplete="off" maxlength="100" disabled/>
                    </td>

                    <td hidden>
                      <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' tabindex="116" value="<?php echo e($udfrow->UDFCMID); ?>" class="form-control" maxlength="100" />
                    </td>
...
function checkDuplicateName(){
  ...
  var EXISTING_MOBILE   = <?php echo json_encode($objMstCust->OUR_CODE_INCBOOK, 15, 512) ?>;
...
//-----------------------
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[5,"update"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Sales/CUSTOMERMASTER/mstfrm5edit.blade.php ENDPATH**/ ?>