...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Stock Adjustment</a>
        </div>
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="<?php echo e(isset($objResponse->ST_ADJUST_DOCNO) && $objResponse->ST_ADJUST_DOCNO !=''?$objResponse->ST_ADJUST_DOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			  ...
			  <div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="ST_ADJUST_DOCDT" id="ST_ADJUST_DOCDT" value="<?php echo e(isset($objResponse->ST_ADJUST_DOCDT) && $objResponse->ST_ADJUST_DOCDT !=''?$objResponse->ST_ADJUST_DOCDT:''); ?>" class="form-control mandatory" >
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockAdjustment\trnfrm234view.blade.php ENDPATH**/ ?>