	...
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="PROID" id="PROID" value="<?php echo e(isset($objResponse)?$objResponse->PROID:''); ?>" class="form-control" readonly  autocomplete="off"   >
				...
				<div class="col-lg-2 pl">
					<input <?php echo e($ActionStatus); ?> type="date" name="PRO_DT" id="PRO_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse)?$objResponse->PRO_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionOrder\trnfrm239edit.blade.php ENDPATH**/ ?>