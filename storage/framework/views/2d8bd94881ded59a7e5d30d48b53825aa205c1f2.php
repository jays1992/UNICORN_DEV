...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
              ...
              <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e($objSE->AFP_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly disabled="disabled" style="text-transform:uppercase" autofocus >
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="AFSDT" id="AFSDT" value="<?php echo e($objSE->AFP_DT); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" disabled="disabled">
          </div>
    
    <div class="col-lg-1 pl"><p> Department	</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="DEPTID_NAME" id="DEPTID_NAME" value="<?php echo e($objSE->NAME); ?>" disabled="disabled" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="DEPID_REF" id="DEPID_REF" value="<?php echo e($objSE->DEPID_REF); ?>" disabled="disabled" class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
    
    <div class="col-lg-1 pl"><p>Financial Year</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="FYID_NAME" id="FYID_NAME" value="<?php echo e($objSE->FYDESCRIPTION); ?>"  disabled="disabled" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="FYID_REF" id="FYID_REF" value="<?php echo e($objSE->FYID_REF); ?>"  disabled="disabled"class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
  </div>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="tab-content">
                         ...
                         <input type="text" name=<?php echo e("BUID_REF_".$key); ?> id=<?php echo e("BUID_REF_".$key); ?>  value="<?php echo e($row->BUCODE); ?>" onClick="get_section($(this).attr('id'))" class="form-control mandatory" style="width:91px" readonly disabled="disabled" tabindex="1" />
                         ...
                         <td hidden> <input type="text" name=<?php echo e("REF_BUID_".$key); ?> id=<?php echo e("REF_BUID_".$key); ?> value="<?php echo e($row->BUID_REF); ?>" /></td>
                                                 ...
                                                 <!-- <td style="text-align:center;" >
                                                  ...
                                                  -->
                                                  <td><input type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?>  class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly disabled="disabled"/></td>
    ...
    <td><input type="text" name=<?php echo e("Itemspec_".$key); ?> id=<?php echo e("Itemspec_".$key); ?>  class="form-control"  value="<?php echo e($row->ITEMSPECI); ?>" autocomplete="off" disabled="disabled" /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH1_AP_".$key); ?> id=<?php echo e("MONTH1_AP_".$key); ?> class="form-control three-digits" value="<?php echo e($row->MONTH1_AP); ?>"   disabled="disabled"       maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH1_RT_".$key); ?> id=<?php echo e("MONTH1_RT_".$key); ?> class="form-control five-digits"  value="<?php echo e($row->MONTH1_RT); ?>" disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH2_AP_".$key); ?>  id=<?php echo e("MONTH2_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH2_AP); ?>"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH2_RT_".$key); ?>  id=<?php echo e("MONTH2_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH2_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH3_AP_".$key); ?>  id=<?php echo e("MONTH3_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH3_AP); ?>"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH3_RT_".$key); ?>  id=<?php echo e("MONTH3_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH3_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH4_AP_".$key); ?>  id=<?php echo e("MONTH4_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH4_AP); ?>"     disabled="disabled"                        maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH4_RT_".$key); ?>  id=<?php echo e("MONTH4_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH4_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH5_AP_".$key); ?>  id=<?php echo e("MONTH5_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH5_AP); ?>"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH5_RT_".$key); ?>  id=<?php echo e("MONTH5_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH5_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH6_AP_".$key); ?>  id=<?php echo e("MONTH6_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH6_AP); ?>"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH6_RT_".$key); ?>  id=<?php echo e("MONTH6_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH6_RT); ?>"   disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH7_AP_".$key); ?>  id=<?php echo e("MONTH7_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH7_AP); ?>"     disabled="disabled"                        maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH7_RT_".$key); ?>  id=<?php echo e("MONTH7_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH7_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH8_AP_".$key); ?>  id=<?php echo e("MONTH8_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH8_AP); ?>"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH8_RT_".$key); ?>  id=<?php echo e("MONTH8_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH8_RT); ?>"   disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH9_AP_".$key); ?>  id=<?php echo e("MONTH9_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_AP); ?>"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name=<?php echo e("MONTH9_TP_".$key); ?>  id=<?php echo e("MONTH9_TP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH9_TP); ?>"   disabled="disabled"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH9_RT_".$key); ?>  id=<?php echo e("MONTH9_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH9_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH10_AP_".$key); ?>  id=<?php echo e("MONTH10_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH10_AP); ?>"  disabled="disabled"                           maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH10_RT_".$key); ?>  id=<?php echo e("MONTH10_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH10_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH11_AP_".$key); ?>  id=<?php echo e("MONTH11_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH11_AP); ?>"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH11_RT_".$key); ?>  id=<?php echo e("MONTH11_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH11_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH12_AP_".$key); ?>  id=<?php echo e("MONTH12_AP_".$key); ?>  class="form-control three-digits"  value="<?php echo e($row->MONTH12_AP); ?>"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name=<?php echo e("MONTH12_RT_".$key); ?>  id=<?php echo e("MONTH12_RT_".$key); ?>  class="form-control five-digits"   value="<?php echo e($row->MONTH12_RT); ?>"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
 ...
 <td align="center" ><button class="btn add material" title="add" data-toggle="tooltip" type="button" disabled="disabled" ><i class="fa fa-plus"></i></button>
                        <button class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button" disabled="disabled"><i class="fa fa-trash" ></i></button></td>
...
$(document).ready(function() {
  ...
  $('#AFSDT').attr("min",last_DT);
  $('#AFSDT').attr("max",today);
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[220,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\AnnualForecastPurchase\trnfrm220view.blade.php ENDPATH**/ ?>