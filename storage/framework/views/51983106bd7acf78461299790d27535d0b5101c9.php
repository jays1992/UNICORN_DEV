    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tr>
                ...
                <th>Instrument Method Code</th>
                <th>Instrument Method Name</th>
                <th>Created Date</th>
                <th>De-Activated</th>
            ...
            <tbody>               
              ...
              ?>
              <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->INSTRUMENT_METHOD_ID); ?>" value="<?php echo e($val->INSTRUMENT_METHOD_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->INSTRUMENT_METHOD_CODE) && $val->INSTRUMENT_METHOD_CODE !=''?$val->INSTRUMENT_METHOD_CODE:''); ?></td>
                <td><?php echo e(isset($val->INSTRUMENT_METHOD_NAME) && $val->INSTRUMENT_METHOD_NAME !=''?$val->INSTRUMENT_METHOD_NAME:''); ?></td>
        ...
        <form id="masterForm385Print" action="<?php echo e(route('mastergetlist',[385,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[385,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[385,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[385,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
  ...
  $.ajax({
      url:'<?php echo e(route("master",[385,"MultiApprove"])); ?>',
      type:'POST',
      dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[385,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\InstrumentMethod\mstfrm385.blade.php ENDPATH**/ ?>