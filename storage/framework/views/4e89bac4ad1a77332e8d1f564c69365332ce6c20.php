...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Role Master</a>
                </div>
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th width="15%">Role Code </th>
                        <th width="15%">Role Description</th>
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->ROLLID); ?>" value="<?php echo e($val->ROLLID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->RCODE) && $val->RCODE !=''?$val->RCODE:''); ?></td>
...
$('#btnAmendment').on('click', function() {         
  ...
  if(seletedRecord==0){
    ...
    if(is_approve==1){
      var editURL = '<?php echo e(route("master",[$FormId,"amendment",":rcdId"])); ?>';
      editURL = editURL.replace(":rcdId",recordId);
      window.location.href=editURL;
    }
    else if(is_approve==2){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Common/RoleMaster/mstfrm198.blade.php ENDPATH**/ ?>