...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Job Work Challan</a>
        </div>
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="JWCNO" id="JWCNO" value="<?php echo e($objMstResponse->JWCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <input type="hidden" name="JWCID" id="JWCID" value="<?php echo e($objMstResponse->JWCID); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
              
          <div class="col-lg-2 pl"><p>JWO Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWCDT" id="JWCDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($objMstResponse->JWCDT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

              
          <div class="col-lg-2 pl"><p>Vendor</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="Vendor_popup" id="txtvendor_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e($objvendorcode2->VCODE); ?> - <?php echo e($objvendorcode2->NAME); ?>" readonly/>
        ...
        <div class="col-lg-2 pl"><p>Bill To </p></div>
          <div class="col-lg-2 pl" id="div_billto">
            ...
            <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e($objMstResponse->BILLTO); ?>" />
          </div>
          ...
          <div class="col-lg-2 pl" id="div_shipto">
            ...
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e($objMstResponse->SHIPTO); ?>" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" autocomplete="off" value=" <?php echo e($TAXSTATE[0]); ?>"   />
          </div>

          <div class="col-lg-2 pl"><p>Remarks</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($objMstResponse->REMARKS) && $objMstResponse->REMARKS !=''?$objMstResponse->REMARKS:''); ?>" class="form-control"  autocomplete="off" />
          </div>
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input type="text" name="txtJWOID_popup_<?php echo e($key); ?>"   id="txtJWOID_popup_<?php echo e($key); ?>" value="<?php echo e($row->JWONO); ?>" class="form-control" autocomplete="off" readonly style="width:100px;" /></td>
                    ...
                    <td hidden><input type="text"  name="SOID_REF_<?php echo e($key); ?>"  id="SOID_REF_<?php echo e($key); ?>" value="<?php echo e($row->SOID_REF); ?>" class="form-control" autocomplete="off" /></td>   
										...
										<td><input	type="text"	name="popupMUOM_<?php echo e($key); ?>"	id="popupMUOM_<?php echo e($key); ?>"	value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"	class="form-control"  autocomplete="off"  readonly style="width:100px;"/></td>
										...
										<td><input type="text"   name="QTY_<?php echo e($key); ?>" 		id="QTY_<?php echo e($key); ?>" 		value="<?php echo e($row->JW_PRODUCE_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input type="text"   name="BL_SOQTY_<?php echo e($key); ?>" 	id="BL_SOQTY_<?php echo e($key); ?>" value="<?php echo e($row->JW_PRODUCE_QTY); ?>"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input type="text"   name="PD_OR_QTY_<?php echo e($key); ?>" 	id="PD_OR_QTY_<?php echo e($key); ?>" value="<?php echo e($row->JW_PRODUCE_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="<?php echo e($mitem_id); ?>" readonly onKeyup="get_materital_item()"  /></td>
										
                    <td><input type="date"   name="EDA_<?php echo e($key); ?>"      id="EDA_<?php echo e($key); ?>"       class="form-control"                value="<?php echo e($row->EDA); ?>" autocomplete="off"    /></td>
                      ...
                      <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                          ...
                          <tbody>
                            ...
                            <tr  class="participantRow4">
                              ...
                              <td hidden>
                                <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDFJWCID); ?>" class="form-control" maxlength="100" />
                              </td>
...
function validateForm(saveAction){
  ...
  if(JWCNO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#JWCDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkChallan\trnfrm355edit.blade.php ENDPATH**/ ?>