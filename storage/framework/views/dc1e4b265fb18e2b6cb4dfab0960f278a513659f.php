        ...
        <form id="frm_mst_bom"  method="POST">   
            ...
            <div class="row">
                ...
                <input type="hidden" id="BOMID_COPY" value="<?php echo e(isset($objBOM->BOMID)?$objBOM->BOMID:''); ?>">
                          ...
                          <input type="text" name="BOMANO" id="BOMANO" value="<?php echo e($ANumber); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                          <input type="hidden" name="BOMID_REF" id="BOMID_REF" value="<?php echo e(isset($objBOM->BOMID)?$objBOM->BOMID:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                  ...
                  <input type="text" name="REASON_BOMA" id="REASON_BOMA" value="" class="form-control mandatory"  autocomplete="off"    >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">         
                                ...
                                <input type="text" name="BOMNO" id="BOMNO" class="form-control mandatory" value="<?php echo e(isset($objBOM->BOM_NO)?$objBOM->BOM_NO:''); ?>" readonly  autocomplete="off" style="text-transform:uppercase" autofocus >
                       
                            </div>
                            <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="BOM_DT" id="BOM_DT" class="form-control mandatory" autocomplete="off" value="<?php echo e(isset($objBOM->BOM_DT)?$objBOM->BOM_DT:''); ?>" placeholder="dd/mm/yyyy" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <input type="text" name="DESCRIPTION" id="DESCRIPTION" class="form-control mandatory" value="<?php echo e(isset($objBOM->NAME)?$objBOM->NAME:''); ?>" readonly autocomplete="off"  >
                            </div>       
                            <div class="col-lg-2 pl"><p>UOM	 </p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="UOMID_REF_DESC" id="UOMID_REF_DESC" value="<?php echo e(isset($objBOM->UOMCODE)?$objBOM->UOMCODE:''); ?> <?php echo e(isset($objBOM->DESCRIPTIONS)?'-'.$objBOM->DESCRIPTIONS:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  >
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[202,"saveamendment"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\BillofMaterial\mstfrm202amendment.blade.php ENDPATH**/ ?>