...
<?php $helper = app('App\Helpers\Helper'); ?>    
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[415,'index'])); ?>" class="btn singlebt">Manual Journal Voucher (MJV)</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid filter">
      ...
      <?php echo csrf_field(); ?>
      <?php echo e(isset($objJV->MJVID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="hidden" name="MJVID" id="MJVID" value="<?php echo e(isset($objJV->MJVID)?$objJV->MJVID:''); ?>" />
              <input <?php echo e($ActionStatus); ?> type="text" name="MJV_NO" id="MJV_NO" value="<?php echo e(isset($objJV->MJV_NO)?$objJV->MJV_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         </div>
        <div class="col-lg-1 pl"><p>MJV Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="MJV_DT" id="MJV_DT" value="<?php echo e(isset($objJV->MJV_DT)?$objJV->MJV_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" readonly />
        </div>
        <div class="col-lg-1 pl"><p> Reverse	</p></div> 
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="checkbox" name="REVERSE" id="REVERSE" <?php echo e(isset($objJV->REVERSE) && $objJV->REVERSE == 1 ? 'checked' : ''); ?> />
        </div>
        <div class="col-lg-1 pl"><p>Reverse Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="REVERSE_DT" id="REVERSE_DT" value="<?php echo e(isset($objJV->REVERSE_DT)?$objJV->REVERSE_DT:''); ?>" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" class="form-control" value="<?php echo e(isset($objJV->REMARKS)?$objJV->REMARKS:''); ?>"  autocomplete="off"   />
        </div>
        <div class="col-lg-1 pl"><p>Source Doc No</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="SOURCE_DOCNO" id="SOURCE_DOCNO" class="form-control"  value="<?php echo e(isset($objJV->SOURCE_DOCNO)?$objJV->SOURCE_DOCNO:''); ?>"   autocomplete="off" disabled  />
        </div>
        
        <div class="col-lg-1 pl"><p>Source Doc Date</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="SOURCE_DOCDT" id="SOURCE_DOCDT" autocomplete="off"  value="<?php echo e(isset($objJV->SOURCE_DOCDT)?$objJV->SOURCE_DOCDT:''); ?>"  class="form-control"disabled  >
        </div>

        <div class="col-lg-1 pl"><p>Common Narration</p></div>
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="NARRATION" id="NARRATION" class="form-control"  value="<?php echo e(isset($objJV->NARRATION)?$objJV->NARRATION:''); ?>"   autocomplete="off"  />                          
          </div>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:400px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                            ...
                            <tr>
                                <th width="15%">GL/SL<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>"></th>
                    ...
                    <tbody>
                    <?php if(!empty($objJVACC)): ?>
                      <?php $__currentLoopData = $objJVACC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr  class="participantRow">
                            ...
                            <td hidden><input type="hidden" name=<?php echo e("txtflag_".$key); ?> id=<?php echo e("txtflag_".$key); ?> class="form-control" value="<?php echo e($row->SGLID_REF); ?>" autocomplete="off" /></td>
                            ...
                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("DR_AMT_".$key); ?> id=<?php echo e("DR_AMT_".$key); ?> class="form-control two-digits right" value="<?php echo e($row->DR_AMT); ?>" maxlength="15"  autocomplete="off" <?php echo e($row->CR_AMT > ".00" && $row->DR_AMT == ".00" ? 'disabled' : ''); ?> onkeyup="getTotalRowValue()"  /></td>
                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CR_AMT_".$key); ?> id=<?php echo e("CR_AMT_".$key); ?> class="form-control two-digits right" value="<?php echo e($row->CR_AMT); ?>" maxlength="15"  autocomplete="off" <?php echo e($row->DR_AMT > ".00" && $row->CR_AMT == ".00" ? 'disabled' : ''); ?> onkeyup="getTotalRowValue()" /></td>
                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("NARRATION_".$key); ?> id=<?php echo e("NARRATION_".$key); ?> class="form-control" value="<?php echo e($row->NARRATION); ?>"  autocomplete="off"  /></td>
        ...
        <div id="udf" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                    <tr >
                        <th>UDF Fields<input class="form-control" type="hidden" name="Row_Count2" id ="Row_Count2" value="<?php echo e(isset($objCount2)? $objCount2 : (isset($objCountUDF)? objCountUDF : 1)); ?>"></th>
                    ...
                    <?php if(!empty($objJVUDF)): ?>
                        <?php $__currentLoopData = $objJVUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow4">
                                <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDFJVID_".$Ukey); ?> id=<?php echo e("popupUDFJVID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                <td hidden><input type="hidden" name=<?php echo e("UDFJVID_REF_".$Ukey); ?>  id=<?php echo e("UDFJVID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFJVID_REF); ?>" autocomplete="off" /></td>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                    <?php else: ?>
                        <?php $__currentLoopData = $objUdfJVData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDFJVID_".$uindex); ?> id=<?php echo e("popupUDFJVID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDFJVID_REF_".$uindex); ?> id=<?php echo e("UDFJVID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFJVID); ?>" autocomplete="off"   /></td>
        ...
        <div id="CostCenter" class="tab-pane fade" >
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                    <tr >
                        <th>GLID<input class="form-control" type="hidden" name="Row_Count3" id ="Row_Count3" value="<?php echo e($objCount3); ?>"></th>
                        <th>CCID</th>
                        <th>DR_AMT</th>
                        <th>CR_AMT</th>
                    </tr>
                    ...
                    <tbody>
                    <?php if(!empty($objJVCCD)): ?>
                        <?php $__currentLoopData = $objJVCCD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cckey => $ccrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow5">
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("D_AMT_".$cckey); ?> id=<?php echo e("D_AMT_".$cckey); ?> class="form-control two-digits" value="<?php echo e($ccrow->DR_AMT); ?>"   autocomplete="off" readonly/></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("C_AMT_".$cckey); ?> id=<?php echo e("C_AMT_".$cckey); ?> class="form-control two-digits" value="<?php echo e($ccrow->CR_AMT); ?>"  autocomplete="off"  readonly/></td>                          
                          </tr>
                          <tr></tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                    <?php else: ?>
                          <tr  class="participantRow5">
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name="D_AMT_0" id="D_AMT_0" class="form-control two-digits"   autocomplete="off" readonly/></td>
                              <td><input  <?php echo e($ActionStatus); ?> type="text" name="C_AMT_0" id="C_AMT_0" class="form-control two-digits"  autocomplete="off"  readonly/></td>                          
                          </tr>
                          <tr></tr>
                    <?php endif; ?> 
                    </tbody>
      ...
      <table id="CostTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;">
        ...
        <tbody id="tbody_cc"> 
          <tr class="participantRow2">
            <td style="width:20%;"><input <?php echo e($ActionStatus); ?> type="text" name="ppGLID_0" id="ppGLID_0" class="form-control"  autocomplete="off"  readonly/></td>
            ...
            <td style="width:15%;"><input <?php echo e($ActionStatus); ?> type="text" name="hdnDRAMT_0" id="hdnDRAMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
            <td style="width:15%;"><input <?php echo e($ActionStatus); ?> type="text" name="hdnCRAMT_0" id="hdnCRAMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
            <td style="width:15%;">
            <button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
  ...
  $('#Accounting').on('click','[id*="txtGLID"]',function(event){
    ...
    var fieldid = $(this).parent().parent().find('[id*="GLID_REF"]').attr('id');
      ...
      $("#tbody_glsl").html('');
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[415,"getglsl"])); ?>',
            type:'POST',
...
let cid = "#ppcostcenter2";
  ...
  $('#costpopup').on('click','[id*="CostCenter"]',function(event){
    ...
    $("#tbody_ppcost").html('');
      ...
      $.ajax({
          url:'<?php echo e(route("transaction",[415,"getCostCenter"])); ?>',
          type:'POST',
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("transaction",[415,"add"])); ?>';
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[415,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[415,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transaction",[415,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[415,"index"])); ?>';
});
...
function getBalanceGrid(bankid,fieldid,flag){
  ...
  url:'<?php echo e(route("transaction",[415,"getBalance"])); ?>',
  async: false,
  dataType: 'json',
...
$('#btnPrint').on('click', function() {
            var DOCID    ='<?php echo e($objJV->MJVID); ?>';     
            var Flag    = 'H';
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[415,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
  ...
  $('#btnExcel').on('click', function() {
            ...
            var Flag = 'E';
            var formData = 'SO='+ DOCID + '&MJVID='+ DOCID + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[415,"ViewReport",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ManualJournalVoucher\trnfrm415view.blade.php ENDPATH**/ ?>