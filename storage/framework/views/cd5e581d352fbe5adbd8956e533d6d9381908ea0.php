         ...
         <form id="frm_mst_add" method="POST"> 
          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="TERRITORY_NAME" id="TERRITORY_NAME" onclick="getTerritoryName(this.id,'<?php echo e(route('master',[$FormId,'getTerritory'])); ?>','Territory Name Details')" class="form-control mandatory" readonly />
                          ...
                          <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                            ...
                            <tbody>
                              <tr  class="participantRow">
                                ...
                                <td><input  class="form-control" type="text" name="CITYCODE[]"   id ="CITYCODE_0" onclick="getTerritoryName(this.id,'<?php echo e(route('master',[$FormId,'getCityCode'])); ?>','City Code Details')" autocomplete="off" readonly></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\PROJECTS\UNICORN_DEV\resources\views/masters/PreSales/TerritoryCityMapping/mstfrm558add.blade.php ENDPATH**/ ?>