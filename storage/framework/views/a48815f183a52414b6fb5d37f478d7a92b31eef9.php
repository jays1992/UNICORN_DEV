...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->RFQID); ?>" value="<?php echo e($val->RFQID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->RFQ_DT) && $val->RFQ_DT !='' && $val->RFQ_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RFQ_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->RFQ_NO) && $val->RFQ_NO !=''?$val->RFQ_NO:''); ?></td>
              <td><?php echo e(isset($val->RFQ_DT) && $val->RFQ_DT !='' && $val->RFQ_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RFQ_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\RequestForQuotation\trnfrm60.blade.php ENDPATH**/ ?>