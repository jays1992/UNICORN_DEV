       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" value="<?php echo e($objHRD->ASSETTRANCODE); ?>" class="form-control mandatory"  autocomplete="off" readonly disabled>
                 <span class="text-danger" id="ERROR_DPP_NO"></span> 
               </div>

               <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="LEAVE_APP_DT" value="<?php echo e($objHRD->ASSETTRANDATE); ?>" id="LEAVE_APP_DT" class="form-control"  maxlength="100" disabled> 
                 </div>

               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="<?php echo e($objHRD->ASSETCODE); ?>" class="form-control mandatory"  autocomplete="off" disabled readonly/>
                   <input type="hidden" name="ASSETID_REF" id="ASCATID" value="<?php echo e($objHRD->ASSETID_REF); ?>" class="form-control" autocomplete="off" disabled />
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" value="<?php echo e($objHRD->ASTDESCRIPTIONS); ?>" class="form-control" readonly  maxlength="100" disabled> 
                 </div>
               
                 <div class="col-lg-2 pl"><p>Asset No*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETNO" id="ASSETNO" value="<?php echo e($objHRD->ASTCODE); ?>" class="form-control mandatory"  autocomplete="off" disabled readonly/>
                   <input type="hidden" name="ASTID_REF" id="ASTID_REF" value="<?php echo e($objHRD->ASSETNOID_REF); ?>" class="form-control" autocomplete="off" disabled />
               ...
               <div class="col-lg-2 pl"><p>Asset Location</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTLOCATION" id="ASTLOCATION" value="<?php echo e($objHRD->ASTSUBCODE); ?>" class="form-control" readonly maxlength="100" disabled> 
                 </div>
               </div>
               <div class="row">
                 <div class="col-lg-2 pl"><p>Sub Location</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTSUBLOCATION" id="ASTSUBLOCATION" value="<?php echo e($objHRD->ASTSUBDES); ?>" class="form-control" readonly maxlength="100" disabled> 
                   <input type="hidden" name="ALID_REF_FROM" id="ALID_REF_FROM" value="<?php echo e($objHRD->ALID_REF_FROM); ?>" class="form-control" readonly maxlength="100" disabled >
                 </div>

                 <div class="col-lg-2 pl"><p>In case Asset with Employee</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTEMPY" id="ASTEMPY"  value="<?php echo e($objHRD->EMPCODE); ?>" class="form-control mandatory"  autocomplete="off" disabled readonly/>
                   <input type="hidden" name="ASASTCATID" id="ASASTCATID"  value="<?php echo e($objHRD->WITH_EMPLOYEE); ?>" class="form-control" autocomplete="off" disabled />
                 </div>
             ...
             <div class="col-lg-2 pl">
               <input type="text" name="REASON_TRANFR" id="REASON_TRANFR" value="<?php echo e($objHRD->REASON); ?>" class="form-control"  maxlength="100" disabled> 
             </div>
           </div>
             ...
             <div class="col-lg-2 pl">
               <input type="text" name="REMARKS" id="REMARKS" value="<?php echo e($objHRD->REMARKS); ?>" class="form-control"  maxlength="100" disabled> 
             <input type="hidden" id="focusid" >
             <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
           </div>          
           </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Asset\AssetTransfer\trnfrm411view.blade.php ENDPATH**/ ?>