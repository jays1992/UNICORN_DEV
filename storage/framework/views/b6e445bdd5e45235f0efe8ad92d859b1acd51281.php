...
<form id="frm_mst_se" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >    
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody id="udfforsebody" >
                    <tr  class="participantRow">
                        ...
                        <td><textarea class="form-control w-100" rows="1" name="DESCRIPTIONS_0" id="txtdesc_0"  maxlength="200" autocomplete="off" ></textarea> </td>
    ...
    // $('[id*="txtlabel"]').blur(function(){
     $('#example2').on('blur','[id*="txtlabel"]',function(){
      ...
      if(LABEL ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[90,"checkLabel"])); ?>',
            type:'POST',
            data:formData,
...
//add row
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[90,'add'])); ?>";
...
function validateForm(){
 ...
 else if(VALUETYPE ==="Combobox" && DESCRIPTIONS ===""){
...
$.ajax({
    url:'<?php echo e(route("master",[90,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\UDFSE\mstfrm90add.blade.php ENDPATH**/ ?>