...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                    <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">User Role Listing Report</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pbs"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Module Name</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="MODULENAME[]" data-hide-disabled="hide" multiple data-actions-box="true" id="MODULENAME" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjModule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cRow->MODULEID); ?>" selected><?php echo e($cRow->MODULECODE); ?>-<?php echo e($cRow->MODULENAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            
                            <div class="col-lg-3 pl"><p>User Name</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="USERNAME[]" data-hide-disabled="hide" multiple data-actions-box="true" id="USERNAME" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cRow->USERID); ?>" selected><?php echo e($cRow->UCODE); ?>-<?php echo e($cRow->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
    ...
    $('#btnView').on('click', function() {
        ...
        var MODULENAME = [];
        $("select[name='MODULENAME[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                MODULENAME.push(value3);
            }
        });

        var USERNAME = [];
        $("select[name='USERNAME[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                USERNAME.push(value4);
            }
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Common\UserRoleListingReport\rptfrm550.blade.php ENDPATH**/ ?>