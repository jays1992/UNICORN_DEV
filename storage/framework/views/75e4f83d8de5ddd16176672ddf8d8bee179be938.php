  ...
  <div class="multiple table-responsive  ">
    <table id="rpro_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->EWID); ?>" value="<?php echo e($val->EWID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->EW_DT) && $val->EW_DT !='' && $val->EW_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->EW_DT)):''); ?>" ></td>
          <td><?php echo e(isset($val->EW_NO) && $val->EW_NO !=''?$val->EW_NO:''); ?></td>
          <td><?php echo e(isset($val->EW_DT) && $val->EW_DT !='' && $val->EW_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->EW_DT)):''); ?></td>
      ...
      <div class="modal-body">
        ...
        <div class="btdiv">    
          ...
          <button class="btn alertbt" name='OkBtn' id="OkBtn" style="margin-left: 90px;">
            <div id="alert-active" class="activeOk"></div>OK
          </button>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Extended Warranty Print</p></div>
        <div class="row">
...
// Print
  $('#btnPrint').on('click', function() {
    ...
    }else if(seletedRecord==1)
    {
      ...
      var Flag = 'H';
      var formData = 'SO='+ SONO + '&EWID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/ExtendedWarranty/trnfrm497.blade.php ENDPATH**/ ?>