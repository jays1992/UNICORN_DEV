<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
          <div class="inner-form">
                ...
                <div class="row">
                  <div class="col-lg-2 pl"><p>Post Level</p></div>
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->PDESCRCRIPTIONS); ?> </label>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\DesignationMaster\mstfrm171view.blade.php ENDPATH**/ ?>