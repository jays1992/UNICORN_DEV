    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button class="btn topnavbt" id="btnApprove" <?php echo e(($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? 'disabled' : 'disabled'); ?>><i class="fa fa-thumbs-o-up"></i> Approved</button>
            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                            <div class="col-lg-2 pl">
                                ...
                                <input <?php echo e($ActionStatus); ?> type="text" name="DOCNO" id="DOCNO" value="<?php echo e(isset($objSTORETOTSOTE->STTOST_DOCNO)?$objSTORETOTSOTE->STTOST_DOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                                                                              
                       
                            </div>


                    <input type="hidden" name="STTOSTID" value="<?php echo e(isset($objSTORETOTSOTE->STTOSTID)?$objSTORETOTSOTE->STTOSTID:''); ?>">

          
                    <div class="col-lg-2 pl"><p>Date</p></div>
                    <div class="col-lg-2 pl">
                    <input type="hidden" id="objlastSTSDT"  value="<?php echo e(isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''); ?>">
                                <input <?php echo e($ActionStatus); ?> type="date" name="STSDT" id="STSDT" value="<?php echo e(isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>

                    <div class="col-lg-2 pl"><p>Item Category</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="ItemCatID_popup" id="txtItemCatID_popup" value="<?php echo e(isset($objCategory->ICCODE)?$objCategory->ICCODE:''); ?> <?php echo e(isset($objCategory->DESCRIPTIONS)?'-'.$objCategory->DESCRIPTIONS:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                                <input type="hidden" name="ITEMCAT_REF" id="ITEMCAT_REF" value="<?php echo e(isset($objSTORETOTSOTE->ICID_REF)?$objSTORETOTSOTE->ICID_REF:''); ?>" class="form-control" autocomplete="off" />
                ...
                <div class="col-lg-2 pl"><p>From Store</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="FromStore_popup" id="txtFromStore_popup"  class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objFromStore->STCODE)?$objFromStore->STCODE:''); ?> <?php echo e(isset($objFromStore->NAME)?'-'.$objFromStore->NAME:''); ?>"  readonly/>
                                <input type="hidden" name="FROMSTOREID_REF" id="FROMSTOREID_REF" value="<?php echo e(isset($objSTORETOTSOTE->FROM_STID_REF)?$objSTORETOTSOTE->FROM_STID_REF:''); ?>" class="form-control" autocomplete="off" />
                            </div>  
                <div class="col-lg-2 pl"><p>To Store</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="ToStore_popup" id="txtToStore_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objToStore->STCODE)?$objToStore->STCODE:''); ?> <?php echo e(isset($objToStore->NAME)?'-'.$objToStore->NAME:''); ?>"  readonly/>
                                <input type="hidden" name="TOSTOREID_REF" id="TOSTOREID_REF" class="form-control" value="<?php echo e(isset($objSTORETOTSOTE->TO_STID_REF)?$objSTORETOTSOTE->TO_STID_REF:''); ?>" autocomplete="off" />
                            </div>  
                        ...
                        <div id="MaterialCustom" class="tab-pane fade in active">
                            ...
                            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height: 380px; margin-top: 10px;">
                                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height: auto !important;">
                                    ...
                                    <tbody>
                                    <?php if(!empty($objSTORETOTSOTEMAT)): ?>
                                    <?php $__currentLoopData = $objSTORETOTSOTEMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$objSTORETOTSOTEMAT_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <tr class="participantRow1">
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ITEMG_CODE_".$key); ?> id=<?php echo e("ITEMG_CODE_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->GROUPCODE); ?>-<?php echo e($objSTORETOTSOTEMAT_list->GROUPNAME); ?>"  class="form-control" autocomplete="off" readonly /></td>
                                            <td hidden>
                                                <input type="text" name=<?php echo e("ITEMGID_REF_".$key); ?> id=<?php echo e("ITEMGID_REF_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->ITEMGID_REF); ?>" class="form-control" autocomplete="off" />
                                                <input type="text" name="rowscount1[]" />
                                            </td>
                                
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("MainItemCode1_".$key); ?> id=<?php echo e("MainItemCode1_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->ICODE); ?>"  class="form-control" autocomplete="off" readonly /></td>
                                            <td hidden><input type="hidden" name=<?php echo e("MainItemId1_Ref_".$key); ?> id=<?php echo e("MainItemId1_Ref_".$key); ?>  class="form-control" value="<?php echo e($objSTORETOTSOTEMAT_list->ITEMID_REF); ?>" autocomplete="off" /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("MainItemName1_".$key); ?> id=<?php echo e("MainItemName1_".$key); ?> value="<?php echo e($objSTORETOTSOTEMAT_list->NAME); ?>" class="form-control" autocomplete="off" readonly /></td>

                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($objSTORETOTSOTEMAT_list->ALPS_PART_NO)?$objSTORETOTSOTEMAT_list->ALPS_PART_NO:''); ?>" readonly/></td>
                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($objSTORETOTSOTEMAT_list->CUSTOMER_PART_NO)?$objSTORETOTSOTEMAT_list->CUSTOMER_PART_NO:''); ?>" readonly/></td>
                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="OEMpartno_<?php echo e($key); ?>"  id="OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  value="<?php echo e(isset($objSTORETOTSOTEMAT_list->OEM_PART_NO)?$objSTORETOTSOTEMAT_list->OEM_PART_NO:''); ?>" readonly/></td>



                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("UOM_".$key); ?> id=<?php echo e("UOM_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->UOMCODE); ?>-<?php echo e($objSTORETOTSOTEMAT_list->DESCRIPTIONS); ?>"  class="form-control" readonly autocomplete="off" /></td>
                                            <td hidden><input type="text" name=<?php echo e("UOM_REF_".$key); ?> id=<?php echo e("UOM_REF_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->UOMID_REF); ?>" maxlength="12" class="form-control" readonly autocomplete="off" /></td>
                                            <td hidden><input type="text" name=<?php echo e("ALTUOMID_REF_".$key); ?> id=<?php echo e("ALTUOMID_REF_".$key); ?>  maxlength="12" class="form-control" readonly autocomplete="off" value="<?php echo e($objSTORETOTSOTEMAT_list->ALT_UOMID_REF); ?>" /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ITEM_QTY_".$key); ?> id=<?php echo e("ITEM_QTY_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->QTY); ?>"  maxlength="12" class="form-control" autocomplete="off" /></td>
                                            <td align="center" >
                                              <button <?php echo e($ActionStatus); ?> class="btn" <?php echo e(isset($objSTORETOTSOTEMAT_list->BATCHNOA) && $objSTORETOTSOTEMAT_list->BATCHNOA =='0' ? 'disabled':''); ?> id="SCSTR_0" name="SCSTR_0" type="button"><i class="fa fa-clone"></i></button>
                                            </td>


                                            <td hidden ><input type="hidden" name=<?php echo e("TotalHiddenQty_".$key); ?> id=<?php echo e("TotalHiddenQty_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->QTY); ?>"></td>
                                            <td hidden ><input type="hidden" name=<?php echo e("HiddenRowId_".$key); ?> id=<?php echo e("HiddenRowId_".$key); ?>   value="<?php echo e($objSTORETOTSOTEMAT_list->BATCH_QTY); ?>"></td>                                                    
                                            <td hidden><input type="text" name=<?php echo e("STORE_".$key); ?> id=<?php echo e("STORE_".$key); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                           
                                            <td hidden><input type="text" name=<?php echo e("RATE_".$key); ?> id=<?php echo e("RATE_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->RATE); ?>" class="form-control" maxlength="12" autocomplete="off" readonly /></td>

                                            <td hidden><input type="text" name=<?php echo e("VALUE_".$key); ?> id=<?php echo e("VALUE_".$key); ?>  value="<?php echo e($Total_Amounts); ?>"  class="form-control" maxlength="12" autocomplete="off" value="0.00" readonly /></td>


                                           
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("REMARKS_".$key); ?> id=<?php echo e("REMARKS_".$key); ?>  value="<?php echo e($objSTORETOTSOTEMAT_list->REMARKS); ?>" class="form-control"  autocomplete="off" /></td>
                                   
                                            <td align="center">
                                                <button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                <button <?php echo e($ActionStatus); ?> class="btn remove smaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
								...
								<div id="store" class="tab-pane fade" >
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                                        <table id="example5" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tr >
                                                <th>Batch No<input class="form-control" type="hidden" name="Row_Count3" id ="Row_Count3" value="<?php echo e($objCount3); ?>"></th>
                                                <th>From Store</th>
                                                <th>To Store</th>
                                            ...
                                            <tbody>
                                            <?php if(!empty($objSTORE)): ?>
                                              <?php $__currentLoopData = $objSTORE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$sRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow5">
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("BATCHNO_".$key); ?> id=<?php echo e("BATCHNO_".$key); ?> class="form-control" value="<?php echo e($sRow->BATCH_CODE); ?>"  autocomplete="off"  /></td>
                                                 <td width="125"><input <?php echo e($ActionStatus); ?> type="text"  class="form-control" value="<?php echo e($objFromStore->STCODE); ?>-<?php echo e($objFromStore->NAME); ?>" autocomplete="off"   readonly /></td>
                                                 <td width="125"><input <?php echo e($ActionStatus); ?> type="text"  class="form-control" value="<?php echo e($objToStore->STCODE); ?>-<?php echo e($objToStore->NAME); ?>" autocomplete="off"   readonly /></td>
                                                 <td hidden><input type="text" name=<?php echo e("STID_REF_".$key); ?> id=<?php echo e("STID_REF_".$key); ?> class="form-control" value="" autocomplete="off"   readonly /></td>
                                                 <td hidden><input type="text"  name=<?php echo e("BATCHID_REF_".$key); ?> id=<?php echo e("BATCHID_REF_".$key); ?>  class="form-control"  autocomplete="off"  value="<?php echo e($sRow->BATCHID_REF); ?>" /></td>
                                                  <td hidden><input type="text" name=<?php echo e("SERIALNO_".$key); ?> id=<?php echo e("SERIALNO_".$key); ?> class="form-control" value=""   autocomplete="off" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("STRMUOMID_REF_".$key); ?> id=<?php echo e("STRMUOMID_REF_".$key); ?> class="form-control" value="<?php echo e($sRow->MAIN_UOMID_REF); ?>"  autocomplete="off"  /></td>
                                                  <td hidden><input type="text" name=<?php echo e("SOTCK_".$key); ?> id=<?php echo e("SOTCK_".$key); ?> class="form-control" autocomplete="off" value=""   /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("DISPATCH_MAIN_QTY_".$key); ?> id=<?php echo e("DISPATCH_MAIN_QTY_".$key); ?> class="form-control"  value="<?php echo e($sRow->TRANSFER_QTY); ?>"  autocomplete="off" /></td>
                                                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("STRAUOMID_REF_".$key); ?> id=<?php echo e("STRAUOMID_REF_".$key); ?> class="form-control" value="<?php echo e($sRow->ALT_UOMID_REF); ?>" autocomplete="off"   /></td>
                                                  <td hidden><input type="text" name=<?php echo e("STRITEM_REF_".$key); ?> id=<?php echo e("STRITEM_REF_".$key); ?> class="form-control" value="<?php echo e($sRow->ITEMID_REF); ?>"  autocomplete="off" /></td>
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[270,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $("#btnApprove").show();  
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[270,"update"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
          $(".buttonload").hide(); 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StoretoStoreTransafer\trnfrm270view.blade.php ENDPATH**/ ?>