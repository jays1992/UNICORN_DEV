	...
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="RPRID" id="RPRID" value="<?php echo e(isset($objResponse)?$objResponse->RPRID:''); ?>" class="form-control" readonly  autocomplete="off"   >
				...
				<div class="col-lg-2 pl">
					<input <?php echo e($ActionStatus); ?> type="date" name="RPR_DT" id="RPR_DT" value="<?php echo e(isset($objResponse)?$objResponse->RPR_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\RequisitionAgainstPRO\trnfrm273view.blade.php ENDPATH**/ ?>