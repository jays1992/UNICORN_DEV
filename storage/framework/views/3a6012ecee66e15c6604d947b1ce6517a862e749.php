...
<div class="inner-form">
  ...
  <div class="row">
   ...
   <div class="row">
    ...
    value='<?php echo e($objRouting->DEACTIVATED == 1 ? 1 : 0); ?>'  >
    </div>
    
    <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
    <div class="col-lg-2 pl">
      <input type="date" name="HDR_DODEACTIVATED" class="form-control" id="HDR_DODEACTIVATED" <?php echo e($objRouting->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objRouting->DODEACTIVATED) && $objRouting->DODEACTIVATED !="" && $objRouting->DODEACTIVATED !="1900-01-01" ? $objRouting->DODEACTIVATED:''); ?>" placeholder="dd/mm/yyyy"  />
    </div>
  </div>
...
<tr  class="participantRow">
  ...
  <td style="text-align:center;" >
    <input type="text" name="PStage_popup_<?php echo e($key); ?>" id="txtPStage_popup_<?php echo e($key); ?>"   value="<?php echo e($row->PSTAGE_CODE); ?>" class="form-control mandatory" style="width:140px" readonly />
  </td>
  <td  hidden>
  ...
  <td >
    <input type="text" name="STAGE_DESC_<?php echo e($key); ?>" id="STAGE_DESC_<?php echo e($key); ?>" value="<?php echo e($row->DESCRIPTIONS); ?>" class="form-control" readonly style="width: 100%;"/> 
  </td> 
  <td style="text-align: center;"><input type="checkbox" name="INHOUSE_PRODUCTION_<?php echo e($key); ?>" id="INHOUSE_PRODUCTION_<?php echo e($key); ?>" value="1" <?php if($row->INHOUSE_PRODUCTION==1): ?> checked <?php endif; ?> class="filter-none"  style="float:none;" ></td>
  <td style="text-align: center;"><input type="checkbox" name="JOB_WORKER_<?php echo e($key); ?>" id="JOB_WORKER_<?php echo e($key); ?>" value="1" <?php if($row->JOB_WORKER==1): ?> checked <?php endif; ?>   class="filter-none" style="float:none;" style="float:none;" ></td>
  <td style="text-align: center;"><input type="checkbox" name="FG_STAGE_<?php echo e($key); ?>" id="FG_STAGE_<?php echo e($key); ?>"   value="1" <?php if($row->FG_STAGE==1): ?> checked <?php endif; ?>   class="filter-none"  style="float:none;"  ></td>  
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("master",[271,"add"])); ?>';
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[271,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[271,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\RoutingMaster\mstfrm271edit.blade.php ENDPATH**/ ?>