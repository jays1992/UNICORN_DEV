...
<?php $helper = app('App\Helpers\Helper'); ?>  
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="AP_DOC_DT" id="AP_DOC_DT"  value="<?php echo e(isset($objAPDRCR->AP_DOC_DT)?$objAPDRCR->AP_DOC_DT:''); ?>" onchange="checkPeriodClosing(235,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Source</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="SOURCE_TYPE" id="SOURCE_TYPE"  onchange='sourceType(this.value)' class="form-control mandatory">
          <option <?php echo e(isset($objAPDRCR->SOURCE_TYPE) && $objAPDRCR->SOURCE_TYPE =='Vendor'?'selected="selected"':''); ?> value="Vendor">Vendor</option>
          <option <?php echo e(isset($objAPDRCR->SOURCE_TYPE) && $objAPDRCR->SOURCE_TYPE =='Employee'?'selected="selected"':''); ?> value="Employee">Employee</option>
          </select>
        </div>        
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input type="checkbox" <?php echo e($ActionStatus); ?> name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objAPDRCR->FC) && $objAPDRCR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      ...
      <div class="col-lg-2 pl" id="divcurrency" >
          ...
          <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="<?php echo e(isset($objAPDRCR->CRDESCRIPTION) && $objAPDRCR->CRDESCRIPTION !=''? $objAPDRCR->CRCODE.'-'.$objAPDRCR->CRDESCRIPTION:''); ?>"/>
      
          <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objAPDRCR->CRID_REF)?$objAPDRCR->CRID_REF:''); ?>" />
    ...
    <div class="row">	
      ...
      <div class="col-lg-2 pl">
          <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('tot_amt')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objAPDRCR->CONVFACT)?$objAPDRCR->CONVFACT:''); ?>"  />
      </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <?php if(!empty($objAPDRCRACC)): ?>
                      ...
                      ?>
                                  ...
                                  <td align="center" ><button class="btn"  name=<?php echo e("ADJ_".$key); ?> id=<?php echo e("ADJ_".$key); ?>  onclick="GetAdjustment(this.id);" type="button"><i class="fa fa-clone"></i></button></td>
                                  <td hidden ><input type="hidden" name=<?php echo e("PAYMENTID_REF_".$key); ?> id=<?php echo e("PAYMENTID_REF_".$key); ?>  class="form-control" autocomplete="off"  value="<?php echo e($row->PAYMENTID_REF); ?>" /></td>
                                  <td hidden ><input type="hidden" name=<?php echo e("ADJUSTMENT_AMOUNT_".$key); ?> id=<?php echo e("ADJUSTMENT_AMOUNT_".$key); ?>  class="form-control" autocomplete="off" value="<?php echo e($row->ADJUSTMENT_AMOUNT); ?>" /></td>

                                <td>                                 
                                <select name=<?php echo e("TYPE_".$key); ?> id=<?php echo e("TYPE_".$key); ?> <?php echo e($ActionStatus); ?>   class="form-control" style="width: 85px;">
                                <option value="Advance" <?php echo e(isset($row->TYPE) && $row->TYPE =='Advance'?'selected="selected"':''); ?> >Advance</option>
                                <option value="Loan" <?php echo e(isset($row->TYPE) && $row->TYPE =='Loan'?'selected="selected"':''); ?>>Loan</option>                            
                                <option value="Medical" <?php echo e(isset($row->TYPE) && $row->TYPE =='Medical'?'selected="selected"':''); ?>>Medical</option>
                                <option value="Conveyance" <?php echo e(isset($row->TYPE) && $row->TYPE =='Conveyance'?'selected="selected"':''); ?>>Conveyance</option>
                                <option value="Others" <?php echo e(isset($row->TYPE) && $row->TYPE =='Others'?'selected="selected"':''); ?>>Others</option>
                                </select></td>
...
let strtid = "#adjustmentTable";
  ...
  var APDRCRID 			  =   $.trim($("#APDRCRID").val());
  ...
  $("#NoBtn").hide();
  $("#OkBtn1").show();
  $("#AlertMessage").text('Please enter value in material tab.');
  $("#alert").modal('show');
  $("#OkBtn1").focus();
  return false;
}
  ...
  $.ajaxSetup({
   ...
   $.ajax({
                ...
                type:'POST',
                data:{EMPID_REF:EMPID_REF,PAYMENTID_REF:PAYMENTID_REF,ADJUSTMENT_AMOUNT:ADJUSTMENT_AMOUNT,ACTION_TYPE:'VIEW',RawID:RawID,APDRCRID:APDRCRID},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\APDebitNote\trnfrm235view.blade.php ENDPATH**/ ?>