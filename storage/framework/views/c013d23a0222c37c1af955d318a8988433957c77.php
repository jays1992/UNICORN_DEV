...
<!-- <form id="frm_rpt_pbsvw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[280,'index'])); ?>" class="btn singlebt">Purchase Bill Summary Vendor Wise</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_pbsvw"  method="POST">   
            <?php echo csrf_field(); ?>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl">
                                <select name="VENDORGRP[]" id="VENDORGRP" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <?php $__currentLoopData = $objVendorGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->VGID); ?>" selected><?php echo e($Row->VGCODE); ?>-<?php echo e($Row->DESCRIPTIONS); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <select name="VENDOR[]" id="VENDOR" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <?php $__currentLoopData = $objVendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iindex=>$iRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($iRow->VID); ?>" selected><?php echo e($iRow->VCODE); ?>-<?php echo e($iRow->NAME); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
//                 });
//                 $.ajax({
//                     url:'<?php echo e(route("report",[280,"GetPurchaseOrder"])); ?>',
//                     type:'POST',
...
$('#btnView').on('click', function() {
    var From_Date       = $('#From_Date').val();
        ...
        var VENDORGRP  = [];
        $("select[name='VENDORGRP[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                VENDORGRP.push(value4);
            }
        });
        ...
        else if(VENDOR  == '')
        {
            ...
            var trnsoForm = $("#frm_rpt_pbsvw");
            var formData = trnsoForm.serialize();
            var consultURL = '<?php echo e(route("report",[280,"ViewReport",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\PBVendorwise\rptfrm280.blade.php ENDPATH**/ ?>