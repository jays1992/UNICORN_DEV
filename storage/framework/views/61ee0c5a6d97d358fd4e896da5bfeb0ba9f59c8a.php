         ...
         <form id="frm_mst_add" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          ...
          <div class="inner-form">              
                <div class="row">
                  ...
                  <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROVISION_DT" id="PROVISION_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("PROVISION_DOC_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control"  maxlength="100" > 
                    </div>

                    <div class="col-lg-2 pl"><p>Bonus </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="BONUS" id="BNSGRTYLE" value="<?php echo e($objBonus->BONUSID); ?>" onchange="getBonusName(this.value)"> 
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-2 pl"><p>Gratuity </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="GRTUITY" id="BNSGRTYLE" value="<?php echo e($objGraty->GRATUITYID); ?>" onchange="getGratuityName(this.value)"> 
                    </div>

                    <div class="col-lg-2 pl"><p>Leave Encashment </p></div>
                      <div class="col-lg-2 pl">
                      <input type="checkbox" name="LEAVE_ENCASH" id="BNSGRTYLE" value="<?php echo e($objLeaveEnt->LEPID); ?>" onchange="getLeaveEntName(this.value)"> 
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\ProvisionOfBonusGratuityLeaveEncashment\trnfrm416add.blade.php ENDPATH**/ ?>