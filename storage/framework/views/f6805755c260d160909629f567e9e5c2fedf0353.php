...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Stock Adjustment</a></div>
...
<form id="frm_trn_edit"  method="POST">   
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="<?php echo e(isset($objResponse->ST_ADJUST_DOCNO) && $objResponse->ST_ADJUST_DOCNO !=''?$objResponse->ST_ADJUST_DOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
			
			  <div class="col-lg-2 pl"><p>Date</p></div>
			  <div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="ST_ADJUST_DOCDT" id="ST_ADJUST_DOCDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->ST_ADJUST_DOCDT) && $objResponse->ST_ADJUST_DOCDT !=''?$objResponse->ST_ADJUST_DOCDT:''); ?>" class="form-control mandatory" >
        </div>

        <div class="col-lg-2 pl"><p>Adjustment Type</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="ST_ADJUST_TYPE" id="ST_ADJUST_TYPE" class="form-control" >
            <option value="">Select</option>
            <option <?php echo e(isset($objResponse) && $objResponse->ST_ADJUST_TYPE=='IN'?'selected="selected"':''); ?> value="IN">IN</option>
            <option <?php echo e(isset($objResponse) && $objResponse->ST_ADJUST_TYPE=='OUT'?'selected="selected"':''); ?> value="OUT">OUT</option>
          </select>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text" style="width:100px;" type="text" name="RATE_<?php echo e($key); ?>" id="RATE_<?php echo e($key); ?>" value="<?php echo e($row->RATE); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" <?php echo e(isset($objResponse) && $objResponse->ST_ADJUST_TYPE=='IN'?'readonly':''); ?> /></td>
...
function validateForm(actionType,actionMsg){
  ...
  if(ST_ADJUST_DOCNO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#ST_ADJUST_DOCDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockAdjustment\trnfrm234edit.blade.php ENDPATH**/ ?>