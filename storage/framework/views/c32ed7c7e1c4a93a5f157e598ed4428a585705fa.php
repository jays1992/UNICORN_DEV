  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="PRO_NO" id="PRO_NO" value="<?php echo e($objDataNo); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
          <?php endif; ?>

          <?php if(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
          <input type="text" name="PRO_NO" id="PRO_NO" value="<?php echo e(old('PRO_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
          <?php endif; ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PRO_DT" id="PRO_DT" value="<?php echo e(old('PRO_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
          ...
          <div id="udf" class="tab-pane fade">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFJWOID); ?>" autocomplete="off"   /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkOrder\trnfrm354add_bkp.blade.php ENDPATH**/ ?>