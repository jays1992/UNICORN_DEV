...
<?php $helper = app('App\Helpers\Helper'); ?> 
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="PAYMENT_NO" id="PAYMENT_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
      </div>
        <div class="col-lg-1 pl"><p>Payment Date*</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PAYMENT_DT" id="PAYMENT_DT" value="<?php echo e(old('PAYMENT_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
       ...
       <table id="Bank2CodeTable2" class="display nowrap table  table-striped table-bordered" style="width:100%;" >
         ...
         <?php $__currentLoopData = $objBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bkRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          if(isset($bkRow) && !empty($bkRow)){ if($bkRow->SYSTEM_GRSR == "1"){if($bkRow->PREFIX_RQ == "1"){$objSONO = $bkRow->PREFIX;}        
              ...
              $objSONO = $objSONO.'-'; } } if($bkRow->SUFFIX_RQ == "1") { $objSONO = $objSONO.$bkRow->SUFFIX; } } } ?>
           <tr >
               <td style="width:10%; text-align: center;"><input type="checkbox"  id="bkidcode2_<?php echo e($index); ?>" class="clsbk2id" value="<?php echo e($bkRow->BID); ?>" name="cashbank2[]" ></td>
...
var BalId2=$.trim($("#BALANCE_ACCOUNT").text());
 ...
 else if($('#chk_Account').is(':checked') == true && BANK_CASH_ID !="" && parseFloat(TotalAmount_account) > parseFloat(BALANCE_ACCOUNT) )
 {
    ...
    var allblank12 = [];
        ...
        else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#PAYMENT_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/PaymentEntry/trnfrm301add.blade.php ENDPATH**/ ?>