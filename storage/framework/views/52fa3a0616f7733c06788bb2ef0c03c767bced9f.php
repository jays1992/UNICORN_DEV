       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="<?php echo e($objEmpName->FNAME); ?>" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
                      ...
                      <?php $__currentLoopData = $objDataResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr  class="participantRow">
                         <td hidden><input type="hidden" name="ASSIGN_LDID" id="ASSIGN_LDID" value="<?php echo e($row->ASSIGN_LDID); ?>" /></td>
                           <td><input  class="form-control" type="date" name=<?php echo e("ASSIGN_DT_".$key); ?>   id =<?php echo e("ASSIGN_DT_".$key); ?>  value="<?php echo e($row->ASSIGN_DT); ?>" autocomplete="off" style="width: 99%"></td>
                           <td><select name=<?php echo e("ASSIGN_AS_".$key); ?>   id =<?php echo e("ASSIGN_AS_".$key); ?> class="form-control mandatory" tabindex="4">
                              <option value="" selected="">Select</option>
                           ...
                           <td><select name=<?php echo e("LTID_REF_".$key); ?>   id =<?php echo e("LTID_REF_".$key); ?> onchange="getLeaveTyName(this.id,this.value)" class="form-control mandatory" tabindex="4">
                             <option value="" selected="">Select</option>
                           ...
                           <td><input type="text" id =<?php echo e("LEAVETYPE_DESC_".$key); ?> value="<?php echo e($row->LEAVETYPE_DESC); ?>" class="form-control" readonly  maxlength="100" > </td>
                           <td><input  class="form-control" type="text" name=<?php echo e("REASON_LEAVE_".$key); ?>   id =<?php echo e("REASON_LEAVE_".$key); ?>  value="<?php echo e($row->REASON_LEAVE); ?>" autocomplete="off" style="width: 99%"></td>
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[399,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AssignLeave\trnfrm399edit.blade.php ENDPATH**/ ?>