...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->BANK_RECONCILEID); ?>" value="<?php echo e($val->BANK_RECONCILEID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->BANK_RECONCILE_CODE) && $val->BANK_RECONCILE_CODE !=''?$val->BANK_RECONCILE_CODE:''); ?></td>
                <td><?php echo e(isset($val->BANK_RECONCILE_DATE) && $val->BANK_RECONCILE_DATE !='' && $val->BANK_RECONCILE_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BANK_RECONCILE_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/BankReconcilation/trnfrm394.blade.php ENDPATH**/ ?>