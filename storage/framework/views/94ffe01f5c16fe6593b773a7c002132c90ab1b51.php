...
<div class="container-fluid purchase-order-view filter">     
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
      ...
      <input type="text" name="COMPANY_HOLIDAY_CODE" id="COMPANY_HOLIDAY_CODE" value="<?php echo e($objCondition->COMPANY_HOLIDAY_CODE); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" disabled >
    <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
      <input type="text" name="COMPANY_HOLIDAY_CODE" id="COMPANY_HOLIDAY_CODE" value="<?php echo e(old('COMPANY_HOLIDAY_CODE')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase" disabled >
    <?php else: ?>
      <input type="text" name="COMPANY_HOLIDAY_CODE" id="COMPANY_HOLIDAY_CODE" value="<?php echo e($objCondition->COMPANY_HOLIDAY_CODE); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  disabled>
      <?php endif; ?>
    </div>
    <div class="col-lg-2 pl"><p>Company Holiday Date*</p></div>
      <div class="col-lg-2 pl">
      <input type="date" name="COMPANY_HOLIDAY_DATE" id="COMPANY_HOLIDAY_DATE" value="<?php echo e($objCondition->COMPANY_HOLIDAY_DATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" disabled>
      </div> 
      
      <div class="col-lg-2 pl"><p>Financial Year*</p></div>
      <div class="col-lg-2 pl">
        <select name="FYID_REF" id="FYID_REF" class="form-control" disabled>
    ...
    <table id="example2" class="display nowrap table table-striped table-bordered itemlist itemlistscroll w-150" style="height:auto !important;">
      <thead id="thead1" style="position: sticky;top: 0; white-space:none;">
        ...
        <tbody>
          ...
          <td style="width:27%;"><input disabled class="form-control w-100" type="date" name="HOLIDAY_DATE_<?php echo e($key); ?>" id="HOLIDAY_DATE_<?php echo e($key); ?>" value="<?php echo e($row->HOLIDAY_DATE); ?>" maxlength="200" autocomplete="off" style="text-transform:uppercase"></td>             
                      <td style="width:51%;"><input disabled class="form-control selvt" rows="1" name="HOLIDAY_EVENT_<?php echo e($key); ?>" id="drpvalue_<?php echo e($key); ?>" value="<?php echo e($row->HOLIDAY_EVENT); ?>" maxlength="150" autocomplete="off" ></td> 
                      <td style="width:16%;">
                      <select class="form-control" name="HOLIDAYTYPEID_REF_<?php echo e($key); ?>" id="txtdesc_<?php echo e($key); ?>" disabled>
                      <option value="" selected >Select</option>
          ...
          <td style="width:10%;"><button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
          </tr>
          <tr></tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\CompanyHoliday\mstfrm268view.blade.php ENDPATH**/ ?>