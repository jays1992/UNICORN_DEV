    ...
    <?php echo e(isset($objMstResponse->HSNID) ? method_field('PUT') : ''); ?>
		...
		<div class="inner-form">
          ...
          <label><?php echo e($objMstResponse->HSNCODE); ?></label>
					<input type="hidden" name="HSNCODE" id="HSNCODE" class="form-control mandatory" value="<?php echo e($objMstResponse->HSNCODE); ?>"  maxlength="20" required tabindex="1" autocomplete="off" >
			...
			<div class="row">
				...
				<div class="col-lg-4 pl">
					<input type="text" name="HSNDESCRIPTION" id="HSNDESCRIPTION" value="<?php echo e($objMstResponse->HSNDESCRIPTION); ?>"  class="form-control mandatory"  maxlength="200" required tabindex="2" autocomplete="off">
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[144,"update"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\HSN\mstfrm144edit.blade.php ENDPATH**/ ?>