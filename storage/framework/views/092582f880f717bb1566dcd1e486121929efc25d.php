  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <?php if(!empty($objDataList)): ?>           
            ...
            ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->EMC_ID); ?>" value="<?php echo e($val->EMC_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->EMC_DATE) && $val->EMC_DATE !='' && $val->EMC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->EMC_DATE)):''); ?>" ></td>
          <td><?php echo e(isset($val->EMC_NO) && $val->EMC_NO !=''?$val->EMC_NO:''); ?></td>
          <td><?php echo e(isset($val->EMC_DATE) && $val->EMC_DATE !='' && $val->EMC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->EMC_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\EnergyMeterConsumption\trnfrm368.blade.php ENDPATH**/ ?>