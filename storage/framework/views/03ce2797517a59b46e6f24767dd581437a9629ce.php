      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="PRR_NO" id="PRR_NO" value="<?php echo e(isset($objSO->PRR_NO)?$objSO->PRR_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
          </div>
            
            <div class="col-lg-2 pl"><p>PRR Date</p></div>
            <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="date" name="PRR_DT" id="PRR_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objSO->PRR_DT)?$objSO->PRR_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            
            <div hidden class="col-lg-2 pl"><p>GL</p></div>
            <div hidden class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="GLID_popup" id="txtgl_popup"  class="form-control mandatory"  autocomplete="off" readonly/>
            ...
            <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup"  value="<?php echo e(isset($objsubglcode->VCODE)?$objsubglcode->VCODE:''); ?>  <?php echo e(isset($objsubglcode->NAME)?$objsubglcode->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e(isset($objSO->VID_REF)?$objSO->VID_REF:''); ?>" class="form-control" autocomplete="off" />
                <input type="hidden" name="hdnmaterial" id="hdnmaterial" class="form-control" autocomplete="off" />                                                                
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input <?php echo e($ActionStatus); ?> type="text" name="VCL_NO" id="VCL_NO" value="<?php echo e(isset($objSO->VCL_NO)?$objSO->VCL_NO:''); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="<?php echo e(isset($objSO->TRANSPORTER_CODE)?$objSO->TRANSPORTER_CODE:''); ?>   <?php echo e(isset($objSO->TRANSPORTER_NAME)?'-'.$objSO->TRANSPORTER_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                                <input type="hidden" name="TRASPORTER_NAME" id="TRASPORTER_NAME" value="<?php echo e(isset($objSO->TRASPORTER_NAME)?$objSO->TRASPORTER_NAME:''); ?>" class="form-control" autocomplete="off" />                                                              
                            </div>

                            <div class="col-lg-2 pl"><p>Driver Name</p></div>
                            <div class="col-lg-2 pl">
                              <input <?php echo e($ActionStatus); ?> type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="<?php echo e(isset($objSO->DRIVER_NAME)?$objSO->DRIVER_NAME:''); ?>" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="txtSQ_popup_<?php echo e($key); ?>" id="txtSQ_popup_<?php echo e($key); ?>" value="<?php echo e($row->PB_DOCNO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="SQAUOM_<?php echo e($key); ?>" id="SQAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="SQAUOMQTY_<?php echo e($key); ?>" id="SQAUOMQTY_<?php echo e($key); ?>" value="<?php echo (($row->RETURN_QTY_MU*$row->TO_QTY)/$row->FROM_QTY); ?>" class="form-control" autocomplete="off"  readonly/></td>


<td><input <?php echo e($ActionStatus); ?> type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_MU); ?>" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off"  style="width:75px;" /></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY_AU); ?>"  class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>
...
<td><input <?php echo e($ActionStatus); ?> type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATEPUOM_MU); ?>" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input <?php echo e($ActionStatus); ?> type="checkbox" value="<?php echo e($row->TAX_IMPACT); ?>" name='flagtype_<?php echo e($key); ?>' id="flagtype_<?php echo e($key); ?>" <?php echo e($GST_FLAGE_CHECKED); ?> ></td>


<td><input <?php echo e($ActionStatus); ?> type="text" name="IGST_<?php echo e($key); ?>" id="IGST_<?php echo e($key); ?>" value="<?php echo e($row->IGST_RATE); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="IGSTAMT_<?php echo e($key); ?>" id="IGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="CGST_<?php echo e($key); ?>" id="CGST_<?php echo e($key); ?>" value="<?php echo e($row->CGST_RATE); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="CGSTAMT_<?php echo e($key); ?>" id="CGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="SGST_<?php echo e($key); ?>" id="SGST_<?php echo e($key); ?>" value="<?php echo e($row->SGST_RATE); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="SGSTAMT_<?php echo e($key); ?>" id="SGSTAMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="TGST_AMT_<?php echo e($key); ?>" id="TGST_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input <?php echo e($ActionStatus); ?> type="text" name="TOT_AMT_<?php echo e($key); ?>" id="TOT_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                            ...
                                            <?php if(!empty($objSOCAL)): ?>
                                                <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td style="text-align:center;"><input <?php echo e($ActionStatus); ?> type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?>  ></td>
                                                        <td align="center" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseReturn\trnfrm310edit.blade.php ENDPATH**/ ?>