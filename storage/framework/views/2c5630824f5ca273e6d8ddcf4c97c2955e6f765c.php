    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive">
           ...
           if(!Empty($val->STATUS) && $val->STATUS=="A"){ 
            ...
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->FYID_REF); ?>" value="<?php echo e($val->FYID_REF); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->PAY_PERIOD_CODE) && $val->PAY_PERIOD_CODE !=''?$val->PAY_PERIOD_CODE:''); ?></td>
                <td><?php echo e(isset($val->PAY_PERIOD_DESC) && $val->PAY_PERIOD_DESC !='' && $val->PAY_PERIOD_DESC !='1900-01-01' ? date('d-m-Y',strtotime($val->PAY_PERIOD_DESC)):''); ?></td>
                <td><?php echo e(isset($val->INDATE) && $val->INDATE !='' && $val->INDATE !='1900-01-01' ? date('d-m-Y',strtotime($val->INDATE)):''); ?></td>
                <td><?php echo e($STATUS_DESC); ?></td>
            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveRules\mstfrm377.blade.php ENDPATH**/ ?>