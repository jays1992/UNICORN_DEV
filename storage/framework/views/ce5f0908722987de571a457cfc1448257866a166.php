...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[169,'index'])); ?>" class="btn singlebt">Journal Voucher(JV)</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid filter">
      ...
      <?php echo csrf_field(); ?>
      <?php echo e(isset($objJV->JVID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="hidden" name="JVID" id="JVID" value="<?php echo e(isset($objJV->JVID)?$objJV->JVID:''); ?>" />
              <input <?php echo e($ActionStatus); ?> type="text" name="JV_NO" id="JV_NO" value="<?php echo e(isset($objJV->JV_NO)?$objJV->JV_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         </div>
        <div class="col-lg-1 pl"><p>JV Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="JV_DT" id="JV_DT" value="<?php echo e(isset($objJV->JV_DT)?$objJV->JV_DT:''); ?>" onchange="checkPeriodClosing(169,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
  ...
  $('#Accounting').on('click','[id*="txtGLID"]',function(event){
    ...
    var fieldid = $(this).parent().parent().find('[id*="GLID_REF"]').attr('id');
      ...
      $("#tbody_glsl").html('');
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[169,"getglsl"])); ?>',
            type:'POST',
...
let cid = "#ppcostcenter2";
  ...
  $('#costpopup').on('click','[id*="CostCenter"]',function(event){
    ...
    $("#tbody_ppcost").html('');
      ...
      $.ajax({
          url:'<?php echo e(route("transaction",[169,"getCostCenter"])); ?>',
          type:'POST',
...
var lastdt = <?php echo json_encode($objlastJVDT[0]->JV_DT); ?>;
  var jv = <?php echo json_encode($objJV); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < jv.JV_DT)
  {
	$('#JV_DT').attr('min',lastdt);
  }
  else
  {
	  $('#JV_DT').attr('min',jv.JV_DT);
  }
  $('#JV_DT').attr('max',sodate);
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("transaction",[169,"add"])); ?>';
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[169,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[169,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transaction",[169,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[169,"index"])); ?>';
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\JournalVoucher\trnfrm169edit.blade.php ENDPATH**/ ?>