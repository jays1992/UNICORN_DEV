<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->ATTTNDID); ?>" value="<?php echo e($val->ATTTNDID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->DOCNO) && $val->DOCNO !=''?$val->DOCNO:''); ?></td>
              <td><?php echo e(isset($val->DOCDATE) && $val->DOCDATE !='' && $val->DOCDATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DOCDATE)):''); ?></td>
              
              <td><?php echo e(isset($val->START_TIME) && $val->START_TIME !=''? $val->START_TIME:''); ?> - <?php echo e(isset($val->END_TIME) && $val->END_TIME !=''? $val->END_TIME:''); ?></td>
...
$('#btnImport').on('click', function(){
  window.location.href='<?php echo e(route("transaction",[$FormId,"importdata"])); ?>';
});
</script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AttendanceTimeWiseDateWise\AttendanceTimeWiseDateWise\trnfrm425.blade.php ENDPATH**/ ?>