    ...
    <div class="container-fluid filter">
      ...
      <div class="inner-form">
        ...
        <div class="row">
            ...
            <input type="text" name="BDSL_NO" id="BDSL_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="BDSL_DATE" id="BDSL_DATE" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("BDSL_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('BDSL_DATE')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\Break_down_Solution\trnfrm365add.blade.php ENDPATH**/ ?>