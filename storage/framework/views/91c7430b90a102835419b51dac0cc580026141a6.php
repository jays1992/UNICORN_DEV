...
if(itemid !='' && id === "Main_RECEIVED_QTY_"+index){          
  ...
  $.ajax({
    ...
    type:'POST',
    data:{'itemid':itemid, 'doctype':doctype,'docid':docid,'action':'edit'},
      success:function(data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\Barcode\trnfrm418edit.blade.php ENDPATH**/ ?>