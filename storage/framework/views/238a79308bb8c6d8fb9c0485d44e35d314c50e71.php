...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objSO->SRID[0]) ? method_field('PUT') : ''); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="SONO" id="SONO" value="<?php echo e(isset($objSO->SRNO)?$objSO->SRNO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(45,this.value,1)" value="<?php echo e(isset($objSO->SRDT)?$objSO->SRDT :''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input <?php echo e($InputStatus); ?>  type="text" name="REASONOFSR" id="REASONOFSR" value="<?php echo e(isset($objSO->REASONOFSR)?$objSO->REASONOFSR:''); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($InputStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('TotalValue')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSO->CONVFACT)?$objSO->CONVFACT:''); ?>"  />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input  <?php echo e($InputStatus); ?> type="text" name="COMMONNRT" id="COMMONNRT" value="<?php echo e(isset($objSO->COMMONNRT)?$objSO->COMMONNRT:''); ?>" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>

                           
                             <div class="col-lg-2 pl"><p>Purchase</p></div>        
                            <div class="col-lg-2 pl">
                                <input type="checkbox" <?php echo e($InputStatus); ?> name="chk_Purchase" id="chk_Purchase" <?php echo e(isset($objSO->chk_Purchase) && $objSO->chk_Purchase == 1 ? 'checked' : ''); ?> />
                            </div>
                        ...
                        <div class="col-lg-2 pl"><p>Total Value</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="TotalValue" id="TotalValue" class="form-control"  autocomplete="off" readonly  />
                            </div>
                        ...
                        <div class="row" id="purchase_section" style="display:none">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="text" <?php echo e($InputStatus); ?> name="BILL_NO" id="BILL_NO" autocomplete="off" class="form-control" maxlength="200" value="<?php echo e(isset($objSO->BILL_NO)?$objSO->BILL_NO:''); ?>"  >
                          </div>

                          <div class="col-lg-2 pl"><p>Bill Date</p></div>
                          <div class="col-lg-2 pl">
                              <input type="date" <?php echo e($InputStatus); ?> name="BILL_DT" id="BILL_DT" class="form-control"  autocomplete="off"  value="<?php echo e(isset($objSO->BILL_DT)?$objSO->BILL_DT:''); ?>" />
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                    ...
                                    <tr  class="participantRow">
                                      ...
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("txtSQ_popup_".$key); ?> id=<?php echo e("txtSQ_popup_".$key); ?> class="form-control" value="<?php echo e($row->SINO); ?>" autocomplete="off"   readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name=<?php echo e("SQA_".$key); ?> id=<?php echo e("SQA_".$key); ?> class="form-control" value="<?php echo e($row->SIID_REF); ?>" autocomplete="off" /></td>
                                      <td hidden><input type="hidden" name=<?php echo e("SEQID_REF_".$key); ?> id=<?php echo e("SEQID_REF_".$key); ?> class="form-control" value="<?php echo e($row->SIID_REF); ?>" autocomplete="off" /></td>
                                      
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      ...
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->NAME); ?>"  autocomplete="off"  readonly style="width:200px;" /></td>
                                      
                                      <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($InputStatus); ?> type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->ALPS_PART_NO)?$row->ALPS_PART_NO:''); ?>" readonly/></td>
                                      ...
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" value="<?php echo e($row->SIMAIN_QTY); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="SQAUOM_<?php echo e($key); ?>" id="SQAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="SQAUOMQTY_<?php echo e($key); ?>" id="SQAUOMQTY_<?php echo e($key); ?>" class="form-control" autocomplete="off"  readonly/></td>

                                      <td><input  <?php echo e($InputStatus); ?> type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name="MAIN_UOMID_REF_<?php echo e($key); ?>" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_SRUOMID_REF); ?>" class="form-control"  autocomplete="off" style="width:75px;" /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->SRQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly  style="width:75px;" <?php echo e(isset($objSO->chk_Purchase) && $objSO->chk_Purchase == 1 ? '' : 'readonly'); ?> /></td>
                                      <td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" value="<?php echo e($row->SRQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                                      <td hidden><input type="hidden" name="ALT_UOMID_REF_<?php echo e($key); ?>" id="ALT_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ALT_SRUOMID_REF); ?>" class="form-control"  autocomplete="off"  readonly  style="width:75px;"  /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>" class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>
                                      

                                      <td style="text-align:center;" ><a <?php echo e($InputStatus); ?> class="btn checkstore" id="store_<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
                                      <td  hidden><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->SRQTY); ?>" ></td>
                                      <td  hidden><input type="hidden" name="HiddenRowId_<?php echo e($key); ?>" id="HiddenRowId_<?php echo e($key); ?>" value="<?php echo e(isset($row->STORE_MATID_REF) && $row->STORE_MATID_REF !=''?$row->STORE_MATID_REF:''); ?> <?php echo e(isset($row->RETURN_QTYM) && $row->RETURN_QTYM !=''?'-'.$row->RETURN_QTYM:''); ?>" ></td>
                                                              
                                      <td hidden><input type="hidden" name="DISCPER_<?php echo e($key); ?>" id="DISCPER_<?php echo e($key); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;"   style="width:75px;" /></td>
                                      <td hidden><input type="hidden" name="DISCOUNT_AMT_<?php echo e($key); ?>" id="DISCOUNT_AMT_<?php echo e($key); ?>" class="form-control two-digits" maxlength="15"  autocomplete="off"   style="width:75px;" /></td>
                                              
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->SRRATE); ?>"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off" readonly  style="width:75px;" /></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>" value="<?php echo e($row->SRAMT); ?>"  class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                              
                                      <td style="text-align:center;" ><input <?php echo e($InputStatus); ?> type="checkbox" value="<?php echo e($row->GST); ?>" name='flagtype_0' id="flagtype_0" <?php echo e($GST_FLAGE_CHECKED); ?>  value="1" ></td>

                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                      <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$Ukey); ?>  id=<?php echo e("UDFSOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDF_SRID_REF); ?>" autocomplete="off" /></td>
    ...
    <input type="text" id="UDFSOIDnamesearch" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_<?php echo e($udfindex); ?>" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->UDF_SRID); ?>"/>
          </td>
      ...
      $(".clstncid").dblclick(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[45,"gettncdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[45,"gettncdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[45,"gettncdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
function ItemOEMPNFunction() {
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        //           });
        //           $.ajax({
        //               url:'<?php echo e(route("transaction",[45,"getItemDetailswithoutQuotation"])); ?>',
        //               type:'POST',
...
function validateForm(saveAction){
  ...
  var attachcount    =   "<?php echo e($objCountAttachment); ?>";
...
$.ajax({
    ...
    type:'POST',
    data:{ITEMID_REF:ITEMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'VIEW',SIID_REF:SIID_REF,WhereId:WhereId},
    success:function(data) {
...
function getSL(){
  ...
  $.ajax({
      url:'<?php echo e(route("transaction",[45,"getsubledger"])); ?>',
      type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesReturn\SalesReturn\trnfrm45view.blade.php ENDPATH**/ ?>