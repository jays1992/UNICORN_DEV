...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[290,'index'])); ?>" class="btn singlebt">Batch Wise Stock Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_bwsr"  method="POST">   
            <?php echo csrf_field(); ?>
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                <?php $__currentLoopData = $ObjItemGrp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->ITEMGID); ?>" selected><?php echo e($GRow->GROUPCODE); ?>-<?php echo e($GRow->GROUPNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" id="div_item">
                                <select name="ITEM[]" data-hide-disabled="hide" multiple data-actions-box="true" id="ITEM" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[290,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMGID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[290,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/inventory/BatchWiseStockReport/rptfrm290.blade.php ENDPATH**/ ?>