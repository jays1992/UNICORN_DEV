...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[444,'index'])); ?>" class="btn singlebt">Salary Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="PAYPERIODID" data-hide-disabled="hide"  data-actions-box="true" id="PAYPERIODID"  class="form-control selectpicker"  data-live-search="true"  >
                                    <?php $__currentLoopData = $ObjPayPeriod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ppindex=>$ppRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ppRow->PAYPERIODID); ?>" selected><?php echo e($ppRow->PAY_PERIOD_DESC); ?></option>
                        ...
                        <div class="row">              
							...
							<div class="col-lg-3 pl"><p>Designation</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="DESGID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="DESGID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjDesignation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->DESGID); ?>" selected><?php echo e($Row->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[444,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
		...
		var DESGID = [];
        $("select[name='DESGID[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                DESGID.push(value3);
            }
		...
		else if(DESGID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Designation.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }   
        else if(EMPID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[444,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Payroll\SalaryRegister\rptfrm444.blade.php ENDPATH**/ ?>