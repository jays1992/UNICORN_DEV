<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->EARNING_TYPEID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->EARNING_TYPECODE); ?> </label>
                    <input type="hidden" name="EARNING_TYPEID" id="EARNING_TYPEID" value="<?php echo e($objResponse->EARNING_TYPEID); ?>" />
                    <input type="hidden" name="EARNING_TYPECODE" id="EARNING_TYPECODE" value="<?php echo e($objResponse->EARNING_TYPECODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="EARNING_TYPE_DESC" id="EARNING_TYPE_DESC" class="form-control mandatory" value="<?php echo e(old('EARNING_TYPE_DESC',$objResponse->EARNING_TYPE_DESC)); ?>" maxlength="200" tabindex="1"  />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[185,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[185,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EarningHeadType\mstfrm185edit.blade.php ENDPATH**/ ?>