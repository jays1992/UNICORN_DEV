        ...
        <div class="inner-form">
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>Employee Code*</p></div>
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" id="FNAME" value="<?php echo e($objLvDesList->FNAME); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>
                  <div class="col-lg-2 pl"><p>Leave Application No *</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="LEAVE_APPID_REF" id="txtitem_popup" value="<?php echo e($ObjItem->LEAVE_APP_NO); ?>"  class="form-control mandatory"  autocomplete="off" readonly/>
                    <input type="hidden" name="LEAVE_APPID" id="LEAVE_APPID" value="<?php echo e($ObjItem->LEAVE_APPID); ?>" class="form-control" autocomplete="off" />
                ...
                <div class="col-lg-2 pl"><p>Leave Application Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="LEAVE_APP_DT" id="LEAVE_APP_DT" value="<?php echo e($ObjItem->LEAVE_APP_DT); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Pay Period Code</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="PAY_PERIOD_CODE" id="PAY_PERIOD_CODE" value="<?php echo e($ObjItem->PAY_PERIOD_CODE); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Description</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="PAY_PERIOD_DESC" id="PAY_PERIOD_DESC" value="<?php echo e($ObjItem->PAY_PERIOD_DESC); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>                    
              </div>
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>Leave Applied from Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="LEAVE_APP_FRDT" id="LEAVE_APP_FRDT" value="<?php echo e($ObjItem->LEAVE_APP_FRDT); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Leave Applied To Date</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="LEAVE_APP_TODT" id="LEAVE_APP_TODT" value="<?php echo e($ObjItem->LEAVE_APP_TODT); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>Reason of Leave</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="REASON_LEAVE" id="REASON_LEAVE" value="<?php echo e($ObjItem->REASON_LEAVE); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Address During the leave </p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="ADDRESS_LEAVE" id="ADDRESS_LEAVE" value="<?php echo e($ObjItem->ADDRESS_LEAVE); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Contact no During the leave </p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="MONO_INLEAVE1" id="MONO_INLEAVE1" value="<?php echo e($ObjItem->MONO_INLEAVE1); ?>" class="form-control" readonly  maxlength="100" > 
                  </div>                    
              </div>
              <br>
              ...
              <div class="col-lg-2 pl"><p>Approved By </p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="APPROVAL1_BY" id="APPROVAL1_BY" value="<?php echo e($objResponse->APPROVAL1_BY); ?>"  class="form-control"  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Date of Approval </p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="APPROVAL1_DT" id="APPROVAL1_DT" value="<?php echo e($objResponse->APPROVAL1_DT); ?>" class="form-control"  maxlength="100" > 
                  </div>

                  <div class="col-lg-2 pl"><p>Approved</p></div>
                  <div class="col-lg-2 pl">
                    <input type="radio" name="APPROVAL1_ST" id="APPROVAL1_ST" value="<?php echo e($objResponse->APPROVAL1_ST); ?>" <?php echo e(isset($objResponse) && $objResponse->APPROVAL1_ST=='A'?'checked':''); ?> class="form-checkbox">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>Rejected</p></div>
                  <div class="col-lg-2 pl">
                  <input type="radio" name="APPROVAL1_ST" id="APPROVAL1_ST" value="<?php echo e($objResponse->APPROVAL1_ST); ?>" <?php echo e(isset($objResponse) && $objResponse->APPROVAL1_ST=='R'?'checked':''); ?> class="form-checkbox">
                </div>

                <div class="col-lg-2 pl"><p>Hold</p></div>
                  <div class="col-lg-2 pl">
                  <input type="radio" name="APPROVAL1_ST" id="APPROVAL1_ST" value="<?php echo e($objResponse->APPROVAL1_ST); ?>" <?php echo e(isset($objResponse) && $objResponse->APPROVAL1_ST=='H'?'checked':''); ?> class="form-checkbox">
                </div>

                <div class="col-lg-2 pl"><p>Partial Approved</p></div>
                  <div class="col-lg-2 pl">
                  <input type="radio" name="APPROVAL1_ST" id="APPROVAL1_ST" value="<?php echo e($objResponse->APPROVAL1_ST); ?>" <?php echo e(isset($objResponse) && $objResponse->APPROVAL1_ST=='P'?'checked':''); ?> class="form-checkbox">
                </div>
              </div>
              ...
              <div class="col-lg-2 pl"><p>Approved Days (Partial)</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="APPROVAL1_PARTIALDAYS" id="APPROVAL1_PARTIALDAYS" value="<?php echo e($objResponse->APPROVAL1_PARTIALDAYS); ?>" onkeypress="return onlyNumberKey(event)" class="form-control"  maxlength="100" > 
                </div>

                <div class="col-lg-2 pl"><p>Rejected / Partial Reason</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="APPROVAL1_REASON" id="APPROVAL1_REASON" value="<?php echo e($objResponse->APPROVAL1_REASON); ?>" class="form-control"  maxlength="100" style="width: 430px;"> 
                </div>
              </div>
                    ...
                    <div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
                      ...
                      <tbody>
                        ...
                        <tr  class="participantRow">
                            <td>
                              <select name=<?php echo e("LTID_REF_".$index); ?> id=<?php echo e("LTID_REF_".$index); ?> class="form-control mandatory" tabindex="4">
                                <option value="" selected="">Select</option>
                            ...
                            <td>                              
                              <input  class="form-control" type="date" name=<?php echo e("FROM_DT_".$index); ?> id=<?php echo e("FROM_DT_".$index); ?> value="<?php echo e($row->FROM_DT); ?>" onchange="leaveFromDate(this.id)" autocomplete="off" style="width: 99%"></td>
                            </td>
                            <td><input  class="form-control" type="date" name=<?php echo e("TO_DT_".$index); ?> id=<?php echo e("TO_DT_".$index); ?> value="<?php echo e($row->TO_DT); ?>" onchange="leaveFromDate(this.id)"  autocomplete="off" style="width: 99%"></td></td>
                            <td><input type="text" name=<?php echo e("totldays_".$index); ?> id=<?php echo e("totldays_".$index); ?> class="form-control" readonly  maxlength="100" > </td>
                            <td><input  class="form-control" type="text" name=<?php echo e("REMARKS_".$index); ?> id=<?php echo e("REMARKS_".$index); ?> value="<?php echo e($row->REMARKS); ?>" autocomplete="off" style="width: 99%"></td>
                            <td><input  class="form-control" type="text" name=<?php echo e("LEAVE_BLANCE_".$index); ?> id=<?php echo e("LEAVE_BLANCE_".$index); ?> value="<?php echo e($row->LEAVE_BLANCE); ?>" onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                      </tbody>
                    </table>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LeaveApproval\trnfrm404edit.blade.php ENDPATH**/ ?>