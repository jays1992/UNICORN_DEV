...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[382,'index'])); ?>" class="btn singlebt">Customer Ageing Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">                        
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_CDG">
                                ...
                                <?php $__currentLoopData = $ObjCustomerGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->CGID); ?>" selected><?php echo e($cRow->CGROUP); ?>-<?php echo e($cRow->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <input type="date" name="AsOnDate" id="AsOnDate" value="<?php echo e(old('AsOnDate')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
                            </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[382,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
		...
		else if(ReportBasis  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[382,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\CustomerAgeingReport\rptfrm382.blade.php ENDPATH**/ ?>