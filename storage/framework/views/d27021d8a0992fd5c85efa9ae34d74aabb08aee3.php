...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MISRID); ?>" value="<?php echo e($val->MISRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MISRDT) && $val->MISRDT !='' && $val->MISRDT !='1900-01-01' ? date('d-m-Y',strtotime($val->MISRDT)):''); ?>"></td>
                <td><?php echo e(isset($val->MISRNO) && $val->MISRNO !=''?$val->MISRNO:''); ?></td>
                <td><?php echo e(isset($val->MISRDT) && $val->MISRDT !='' && $val->MISRDT !='1900-01-01' ? date('d-m-Y',strtotime($val->MISRDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\MaterialIssueSlipRPR\trnfrm305.blade.php ENDPATH**/ ?>