  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <?php if(!empty($objDataList)): ?>           
            ...
            ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->DGUFF_ID); ?>" value="<?php echo e($val->DGUFF_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DGUFF_DATE) && $val->DGUFF_DATE !='' && $val->DGUFF_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DGUFF_DATE)):''); ?>" ></td>
          <td><?php echo e(isset($val->DGUFF_NO) && $val->DGUFF_NO !=''?$val->DGUFF_NO:''); ?></td>
          <td><?php echo e(isset($val->DGUFF_DATE) && $val->DGUFF_DATE !='' && $val->DGUFF_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DGUFF_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\DGUsageFuelFill\trnfrm369.blade.php ENDPATH**/ ?>