  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->QIJID); ?>" value="<?php echo e($val->QIJID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->QIJDT) && $val->QIJDT !='' && $val->QIJDT !='1900-01-01' ? date('d-m-Y',strtotime($val->QIJDT)):''); ?>" ></td>
          <td><?php echo e(isset($val->QIJNO) && $val->QIJNO !=''?$val->QIJNO:''); ?></td>
          <td><?php echo e(isset($val->QIJDT) && $val->QIJDT !='' && $val->QIJDT !='1900-01-01' ? date('d-m-Y',strtotime($val->QIJDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\QualityInspection\trnfrm358.blade.php ENDPATH**/ ?>