                  ...
                  <div class="col-lg-2 pl"><p>Asset Group Code*</p></div>
                    <div class="col-lg-2 pl">
                     <select name="ASGID_REF" id="ASGID_REF" class="form-control mandatory" tabindex="4">
                        ...
                        <option value="<?php echo e($val->ASGID); ?>"><?php echo e($val->ASGCODE); ?></option>
                    ...
                    <div class="col-lg-2 pl">
                      <select name="ASTID_REF" id="ASTID_REF" class="form-control mandatory" tabindex="4">
                        ...
                        <option value="<?php echo e($val->ASTID); ?>"><?php echo e($val->ASSETTYPE); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                </div>               
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetCategory\mstfrm407add.blade.php ENDPATH**/ ?>