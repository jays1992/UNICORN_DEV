...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2">
      <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">User-Branch Mapping</a>
      </div>
      ...
      <div class="col-lg-1 pl"><p>Branch</p></div>
        <div class="col-lg-2 pl">
          <select disabled name="MAPBRID_REF" id="MAPBRID_REF" class="form-control" required onchange="selectBranch(this.value)" >
              ...
              <?php if(isset($getBranch) && !empty($getBranch)): ?>
              <?php $__currentLoopData = $getBranch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option <?php echo e(isset($objResponse->MAPBRID_REF) && $objResponse->MAPBRID_REF ==$val->FID?'selected="selected"':''); ?> value="<?php echo e($val->FID); ?>"><?php echo e($val->BRCODE.'-'.$val->BRNAME); ?></option>
...
$(document).ready(function(){
  var MAPBRID_REF="<?php echo e(isset($objResponse) && $objResponse->MAPBRID_REF !=''?$objResponse->MAPBRID_REF:''); ?>";
  selectBranch(MAPBRID_REF);
});
</script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserBranchMapping\mstfrm204view.blade.php ENDPATH**/ ?>