...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SALINVALID); ?>" value="<?php echo e($val->SALINVALID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SALINVAL_DATE) && $val->SALINVAL_DATE !=''?$val->SALINVAL_DATE:''); ?>" ></td>
                <td><?php echo e(isset($val->SALINVAL_NO) && $val->SALINVAL_NO !=''?$val->SALINVAL_NO:''); ?></td>
                <td><?php echo e(isset($val->SALINVAL_DATE) && $val->SALINVAL_DATE !=''?$val->SALINVAL_DATE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/SalesInvoiceAllocation/trnfrm499.blade.php ENDPATH**/ ?>