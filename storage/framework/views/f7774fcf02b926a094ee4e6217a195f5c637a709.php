    ...
    <div class="container-fluid purchase-order-view">
                      ...
                      <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="text" name="SOANO" id="SOANO" value="<?php echo e(isset($MAXSOANO)?$MAXSOANO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            <input type="hidden" name="SOID_REF" id="SOID_REF" value="<?php echo e(isset($objSO->SOID)?$objSO->SOID:''); ?>" class="form-control" maxlength="15"   readonly >
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="SONO" id="SONO" value="<?php echo e(isset($objSO->SONO)?$objSO->SONO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Sales Order Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(38,this.value,1)" value="<?php echo e(isset($objSO->SODT)?$objSO->SODT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly>
                            </div>
                            

                            <div class="col-lg-2 pl"><p>Customer*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e(isset($objsubglcode->SGLCODE)?$objsubglcode->SGLCODE:''); ?> <?php echo e(isset($objsubglcode->SLNAME)?'-'.$objsubglcode->SLNAME:''); ?>"  autocomplete="off" readonly/>
                        ...
                        <div class="row">                               
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($objSO->DEALER_COMMISSION_AMT)?$objSO->DEALER_COMMISSION_AMT:''); ?>"  name="DEALER_COMMISSION_AMT" id="DEALER_COMMISSION_AMT" readonly autocomplete="off" class="form-control" maxlength="100"  />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSO->OVFDT)?$objSO->OVFDT:''); ?>" readonly>
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Order Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSO->OVTDT)?$objSO->OVTDT:''); ?>" min="<?php echo e(isset($objSO->OVFDT)?$objSO->OVFDT:''); ?>" >
                            </div>

                            <div class="col-lg-2 pl"><p>Customer PO No*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" class="form-control" autocomplete="off" style="text-transform:uppercase" value="<?php echo e(isset($objSO->CUSTOMERPONO)?$objSO->CUSTOMERPONO:''); ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Customer PO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="CUSTOMERDT" id="CUSTOMERDT" class="form-control " autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSO->CUSTOMERDT)?$objSO->CUSTOMERDT:''); ?>">
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objSO->REFNO)?$objSO->REFNO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->CREDITDAYS)?$objSO->CREDITDAYS:''); ?>">
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objShpAddress[0])?$objShpAddress[0]:''); ?>" readonly disabled />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e(isset($objSO->REMARKS)?$objSO->REMARKS:''); ?>"  >
                            </div>
                        ...
                        <div class="col-lg-2 pl">
                            <input type="checkbox" name="GST_Reverse" id="GST_Reverse" <?php echo e(isset($objSO->REVERSE_GST) && $objSO->REVERSE_GST == 1 ? 'checked' : ''); ?>    />                          
                        </div>
                        <div class="col-lg-2 pl"><p>GST Input Not Avail</p></div>
                        <div class="col-lg-2 pl">
                            <input type="checkbox" name="GST_N_Avail" id="GST_N_Avail"  <?php echo e(isset($objSO->GST_INPUT) && $objSO->GST_INPUT == 1 ? 'checked' : ''); ?>    />
                        </div>      
                        ...
                        <div class="col-lg-2 pl"><p>Total Value</p></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                              <textarea disabled <?php echo e($ActionStatus); ?> name="SHIPPING_INSTRUCTION" id="SHIPPING_INSTRUCTION" autocomplete="off" class="form-control" style="height:60px;" ><?php echo e(isset($objSO->SHIPPING_INSTRUCTION)?$objSO->SHIPPING_INSTRUCTION:''); ?></textarea>
                            </div> 
                            
                            <div class="col-lg-2 pl"><p>Delivery Address</p></div>
                            <div class="col-lg-4 pl">
                              <textarea disabled <?php echo e($ActionStatus); ?> name="DELIVERY_ADDRESS" id="DELIVERY_ADDRESS" autocomplete="off" class="form-control" style="height:60px;" ><?php echo e(isset($objSO->DELIVERY_ADDRESS)?$objSO->DELIVERY_ADDRESS:''); ?></textarea>
                            </div>
                          </div>
</div>
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                ...
                                                ?>
                                                    ...
                                                    <td hidden><input type="hidden" name=<?php echo e("SCHEMEID_REF_".$key); ?> id =<?php echo e("SCHEMEID_REF_".$key); ?>   class="form-control" autocomplete="off" style="width:130px;" value="<?php echo e($row->SCHEMEID_REF); ?>"  /></td>
                                                      <td hidden><input type="hidden" name=<?php echo e("ITEM_TYPE_".$key); ?> id =<?php echo e("ITEM_TYPE_".$key); ?>    class="form-control" autocomplete="off" style="width:130px;"  value="<?php echo e($row->ITEM_TYPE); ?>" /></td>
                                                    ...
                                                    <td><input type="text" name=<?php echo e("LEADDT_".$key); ?> id=<?php echo e("LEADDT_".$key); ?>  class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->LEAD_DT); ?>"  style="width:130px;"/></td>
                                                        ...
                                                        <td align="center"><button class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button class="btn remove dmaterial" title="Delete" id=<?php echo e("remove_".$key); ?> data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
        ...
        <div id="ADDITIONAL" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <textarea name="Template_Description" id="Template_Description" cols="118" rows="10" tabindex="3" ><?php echo e(isset($Template->TEMPLATE)?$Template->TEMPLATE:''); ?></textarea>
                                        </div>
                                    </div>            
                            </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UNICORN_DEV\resources\views/transactions/sales/SalesOrder/trnfrm38amendment.blade.php ENDPATH**/ ?>