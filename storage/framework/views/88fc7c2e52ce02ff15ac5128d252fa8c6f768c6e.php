...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->GEJWOID); ?>" value="<?php echo e($val->GEJWOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->GEDT) && $val->GEDT !='' && $val->GEDT !='1900-01-01' ? date('d-m-Y',strtotime($val->GEDT)):''); ?>" ></td>
                <td><?php echo e(isset($val->GENO) && $val->GENO !=''?$val->GENO:''); ?></td>
                <td><?php echo e(isset($val->GEDT) && $val->GEDT !='' && $val->GEDT !='1900-01-01' ? date('d-m-Y',strtotime($val->GEDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkGateEntry\trnfrm356.blade.php ENDPATH**/ ?>