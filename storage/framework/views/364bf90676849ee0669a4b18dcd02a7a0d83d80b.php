                    ...
                    <div class="row">
                        ...
                        <div class="row">
								...
								<div class="col-lg-3 pl" >
									...
									<option value="<?php echo e($val->SGLID); ?>" selected><?php echo e($val->SGLCODE); ?> - <?php echo e($val->SLNAME); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\PendingKnockReport\rptfrm516.blade.php ENDPATH**/ ?>