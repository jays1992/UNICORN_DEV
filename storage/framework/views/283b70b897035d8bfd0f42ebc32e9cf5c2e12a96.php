...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Gate Entry (GE)</a>
        </div>
...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->GEID[0]) ? method_field('PUT') : ''); ?>  
  <div class="container-fluid filter">
	  <div class="inner-form">
        ...
        <div class="col-lg-1 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="GE_NO" id="GE_NO" value="<?php echo e(isset($objResponse->GE_NO) && $objResponse->GE_NO !=''?$objResponse->GE_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
			
        <div class="col-lg-1 pl"><p>GE Date</p></div>
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="date" name="GE_DT" id="GE_DT" value="<?php echo e(isset($objResponse->GE_DT) && $objResponse->GE_DT !=''?$objResponse->GE_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>GE Time</p></div>
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="time" name="GE_TM" id="GE_TM" value="<?php echo e(isset($objResponse->GE_TM) && $objResponse->GE_TM !=''?date('H:i:s',strtotime($objResponse->GE_TM)):''); ?>" class="form-control mandatory"  autocomplete="off"  >
        </div>

        <div class="col-lg-2 pl"><p>Security Supervisor</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SECURITY_SUP" id="SECURITY_SUP" value="<?php echo e(isset($objResponse->SECURITY_SUP) && $objResponse->SECURITY_SUP !=''?$objResponse->SECURITY_SUP:''); ?>" maxlength="100" class="form-control" autocomplete="off"   >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SECURITY_GUARD" id="SECURITY_GUARD" value="<?php echo e(isset($objResponse->SECURITY_GUARD) && $objResponse->SECURITY_GUARD !=''?$objResponse->SECURITY_GUARD:''); ?>" maxlength="100" class="form-control" autocomplete="off"   >
        </div>
        <div class="col-lg-1 pl"></div>

        <div class="col-lg-2 pl"><p>Type</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="TYPE" id="TYPE" class="form-control"  autocomplete="off" onchange="getType(this.value)" >
            <option <?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE ==='Vendor'?'selected="selected"':''); ?> value="Vendor">Vendor</option>
            <option <?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE ==='Customer'?'selected="selected"':''); ?> value="Customer"  <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='RGP'?'':'disabled'); ?>>Customer</option>
            <option <?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE ==='Employee'?'selected="selected"':''); ?> value="Employee" <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='RGP'?'':'disabled'); ?>>Employee</option>
          </select>
        </div>

        <div class="col-lg-2 pl"><p id='fieldtype' ><?php echo e($objResponse->TYPE); ?></p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text"    name="VID_REF_Details" id="VID_REF_Details" value="<?php echo e(isset($objVendorName->VCODE) && $objVendorName->VCODE !=''?$objVendorName->VCODE.' - '.$objVendorName->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 pl">
          ...
          <div class="col-lg-1 pl">
              <input <?php echo e($ActionStatus); ?> type="checkbox" name="GETYPE" id="PO" <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='PO'?'checked':''); ?> value="PO" onchange="PoRgpType('PO');"  />
          </div>

          <div class="col-lg-2 pl"><p>RGP</p></div>
          <div class="col-lg-1 pl">
              <input <?php echo e($ActionStatus); ?> type="checkbox" name="GETYPE" id="RGP"  <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='RGP'?'checked':''); ?> value="RGP" onchange="PoRgpType('RGP');"  />    
          </div>

          <div class="col-lg-2 pl"><p>IPO</p></div>
          <div class="col-lg-1 pl">
              <input <?php echo e($ActionStatus); ?> type="checkbox" name="GETYPE" id="IPO"  <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='IPO'?'checked':''); ?> value="IPO" onchange="PoRgpType('IPO');"  />    
          </div>

          <div class="col-lg-2 pl"><p>BPO</p></div>
          <div class="col-lg-1 pl">
              <input <?php echo e($ActionStatus); ?> type="checkbox" name="GETYPE" id="BPO"  <?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE =='BPO'?'checked':''); ?> value="BPO" onchange="PoRgpType('BPO');"  />    
          </div>
        ...
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="PO_NO_Details" id="PO_NO_Details" value="<?php echo e(isset($objPoRgpName) && $objPoRgpName!=''?$objPoRgpName:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="PO_NO" id="PO_NO" value="<?php echo e(isset($objResponse->PO_NO) && $objResponse->PO_NO !=''?$objResponse->PO_NO:''); ?>" class="form-control" autocomplete="off" />
        </div>

        

        <div class="col-lg-2 pl"><p id="fieldtype1" ><?php echo e($objResponse->TYPE); ?> Bill No</p></div>
        <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_BILLNO" id="VENDOR_BILLNO" onkeyup="deleteDate('VENDOR_BILLDT',this.value),checkDuplicateVendorBillNo(this.value,'')"  value="<?php echo e(isset($objResponse->VENDOR_BILLNO) && $objResponse->VENDOR_BILLNO !=''?$objResponse->VENDOR_BILLNO:''); ?>" maxlength="20"  class="form-control" autocomplete="off"   >

              <input type="hidden" name="VENDOR_BILLNO_LAST" id="VENDOR_BILLNO_LAST" value="<?php echo e(isset($objResponse->VENDOR_BILLNO) && $objResponse->VENDOR_BILLNO !=''?$objResponse->VENDOR_BILLNO:''); ?>" class="form-control" autocomplete="off" />

              <input type="hidden" name="VID_REF_LAST" id="VID_REF_LAST" value="<?php echo e(isset($objResponse->VID_REF) && $objResponse->VID_REF !=''?$objResponse->VID_REF:''); ?>" class="form-control" autocomplete="off" />
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-2 pl"><p>Bill Date</p></div>
			<div class="col-lg-2 pl">
				  <input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_BILLDT" id="VENDOR_BILLDT" value="<?php echo e(isset($objResponse->VENDOR_BILLDT) && $objResponse->VENDOR_BILLDT !=''?$objResponse->VENDOR_BILLDT:''); ?>"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p id="fieldtype2"><?php echo e($objResponse->TYPE); ?> Challan No</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_CHNO" id="VENDOR_CHNO" onkeyup="deleteDate('VENDOR_CHDT',this.value);" value="<?php echo e(isset($objResponse->VENDOR_CHNO) && $objResponse->VENDOR_CHNO !=''?$objResponse->VENDOR_CHNO:''); ?>" maxlength="20"  class="form-control" autocomplete="off"   >
        </div>

      <div class="col-lg-2 pl"><p>Challan Date</p></div>
			<div class="col-lg-2 pl">
				<input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_CHDT" id="VENDOR_CHDT" value="<?php echo e(isset($objResponse->VENDOR_CHDT) && $objResponse->VENDOR_CHDT !=''?$objResponse->VENDOR_CHDT:''); ?>"  class="form-control" autocomplete="off"   >
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="GATE_NO" id="GATE_NO" value="<?php echo e(isset($objResponse->GATE_NO) && $objResponse->GATE_NO !=''?$objResponse->GATE_NO:''); ?>" maxlength="15"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Gate Register No</p></div>
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="GATE_RGNO" id="GATE_RGNO"  onkeyup="deleteDate('DATE',this.value);"  value="<?php echo e(isset($objResponse->GATE_RGNO) && $objResponse->GATE_RGNO !=''?$objResponse->GATE_RGNO:''); ?>" maxlength="15"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Date</p></div>
			<div class="col-lg-2 pl">
				  <input <?php echo e($ActionStatus); ?> type="date" name="DATE" id="DATE" value="<?php echo e(isset($objResponse->DATE) && $objResponse->DATE !=''?$objResponse->DATE:''); ?>"  class="form-control" autocomplete="off"   >
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="BOE_NO" id="BOE_NO" value="<?php echo e(isset($objResponse->BOE_NO) && $objResponse->BOE_NO !=''?$objResponse->BOE_NO:''); ?>" maxlength="30"  class="form-control" autocomplete="off" onkeypress="return AvoidSpace(event);" onblur="this.value=removeSpaces(this.value);"   >
      </div>
      <div class="col-lg-2 pl"><p>BOE Date</p></div>
			<div class="col-lg-2 pl">
				  <input <?php echo e($ActionStatus); ?> type="date" name="BOE_DATE" id="BOE_DATE"  class="form-control" value="<?php echo e(isset($objResponse->BOE_DATE) && $objResponse->BOE_DATE !=''?$objResponse->BOE_DATE:''); ?>" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Country of Origin</p></div>
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="COUNTRY_ORIGIN" id="COUNTRY_ORIGIN" value="<?php echo e(isset($objResponse->COUNTRY_ORIGIN) && $objResponse->COUNTRY_ORIGIN !=''?$objResponse->COUNTRY_ORIGIN:''); ?>" maxlength="50"  class="form-control" autocomplete="off"   > 
    </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="PORT_DETAIL" id="PORT_DETAIL" maxlength="200" value="<?php echo e(isset($objResponse->PORT_DETAIL) && $objResponse->PORT_DETAIL !=''?$objResponse->PORT_DETAIL:''); ?>"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Airway/Way Bill No.</p></div>
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="AIRBILL_NO" id="AIRBILL_NO" maxlength="30" value="<?php echo e(isset($objResponse->AIRBILL_NO) && $objResponse->AIRBILL_NO !=''?$objResponse->AIRBILL_NO:''); ?>"  class="form-control" autocomplete="off"   > 
    </div>

    <div class="col-lg-2 pl"><p>Airway/Way Bill Date</p></div>
			<div class="col-lg-2 pl">
				  <input <?php echo e($ActionStatus); ?> type="date" name="AIRBILL_DATE" id="AIRBILL_DATE" value="<?php echo e(isset($objResponse->AIR_DATE) && $objResponse->AIR_DATE !=''?$objResponse->AIR_DATE:''); ?>"  class="form-control" autocomplete="off"   >
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="FREIGHT_TERMS" id="FREIGHT_TERMS" value="<?php echo e(isset($objResponse->FREIGHT_TERMS) && $objResponse->FREIGHT_TERMS !=''?$objResponse->FREIGHT_TERMS:''); ?>" maxlength="200"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Carrier Agent</p></div>
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="CARRIERF_AGENT" id="CARRIERF_AGENT" value="<?php echo e(isset($objResponse->CARRIERF_AGENT) && $objResponse->CARRIERF_AGENT !=''?$objResponse->CARRIERF_AGENT:''); ?>" maxlength="200"  class="form-control" autocomplete="off"   > 
    </div>

    <div class="col-lg-2 pl"><p>E-way Bill No.</p></div>
			<div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="EWAY_BILLNO" id="EWAY_BILLNO" value="<?php echo e(isset($objResponse->EWAY_BILLNO) && $objResponse->EWAY_BILLNO !=''?$objResponse->EWAY_BILLNO:''); ?>" maxlength="30"  class="form-control" autocomplete="off"   > 
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="date" name="EWAY_BILLDATE" id="EWAY_BILLDATE" value="<?php echo e(isset($objResponse->EWAY_BILLDATE) && $objResponse->EWAY_BILLDATE !=''?$objResponse->EWAY_BILLDATE:''); ?>"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Total Boxes</p></div>
      <div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="TOTAL_BOXES" onkeypress="return isNumberKey(event,this)" id="TOTAL_BOXES" value="<?php echo e(isset($objResponse->TOTAL_BOXES) && $objResponse->TOTAL_BOXES !=''?$objResponse->TOTAL_BOXES:''); ?>" maxlength="15"  class="form-control" autocomplete="off"   > 
    </div>

    <div class="col-lg-2 pl"><p>Truck Seal No.</p></div>
			<div class="col-lg-2 pl">
      <input <?php echo e($ActionStatus); ?> type="text" name="TRUCK_SEAL_NO" id="TRUCK_SEAL_NO" value="<?php echo e(isset($objResponse->TRUCK_SEAL_NO) && $objResponse->TRUCK_SEAL_NO !=''?$objResponse->TRUCK_SEAL_NO:''); ?>" maxlength="200"  class="form-control" autocomplete="off"   > 
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($objResponse->REMARKS) && $objResponse->REMARKS !=''?$objResponse->REMARKS:''); ?>" maxlength="200"  class="form-control" autocomplete="off"   >
      </div>

      <div class="col-lg-2 pl"><p>Currency</p></div>
        <div class="col-lg-2 pl" id="divcurrency" >
            <input <?php echo e($ActionStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" value="<?php echo e(isset($objResponse->CRCODE) && $objResponse->CRCODE !=''?$objResponse->CRCODE.'-'.$objResponse->CRDESCRIPTION:''); ?>" class="form-control"  autocomplete="off"  disabled/>
            <input <?php echo e($ActionStatus); ?> type="hidden" name="CRID_REF" id="CRID_REF" value="<?php echo e(isset($objResponse->CRID_REF) && $objResponse->CRID_REF !=''?$objResponse->CRID_REF:''); ?>" class="form-control" autocomplete="off" />                                
        </div>

        <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="CONVFACT" id="CONVFACT" autocomplete="off" value="<?php echo e(isset($objResponse->CONVFACT) && $objResponse->CONVFACT !=''?$objResponse->CONVFACT:''); ?>" class="form-control" maxlength="100" />
        </div>
    </div>
        ...
        <li><a data-toggle="tab" href="#Unloading" id="UnloadingTab">Unloading</a></li>
          ...
          <div class="inner-form">
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="LR_NO" id="LR_NO" onkeyup="deleteDate('LR_DT',this.value);" value="<?php echo e(isset($objResponseVcl->LR_NO) && $objResponseVcl->LR_NO !=''?$objResponseVcl->LR_NO:''); ?>" maxlength="30" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>LR Date</p></div>
              <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="date" name="LR_DT" id="LR_DT" value="<?php echo e(isset($objResponseVcl->LR_DT) && $objResponseVcl->LR_DT !=''?$objResponseVcl->LR_DT:''); ?>" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Primary Mode of Transport</p></div>
              <div class="col-lg-2 pl">
                <select <?php echo e($ActionStatus); ?>  name="TRANSPORT_MODE" id="TRANSPORT_MODE" class="form-control" autocomplete="off" >
                  <option value="">Select</option>
                  <option <?php echo e(isset($objResponseVcl->TRANSPORT_MODE) && $objResponseVcl->TRANSPORT_MODE =='By Road'?'selected="selected"':''); ?> value="By Road">By Road</option>
                  <option <?php echo e(isset($objResponseVcl->TRANSPORT_MODE) && $objResponseVcl->TRANSPORT_MODE =='By Sea'?'selected="selected"':''); ?> value="By Sea">By Sea</option>
                  <option <?php echo e(isset($objResponseVcl->TRANSPORT_MODE) && $objResponseVcl->TRANSPORT_MODE =='By Air'?'selected="selected"':''); ?> value="By Air">By Air</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="VEHICLE_NO" id="VEHICLE_NO" value="<?php echo e(isset($objResponseVcl->VEHICLE_NO) && $objResponseVcl->VEHICLE_NO !=''?$objResponseVcl->VEHICLE_NO:''); ?>" maxlength="30" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Vehicle Category</p></div>
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="VEHICLE_CAT" id="VEHICLE_CAT" value="<?php echo e(isset($objResponseVcl->VEHICLE_CAT) && $objResponseVcl->VEHICLE_CAT !=''?$objResponseVcl->VEHICLE_CAT:''); ?>" maxlength="100" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Transporter</p></div>
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="TRANSPORTER_Details" id="TRANSPORTER_Details" value="<?php echo e(isset($objTransporterName->TRANSPORTER_CODE) && $objTransporterName->TRANSPORTER_CODE !=''?$objTransporterName->TRANSPORTER_CODE.' - '.$objTransporterName->TRANSPORTER_NAME:''); ?>"  class="form-control"  autocomplete="off" readonly/>
                <input type="hidden" name="TRANSPORTER" id="TRANSPORTER" value="<?php echo e(isset($objResponseVcl->TRANSPORTER) && $objResponseVcl->TRANSPORTER !=''?$objResponseVcl->TRANSPORTER:''); ?>" class="form-control" autocomplete="off" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="<?php echo e(isset($objResponseVcl->DRIVER_NAME) && $objResponseVcl->DRIVER_NAME !=''?$objResponseVcl->DRIVER_NAME:''); ?>" maxlength="100" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Weighment Machine</p></div>
              <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="WEIGHMENT_MACHINE" id="WEIGHMENT_MACHINE" value="<?php echo e(isset($objResponseVcl->WEIGHMENT_MACHINE) && $objResponseVcl->WEIGHMENT_MACHINE !=''?$objResponseVcl->WEIGHMENT_MACHINE:''); ?>" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Weighment Slip No</p></div>
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="WEIGHMENT_SLIP" id="WEIGHMENT_SLIP" value="<?php echo e(isset($objResponseVcl->WEIGHMENT_SLIP) && $objResponseVcl->WEIGHMENT_SLIP !=''?$objResponseVcl->WEIGHMENT_SLIP:''); ?>"  maxlength="10"  class="form-control"  autocomplete="off"/>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="GROSS_WEIGHT" id="GROSS_WEIGHT" onkeyup="weightCalculation();" value="<?php echo e(isset($objResponseVcl->GROSS_WEIGHT) && $objResponseVcl->GROSS_WEIGHT !=''?$objResponseVcl->GROSS_WEIGHT:''); ?>" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
              </div>
          
              <div class="col-lg-2 pl"><p>Tare Weight (KGS)</p></div>
              <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="TARE_WEIGHT" id="TARE_WEIGHT" onkeyup="weightCalculation();" value="<?php echo e(isset($objResponseVcl->TARE_WEIGHT) && $objResponseVcl->TARE_WEIGHT !=''?$objResponseVcl->TARE_WEIGHT:''); ?>" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
              </div>

              <div class="col-lg-2 pl"><p>Net Weight (KGS)</p></div>
              <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="NET_WEIGHT" id="NET_WEIGHT" value="<?php echo e(isset($objResponseVcl->NET_WEIGHT) && $objResponseVcl->NET_WEIGHT !=''?$objResponseVcl->NET_WEIGHT:''); ?>" maxlength="50" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" readonly  >
              </div>
            </div>
        ...
        <div id="Unloading" class="tab-pane fade">	
          <div class="inner-form">
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="text" name="UNL_BAYNO" id="UNL_BAYNO" value="<?php echo e(isset($objResponseUnl->UNL_BAYNO) && $objResponseUnl->UNL_BAYNO !=''?$objResponseUnl->UNL_BAYNO:''); ?>" maxlength="30" class="form-control" autocomplete="off" >
                </div>
            
                <div class="col-lg-2 pl"><p>Stock Custodian</p></div>
                <div class="col-lg-2 pl">
                      <input <?php echo e($ActionStatus); ?> type="text" name="ST_CUSTODIAN" id="ST_CUSTODIAN" value="<?php echo e(isset($objResponseUnl->ST_CUSTODIAN) && $objResponseUnl->ST_CUSTODIAN !=''?$objResponseUnl->ST_CUSTODIAN:''); ?>" class="form-control" autocomplete="off" >
                </div>

                <div class="col-lg-2 pl"><p>Unload Method</p></div>
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="text" name="UNL_METHOD" id="UNL_METHOD" value="<?php echo e(isset($objResponseUnl->UNL_METHOD) && $objResponseUnl->UNL_METHOD !=''?$objResponseUnl->UNL_METHOD:''); ?>" maxlength="100"  class="form-control"  autocomplete="off"/>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  <input <?php echo e($ActionStatus); ?> type="text" name="PTID_REF_Details" id="PTID_REF_Details" value="<?php echo e(isset($objPackingName->PTCODE) && $objPackingName->PTCODE !=''?$objPackingName->PTCODE.' - '.$objPackingName->PTNAME:''); ?>" class="form-control"   autocomplete="off" readonly/>
                    <input type="hidden" name="PTID_REF" id="PTID_REF" value="<?php echo e(isset($objResponseUnl->PTID_REF) && $objResponseUnl->PTID_REF !=''?$objResponseUnl->PTID_REF:''); ?>" class="form-control" autocomplete="off" />
                </div>
            
                <div class="col-lg-2 pl"><p>No of Packing</p></div>
                <div class="col-lg-2 pl">
                      <input <?php echo e($ActionStatus); ?> type="text" name="PACKING_NO" id="PACKING_NO" value="<?php echo e(isset($objResponseUnl->PACKING_NO) && $objResponseUnl->PACKING_NO !=''?$objResponseUnl->PACKING_NO:''); ?>" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" autocomplete="off" >
                </div>

                <div class="col-lg-2 pl"><p>Primary Packaging Condition</p></div>
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="text" name="PACKING_CONDITION" id="PACKING_CONDITION"  value="<?php echo e(isset($objResponseUnl->PACKING_CONDITION) && $objResponseUnl->PACKING_CONDITION !=''?$objResponseUnl->PACKING_CONDITION:''); ?>" maxlength="200"  class="form-control"  autocomplete="off"/>
                </div>
              </div>
          </div>
				</div>
      ...
      <div class="modal-body">
          ...
          <table id="TRANSPORTER_Table" class="display nowrap table  table-striped table-bordered" >
            ...
            <table id="TRANSPORTER_Table2" class="display nowrap table  table-striped table-bordered">
              ...
              <tbody>
              <?php $__currentLoopData = $objTransporterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr >
                <td class="ROW1"> <input type="checkbox" name="SELECT_TRANSPORTER[]" id="TRANSPORTER_TDID_<?php echo e($key); ?>" class="TRANSPORTER_Row" value="<?php echo e($val-> TRANSPORTERID); ?>" ></td>
                <td class="ROW2" ><?php echo e($val-> TRANSPORTER_CODE); ?> <input type="hidden" id="txtTRANSPORTER_TDID_<?php echo e($key); ?>" data-desc="<?php echo e($val-> TRANSPORTER_CODE); ?> - <?php echo e($val-> TRANSPORTER_NAME); ?>"  value="<?php echo e($val-> TRANSPORTERID); ?>"/></td>
                <td class="ROW3"><?php echo e($val-> TRANSPORTER_NAME); ?></td>
              </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
      ...
      <div class="modal-body">
          ...
          <table id="PTID_REF_Table" class="display nowrap table  table-striped table-bordered" >
            ...
            <table id="PTID_REF_Table2" class="display nowrap table  table-striped table-bordered" >
              ...
              <tbody>
              <?php $__currentLoopData = $objPackingList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr >
                <td class="ROW1"> <input type="checkbox" name="SELECT_PTID_REF[]" id="PTID_REF_TDID_<?php echo e($key); ?>" class="PTID_REF_Row" value="<?php echo e($val-> PTID); ?>" ></td>
                <td class="ROW2" ><?php echo e($val-> PTCODE); ?> <input type="hidden" id="txtPTID_REF_TDID_<?php echo e($key); ?>" data-desc="<?php echo e($val-> PTCODE); ?> - <?php echo e($val-> PTNAME); ?>"  value="<?php echo e($val-> PTID); ?>"/></td>
                <td class="ROW3"><?php echo e($val-> PTNAME); ?></td>
              </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tbody>
      ...
      <table id="EmployeeTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_EMPLOYEE[]" id="spidcode_<?php echo e($key); ?>" class="clssemployee" value="<?php echo e($val-> EMPID); ?>" ></td>  
...
function getPoRgp(Type,VID_REF,CTYPE){
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[$FormId,"getPoRgp"])); ?>',
        type:'POST',
        data:{Type:Type,VID_REF:VID_REF,CTYPE:CTYPE,value:'<?php echo e(isset($objResponse->PO_NO) && $objResponse->PO_NO !=''?$objResponse->PO_NO:''); ?>'},
        success:function(data) {
...
$(function() { 
  ...
  getPoRgp("<?php echo e(isset($objResponse->GETYPE) && $objResponse->GETYPE !=''?$objResponse->GETYPE:''); ?>","<?php echo e(isset($objResponse->VID_REF) && $objResponse->VID_REF !=''?$objResponse->VID_REF:''); ?>","<?php echo e(isset($objResponse->TYPE) && $objResponse->TYPE !=''?$objResponse->TYPE:''); ?>")
});
...
function validateForm(actionType){
 ...
 // alert($('input[name="GETYPE"]:checked').val());
  ...
  // }
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#GE_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
var checkDuplicateVendorBillNo = $.ajax({type: 'POST',url:'<?php echo e(route("transaction",[$FormId,"checkDuplicateVendorBillNo"])); ?>',async: false,dataType: 'json',data: {VENDOR_BILLNO:VENDOR_BILLNO,VID_REF:VID_REF},done: function(response) {return response;}}).responseText;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\GateEntry_1\trnfrm92edit.blade.php ENDPATH**/ ?>