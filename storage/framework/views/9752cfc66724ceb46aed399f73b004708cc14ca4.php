<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->USERID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="USERID" id="USERID" value="<?php echo e($objResponse->USERID); ?>" />
                    <input type="hidden" name="UCODE" id="UCODE" value="<?php echo e($objResponse->UCODE); ?>" autocomplete="off"    />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="DESCRIPTIONS" id="DESCRIPTIONS" class="form-control mandatory" value="<?php echo e(old('NAME',$objResponse->DESCRIPTIONS)); ?>" maxlength="200" tabindex="1"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="password" name="PASSWORD" id="PASSWORD" class="form-control mandatory" value="<?php echo e(old('PASSWORD',$objResponse->PASSWORD)); ?>" maxlength="200" tabindex="3"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="password" name="CONFIRM_PASSWORD" id="CONFORM_PASSWORD" class="form-control mandatory" value="<?php echo e(old('CONFORM_PASSWORD',$objResponse->PASSWORD)); ?>"  maxlength="200" tabindex="4"  />
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        ?>
                          ...
                          <tr  class="participantRow">
                            <td>
                              <input type="text" name="POPUP_EMPID_<?php echo e($key); ?>" id="POPUP_EMPID_<?php echo e($key); ?>" class="form-control showEmp"  value="<?php echo e($row->EMPCODE); ?>" readonly  style="width:100%;"  />
                              </td>
                              <td hidden><input type="hidden" name=<?php echo e("UDID_".$key); ?> id =<?php echo e("UDID_".$key); ?> value="<?php echo e($row->UDID); ?>" /></td>
                              <td hidden><input type="hidden" name=<?php echo e("EMPID_REF_".$key); ?> id =<?php echo e("EMPID_REF_".$key); ?> value="<?php echo e($row->EMPID_REF); ?>" /></td>
                              <td><input  class="form-control w-100" type="text" name=<?php echo e("EMP_NAME_".$key); ?> id =<?php echo e("EMP_NAME_".$key); ?> value="<?php echo e($row->FNAME); ?> <?php echo e($row->MNAME); ?> <?php echo e($row->LNAME); ?>" maxlength="200" readonly style="width:100%;" ></td>
                              <td><input  class="form-control w-100" type="date" name=<?php echo e("STARTPD_".$key); ?> id =<?php echo e("STARTPD_".$key); ?> value="<?php echo e(isset($row->STARTPD) && $row->STARTPD !="" && $row->STARTPD !="1900-01-01" ? $row->STARTPD:''); ?>"  autocomplete="off" style="width:100%;" ></td>
                              <td><input  class="form-control w-100" type="date" name=<?php echo e("ENDPD_".$key); ?> id =<?php echo e("ENDPD_".$key); ?> value="<?php echo e(isset($row->ENDPD) && $row->ENDPD !="" && $row->ENDPD !="1900-01-01" ? $row->ENDPD:''); ?>"   autocomplete="off" style="width:100%;"  ></td>
                              <td><input  class="" type="checkbox" name=<?php echo e("EMPDEACTIVATED_".$key); ?> id =<?php echo e("EMPDEACTIVATED_".$key); ?>  value="1"  autocomplete="off" style="width:100%;"  <?php echo e($row->DEACTIVATED == 1 ? "checked" : ""); ?> ></td>
                              <td><input  class="form-control w-100" type="date" name=<?php echo e("EMPDODEACTIVATED_".$key); ?> id =<?php echo e("EMPDODEACTIVATED_".$key); ?>  autocomplete="off" style="width:100%;" value="<?php echo e(isset($row->DODEACTIVATED) && $row->DODEACTIVATED !="" && $row->DODEACTIVATED !="1900-01-01" ? $row->DODEACTIVATED:''); ?>" <?php echo e($row->DEACTIVATED == 1 ? "" : "disabled"); ?>  ></td>
                              <td><input  class="" type="checkbox" name=<?php echo e("SUPPERUSER_".$key); ?> id =<?php echo e("SUPPERUSER_".$key); ?> value="1"  autocomplete="off" style="width:100%;" <?php echo e($row->SUPPERUSER == 1 ? "checked" : ""); ?>></td>

                              <td align="center" >
                                  <button class="btn add" title="add" data-toggle="tooltip" <?php echo e(count($objDataResponse) == count($m)?'':'disabled'); ?> ><i class="fa fa-plus"></i></button>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[150,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[150,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserMaster\mstfrm150edit.blade.php ENDPATH**/ ?>