	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="MIS_NO" id="MIS_NO" value="<?php echo e(isset($objResponse->MIS_NO) && $objResponse->MIS_NO !=''?$objResponse->MIS_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MIS_DT" id="MIS_DT" value="<?php echo e(isset($objResponse->MIS_DT) && $objResponse->MIS_DT !=''?$objResponse->MIS_DT:''); ?>" class="form-control mandatory" >
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialIssueSlip\trnfrm89view.blade.php ENDPATH**/ ?>