...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[1,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="calculationmst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->CTID); ?>" value="<?php echo e($val->CTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->CTCODE) && $val->CTCODE !=''?$val->CTCODE:''); ?></td>
              <td><?php echo e(isset($val->CTDESCRIPTION) && $val->CTDESCRIPTION !=''?$val->CTDESCRIPTION:''); ?></td>
...
<style>
  #custom_dropdown, #calculationmst_filter {
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#btnExit').on('click', function() {
      var viewURL = '<?php echo e(route('home')); ?>';
        ...
        // Data table for serverside
         var mstcalculationTable =  $('#calculationmst').DataTable({
      ...
      $('#btnEdit').on('click', function() {
            ...
            var calculationIdsData = getSeletectedCBox();
            var seletedRecord = calculationIdsData.length;
            ...
            if(seletedRecord==0){
              ...
              var recordId = calculationIdsData[0];
                  var is_approve = $('#chkId'+recordId).data("rcdstatus");
                  console.log("is app=="+is_approve);  

                  if(is_approve==0){

                    var editURL = '<?php echo e(route("master",[1,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[1,"view",":rcdId"])); ?>';
    ...
    $('#btnApprove').on('click', function() {
            var calculationIdsData = getSeletectedCBox();
            var seletedRecord = calculationIdsData.length;
            var calculationIdsDataID = getSeletectedCBoxID();
            ...
            if(seletedRecord==0){
              ...
              var recordId = calculationIdsDataID;
    ...
    $('#btnAttach').on('click', function() {
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[1,"attachment",":rcdId"])); ?>';
      ...
      function getSeletectedCBox(){       
        selectedIds=[];
            var checkedcollection = mstcalculationTable.$(".js-selectall1:checked", { "page": "all" });
...
var recordId = calculationIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[1,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[1,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Common/CalculationTemplate/mstfrm1.blade.php ENDPATH**/ ?>