  ...
  <form id="master_form" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
   ...
   <div class="inner-form">              
         <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="FROMDT" id="FROM_DT" value="<?php echo e(isset($DDMMYY)?$DDMMYY:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="TODT" id="TO_DT" value="<?php echo e(isset($TOTALDDMMYY)?$TOTALDDMMYY:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\PeriodClosing\mstfrm502add.blade.php ENDPATH**/ ?>