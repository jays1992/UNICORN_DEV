...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
          ...
          <input type="date" name="MPPDT" id="MPPDT" value="<?php echo e($objSE->MPP_DOC_DT); ?>" class="form-control mandatory MPPDT"  placeholder="dd/mm/yyyy" disabled>
...
<tr  class="participantRow">
  <td style="text-align:center;">
    <input type="text" name="BUID_REF_<?php echo e($key); ?>" id="BUID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ICCODE); ?>" disabled  onClick="get_section($(this).attr('id'))" class="form-control mandatory" style="width:140px" readonly tabindex="1" />
  </td>
  ...
  <td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>"   disabled     value="<?php echo e($row->ICODE); ?>"       class="form-control"  autocomplete="off" style="width:150px;"  readonly/></td>
  ...
  <td><input type="text" name="ppqty_<?php echo e($key); ?>" id="ppqty_<?php echo e($key); ?>"            disabled        value="<?php echo e($row->PD_PLAN_QTY); ?>"  class="form-control three-digits" style="width:130px;" maxlength="13" autocomplete="off"  /></td>

  
  <td id="tdmachine_1"> 
    <input type="text" name="machine1_<?php echo e($key); ?>" id="machine1_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_1_DESC); ?>"  disabled   readonly data-dayno="1"  class="form-control"  style="width:140px;"  />
  </td>
  <td id="tdhdnmachine_1" hidden><input type="text" name="machine1_MACH_REFID_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_1_ID); ?>"     id="machine1_hdnMACHID_<?php echo e($key); ?>" class="form-control" /></td>
  <td id="tdshift_1" >
      <input type="text" name="shift1_<?php echo e($key); ?>" id="shift1_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->SHFT_1_DESC); ?>"  disabled    readonly data-dayno="1" class="form-control" style="width:140px;"  />
  </td>
  <td id="tdhdnshift_1" hidden> <input type="text" name="shift1_SHIFT_REFID_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->SHFT_1_ID); ?>"   id="shift1_hdnSHIFTID_<?php echo e($key); ?>" class="form-control"  /> </td>
  <td id="tdday_qty_1"> <input type="text" name="dayqty1_<?php echo e($key); ?>"  disabled    id="dayqty1_<?php echo e($key); ?>"   disabled   data-dayno="1"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_1); ?>" style="width:130px;" autocomplete="off"  /> </td>
  
  
  <td id="tdmachine_2"> 
    <input type="text" name="machine2_<?php echo e($key); ?>" id="machine2_txtMachine_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->MACH_2_DESC); ?>"  disabled   readonly data-dayno="2"  class="form-control"  style="width:140px;"  />
  </td>
  <td id="tdhdnmachine_2" hidden><input type="text" name="machine2_MACH_REFID_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->MACH_2_ID); ?>" id="machine2_hdnMACHID_<?php echo e($key); ?>" class="form-control" /></td>
  <td id="tdshift_2" >
      <input type="text" name="shift2_<?php echo e($key); ?>" id="shift2_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_2_DESC); ?>"  disabled   readonly data-dayno="2" class="form-control" style="width:140px;"  />
  </td>
  <td id="tdhdnshift_2" hidden> <input type="text" name="shift2_SHIFT_REFID_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_2_ID); ?>"   id="shift2_hdnSHIFTID_<?php echo e($key); ?>" class="form-control"  /> </td>
  <td id="tdday_qty_2"><input type="text" name="dayqty2_<?php echo e($key); ?>"  disabled    id="dayqty2_<?php echo e($key); ?>"   disabled  data-dayno="2"   class="form-control three-digits" maxlength="13"  value="<?php echo e($row->QTY_2); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_3"> 
    <input type="text" name="machine3_<?php echo e($key); ?>" id="machine3_txtMachine_popup_<?php echo e($key); ?>"    disabled   value="<?php echo e($row->MACH_3_DESC); ?>"  disabled    readonly data-dayno="3"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_3" >
      <input type="text" name="shift3_<?php echo e($key); ?>" id="shift3_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_3_DESC); ?>"  disabled   readonly data-dayno="3" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_3"><input type="text" name="dayqty3_<?php echo e($key); ?>"  disabled    id="dayqty3_<?php echo e($key); ?>"   disabled  data-dayno="3"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_3); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_4"> 
    <input type="text" name="machine4_<?php echo e($key); ?>" id="machine4_txtMachine_popup_<?php echo e($key); ?>"  disabled   value="<?php echo e($row->MACH_4_DESC); ?>"  disabled   readonly data-dayno="4"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_4" >
      <input type="text" name="shift4_<?php echo e($key); ?>" id="shift4_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_4_DESC); ?>"  disabled   readonly data-dayno="4" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_4"><input type="text" name="dayqty4_<?php echo e($key); ?>"  disabled    id="dayqty4_<?php echo e($key); ?>"   disabled  data-dayno="4"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_4); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_5"> 
    <input type="text" name="machine5_<?php echo e($key); ?>" id="machine5_txtMachine_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->MACH_5_DESC); ?>"  disabled    readonly data-dayno="5"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_5" >
      <input type="text" name="shift5_<?php echo e($key); ?>" id="shift5_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_5_DESC); ?>"  disabled  readonly data-dayno="5" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_5"><input type="text" name="dayqty5_<?php echo e($key); ?>"  disabled    id="dayqty5_<?php echo e($key); ?>"   disabled  data-dayno="5"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_5); ?>" style="width:130px;" autocomplete="off"  /></td>
  
 
  <td id="tdmachine_6"> 
    <input type="text" name="machine6_<?php echo e($key); ?>" id="machine6_txtMachine_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->MACH_6_DESC); ?>"  disabled   readonly data-dayno="6"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_6" >
      <input type="text" name="shift6_<?php echo e($key); ?>" id="shift6_txtLISTPOP_popup_<?php echo e($key); ?>"    disabled  value="<?php echo e($row->SHFT_6_DESC); ?>"  disabled  readonly data-dayno="6" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_6"><input type="text" name="dayqty6_<?php echo e($key); ?>"  disabled    id="dayqty6_<?php echo e($key); ?>"   disabled  data-dayno="6"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_6); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_7"> 
    <input type="text" name="machine7_<?php echo e($key); ?>" id="machine7_txtMachine_popup_<?php echo e($key); ?>"    disabled  value="<?php echo e($row->MACH_7_DESC); ?>"  disabled  readonly data-dayno="7"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_7" >
      <input type="text" name="shift7_<?php echo e($key); ?>" id="shift7_txtLISTPOP_popup_<?php echo e($key); ?>"     disabled  value="<?php echo e($row->SHFT_7_DESC); ?>"  disabled  readonly data-dayno="7" class="form-control" style="width:140px;"  />
  </td>
  <td id="tdhdnshift_7" hidden> <input type="text" name="shift7_SHIFT_REFID_<?php echo e($key); ?>"     disabled  value="<?php echo e($row->SHFT_7_ID); ?>"   id="shift7_hdnSHIFTID_<?php echo e($key); ?>" class="form-control"  /> </td>  
  <td id="tdday_qty_7"><input type="text" name="dayqty7_<?php echo e($key); ?>"  disabled    id="dayqty7_<?php echo e($key); ?>"  data-dayno="7"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_7); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_8"> 
    <input type="text" name="machine8_<?php echo e($key); ?>" id="machine8_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_8_DESC); ?>"  disabled   readonly data-dayno="8"  class="form-control"  style="width:140px;"  />
  </td>
  <td id="tdhdnmachine_8" hidden><input type="text" name="machine8_MACH_REFID_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_8_ID); ?>"  id="machine8_hdnMACHID_<?php echo e($key); ?>" class="form-control" /></td>
  <td id="tdshift_8" >
      <input type="text" name="shift8_<?php echo e($key); ?>" id="shift8_txtLISTPOP_popup_<?php echo e($key); ?>"    disabled   value="<?php echo e($row->SHFT_8_DESC); ?>"  disabled  readonly data-dayno="8" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_8"><input type="text" name="dayqty8_<?php echo e($key); ?>"  disabled    id="dayqty8_<?php echo e($key); ?>"   disabled  data-dayno="8"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_8); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_9"> 
    <input type="text" name="machine9_<?php echo e($key); ?>" id="machine9_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_9_DESC); ?>"  disabled  readonly data-dayno="9"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_9" >
      <input type="text" name="shift9_<?php echo e($key); ?>" id="shift9_txtLISTPOP_popup_<?php echo e($key); ?>"    disabled   value="<?php echo e($row->SHFT_9_DESC); ?>"  disabled    readonly data-dayno="9" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_9"><input type="text" name="dayqty9_<?php echo e($key); ?>"  disabled    id="dayqty9_<?php echo e($key); ?>"   disabled  data-dayno="9"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_9); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_10"> 
    <input type="text" name="machine10_<?php echo e($key); ?>" id="machine10_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_10_DESC); ?>"  disabled   readonly data-dayno="10"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_10" >
      <input type="text" name="shift10_<?php echo e($key); ?>" id="shift10_txtLISTPOP_popup_<?php echo e($key); ?>"    disabled   value="<?php echo e($row->SHFT_10_DESC); ?>"  disabled    readonly data-dayno="10" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_10"><input type="text" name="dayqty10_<?php echo e($key); ?>"  disabled    id="dayqty10_<?php echo e($key); ?>"   disabled   data-dayno="10"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_10); ?>"  style="width:130px;" autocomplete="off"  /></td>
  

  
  <td id="tdmachine_11"> 
    <input type="text" name="machine11_<?php echo e($key); ?>" id="machine11_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_11_DESC); ?>"  disabled     readonly data-dayno="11"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_11" >
      <input type="text" name="shift11_<?php echo e($key); ?>" id="shift11_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->SHFT_11_DESC); ?>"  disabled     readonly data-dayno="11" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_11"><input type="text" name="dayqty11_<?php echo e($key); ?>"  disabled    id="dayqty11_<?php echo e($key); ?>"   disabled  data-dayno="11"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_11); ?>" style="width:130px;" autocomplete="off"  /></td>


  <td id="tdmachine_12"> 
    <input type="text" name="machine12_<?php echo e($key); ?>" id="machine12_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_12_DESC); ?>"  disabled     readonly data-dayno="12"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_12" >
      <input type="text" name="shift12_<?php echo e($key); ?>" id="shift12_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled    value="<?php echo e($row->SHFT_12_DESC); ?>"  disabled   readonly data-dayno="12" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_12"><input type="text"  name="dayqty12_<?php echo e($key); ?>"   disabled    id="dayqty12_<?php echo e($key); ?>"   disabled   data-dayno="12"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_12); ?>"  style="width:130px;" autocomplete="off"  /></td>
  
  <td id="tdmachine_13"> 
    <input type="text" name="machine13_<?php echo e($key); ?>" id="machine13_txtMachine_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->MACH_13_DESC); ?>"  disabled   readonly data-dayno="13"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_13" >
      <input type="text" name="shift13_<?php echo e($key); ?>" id="shift13_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled  value="<?php echo e($row->SHFT_13_DESC); ?>"  disabled   readonly data-dayno="13" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_13"><input type="text"  name="dayqty13_<?php echo e($key); ?>"   disabled    id="dayqty13_<?php echo e($key); ?>"   disabled   data-dayno="13"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_13); ?>" style="width:130px;" autocomplete="off"  /></td>

  
  <td id="tdmachine_14"> 
    <input type="text" name="machine14_<?php echo e($key); ?>" id="machine14_txtMachine_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->MACH_14_DESC); ?>"  disabled   readonly data-dayno="14"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_14" >
      <input type="text" name="shift14_<?php echo e($key); ?>" id="shift14_txtLISTPOP_popup_<?php echo e($key); ?>"   disabled   value="<?php echo e($row->SHFT_14_DESC); ?>"  disabled   readonly data-dayno="14" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_14"><input type="text"  name="dayqty14_<?php echo e($key); ?>"   disabled    id="dayqty14_<?php echo e($key); ?>"   disabled   data-dayno="14"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_14); ?>" style="width:130px;" autocomplete="off"  /></td>
  


  <td id="tdmachine_15"> 
    <input type="text" name="machine15_<?php echo e($key); ?>" id="machine15_txtMachine_popup_<?php echo e($key); ?>" value="<?php echo e($row->MACH_15_DESC); ?>"  disabled   readonly data-dayno="15"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_15" >
      <input type="text" name="shift15_<?php echo e($key); ?>" id="shift15_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_15_DESC); ?>"  disabled  readonly data-dayno="15" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_15"><input type="text"  name="dayqty15_<?php echo e($key); ?>"   disabled     disabled    id="dayqty15_<?php echo e($key); ?>"  data-dayno="15"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_15); ?>" style="width:130px;" autocomplete="off"  /></td>
  

  <td id="tdmachine_16"> 
    <input type="text" name="machine16_<?php echo e($key); ?>" id="machine16_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_16_DESC); ?>"  disabled  readonly data-dayno="16"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_16" >
      <input type="text" name="shift16_<?php echo e($key); ?>" id="shift16_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_16_DESC); ?>"  disabled  readonly data-dayno="16" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_16"><input type="text"  name="dayqty16_<?php echo e($key); ?>"   disabled     disabled    id="dayqty16_<?php echo e($key); ?>"  data-dayno="16"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_16); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  

  <td id="tdmachine_17"> 
    <input type="text" name="machine17_<?php echo e($key); ?>" id="machine17_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_17_DESC); ?>"  disabled   readonly data-dayno="17"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_17" >
      <input type="text" name="shift17_<?php echo e($key); ?>" id="shift17_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_17_DESC); ?>"  disabled    readonly data-dayno="17" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_17"><input type="text"  name="dayqty17_<?php echo e($key); ?>"   disabled    id="dayqty17_<?php echo e($key); ?>"  data-dayno="17"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_17); ?>" style="width:130px;" autocomplete="off"  /></td>
  



  <td id="tdmachine_18"> 
    <input type="text" name="machine18_<?php echo e($key); ?>" id="machine18_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_18_DESC); ?>"  disabled    readonly data-dayno="18"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_18" >
      <input type="text" name="shift18_<?php echo e($key); ?>" id="shift18_txtLISTPOP_popup_<?php echo e($key); ?>" value="<?php echo e($row->SHFT_18_DESC); ?>"  disabled   readonly data-dayno="18" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_18"><input type="text"  name="dayqty18_<?php echo e($key); ?>"   disabled    id="dayqty18_<?php echo e($key); ?>"  data-dayno="18"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_18); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  

  <td id="tdmachine_19"> 
    <input type="text" name="machine19_<?php echo e($key); ?>" id="machine19_txtMachine_popup_<?php echo e($key); ?>" value="<?php echo e($row->MACH_19_DESC); ?>"  disabled    readonly data-dayno="19"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_19" >
      <input type="text" name="shift19_<?php echo e($key); ?>" id="shift19_txtLISTPOP_popup_<?php echo e($key); ?>" value="<?php echo e($row->SHFT_19_DESC); ?>"  disabled   readonly data-dayno="19" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_19"><input type="text"  name="dayqty19_<?php echo e($key); ?>"   disabled    id="dayqty19_<?php echo e($key); ?>"  data-dayno="19"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_19); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_20"> 
    <input type="text" name="machine20_<?php echo e($key); ?>" id="machine20_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_20_DESC); ?>"  disabled   readonly data-dayno="20"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_20" >
      <input type="text" name="shift20_<?php echo e($key); ?>" id="shift20_txtLISTPOP_popup_<?php echo e($key); ?>" value="<?php echo e($row->SHFT_20_DESC); ?>"  disabled    readonly data-dayno="20" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_20"><input type="text"  name="dayqty20_<?php echo e($key); ?>"   disabled    id="dayqty20_<?php echo e($key); ?>"  data-dayno="20"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_20); ?>" style="width:130px;" autocomplete="off"  /></td>
  


  <td id="tdmachine_21"> 
    <input type="text" name="machine21_<?php echo e($key); ?>" id="machine21_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_21_DESC); ?>"  disabled   readonly data-dayno="21"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_21" >
      <input type="text" name="shift21_<?php echo e($key); ?>" id="shift21_txtLISTPOP_popup_<?php echo e($key); ?>" value="<?php echo e($row->SHFT_21_DESC); ?>"  disabled   readonly data-dayno="21" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_21"><input type="text"  name="dayqty21_<?php echo e($key); ?>"   disabled    id="dayqty21_<?php echo e($key); ?>"  data-dayno="21"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_21); ?>" style="width:130px;" autocomplete="off"  /></td>
  


  <td id="tdmachine_22"> 
    <input type="text" name="machine22_<?php echo e($key); ?>" id="machine22_txtMachine_popup_<?php echo e($key); ?>" value="<?php echo e($row->MACH_22_DESC); ?>"  disabled    readonly data-dayno="22"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_22" >
      <input type="text" name="shift22_<?php echo e($key); ?>" id="shift22_txtLISTPOP_popup_<?php echo e($key); ?>" value="<?php echo e($row->SHFT_22_DESC); ?>"  disabled   readonly data-dayno="22" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_22"><input type="text"  name="dayqty22_<?php echo e($key); ?>"   disabled    id="dayqty22_<?php echo e($key); ?>"  data-dayno="22"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_22); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  <td id="tdmachine_23"> 
    <input type="text" name="machine23_<?php echo e($key); ?>" id="machine23_txtMachine_popup_<?php echo e($key); ?>" value="<?php echo e($row->MACH_23_DESC); ?>"  disabled  readonly data-dayno="23"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_23" >
      <input type="text" name="shift23_<?php echo e($key); ?>" id="shift23_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_23_DESC); ?>"  disabled  readonly data-dayno="23" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_23"><input type="text"  name="dayqty23_<?php echo e($key); ?>"   disabled    id="dayqty23_<?php echo e($key); ?>"  data-dayno="23"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_23); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    

  <td id="tdmachine_24"> 
    <input type="text" name="machine24_<?php echo e($key); ?>" id="machine24_txtMachine_popup_<?php echo e($key); ?>" value="<?php echo e($row->MACH_24_DESC); ?>"  disabled    readonly data-dayno="24"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_24" >
      <input type="text" name="shift24_<?php echo e($key); ?>" id="shift24_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_24_DESC); ?>"  disabled   readonly data-dayno="24" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_24"><input type="text"  name="dayqty24_<?php echo e($key); ?>"   disabled    id="dayqty24_<?php echo e($key); ?>"  data-dayno="24"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_24); ?>" style="width:130px;" autocomplete="off"  /></td>
  

    
  <td id="tdmachine_25"> 
    <input type="text" name="machine25_<?php echo e($key); ?>" id="machine25_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_25_DESC); ?>"  disabled     readonly data-dayno="25"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_25" >
      <input type="text" name="shift25_<?php echo e($key); ?>" id="shift25_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_25_DESC); ?>"  disabled   readonly data-dayno="25" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_25"><input type="text"  name="dayqty25_<?php echo e($key); ?>"   disabled    id="dayqty25_<?php echo e($key); ?>"  data-dayno="25"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_25); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  <td id="tdmachine_26"> 
    <input type="text" name="machine26_<?php echo e($key); ?>" id="machine26_txtMachine_popup_<?php echo e($key); ?>"  value="<?php echo e($row->MACH_26_DESC); ?>"  disabled   readonly data-dayno="26"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_26" >
      <input type="text" name="shift26_<?php echo e($key); ?>" id="shift26_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_26_DESC); ?>"  disabled   readonly data-dayno="26" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_26"><input type="text"  name="dayqty26_<?php echo e($key); ?>"   disabled    id="dayqty26_<?php echo e($key); ?>"  data-dayno="26"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_26); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  <td id="tdmachine_27"> 
    <input type="text" name="machine27_<?php echo e($key); ?>" id="machine27_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_27_DESC); ?>"  disabled   readonly data-dayno="27"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_27" >
      <input type="text" name="shift27_<?php echo e($key); ?>" id="shift27_txtLISTPOP_popup_<?php echo e($key); ?>"   value="<?php echo e($row->SHFT_27_DESC); ?>"  disabled   readonly data-dayno="27" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_27"><input type="text"  name="dayqty27_<?php echo e($key); ?>"   disabled    id="dayqty27_<?php echo e($key); ?>"  data-dayno="27"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_27); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  
  <td id="tdmachine_28"> 
    <input type="text" name="machine28_<?php echo e($key); ?>" id="machine28_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_28_DESC); ?>"  disabled   readonly data-dayno="28"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_28" >
      <input type="text" name="shift28_<?php echo e($key); ?>" id="shift28_txtLISTPOP_popup_<?php echo e($key); ?>"   value="<?php echo e($row->SHFT_28_DESC); ?>"  disabled    readonly data-dayno="28" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_28"><input type="text"  name="dayqty28_<?php echo e($key); ?>"   disabled    id="dayqty28_<?php echo e($key); ?>"  data-dayno="28"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_28); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  
  <td id="tdmachine_29"> 
    <input type="text" name="machine29_<?php echo e($key); ?>" id="machine29_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_29_DESC); ?>"  disabled    readonly data-dayno="29"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_29" >
      <input type="text" name="shift29_<?php echo e($key); ?>" id="shift29_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_29_DESC); ?>"  disabled    readonly data-dayno="29" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_29"><input type="text"  name="dayqty29_<?php echo e($key); ?>"   disabled    id="dayqty29_<?php echo e($key); ?>"  data-dayno="29"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_29); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  <td id="tdmachine_30"> 
    <input type="text" name="machine30_<?php echo e($key); ?>" id="machine30_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_30_DESC); ?>"  disabled    readonly data-dayno="30"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_30" >
      <input type="text" name="shift30_<?php echo e($key); ?>" id="shift30_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_30_DESC); ?>"  disabled    readonly data-dayno="30" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_30"><input type="text"  name="dayqty30_<?php echo e($key); ?>"   disabled    id="dayqty30_<?php echo e($key); ?>"  data-dayno="30"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_30); ?>" style="width:130px;" autocomplete="off"  /></td>
  
    
  <td id="tdmachine_31"> 
    <input type="text" name="machine31_<?php echo e($key); ?>" id="machine31_txtMachine_popup_<?php echo e($key); ?>"   value="<?php echo e($row->MACH_31_DESC); ?>"  disabled    readonly data-dayno="31"  class="form-control"  style="width:140px;"  />
  </td>
  ...
  <td id="tdshift_31" >
      <input type="text" name="shift31_<?php echo e($key); ?>" id="shift31_txtLISTPOP_popup_<?php echo e($key); ?>"  value="<?php echo e($row->SHFT_31_DESC); ?>"  disabled    readonly data-dayno="31" class="form-control" style="width:140px;"  />
  </td>
  ...
  <td id="tdday_qty_31"><input type="text"  name="dayqty31_<?php echo e($key); ?>"   disabled    id="dayqty31_<?php echo e($key); ?>"  data-dayno="31"   class="form-control three-digits" maxlength="13" value="<?php echo e($row->QTY_31); ?>" style="width:130px;" autocomplete="off"  /></td>
  
  
  
  <td align="center" ><button class="btn add material" title="add" data-toggle="tooltip" disabled type="button" ><i class="fa fa-plus"></i></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ManualProductionPlan\trnfrm229view.blade.php ENDPATH**/ ?>