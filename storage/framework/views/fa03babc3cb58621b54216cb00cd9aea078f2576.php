            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Target Type</p></div>
                            <div class="col-lg-3 pl">
...
$('#btnView').on('click', function() {
        ...
        else if(TARGET_TYPE  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Target Type.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesTargetActualReport\rptfrm521.blade.php ENDPATH**/ ?>