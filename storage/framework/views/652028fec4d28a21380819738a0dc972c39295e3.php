...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[40,'index'])); ?>" class="btn singlebt">Open Sales Order (OSO)</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_oso"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objOSO->OSOID[0]) ? method_field('PUT') : ''); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="OSONO" id="OSONO" value="<?php echo e(isset($objOSO->OSONO)?$objOSO->OSONO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>SO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="OSODT" id="OSODT" value="<?php echo e(isset($objOSO->OSODT)?$objOSO->OSODT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="<?php echo e(isset($objOSO->SLID_REF)?$objOSO->SLID_REF:''); ?>"/>
                                <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objOSO->GLID_REF)?$objOSO->GLID_REF:''); ?>" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objOSO->OVFDT)?$objOSO->OVFDT:''); ?>" >
                            </div>                            
                            <div class="col-lg-2 pl"><p>To </p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objOSO->OVTDT)?$objOSO->OVTDT:''); ?>" >
                            </div>
                            <div class="col-lg-2 pl"><p>Customer PO No*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" value="<?php echo e(isset($objOSO->CUSTOMERPONO)?$objOSO->CUSTOMERPONO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  >
                            </div>                            
                        </div>                        
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Customer PO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="CUSTOMERPODT" id="CUSTOMERPODT" value="<?php echo e(isset($objOSO->CUSTOMERPODT)?$objOSO->CUSTOMERPODT:''); ?>"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SPID_REF" id="SPID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objOSO->SPID_REF)?$objOSO->SPID_REF:''); ?>" />
                            </div>
                            <div class="col-lg-2 pl"><p>Ref No </p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objOSO->REFNO)?$objOSO->REFNO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="checkbox" name="OSOFC" id="OSOFC" class="form-checkbox" <?php echo e(isset($objOSO->OSOFC) && $objOSO->OSOFC == 1 ? 'checked' : ''); ?> >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Currency</p></div>
                            <div class="col-lg-2 pl" id="divcurrency" >
                                <?php if($objOSOcurrency): ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objOSOcurrency)?$objOSOcurrency:''); ?>"   />
                                <?php else: ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                                <?php endif; ?>
                                <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objOSO->CRID_REF)?$objOSO->CRID_REF:''); ?>" />
                            </div>
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <?php if($objOSOcurrency): ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="CONVFACT" id="CONVFACT" class="form-control"  autocomplete="off" value="<?php echo e(isset($objOSO->CONVFACT)?$objOSO->CONVFACT:''); ?>"   />
                                <?php else: ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e(isset($objOSO->REMARKS)?$objOSO->REMARKS:''); ?>"  >
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                            ...
                                            <?php if(!empty($objOSOMAT)): ?>
                                                <?php $__currentLoopData = $objOSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        <td hidden>
                                                        <input <?php echo e($InputStatus); ?>  class="form-control" type="hidden" name=<?php echo e("OSOMATID_".$key); ?> id =<?php echo e("OSOMATID_".$key); ?> maxlength="100" value="<?php echo e($row->OSOMATID); ?>" autocomplete="off"   >
                                                        </td>
                                                        ...
                                                        <td><input  <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUOM_".$key); ?> id=<?php echo e("popupUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupUOM); ?>" readonly/></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("UOMID_REF_".$key); ?> id=<?php echo e("UOMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->UOMID_REF); ?>" autocomplete="off" /></td>
                                                        <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ITEMSPECI_".$key); ?> id=<?php echo e("ITEMSPECI_".$key); ?> class="form-control" maxlength="200"  autocomplete="off"  value="<?php echo e($row->ITEMSPECI); ?>"/></td>
                                                        <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATEPUOM); ?>"  autocomplete="off" /></td>
                                                        <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("RMK_".$key); ?> id=<?php echo e("RMK_".$key); ?> class="form-control" maxlength="200" autocomplete="off"  value="<?php echo e($row->REMARKS); ?>"/></td>
                                                        <td align="center">
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <?php if(!empty($objOSOTNC)): ?>
                                         <input type="hidden" name="TNCID_REF" id="TNCID_REF" class="form-control" value="<?php echo e($objOSOTNC[0]->TNCID_REF); ?>" autocomplete="off" />
                                         <?php else: ?>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:50%;">
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody id="tncbody">
                                            <?php if(!empty($objOSOTNC)): ?>
                                                <?php $__currentLoopData = $objOSOTNC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Tkey => $Trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(!empty($objOSOUDF)): ?>
                                            <?php $__currentLoopData = $objOSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUDFID_".$Ukey); ?> id=<?php echo e("popupUDFID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFID_REF_".$Ukey); ?>  id=<?php echo e("UDFID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->SOUDFID_REF); ?>" autocomplete="off" /></td>
                                            ...
                                            <?php $__currentLoopData = $objUdfOSOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUDFID_".$uindex); ?> id=<?php echo e("popupUDFID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
      ...
      $(".clstncid").click(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[40,"gettncdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[40,"gettncdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[40,"gettncdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
$(document).ready(function(e) {
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '<?php echo e(route("transaction",[40,"add"])); ?>';
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[40,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[40,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[40,"index"])); ?>';
});
...
$('#btnPdf').on('click', function() {
  var SONO = objOSO.OSOID;
  var Flag = 'P';
  var formData = 'SO='+ SONO + '&OSONO='+ SONO + '&Flag='+ Flag ;
  var consultURL = '<?php echo e(route("transaction",[40,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[40,"ViewReport"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\OpenSalesOrder\trnfrm40view.blade.php ENDPATH**/ ?>