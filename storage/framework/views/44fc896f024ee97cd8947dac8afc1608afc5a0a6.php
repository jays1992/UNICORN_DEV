            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <?php if(isset($objOSON->SYSTEM_GRSR) && $objOSON->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="OSONO" id="OSONO" value="<?php echo e(isset($objOSONO)?$objOSONO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            <?php elseif(isset($objOSON->MANUAL_SR) &&  $objOSON->MANUAL_SR == "1"): ?>
                                <input type="text" name="OSONO" id="OSONO" class="form-control mandatory" maxlength="<?php echo e(isset($objOSON->MANUAL_MAXLENGTH)?$objOSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                            <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OSODT" id="OSODT" value="<?php echo e(old('OSODT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <?php $__currentLoopData = $objUdfOSOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name=<?php echo e("popupUDFID_".$uindex); ?> id=<?php echo e("popupUDFID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
...
//add row
    ...
    window.fnUndoYes = function (){
      //reload form
      window.location.href = "<?php echo e(route('transaction',[40,'add'])); ?>";
   }//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[40,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\OpenSalesOrder\trnfrm40add.blade.php ENDPATH**/ ?>