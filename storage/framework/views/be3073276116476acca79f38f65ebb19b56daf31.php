    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <th>Earning Head Code</th>
                <th>Description</th>
                <th>Earning Head Type</th>
                <th>GL Name</th>
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->EARNING_HEADID); ?>" value="<?php echo e($val->EARNING_HEADID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->EARNING_HEADCODE) && $val->EARNING_HEADCODE !=''?$val->EARNING_HEADCODE:''); ?></td>
                <td><?php echo e(isset($val->EARNING_HEAD_DESC) && $val->EARNING_HEAD_DESC !=''?$val->EARNING_HEAD_DESC:''); ?></td>
                <td><?php echo e(isset($val->EARNING_TYPE_DESC) && $val->EARNING_TYPE_DESC !=''?$val->EARNING_TYPE_DESC:''); ?></td>
        ...
        <form id="masterForm186Print" action="<?php echo e(route('mastergetlist',[186,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[186,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[186,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[186,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[186,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[186,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EarningHead\mstfrm186.blade.php ENDPATH**/ ?>