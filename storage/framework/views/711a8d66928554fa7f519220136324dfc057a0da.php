...
<div class="container-fluid topnav">
	<div class="row">
		<div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Preventive Maintenance <br/> Schedule</a></div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input disabled type="text" name="PMSL_NO" id="PMSL_NO" VALUE="<?php echo e(isset($HDR->PMSL_NO)?$HDR->PMSL_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>Schedule Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="PMSL_DATE" id="PMSL_DATE" VALUE="<?php echo e(isset($HDR->PMSL_DATE)?$HDR->PMSL_DATE:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>

            <div class="col-lg-2 pl"><p>Machine Code</p></div>
			      <div class="col-lg-2 pl">
              <input disabled type="text" name="MACHINEID_REF_popup" id="txtMACHINEID_REF_popup" VALUE="<?php echo e(isset($HDR->MACHINE_NO)?$HDR->MACHINE_NO:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Machine Description</p></div>
			      <div class="col-lg-2 pl">
              <input disabled type="text" name="MACHINEID_DESC" id="MACHINEID_DESC" VALUE="<?php echo e(isset($HDR->MACHINE_DESC)?$HDR->MACHINE_DESC:''); ?>" class="form-control"  autocomplete="off" readonly />
			      </div>
            ...
            <div class="col-lg-2 pl">
                <select disabled name="FLEXIBLE_SCHEDULE" id="FLEXIBLE_SCHEDULE"  class="form-control" autocomplete="off"  > 
                  ...
                  <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="50%" style="height:auto !important;">
                    ...
                    <tbody>
                      ...
                      <tr  class="participantRow">
                        ...
                        <td><input disabled type="date"   name="PMSL_FROM_DATE_<?php echo e($key); ?>" id="PMSL_FROM_DATE_<?php echo e($key); ?>" value="<?php echo e(isset($row->PMSL_FROM_DATE)?$row->PMSL_FROM_DATE:''); ?>"  class="form-control"   autocomplete="off" style="width:200px;"  /></td>
                        <td><input disabled type="date"   name="PMSL_TO_DATE_<?php echo e($key); ?>" id="PMSL_TO_DATE_<?php echo e($key); ?>"     value="<?php echo e(isset($row->PMSL_TO_DATE)?$row->PMSL_TO_DATE:''); ?>" class="form-control"   autocomplete="off" style="width:200px;"  /></td>
                        <td><input disabled type="text"   name="SPECIAL_INST_<?php echo e($key); ?>" id="SPECIAL_INST_<?php echo e($key); ?>"     value="<?php echo e(isset($row->SPECIAL_INST)?$row->SPECIAL_INST:''); ?>" class="form-control"   autocomplete="off" style="width:200px;"   /></td>
                  ...
                  <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="50%" style="height:auto !important;">
                    ...
                    <tbody>
                      ...
                      <tr  class="participantRow2">
                        ...
                        <td><input disabled type="text"   name="PMSL_ID_REF_<?php echo e($key); ?>" id="PMSL_ID_REF_<?php echo e($key); ?>" value="<?php echo e($key+1); ?>" class="form-control"   autocomplete="off" style="width:200px;" readonly  /></td>
                        <td><input disabled type="text"   name="SPARE_PART_NAME_<?php echo e($key); ?>" id="SPARE_PART_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->SPARE_PART_NAME)?$row->SPARE_PART_NAME:''); ?>"   class="form-control"   autocomplete="off" style="width:200px;"  /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\Preventive_Maintenance_Schedule\trnfrm366view.blade.php ENDPATH**/ ?>