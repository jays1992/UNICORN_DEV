...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Job Work Invoice (JWI)</a>
                </div>
...
<div class="container-fluid filter">
    <form id="edit_trn_form"  method="POST"> 
      <?php echo csrf_field(); ?>
      <?php echo e(isset($OBJ_HDR->JWIID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="JWINO" id="JWINO" value="<?php echo e($OBJ_HDR->JWINO); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
        </div>
        <div class="col-lg-2 pl"><p>JWI Doc Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="JWIDT" id="JWIDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($OBJ_HDR->JWIDT); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-2 pl"><p>Department</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="txtdepartment" id="txtdepartment" class="form-control" value="<?php echo e($OBJ_HDR_DEP->DCODE); ?>-<?php echo e($OBJ_HDR_DEP->NAME); ?>"  readonly  />
                <input type="hidden" name="DEPID_REF" id="DEPID_REF" value="<?php echo e($OBJ_HDR->DEPARTMENTID_REF); ?>"  class="form-control " />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="txtvendor" id="txtvendor" class="form-control" value="<?php echo e($OBJ_HDR_VID->VCODE); ?>-<?php echo e($OBJ_HDR_VID->NAME); ?>" readonly  />
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="<?php echo e($OBJ_HDR->VID_REF); ?>" />
        </div>

        <div class="col-lg-2 pl"><p> Vendor Invoice No</p></div> 
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="<?php echo e($OBJ_HDR->VENDOR_INVOICENO); ?>" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p> Date</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="<?php echo e($OBJ_HDR->VENDOR_INVOICEDT); ?>" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_billto">
            ...
            <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e($OBJ_HDR->BILL_TO); ?>" />
        </div>
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            ...
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e($OBJ_HDR->SHIP_TO); ?>" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" value="<?php echo e($TAXSTATE[0]); ?>" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="<?php echo e($OBJ_HDR->REMARKS); ?>" maxlength="200"  >
        </div>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:320px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    <thead id="thead1"  style="position: sticky;top: 0">
                          <tr>
                              <th>GRN No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>" /></th>
                              <th>Item Code</th>
                              <th>Item Name</th>
                              <th>Main UOM</th>
                              <th>Received Qty</th>
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      <?php $__currentLoopData = $objPBMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr  class="participantRow">
                              ...
                              <input <?php echo e($ActionStatus); ?> type="text" name="txtGRN_NO_<?php echo e($key); ?>" id="txtGRN_NO_<?php echo e($key); ?>" value="<?php echo e(isset($row->GRNNO)?$row->GRNNO:''); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                              <td hidden><input type="hidden" name="GRJID_REF_<?php echo e($key); ?>" id="GRJID_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->GRJID_REF)?$row->GRJID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                              
                              <td hidden><input type="text" name="JWCID_REF_<?php echo e($key); ?>" id="JWCID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->JWCID_REF)?$row->JWCID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="JWOID_REF_<?php echo e($key); ?>" id="JWOID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->JWOID_REF)?$row->JWOID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="PROID_REF_<?php echo e($key); ?>" id="PROID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row->PROID_REF)?$row->PROID_REF:''); ?>" class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SOID_REF_<?php echo e($key); ?>"  id="SOID_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->SOID_REF)?$row->SOID_REF:''); ?>"  class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SQID_REF_<?php echo e($key); ?>"  id="SQID_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->SQID_REF)?$row->SQID_REF:''); ?>"  class="form-control" autocomplete="off" /></td>
                              <td hidden><input type="text" name="SEID_REF_<?php echo e($key); ?>"  id="SEID_REF_<?php echo e($key); ?>"  value="<?php echo e(isset($row->SEID_REF)?$row->SEID_REF:''); ?>"  class="form-control" autocomplete="off" /></td>
                              ...
                              <td hidden><input type="hidden" name=<?php echo e("ITEMID_REF_".$key); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->ITEMID_REF); ?>" autocomplete="off" style="width:100px;"  /></td>
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("txtUOM_".$key); ?> id=<?php echo e("txtUOM_".$key); ?> class="form-control" maxlength="15" value="<?php echo e($row->MAIN_UOM_CODE); ?>" autocomplete="off"  readonly style="width:130px;"  /></td>
                              <td hidden><input type="hidden" name=<?php echo e("UOMID_REF_".$key); ?> id=<?php echo e("UOMID_REF_".$key); ?> class="form-control" value="<?php echo e($row->UOMID_REF); ?>" autocomplete="off" style="width:100px;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("RECEIVED_QTY_".$key); ?> id=<?php echo e("RECEIVED_QTY_".$key); ?> class="form-control three-digits" value="<?php echo e($row->RECV_QTY); ?>" maxlength="15"  autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              
                              <td hidden><input type="text" name=<?php echo e("txtALTUOM_".$key); ?> id=<?php echo e("txtALTUOM_".$key); ?> class="form-control" maxlength="15"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              <td hidden><input type="hidden" name=<?php echo e("ALT_UOMID_REF_".$key); ?> id=<?php echo e("ALT_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" /></td>
                              <td hidden><input type="text" name=<?php echo e("RECEIVED_ALT_QTY_".$key); ?> id=<?php echo e("RECEIVED_ALT_QTY_".$key); ?> class="form-control three-digits"  maxlength="15"  autocomplete="off" readonly style="width:100px;"  /></td>
                              
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("BILL_QTY_".$key); ?> id=<?php echo e("BILL_QTY_".$key); ?> class="form-control three-digits" maxlength="15" value="<?php echo e($row->BILL_QTY); ?>"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                              
                              <td hidden><input type="text" name=<?php echo e("txtBILLUOM_".$key); ?> id=<?php echo e("txtBILLUOM_".$key); ?> class="form-control" maxlength="15"  autocomplete="off"  readonly style="width:100px;"  /></td>
                              <td hidden><input type="hidden" name=<?php echo e("BILL_UOMID_REF_".$key); ?> id=<?php echo e("BILL_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" style="width:100px;"  /></td>
                              
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ItemDesc_".$key); ?> id=<?php echo e("ItemDesc_".$key); ?> class="form-control" value="<?php echo e($row->ITEM_SPECI); ?>" autocomplete="off"  style="width:150px;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("BILL_RATEPUOM_".$key); ?> id=<?php echo e("BILL_RATEPUOM_".$key); ?> class="form-control five-digits blurRate" value="<?php echo e($row->BILL_RATE); ?>" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;"   /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("DISC_PER_".$key); ?> id=<?php echo e("DISC_PER_".$key); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($row->DISC_PER); ?>" autocomplete="off"  style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("DISC_AMT_".$key); ?> id=<?php echo e("DISC_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($row->DISC_AMT); ?>" autocomplete="off" style="width:130px;text-align:right;"   /></td>
                              ...
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("IGST_AMT_".$key); ?> id=<?php echo e("IGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($IGSTAMT); ?>" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("CGST_AMT_".$key); ?> id=<?php echo e("CGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($CGSTAMT); ?>" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($row->SGST); ?>"  autocomplete="off"  readonly style="width:130px;text-align:right;"  /></td>
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SGST_AMT_".$key); ?> id=<?php echo e("SGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($SGSTAMT); ?>" autocomplete="off" readonly style="width:130px;text-align:right;"  /></td>
                    ...
                    <?php if(!empty($objPBUDF)): ?>
                      <?php $__currentLoopData = $objPBUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDFJWIID_".$Ukey); ?> id=<?php echo e("popupUDFJWIID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDFJWIID_REF_".$Ukey); ?>  id=<?php echo e("UDFJWIID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFJWIID_REF); ?>" autocomplete="off" /></td>
                      ...
                      <?php if($objUdfPBData): ?>
                        <?php $__currentLoopData = $objUdfPBData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupUDFJWIID_".$uindex); ?> id=<?php echo e("popupUDFJWIID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDFJWIID_REF_".$uindex); ?> id=<?php echo e("UDFJWIID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFJWIID); ?>" autocomplete="off"   /></td>
                        ...
                        <?php else: ?>
                          <tr  class="participantRow4">
                              <td><input <?php echo e($ActionStatus); ?> type="text" name="popupUDFJWIID_0" id="popupUDFJWIID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
...
if(JWINO ===""){
  ...
  var focustext12  = "";
      ...
      if(jQuery.inArray("false", allblank) !== -1){
        ...
        else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#JWIDT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkInvoice\trnfrm359edit.blade.php ENDPATH**/ ?>