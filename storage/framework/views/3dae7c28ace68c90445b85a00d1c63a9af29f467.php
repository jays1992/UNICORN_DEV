...
<div class="container-fluid topnav">
  <div class="row">
    ...
    <div class="col-lg-10 topnav-pd">
      ...
      <button class="btn topnavbt" id="btnBarcode" <?php echo e(isset($objRights->VIEW) && $objRights->VIEW != 1 ? 'disabled' : ''); ?> ><i class="fa fa-barcode"></i> Barcode</button>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->BRCID); ?>" value="<?php echo e($val->BRCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->BRC_NO) && $val->BRC_NO !=''?$val->BRC_NO:''); ?></td>
                <td><?php echo e(isset($val->BRC_DT) && $val->BRC_DT !='' && $val->BRC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BRC_DT)):''); ?></td>
                <td><?php echo e(isset($val->SOURCE_TYPE) && $val->SOURCE_TYPE !=''?$val->SOURCE_TYPE:''); ?></td>
...
$('#btnBarcode').on('click', function(){
  ...
  if(seletedRecord==0){
    ...
    $("#OkBtn1").focus();
      ...
      var viweRecordId = resultIdsData[0];
      var viewURL = '<?php echo e(route("transaction",[$FormId,"barcode",":rcdId"])); ?>';
          viewURL = viewURL.replace(":rcdId",viweRecordId);
          window.location.href=viewURL;
  }
});
...
$('#btnImport').on('click', function(){
  window.location.href='<?php echo e(route("transaction",[418,"importdata"])); ?>';
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\Barcode\trnfrm418.blade.php ENDPATH**/ ?>