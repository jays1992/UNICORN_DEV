...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Quality Inspection Master</a></div>
  ...
  <div class="multiple table-responsive  ">
    ...
    <thead id="thead1">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->QICID); ?>" value="<?php echo e($val->QICID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->QICNO) && $val->QICNO !=''?$val->QICNO:''); ?></td>
          <td><?php echo e(isset($val->QICDT) && $val->QICDT !='' && $val->QICDT !='1900-01-01' ? date('d-m-Y',strtotime($val->QICDT)):''); ?></td>
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&QICID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\QualityInspectionMaster\mstfrm361.blade.php ENDPATH**/ ?>