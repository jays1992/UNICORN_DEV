...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
            ...
            <input type="text" name="BASIS_DOC_NO" id="BASIS_DOC_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="BASIS_DOC_DT" id="BASIS_DOC_DT" value="<?php echo e(old('BASIS_DOC_DT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('master',[199,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("master",[199,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
function highlighFocusBtn(pclass){
      ...
      function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[199,"codeduplicate"])); ?>',
            type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\Calculation_Basis\mstfrm199add.blade.php ENDPATH**/ ?>