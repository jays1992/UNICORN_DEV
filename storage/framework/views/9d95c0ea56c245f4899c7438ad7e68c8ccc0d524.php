...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('report',[376,'index'])); ?>" class="btn singlebt">Sales Service Invoice Print</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pop"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">
                            <div class="col-lg-3 pl"><p>Sales Service Invoice Number</p></div>
                            <div class="col-lg-3 pl">
                                <select name="SSI_NO" id="SSI_NO" class="form-control mandatory">
                                    <option value="">select</option>
                                    <?php $__currentLoopData = $ObjSSI; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SSIID); ?>" ><?php echo e($Row->SSI_NO); ?></option>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[376,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'<?php echo e(route("report",[376,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SSIPrint\rptfrm376.blade.php ENDPATH**/ ?>