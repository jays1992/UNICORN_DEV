          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> <?php echo e($objResponse->ACTIVITYCODE); ?> </label>
                    <input type="hidden" name="ACTIVITYCODE" id="ACTIVITYCODE" value="<?php echo e($objResponse->ID); ?>" />
                    <input type="hidden" name="ACTIVITYCODE" id="ACTIVITYCODE" value="<?php echo e($objResponse->ACTIVITYCODE); ?>" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="ACTIVITYNAME" id="ACTIVITYNAME" class="form-control mandatory" value="<?php echo e(old('ACTIVITYNAME',$objResponse->ACTIVITYNAME)); ?>" maxlength="200" tabindex="1"  />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\ActivityType\mstfrm429edit.blade.php ENDPATH**/ ?>