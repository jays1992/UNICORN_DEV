<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SALARYPRID); ?>" value="<?php echo e($val->SALARYPRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DOCDATE) && $val->DOCDATE !=''?$val->DOCDATE:''); ?>" ></td>
              <td><?php echo e(isset($val->DOCNO) && $val->DOCNO !=''?$val->DOCNO:''); ?></td>
              <td><?php echo e(isset($val->DOCDATE) && $val->DOCDATE !=''?$val->DOCDATE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\SalaryProcess\trnfrm427.blade.php ENDPATH**/ ?>