...
<!-- <form id="frm_mst_edit" onsubmit="return validateForm()"  method="POST"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[110,'index'])); ?>" class="btn singlebt">UDF for Material Issue Slip<br/> (PMIS)</a>
                </div><!--col-2-->
    ...
    <?php echo csrf_field(); ?>
          ...
          <?php echo e(isset($objUdfResponse->UDFPMISID[0]) ? method_field('PUT') : ''); ?>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <?php $__currentLoopData = $objUdfResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr  class="participantRow">
                        <td hidden>
                        <input  class="form-control" type="hidden" name=<?php echo e("UDFPMISID_".$key); ?> id =<?php echo e("txtID_".$key); ?> maxlength="100" value="<?php echo e($row->UDFPMISID); ?>" autocomplete="off"   >
                        </td>
                        <td>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[110,"add"])); ?>';
...
window.fnSaveData = function (){
            ...
            event.preventDefault();
                            ...
                            $.ajax({
                                url:'<?php echo e(route("mastermodify",[110,"update"])); ?>',
                                type:'POST',
                                data:formData,
                                success:function(data) {
                                    ...
                                    if(data.success) {                   
                                        ...
                                        // window.location.href="<?php echo e(route('master',[110,'index'])); ?>";
                                    }
                                    else if(data.cancel) {                   
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[110,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\UDFPMIS\mstfrm110edit.blade.php ENDPATH**/ ?>