<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->TAXID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <div class="col-lg-12 pl">
                    <label><?php echo e($objResponse->TTCODE); ?></label>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <label><?php echo e($objResponse->TTDESCRIPTION); ?></label>
                </div>
              </div>	
              ...
              <div class="row">
                <div class="col-lg-2 pl"><p>Type</p></div>
                  ...
                  <div class="col-lg-1 pl pr">
                    <input type="radio" name="IGST_TYPE" value="IGST" id="IGST_TYPE"  tabindex="3" <?php if($objResponse->TAX_TYPE=="IGST"): ?> checked <?php endif; ?> disabled />
                    <input type="hidden" name="TAX_TYPE" id="TAX_TYPE" value="<?php echo e($objResponse->TAX_TYPE); ?>" />
                  </div>
                  <div class="col-lg-1 pl"><p>CGST</p></div>
                  <div class="col-lg-1 pl pr">
                    <input type="radio" name="CGST_TYPE" value="CGST" id="CGST_TYPE"  tabindex="4" <?php if($objResponse->TAX_TYPE=="CGST"): ?> checked <?php endif; ?> disabled />
                  </div>
                  <div class="col-lg-1 pl"><p>SGST</p></div>
                  <div class="col-lg-1 pl pr">
                    <input type="radio" name="SGST_TYPE" value="SGST" id="SGST_TYPE"  tabindex="5" <?php if($objResponse->TAX_TYPE=="SGST"): ?> checked <?php endif; ?> disabled />
                  </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="SALE_WITHINSTATE" id="SALE_WITHINSTATE" <?php if($FOR_SALE==1 && $WITHINSTATE==1): ?> checked <?php endif; ?> tabindex="3" disabled>
                </div>
                
                <div class="col-lg-1 pl"><p>Out of State</p></div>
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="SALE_OUTOFSTATE" id="SALE_OUTOFSTATE" tabindex="4"  <?php if($FOR_SALE==1 && $OUTOFSTATE==1): ?>  checked <?php endif; ?> disabled> 
                </div>
                
                <div class="col-lg-1 pl"><p>EXPORT</p></div>
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="SALE_EXPORT" id="SALE_EXPORT" tabindex="5" <?php if($FOR_SALE==1 && $EXPORT ==1): ?> checked <?php endif; ?> disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl "><p>Within State</p></div>
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="PURCHASE_WITHINSTATE" id="PURCHASE_WITHINSTATE" tabindex="6" <?php if($FOR_PURCHASE==1 && $WITHINSTATE==1): ?> checked <?php endif; ?> disabled>
                </div>
                
                <div class="col-lg-1 pl"><p>Out of State</p></div>
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="PURCHASE_OUTOFSTATE" id="PURCHASE_OUTOFSTATE" tabindex="7" <?php if($FOR_PURCHASE==1 && $OUTOFSTATE==1): ?> checked  <?php endif; ?> disabled>
                </div>
                
                <div class="col-lg-1 pl"><p>Import</p></div>
                <div class="col-lg-1 pl pr">
                  <input type="radio" name="TAX_FOR" value="PURCHASE_IMPORT" id="PURCHASE_IMPORT" tabindex="8" <?php if($FOR_PURCHASE==1 && $EXPORT==1): ?> checked <?php endif; ?> disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <label><?php echo e($objOldGSTSLList->GLCODE); ?> - <?php echo e($objOldGSTSLList->GLNAME); ?></label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-1 pl"><p>GL</p></div>
                <div class="col-lg-2 pl">
                  <label><?php echo e($objOldREVSLList->GLCODE); ?> - <?php echo e($objOldREVSLList->GLNAME); ?></label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-1 pl"><p>GL</p></div>
                <div class="col-lg-2 pl">
                  <label><?php echo e($SALE_GLID_REF_LABEL); ?></label>
                </div>
                <div class="col-lg-1 pl col-md-offset-2"><p>GL</p></div>
                <div class="col-lg-2 pl">
                  <label><?php echo e($SALERETURN_GLID_REF_LABEL); ?></label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-1 pl"><p>GL</p></div>
                <div class="col-lg-2 pl">
                  <label><?php echo e($PURCHASE_GLID_REF_LABEL); ?></label>
                </div>
                
                <div class="col-lg-1 pl col-md-offset-2"><p>GL</p></div>
                <div class="col-lg-2 pl">
                  <label><?php echo e($PURCHASERETURN_GLID_REF_LABEL); ?></label>
                </div>
              </div> -->
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl pr">
                <input type="checkbox" name="DEACTIVATED" name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?>   value='<?php echo e($objResponse->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="14"  disabled>
                </div>
                ...
                <div class="col-lg-8 pl">
                  ...
                  <?php echo e($objResponse->DEACTIVATED == 1 ? "" : "disabled"); ?>

                     tabindex="8" value="<?php echo e((!is_null($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED!='1900-01-01')? 
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="GSTGL_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="gstglidref_<?php echo e($GSTGLList->GLID); ?>" class="cls_gstglidref">
          <td width="50%"><?php echo e($GSTGLList->GLCODE); ?>
          ...
          <td><?php echo e($GSTGLList->GLNAME); ?></td>
        </tr>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="SALEGL_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="saleglidref_<?php echo e($SALEGLList->GLID); ?>" class="cls_saleglidref">
          <td width="50%"><?php echo e($SALEGLList->GLCODE); ?>
          ...
          <td><?php echo e($SALEGLList->GLNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="SALERETGL_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objSALEGLList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$SALEGLList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="saleretglidref_<?php echo e($SALEGLList->GLID); ?>" class="cls_saleretglidref">
          <td width="50%"><?php echo e($SALEGLList->GLCODE); ?>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="PURGL_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="purglidref_<?php echo e($PurRow->GLID); ?>" class="cls_purglidref">
          <td width="50%"><?php echo e($PurRow->GLCODE); ?>
          ...
          <td><?php echo e($PurRow->GLNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="PURRETGL_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objPURGLList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$PurRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="purretglidref_<?php echo e($PurRow->GLID); ?>" class="cls_purretglidref">
          <td width="50%"><?php echo e($PurRow->GLCODE); ?>
...
//-----------
  ...
  $('#btnExit').on('click', function() {
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[139,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[139,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
        window.location.href = '<?php echo e(route("master",[139,"index"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\TaxType\mstfrm139view.blade.php ENDPATH**/ ?>