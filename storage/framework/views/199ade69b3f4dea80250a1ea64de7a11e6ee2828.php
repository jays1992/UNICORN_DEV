<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Opportunity Stage</a>
                </div>
          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> <?php echo e($objResponse->OPPORTUNITY_STAGECODE); ?> </label>
                    <input type="hidden" name="OPPORTUNITY_STAGECODE" id="OPPORTUNITY_STAGECODE" value="<?php echo e($objResponse->ID); ?>" />
                    <input type="hidden" name="OPPORTUNITY_STAGECODE" id="OPPORTUNITY_STAGECODE" value="<?php echo e($objResponse->OPPORTUNITY_STAGECODE); ?>" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="OPPORTUNITY_STAGENAME" id="OPPORTUNITY_STAGENAME" class="form-control mandatory" value="<?php echo e(old('OPPORTUNITY_STAGENAME',$objResponse->OPPORTUNITY_STAGENAME)); ?>" maxlength="200" tabindex="1"  />
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="COMPLETE_PERCENT" id="COMPLETE_PERCENT" onkeypress="return onlyNumberKey(event)" class="form-control mandatory" value="<?php echo e(old('COMPLETE_PERCENT',$objResponse->COMPLETE_PERCENT)); ?>" maxlength="200" tabindex="2"  />
                  </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\OpportunityStage\mstfrm437edit.blade.php ENDPATH**/ ?>