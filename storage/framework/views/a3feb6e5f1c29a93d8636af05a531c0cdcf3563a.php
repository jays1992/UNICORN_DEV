            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <input type="text" name="LOB_NO" id="LOB_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >

                              
                            </div>
                            <div class="col-lg-2 pl"><p>LOB Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="LOB_DT" id="LOB_DT" value="<?php echo e(old('LOB_DT')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
...
$.ajax({
    url:'<?php echo e(route("master",[390,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveOpeningBalance\mstfrm390add.blade.php ENDPATH**/ ?>