       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl">
                <input type="text" name="ASTCODENO" id="ASTCODENO" value="<?php echo e($HDR->ASSETNOCODE); ?>" class="form-control" maxlength="100">
               </div>

               <div class="col-lg-2 pl"><p>Asset Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATES" id="ASTDATES" value="<?php echo e($HDR->ASSETNODATE); ?>" class="form-control" maxlength="100">
                 </div>

               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="<?php echo e($HDR->ASSETCODE); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASSETID_REF" id="ASCATID" value="<?php echo e($HDR->ASSETID); ?>" class="form-control" autocomplete="off" />
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTDESCRIPTIONS" id="DESCRIPTIONS" value="<?php echo e($HDR->ASTDES); ?>" class="form-control" readonly="" maxlength="100">
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCATEGRY" id="ASSETCATEGRY" value="<?php echo e($HDR->CATEGORY); ?>" class="form-control mandatory" autocomplete="off" readonly="">
               ...
               <br>
                 ...
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATEPURCH" id="ASTDATEPURCH" value="<?php echo e($HDR->DOP); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Party Name (Supplier)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPARTYNAME" id="ASTPARTYNAME" value="<?php echo e($HDR->PARTYNAME); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Basic Cost</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTBCOST" id="ASTBCOST" value="<?php echo e($HDR->BASICCOST); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPINWARD" id="ASTPINWARD" value="<?php echo e($HDR->FREIGHTINWARD); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Loading & unloading</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTLOADUNLOAD" id="ASTLOADUNLOAD" value="<?php echo e($HDR->LOADUNLOAD); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Custom Duty</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTCUSTDUTY" id="ASTCUSTDUTY" value="<?php echo e($HDR->CUSTOMDUTY); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTCFCHARGE" id="ASTCFCHARGE" value="<?php echo e($HDR->CFCHARGES); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Taxes (GST)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTTAXGST" id="ASTTAXGST" value="<?php echo e($HDR->GST); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other 1</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHER1" id="ASTOTHER1" value="<?php echo e($HDR->OTH1); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHER2" id="ASTOTHER2" value="<?php echo e($HDR->OTH2); ?>" class="form-control amt"  onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTQTY" id="ASTQTY" value="<?php echo e($HDR->QTY); ?>" class="form-control" onkeypress="return onlyNumberKey(event)" maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF1" id="ASTOTHERSPEF1" value="<?php echo e($HDR->OTH_SPEC1); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other Specification 2</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF2" id="ASTOTHERSPEF2" value="<?php echo e($HDR->OTH_SPEC2); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Other Specification 3</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTOTHERSPEF3" id="ASTOTHERSPEF3" value="<?php echo e($HDR->OTH_SPEC3); ?>" class="form-control"  maxlength="100" > 
                 </div>
               </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATEOFMANF" id="ASTDATEOFMANF" value="<?php echo e($HDR->DOM); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Expiry Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTEXPDATE" id="ASTEXPDATE" value="<?php echo e($HDR->EXPIRYDATE); ?>" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTPURVOUCHNO" id="ASTPURVOUCHNO" value="<?php echo e($HDR->PVOUCHERNO); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="ASTDATE" id="ASTDATE" value="<?php echo e($HDR->VDATE); ?>" class="form-control"  maxlength="100" > 
                 </div>                    
               </div>
             </div>
     </form>
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[410,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetNoMaster\mstfrm410edit.blade.php ENDPATH**/ ?>