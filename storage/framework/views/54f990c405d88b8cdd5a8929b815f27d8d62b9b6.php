<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[18,'index'])); ?>" class="btn singlebt">Industry Vertical</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="industryverticalmst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
                <th id="all-check" style="width:50px;"><input type="checkbox" class="js-selectall" data-target=".js-selectall1"  />Select</th>
                <th>Industry Vertical Code</th>
                <th>Descriptions</th>
                <th>Created Date</th>
                <th>De-Activated</th>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->INDSVID); ?>" value="<?php echo e($val->INDSVID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->INDSVCODE) && $val->INDSVCODE !=''?$val->INDSVCODE:''); ?></td>
              <td><?php echo e(isset($val->DESCRIPTIONS) && $val->DESCRIPTIONS !=''?$val->DESCRIPTIONS:''); ?></td>
        ...
        <form id="masterForm18Print" action="<?php echo e(route('mastergetlist',[18,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<style>
  #custom_dropdown, #industryverticalmst_filter {
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[18,"add"])); ?>';
  ...
  $(document).ready(function(){
        ...
        // Data table for serverside
         var mstresultTable =  $('#industryverticalmst').DataTable({
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[18,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[18,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[18,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[18,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                            window.location.href="<?php echo e(route('master',[18,'index'])); ?>";
                        }               
                    },
                    error:function(data){
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[18,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\INDUSTRYVERTICAL\mstfrm18.blade.php ENDPATH**/ ?>