                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="hidden" name="SQID_REF" id="SQID_REF" value="<?php echo e(isset($objSQ->SQID)?$objSQ->SQID:''); ?>" class="form-control" maxlength="15"  readonly >
                            <input type="text" name="SQANO" id="SQANO" value="<?php echo e(isset($MAXSQANO)?$MAXSQANO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" readonly >
                          </div>
                          
                          <div class="col-lg-2 pl"><p>SQA Date *</p></div>
                          <div class="col-lg-2 pl">
                              <input type="date" name="SQADT" id="SQADT" value="<?php echo e(date('Y-m-d')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                          </div>

                          <div class="col-lg-2 pl"><p>Reason to amend  SQ</p></div>
                          <div class="col-lg-2 pl">
                              <input type="text" name="REASONTOSQA" id="REASONTOSQA" value="<?php echo e(isset($objSQ->REASONTOSQA)?$objSQ->REASONTOSQA:''); ?>" class="form-control mandatory" autocomplete="off" maxlength="200"  >
                          </div>

                        </div>

                        <div class="row">
                            <input type="radio" onclick='return false'  name="LEAD" id="WITH_LEAD" <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""); ?> value="WITH_LEAD" class="form-radio" style="display: none;">
                            <input type="radio" name="LEAD" onclick='return false' <?php echo e($objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""); ?> id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" style="display: none;">

                            <div class="col-lg-2 pl"><p>Customer / Prospect</p></div>
                            <div class="col-lg-2 pl">
                              <select <?php echo e($ActionStatus); ?> name="CUSTOMER" id="CUSTOMER" onchange="getCustomer(this.value)" class="form-control mandatory" disabled>
                            ...
                            <div class="col-lg-2 pl"><p id="customer_prospect"> <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" ? "Prospect *":"Customer *"); ?></p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" disabled name="SubGl_popup" id="txtgl_popup" value="<?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" ?   $objSQ->PCODE. '-'.$objSQ->NAME: $objsubglcode->SGLCODE .'-'.$objsubglcode->SLNAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                            ...
                            <div class="col-lg-2 pl"  >
                            <input type="text" onclick='return false' name="Leadpopup" id="txtLeadpopup" value="<?php echo e(isset($objSQ->LEAD_NO)?$objSQ->LEAD_NO:''); ?>"  class="form-control mandatory"    readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="SQNO" id="SQNO" value="<?php echo e(isset($objSQ->SQNO)?$objSQ->SQNO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Quotation Date *</p></div>
                            <div class="col-lg-2 pl">
                                <input type="hidden" id="LASTSQDT" value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>">
                                <input type="date" name="SQDT" id="SQDT" value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly >
                            </div>
                            
                            <div class="col-lg-2 pl "><p>Dealer</p></div>
                            <div class="col-lg-2 pl"  >
                            <input type="text"    name="Dealerpopup" id="txtDealerpopup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objSQ->CUSTOMER_NAME)?$objSQ->CUSTOMER_NAME:''); ?>"  readonly/>
                        ...
                        <div class="row">                              
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text"  value="<?php echo e(isset($objSQ->DEALER_COMMISSION_AMT)?$objSQ->DEALER_COMMISSION_AMT:''); ?>"  name="DEALER_COMMISSION_AMT" id="DEALER_COMMISSION_AMT" readonly autocomplete="off" class="form-control" maxlength="100"  />
                            </div>
                            <div class="col-lg-2 pl "><p>Project</p></div>
                            <div class="col-lg-2 pl"  >
                            <input type="text"  value="<?php echo e(isset($objSQ->PROJECT_NAME)?$objSQ->PROJECT_NAME:''); ?>"  name="Projectpopup" id="txtProjectpopup" class="form-control mandatory"  autocomplete="off"  readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="QVFDT" id="QVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSQ->QVFDT)?$objSQ->QVFDT:''); ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="QVTDT" id="QVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSQ->QVTDT)?$objSQ->QVTDT:''); ?>" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Sales Person *</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="SPID_popup" id="txtSPID_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objSPID[0])?$objSPID[0]:''); ?>"  readonly/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objSQ->REFNO)?$objSQ->REFNO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>               
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                <input disabled type="text"  name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objBillAddress[0])?$objBillAddress[0]:''); ?>"   />
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input disabled type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objBillAddress[0])?$objBillAddress[0]:''); ?>" readonly  />
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e(isset($objSQ->REMARKS)?$objSQ->REMARKS:''); ?>"  >
                            </div>
                        </div>
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <?php if(!empty($objSQTNC)): ?>
                                                <?php $__currentLoopData = $objSQTNC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Tkey => $Trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <td><input type="text" name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control"  autocomplete="off"  readonly/></td>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:500px;width:50%;">
                                        ...
                                        <?php if(!empty($objSQUDF)): ?>
                                            <?php $__currentLoopData = $objSQUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input type="text" name=<?php echo e("popupUDFSQID_".$Ukey); ?> id=<?php echo e("popupUDFSQID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $objUdfSQData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name=<?php echo e("popupUDFSQID_".$uindex); ?> id=<?php echo e("popupUDFSQID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                                            ...
                                            <?php if(!empty($objSQCAL)): ?>
                                                <?php $__currentLoopData = $objSQCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        <td><input type="text" name=<?php echo e("popupTID_".$Ckey); ?> id=<?php echo e("popupTID_".$Ckey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("RATE_".$Ckey); ?>  id=<?php echo e("RATE_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->RATE); ?>"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("VALUE_".$Ckey); ?> id=<?php echo e("VALUE_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($Crow->VALUE); ?>" readonly /></td>
                                                        <td style="text-align:center;" ><input type="checkbox" class="filter-none" name=<?php echo e("calGST_".$Ckey); ?> id=<?php echo e("calGST_".$Ckey); ?> <?php echo e($Crow->GST == 1 ? 'checked' : ''); ?>   ></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("AMTIGST_".$Ckey); ?> id=<?php echo e("AMTIGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("calCGST_".$Ckey); ?> id=<?php echo e("calCGST_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->CGST); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("AMTCGST_".$Ckey); ?> id=<?php echo e("AMTCGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("AMTSGST_".$Ckey); ?> id=<?php echo e("AMTSGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("TOTGSTAMT_".$Ckey); ?> id=<?php echo e("TOTGSTAMT_".$Ckey); ?> class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[36,"saveamendment"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesQuotation_20221117\trnfrm36amendment.blade.php ENDPATH**/ ?>