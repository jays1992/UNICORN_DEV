<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->ATTID) ? method_field('PUT') : ''); ?>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">
                    ...
                    <tr  class="participantRow">
                      <td><input  class="form-control w-100" type="text" name=<?php echo e("PARTICULAR_".$key); ?> id =<?php echo e("PARTICULAR_".$key); ?> value="<?php echo e($row->PARTICULAR); ?>"  maxlength="100" autocomplete="off" style="text-transform:uppercase;width:100%;" ></td>
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'<?php echo e(route("mastermodify",[353,"update"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
...
$("#btnUndo").click(function(){
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[353,"Approve"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\Definition\mstfrm353edit.blade.php ENDPATH**/ ?>