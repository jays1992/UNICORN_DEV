  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->DCID); ?>" value="<?php echo e($val->DCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DC_DATE) && $val->DC_DATE !='' && $val->DC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DC_DATE)):''); ?>" ></td>
                <td><?php echo e(isset($val->DC_NO) && $val->DC_NO !=''?$val->DC_NO:''); ?></td>
                <td><?php echo e(isset($val->DC_DATE) && $val->DC_DATE !='' && $val->DC_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DC_DATE)):''); ?></td>
                <td><?php echo e(isset($val->DC_TYPE) && $val->DC_TYPE !=''?$val->DC_TYPE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/DealerCommission/trnfrm500.blade.php ENDPATH**/ ?>