...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SOSID); ?>" value="<?php echo e($val->SOSID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SOSDT) && $val->SOSDT !='' && $val->SOSDT !='1900-01-01' ? date('d-m-Y',strtotime($val->SOSDT)):''); ?>" ></td>
              <td><?php echo e(isset($val->SOSNO) && $val->SOSNO !=''?$val->SOSNO:''); ?></td>
              <td><?php echo e(isset($val->SOSDT) && $val->SOSDT !='' && $val->SOSDT !='1900-01-01' ? date('d-m-Y',strtotime($val->SOSDT)):''); ?></td>
          ...
          var sosIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '<?php echo e(route("transaction",[41,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[41,"attachment",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[41,"edit",":rcdId"])); ?>';
...
var recordId = sosIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[41,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[41,"cancel"])); ?>',
                            type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ScheduleOpenSalesOrder\trnfrm41.blade.php ENDPATH**/ ?>