            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="VQ_DT" id="VQ_DT" value="<?php echo e(isset($objMstResponse->VQ_DT)?$objMstResponse->VQ_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                  <input <?php echo e($ActionStatus); ?> type="checkbox" name="DIRECT_VQ" id="DIRECT_VQ" class="form-checkbox" value='<?php echo e(isset($objMstResponse->DIRECT_VQ) && $objMstResponse->DIRECT_VQ == 1 ? 1 : 0); ?>' <?php echo e(isset($objMstResponse->DIRECT_VQ) && $objMstResponse->DIRECT_VQ == 1 ? "checked" : ""); ?> >
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\VendorQuotation\trnfrm61view.blade.php ENDPATH**/ ?>