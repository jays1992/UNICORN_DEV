...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Assembling/Dissembling</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(isset($objResponse->ADSMNO)?$objResponse->ADSMNO:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DATE" id="DOC_DATE" value="<?php echo e(isset($objResponse->ADSMDT)?$objResponse->ADSMDT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
        ...
        <div class="col-lg-2 pl">
          <input type="text"    name="MAIN_ITEMID_NAME" id="MAIN_ITEMID_NAME" value="<?php echo e(isset($objResponse->ICODE)?$objResponse->ICODE:''); ?>" class="form-control" readonly >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_UOM" id="MAIN_UOM" value="<?php echo e(isset($objResponse->UOMCODE)?$objResponse->UOMCODE:''); ?><?php echo e(isset($objResponse->DESCRIPTIONS)?'-'.$objResponse->DESCRIPTIONS:''); ?>" class="form-control" readonly >
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_QTY" id="MAIN_QTY" value="<?php echo e(isset($objResponse->QTY)?$objResponse->QTY:''); ?>" class="form-control" onkeypress="return isNumberKey(event,this)" >
        </div>

        <div class="col-lg-1 pl"><p>Store</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="STID_REF_NAME" id="STID_REF_NAME" value="<?php echo e(isset($objResponse->STCODE)?$objResponse->STCODE:''); ?><?php echo e(isset($objResponse->STNAME)?'-'.$objResponse->STNAME:''); ?>" onclick="modal('show')" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($objResponse->REMARKS)?$objResponse->REMARKS:''); ?>" class="form-control" >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="AMOUNT" id="AMOUNT" value="<?php echo e(isset($objResponse->AMOUNT)?$objResponse->AMOUNT:''); ?>" class="form-control" readonly >
        </div>
      </div>
    </div>
...
function validateForm(actionType,actionMsg){
  ...
  if(DOC_NO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#DOC_DATE").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\AssemblingDissembling\trnfrm490edit.blade.php ENDPATH**/ ?>