      ...
      <div class="inner-form">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="ICODE" id="ICODE" class="form-control" value="<?php echo e($objItem->ICODE); ?>"  readonly >
                  <input type="hidden" name="RECORDID" id="RECORDID" class="form-control" value="<?php echo e($objItem->ITEMID); ?>"  readonly >
                  <span class="text-danger" id="ERROR_ICODE"></span> 
                </div>
                
                <div class="col-lg-1 pl"><p>Name</p></div>
                <div class="col-lg-3 pl" >
                  <input type="text" name="NAME" id="NAME" onkeyup="checkDuplicateIcodeName(this.value,'')" class="form-control mandatory" value="<?php echo e($objItem->NAME); ?>"   maxlength="200"   >
                  <!--<input type="hidden" name="NAME" id="NAME" class="form-control mandatory" value="<?php echo e($objItem->NAME); ?>"   maxlength="200"   >-->
				     <input type="hidden" name="NAME_OLD" id="NAME_OLD" class="form-control mandatory" value="<?php echo e($objItem->NAME); ?>"   maxlength="200"   >
                  <span class="text-danger" id="ERROR_NAME"></span> 
                </div>
                
                <div class="col-lg-1 pl"><p>Part No</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="PARTNO" id="PARTNO" class="form-control " value="<?php echo e($objItem->PARTNO); ?>"  maxlength="20"  autocomplete="off"/>
                </div>
                
                <div class="col-lg-1 pl"><p>Drawing No</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="DRAWINGNO" id="DRAWINGNO" class="form-control " value="<?php echo e($objItem->DRAWINGNO); ?>" maxlength="20" autocomplete="off">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <input type="text" name="GLID_REF_POPUP" id="GLID_REF_POPUP" class="form-control mandatory" value="<?php echo e(isset($objOldGlList->GLCODE) && $objOldGlList->GLCODE !=''?$objOldGlList->GLCODE.' - '.$objOldGlList->GLNAME:''); ?>"  readonly  />
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="ITEM_DESC" id="ITEM_DESC" class="form-control " value="<?php echo e($objItem->ITEM_DESC); ?>" maxlength="200"  >
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="itesubgrp_popup" id="itesubgrp_popup" value="<?php echo e($Objsubgroup->ISGCODE); ?> - <?php echo e($Objsubgroup->DESCRIPTIONS); ?>" class="form-control mandatory"   readonly />
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl">
                  <input type="text" name="SCDRate" id="SCDRate" class="form-control rightalign" maxlength="8" value="<?php echo e($objItem->CUSTOM_DUTY_RATE); ?>" autocomplete="off"  >
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl">
                  ...
                  <input type="text" name="STDCOST" id="STDCOST" class="form-control rightalign "  maxlength="18" value="<?php echo e($objItem->STDCOST); ?>" autocomplete="off" >
                  
                </div>
                
                <div class="col-lg-2 pl"><p>Standard SWS Rate %</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="SSRate" id="SSRate" class="form-control rightalign"  maxlength="8" value="<?php echo e($objItem->STD_SWS_RATE); ?>" autocomplete="off">
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 pl">
                  ...
                  <input type="text" name="MINLEVEL" id="MINLEVEL" class="form-control rightalign"  maxlength="16" value="<?php echo e($objItem->MINLEVEL); ?>" autocomplete="off">
                  </div>
                </div>
                ...
                <div class="col-lg-1 pl">
                  <div class="col-lg-12 pl">
                  <input type="text" name="REORDERLEVEL" id="REORDERLEVEL" class="form-control rightalign "  maxlength="16" value="<?php echo e($objItem->REORDERLEVEL); ?>" autocomplete="off">
                  </div>
                </div>
                ...
                <div class="col-lg-1 pl">
                  ...
                  <input type="text" name="MAXLEVEL" id="MAXLEVEL" class="form-control rightalign" maxlength="16" value="<?php echo e($objItem->MAXLEVEL); ?>" autocomplete="off">
                  
                </div>
                
                <div class="col-lg-1 pl"><p>Lead (Days)</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="LEAD_DAYS" id="LEAD_DAYS" value="<?php echo e($objItem->LEAD_DAYS); ?>" onkeypress="return isNumberKey(event,this)" class="form-control rightalign"  maxlength="4" autocomplete="off" >
                </div>

                <div class="col-lg-1 pl"><p>Shelf Life (Month)</p></div>
                <div class="col-lg-1 pl">
                  <input type="text" name="SHELF_LIFE" id="SHELF_LIFE" value="<?php echo e($objItem->SHELF_LIFE); ?>" onkeypress="return isNumberKey(event,this)" class="form-control rightalign"  maxlength="4" autocomplete="off" >
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <input type="text" name="ITEM_SPECI" id="ITEM_SPECI" class="form-control "  maxlength="200" value="<?php echo e($objItem->ITEM_SPECI); ?>" >
                </div>
              </div>
              ...
              <div class="row">
                ...
                <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objItem->DEACTIVATED == 1 ? "checked" : ""); ?>
                 ...
                 value='<?php echo e($objItem->DEACTIVATED == 1 ? 1 : 0); ?>'  >
                </div>
                ...
                <?php echo e($objItem->DEACTIVATED == 1 ? "" : "disabled"); ?>

                   tabindex="8" value="<?php echo e((!is_null($objItem->DODEACTIVATED) && $objItem->DODEACTIVATED!='1900-01-01')? 
                        ...
                        <?php if(!empty($objItemAttribute)): ?>
                          <?php $__currentLoopData = $objItemAttribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow">
                              ...
                              <td hidden>
                                <input type="text" name=<?php echo e("attrvalue_".$key); ?> id=<?php echo e("hdnattrvalue_popup_".$key); ?> value ="<?php echo e($row->AVALUE); ?>" class="form-control" />
                              </td> 

                            <td align="center" ><button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" <?php if($loop->iteration-1==0): ?> disabled <?php endif; ?>><i class="fa fa-trash" ></i></button></td>
                            </tr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                          <select name="QCA" id="QCA" class="form-control mandatory"  >
                            <option <?php echo e(isset($objFlage->QCA) && $objFlage->QCA =='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->QCA) && $objFlage->QCA=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                        ...
                        <div class="col-lg-1 pl">
                          <select name="INCA" id="INCA" class="form-control mandatory"  >
                            <option <?php echo e(isset($objFlage->INCA) && $objFlage->INCA =='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->INCA) && $objFlage->INCA=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                          <select name="SRNOA" id="SRNOA" class="form-control mandatory"  >
                            <option  <?php echo e(isset($objFlage->SRNOA) && $objFlage->SRNOA=='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->SRNOA) && $objFlage->SRNOA=='0'?'selected="selected"':''); ?>  value="0">No</option>
                          </select>
                        </div>
                        ...
                        <div class="col-lg-1 pl">
                          <select name="BIN" id="BIN" class="form-control mandatory"  >
                            <option <?php echo e(isset($objFlage->BIN) && $objFlage->BIN =='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->BIN) && $objFlage->BIN=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                          <select name="BATCHNOA" id="BATCHNOA" class="form-control mandatory"  >
                            <option  <?php echo e(isset($objFlage->BATCHNOA) && $objFlage->BATCHNOA=='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->BATCHNOA) && $objFlage->BATCHNOA=='0'?'selected="selected"':''); ?>  value="0">No</option>
                          </select>
                        </div>
                        ...
                        <div class="col-lg-1 pl">
                          <select name="WARA" id="WARA" class="form-control mandatory" onchange="getWarranty(this.value)" >
                            <option <?php echo e(isset($objFlage->WARA) && $objFlage->WARA =='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->WARA) && $objFlage->WARA=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                          <select name="INVMANTAIN" id="INVMANTAIN" class="form-control mandatory"  >
                            <option  <?php echo e(isset($objFlage->INVMANTAIN) && $objFlage->INVMANTAIN=='1'?'selected="selected"':''); ?>  value="1" >Yes</option>
                            <option <?php echo e(isset($objFlage->INVMANTAIN) && $objFlage->INVMANTAIN=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>

                        <div class="col-lg-2 pl"><p>Warranty(Month)</p></div>
                        <div class="col-lg-1 pl">
                          <input type="text" name="WARA_MONTH" id="WARA_MONTH" value="<?php echo e(isset($objFlage->WARA_MONTH)?$objFlage->WARA_MONTH:0); ?>" onkeypress="return isNumberKey(event,this)" class="form-control mandatory" <?php echo e(isset($objFlage->WARA) && $objFlage->WARA =='1'?'':'readonly'); ?>  >
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-1 pl">
                          <select name="BARCODE_APPLICABLE" id="BARCODE_APPLICABLE" class="form-control mandatory"  >
                            <option <?php echo e(isset($objFlage->BARCODE_APPLICABLE) && $objFlage->BARCODE_APPLICABLE=='1'?'selected="selected"':''); ?>  value="1">Yes</option>
                            <option <?php echo e(isset($objFlage->BARCODE_APPLICABLE) && $objFlage->BARCODE_APPLICABLE=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                        ...
                        <div class="col-lg-1 pl">
                          <select name="EXPIRY_APPLICABLE" id="EXPIRY_APPLICABLE" class="form-control mandatory"  >
                            <option  <?php echo e(isset($objFlage->EXPIRY_APPLICABLE) && $objFlage->EXPIRY_APPLICABLE=='1'?'selected="selected"':''); ?>  value="1" >Yes</option>
                            <option <?php echo e(isset($objFlage->EXPIRY_APPLICABLE) && $objFlage->EXPIRY_APPLICABLE=='0'?'selected="selected"':''); ?>  value="0" >No</option>
                          </select>
                        </div>
                      </div>

                      <div class="row" id="serial_no_mode" style="<?php echo e(isset($objFlage->SRNOA) && $objFlage->SRNOA =='1'?'':'display:none;'); ?>"  >
                        <div class="col-lg-2 pl"><p>Serial No Mode</p></div>
                        <div class="col-lg-1 pl">
                          <select name="SERIALNO_MODE" id="SERIALNO_MODE" class="form-control mandatory"  >
                            <option  value="">Select</option>
                            <option <?php echo e(isset($objFlage->SERIALNO_MODE) && $objFlage->SERIALNO_MODE=='MANUAL'?'selected="selected"':''); ?>  value="MANUAL">MANUAL</option>
                            <option <?php echo e(isset($objFlage->SERIALNO_MODE) && $objFlage->SERIALNO_MODE=='AUTOMATIC'?'selected="selected"':''); ?>  value="AUTOMATIC" >AUTOMATIC</option>
                          </select>
                        </div>
                        <div id="automatic_mode" style="<?php echo e(isset($objFlage->SERIALNO_MODE) && $objFlage->SERIALNO_MODE =='AUTOMATIC'?'':'display:none;'); ?>" >
                          <div class="col-lg-1 pl"><p>Prefix</p></div>
                          <div class="col-lg-1 pl">
                            <input type="text" id="SERIALNO_PREFIX" name="SERIALNO_PREFIX" value="<?php echo e(isset($objFlage->SERIALNO_PREFIX)?$objFlage->SERIALNO_PREFIX:''); ?>" class="form-control mandatory" autocomplete="off" >
                          </div>

                          <div class="col-lg-1 pl"><p>Start From</p></div>
                          <div class="col-lg-1 pl">
                            <input type="text" id="SERIALNO_STARTS_FROM" name="SERIALNO_STARTS_FROM" value="<?php echo e(isset($objFlage->SERIALNO_STARTS_FROM)?$objFlage->SERIALNO_STARTS_FROM:''); ?>" class="form-control mandatory" autocomplete="off" onkeypress="return isNumberKey(event,this)" >
                          </div>

                          <div class="col-lg-1 pl"><p>Suffix</p></div>
                          <div class="col-lg-1 pl">
                            <input type="text" id="SERIALNO_SUFFIX" name="SERIALNO_SUFFIX" value="<?php echo e(isset($objFlage->SERIALNO_SUFFIX)?$objFlage->SERIALNO_SUFFIX:''); ?>" class="form-control mandatory" autocomplete="off" >
                          </div>

                          <div class="col-lg-1 pl"><p>Max Length</p></div>
                          <div class="col-lg-1 pl">
                            <input type="text" id="SERIALNO_MAX_LENGTH" name="SERIALNO_MAX_LENGTH" value="<?php echo e(isset($objFlage->SERIALNO_MAX_LENGTH)?$objFlage->SERIALNO_MAX_LENGTH:''); ?>" class="form-control mandatory" autocomplete="off" onkeypress="return isNumberKey(event,this)" >
                          </div>
                        </div>
                      ...
                      <table id="table2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php if(!empty($objItemTechSpecification)): ?>
                          <?php $__currentLoopData = $objItemTechSpecification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tskey => $tsrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow">
                            <td><input  class="form-control w-100" type="text" name=<?php echo e("TSTYPE_".$tskey); ?> id=<?php echo e("TSTYPE_".$tskey); ?> value="<?php echo e($tsrow->TSTYPE); ?>" maxlength="50" ></td>
                            <td><input  class="form-control w-100" type="text" name=<?php echo e("TSVALUE_".$tskey); ?> id=<?php echo e("TSVALUE_".$tskey); ?> value="<?php echo e($tsrow->VALUE); ?>" maxlength="100" ></td>
                            <td align="center" ><button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button"  <?php if( ($loop->iteration-1)==0): ?> disabled <?php endif; ?>><i class="fa fa-trash" ></i></button></td>
                            </tr>
                          <tr></tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                  ...
                  <div id="UOMConversion" class="tab-pane fade">
                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:250px;width:50%;margin-top:10px;" >
                      <table id="table3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <tbody>
                        <?php if(!empty($objItemUOMConv)): ?>
                          <?php $__currentLoopData = $objItemUOMConv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iokey => $iorow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr  class="participantRow">
                            <td>
                              <input  class="form-control w-100" type="text" name=<?php echo e("txt_from_uom_".$iokey); ?> id=<?php echo e("txt_from_uom_".$iokey); ?>  value="<?php echo e($iorow->FROM_UOMID_REF); ?>"  maxlength="50" required readonly />
                            </td>
                            <td hidden>
                            <input  class="form-control w-100" type="text" name=<?php echo e("hdntxt_from_uomid_".$iokey); ?> id=<?php echo e("hdntxt_from_uomid_".$iokey); ?> value="<?php echo e($iorow->FROM_UOMID_REF); ?>" maxlength="50" />
                            </td>
                            <td>
                              <input  class="form-control w-100" type="text" name=<?php echo e("FROM_QTY_".$iokey); ?> ID=<?php echo e("TXT_FROM_QTY_".$iokey); ?> maxlength="5" value="<?php echo e($iorow->FROM_QTY); ?>" readonly >
                            </td>
                            <td>
                              <input name=<?php echo e("touom_popup_".$iokey); ?> id=<?php echo e("txttouom_popup_".$iokey); ?> class="form-control disabledinput" autocomplete="off" value="<?php echo e($iorow->TO_UOMID_REF); ?>"  readonly />
                            </td>
                            <td hidden>
                              <input type="text" name=<?php echo e("touom_".$iokey); ?> id=<?php echo e("hdntouom_popup_".$iokey); ?> class="form-control" value="<?php echo e($iorow->TO_UOMID_REF); ?>" />
                            </td>
                            
                            <td><input  class="form-control w-100 rightalign disabledinput" type="text" name=<?php echo e("TO_QTY_".$iokey); ?> id=<?php echo e("TXT_TO_QTY_".$iokey); ?> value="<?php echo e($iorow->TO_QTY); ?>" autocomplete="off" ></td>
                            <td align="center" ><button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" <?php if( ($loop->iteration-1)==0): ?> disabled <?php endif; ?>><i class="fa fa-trash" ></i></button></td>
                            </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                        <?php endif; ?> 
                  ...
                  <div id="ALPSSpecific" class="tab-pane fade">
                    ...
                    <div class="inner-form" style="margin-top:10px;">
                      <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_CODE" id="SAP_CUSTOMER_CODE" value="<?php echo e($objItem->SAP_CUSTOMER_CODE); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD2) && $TabSetting->FIELD2 !=''?$TabSetting->FIELD2:'Add. Customer Name'); ?></p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUSTOMER_NAME" id="SAP_CUSTOMER_NAME" value="<?php echo e($objItem->SAP_CUSTOMER_NAME); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD3) && $TabSetting->FIELD3 !=''?$TabSetting->FIELD3:'Add. Part Number'); ?></p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_PART_NO" id="SAP_PART_NO" value="<?php echo e($objItem->SAP_PART_NO); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_PART_DESC" id="SAP_PART_DESC" value="<?php echo e($objItem->SAP_PART_DESC); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_CUST_PARTNO" id="SAP_CUST_PARTNO" value="<?php echo e($objItem->SAP_CUSTOMER_PARTNO); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD6) && $TabSetting->FIELD6 !=''?$TabSetting->FIELD6:'Add. Market & Set Code'); ?></p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="SAP_MARTKET_SETCODE" id="SAP_MARTKET_SETCODE" value="<?php echo e($objItem->SAP_MARKET_SETCODE); ?>" class="form-control" style="text-transform:uppercase">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="LOTSIZEQTY" id="LOTSIZEQTY" value="<?php echo e($objItem->ROUNDING_VALUE); ?>" class="form-control">
                        </div>
                        <div class="col-lg-2 pl"><p><?php echo e(isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?$TabSetting->FIELD8:'Add. Info Part No'); ?></p></div>
                        <div class="col-lg-2 pl">
                        <input type="text" name="ALPS_PART_NO" id="ALPS_PART_NO" value="<?php echo e($objItem->ALPS_PART_NO); ?>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="CUSTOMER_PART_NO" id="CUSTOMER_PART_NO" value="<?php echo e($objItem->CUSTOMER_PART_NO); ?>" class="form-control">
                        </div>
                        ...
                        <div class="col-lg-2 pl">
                        <input type="text" name="OEM_PART_NO" id="OEM_PART_NO" value="<?php echo e($objItem->OEM_PART_NO); ?>" class="form-control">
                        </div>
                      </div>
                  ...
                  <tbody>
                      <?php $__currentLoopData = $objItemUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfkey => $udfrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr  class="participantRow">
                          ...
                          <td hidden>
                            <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDFITEMID_REF); ?>" class="form-control" maxlength="100" />
                          </td>
  ...
  <div class="modal-body">
    ...
    <tbody>
      ...
      <table id="example23" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstInventoryClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$InvClaRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_CLASSID_REF[]" id="invclacode_<?php echo e($InvClaRow->CLASSID); ?>" class="clsinventory" value="<?php echo e($InvClaRow-> CLASSID); ?>" ></td>
          <td class="ROW2" style="width: 39%"><?php echo e($InvClaRow-> CLASS_CODE); ?>

              <input type="hidden" id="txtinvclacode_<?php echo e($InvClaRow-> CLASSID); ?>" data-desc="<?php echo e($InvClaRow-> CLASS_CODE); ?> - <?php echo e($InvClaRow-> CLASS_DESC); ?>" value="<?php echo e($InvClaRow-> CLASSID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($InvClaRow->CLASS_DESC); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tr>
      ...
      <table id="muomtable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstUOM; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$UOMRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_UOMID_REF[]"  id="maiuomref_<?php echo e($UOMRow->UOMID); ?>" class="clsmaiuomref" value="<?php echo e($UOMRow->UOMID); ?>" ></td>
          <td class="ROW2" style="width: 39%"><?php echo e($UOMRow->UOMCODE); ?>

          <input type="hidden" id="txtmaiuomref_<?php echo e($UOMRow->UOMID); ?>" data-desc="<?php echo e($UOMRow->UOMCODE); ?> - <?php echo e($UOMRow->DESCRIPTIONS); ?>" value="<?php echo e($UOMRow-> UOMID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($UOMRow->DESCRIPTIONS); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tr>
      ...
      <table id="auomtable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr>
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ALTUOMID_REF[]"  id="altuomref_<?php echo e($UOMRow->UOMID); ?>" class="clsaltuomref" value="<?php echo e($UOMRow->UOMID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($UOMRow->UOMCODE); ?>

           <input type="hidden" id="txtaltuomref_<?php echo e($UOMRow->UOMID); ?>" data-desc="<?php echo e($UOMRow->UOMCODE); ?> - <?php echo e($UOMRow->DESCRIPTIONS); ?>" value="<?php echo e($UOMRow-> UOMID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($UOMRow->DESCRIPTIONS); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tbody>
      ...
      <table id="itmgrp2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstItemGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$ItemGroupRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr >
            <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ITEMGID_REF[]"  id="itegrp_<?php echo e($ItemGroupRow->ITEMGID); ?>" class="clsitegrp" value="<?php echo e($ItemGroupRow->ITEMGID); ?>" /></td>
            <td class="ROW2" style="width: 39%"><?php echo e($ItemGroupRow->GROUPCODE); ?>

            <input type="hidden" id="txtitegrp_<?php echo e($ItemGroupRow->ITEMGID); ?>" data-desc="<?php echo e($ItemGroupRow->GROUPCODE); ?> - <?php echo e($ItemGroupRow->GROUPNAME); ?>" value="<?php echo e($ItemGroupRow-> ITEMGID); ?>"/>
            </td>
            <td class="ROW3" style="width: 39%"><?php echo e($ItemGroupRow->GROUPNAME); ?></td>
          </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tbody>
      ...
      <table id="itmcat2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstItemCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$ItemCatRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ICID_REF[]" id="itecat_<?php echo e($ItemCatRow->ICID); ?>" class="clsitecat" value="<?php echo e($ItemCatRow->ICID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($ItemCatRow->ICCODE); ?>

            <input type="hidden" id="txtitecat_<?php echo e($ItemCatRow->ICID); ?>" data-desc="<?php echo e($ItemCatRow->ICCODE); ?> - <?php echo e($ItemCatRow->DESCRIPTIONS); ?>" value="<?php echo e($ItemCatRow-> ICID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($ItemCatRow->DESCRIPTIONS); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tbody>
      ...
      <table id="defstd2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstStore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$StoreRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_STID_REF[]"  id="defsto_<?php echo e($StoreRow->STID); ?>" class="clsdefsto" value="<?php echo e($StoreRow->STID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($StoreRow->STCODE); ?>

            <input type="hidden" id="txtdefsto_<?php echo e($StoreRow->STID); ?>" data-desc="<?php echo e($StoreRow->STCODE); ?> - <?php echo e($StoreRow->NAME); ?>" value="<?php echo e($StoreRow-> STID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($StoreRow->NAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tbody>
      ...
      <table id="hsncd2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstHSN; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$HSNRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_HSNID_REF[]" id="hsn_<?php echo e($HSNRow->HSNID); ?>" class="clshsn" value="<?php echo e($HSNRow->HSNID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($HSNRow->HSNCODE); ?>

          <input type="hidden" id="txthsn_<?php echo e($HSNRow->HSNID); ?>" data-desc="<?php echo e($HSNRow->HSNCODE); ?> - <?php echo e($HSNRow->HSNDESCRIPTION); ?>" value="<?php echo e($HSNRow-> HSNID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($HSNRow->HSNDESCRIPTION); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <tbody>
      ...
      <table id="bsnunt2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $ObjMstBusinessUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$BUnitRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_BUID_REF[]" id="busuni_<?php echo e($BUnitRow->BUID); ?>" class="clsbusuni" value="<?php echo e($BUnitRow->BUID); ?>" /></td>
          <td class="ROW2" style="width: 39%"><?php echo e($BUnitRow->BUCODE); ?>

          <input type="hidden" id="txtbusuni_<?php echo e($BUnitRow->BUID); ?>" data-desc="<?php echo e($BUnitRow->BUCODE); ?> - <?php echo e($BUnitRow->BUNAME); ?>" value="<?php echo e($BUnitRow-> BUID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($BUnitRow->BUNAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="attrcodepopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <table id="attrcodetable" class="display nowrap table  table-striped table-bordered" width="100%">
      ...
      <tbody>
      <?php $__currentLoopData = $ObjMstAttribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$AttRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr >
        <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ATTID_REF[]"  id="attrcode_<?php echo e($AttRow->ATTID); ?>" class="clsattrcode" value="<?php echo e($AttRow->ATTID); ?>" /></td>
        <td class="ROW2" style="width: 39%"><?php echo e($AttRow->ATTCODE); ?>

        <input type="hidden" id="txtattrcode_<?php echo e($AttRow->ATTID); ?>" data-desc="<?php echo e($AttRow->ATTCODE); ?> - <?php echo e($AttRow->DESCRIPTIONS); ?>" value="<?php echo e($AttRow-> ATTID); ?>" data-attrdesc="<?php echo e($AttRow->DESCRIPTIONS); ?>" value="<?php echo e($AttRow->DESCRIPTIONS); ?>"  />
        </td>
        <td class="ROW3" style="width: 39%"><?php echo e($AttRow->DESCRIPTIONS); ?></td>
      </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </tbody>
      </table>
...
<div id="touompopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <table id="touomexample2345" class="display nowrap table  table-striped table-bordered" width="100%">
      ...
      <?php $__currentLoopData = $ObjMstUOM; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$UOMRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr >
        <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_TOUOMID_REF[]" id="touom_<?php echo e($UOMRow->UOMID); ?>" class="clstouom" value="<?php echo e($UOMRow->UOMID); ?>" /></td>
        <td class="ROW2" style="width: 39%" ><?php echo e($UOMRow->UOMCODE); ?>

        <input type="hidden" id="txttouom_<?php echo e($UOMRow->UOMID); ?>" data-desc="<?php echo e($UOMRow->UOMCODE); ?> - <?php echo e($UOMRow->DESCRIPTIONS); ?>" value="<?php echo e($UOMRow-> UOMID); ?>"/>
        </td>
        <td class="ROW3" style="width: 39%"><?php echo e($UOMRow->DESCRIPTIONS); ?></td>
      </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="udffiepopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md">
    ...
    <table id="udffieexample2345" class="display nowrap table  table-striped table-bordered" width="100%">
      ...
      <tbody>
      <?php $__currentLoopData = $objUdfForItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$UdffieRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr id="udffie_<?php echo e($UdffieRow->UDFITEMID); ?>" class="clsudffie">
        <td ><?php echo e($UdffieRow->LABEL); ?>  <input type="hidden" id="txtudffie_<?php echo e($UdffieRow->UDFITEMID); ?>" value="<?php echo e($UdffieRow-> UDFITEMID); ?>"
      ...
      var customid = txtval;
        if(customid!=''){
          ...
          $('#tbody_itesubgrp').html('<tr><td colspan="2">Loading..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("master",[72,"getsubgroup"])); ?>',
                type:'POST',
                data:{'id':customid},
...
$('#table1').on ("focus","[id*='txtattrvalue_popup']",function(event){
        ...
        //----------
          ...
          $('#tbody_attrvalue').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("master",[72,"getAttValData"])); ?>',
                type:'POST',
                data:{'id':id3value},
                success:function(data) {
 ...
 // $('#table3').on("dblclick",".clstouom",function(){
  ...
  var formItemMst = $( "#frm_mst_item" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"codedupeditmode"])); ?>',
            type:'POST',
    ...
    function checkDuplicateName(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"namedupeditmode"])); ?>',
            type:'POST',
    ...
    function checkDuplicateNameAlps(buid){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"nameduplicatealpseditmode"])); ?>',
            type:'POST',
...
function validateForm(actionType,actionMsg){
  ...
  else if('<?php echo e($checkCompany); ?>' !='' && $.trim($("#busuni_id").val()) ===""){
...
$("#btnApprove").click(function(){
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"saveamendment"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
                ...
                if(data.success) {                   
                  ...
                  //  window.location.href='<?php echo e(route("master",[72,"index"])); ?>';
...
$.ajax({
    url:'<?php echo e(route("master",[72,"singleapprove"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
$(document).ready(function(){
  ...
  var result  = $.ajax({
                url:'<?php echo e(route("master",[72,"check_transaction"])); ?>',
                type:'POST',
                async: false,
                dataType: 'json',
                data: {ICODE:ICODE},
  ...
  $('#table3').find('.participantRow').each(function(){
    ...
    var exist_uom = $.ajax({
                    url:'<?php echo e(route("master",[72,"check_uom_transaction"])); ?>',
                    type:'POST',
                    async: false,
                    dataType: 'json',
...
var checkDuplicateIcodeName = $.ajax({type: 'POST',url:'<?php echo e(route("master",[72,"checkDuplicateIcodeName"])); ?>',async: false,dataType: 'json',data: {INAME:INAME},done: function(response) {return response;}}).responseText;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/inventory/itemmasters/mstfrm72amendment.blade.php ENDPATH**/ ?>