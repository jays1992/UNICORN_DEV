    ...
    <div class="inner-form">
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="QIC_NO" id="QIC_NO" value="<?php echo e(isset($MAXQIC_NO)?$MAXQIC_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
          <input type="hidden" name="QICID_REF" id="QICID_REF" value="<?php echo e(isset($objQIC->QICID)?$objQIC->QICID:''); ?>" class="form-control" maxlength="15"   readonly >
        </div>

        <div class="col-lg-2 pl"><p>Amendment Date*</p></div>
          <div class="col-lg-2 pl">
          <input type="date" name="QIC_DT" id="QIC_DT"  value="<?php echo e(date('Y-m-d')); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="QICNO" id="QICNO" value="<?php echo e(isset($HDR->QICNO)?$HDR->QICNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase">
        </div>
        
        <div class="col-lg-2 pl"><p>QIC Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="QICDT" id="QICDT" value="<?php echo e(isset($HDR->QICDT)?$HDR->QICDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" readonly>
        </div>
        
        <div class="col-lg-2 pl"><p>Item</p></div>
        <div class="col-lg-2 pl">
          <input type="text"    name="popupITEMID" id="popupITEMID" value="<?php echo e(isset($HDR->ICODE)?$HDR->ICODE:''); ?> <?php echo e(isset($HDR->ITEM_NAME)? ' - '.$HDR->ITEM_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" disabled/>
                    ...
                    <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                      ...
                      <tbody>
                        ...
                        <tr  class="participantRow">
                          ...
                          <td><input  type="text" name="txtQCP_popup_<?php echo e($key); ?>" id="txtQCP_popup_<?php echo e($key); ?>" value="<?php echo e(isset($row->QCP_CODE)?$row->QCP_CODE:''); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                          ...
                          <td><input type="text" name="QCP_DESC_<?php echo e($key); ?>" id="QCP_DESC_<?php echo e($key); ?>" value="<?php echo e(isset($row->QCP_DESC)?$row->QCP_DESC:''); ?>" class="form-control"  autocomplete="off"  readonly /></td>
                          
                          
                          <td><input type="text" name="txtUOMID_popup_<?php echo e($key); ?>"   id="txtUOMID_popup_<?php echo e($key); ?>" value="<?php echo e(isset($row->UOMCODE)?$row->UOMCODE:''); ?>" class="form-control" autocomplete="off" readonly/></td>
                          ...
                          <td><input type="text" name="txtINTMNTID_popup_<?php echo e($key); ?>"   id="txtINTMNTID_popup_<?php echo e($key); ?>" value="<?php echo e(isset($row->INSTRUMENT_METHOD_NAME)?$row->INSTRUMENT_METHOD_NAME:''); ?>" class="form-control" autocomplete="off" readonly/></td>
                          ...
                          <td>
                            <select name="STANDARDVALUE_TYPE_<?php echo e($key); ?>" id="STANDARDVALUE_TYPE_<?php echo e($key); ?>" class="form-control"  autocomplete="off" onchange="getStandardValue(this.id,this.value,'')" >
                          ...
                          <td><input type="text" name="STANDARD_VALUE_<?php echo e($key); ?>" id="STANDARD_VALUE_<?php echo e($key); ?>" value="<?php echo e(isset($row->STANDARD_VALUE)?$row->STANDARD_VALUE:''); ?>" class="form-control"   autocomplete="off"/></td>
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'<?php echo e(route("mastermodify",[$FormId,"saveamendment"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\QualityInspectionMaster\mstfrm361amendment.blade.php ENDPATH**/ ?>