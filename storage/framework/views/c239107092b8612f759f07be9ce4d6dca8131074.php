...
<!-- <form id="frm_rpt_ledger" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[1392,'index'])); ?>" class="btn singlebt">Section Wise TDS Report</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_ledger"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>Section</p></div>
                            <div class="col-lg-3 pl" id="div_vdg">
                                <select name="SECTION[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SECTION " class="form-control selectpicker VD" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bindex=>$bRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bRow->SECTIONID); ?>" selected><?php echo e($bRow->SECTION_CODE); ?>-<?php echo e($bRow->SECTION_NAME); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[1392,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(SECTION  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[1392,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\TDS_SectionWise\rptfrm1392.blade.php ENDPATH**/ ?>