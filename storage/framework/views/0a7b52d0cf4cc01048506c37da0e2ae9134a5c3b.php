  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="ST_ADJUST_DOCDT" id="ST_ADJUST_DOCDT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("ST_ADJUST_DOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('ST_ADJUST_DOCDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/inventory/StockAdjustment/trnfrm234add.blade.php ENDPATH**/ ?>