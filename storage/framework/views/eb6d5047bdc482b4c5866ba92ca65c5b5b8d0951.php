...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SSOID); ?>" value="<?php echo e($val->SSOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SSO_DT) && $val->SSO_DT !='' && $val->SSO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SSO_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->SSO_NO) && $val->SSO_NO !=''?$val->SSO_NO:''); ?></td>
                ...
                <td><?php echo e(isset($val->OVF_DT) && $val->OVF_DT !='' && $val->OVF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVF_DT)):''); ?></td>
                <td><?php echo e(isset($val->OVT_DT) && $val->OVT_DT !='' && $val->OVT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVT_DT)):''); ?></td>
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[151,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[151,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesServiceOrder\trnfrm151.blade.php ENDPATH**/ ?>