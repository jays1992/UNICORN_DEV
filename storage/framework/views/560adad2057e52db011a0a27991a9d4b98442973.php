...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[348,'index'])); ?>" class="btn singlebt">Production & Movement Register</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_dpp"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            <div class="col-lg-3 pl"><p>Production & Movement No</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="PNM_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="PNM_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjPNMNO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->PNMID); ?>" selected><?php echo e($GRow->PNM_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>               
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[348,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var PNM_NO = [];
        $("select[name='PNM_NO[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                PNM_NO.push(value5);
            }
        ...
        else if(PNM_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Production & Movement No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[348,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\PNMRegister\rptfrm348.blade.php ENDPATH**/ ?>