...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <a href="<?php echo e(route('report',[$FormId,'index'])); ?>" class="btn singlebt">Item Master</a>
                </div>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Group</p></div>
                            ...
                            <div class="col-lg-3 pl"><p>Sub Group</p></div>
                            <div class="col-lg-3 pl" id="div_itemid">
                                ...
                                <?php $__currentLoopData = $ObjItemSubGrp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Iindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($IRow->ISGID); ?>" selected>
                                        <?php echo e($IRow->DESCRIPTIONS); ?> (<?php echo e($IRow->ISGCODE); ?>)                                                                           
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="row">                   
                            ...
                            <div class="col-lg-3 pl" id="div_itemid">
                                ...
                                <?php $__currentLoopData = $ObjCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Iindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($IRow->ICID); ?>" selected>
                                        <?php echo e($IRow->DESCRIPTIONS); ?> (<?php echo e($IRow->ICCODE); ?>)                                                                             
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\purchase\ItemMaster\rptfrm547.blade.php ENDPATH**/ ?>