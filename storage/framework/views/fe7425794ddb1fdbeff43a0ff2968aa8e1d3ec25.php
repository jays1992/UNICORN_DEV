<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"> 
        <?php echo csrf_field(); ?>
        <?php echo e(isset($objResponse->ASGID) ? method_field('PUT') : ''); ?>
       ...
       <div class="inner-form">
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="<?php echo e($HDR->ASSETCODE); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTDESCRIPTIONS" id="ASTDESCRIPTIONS" value="<?php echo e($HDR->ASTDESCRIPTIONS); ?>" class="form-control"  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Category</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATEGORY" id="ASSETCAT" value="<?php echo e($HDR->CATEGORY); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                   <input type="hidden" name="ASCATID_REF" id="ASCATID_REF" value="<?php echo e($HDR->ASCATID); ?>" class="form-control" autocomplete="off" />
                 </div>
             </div> 
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Category Description</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATDESCRIPTIONS" id="CATADESCRIPTIONS" value="<?php echo e($HDR->CATDESCRIPTIONS); ?>"  class="form-control" readonly  maxlength="100" >  
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Group</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASGCODE" id="ASGCODE"       value="<?php echo e($HDR->ASGCODE); ?>" class="form-control" readonly  maxlength="100" > 
                   <input type="hidden" name="ASGID_REF" id="ASGID_REF" value="<?php echo e($HDR->ASGID); ?>" class="form-control" readonly  maxlength="100" > 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Type</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETTYPE" id="ASSETTYPE"   value="<?php echo e($HDR->ASSETTYPE); ?>" class="form-control" readonly  maxlength="100" >
                   <input type="hidden" name="ASTID_REF" id="ASTID_REF" value="<?php echo e($HDR->ASTID); ?>" class="form-control" readonly  maxlength="100" > 
                 </div>
             </div>
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Company Act</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" <?php echo e(isset($HDR) && $HDR->DMETHOD_INCOMETAX =='1'?'checked':''); ?> value="1" class="enable_tb">
                 </div>

               <div class="col-lg-2 pl"><p>Salvage Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input name="SALAVERATE" id="SALAVERATE" value="<?php echo e($HDR->SALAVERATE); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" type="text"> 
                 </div>

                 <div class="col-lg-2 pl"><p>Life of Asset (in Years)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="LOASSET" id="LOASSET" value="<?php echo e($HDR->LOASSET); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>                   
             </div>
             <div class="row">
               <div class="col-lg-2 pl"><p>WDV Method</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" <?php echo e(isset($HDR) && $HDR->DMETHOD_INCOMETAX =='2'?'checked':''); ?> value="1" class="enable_tbwdv"> 
                 </div>

               <div class="col-lg-2 pl"><p>WDV Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="WDVRATE" id="WDVRATE" value="<?php echo e($HDR->WDVRATE); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" > 
                 </div>
             </div>
             <br>
             <div class="row">
                   ...
                   <tbody>
                    ...
                    <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr  class="participantRow">
                        <td hidden><input type="hidden" name="ASSETID_REF[]"        id="ASSETID_REF" value="<?php echo e($row->ASSETID_REF); ?>" /></td>
                        <td><input type="text"          name="popupITEMID[]"        id=<?php echo e("popupITEMID_".$key); ?> value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="ITEMID_REF[]"         id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->ITEMID_REF); ?>" autocomplete="off" /></td>
                        <td><input type="text"          name="ItemName[]"           id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->NAME); ?>"  autocomplete="off"   readonly/></td>
                        <td><input type="text"          name="Itemspec[]"           id=<?php echo e("Itemspec_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEM_SPECI); ?>" readonly  /></td>
                        <td><input type="text"          name="popupMUOM[]"          id=<?php echo e("popupMUOM_".$key); ?> class="form-control" value="<?php echo e($row->UOMCODE); ?> <?php echo e($row->DESCRIPTIONS); ?>"   autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="UOMID_REF[]"          id=<?php echo e("UOMID_REF_".$key); ?>  class="form-control" value="<?php echo e($row->UOMID_REF); ?>"   autocomplete="off" /></td>
                        <td hidden><input type="hidden" name="MAIN_UOMID_REF[]"     id=<?php echo e("MAIN_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" /></td>
                        <td hidden><input type="hidden" name="SE_QTY[]"             id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" maxlength="13" autocomplete="off"  /></td>
                        <td hidden><input type="hidden" name="SO_FQTY[]"            id=<?php echo e("SO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="PRIORITYID[]"         id=<?php echo e("PRIORITYID_".$key); ?> class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="PTID_REF[]"           id=<?php echo e("PTID_REF_".$key); ?> class="form-control"  autocomplete="off" readonly/></td>
                        <td hidden><input type="hidden" name="EDD[]"                id=<?php echo e("EDD_".$key); ?>         class="form-control w-100" placeholder="dd/mm/yyyy" ></td>
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[409,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetMaster\mstfrm409edit.blade.php ENDPATH**/ ?>