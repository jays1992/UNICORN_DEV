<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->TEMPLATEID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                      <input type="hidden" name="TEMPLATEID" id="TEMPLATEID" value="<?php echo e($objResponse->TEMPLATEID); ?>" />
                        <input type="text" name="TEMPLATE_NAME" id="TEMPLATE_NAME" value="<?php echo e($objResponse->TEMPLATE_NAME); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
            ...
            <div class="row">
              ...
              <div class="col-lg-3 pl" id="temdes">
                <textarea name="TEMPLATE" id="TEMPLATE" cols="118" rows="10" ><?php echo e(isset($objResponse->TEMPLATE) && $objResponse->TEMPLATE !=''?$objResponse->TEMPLATE:''); ?></textarea>
              </div>
            </div>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[1384,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[1384,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\TemplateMaster\mstfrm1384edit.blade.php ENDPATH**/ ?>