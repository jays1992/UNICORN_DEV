                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input type="text" name=<?php echo e("txtFORM_popup_".$key); ?> id=<?php echo e("txtFORM_popup_".$key); ?> class="form-control" value="<?php echo e($row->MP_CODE); ?>"  autocomplete="off"  readonly style="width:100%;"  /></td>
                              ...
                              <td><input  class="form-control" style="width: 100%" type="text" name=<?php echo e("FORMNAME_".$key); ?> id =<?php echo e("FORMNAME_".$key); ?> value="<?php echo e($row->MP_DESC); ?>"   autocomplete="off" readonly></td>
                              ...
                              <td><input type="text" name=<?php echo e("txtLISTPOP1_popup_".$key); ?> id=<?php echo e("txtLISTPOP1_popup_".$key); ?>  value="<?php echo e($row->MSP_CODE); ?>" class="form-control "  autocomplete="off"  readonly style="width:100%;" /></td>
                              ...
                              <td><input  class="form-control" style="width: 100%" type="text" name=<?php echo e("STANDARD_VAL_".$key); ?> id =<?php echo e("STANDARDID_VAL_".$key); ?> value="<?php echo e($row->VALUE); ?>" maxlength="200" autocomplete="off" ></td>                            
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\MachineWiseChecklist\mstfrm228edit.blade.php ENDPATH**/ ?>