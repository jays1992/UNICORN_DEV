...
<!-- <form id="frm_trn_ro" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[315,'index'])); ?>" class="btn singlebt">Release Order</a>
                </div><!--col-2-->
              ...
              <div class="inner-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="text" name="RONO" id="RONO" value="<?php echo e(isset($objRO->RONO)?$objRO->RONO:''); ?>" class="form-control mandatory" maxlength="150" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                    </div>
                    
                    <div class="col-lg-2 pl"><p>Release Order Date</p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="date" name="RODT" id="RODT" value="<?php echo e(isset($objRO->RODT)?$objRO->RODT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
                    ...
                    <div class="col-lg-2 pl">
                        ...
                        <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="<?php echo e(isset($objRO->SLID_REF)?$objRO->SLID_REF:''); ?>"/>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="text" name="SONO_txt" id="SONO_txt" class="form-control mandatory" value="<?php echo e(isset($objsocode->SONO)?$objsocode->SONO:''); ?>" autocomplete="off" style="text-transform:uppercase" readonly/>
                        <input type="hidden" name="SOID_REF" id="SOID_REF" class="form-control mandatory" autocomplete="off"  value="<?php echo e(isset($objRO->SOID_REF)?$objRO->SOID_REF:''); ?>" />
                    </div>  
                    <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="date" name="OVFRM_DT" id="OVFRM_DT" class="form-control mandatory" autocomplete="off" value="<?php echo e(isset($objRO->OVFRM_DT)?$objRO->OVFRM_DT:''); ?>"  placeholder="dd/mm/yyyy" readonly>
                    </div>                            
                    <div class="col-lg-2 pl"><p>Order Validity To </p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="date" name="OVTOM_DT" id="OVTOM_DT" class="form-control mandatory" autocomplete="off" value="<?php echo e(isset($objRO->OVTOM_DT)?$objRO->OVTOM_DT:''); ?>"  placeholder="dd/mm/yyyy" readonly>
                    </div> 
                </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="text" name="CUSTOMERPONO" id="CUSTOMERPONO" class="form-control" autocomplete="off" value="<?php echo e(isset($objRO->CUSTOMERPONO)?$objRO->CUSTOMERPONO:''); ?>" style="text-transform:uppercase" readonly>
                    </div>
                    <div class="col-lg-2 pl"><p>Customer PO Date </p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="date" name="CUSTOMERDT" id="CUSTOMERDT" class="form-control " autocomplete="off" value="<?php echo e(isset($objRO->CUSTOMERDT)?$objRO->CUSTOMERDT:''); ?>" placeholder="dd/mm/yyyy" readonly />
                    </div>
                    <div class="col-lg-2 pl"><p>Foreign Currency</p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="checkbox" name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objRO->FC) && $objRO->FC  == 1 ? 'checked' : ''); ?>  disabled/>
                        <input type="hidden" name="hdn_FC" id="hdn_FC" class="form-control mandatory" value="<?php echo e(isset($objRO->FC)?$objRO->FC:''); ?>" autocomplete="off"  />
                    </div> 
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl" id="divcurrency" >
                        <?php if($objrocurrency): ?>
                        <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objrocurrency[0])?$objrocurrency[0]:''); ?>"   disabled/>
                        <?php else: ?>
                        <input <?php echo e($InputStatus); ?> type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
                        <?php endif; ?>
                        <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objRO->CRID_REF)?$objRO->CRID_REF:''); ?>" disabled/>
                    </div>
                    <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="text" name="CONVERSION_FACT" id="CONVERSION_FACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e(isset($objRO->CONVERSION_FACT)?$objRO->CONVERSION_FACT:''); ?>" disabled />
                    </div>
                    ...
                    <div class="col-lg-2 pl" id="div_billto">
                        ...
                        <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objRO->BILLTO_CLID_REF)?$objRO->BILLTO_CLID_REF:''); ?>" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl" id="div_shipto">
                        ...
                        <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objRO->SHIPTO_CLID_REF)?$objRO->SHIPTO_CLID_REF:''); ?>" />
                    ...
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="text" name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e(isset($objRO->REMARKS)?$objRO->REMARKS:''); ?>"  >
                    </div>
                ...
                <div class="col-lg-2 pl "><p>Deliver Date</p></div>
                    <div class="col-lg-2 pl">
                        <input type="date" name="DELIVER_DATE" id="DELIVER_DATE" value="<?php echo e(isset($objRO->DELIVER_DATE)?$objRO->DELIVER_DATE:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist"  style="width:100%;height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                <tr>
                                                    <th colspan="3"><input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>"></th>
                                ...
                                <div id="Specification" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example6" class="display nowrap table table-striped table-bordered itemlist"  style="width:100%;height:auto !important;">
                                            ...
                                            <tbody id="tbody_spec">
                                              <?php if(!empty($objROISP)): ?>
                                                <?php $__currentLoopData = $objROISP; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ikey => $irow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow5">
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("IITEMID_REF_".$ikey); ?> id=<?php echo e("IITEMID_REF_".$ikey); ?> class="form-control" value="<?php echo e($irow->ITEMID_REF); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ISEID_REF_".$ikey); ?> id=<?php echo e("ISEID_REF_".$ikey); ?> class="form-control" value="<?php echo e($irow->SEID_REF); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ISQID_REF_".$ikey); ?> id=<?php echo e("ISQID_REF_".$ikey); ?> class="form-control" value="<?php echo e($irow->SQID_REF); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ISOID_REF_".$ikey); ?> id=<?php echo e("ISOID_REF_".$ikey); ?> class="form-control" value="<?php echo e($irow->SOID_REF); ?>" autocomplete="off" /></td>
                                                  <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name=<?php echo e("Specification_ID_".$ikey); ?> id=<?php echo e("Specification_ID_".$ikey); ?> class="form-control"  value="<?php echo e($irow->Specification_ID); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Specification_Name_".$ikey); ?> id=<?php echo e("Specification_Name_".$ikey); ?> class="form-control"  value="<?php echo e($irow->Specification_Name); ?>" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Itemspec_".$ikey); ?> id=<?php echo e("Itemspec_".$ikey); ?> class="form-control"  value="<?php echo e($irow->ITEM_SPECI); ?>" autocomplete="off" /></td>
                                                  </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                <?php else: ?>
                                                <tr  class="participantRow5">
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="IITEMID_REF_0" id="IITEMID_REF_0" class="form-control" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="ISEID_REF_0" id="ISEID_REF_0" class="form-control" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="ISQID_REF_0" id="ISQID_REF_0" class="form-control" autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="ISOID_REF_0" id="ISOID_REF_0" class="form-control" autocomplete="off" /></td>
                                                  <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="Specification_ID_0" id="Specification_ID_0" class="form-control"  autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="Specification_Name_0" id="Specification_Name_0" class="form-control"  autocomplete="off" /></td>
                                                  <td><input <?php echo e($InputStatus); ?> type="text" name="Itemspec_0" id="Itemspec_0" class="form-control"  autocomplete="off" /></td>
                                              </tr>
                                          <?php endif; ?> 
                                              <tr></tr>
                                ...
                                <div id="udf" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $objUdfROData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name=<?php echo e("popupUDFROID_".$uindex); ?> id=<?php echo e("popupUDFROID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFROID_REF_".$uindex); ?> id=<?php echo e("UDFROID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFROID); ?>" autocomplete="off"   /></td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="UDFROIDnamesearch" onkeyup="UDFROIDNameFunction()">
      ...
      <table id="UDFROIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objUdfROData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfindex=>$udfRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="udfroid_<?php echo e($udfindex); ?>" class="clsudfroid">
          <td width="50%"><?php echo e($udfRow->LABEL); ?>

          <input type="hidden" id="txtudfroid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->UDFROID); ?>"/>
          </td>
    ...
    <tr>
      ...
      <table id="SpcftionCodeTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody id="tbody_spcfions" >
          <?php $__currentLoopData = $objROISP; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ikey => $irow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr  class="participantRow5">
            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Specification_ID_".$ikey); ?> id=<?php echo e("Specification_ID_".$ikey); ?> class="form-control"  value="<?php echo e($irow->Specification_ID); ?>" autocomplete="off" /></td>
            <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name=<?php echo e("Specification_Name_".$ikey); ?> id=<?php echo e("Specification_Name_".$ikey); ?> class="form-control"  value="<?php echo e($irow->Specification_Name); ?>" autocomplete="off" /></td>
            <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name=<?php echo e("Itemspec_".$ikey); ?> id=<?php echo e("Itemspec_".$ikey); ?> class="form-control"  value="<?php echo e($irow->ITEM_SPECI); ?>" autocomplete="off" /></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $ObjSpc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ikey => $irow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="participantRow5">
              <td><input type="checkbox" name="spcfchecked" id="spcfchecked" value="<?php echo e($irow->SPECIFICATIONID); ?>"></td>
              <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Specification_ID_".$ikey); ?> id=<?php echo e("Specification_ID_".$ikey); ?> class="form-control"  value="<?php echo e($irow->SPECIFICATIONID); ?>" autocomplete="off" /></td>
              <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Specification_Name_".$ikey); ?> id=<?php echo e("Specification_Name_".$ikey); ?> class="form-control"  value="<?php echo e($irow->SPECIFICATIONNAME); ?>" autocomplete="off" /></td>
              <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Itemspec_".$ikey); ?> id=<?php echo e("Itemspec_".$ikey); ?> class="form-control"  value="<?php echo e($irow->SPECIFICATIONDESC); ?>" autocomplete="off" /></td>
              </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Release Order Print</p></div>
        <div class="row">
      ...
      $('#SONO_txt').click(function(event)
      {
        ...
        if(SLID_REF!='')
        {
          $("#tbody_SO").html('');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getsalesorder"])); ?>',
                type:'POST',
      ...
      $(".clssoid").click(function()
      {
        ...
        if(customid!='')
        {
          ...
          $("#SHIPTO1").val('');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getsodata"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getBillTo"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#txtBILLTO1").hide();
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getShipTo"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#txtSHIPTO1").hide();
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getItemDetails"])); ?>',
                type:'POST',
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getItemCount"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $('#Row_Count1').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getTNCData"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  if(data != '')
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getTNCDetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#tncbody").html('');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[315,"getTNCCount"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#Row_Count2").val(data);
...
//------------------------
      ...
      function loadSpftion(SPECIFICATIONID,SPECIFICATIONNAME,SPECIFICATIONDESC,IDSPF,IDSPF_VAL){
        ...
        $.ajax({
          url:'<?php echo e(route("transaction",[315,"getItesmSpection"])); ?>',
          type:'POST',
...
$(document).ready(function(e) {
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '<?php echo e(route("transaction",[315,"add"])); ?>';
    ...
    //to check the label duplicacy
     $('#RONO').focusout(function(){
      ...
      if(RONO ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[315,"checkso"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
...
//SO Date Check
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('transaction',[315,'add'])); ?>";
...
var customFnName = $("#YesBtn").data("funcname");
    window[customFnName]();
   // window.location.href = "<?php echo e(route('transaction',[315,'index'])); ?>";
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[315,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {       
        if(data.errors) {
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[315,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
var objSO = <?php echo json_encode($objRO); ?>;

$('#btnPdf').on('click', function() {
  var ROID = objSO.ROID;
  var Flag = 'P';
  var formData = 'SO='+ ROID + '&ROID='+ ROID + '&Flag='+ Flag ;
  var consultURL = '<?php echo e(route("transaction",[315,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[315,"ViewReport"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
...
$.ajax({
    url:'<?php echo e(route("transaction",[315,"getItemDetailsEdit"])); ?>',
    type:'POST',
    data:{'id':'<?php echo e(isset($objRO->SOID_REF)?$objRO->SOID_REF:''); ?>','ROID':'<?php echo e(isset($objRO->ROID)?$objRO->ROID:''); ?>'},
    success:function(data) {
      $("#tbody_mat").html('');
      $("#tbody_mat").html(data);
      var i=0;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ReleaseOrder\trnfrm315view.blade.php ENDPATH**/ ?>