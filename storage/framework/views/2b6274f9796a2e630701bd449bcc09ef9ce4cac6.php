            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <input type="text" name="BOMNO" id="BOMNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                               
                          
                            </div>
                            <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="BOM_DT" id="BOM_DT" value="<?php echo e(date('Y-m-d')); ?>" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <input type="text" name="DESCRIPTION" id="DESCRIPTION" value="<?php echo e(old('DESCRIPTION')); ?>" class="form-control mandatory" readonly  autocomplete="off"  >
                            </div>       
                            <div class="col-lg-2 pl"><p>UOM	 </p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="UOMID_REF_DESC" id="UOMID_REF_DESC" value="<?php echo e(old('UOMID_REF_DESC')); ?>" class="form-control mandatory" readonly  autocomplete="off"  >
                            <input type="hidden" name="UOMID_REF" id="UOMID_REF" value="<?php echo e(old('UOMID_REF')); ?>" class="form-control mandatory" readonly  autocomplete="off"  >
                            </div>      
...
//add row
    ...
    window.fnUndoYes = function (){
      //reload form
      window.location.href = "<?php echo e(route('master',[202,'add'])); ?>";
   }//fnUndoYes
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\BillofMaterial\mstfrm202add.blade.php ENDPATH**/ ?>