...
<?php
$readonly = isset($HDR->PRE_MATURITY_DATE) && $HDR->PRE_MATURITY_DATE !=''?'readonly':'';
$disabled = isset($HDR->PRE_MATURITY_DATE) && $HDR->PRE_MATURITY_DATE !=''?'disabled':'';
?>
  ...
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Fixed Deposit</a></div>
      <div class="col-lg-10 topnav-pd">
        ...
        <button class="btn topnavbt" id="btnSaveFormData" onclick="saveAction('mature')" <?php echo e($disabled); ?> ><i class="fa fa-floppy-o"></i> Save</button>
        ...
        <button class="btn topnavbt" id="btnApprove" disabled="disabled" onclick="saveAction('approve')" <?php echo e((isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?> ><i class="fa fa-thumbs-o-up"></i> Approved</button>
    ...
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_CODE" id="FD_CODE" value="<?php echo e(isset($HDR->FD_CODE)?$HDR->FD_CODE:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
                          
        <div class="col-lg-2 pl"><p>FD Date*</p></div>
        <div class="col-lg-2 pl">
          <input  type="date" name="FD_DATE" id="FD_DATE" value="<?php echo e(isset($HDR->FD_DATE)?$HDR->FD_DATE:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" <?php echo e($readonly); ?> >
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input  type="text"   name="BANK_AC_TEXT" id="BANK_AC_TEXT" value="<?php echo e(isset($HDR->BANK_CODE)?$HDR->BANK_CODE:''); ?> - <?php echo e(isset($HDR->BANK_NAME)?$HDR->BANK_NAME:''); ?>"  class="form-control" autocomplete="off" onclick="getAccountMaster('')" readonly/>
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="BANK_AC_NO" id="BANK_AC_NO" value="<?php echo e(isset($HDR->BANK_AC_NO)?$HDR->BANK_AC_NO:''); ?>" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">               
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_BANK_AC_TEXT" id="FD_BANK_AC_TEXT"  value="<?php echo e(isset($HDR->FD_BANK_CODE)?$HDR->FD_BANK_CODE:''); ?> - <?php echo e(isset($HDR->FD_BANK_NAME)?$HDR->FD_BANK_NAME:''); ?>" class="form-control "  autocomplete="off" onclick="getAccountMaster('FD')" readonly/>
        ...
        <div class="col-lg-2 pl"><p>Account Number</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="FD_BANK_AC_NO" id="FD_BANK_AC_NO" value="<?php echo e(isset($HDR->FD_BANK_AC_NO)?$HDR->FD_BANK_AC_NO:''); ?>" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input  type="date" name="MATURITY_DATE" id="MATURITY_DATE" value="<?php echo e(isset($HDR->MATURITY_DATE)?$HDR->MATURITY_DATE:''); ?>" class="form-control" autocomplete="off" <?php echo e($readonly); ?> />
        </div>
        
        <div class="col-lg-2 pl"><p>In-Favour</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="IN_FAVOUR" id="IN_FAVOUR" value="<?php echo e(isset($HDR->IN_FAVOUR)?$HDR->IN_FAVOUR:''); ?>" class="form-control" autocomplete="off" <?php echo e($readonly); ?> />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select   name="BG_NO_APPLICABLE" id="BG_NO_APPLICABLE" class="form-control" autocomplete="off" onchange="getBgAppl(this.value)" <?php echo e($readonly); ?> >
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="BG_NO" id="BG_NO" value="<?php echo e(isset($HDR->BG_NO)?$HDR->BG_NO:''); ?>" class="form-control" autocomplete="off" <?php echo e($readonly); ?> />
        </div>

        <div class="col-lg-2 pl"><p>Principal Amount</p></div>
        <div class="col-lg-2 pl">
          <input  type="text" name="PRINCIPLE_AMOUNT" id="PRINCIPLE_AMOUNT" value="<?php echo e(isset($HDR->PRINCIPLE_AMOUNT)?$HDR->PRINCIPLE_AMOUNT:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" <?php echo e($readonly); ?> />
        </div>
      </div>  
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select   name="RATE_OF_INTEREST_BASE" id="RATE_OF_INTEREST_BASE" class="form-control" autocomplete="off" <?php echo e($readonly); ?> >
            <option value="">Select</option>
        ...
        <div class="col-lg-2 pl">
          <input  type="text" name="RATE_OF_INTEREST" id="RATE_OF_INTEREST" value="<?php echo e(isset($HDR->RATE_OF_INTEREST)?$HDR->RATE_OF_INTEREST:''); ?>" class="form-control" autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" <?php echo e($readonly); ?> />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</div>
        <div class="col-lg-2 pl">
          <input  type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($HDR->REMARKS)?$HDR->REMARKS:''); ?>" class="form-control" autocomplete="off" <?php echo e($readonly); ?> />
        </div>
      </div> 
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MATURE_TYPE" id="MATURE_TYPE" value="<?php echo e(isset($HDR->MATURE_TYPE)?$HDR->MATURE_TYPE:''); ?>" class="form-control" autocomplete="off" readonly  />
        </div>
      </div> 
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Maturity Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="PRE_MATURITY_DATE" id="PRE_MATURITY_DATE" value="<?php echo e(isset($HDR->PRE_MATURITY_DATE)?$HDR->PRE_MATURITY_DATE:''); ?>" class="form-control" autocomplete="off" onchange="getMatureType()" <?php echo e($readonly); ?> />
        </div>

        <div class="col-lg-2 pl"><p>Interest calculator</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="INTEREST_CALCULATOR" id="INTEREST_CALCULATOR" value="<?php echo e(isset($HDR->INTEREST_CALCULATOR)?$HDR->INTEREST_CALCULATOR:''); ?>" class="form-control" autocomplete="off" onkeyup="getGrossFdValue()" <?php echo e($readonly); ?> />
        </div>

        <div class="col-lg-2 pl"><p>Gross FD Value</div>
        <div class="col-lg-2 pl">
          <input type="text" name="GROSS_FD_VALUE" id="GROSS_FD_VALUE" value="<?php echo e(isset($HDR->GROSS_FD_VALUE)?$HDR->GROSS_FD_VALUE:''); ?>" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
...
function validateForm(action){
  ...
  else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#FD_DATE").val(),0) ==0){
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn").hide();
    $("#OkBtn1").show();
...
$("#YesBtn").click(function(){
  ...
  if(action ==="save"){
    ...
    window[customFnName]('<?php echo e(route("transaction",[$FormId,"updateMature"])); ?>');
  }
...
$(function(){
  ...
  var MATURE_TYPE=<?php echo json_encode(isset($HDR->MATURE_TYPE)?$HDR->MATURE_TYPE:'', 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\FixedDeposit\trnfrm501mature.blade.php ENDPATH**/ ?>