...
<!-- <form id="frm_rpt_sispw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->

    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[247,'index'])); ?>" class="btn singlebt">Dispatch Summary Sales Person Wise</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_sispw"  method="POST">   
            <?php echo csrf_field(); ?>
...
$(document).ready(function(e) {
   ...
   $('#To_Date').change(function(){
       ...
       if(From_Date != '' && To_Date != '')
       {
                ...
                $.ajax({
                    url:'<?php echo e(route("report",[247,"GetSP"])); ?>',
                    type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\DispatchSummarySPwise\rptfrm247.blade.php ENDPATH**/ ?>