...
<script>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[43,'index'])); ?>" class="btn singlebt">Sales Challan (SC)</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_sc"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objSC->SCID[0]) ? method_field('PUT') : ''); ?>
                    ...
                    <div class="inner-form">
						<div class="row">
							...
							<div class="col-lg-2 pl">
								<select name="CHALLANTYPE" id="CHALLANTYPE" class="form-control" >
									   <option value="SALES" <?php echo e(isset($objSC->CHALLANTYPE) && $objSC->CHALLANTYPE == 'SALES' ? 'selected' : ''); ?>>Sales</option>
									   <option value="TRANSFER" <?php echo e(isset($objSC->CHALLANTYPE) && $objSC->CHALLANTYPE == 'TRANSFER' ? 'selected' : ''); ?>>STOCK TRANSFER</option>
								</select>
							</div>
						</div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="SCNO" id="SCNO" value="<?php echo e(isset($objSC->SCNO)?$objSC->SCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            </div>
                            <div class="col-lg-2 pl"><p>Sales Challan Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SCDT" id="SCDT" onchange="checkPeriodClosing(43,this.value,1)" value="<?php echo e(isset($objSC->SCDT)?$objSC->SCDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                           
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objSC->SLID_REF)?$objSC->SLID_REF:''); ?>" />
                                <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objSC->GLID_REF)?$objSC->GLID_REF:''); ?>"  />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSC->BILLTO)?$objSC->BILLTO:''); ?>" />
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSC->SHIPTO)?$objSC->SHIPTO:''); ?>" />
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" maxlength="200" value="<?php echo e(isset($objSC->REMARKS)?$objSC->REMARKS:''); ?>"   >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Transporter Code</p></div>
                            <div class="col-lg-2 pl">
                                <?php if(!empty($objTransporter2)): ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="TRANSPORTERID_popup" id="TRANSPORTERID_popup" class="form-control"  autocomplete="off" value="<?php echo e(isset($objTransporter2->TRANSPORTER_CODE)?$objTransporter2->TRANSPORTER_CODE:''); ?>"  readonly/>
                                <?php else: ?>
                                <input  <?php echo e($InputStatus); ?>type="text" name="TRANSPORTERID_popup" id="TRANSPORTERID_popup" class="form-control"  autocomplete="off" readonly/>
                                <?php endif; ?> 
                                <input type="hidden" name="TRANSPORTERID_REF" id="TRANSPORTERID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objSC->TRANSPORTERID_REF)?$objSC->TRANSPORTERID_REF:''); ?>" readonly/>                                
                            </div>                            
                            <div class="col-lg-2 pl"><p>Name</p></div>
                            <div class="col-lg-2 pl">
                                <?php if(!empty($objTransporter2)): ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="TRANSPORTERNAME" id="TRANSPORTERNAME" class="form-control"  autocomplete="off" value="<?php echo e(isset($objTransporter2->TRANSPORTER_NAME)?$objTransporter2->TRANSPORTER_NAME:''); ?>"  readonly/>
                                <?php else: ?>
                                <input <?php echo e($InputStatus); ?> type="text" name="TRANSPORTERNAME" id="TRANSPORTERNAME" class="form-control"  autocomplete="off" readonly/>
                                <?php endif; ?> 
                            </div>
                            <div class="col-lg-2 pl"><p>Transport Time</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="TRANSPORTTIME" id="TRANSPORTTIME" class="form-control" maxlength="30" value="<?php echo e(isset($objSC->TRANSPORT_TIME)?$objSC->TRANSPORT_TIME:''); ?>"  autocomplete="off"   >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 pl"><p>Type</p></div>
                            <div class="col-lg-2 pl">
                               <select <?php echo e($InputStatus); ?> name="TYPE" id="TYPE" class="form-control" >
                               <option value="SO"  <?php echo e(isset($objSC->TYPE) && $objSC->TYPE == 'SO' ? 'selected' : ''); ?>>Sales Order</option>
                               <option value="OSO"  <?php echo e(isset($objSC->TYPE) && $objSC->TYPE == 'OSO' ? 'selected' : ''); ?>>Open Sales Order</option>
                               </select>
                              
                            </div>
                        <div class="col-lg-2 pl"><p>Shipping Instruction</p></div>
                            <div class="col-lg-4 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="SHIPPINGINSTRUCTION" id="SHIPPINGINSTRUCTION" class="form-control" maxlength="100" value="<?php echo e(isset($objSC->SHIPPING_INST)?$objSC->SHIPPING_INST:''); ?>"  autocomplete="off"   >
                            </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                    ...
                                                    <tr>
                                                        <th width="10%">SO No / SOA No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>"></th>
                                            ...
                                            <tbody>
                                            <?php if(!empty($objSCMAT)): ?>
                                                <?php $__currentLoopData = $objSCMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 
                                                <tr  class="participantRow">
                                             <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("SCMATID_".$key); ?> id =<?php echo e("SCMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SCMATID); ?>" autocomplete="off"   >
                                                    </td>
                                                    <td hidden><input type="hidden" name=<?php echo e("DEALERID_REF_".$key); ?> id =<?php echo e("DEALERID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->DEALERID_REF); ?>" /></td>
                                 
                                                    <td hidden><input type="hidden" name=<?php echo e("SCHEMEID_REF_".$key); ?> id =<?php echo e("SCHEMEID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->SCHEMEID_REF); ?>" /></td>
                                                    <td style="text-align:center;"> 

                                                    <input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("txtSO_popup_".$key); ?> id=<?php echo e("txtSO_popup_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->SONO); ?>"   readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("SOID_REF_".$key); ?> id=<?php echo e("SOID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->SO); ?>" /></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("SQID_REF_".$key); ?> id=<?php echo e("SQID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->SQID_REF); ?>" /></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("SEID_REF_".$key); ?> id=<?php echo e("SEQID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->SEID_REF); ?>" /></td>                                   

                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ICODE); ?>"  readonly/></td>
                                                    
                                                    <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ALPSPARTNO_".$key); ?> id=<?php echo e("ALPSPARTNO_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALPS_PARTNO); ?>" readonly/></td>
                                                    <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($InputStatus); ?> type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($row->CUSTOMER_PART_NO)?$row->CUSTOMER_PART_NO:''); ?>" readonly/></td>
                                                    <td <?php echo e($AlpsStatus['hidden']); ?>><input <?php echo e($InputStatus); ?> type="text" name="OEMpartno_<?php echo e($key); ?>"  id="OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  value="<?php echo e(isset($row->OEM_PART_NO)?$row->OEM_PART_NO:''); ?>" readonly/></td>
                                                    
                                                    
                                                    <td hidden><input type="hidden" name=<?php echo e("ITEMID_REF_".$key); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control" autocomplete="off" value="<?php echo e($row->ITEMID_REF); ?>" /></td>

                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ItemName); ?>"  readonly/></td>
                                       
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ITEMSPECI_".$key); ?> id=<?php echo e("ITEMSPECI_".$key); ?> class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->ITEMSPECI); ?>"/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SOMUOM_".$key); ?> id=<?php echo e("SOMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->SOMUOM); ?>" readonly/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SOMUOMQTY_".$key); ?> id=<?php echo e("SOMUOMQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off" value="<?php echo e($row->SOMUOMQTY); ?>" readonly/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SOPENDINGQTY_".$key); ?> id=<?php echo e("SOPENDINGQTY_".$key); ?> class="form-control three-digits"  autocomplete="off" value="<?php echo e($row->SOPENDINGQTY); ?>" readonly/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SOAUOM_".$key); ?> id=<?php echo e("SOAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->SOAUOM); ?>" readonly/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SOAUOMQTY_".$key); ?> id=<?php echo e("SOAUOMQTY_".$key); ?> class="form-control three-digits" maxlength="13" autocomplete="off" value="<?php echo e($row->SOAUOMQTY); ?>" readonly/></td>
                                                    
                                                    <td align="center" ><button <?php echo e($InputStatus); ?> class="btn" id=<?php echo e("SCSTR_".$key); ?> name=<?php echo e("SCSTR_".$key); ?> onclick="GetStore(this.id);" type="button"><i class="fa fa-clone"></i></button></td>

                                                    <td hidden ><input type="hidden" id=<?php echo e("BATCHID_REF_".$key); ?> name=<?php echo e("BATCHID_REF_".$key); ?>  class="form-control" autocomplete="off" value="<?php echo e($row->BATCHID_REF); ?>" /></td>
                                                    <td hidden ><input type="hidden" id=<?php echo e("STORE_QTYS_".$key); ?> name=<?php echo e("STORE_QTYS_".$key); ?>  class="form-control" autocomplete="off" value="<?php echo e($row->STORE_QTYS); ?>" /></td>
                                                    

                                                    <td><input <?php echo e($InputStatus); ?> type="text" name="STORE_NAME_<?php echo e($key); ?>" id="STORE_NAME_<?php echo e($key); ?>" value="<?php echo e(isset($row->STORE_NAME)?$row->STORE_NAME:''); ?>"  class="form-control w-100" autocomplete="off" readonly style="width:200px;" ></td>
                                                    <td><input type="text" name="AVG_RATE_<?php echo e($key); ?>" id="AVG_RATE_<?php echo e($key); ?>" value="<?php echo e(isset($row->RATEPUOM)?$row->RATEPUOM:''); ?>"  class="form-control w-100" autocomplete="off" readonly style="width:100px;" ></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupMUOM); ?>" readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("MAINUOMID_REF_".$key); ?> id=<?php echo e("MAINUOMID_REF_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->MAINUOMID_REF); ?>" /></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("CHALLAN_MAINQTY_".$key); ?> id=<?php echo e("CHALLAN_MAINQTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->CHALLAN_MAINQTY); ?>" autocomplete="off" readonly  /></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("SO_FQTY_".$key); ?> id=<?php echo e("SO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off" value="1" readonly/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupAUOM); ?>"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("ALTUOMID_REF_".$key); ?> id=<?php echo e("ALTUOMID_REF_".$key); ?> class="form-control"  autocomplete="off"  readonly value="<?php echo e($row->ALTUOMID_REF); ?>"/></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->ALT_UOMID_QTY); ?>" autocomplete="off"  readonly/></td>
                                             
                                                    
                                                              
                                             
                                                    
                                                    <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                    <button <?php echo e($InputStatus); ?> class="btn remove" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            ...
                                            <?php if(!empty($objUdfSCData)): ?>
                                              <?php $__currentLoopData = $objUdfSCData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUDFSCID_".$uindex); ?> id=<?php echo e("popupUDFSCID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
            ...
            var customid = txtval;
              if(customid!=''){
                ...
                $("#BILLTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getBillTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getShipTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtSHIPTO1").hide();
  ...
  $('#div_billto').on('click','#txtBILLTO',function(event){
    var customid = $('#SLID_REF').val();
        $("#tbody_BillTo").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getBillAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
  ...
  $('#div_shipto').on('click','#txtSHIPTO',function(event){
    var customid = $('#SLID_REF').val();
        $("#tbody_ShipTo").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getShipAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
  ...
  $('#Material').on('click','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getAltUOM"])); ?>',
                      type:'POST',
                      data:{'id':ItemID},
                      success:function(data) {
      ...
      $(".clsaltuom").click(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[43,"getaltuomqty"])); ?>',
                      type:'POST',
...
$(document).ready(function(e) {
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '<?php echo e(route("transaction",[43,"add"])); ?>';
...
$("#btnApprove").prop("disabled", true);
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[43,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $(".buttonload").hide(); 
...
$("#btnSaveSC").prop("disabled", true);
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[43,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[43,"index"])); ?>';
});
...
var DOCID_REF = '<?php echo e($objSC->SCID); ?>';
$.ajaxSetup({
    headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    }
...
url:'<?php echo e(route("transaction",[$FormId,"Get_Barcode_Status"])); ?>',
async: false,
dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECTS\UNICORN_DEV\resources\views/transactions/sales/SalesChallan/trnfrm43edit.blade.php ENDPATH**/ ?>