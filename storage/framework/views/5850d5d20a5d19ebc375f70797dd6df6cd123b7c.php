...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_sq"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objSQ->SQID[0]) ? method_field('PUT') : ''); ?>

            <div class="container-fluid filter">

                    <div class="inner-form">
                    <div class="row">
                        <input type="radio" <?php echo e($ActionStatus); ?>  name="LEAD" id="WITH_LEAD" <?php echo e($objSQ->QUOTATTION_TYPE =="PROSPECT" || $objSQ->QUOTATTION_TYPE =="CUSTOMER" ? "checked":""); ?> value="WITH_LEAD" class="form-radio" style="display: none;">
                        <input type="radio" name="LEAD" <?php echo e($ActionStatus); ?> <?php echo e($objSQ->QUOTATTION_TYPE =="DIRECT" ? "checked":""); ?> id="WITHOUT_LEAD" value="WITHOUT_LEAD" class="form-radio" style="display: none;">

                        <div class="col-lg-2 pl"><p>Customer / Prospect</p></div>
                        <div class="col-lg-2 pl">
                          <select <?php echo e($ActionStatus); ?> name="CUSTOMER" id="CUSTOMER" onchange="getCustomer(this.value)" class="form-control mandatory">
                            <option <?php echo e(isset($objSQ->CUSTOMER_PROSPECT_TYPE) && $objSQ->CUSTOMER_PROSPECT_TYPE == 'PROSPECT'?'selected="selected"':''); ?> value="PROSPECT">Prospect</option>
                            <option <?php echo e(isset($objSQ->CUSTOMER_PROSPECT_TYPE) && $objSQ->CUSTOMER_PROSPECT_TYPE == 'CUSTOMER'?'selected="selected"':''); ?> value="CUSTOMER">Customer</option>
                        </select>
                        </div>

                        <div class="col-lg-2 pl" ><p id="customer_prospect"><?php echo e($objSQ->CUSTOMER_PROSPECT_TYPE =="PROSPECT" ? "Prospect *":"Customer *"); ?></p></div>
                        <div class="col-lg-2 pl">
                            <input type="text" <?php echo e($ActionStatus); ?>  name="SubGl_popup" id="txtgl_popup" class="form-control mandatory"  value="<?php echo e($objSQ->CUSTOMER_PROSPECT_TYPE =='PROSPECT'?$objSQ->PCODE.'-'.$objSQ->NAME:''); ?><?php echo e($objSQCUST->CUSTOMER_PROSPECT_TYPE =='CUSTOMER'?$objSQCUST->CCODE.'-'.$objSQCUST->NAME:''); ?>" autocomplete="off" readonly/>
                            <input type="hidden" name="CUSTOMER_PROSPECT" id="CUSTOMER_PROSPECT"  class="form-control" value="<?php echo e(isset($objSQ->SLID_REF)?$objSQ->SLID_REF:''); ?>" autocomplete="off" />

                            <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off"            value="<?php echo e(isset($objSQ->GLID_REF)?$objSQ->GLID_REF:''); ?>" />
                            <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"            value="<?php echo e(isset($objSQ->SLID_REF)?$objSQ->SLID_REF:''); ?>" />
                            <input type="hidden" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE" value="<?php echo e(isset($objsubglcode->BELONGS_TO)?strtoupper($objsubglcode->BELONGS_TO):''); ?>" class="form-control" autocomplete="off" />
                        ...
                        <div class="col-lg-2 pl"  >
                        <input type="text" <?php echo e($ActionStatus); ?> name="Leadpopup" id="txtLeadpopup" value="<?php echo e(isset($objSQ->LEAD_NO)?$objSQ->LEAD_NO:''); ?>"  class="form-control mandatory"    readonly/>
                        <input type="hidden" name="LEAD_REF" id="LEAD_REF" value="<?php echo e(isset($objSQ->LEADID_REF)?$objSQ->LEADID_REF:''); ?>"  class="form-control"  />                           
                        <input type="hidden" name="QUOTATIONTYPE" id="QUOTATIONTYPE" value="<?php echo e(isset($objSQ->QUOTATTION_TYPE)?$objSQ->QUOTATTION_TYPE:''); ?>" class="form-control"  />                           
                        </div>     
                    </div>   
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Quotation No *</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="SQNO" id="SQNO" value="<?php echo e(isset($objSQ->SQNO)?$objSQ->SQNO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Quotation Date *</p></div>
                            <div class="col-lg-2 pl">
                                <input type="hidden"  id="LASTSQDT" value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>">
                                <input type="date"  <?php echo e($ActionStatus); ?> name="SQDT" id="SQDT" value="<?php echo e(isset($objSQ->SQDT)?$objSQ->SQDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            ...
                            <div class="col-lg-2 pl"  >
                            <input type="text"  <?php echo e($ActionStatus); ?>  name="Dealerpopup" id="txtDealerpopup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objSQ->CUSTOMER_NAME)?$objSQ->CUSTOMER_NAME:''); ?>"  readonly/>
                            <input type="hidden" name="DEALERID_REF" value="<?php echo e(isset($objSQ->DEALERID_REF)?$objSQ->DEALERID_REF:''); ?>" id="DEALERID_REF" class="form-control" autocomplete="off" />                                
                            <input type="hidden" name="DEALER_COMMISSION" value="<?php echo e(isset($objSQ->COMMISION)?$objSQ->COMMISION:''); ?>" id="DEALER_COMMISSION" class="form-control" autocomplete="off" />                                
                            </div> 
                        ...
                        <div class="row">                               
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($objSQ->DEALER_COMMISSION_AMT)?$objSQ->DEALER_COMMISSION_AMT:''); ?>"  name="DEALER_COMMISSION_AMT" id="DEALER_COMMISSION_AMT" readonly autocomplete="off" class="form-control" maxlength="100"  />
                            </div>
                            <div class="col-lg-2 pl "><p>Project</p></div>
                            <div class="col-lg-2 pl"  >
                            <input type="text" <?php echo e($ActionStatus); ?> value="<?php echo e(isset($objSQ->PROJECT_NAME)?$objSQ->PROJECT_NAME:''); ?>"  name="Projectpopup" id="txtProjectpopup" class="form-control mandatory"  autocomplete="off"  readonly/>
                            <input type="hidden" name="PROJECTID_REF" value="<?php echo e(isset($objSQ->PROJECTID_REF)?$objSQ->PROJECTID_REF:''); ?>" id="PROJECTID_REF" class="form-control" autocomplete="off" />                                                            
                            </div> 
                            
                            <div class="col-lg-2 pl"><p>FC</p></div>
                            <div class="col-lg-2 pl">
                                <input type="checkbox" <?php echo e($ActionStatus); ?> name="FC" id="FC" class="form-checkbox" <?php echo e(isset($objSQ->FC) && $objSQ->FC == 1 ? 'checked' : ''); ?> >
                            </div>
                        </div>   
                            ...
                            <div class="col-lg-2 pl" id="divcurrency" >
                                ...
                                <input type="text" <?php echo e($ActionStatus); ?> name="CRID_popup" id="txtCRID_popup" disabled class="form-control"   autocomplete="off"   value="<?php echo e(isset($objSQ->CRDESCRIPTION) && $objSQ->CRDESCRIPTION !=''? $objSQ->CRCODE.'-'.$objSQ->CRDESCRIPTION:''); ?>"/>
                           
                                <input type="hidden"  name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e(isset($objSQ->CRID_REF)?$objSQ->CRID_REF:''); ?>" />
                                
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="CONVFACT" id="CONVFACT" class="form-control" onkeyup="MultiCurrency_Conversion('TotalValue')" maxlength="100" autocomplete="off" value="<?php echo e(isset($objSQ->CONVFACT)?$objSQ->CONVFACT:''); ?>"  />
                            </div>
                            <div class="col-lg-2 pl"><p>Quotation Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" <?php echo e($ActionStatus); ?> name="QVFDT" id="QVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSQ->QVFDT)?$objSQ->QVFDT:''); ?>" >
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" <?php echo e($ActionStatus); ?> name="QVTDT" id="QVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSQ->QVTDT)?$objSQ->QVTDT:''); ?>" >
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="SPID_REF" id="SPID_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objSQ->SPID_REF)?$objSQ->SPID_REF:''); ?>" />
                            </div>
                            <div class="col-lg-2 pl"><p>Ref No </p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objSQ->REFNO)?$objSQ->REFNO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSQ->BILLTO)?$objSQ->BILLTO:''); ?>" />
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSQ->SHIPTO)?$objSQ->SHIPTO:''); ?>" />
                                <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" autocomplete="off" value="<?php echo e(isset($objSQ->BILLTO_SHIPTO)?$objSQ->BILLTO_SHIPTO:''); ?>"   />
                            </div>

                            <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="REMARKS" id="REMARKS" class="form-control" autocomplete="off" maxlength="200" value="<?php echo e(isset($objSQ->REMARKS)?$objSQ->REMARKS:''); ?>"  >
                            </div>                       
                        </div>
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectSQ" id="DirectSQ" class="form-checkbox" onchange="direct()"  <?php echo e(isset($objSQ->QUOTATTION_TYPE) && $objSQ->QUOTATTION_TYPE == 'DIRECT' ? 'checked' : ''); ?> />
                            </div>
                            ...
                            <div class="tab-content">
                                <div id="Material" class="tab-pane fade in active">
                                    <div id="GetSchemeMaterialItems"  class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                            <?php if(!empty($objSQMAT)): ?>
                                                <?php $__currentLoopData = $objSQMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">

                                                    <td hidden><input type="text" name=<?php echo e("SCHEMEID_REF_".$key); ?> id =<?php echo e("SCHEMEID_REF_".$key); ?>   class="form-control" autocomplete="off" style="width:130px;" value="<?php echo e($row->SCHEMEID_REF); ?>"  /></td>
                                                      ...
                                                      <td hidden><input type="hidden" name=<?php echo e("SCHEMEQTY_".$key); ?> id =<?php echo e("SCHEMEQTY_".$key); ?>   class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:130px;text-align:right;"   value="<?php echo e(isset($row->SCHEMEQTY) ?  $row->SCHEMEQTY : ''); ?>"   /></td>
                                                        ...
                                                        <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("SQMATID_".$key); ?> id =<?php echo e("SQMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SQMATID); ?>" autocomplete="off"   >
                                                        </td>
                                                        <td style="text-align:center;" >
                                                        <input style="width:100px;" type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("txtSE_popup_".$key); ?> id=<?php echo e("txtSE_popup_".$key); ?> class="form-control"   autocomplete="off" value="<?php echo e($row->ENQNO); ?>"   readonly/></td>
                                                        ...
                                                        <td><input style="width:100px;" type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input style="width:100px;" type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ItemName); ?>" readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SEMUOM_".$key); ?> id=<?php echo e("SEMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->SEMUOM); ?>" readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SEMUOMQTY_".$key); ?> id=<?php echo e("SEMUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->SEMUOMQTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SEAUOM_".$key); ?> id=<?php echo e("SEAUOM_".$key); ?> class="form-control"  autocomplete="off"  value="<?php echo e($row->SEAUOM); ?>" readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SEAUOMQTY_".$key); ?> id=<?php echo e("SEAUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->SEAUOMQTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupMUOM); ?>" readonly/></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SQ_QTY_".$key); ?> id=<?php echo e("SQ_QTY_".$key); ?>  onkeyup="dataCal(this.id)" class="form-control three-digits <?php echo e($row->ITEM_TYPE); ?>SCHEME<?php echo e($row->SCHEMEID_REF); ?>" maxlength="13" value="<?php echo e($row->SQ_QTY); ?>"  autocomplete="off"  /></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("SQ_FQTY_".$key); ?> id=<?php echo e("SQ_FQTY_".$key); ?> class="form-control three-digits" maxlength="13" value="1" autocomplete="off"   readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->popupAUOM); ?>" readonly/></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->ALT_UOMID_QTY); ?>" autocomplete="off"  readonly/></td>
                                                        
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?>    onkeyup="dataCal(this.id),get_delear_customer_price(this.id,'change')" class="form-control five-digits blurRate" maxlength="13" value="<?php echo e($row->RATEPUOM); ?>"  autocomplete="off" /></td>
                                                        <td hidden><input type="text" name="COMMISSION_AMOUNT_<?php echo e($key); ?>" id="COMMISSION_AMOUNT_<?php echo e($key); ?>" value="<?php echo e($row->COMMISSION_AMOUNT); ?>" /></td>
                                                    
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits " maxlength="8" value="<?php echo e($row->DISCPER); ?>" onkeyup="dataCal(this.id)"  autocomplete="off" style="width: 50px;" /></td>
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DISCOUNT_AMT); ?>"  onkeyup="dataCal(this.id)"maxlength="15"  autocomplete="off"  /></td>
                                                        <?php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TaxAmt); ?>" readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> onkeyup="dataCal(this.id)"class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($IGSTAMT); ?>"  readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> onkeyup="dataCal(this.id)"class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($CGSTAMT); ?>"  readonly/></td>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> onkeyup="dataCal(this.id)"class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly/></td>
                                                        <?php
                                                            $SGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->SGST)/100),2, '.', '');
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($SGSTAMT); ?>"  readonly/></td>
                                                        <?php
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                            $SGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->SGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TOTGST); ?>"   readonly/></td>
                                                        <?php
                                                            $TaxAmt=number_format((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT),2, '.', '');
                                                            $IGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->IGST)/100),2, '.', '');
                                                            $CGSTAMT=number_format((((($row->SQ_QTY*$row->RATEPUOM) - $row->DISCOUNT_AMT)*$row->CGST)/100),2, '.', '');
                                                        ...
                                                        ?>
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($TOTAMT); ?>" readonly/></td>
                                                        <td align="center"><button class="btn add material" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button class="btn remove dmaterial" <?php echo e($ActionStatus); ?> title="Delete" id=<?php echo e("remove_".$key); ?>  data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <div class="col-lg-2 pl">
                                        <input type="text" <?php echo e($ActionStatus); ?> name="txtTNCID_popup" id="txtTNCID_popup" value="<?php echo e(isset($objSQTNC[0]->TNC_CODE) && $objSQTNC[0]->TNC_CODE !=''?$objSQTNC[0]->TNC_CODE:''); ?> <?php echo e(isset($objSQTNC[0]->TNC_DESC) && $objSQTNC[0]->TNC_DESC !=''?'- '.$objSQTNC[0]->TNC_DESC:''); ?>" class="form-control"  autocomplete="off"  readonly/>
                                        <?php if(!empty($objSQTNC)): ?>
                                         <input type="hidden" name="TNCID_REF" id="TNCID_REF" class="form-control" value="<?php echo e($objSQTNC[0]->TNCID_REF); ?>" autocomplete="off" />
                                         <?php else: ?>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:50%;">
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody id="tncbody">
                                            <?php if(!empty($objSQTNC)): ?>
                                                <?php $__currentLoopData = $objSQTNC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Tkey => $Trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <tr  class="participantRow3">
                                                  <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e(isset($Trow->TNC_NAME)?$Trow->TNC_NAME:''); ?>"  autocomplete="off"  readonly/></td>
                                                  ...
                                                  <td hidden id=<?php echo e("tdinputid_".$Tkey); ?>></td> 
                                                  <?php 
                                                    $VALUE_TYPE = isset($Trow->VALUE_TYPE)?$Trow->VALUE_TYPE:'';
                                                    if($VALUE_TYPE=='Date'){ ?>
                                                    <td><input type="date" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->VALUE); ?>" placeholder="dd/mm/yyyy" /></td>       
                                                      
                                                    <?php } else if($VALUE_TYPE=='Time'){ ?>
                                                      <td><input type="time" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->VALUE); ?>" placeholder="dd/mm/yyyy" /></td>       
                                                      
                                                    <?php } else if($VALUE_TYPE=='Numeric'){ ?>
                                                      <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->VALUE); ?>" placeholder="dd/mm/yyyy" /></td>       
                                                      
                                                    <?php } else if($VALUE_TYPE=='Text'){ ?>
                                                      <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->VALUE); ?>" placeholder="dd/mm/yyyy" /></td>       

                                                    <?php } else if($VALUE_TYPE=='Boolean'){ ?>
                                                      <td><input type="checkbox" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTNCDID_".$Tkey); ?> id=<?php echo e("popupTNCDID_".$Tkey); ?> class="form-control" value="<?php echo e($Trow->VALUE); ?>" placeholder="dd/mm/yyyy" /></td>       
                                                    
                                                    <?php } else if($VALUE_TYPE=='Combobox'){ ?>

                                                    <td><select <?php echo e($ActionStatus); ?> name="DESIGNID_REF" id="DESIGNID_REF" class="form-control mandatory">                                                          
                                                      <?php
                                                    ...
                                                    <?php } ?>                                                           
                                                      ...
                                                      <td align="center" ><button class="btn add TNC" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip"  type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove DTNC" <?php echo e($ActionStatus); ?> title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                  </tr>
                                                <tr></tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                <?php else: ?>
                                ...
                                <div id="udf" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:500px;width:50%;">
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                        <?php if(!empty($objSQUDF)): ?>
                                            <?php $__currentLoopData = $objSQUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupUDFSQID_".$Ukey); ?> id=<?php echo e("popupUDFSQID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFSQID_REF_".$Ukey); ?>  id=<?php echo e("UDFSQID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFSQID_REF); ?>" autocomplete="off" /></td>
                                                    ...
                                                    <td align="center" ><button class="btn add UDF" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove DUDF" <?php echo e($ActionStatus); ?> title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                        <?php else: ?>
                                            <?php $__currentLoopData = $objUdfSQData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupUDFSQID_".$uindex); ?> id=<?php echo e("popupUDFSQID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFSQID_REF_".$uindex); ?> id=<?php echo e("UDFSQID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFSQID); ?>" autocomplete="off"   /></td>
                                ...
                                <div id="CT" class="tab-pane fade">
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <div class="col-lg-2 pl">
                                        <input type="text" <?php echo e($ActionStatus); ?> name="txtCTID_popup" id="txtCTID_popup" class="form-control"  autocomplete="off"  readonly/>
                                        <?php if(!empty($objSQCAL)): ?>
                                         <input type="hidden" name="CTID_REF" id="CTID_REF" class="form-control" value="<?php echo e($objSQCAL[0]->CTID_REF); ?>" autocomplete="off" />
                                         <?php else: ?>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y" style="height:240px;margin-top:10px;" >
                                        <table id="example5" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                                <tr>
                                                    <th>Calculation Component<input class="form-control" type="hidden" name="Row_Count4" id ="Row_Count4" value="<?php echo e($objCount4); ?>"></th>
                                                    <th>Rate</th>
                                                    <th>Value</th>
                                            ...
                                            <tbody id="tbody_ctid">
                                            <?php if(!empty($objSQCAL)): ?>
                                                <?php $__currentLoopData = $objSQCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("popupTID_".$Ckey); ?> id=<?php echo e("popupTID_".$Ckey); ?>  value="<?php echo e($Crow->COMPONENT); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("VALUE_".$Ckey); ?> id=<?php echo e("VALUE_".$Ckey); ?> class="form-control" value="<?php echo e($Crow->VALUE); ?>" readonly /></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("calSGST_".$Ckey); ?> id=<?php echo e("calSGST_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->SGST); ?>" readonly/></td>
                                                        ...
                                                        <td hidden><input type="hidden" name=<?php echo e("calkey_".$Ckey); ?> id=<?php echo e("calkey_".$Ckey); ?> value="<?php echo e($Ckey); ?>" class="form-control" autocomplete="off"  /></td>
                                                        ...
                                                        <td align="center" ><button class="btn add" <?php echo e($ActionStatus); ?> title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" <?php echo e($ActionStatus); ?> title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                    </tr>
                                                    <tr></tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                <?php else: ?>
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td><input type="text" name="RATE_0" <?php echo e($ActionStatus); ?> id="RATE_0" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                                                    ...
                                                    <td style="text-align:center;" ><input type="checkbox" <?php echo e($ActionStatus); ?> class="filter-none" name="calGST_0" id="calGST_0" value="" ></td>
                                                    ...
                                                    <td hidden><input type="hidden" <?php echo e($ActionStatus); ?> name="calkey_0" id="calkey_0" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="TNCnamesearch" class="form-control" onkeyup="TNCNameFunction()">
      ...
      <table id="TNCIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="tnc[]" id="tncidcode_<?php echo e($tncindex); ?>" class="clstncid" value="<?php echo e($tncRow-> TNCID); ?>" ></td>
          <td style="width:30%"><?php echo e($tncRow-> TNC_CODE); ?>

          <input type="hidden" id="txttncidcode_<?php echo e($tncindex); ?>" data-desc="<?php echo e($tncRow-> TNC_CODE); ?> - <?php echo e($tncRow-> TNC_DESC); ?>"  
          value="<?php echo e($tncRow-> TNCID); ?>"/></td><td style="width:60%"><?php echo e($tncRow-> TNC_DESC); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="CTIDnamesearch" class="form-control" onkeyup="CTIDNameFunction()">
      ...
      <table id="CTIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="calculationtemplate[]" id="CTIDcode_<?php echo e($calindex); ?>" class="clsctid" value="<?php echo e($calRow-> CTID); ?>" ></td>
          <td style="width:30%;"><?php echo e($calRow-> CTCODE); ?>

          <input type="hidden" id="txtCTIDcode_<?php echo e($calindex); ?>" data-desc="<?php echo e($calRow-> CTCODE); ?> - <?php echo e($calRow-> CTDESCRIPTION); ?>"  
          value="<?php echo e($calRow-> CTID); ?>"/></td><td style="width:60%;"><?php echo e($calRow-> CTDESCRIPTION); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="currencynamesearch" class="form-control" onkeyup="CurrencyNameFunction()">
      ...
      <table id="CurrencyTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="currencytype[]" id="cridcode_<?php echo e($crindex); ?>" class="clscrid" value="<?php echo e($crRow-> CRID); ?>" ></td>
          <td style="width:30%"><?php echo e($crRow-> CRCODE); ?>

          <input type="hidden" id="txtcridcode_<?php echo e($crindex); ?>" data-desc="<?php echo e($crRow-> CRCODE); ?>-<?php echo e($crRow-> CRDESCRIPTION); ?>"  value="<?php echo e($crRow-> CRID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($crRow-> CRDESCRIPTION); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="UDFSQIDnamesearch" onkeyup="UDFSQIDNameFunction()">
      ...
      <table id="UDFSQIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objUdfSQData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfindex=>$udfRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="UDFSQID_<?php echo e($udfindex); ?>" class="clsudfsqid">
          <td width="50%"><?php echo e($udfRow->LABEL); ?>

          <input type="hidden" id="txtudfsqid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->UDFSQID); ?>"/>
          </td>
      ...
      $(".clstncid").click(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"gettncdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"gettncdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"gettncdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
      ...
      $(".clsctid").click(function(){
        ...
        if(customid!=''){
          ...
          $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"getcalculationdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"getcalculationdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $('#Row_Count4').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[36,"getcalculationdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            var customid = txtval;
              if(customid!=''){
                $("#CREDITDAYS").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getcreditdays"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#CREDITDAYS").val(data);                        
                ...
                $("#BILLTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getBillTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtBILLTO1").hide();
                  ...
                  $("#tbody_BillTo").html('');
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getBillAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getShipTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                  ...
                  $("#tbody_ShipTo").html('');
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getShipAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getsalesenquiry"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#tbody_SE").html(data);
...
function loadItem(taxstate,CODE,NAME,MUOM,GROUP,CTGRY,BUNIT,APART,CPART,OPART,FORMID){
    ...
    var SQDT=$("#SQDT").val(); 
		$.ajax({
          url:'<?php echo e(route("transaction",[36,"getItemDetails"])); ?>',
          type:'POST',
...
$('#Material').on('click','[id*="popupITEMID"]',function(event){
  ...
  if($("#DirectSQ").is(":checked") == false && LEAD_REF ===""){
    ...
    if(SalesEnquiryID ===""){
      ...
      $.ajax({
        url:'<?php echo e(route("transaction",[36,"getItemDetailsEnquirywise"])); ?>',
        type:'POST',
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[36,"getItemDetails_lead"])); ?>',
      type:'POST',
  ...
  $('#Material').on('click','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[36,"getAltUOM"])); ?>',
                      type:'POST',
...
//add row
  ...
  window.fnUndoYes = function (){
    ...
    //reload form
    window.location.href = "<?php echo e(route('transaction',[36,'add'])); ?>";
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[36,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[36,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
            ...
            if(QUOTATIONTYPE === "")
            {
              ...
              var CUSTPROSCTID  = $("#CUSTOMER_PROSPECT").val();
                ...
                $("#Dataresult").html('');
                  ...
                  $("#Data_seach").show();
                  $.ajax({
                      url:'<?php echo e(route("transaction",[$FormId,"get_Lead"])); ?>',
                      type:'POST',
...
var click_button="clssSTRid";
  ...
  $.ajax({
      url:'<?php echo e(route("transaction",[$FormId,"get_Price"])); ?>',
      type:'POST',
...
if(altuomid !='' && id === "ALT_UOMID_QTY_"+index){
            ...
            $.ajax({
              url:'<?php echo e(route("transaction",[36,"getmainuomqty"])); ?>',
              type:'POST',
...
$.ajax({
    url:'<?php echo e(route("transaction",[36,"get_delear_customer_price"])); ?>',
    type:'POST',
    data:{
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesQuotation_20221117\trnfrm36view.blade.php ENDPATH**/ ?>