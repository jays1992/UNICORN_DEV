          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->OT_DESC); ?></label>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                    <label> <?php echo e($objResponse->OT_RATE); ?> </label>
                  </div>
                  <div class="col-lg-2 pl"><p>Factor</p></div>
                  <div class="col-lg-1 pl">
                    <label> <?php echo e($objResponse->OT_FACTOR); ?> </label>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\OverTime\mstfrm193view.blade.php ENDPATH**/ ?>