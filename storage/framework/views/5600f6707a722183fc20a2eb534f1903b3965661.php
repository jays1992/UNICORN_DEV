      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <?php if(isset($objSON->SYSTEM_GRSR) && $objSON->SYSTEM_GRSR == "1"): ?>
            <input type="text" name="KNOCKOFF_NO" id="KNOCKOFF_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" value class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
            <input type="text" name="KNOCKOFF_NO" id="KNOCKOFF_NO" value="<?php echo e(old('KNOCKOFF_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objSON->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="KNOCKOFF_DT" id="KNOCKOFF_DT" value="<?php echo e(date('Y-m-d')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\KnowkOff\trnfrm313add.blade.php ENDPATH**/ ?>