...
<div class="container-fluid purchase-order-view filter">     
  <form id="master_form" method="POST"> 
    <?php echo csrf_field(); ?>
    <?php echo e(isset($HDR->PID) ? method_field('PUT') : ''); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="REGCTRYID_REF" id="REGCTRYID_REF" onchange="getstate(this.value,'REGSTID_REF','REGCITYID_REF','')" class="form-control mandatory">
            ...
            <option <?php echo e(isset($HDR->REGCTRYID_REF) && $HDR->REGCTRYID_REF == $val->CTRYID?'selected="selected"':''); ?> value="<?php echo e($val->CTRYID); ?>"><?php echo e($val->NAME); ?></option>
        ...
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="REGSTID_REF" id="REGSTIDREF" onchange="getcity(this.value,'REGCITYID_REF','')" class="form-control mandatory">
            ...
            <option <?php echo e(isset($HDR->REGSTID_REF) && $HDR->REGSTID_REF == $val->STID?'selected="selected"':''); ?> value="<?php echo e($val->STID); ?>"><?php echo e($val->NAME); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>                            
        </div>
        ...
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="REGCITYID_REF" id="REGCITYIDREF" class="form-control mandatory">
            ...
            <option <?php echo e(isset($HDR->REGCITYID_REF) && $HDR->REGCITYID_REF == $val->CITYID?'selected="selected"':''); ?> value="<?php echo e($val->CITYID); ?>"><?php echo e($val->NAME); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select> 
        </div>
          ...
          <div id="DetailBlock" class="tab-pane fade in active">
            <div class="inner-form">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="CORPCTRYID_REF" id="CORPCTRYID_REF" onchange="getstate(this.value,'CORPSTID_REF','CORPCITYID_REF','')" class="form-control mandatory">
                    ...
                    <?php if(isset($country) && !empty($country)): ?>
                    <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(isset($HDR->CORPCTRYID_REF) && $HDR->CORPCTRYID_REF == $val->CTRYID?'selected="selected"':''); ?> value="<?php echo e($val->CTRYID); ?>"><?php echo e($val->NAME); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </select>                           
                </div>
                ...
                <div class="col-lg-1 pl"><p>State</p></div>
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="CORPSTID_REF" id="CORPSTIDREF" onchange="getcity(this.value,'CORPCITYID_REF','')" class="form-control mandatory">
                    <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(isset($MAT->CORPSTID_REF) && $MAT->CORPSTID_REF == $val->STID?'selected="selected"':''); ?> value="<?php echo e($val->STID); ?>"><?php echo e($val->NAME); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>                            
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-1 pl"><p>City</p></div>
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="CORPCITYID_REF" id="CORPCITYIDREF" class="form-control mandatory">
                    <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(isset($MAT->CORPCITYID_REF) && $MAT->CORPCITYID_REF == $val->CITYID?'selected="selected"':''); ?> value="<?php echo e($val->CITYID); ?>"><?php echo e($val->NAME); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select> 
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\ProspectMaster\mstfrm441view.blade.php ENDPATH**/ ?>