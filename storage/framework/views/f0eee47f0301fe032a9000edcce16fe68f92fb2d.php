...
<div class="row">
		<div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Energy Meter Consumption</a></div>
...
<form id="edit_trn_form" method="POST"  >
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                  ...
                  <input type="text" name="EMC_NO" id="EMC_NO" disabled value="<?php echo e($objResponse->EMC_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              ...
              <div class="col-lg-2 pl">
                  <input type="date" name="EMC_DATE" id="EMC_DATE" disabled value="<?php echo e($objResponse->EMC_DATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
              </div>
             ...
             <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      ...
                      <input type="text"  name="EnergyMeter_popup" disabled id="txtEnergyMeter_popup" class="form-control mandatory" value="<?php echo e($objResponse->METER_CODE); ?>"  autocomplete="off"  readonly/>
                      <input type="hidden" name="ENERGYID_REF" id="ENERGYID_REF" class="form-control" value="<?php echo e($objResponse->ENERGYID_REF); ?>"  autocomplete="off" />
                    ...
                    <div class="col-lg-2 pl">
                      <input type="text" name="METER_DESC" id="METER_DESC" disabled class="form-control mandatory"  value="<?php echo e($objResponse->METER_DESC); ?>" readonly maxlength="200"  />
              ...
              <div class="col-lg-2 pl"><p>From Date</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="FROMDATE" disabled class="form-control " id="FROMDATE" value="<?php echo e($objResponse->FROM_DATE); ?>"  placeholder="dd/mm/yyyy"  />
                </div>
                  <div class="col-lg-2 pl"><p>To Date</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="TODATE" disabled class="form-control " id="TODATE" value="<?php echo e($objResponse->TO_DATE); ?>"  placeholder="dd/mm/yyyy"  />
                </div>
              </div>
              ...
              <div class="col-lg-2 pl"><p>Power Factor</p></div>
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="POWER_FACTOR" disabled id="POWER_FACTOR" class="form-control " value="<?php echo e($objResponse->POWER_FACTOR); ?>" readonly autocomplete="off" maxlength="100" />                 
                  </div>
                <div class="col-lg-2 pl"><p>Meter Company</p></div>
                <div class="col-lg-2 pl">                 
                  <input type="text" name="METER_COMPANY" disabled id="METER_COMPANY" class="form-control " value="<?php echo e($objResponse->METER_COMPANY); ?>"  readonly autocomplete="off" maxlength="100" />                 
                </div>
            ...
            <div class="col-lg-2 pl"><p>Brand</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="BRAND" id="BRAND" disabled class="form-control " readonly value="<?php echo e($objResponse->BRAND); ?>" autocomplete="off" maxlength="100" />
                </div>
              <div class="col-lg-2 pl"><p>Model</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="MODEL" id="MODEL" disabled class="form-control " readonly value="<?php echo e($objResponse->MODEL); ?>" autocomplete="off" maxlength="100" />
              </div>
            ...
            <div class="col-lg-2 pl"><p>Serial No</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SERIAL_NO" id="SERIAL_NO" disabled class="form-control " value="<?php echo e($objResponse->SERIAL_NO); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
              <div class="col-lg-2 pl"><p>Load Sanction</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SANCTION_LOAD" id="SANCTION_LOAD" disabled class="form-control " value="<?php echo e($objResponse->SANCTION_LOAD); ?>" readonly  autocomplete="off" maxlength="50" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_STARTED" id="KWH_STARTED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_START_KWH); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_ENDED" id="KWH_ENDED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_END_KWH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KWH_CONSUMED" id="KWH_CONSUMED" disabled class="form-control " value="<?php echo e($CONSUME1); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_STARTED" id="KVARH_STARTED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_START_KVARH); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_ENDED" id="KVARH_ENDED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_END_KVARH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KVARH_CONSUMED" id="KVARH_CONSUMED" disabled class="form-control " value="<?php echo e($CONSUME2); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl"> 
                <input type="text" name="KVAH_STARTED" id="KVAH_STARTED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_START_KVAH); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="KVAH_ENDED" id="KVAH_ENDED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_END_KVAH); ?>"  autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="KVAH_CONSUMED" id="KVAH_CONSUMED" disabled class="form-control" value="<?php echo e($CONSUME3); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="MD_STARTED" id="MD_STARTED" disabled class="form-control " value="<?php echo e($objResponse->METER_READING_START_MD); ?>" readonly autocomplete="off" maxlength="20" />
              </div>
             
              <div class="col-lg-2 pl">
                <input type="text" name="MD_ENDED" id="MD_ENDED" disabled class="form-control "  value="<?php echo e($objResponse->METER_READING_END_MD); ?>" autocomplete="off" maxlength="20" />
              </div>
  
              <div class="col-lg-2 pl">
                <input type="text" name="MD_CONSUMED" id="MD_CONSUMED" disabled class="form-control " value="<?php echo e($CONSUME4); ?>" readonly  autocomplete="off" maxlength="20" />
              </div>
            ...
            <div class="row">
              ...
              <select  class="form-control" disabled name="drpstatus" id="drpstatus" > 
                    ...
                    <option value="Ok" <?php echo e(isset($objResponse) && $objResponse->RUNNING_STATUS=='Ok'?'selected':''); ?>>Ok</option>
                    <option value="Stopped"  <?php echo e(isset($objResponse) && $objResponse->RUNNING_STATUS=='Stopped'?'selected':''); ?>>Stopped</option>
                  </select>  
              </div>
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="REMARKS" id="REMARKS" disabled class="form-control " value="<?php echo e($objResponse->REMARKS); ?>"  autocomplete="off" maxlength="20" />
              </div>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Meternamesearch" class="form-control" onkeyup="MeterNameFunction()">
      ...
      <table id="MeterTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody >   
        <?php if(!empty($objEnergy)): ?>
   
        <?php $__currentLoopData = $objEnergy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$objEnergyRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
    
          
        <td style="text-align:center; width:10%"> <input type="checkbox" name="complaints[]" id="departmentidcode_<?php echo e($index); ?>" class="clsspid_meters"  value="<?php echo e($objEnergyRow->ENERGYID); ?>" ></td>

          <td style="width:30%"><?php echo e($objEnergyRow->METER_CODE); ?>

          <input type="hidden" id="txtdepartmentidcode_<?php echo e($index); ?>"
           data-code="<?php echo e($objEnergyRow->METER_CODE); ?>"
           data-desc="<?php echo e($objEnergyRow->METER_DESC); ?>"
           data-power_factor="<?php echo e($objEnergyRow->POWER_FACTOR); ?>"
           data-meter_company="<?php echo e($objEnergyRow->METER_COMPANY); ?>"
           data-brand="<?php echo e($objEnergyRow->BRAND); ?>"
           data-model="<?php echo e($objEnergyRow->MODEL); ?>"
           data-serialno="<?php echo e($objEnergyRow->SERIAL_NO); ?>"
           data-section_load="<?php echo e($objEnergyRow->SANCTION_LOAD); ?>"


           
           value="<?php echo e($objEnergyRow->ENERGYID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($objEnergyRow-> METER_DESC); ?> </td>
        </tr>
...
$.ajax({
  url:'<?php echo e(route("transaction",[$FormId,"get_meter_details"])); ?>',
  type:'POST',
  data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\EnergyMeterConsumption\trnfrm368view.blade.php ENDPATH**/ ?>