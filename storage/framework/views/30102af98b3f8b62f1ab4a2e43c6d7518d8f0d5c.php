...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MRSID); ?>" value="<?php echo e($val->MRSID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MRS_DT) && $val->MRS_DT !='' && $val->MRS_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MRS_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->MRS_NO) && $val->MRS_NO !=''?$val->MRS_NO:''); ?></td>
                <td><?php echo e(isset($val->MRS_DT) && $val->MRS_DT !='' && $val->MRS_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MRS_DT)):''); ?></td>
                <td><?php echo e(isset($val->MRS_TYPE) && $val->MRS_TYPE !=''?$val->MRS_TYPE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialRequisitionSlip\trnfrm88.blade.php ENDPATH**/ ?>