<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[133,'index'])); ?>" class="btn singlebt">Currency Master</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[133,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->CRID); ?>" value="<?php echo e($val->CRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->CRCODE) && $val->CRCODE !=''?$val->CRCODE:''); ?></td>
              <td><?php echo e(isset($val->CRDESCRIPTION) && $val->CRDESCRIPTION !=''?$val->CRDESCRIPTION:''); ?></td>
        ...
        <form id="masterForm133Print" action="<?php echo e(route('mastergetlist',[133,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[133,"add"])); ?>';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[133,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[133,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[133,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[133,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                            window.location.href="<?php echo e(route('master',[133,'index'])); ?>";
                        }               
                    },
                    error:function(data){
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[133,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\CurrencyMaster\mstfrm133.blade.php ENDPATH**/ ?>