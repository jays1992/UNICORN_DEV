...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[250,'index'])); ?>" class="btn singlebt">Sales Service Order Register</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_sos"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            <div class="col-lg-3 pl"><p>Sales Service Order</p></div>
                            <div class="col-lg-3 pl" id="div_ssoid">
                                <select name="SSOID[]" id="SSOID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjSSONO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->SSOID); ?>" selected><?php echo e($GRow->SSO_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>                            
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[250,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SSOID = [];
        $("select[name='SSOID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                SSOID.push(value5);
            }
        ...
        else if(SSOID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Sales Service Order.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[250,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesServiceOrderRegister\rptfrm250.blade.php ENDPATH**/ ?>