...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[352,'index'])); ?>" class="btn singlebt">Bill of Material Checklist</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_bom"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>BOM NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="BOMID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="BOMID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objBOMNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Bindex=>$BRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($BRow->BOMID); ?>" selected><?php echo e($BRow->BOM_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[352,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var BOMID  = [];
        $("select[name='BOMID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                BOMID.push(value7);
            }
        ...
        else if(BOMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[352,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\BOM_Checklist\rptfrm352.blade.php ENDPATH**/ ?>