  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="BRC_NO" id="BRC_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
         
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
          <input type="text" name="BRC_NO" id="BRC_NO" value="<?php echo e(old('BRC_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BRC_DT" id="BRC_DT" value="<?php echo e(old('BRC_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\Barcode\trnfrm418add.blade.php ENDPATH**/ ?>