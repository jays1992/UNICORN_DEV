...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">AR Debit / Credit Note</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->ARDRCRID); ?>" value="<?php echo e($val->ARDRCRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->AR_DOC_DT) && $val->AR_DOC_DT !=''?$val->AR_DOC_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->AR_DOC_NO) && $val->AR_DOC_NO !=''?$val->AR_DOC_NO:''); ?></td>
                <td><?php echo e(isset($val->AR_DOC_DT) && $val->AR_DOC_DT !=''?$val->AR_DOC_DT:''); ?></td>
                <td><?php echo e(isset($val->SGLCODE) && $val->SGLCODE !==''?$val->SGLCODE:''); ?></td>
                <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !==''?$val->SLNAME:''); ?></td>
                <td><?php echo e(isset($val->AR_TYPE) && $val->AR_TYPE !=''?$val->AR_TYPE:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>AR Voucher Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'PO='+ POID + '&ARDRCRID='+ POID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ARDebitNote\trnfrm233.blade.php ENDPATH**/ ?>