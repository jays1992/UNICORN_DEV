...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[199,'index'])); ?>" class="btn singlebt">Calculation Basis</a>
                </div><!--col-2-->
...
<?php echo csrf_field(); ?>
    <?php echo e(isset($objHeader->CAL_BASISID) ? method_field('PUT') : ''); ?>
  ...
  <div class="row">
            ...
            <input type="text" name="BASIS_DOC_NO" id="BASIS_DOC_NO" disabled  class="form-control mandatory" value="<?php echo e($objHeader->BASIS_DOC_NO); ?>"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >   
            ...
            <div class="col-lg-2 pl">
            <input type="date" name="BASIS_DOC_DT" id="BASIS_DOC_DT" disabled value="<?php echo e($objHeader->BASIS_DOC_DT); ?>" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy"/>
            </div>
        </div>
  ...
  <div class="row">
            ...
            <div class="col-lg-2 pl"> 
     <input type="checkbox"   name="DEACTIVATED" disabled  id="deactive-checkbox_0" <?php echo e($objHeader->DEACTIVATED == 1 ? "checked" : ""); ?>

                 value='<?php echo e($objHeader->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2"  >
            ...
            <div class="col-lg-2 pl">
            <input type="date" name="DODEACTIVATED" disabled class="form-control" id="DODEACTIVATED" <?php echo e($objHeader->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objHeader->DODEACTIVATED) && $objHeader->DODEACTIVATED !="" && $objHeader->DODEACTIVATED !="1900-01-01" ? $objHeader->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  />
            </div>
        </div>
  ...
  <div class="row">
    ...
    <div class="tab-content">
                                  ...
                                  <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:450px;margin-top:10px;" >
                                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                          <thead id="thead1"  style="position: sticky;top: 0">
                                                  ...
                                                  <th>Earning Head Code	 <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>"> </th>
            ...
            <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                      ...
                      <td><input  type="text" disabled name=<?php echo e("txtEH_popup_".$key); ?> id=<?php echo e("txtEH_popup_".$key); ?> value="<?php echo e($row->EARNING_HEADCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                          <td  hidden><input type="text" disabled name=<?php echo e("EHID_REF_".$key); ?> id=<?php echo e("EHID_REF_".$key); ?> value="<?php echo e($row->EARNING_HEADID_REF); ?>"  class="form-control" autocomplete="off" /></td>                          
                          <td><input type="text"  name=<?php echo e("EH_REF_".$key); ?> id=<?php echo e("EH_REF_".$key); ?> value="<?php echo e($row->EARNING_HEAD_DESC); ?>" class="form-control"  autocomplete="off"  readonly /></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("PF_".$key); ?> id=<?php echo e("PF_".$key); ?> <?php echo e($row->PF == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled  name=<?php echo e("VPF_".$key); ?> id=<?php echo e("VPF_".$key); ?> <?php echo e($row->VPF == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("ESI_".$key); ?> id=<?php echo e("ESI_".$key); ?> <?php echo e($row->ESI == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Bonus_".$key); ?> id=<?php echo e("Bonus_".$key); ?> <?php echo e($row->BONUS == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("OT_".$key); ?> id=<?php echo e("OT_".$key); ?> <?php echo e($row->OT == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Gratuity_".$key); ?> id=<?php echo e("Gratuity_".$key); ?> <?php echo e($row->GRATUITY == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Welfare_Fund_".$key); ?> id=<?php echo e("Welfare_Fund_".$key); ?> <?php echo e($row->WELFARE_FUND == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"  disabled name=<?php echo e("TDS_".$key); ?> id=<?php echo e("TDS_".$key); ?> <?php echo e($row->TDS == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("PT_".$key); ?> id=<?php echo e("PT_".$key); ?> <?php echo e($row->PT == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox"   disabled name=<?php echo e("LWP_".$key); ?> id=<?php echo e("LWP_".$key); ?> <?php echo e($row->LWP == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Earned_Leave_".$key); ?> id=<?php echo e("Earned_Leave_".$key); ?> <?php echo e($row->EARNED_LEAVE == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Incentive_".$key); ?> id=<?php echo e("Incentive_".$key); ?> <?php echo e($row->INCENTIVE == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("Super_Anuation_".$key); ?> id=<?php echo e("Super_Anuation_".$key); ?> <?php echo e($row->SUPER_ANNUATION == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("OTHER1_".$key); ?> id=<?php echo e("OTHER1_".$key); ?> <?php echo e($row->OTHER1 == 1 ? 'checked' : ''); ?>   ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("OTHER2_".$key); ?> id=<?php echo e("OTHER2_".$key); ?> <?php echo e($row->OTHER2 == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("OTHER3_".$key); ?> id=<?php echo e("OTHER3_".$key); ?> <?php echo e($row->OTHER3 == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled name=<?php echo e("OTHER4_".$key); ?> id=<?php echo e("OTHER4_".$key); ?> <?php echo e($row->OTHER4 == 1 ? 'checked' : ''); ?>  ></td>
                            <td style="text-align:center; width: 81px;"><input type="checkbox" disabled   name=<?php echo e("OTHER5_".$key); ?> id=<?php echo e("OTHER5_".$key); ?> <?php echo e($row->OTHER5 == 1 ? 'checked' : ''); ?>  ></td>    
...
var fieldid = $(this).parent().parent().find('[id*="EHID_REF"]').attr('id');
  ...
  $.ajax({
      url:'<?php echo e(route("master",[199,"get_EarningHead"])); ?>',
      type:'POST',
...
$('#btnAdd').on('click', function() {
  var viewURL = '<?php echo e(route("master",[199,"add"])); ?>';
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[199,"update"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[199,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
          if(data.errors) {
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("master",[199,"index"])); ?>';
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\Calculation_Basis\mstfrm199view.blade.php ENDPATH**/ ?>