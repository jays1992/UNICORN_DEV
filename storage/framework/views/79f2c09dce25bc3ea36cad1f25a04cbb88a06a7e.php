         ...
         <form id="frm_mst_state" method="POST"  > 
          ...
          <div class="inner-form">
				...
				<div class="row">
					...
					<div class="col-lg-1 pl">
						<select name="CTRYID_REF" id="CTRYID_REF" class="form-control mandatory" onchange="getCountryName(this.value)" tabindex="1"  >
							...
							<option <?php echo e(isset($objCountry->CTRYID_REF) && $objCountry->CTRYID_REF ==$countryList->CTRYID?"selected='selected'":""); ?>  value="<?php echo e($countryList->CTRYID); ?>"><?php echo e($countryList->CTRYCODE); ?></option>
              ...
              <div class="row">
                ...
                <?php echo e($objCountry->DEACTIVATED == 1 ? "" : "disabled"); ?>

                   tabindex="9" value="<?php echo e((is_null($objCountry->DODEACTIVATED) || $objCountry->DODEACTIVATED=='1900-01-01' )?'':
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\state\mstfrm3edit.blade.php ENDPATH**/ ?>