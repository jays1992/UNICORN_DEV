    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
              ...
              <th>Transporter Registered Address Line 1</th>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->TRANSPORTERID); ?>" value="<?php echo e($val->TRANSPORTERID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->TRANSPORTER_CODE) && $val->TRANSPORTER_CODE !=''?$val->TRANSPORTER_CODE:''); ?></td>
              <td><?php echo e(isset($val->TRANSPORTER_NAME) && $val->TRANSPORTER_NAME !=''?$val->TRANSPORTER_NAME:''); ?></td>
              <td><?php echo e(isset($val->REG_ADD1) && $val->REG_ADD1 !=''?$val->REG_ADD1:''); ?></td>
              <td><?php echo e(isset($val->CP_NAME) && $val->CP_NAME !=''?$val->CP_NAME:''); ?></td>
        ...
        <form id="masterForm34Print" action="<?php echo e(route('mastergetlist',[34,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<style>
  #custom_dropdown, #transportermst_filter {
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[34,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[34,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[34,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[34,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[34,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\TRANSPORTER\mstfrm34.blade.php ENDPATH**/ ?>