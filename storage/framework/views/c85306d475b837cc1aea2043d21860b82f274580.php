              ...
              <div class="inner-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
						<input type="hidden" name="ROID" id="ROID" value="<?php echo e(isset($objRO->ROID)?$objRO->ROID:0); ?>" />
                        <input <?php echo e($InputStatus); ?> type="text" name="RONO" id="RONO" value="<?php echo e(isset($objRO->RONO)?$objRO->RONO:''); ?>" class="form-control mandatory" maxlength="150" autocomplete="off" style="text-transform:uppercase" autofocus  >
                    </div>
                    
                    <div class="col-lg-2 pl"><p>Release Order Date</p></div>
                    <div class="col-lg-2 pl">
                        <input <?php echo e($InputStatus); ?> type="date" name="RODT" id="RODT" onchange="checkPeriodClosing(315,this.value,1)"  value="<?php echo e(isset($objRO->RODT)?$objRO->RODT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ReleaseOrder\trnfrm315edit.blade.php ENDPATH**/ ?>