       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Employee Target Type</p></div>
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="EMPTARGETTYPE" id="EMPTARGETTYPE" class="form-control"  autocomplete="off">
   ...
   function validateSingleElemnet(element_id){
     var validator =$("#frm_mst_edit" ).validate();
        if(validator.element( "#"+element_id+"" )){
         if(element_id=="EMPLOYEE_TARGETCODE" || element_id=="EMPLOYEE_TARGETCODE" ) {
           checkDuplicateCode();
         }
        }
     }
   ...
   function checkDuplicateCode(){
       ...
       $.ajax({
           ...
           success:function(data) {
             if(data.exists) {
               $(".text-danger").hide();
               showError('ERROR_EMPLOYEE_TARGETCODE',data.msg);
               $("#EMPLOYEE_TARGETCODE").focus();
               }                                
           },
           error:function(data){
             console.log("Error: Something went wrong.");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\EmployeeTargetMaster\mstfrm435view.blade.php ENDPATH**/ ?>