  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="ST_ST_DOCNO" id="ST_ST_DOCNO" value="<?php echo e(isset($objResponse->ST_ST_DOCNO) && $objResponse->ST_ST_DOCNO !=''?$objResponse->ST_ST_DOCNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			  ...
			  <div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="ST_ST_DOCDT" id="ST_ST_DOCDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->ST_ST_DOCDT) && $objResponse->ST_ST_DOCDT !=''?$objResponse->ST_ST_DOCDT:''); ?>" class="form-control mandatory" >
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockToStockTransafer\trnfrm378edit.blade.php ENDPATH**/ ?>