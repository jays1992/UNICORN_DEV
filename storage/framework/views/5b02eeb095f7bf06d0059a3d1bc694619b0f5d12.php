    ...
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input disabled  type="text" name="SALARY_STRUC_NO" id="SALARY_STRUC_NO" value="<?php echo e(isset($HDR->SALARY_STRUC_NO)?$HDR->SALARY_STRUC_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"> 
        </div>
        
        <div class="col-lg-2 pl"><p>Description</p></div>
        <div class="col-lg-2 pl">
          <input disabled type="text" name="SALARY_STRUC_DESC" id="SALARY_STRUC_DESC" value="<?php echo e(isset($HDR->SALARY_STRUC_DESC)?$HDR->SALARY_STRUC_DESC:''); ?>"  class="form-control mandatory" autocomplete="off" >
        </div>
      </div>
              ...
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                ...
                <tbody>
                  ...
                  <tr  class="participantRow1">
                    ...
                    <td>
                      <select disabled name="HEAD_TYPE_<?php echo e($key); ?>" id="HEAD_TYPE_<?php echo e($key); ?>" class="form-control"  autocomplete="off" onchange="select_head_type(this.id)" >
                    ...
                    <td><input disabled  type="text" name="EARNING_HEADID_CODE_<?php echo e($key); ?>" id="EARNING_HEADID_CODE_<?php echo e($key); ?>" value="<?php echo e(isset($row['HEADCODE'])?$row['HEADCODE']:''); ?>" class="form-control"  autocomplete="off" onclick="select_data(this.id)"  readonly  /></td>
                    ...
                    <td><input disabled type="text" name="EARNING_HEADID_DESC_<?php echo e($key); ?>" id="EARNING_HEADID_DESC_<?php echo e($key); ?>" value="<?php echo e(isset($row['HEADDESC'])?$row['HEADDESC']:''); ?>"  class="form-control"  autocomplete="off"  readonly /></td>

                    <td><input disabled  type="text" name="EARNING_TYPEID_CODE_<?php echo e($key); ?>" id="EARNING_TYPEID_CODE_<?php echo e($key); ?>" value="<?php echo e(isset($row['TYPECODE'])?$row['TYPECODE']:''); ?> <?php echo e(isset($row['TYPEDESC'])?'-'.$row['TYPEDESC']:''); ?>" class="form-control"  autocomplete="off" readonly  /></td>
                    ...
                    <td><input disabled  type="text" name="SQ_NO_<?php echo e($key); ?>" id="SQ_NO_<?php echo e($key); ?>" value="<?php echo e($key+1); ?>" class="form-control"  autocomplete="off" readonly style="width:50px;" /></td>

                    <td>
                      <select disabled name="AMT_FORMULA_<?php echo e($key); ?>" id="FOR_TYPE_<?php echo e($key); ?>" class="form-control"  autocomplete="off" onchange="select_formula(this.id,this.value)" >
                        <option value="">Select</option>  
                    ...
                    <td><input disabled type="text" name="FORMULA_<?php echo e($key); ?>" id="FORMULA_<?php echo e($key); ?>" value="<?php echo e(isset($row['FORMULA'])?$row['FORMULA']:''); ?>" class="form-control"  autocomplete="off" readonly /></td>
                    <td><input disabled type="text" name="AMOUNT_<?php echo e($key); ?>" id="AMOUNT_<?php echo e($key); ?>" value="<?php echo e(isset($row['AMOUNT'])?$row['AMOUNT']:''); ?>" class="form-control"  autocomplete="off" onkeypress="return isNumberDecimalKey(event,this)" readonly  /></td>
                    <td><input disabled type="text" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e(isset($row['REMARKS'])?$row['REMARKS']:''); ?>" class="form-control"  autocomplete="off"/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\SalaryStructureMaster\mstfrm197view.blade.php ENDPATH**/ ?>