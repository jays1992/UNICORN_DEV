...
<script>
  ...
  $(document).ready(function(){
         ...
         var mststateTable =  $('#statemst').DataTable({
            ...
            initComplete: function() {
                      ...
                      $('.dataTables_filter input').bind('keyup', function(e){
                          ...
                          if (code == 13) { 
                            mststateTable.search(this.value).draw();
                          }
                      });
                   },
            "ajax":{

                     "url": "<?php echo e(route('mastergetlist',[3,'getstates'])); ?>",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
      ...
      var htmlDD =  '<div id="custom_dropdown"><div id="countrymst_dropdown" class="dataTables_filter">'
        ...
        +'<option value="STCODE" > State Code </option>'
        +'<option value="NAME"> State Name </option>'
        +'<option value="STDCODE"> STD Code </option>'
        +'<option value="LANG"> Language </option>'
        +'<option value="NEWSC"> NEWSC India </option>'
        +'<option value="CAPITAL"> Capital </option>'
		+'<option value="STTYPE"> State/UT </option>'
        +'<option value="STATUS"> Status</option>'
        +'</select></div></div>';
      
          $( htmlDD ).insertBefore( "#statemst_wrapper #statemst_filter" ); 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\state\mstfrm3.blade.php ENDPATH**/ ?>