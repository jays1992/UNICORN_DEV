            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" >
                                <select name="TYPE" data-hide-disabled="hide" data-actions-box="true" id="TYPE" class="form-control selectpicker" data-live-search="true"  >
							...
							<div id="divdealer">
								<div class="col-lg-3 pl"><p>Dealer</p></div>
								<div class="col-lg-3 pl" >
									<select name="DEALER[]" data-hide-disabled="hide" multiple data-actions-box="true" id="DEALER" class="form-control selectpicker" multiple data-live-search="true"  >
									<?php $__currentLoopData = $Dealer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val->CID); ?>" selected><?php echo e($val->NAME); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
							<div id="divspid" style="display:none;">
								<div class="col-lg-3 pl"><p>Sales Person</p></div>
								<div class="col-lg-3 pl" >
									<select name="SPID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SPID" class="form-control selectpicker" multiple data-live-search="true"  >
									<?php $__currentLoopData = $SPID; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val->EMPID); ?>" selected><?php echo e($val->EMPNAME); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
...
$('#btnView').on('click', function() {
    ...
    var To_Date         = $('#To_Date').val();
        ...
        var DEALER = [];
        $("select[name='DEALER[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                DEALER.push(value3);
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesIncentive\rptfrm515.blade.php ENDPATH**/ ?>