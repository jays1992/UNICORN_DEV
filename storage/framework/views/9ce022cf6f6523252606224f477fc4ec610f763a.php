                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 pl">
                                <input type="text" name="PONO" id="PONO" value="<?php echo e($objPO->PO_NO); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-1 pl col-md-offset-1"><p>PO Date</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" value="<?php echo e($objPO->PO_DT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>From Department</p></div>
                            <div class="col-lg-1 pl">
                            <input type="text" name="DEPT_popup" id="txtdept_popup" class="form-control mandatory" value="<?php echo e($objdeptcode2->DCODE); ?>"  autocomplete="off" readonly/>
                            <input type="hidden" name="DEPT_REF" id="DEPT_REF" class="form-control" autocomplete="off" value="<?php echo e($objPO->DEPID_REF); ?>" />
                               
                            </div>
                            
                            <div class="col-lg-1 pl"><p>Vendor</p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="VENDOR_popup" id="txtvendor_popup" class="form-control mandatory" value="<?php echo e($objvendorcode->VCODE); ?>"  autocomplete="off" readonly/>
                                <input type="hidden" name="VENDORID_REF" id="VENDORID_REF" class="form-control" autocomplete="off"  value="<?php echo e($objPO->VID_REF); ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e($objPO->PO_VRF); ?>" >
                            </div>
                            
                            <div class="col-lg-1 pl"><p>To </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e($objPO->PO_VTO); ?>" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>Vendor Ref No </p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e($objPO->VENDOR_REF_NO); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-1 pl"><p>Credit Days</p></div>
                            <div class="col-lg-1 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e($objPO->CREDIT_DAYS); ?>">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e($objPO->BILLTO); ?>" />
                            </div>
                           
                            <div class="col-lg-1 pl"><p>Ship To</p></div>
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly  />
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e($objPO->SHIPTO); ?>" />
                                <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" autocomplete="off" value=" <?php echo e($TAXSTATE[0]); ?>"   />
                            </div>

                            <div class="col-lg-2 pl"><p>Vendor Ref Date </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="<?php echo e($objPO->VENDOR_REF_DT); ?>" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"  <?php if(strtolower($objPO->PO_BASED)=="direct"): ?>  checked="checked" <?php endif; ?>  >
                            </div>

                            <div class="col-lg-1 pl"><p>PO Based on</p></div>
                            <div class="col-lg-2 pl">
                              <select name="PO_BASED" id="PO_BASED" class="form-control"  <?php if($objPO->PO_BASED=="Direct"): ?>  disabled <?php endif; ?>>
                                <option value="" selected="selected">--Please select--</option>
                                <option value="PI" <?php if($objPO->PO_BASED=="PI"): ?> selected="selected" <?php endif; ?>>PI</option>
                                <option value="Quotation" <?php if($objPO->PO_BASED=="Quotation"): ?> selected="selected" <?php endif; ?> >Quotation</option>
                              </select>
                                            ...
                                            <?php if(!empty($objPOMAT)): ?>
                                                <?php $__currentLoopData = $objPOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("POMATID_".$key); ?> id =<?php echo e("POMATID_".$key); ?> maxlength="100" value="<?php echo e($row->POMATID); ?>" autocomplete="off"   >
                                                        </td>
                                                        <td style="text-align:center;" >
                                                        <input type="text" name=<?php echo e("txtPIVQ_popup_".$key); ?> id=<?php echo e("txtPIVQ_popup_".$key); ?> class="form-control"   autocomplete="off"   readonly style="width: 200px;"/></td>
                                                        <td  hidden><input type="text" name=<?php echo e("VQPINO_".$key); ?> id=<?php echo e("VQPINO_".$key); ?> class="form-control" value="<?php echo e($row->RFQPINO); ?>" autocomplete="off" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("DYNAMICID_REF_".$key); ?> id=<?php echo e("DYNAMICID_REF_".$key); ?> class="form-control" value="<?php echo e($row->RFQPINO); ?>" autocomplete="off" /></td>
                                                          
                                                        <td  hidden><input type="text" name=<?php echo e("PIID_REF_".$key); ?> id=<?php echo e("PIID_REF_".$key); ?> class="form-control" value="<?php echo e($row->PIID_REF); ?>" autocomplete="off" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("MRSID_REF_".$key); ?> id=<?php echo e("MRSID_REF_".$key); ?> class="form-control" value="<?php echo e($row->MRSID_REF); ?>" autocomplete="off" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("RFQID_REF_".$key); ?> id=<?php echo e("RFQID_REF_".$key); ?> class="form-control" value="<?php echo e($row->RFQID_REF); ?>" autocomplete="off" /></td>
                                                    
                                                       
                                                        <td><input type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control"  autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("Itemspec_".$key); ?> id=<?php echo e("Itemspec_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEMSPECI); ?>" /></td>
                                                        
                                                        <td><input type="text" name=<?php echo e("PI_VQMUOM_".$key); ?> id=<?php echo e("PI_VQMUOM_".$key); ?> class="form-control"  autocomplete="off"  value="<?php echo e($row->MUOM_DESC); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQMUOMQTY_".$key); ?> id=<?php echo e("PI_VQMUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->MUOM_QTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQAUOM_".$key); ?> id=<?php echo e("PI_VQAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALTUOM_DESC); ?>" readonly/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQAUOMQTY_".$key); ?> id=<?php echo e("PI_VQAUOMQTY_".$key); ?> class="form-control" maxlength="13" autocomplete="off" value="<?php echo e($row->ALTUOM_QTY); ?>"  readonly/></td>
                                                        
                                                        <td><input type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td ><input type="text" name=<?php echo e("PENDING_QTY_".$key); ?> id=<?php echo e("PENDING_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->CAL_PENDING_QTY); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("PO_QTY_".$key); ?> id=<?php echo e("PO_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo number_format(floatVal($row->PO_QTY),3,'.','');  ?>"  autocomplete="off"  /></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("PO_FQTY_".$key); ?> id=<?php echo e("PO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly/></td>
                                                        <td><input type="text" name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off"  readonly/></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("ALT_UOMID_REF_".$key); ?> id=<?php echo e("ALT_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALTUOMID_REF); ?>"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATEP_UOM); ?>"  autocomplete="off" /></td>
                                                        <td><input type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->DISCOUNT_PER); ?>"  autocomplete="off" style="width: 50px;" /></td>
                                                        <td><input type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DIS_AMT); ?>" maxlength="15"  autocomplete="off"  /></td>
                                                        <td><input type="text" name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input type="text" name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="TNCnamesearch" onkeyup="TNCNameFunction()">
      ...
      <table id="TNCIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="tncidcode_<?php echo e($tncindex); ?>" class="clstncid">
          <td width="50%"><?php echo e($tncRow-> TNC_CODE); ?>

          <input type="hidden" id="txttncidcode_<?php echo e($tncindex); ?>" data-desc="<?php echo e($tncRow-> TNC_CODE); ?> - <?php echo e($tncRow-> TNC_DESC); ?>"  
          value="<?php echo e($tncRow-> TNCID); ?>"/></td><td><?php echo e($tncRow-> TNC_DESC); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <input type="text" id="deptnamesearch" onkeyup="DEPTNameFunction()">
      ...
      <table id="DEPTCodeTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <?php $__currentLoopData = $objdeptcode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$dptRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="deptidcode_<?php echo e($index); ?>" class="clsdeptid">
          <td width="50%"><?php echo e($dptRow-> DCODE); ?>

          <input type="hidden" id="txtdeptidcode_<?php echo e($index); ?>" data-desc="<?php echo e($dptRow-> DCODE); ?>"  value="<?php echo e($dptRow-> DEPID); ?>"/>
          </td>
          <td><?php echo e($dptRow-> NAME); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseOrder\PurchaseOrder\trnfrm63edit_bkp.blade.php ENDPATH**/ ?>