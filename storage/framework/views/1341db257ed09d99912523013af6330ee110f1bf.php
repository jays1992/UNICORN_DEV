<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                        ...
                        <button id="btnSave"   class="btn topnavbt" disabled="disabled"><i class="fa fa-save"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  >       
        <?php echo csrf_field(); ?>
        <?php echo e(isset($HDR->ATTTNDID) ? method_field('PUT') : ''); ?>

       <div class="inner-form">              
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?>  type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e($HDR->DOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input <?php echo e($ActionStatus); ?>  type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e($HDR->DOCDATE); ?>" class="form-control"  maxlength="100" > 
                 </div>

               <div class="col-lg-2 pl"><p>Pay Period Code*</p></div>
                 <div class="col-lg-2 pl">
                   <select <?php echo e($ActionStatus); ?>  name="PAYPERIODID_REF" id="PAYPERIODID_REF" class="form-control mandatory" onchange="getPayPrName(this.value)" tabindex="4">
                     ...
                     <option <?php echo e(isset($HDR->PAYPERIODID_REF) && $HDR->PAYPERIODID_REF == $val-> PAYPERIODID ?'selected="selected"':''); ?> value="<?php echo e($val-> PAYPERIODID); ?>"><?php echo e($val->PAY_PERIOD_CODE); ?>-<?php echo e($val->PAY_PERIOD_DESC); ?></option>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input <?php echo e($ActionStatus); ?>  type="text" id="PAY_PERIOD_DESC" value="<?php echo e($HDR->PAY_PERIOD_DESC); ?>" class="form-control" readonly  maxlength="100" > 
                 </div>
                 <div class="col-lg-2 pl"><p>Shift *</p></div>
                    <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?>  type="text" name="TXTSHIFT" id="TXTSHIFT" value="<?php echo e($HDR->SHIFT_NAME); ?>"  class="form-control mandatory"  autocomplete="off" readonly/>
                    <input type="hidden" name="SHIFTID_REF" id="SHIFTID_REF" value="<?php echo e($HDR->SHIFTID_REF); ?>" class="form-control" autocomplete="off" />
                    ...
                    <div class="col-lg-2 pl">
                      <input <?php echo e($ActionStatus); ?>  type="time" id="DEFROMTIME" name="DEFROMTIME" value="<?php echo e($DEF_TIME_FROM); ?>"  class="form-control" readonly  maxlength="100" > 
                    </div>           
             </div>
             <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?>  type="time" id="DEFTOTIME" name="DEFTOTIME" value="<?php echo e($DEF_TIME_TO); ?>" class="form-control" readonly  maxlength="100" > 
                </div>
             </div>
                            ...
                            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                              ...
                              <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr  class="participantRow">
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="txtEMPID[]"    id=<?php echo e("txtEMPID_".$key); ?>   value="<?php echo e($row->EMPCODE); ?>"  autocomplete="off" readonly onclick="getEmployee(this.id)"/></td>
                                  <td hidden><input type="hidden" name="EMPID_REF[]"   id=<?php echo e("EMPID_REF_".$key); ?>    autocomplete="off" value="<?php echo e($row->EMPID_REF); ?>" /></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="FNAME[]"       id =<?php echo e("FNAME_".$key); ?>     value="<?php echo e($row->FNAME); ?>"   autocomplete="off" style="width: 99%" readonly></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="time" name="FROMTIME[]"    id =<?php echo e("FROMTIME_".$key); ?>  value="<?php echo e($TIME_FROM); ?>" autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="time" name="TOTIME[]"      id =<?php echo e("TOTIME_".$key); ?>    value="<?php echo e($TIME_TO); ?>" autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="TOTALHOURS[]"  id =<?php echo e("TOTALHOURS_".$key); ?> value="<?php echo e($TOTALHOURS); ?>" autocomplete="off" style="width: 99%" readonly></td>
                                  
                                  <td><select <?php echo e($ActionStatus); ?>  name="ASID_REF[]" id=<?php echo e("ASID_REF_".$key); ?> class="form-control mandatory">
                                    <option value="" selected="">Select</option>
                                    <?php $__currentLoopData = $objAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option <?php echo e(isset($row->ATTENDANCE_STATUS) && $row->ATTENDANCE_STATUS == $val-> ATTENDANCE_CODEID ?'selected="selected"':''); ?> value="<?php echo e($val->ATTENDANCE_CODEID); ?>"><?php echo e($val->ATTENDANCE_CODE); ?>-<?php echo e($val->ATTENDANCE_CODE_DESC); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                                </td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="REMARKS[]"     id =<?php echo e("REMARKS_".$key); ?>   value="<?php echo e($row->REMARKS); ?>"  autocomplete="off" style="width: 99%"></td>
                              ...
                              <?php else: ?>
                                <tr  class="participantRow">
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="txtEMPID[]"    id="txtEMPID_0"     autocomplete="off" readonly onclick="getEmployee(this.id)"/></td>
                                  <td hidden><input type="hidden"              name="EMPID_REF[]"   id="EMPID_REF_0"    autocomplete="off" /></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="FNAME[]"       id ="FNAME_0"       autocomplete="off" style="width: 99%" readonly></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="time" name="FROMTIME[]"    id ="FROMTIME_0"    autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="time" name="TOTIME[]"      id ="TOTIME_0"      autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="TOTALHOURS[]"  id ="TOTALHOURS_0"  autocomplete="off" style="width: 99%" readonly></td>
                                  
                                  <td>
                                    <select <?php echo e($ActionStatus); ?>  name="ASID_REF[]" id="ASID_REF_0" class="form-control mandatory">
                                      <option value="" selected="">Select</option>
                                    <?php $__currentLoopData = $objAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <td>
                                    <input <?php echo e($ActionStatus); ?>  class="form-control" type="text" name="REMARKS[]"     id ="REMARKS_0"     autocomplete="off" style="width: 99%">
                                  </td>
                                  <td>
                                    <button <?php echo e($ActionStatus); ?>  class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                    <button <?php echo e($ActionStatus); ?>  class="btn remove" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AttendanceTimeWiseDateWise\AttendanceTimeWiseDateWise\trnfrm425view.blade.php ENDPATH**/ ?>