          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                  ...
                  <div class="col-lg-2 pl"><p>LD Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("LOAN_DISB_DOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control"  maxlength="100" > 
                    </div>
                  ...
                  <div class="col-lg-2 pl"><p>Loan Type Code*</p></div>
                    <div class="col-lg-2 pl">
                      <select name="LOANTYPEID_REF" id="LOANTYPEID_REF" class="form-control mandatory" onchange="getLtypeCode(this.value)" tabindex="4">
                        ...
                        <option value="<?php echo e($val->LOANTYPEID); ?>"><?php echo e($val->LOANTYPE_CODE); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                      <span class="text-danger" id="ERROR_PAYPERIODID_REF"></span>                             
                    </div>
...
function validateForm(){
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[403,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LoanDisbursement\trnfrm403add.blade.php ENDPATH**/ ?>