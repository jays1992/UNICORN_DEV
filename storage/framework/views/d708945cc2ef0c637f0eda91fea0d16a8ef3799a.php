          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="SHIFT_CODE" id="SHIFT_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <input type="text" name="SHIFT_NAME" id="SHIFT_NAME" class="form-control mandatory" value="<?php echo e(old('SHIFT_NAME')); ?>" maxlength="200" tabindex="2"  required/>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <input type="time" name="START_TIME" id="START_TIME" class="form-control mandatory" value="<?php echo e(old('START_TIME')); ?>"  tabindex="3"  required/> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <input type="time" name="END_TIME" id="END_TIME" class="form-control mandatory" value="<?php echo e(old('END_TIME')); ?>" tabindex="4" required />                        
                ...
                <div class="row">
                  ...
                  <select class="form-control" name="MIN_MINS_FULL" id="MIN_MINS_FULL" tabindex="7" required>
                        <?php for($i = 0; $i <60; $i++): ?>
                          ...
                          ?>
                          <option value="<?php echo e($keycode); ?>" <?php echo e($i==0?'selected':''); ?>><?php echo e($keycode); ?>  mins</option>
                        <?php endfor; ?>
                      </select>
                  </div>
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[180,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[180,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[180,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\ShiftMaster\mstfrm180add.blade.php ENDPATH**/ ?>