...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Stock Transfer</a></div>
...
function getDocType(DOC_TYPE){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getDocType"])); ?>',
    type:'POST',
...
function getNature(data){
  ...
  $("#BRANCH_ID").val("<?php echo e(Session::get('BRID_REF')); ?>");
  $("#BRANCH_NAME").val("<?php echo e(Session::get('branch_name')); ?>");
...
function getAddressDetails(id){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getAddressDetails"])); ?>',
    type:'POST',
...
function getCountry(){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"getCountry"])); ?>',
    type:'POST',
    success:function(data) {
...
function getBranch(){
  if($("#TRANSFER_TYPE").val() === 'OUT'){
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[$FormId,"getBranch"])); ?>',
      type:'POST',
      success:function(data) {
          $('#tbody_divpopp').html(data);
...
function getTransferOutNo(){
  ...
  if($("#TRANSFER_TYPE").val() === 'IN'){
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[$FormId,"getTransferOutNo"])); ?>',
      type:'POST',
      success:function(data) {
          $('#tbody_divpopp').html(data);
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(isset($HDR->STNO)?$HDR->STNO:''); ?>" class="form-control" autocomplete="off" style="text-transform:uppercase" readonly >
            <input type='hidden' name="VTID_REF" id="VTID_REF" value="<?php echo e(isset($HDR->VTID_REF2)?$HDR->VTID_REF2:''); ?>" >
          </div>
                              
          <div class="col-lg-1 pl"><p>DOC Date</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($HDR->STDT)?$HDR->STDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-1 pl"><p>Nature</p></div>
          <div class="col-lg-2 pl">
            <select <?php echo e($ActionStatus); ?> name="NATURE" id="NATURE" autocomplete="off" class="form-control" onchange="getNature(this.value)" >
              <option value="">Select</option>
              <option <?php echo e(isset($HDR->NATURE) && $HDR->NATURE ==='Stock Transfer'?"selected='selected'":""); ?> value="Stock Transfer">Stock Transfer</option>
              <option <?php echo e(isset($HDR->NATURE) && $HDR->NATURE ==='Donation'?"selected='selected'":""); ?> value="Donation">Donation</option>
              <option <?php echo e(isset($HDR->NATURE) && $HDR->NATURE ==='Sales Promotion'?"selected='selected'":""); ?> value="Sales Promotion">Sales Promotion</option>
              <option <?php echo e(isset($HDR->NATURE) && $HDR->NATURE ==='Sample'?"selected='selected'":""); ?> value="Sample">Sample</option>
              <option <?php echo e(isset($HDR->NATURE) && $HDR->NATURE ==='FOC'?"selected='selected'":""); ?> value="FOC">FOC</option>
            </select>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select <?php echo e($ActionStatus); ?> name="TRANSFER_TYPE" id="TRANSFER_TYPE" autocomplete="off" class="form-control" onchange="getTransferType(this.value)" <?php echo e(isset($HDR->NATURE) && $HDR->NATURE =='Stock Transfer'?'':'disabled'); ?>  >
              <option value="">Select</option>
              <option <?php echo e(isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='IN'?"selected='selected'":""); ?> value="IN">IN</option>
              <option <?php echo e(isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='OUT'?"selected='selected'":""); ?> value="OUT">OUT</option>
            </select>
          </div>

          <div class="col-lg-1 pl"><p>Existing Customer</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_EXIST" <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='EXIST'?"checked":""); ?> value='EXIST'  onchange="getCustomerType('exist')" >
          </div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_NEW" <?php echo e(isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='NEW'?"checked":""); ?> value='NEW' onchange="getCustomerType('new')" >
          </div>

          <div class="col-lg-1 pl txtgl_popup"><p class="CUSTOMER_VENDOR_LABEL">Customer</p></div>
          <div class="col-lg-2 pl txtgl_popup">
            <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtgl_popup" value="<?php echo e(isset($HDR->CUSTOMER_NAME)?$HDR->CUSTOMER_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" /> 
            <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e(isset($HDR->SLID_REF)?$HDR->SLID_REF:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl BRANCH_NAME">
            <input type="hidden"  name="BRANCH_ID"    id="BRANCH_ID" value="<?php echo e(isset($HDR->BRID)?$HDR->BRID:''); ?>"    class="form-control" autocomplete="off" >
            <input <?php echo e($ActionStatus); ?> type="text"    name="BRANCH_NAME"  id="BRANCH_NAME" value="<?php echo e(isset($HDR->BRANCH_NAME)?$HDR->BRANCH_NAME:''); ?>"  class="form-control" autocomplete="off" readonly onclick="getBranch()" >
          </div>

          <div class="col-lg-1 pl"><p>Transfer Out No</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="TRANSFER_OUT_NO_ID" id="TRANSFER_OUT_NO_ID" value="<?php echo e(isset($HDR->TRNSFR_OUT_NO)?$HDR->TRNSFR_OUT_NO:''); ?>" class="form-control" autocomplete="off" >
            <input <?php echo e($ActionStatus); ?> type="text"    name="TRANSFER_OUT_NO"    id="TRANSFER_OUT_NO"  value="<?php echo e(isset($HDR->TRANSFER_OUT_NO)?$HDR->TRANSFER_OUT_NO:''); ?>"   class="form-control" autocomplete="off" readonly <?php echo e(isset($HDR->TRNSFR_OUT_NO) && $HDR->TRNSFR_OUT_NO !=''?'':'disabled'); ?>  onclick="getTransferOutNo()" >
          </div>
                                
          <div class="col-lg-1 pl"><p>Address</p></div>
          <div class="col-lg-2 pl" >
            <input <?php echo e($ActionStatus); ?> type="text"  name="ADDRESS"  id="ADDRESS" value="<?php echo e(isset($HDR->CUST_ADDRESS)?$HDR->CUST_ADDRESS:''); ?>"  class="form-control" autocomplete="off" readonly > 
          </div>

          <div class="col-lg-1 pl"><p>GST No</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text"  name="GST_NO" id="GST_NO" value="<?php echo e(isset($HDR->GSTIN_NO)?$HDR->GSTIN_NO:''); ?>" class="form-control" autocomplete="off" readonly > 
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="hidden"  name="COUNTRY_ID"    id="COUNTRY_ID" value="<?php echo e(isset($HDR->CTRYID_REF)?$HDR->CTRYID_REF:''); ?>"   class="form-control" autocomplete="off">
            <input <?php echo e($ActionStatus); ?> type="text"    name="COUNTRY_NAME"  id="COUNTRY_NAME" value="<?php echo e(isset($HDR->COUNTRY_NAME)?$HDR->COUNTRY_NAME:''); ?>"  class="form-control" autocomplete="off" readonly disabled onclick="getCountry()" >
          </div>

          <div class="col-lg-1 pl"><p>State</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="STATE_ID"    id="STATE_ID" value="<?php echo e(isset($HDR->STID_REF)?$HDR->STID_REF:''); ?>"   class="form-control" autocomplete="off">
            <input <?php echo e($ActionStatus); ?> type="text"    name="STATE_NAME"  id="STATE_NAME" value="<?php echo e(isset($HDR->STATE_NAME)?$HDR->STATE_NAME:''); ?>"  class="form-control" autocomplete="off" readonly disabled onclick="getState()" > 
          </div>

          <div class="col-lg-1 pl"><p>City</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="CITY_ID"    id="CITY_ID" value="<?php echo e(isset($HDR->CITYID_REF)?$HDR->CITYID_REF:''); ?>"    class="form-control" autocomplete="off">
            <input <?php echo e($ActionStatus); ?> type="text"    name="CITY_NAME"  id="CITY_NAME" value="<?php echo e(isset($HDR->CITY_NAME)?$HDR->CITY_NAME:''); ?>"  class="form-control" autocomplete="off" readonly disabled onclick="getCity()" > 
          </div>

          <div class="col-lg-1 pl"><p>Remarks</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" value="<?php echo e(isset($HDR->REMARKS)?$HDR->REMARKS:''); ?>" class="form-control" autocomplete="off"  maxlength="200" >
          </div>
        </div>
              ...
              <div class="table-responsive table-wrapper-scroll-y" style="height:280px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    $desc6  =   $SIID_REF.'-'.$ITEMID_REF.'-'.$SEID_REF.'-'.$SQID_REF.'-'.$SOID.'-'.$SCID_REF;    
                    ...
                    <tr  class="participantRow">
                      ...
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("txtSQ_popup_".$key); ?> id=<?php echo e("txtSQ_popup_".$key); ?> class="form-control"  autocomplete="off"   readonly style="width:100px;" /></td>
                      <td hidden><input type="hidden" name=<?php echo e("SQA_".$key); ?> id=<?php echo e("SQA_".$key); ?> class="form-control"  autocomplete="off" /></td>
                      <td hidden><input type="hidden" name=<?php echo e("SEQID_REF_".$key); ?> id=<?php echo e("SEQID_REF_".$key); ?> class="form-control"  autocomplete="off" /></td>
                      ...
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>"  class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
                      <td hidden><input <?php echo e($ActionStatus); ?> type="text" name="SI_RATE_<?php echo e($key); ?>" id="SI_RATE_<?php echo e($key); ?>"  class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e(isset($row->ST_QTY) && $row->ST_QTY !=''?$row->ST_QTY:'0.00'); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:75px;"  /></td>
                      <td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" value="<?php echo e($row->ST_QTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
                      ...
                      <td  hidden><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->ST_QTY); ?>" ></td>
                      ...
                      <td><input <?php echo e($ActionStatus); ?> type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATEPUOM); ?>"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
...
$(document).ready(function(e) {
  var Material = $("#Material").html(); 
    ...
    var obj = <?php echo json_encode($MAT); ?>;
    ...
    $.each( obj, function( key, value ) {
        ...
        if(parseFloat(value.ST_QTY) > 0){

          var amtbeforedis = parseFloat(value.RATEPUOM*value.ST_QTY).toFixed(2);

        }
        else{

          var amtbeforedis = parseFloat(value.RATEPUOM).toFixed(2);
    ...
    $('#transaction_form1').bootstrapValidator({
        ...
        fields: {
            txtlabel: {
                validators: {
                    notEmpty: {
                        message: 'The DOC NO is required'
                    }
                }
            },            
        },
...
else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#DOC_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
$.ajax({
    ...
    type:'POST',
    data:{TRANSFER_TYPE:TRANSFER_TYPE,ITEMID_REF:ITEMID_REF,MAIN_UOMID_REF:MAIN_UOMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'EDIT',SIID_REF:SIID_REF,WhereId:WhereId},
    success:function(data) {
...
$(document).ready(function(){
  var lastdt = <?php echo json_encode($HDR->STDT); ?>;
  var csv = <?php echo json_encode($HDR); ?>;
  var today = new Date(); 
  var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
  if(lastdt < csv.STDT)
  {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockTransfer\trnfrm482edit.blade.php ENDPATH**/ ?>