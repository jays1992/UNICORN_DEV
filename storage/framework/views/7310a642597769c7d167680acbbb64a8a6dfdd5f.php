<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_add" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->INSTRUMENT_METHOD_ID) ? method_field('PUT') : ''); ?>

          <div class="inner-form">            
            <div class="row">
              <div class="col-lg-2 pl"><p>Instrument Method Code</p></div>
              <div class="col-lg-2 pl">              
                <label> <?php echo e($objResponse->INSTRUMENT_METHOD_CODE); ?> </label>
                <input type="hidden" name="INSTRUMENT_METHOD_ID" id="INSTRUMENT_METHOD_ID" value="<?php echo e($objResponse->INSTRUMENT_METHOD_ID); ?>" />
                <input type="hidden" name="INSTRUMENT_METHOD_CODE" id="INSTRUMENT_METHOD_CODE" value="<?php echo e($objResponse->INSTRUMENT_METHOD_CODE); ?>" autocomplete="off"  maxlength="6"   />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="INSTRUMENT_METHOD_NAME" id="INSTRUMENT_METHOD_NAME" class="form-control mandatory" value="<?php echo e(old('INSTRUMENT_METHOD_NAME',$objResponse->INSTRUMENT_METHOD_NAME)); ?>" maxlength="200" tabindex="2"  />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[385,"update"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {               
                if(data.errors) {
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[385,"singleapprove"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {       
        if(data.errors) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\InstrumentMethod\mstfrm385edit.blade.php ENDPATH**/ ?>