...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">AP Debit / Credit Note</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->APDRCRID); ?>" value="<?php echo e($val->APDRCRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->AP_DOC_DT) && $val->AP_DOC_DT !=''?$val->AP_DOC_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->AP_DOC_NO) && $val->AP_DOC_NO !=''?$val->AP_DOC_NO:''); ?></td>
                <td><?php echo e(isset($val->AP_DOC_DT) && $val->AP_DOC_DT !=''?$val->AP_DOC_DT:''); ?></td>
                <td><?php echo e(isset($val->SGLCODE) && $val->SGLCODE !==''?$val->SGLCODE:''); ?></td>
                <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !==''?$val->SLNAME:''); ?></td>
                <td><?php echo e(isset($val->AP_TYPE) && $val->AP_TYPE !=''?$val->AP_TYPE:''); ?></td>
                <td><?php echo e(isset($val->REASON_DRCR_NOTE) && $val->REASON_DRCR_NOTE !=''?$val->REASON_DRCR_NOTE:''); ?></td></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>AP Voucher Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'PO='+ POID + '&APDRCRID='+ POID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/APDebitNote/trnfrm235.blade.php ENDPATH**/ ?>