...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->DSPID); ?>" value="<?php echo e($val->DSPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DSPDT) && $val->DSPDT !='' && $val->DSPDT !='1900-01-01' ? date('d-m-Y',strtotime($val->DSPDT)):''); ?>" ></td>
              <td><?php echo e(isset($val->DSPNO) && $val->DSPNO !=''?$val->DSPNO:''); ?></td>
              <td><?php echo e(isset($val->DSPDT) && $val->DSPDT !='' && $val->DSPDT !='1900-01-01' ? date('d-m-Y',strtotime($val->DSPDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\DailySalesPlan\trnfrm42.blade.php ENDPATH**/ ?>