<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->TEAMMSTID); ?>" value="<?php echo e($val->TEAMMSTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->TEAMMST_NO) && $val->TEAMMST_NO !=''?$val->TEAMMST_NO:''); ?></td>
                ...
                <td><?php echo e(isset($val->TEAMMST_DATE) && $val->TEAMMST_DATE !='' && $val->TEAMMST_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->TEAMMST_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/PreSales/TeamMaster/mstfrm504.blade.php ENDPATH**/ ?>