...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Budget Master</a></div>
...
<form id="master_form" onsubmit="return validateForm()"  method="POST" class="needs-validation" >  
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <input type="text" name="BUG_NO" id="BUG_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        </div>
              
        <div class="col-lg-2 pl"><p>Budget Date</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="BUG_DATE" id="BUG_DATE" value="<?php echo e(date('Y-m-d')); ?>" class="form-control BUG_DATE" autocomplete="off"  placeholder="dd/mm/yyyy" >
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\BudgetMaster\mstfrm503add.blade.php ENDPATH**/ ?>