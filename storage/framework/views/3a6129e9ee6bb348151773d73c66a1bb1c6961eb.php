...
function validateSingleElemnet(element_id){
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[228,"codeduplicate"])); ?>',
            type:'POST',
...
$(document).ready(function(e) {
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[228,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
$("#txtmachine_popup").focus(function(event){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[228,"getmachines"])); ?>',
        type:'POST',
        success:function(data) {
...
$("#txtchecklist_popup").focus(function(event){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[228,"getchecklists"])); ?>',
        type:'POST',
        success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\MachineWiseChecklist\mstfrm228add.blade.php ENDPATH**/ ?>