...
<?php $__env->startSection('content'); ?>
    ...
    <form id="frm_mst_add" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >
      ...
      <div id="Material" class="tab-pane fade in active">
          <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:450px;margin-top:10px;" >
              <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="500" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">                                                    
                          <tr>                                     
                              <th width="15%">Leave Type Code	 <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="1"> </th>
                              <th>Description</th>
                  ...
                  <tr  class="participantRow">    
                    <td><input  type="text" name="txtLT_popup_0" id="txtLT_popup_0" class="form-control"  autocomplete="off"  readonly/></td>
                    <td  hidden><input type="text" name="LTID_REF_0" id="LTID_REF_0" class="form-control" autocomplete="off" /></td>                          
                    <td><input type="text" name="LT_REF_0" id="LT_REF_0" style=" width: 171px;" class="form-control"  autocomplete="off"  readonly /></td>
                      <td style="text-align:center;"><input type="text" class="form-control" onkeypress="return isNumberDecimalKey(event,this)"  name="MAX_LEAVE_YEAR_0" id="MAX_LEAVE_YEAR_0"  ></td>
                      <td style="text-align:center;"><input type="text" class="form-control" onkeypress="return isNumberDecimalKey(event,this)" name="MAX_COMMULATIVE_LEAVE_0" id="MAX_COMMULATIVE_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="CARRRY_FORWARD_LEAVE_0" id="CARRRY_FORWARD_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="HALF_DAY_LEAVE_0" id="HALF_DAY_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="LAPSE_LEAVE_0" id="LAPSE_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="LEAVE_ENCASHMENT_0" id="LEAVE_ENCASHMENT_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="SANDWITCH_LEAVE_0" id="SANDWITCH_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="NON_DUE_LEAVE_0" id="NON_DUE_LEAVE_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="DESIGNATION_SPECIFIC_0" id="DESIGNATION_SPECIFIC_0"  ></td>
                      <td style="text-align:center;"><input type="checkbox" name="DOCUMENT_REQUIRED_0" id="DOCUMENT_REQUIRED_0"  ></td>
                      <td style="text-align:center;">                      
                      <select name="GENDER_SPECIFIC_0" id="GENDER_SPECIFIC_0" class="form-control"  >
                      ...
                      <td style="text-align:center;"><input type="input" name="MAX_LEAVE_GENDER_0" id="MAX_LEAVE_GENDER_0" onkeypress="return isNumberDecimalKey(event,this)" class="form-control"  ></td>
                      <td style="text-align:center;"><input type="input"  name="MAX_LEAVE_KID_0" id="MAX_LEAVE_KID_0" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" ></td>
                      <td style="text-align:center;"><input type="checkbox" name="DEACTIVATED_0" id="DEACTIVATED_0" class="DEACTIVATED" ></td>
                      <td style="text-align:center;"><input type="date" class="form-control" name="DODEACTIVATED_0" id="DODEACTIVATED_0"  ></td>             
          ...
          <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:450px;margin-top:10px; width:60%;"  >
              <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">                                                    
                          <tr>                                     
                              <th>Leave Type Code <input class="form-control" type="hidden" name="Row_Count2" id ="Row_Count2" value="1"> </th>
                              <th>Description</th>
                              <th> Designation</th>
                  ...
                  <tr  class="participantRow1">    
                    <td><input  type="text" name="txtLT_popup1_0" id="txtLT_popup1_0" class="form-control"  autocomplete="off"  readonly/></td>
                    <td  hidden><input type="text" name="LTID_REF1_0" id="LTID_REF1_0" class="form-control" autocomplete="off" /></td>                          
                    <td><input type="text" name="LT_REF1_0" id="LT_REF1_0" class="form-control"  autocomplete="off"  readonly /></td>
                    <td><input  type="text" name="txtD_popup_0" id="txtD_popup_0" class="form-control"  autocomplete="off"  readonly/></td>
                    <td  hidden><input type="text" name="DID_REF_0" id="DID_REF_0" class="form-control" autocomplete="off" /></td>   
                    <td style="text-align:center;"><input type="input" name="MAX_LEAVE_YEAR1_0" id="MAX_LEAVE_YEAR1_0" onkeypress="return isNumberDecimalKey(event,this)" class="form-control"  ></td>
                      <td style="text-align:center;"><input type="input"  name="MAX_COMMULATIVE_LEAVE1_0" id="MAX_COMMULATIVE_LEAVE1_0" onkeypress="return isNumberDecimalKey(event,this)" class="form-control" ></td>
...
$(document).ready(function() {
  ...
  $("#btnSaveSE").on("submit", function( event ) {
    ...
    $('#frm_mst_add1').bootstrapValidator({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveRules\mstfrm377add.blade.php ENDPATH**/ ?>