    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(isset($HDR->STDT)?$HDR->STDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_EXIST" <?php echo e(isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='EXIST'?"checked":""); ?> value='EXIST' checked onchange="getCustomerType('exist')" >
          </div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_NEW" <?php echo e(isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='NEW'?"checked":""); ?> value='NEW' onchange="getCustomerType('new')" disabled >
          </div>
...
$.ajax({
    ...
    type:'POST',
    data:{TRANSFER_TYPE:TRANSFER_TYPE,ITEMID_REF:ITEMID_REF,MAIN_UOMID_REF:MAIN_UOMID_REF,ROW_ID:ROW_ID,ITEMROWID:ITEMROWID,ACTION_TYPE:'VIEW',SIID_REF:SIID_REF,WhereId:WhereId},
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockTransfer\trnfrm482view.blade.php ENDPATH**/ ?>