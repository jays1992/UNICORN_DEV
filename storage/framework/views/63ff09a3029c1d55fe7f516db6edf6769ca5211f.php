...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->DPPID); ?>" value="<?php echo e($val->DPPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DPP_DT) && $val->DPP_DT !='' && $val->DPP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DPP_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->DPP_NO) && $val->DPP_NO !=''?$val->DPP_NO:''); ?></td>
              <td><?php echo e(isset($val->DPP_DT) && $val->DPP_DT !='' && $val->DPP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DPP_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\DailyProductionPlan\trnfrm230.blade.php ENDPATH**/ ?>