...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[322,'index'])); ?>" class="btn singlebt">Gate Entry Report</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_ger"  method="POST">   
            <?php echo csrf_field(); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="VGID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="VGID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjVendorGrp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->VGID); ?>" selected><?php echo e($GRow->VGCODE); ?>-<?php echo e($GRow->DESCRIPTIONS); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="row">                     
                            <div class="col-lg-3 pl"><p>Gate Entry Type</p></div>
                            <div class="col-lg-3 pl" id="div_GETYPE">
                                <select name="GETYPE[]" data-hide-disabled="hide" multiple data-actions-box="true" id="GETYPE" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjGETYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Iindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($IRow->GETYPE); ?>" selected><?php echo e($IRow->GETYPE); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[322,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var VGID = [];
        $("select[name='VGID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                VGID.push(value5);
            }
        ...
        var GETYPE  = [];
        $("select[name='GETYPE[]']").each(function() {
            var value6 = $(this).val();
            if (value6) {
                GETYPE.push(value6);
            }
        ...
        else if(GETYPE  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Gate Entry Type.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[322,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\inventory\GEReport\rptfrm322.blade.php ENDPATH**/ ?>