          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">   
                    <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                  ...
                  <div class="col-lg-2 pl"><p>LA Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LEAVE_APP_DT" id="LEAVE_APP_DT" onchange='checkPeriodClosing(402,this.value,1),getDocNoByEvent("LEAVE_APP_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control"  maxlength="100" > 
                    </div>
...
function leaveFromDate(id){
  var LEAVE_APP_FRDT    =   $('#LEAVE_APP_FRDT').val();
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[402,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LeaveApply\trnfrm402add.blade.php ENDPATH**/ ?>