...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Schedule against Blanket<br/> Purchase Order</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SBPID); ?>" value="<?php echo e($val->SBPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SBP_DT) && $val->SBP_DT !='' && $val->SBP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SBP_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->SBP_NO) && $val->SBP_NO !=''?$val->SBP_NO:''); ?></td>
              <td><?php echo e(isset($val->SBP_DT) && $val->SBP_DT !='' && $val->SBP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SBP_DT)):''); ?></td>
              <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !=''?$val->SLNAME:''); ?></td>
              <td><?php echo e(isset($val->TITLE) && $val->TITLE !=''?$val->TITLE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Purchase/ScheduleBlanketPurchaseOrder/trnfrm68.blade.php ENDPATH**/ ?>