...
<?php $helper = app('App\Helpers\Helper'); ?>  
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Manual Journal Voucher (MJV)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MJVID); ?>" value="<?php echo e($val->MJVID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MJV_DT) && $val->MJV_DT !=''?$val->MJV_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->MJV_NO) && $val->MJV_NO !=''?$val->MJV_NO:''); ?></td>
                <td><?php echo e(isset($val->MJV_DT) && $val->MJV_DT !=''?$val->MJV_DT:''); ?></td>
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("transaction",[415,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&MJVID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ManualJournalVoucher\trnfrm415.blade.php ENDPATH**/ ?>