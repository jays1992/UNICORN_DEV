  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PRR_DT" id="PRR_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("PRR_DOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('PRR_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
                ...
                <!--  <th>Alt UOM (AU)</th>-->
                  ...
                  <th>Remarks</th>
                         ...
                         <td><input  type="text" name="Main_popupITEMID_0" id="Main_popupITEMID_0" class="form-control"  autocomplete="off"  readonly/></td>
                          ...
                          <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Main_Alpspartno_0" id="Main_Alpspartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Main_Custpartno_0" id="Main_Custpartno_0" class="form-control"  autocomplete="off"  readonly/></td>
                          <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Main_OEMpartno_0"  id="Main_OEMpartno_0" class="form-control"  autocomplete="off"   readonly/></td>
          ...
          <div id="udf" class="tab-pane fade">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFPROID); ?>" autocomplete="off"   /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionReturn\trnfrm401add.blade.php ENDPATH**/ ?>