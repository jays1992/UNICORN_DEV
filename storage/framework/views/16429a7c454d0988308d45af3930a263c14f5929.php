             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e($HDR->EMPVA_DOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($HDR->EMPVA_DOCDT); ?>" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                 <input type="text" name="EMPID_REF" id="txtitem_popup" value="<?php echo e($HDR->EMPCODE); ?>"  class="form-control mandatory"  autocomplete="off" readonly/>
                           ...
                           <tbody>
                            ...
                            <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr  class="participantRow">
                               <td><select name="ADJUSTMENT_TYPE[]" id=<?php echo e("ADJUSTMENT_TYPE_".$key); ?> onchange="getEarHeadName(this.id,this.value)" class="form-control mandatory">
                               ...
                               <td><select name="EARNIGHEAD_REF[]" id=<?php echo e("EARNIGHEAD_REF_".$key); ?> class="form-control mandatory">
                                 <option value="" selected="">Select</option>
                                 ...
                                 <?php }else{?>
                                  ...
                                  <option <?php echo e(isset($row->EARNING_HEADID_REF) && $row->EARNING_HEADID_REF == $val-> DEDUCTION_HEADID ?'selected="selected"':''); ?> value="<?php echo e($val-> DEDUCTION_HEADID); ?>"><?php echo e($val->DEDUCTION_HEADCODE); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  <?php }?>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                               </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AdjustmentVoucherEmployeeWise\trnfrm420edit.blade.php ENDPATH**/ ?>