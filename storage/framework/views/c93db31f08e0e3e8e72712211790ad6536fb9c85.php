<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnAdd" disabled="disabled" ><i class="fa fa-plus"></i> Add</button>
                        ...
                        <button id="btnSaveCountryAttachment"   class="btn topnavbt" tabindex="7"><i class="fa fa-floppy-o"></i> Save</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_state_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[3,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objCountry->STID); ?>" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> <?php echo e(date("d/m/Y", strtotime($objCountry->INDATE) )); ?> </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='<?php echo e(date("Y-m-d", strtotime($objCountry->INDATE))); ?>'   />
					...
					<table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
						...
						<tbody>
							<tr  class="participantRow">
								...
								<td><input type="text" name="REMARKS[]" id="REMARKS_0" 	class="form-control w-100"  maxlength="200" ></td>
								<td align="center" >
...
<script>  
 ...
 var formStateMst = $( "#frm_state_attachment" );
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\state\mstfrm3attachment.blade.php ENDPATH**/ ?>