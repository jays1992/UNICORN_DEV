                          ...
                          <tr  class="participantRow">
                              <td>
                                <select name="LTID_REF_0" id="LTID_REF_0" class="form-control mandatory" tabindex="4">
                                  ...
                                  <option value="<?php echo e($val->LTID); ?>"><?php echo e($val->LEAVETYPE_CODE); ?>- <?php echo e($val->LEAVETYPE_DESC); ?></option>
...
function validateForm(){
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[404,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
$("#gl_closePopup").click(function(event){
  ...
  function loadItem_prod_code(taxstate,CODE,FORMID,LEAVE_APP_DT){
    ...
    $.ajax({
      url:'<?php echo e(route("transaction",[404,"getItemDetails_prod_code"])); ?>',
      type:'POST',
...
$('[id*="chkIdProdCode"]').change(function(){
  ...
  $("#ItemProCodeSearch").val('');
    ...
    var customid = txtval;
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[404,"getALeaveNoMaterial"])); ?>',
              type:'POST',
              data:{'id':customid},
              success:function(data) {
                //alert(data);
...
$("#EMPCODE").focus(function(event){
  ...
  $.ajax({
      url:'<?php echo e(route("transaction",[404,"getemplCode"])); ?>',
      type:'POST',
      success:function(data) {
...
$('#Material').on('click','[id*="LEAVETYPE"]',function(event){
  ...
  $.ajax({
      url:'<?php echo e(route("transaction",[404,"gelvtypeCode"])); ?>',
      type:'POST',
      success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LeaveApproval\trnfrm404add.blade.php ENDPATH**/ ?>