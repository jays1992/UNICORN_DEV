<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[93,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="glmst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
            ...
            <tbody> 
                ...
                ?>
                <tr>
                  <td><input type="checkbox" id="chkId<?php echo e($val->GLID); ?>" value="<?php echo e($val->GLID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                  <td><?php echo e(isset($val->GLCODE) && $val->GLCODE !=''?$val->GLCODE:''); ?></td>
                  <td><?php echo e(isset($val->GLNAME) && $val->GLNAME !=''?$val->GLNAME:''); ?></td>
                  <td><?php echo e(isset($val->ASGNAME) && $val->ASGNAME !=''?$val->ASGNAME:''); ?></td>
                  <td><?php echo e(isset($val->AGNAME) && $val->AGNAME !=''?$val->AGNAME:''); ?></td>
                  <td><?php echo e(isset($val->NOGNAME) && $val->NOGNAME !=''?$val->NOGNAME:''); ?></td>
                  <td><?php echo e(isset($val->NOG_TYPE) && $val->NOG_TYPE !=''?$val->NOG_TYPE:''); ?></td>
                  <!-- <td><?php echo e(isset($val->ALIAS) && $val->ALIAS !=''?$val->ALIAS:''); ?></td> -->
        ...
        <form id="masterForm93Print" action="<?php echo e(route('mastergetlist',[93,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
$('#btnAdd').on('click', function() {
  ...
  $(document).ready(function(){
        ...
        // Data table for serverside
         var mstresultTable =  $('#glmst').DataTable({});
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[93,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[93,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[93,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[93,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[93,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\GENERALLEDGER\mstfrm93.blade.php ENDPATH**/ ?>