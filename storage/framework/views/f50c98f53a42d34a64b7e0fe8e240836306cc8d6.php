 ...
 <div class="container-fluid purchase-order-view">
   ...
   <div class="container-fluid filter">
     ...
     <div class="row">
            ...
            <input disabled type="text" name="PMAL_NO" id="PMAL_NO" value="<?php echo e(isset($objResponse->PMAL_NO)?$objResponse->PMAL_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            </div>

            <div class="col-lg-2 pl"><p>Doc Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="PMAL_DATE" id="PMAL_DATE" value="<?php echo e(isset($objResponse->PMAL_DATE)?$objResponse->PMAL_DATE:''); ?>"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            
            <div class="col-lg-2 pl"><p>Machine Code</p></div>
			      <div class="col-lg-2 pl">
              <input disabled type="text" name="MACHINEID_REF_popup" id="txtMACHINEID_REF_popup" value="<?php echo e(isset($objResponse->MACHINE_NO)?$objResponse->MACHINE_NO:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
              <input type="hidden" name="MACHINEID_REF" id="MACHINEID_REF" value="<?php echo e(isset($objResponse->MACHINEID_REF)?$objResponse->MACHINEID_REF:''); ?>" class="form-control" autocomplete="off" />
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Machine Description</p></div>
			      <div class="col-lg-2 pl">
              <input disabled type="text" name="MACHINEID_DESC" id="MACHINEID_DESC" value="<?php echo e(isset($objResponse->MACHINE_DESC)?$objResponse->MACHINE_DESC:''); ?>" class="form-control"  autocomplete="off" readonly />
			      </div>

            <div class="col-lg-2 pl"><p>Maintenance Schedule From Date</p></div>
            <div class="col-lg-2 pl">
              <input disabled type="text" name="TEXT_PMSL_FROM_DATE_DATA" id="TEXT_PMSL_FROM_DATE_DATA" value="<?php echo e(isset($objResponse->PMSL_FROM_DATE)?$objResponse->PMSL_FROM_DATE:''); ?>" class="form-control mandatory"  autocomplete="off" placeholder="dd/mm/yyyy" readonly/>
              <input type="hidden" name="PMSL_FROM_DATE" id="PMSL_FROM_DATE" value="<?php echo e(isset($objResponse->PMSL_FROM_DATE)?$objResponse->PMSL_FROM_DATE:''); ?>" class="form-control" autocomplete="off" />
              <input type="hidden" name="PMSL_ID_REF" id="PMSL_ID_REF" value="<?php echo e(isset($objResponse->PMSL_ID_REF)?$objResponse->PMSL_ID_REF:''); ?>" class="form-control" autocomplete="off" />
            </div>

            <div class="col-lg-2 pl"><p>Maintenance Schedule To Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="PMSL_TO_DATE" id="PMSL_TO_DATE" value="<?php echo e(isset($objResponse->PMSL_TO_DATE)?$objResponse->PMSL_TO_DATE:''); ?>"  class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" readonly>
            </div> 
        ...
        <div class="row">
            ...
            <div class="col-lg-10 pl">
                <input disabled type="text" name="SPECIAL_INST" id="SPECIAL_INST" value="<?php echo e(isset($objResponse->SPECIAL_INST)?$objResponse->SPECIAL_INST:''); ?>"  class="form-control mandatory" autocomplete="off" readonly >
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
                <input disabled type="date" name="ACTUAL_FROM_DATE" id="ACTUAL_FROM_DATE"  value="<?php echo e(isset($objResponse->ACTUAL_FROM_DATE)?$objResponse->ACTUAL_FROM_DATE:''); ?>" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" >
            </div>
            <div class="col-lg-2 pl"><p>Actual To Date of Maintenance</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="ACTUAL_TO_DATE" id="ACTUAL_TO_DATE"  value="<?php echo e(isset($objResponse->ACTUAL_TO_DATE)?$objResponse->ACTUAL_TO_DATE:''); ?>"  class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" onchange="getTotalDays()" >
            </div>
            <div class="col-lg-2 pl"><p>Total No. of Days</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="text" name="TOTAL_NO_DAYS" id="TOTAL_NO_DAYS"  value="<?php echo e(isset($objResponse->TOTAL_NO_DAYS)?$objResponse->TOTAL_NO_DAYS:''); ?>"  class="form-control mandatory" autocomplete="off" readonly>
            </div>
        </div>
       ...
       <div class="row">
           ...
           <div class="col-lg-1 pl">
               <input disabled type="checkbox" name="EMPLOYEE_TYPE" id="Chk_OwnEmployee" value="own_employee" <?php echo e(isset($objResponse) && $objResponse->OWN_EMPLOYEE=='1'?'checked':''); ?>   />  
           </div>
           <div class="col-lg-2 pl"><p>Outside Resource</p></div>
           <div class="col-lg-1 pl">
               <input disabled type="checkbox" name="EMPLOYEE_TYPE" id="Chk_OutsideResource" value="outside_employee" <?php echo e(isset($objResponse) && $objResponse->OUTSIDE_RESOURCE=='1'?'checked':''); ?>  />
           </div>     
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Outsider Name</p></div>
           <div class="col-lg-2 pl">
               <input disabled type="text" name="Outsider_Name" id="Outsider_Name" class="form-control mandatory" value="<?php echo e($objResponse->OUTSIDE_RNAME); ?>"   autocomplete="off"  />  
           </div>
           <div class="col-lg-2 pl"><p>Contact Number</p></div>
           <div class="col-lg-2 pl">
               <input disabled type="text" name="Contact_Number" id="Contact_Number" class="form-control mandatory" value="<?php echo e($objResponse->OUTSIDE_CONTACT_NO); ?>" autocomplete="off"  />
           </div> 
           <div class="col-lg-2 pl"><p>Company Name</p></div>
           <div class="col-lg-2 pl">
               <input disabled type="text" name="Company_Name" id="Company_Name" class="form-control mandatory" value="<?php echo e($objResponse->OUTSIDE_COMPANY); ?>"  autocomplete="off"  />
           </div>    
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Maintenance Person Name 1</p></div>
           <div class="col-lg-2 pl">
              <input disabled type="text" name="EMP_REF1" id="EMP_REF1_popup" class="form-control mandatory" onclick="get_employee('EMP_REF1');" value="<?php echo e(isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF1!=''?  $objResponse->EMP1_CODE.'-'.$objResponse->EMP1_NAME :''); ?>" autocomplete="off" readonly/>
           ...
           <div class="col-lg-2 pl">
            <input disabled type="text" name="EMP_REF2" id="EMP_REF2_popup" class="form-control mandatory" value="<?php echo e(isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF2!=''?  $objResponse->EMP2_CODE.'-'.$objResponse->EMP2_NAME :''); ?>" onclick="get_employee('EMP_REF2');" autocomplete="off" readonly/>
           ...
           <div class="col-lg-2 pl">
            <input disabled type="text" name="EMP_REF3" id="EMP_REF3_popup" value="<?php echo e(isset($objResponse) && $objResponse->MAINTENANCE_EMPID_REF3!=''?  $objResponse->EMP3_CODE.'-'.$objResponse->EMP3_NAME :''); ?>" class="form-control mandatory" onclick="get_employee('EMP_REF3');" autocomplete="off" readonly/>
       ...
       <div class="row">	
           ...
           <div class="col-lg-2 pl">
               <input disabled type="text" name="CHECKLIST_popup" id="txtchecklist_popup" class="form-control mandatory" value="<?php echo e($objResponsechecklists->CHECKLIST_NO); ?>"  autocomplete="off" readonly/>
           ...
           <div class="col-lg-6 pl">
             <input disabled type="text" name="ChecklistDesc_popup" id="ChecklistDesc_popup" class="form-control" value="<?php echo e($objResponsechecklists->CHECKLIST_DESC); ?>"  autocomplete="off"  readonly/>
           </div>
       </div>
       <div class="row">
           <div class="col-lg-2 pl"><p>Action Taken 1</p></div>
           <div class="col-lg-4 pl">
               <input disabled type="text" name="Action_Taken1" id="Action_Taken1" class="form-control mandatory" value="<?php echo e($objResponse->ACTION_TAKEN1); ?>"  autocomplete="off"  />  
           </div>
           <div class="col-lg-2 pl"><p>Action Taken 2</p></div>
           <div class="col-lg-4 pl">
               <input disabled type="text" name="Action_Taken2" id="Action_Taken2" class="form-control mandatory" value="<?php echo e($objResponse->ACTION_TAKEN2); ?>"  autocomplete="off"  />
           </div>     
       </div>
          ...
          <div class="col-lg-2 pl"><p>Status</p></div>
           <div class="col-lg-2 pl">
               <select disabled  class="form-control" name="drpstatus" id="drpstatus" > 
                 ...
                 <option value="Work In Progress" <?php echo e(isset($objResponse) && $objResponse->PM_STATUS=='Work In Progress'?'selected':''); ?>>Work In Progress</option>
                 <option value="Completed" <?php echo e(isset($objResponse) && $objResponse->PM_STATUS=='Completed'?'selected':''); ?>>Completed</option>
                 <option value="Temporary Solved" <?php echo e(isset($objResponse) && $objResponse->PM_STATUS=='Temporary Solved'?'selected':''); ?>>Temporary Solved</option>
               </select>  
           </div>
           <div class="col-lg-2 pl"><p>Remarks</p></div>
            <div class="col-lg-6 pl">
                <input disabled type="text" name="HDR_REMARKS" id="HDR_REMARKS"  value="<?php echo e(isset($objResponse->REMARKS)?$objResponse->REMARKS:''); ?>" class="form-control mandatory"  autocomplete="off"  />  
            </div>   
       </div>
     </div>
                   ...
                   <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <?php $__currentLoopData = $CHECKLIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr  class="participantRow" >
                        ...
                        <td><input disabled type="text" name="MP_CODE[]"  class="form-control" value="<?php echo e($row->MP_CODE); ?>"  autocomplete="off"  readonly /></td>
         
                        <td><input disabled type="text" name="MP_DESC[]"  class="form-control" value="<?php echo e($row->MP_DESC); ?>"  autocomplete="off"  readonly /></td>
         
                        <td><input disabled type="text" name="MSP_CODE[]"  class="form-control" value="<?php echo e($row->MSP_CODE); ?>"  autocomplete="off"  readonly /></td>
         
                        <td><input disabled type="text" name="MSP_DESC[]"  class="form-control" value="<?php echo e($row->MSP_DESC); ?>"  autocomplete="off"  readonly /></td>
         
                        <td><input disabled type="text" name="STANDARD_VALUE[]"   value="<?php echo e($row->STANDARD_VALUE); ?>" class="form-control three-digits" maxlength="15"  autocomplete="off"  readonly/></td>

                        <td><input disabled type="text" name="ACTUAL_VALUE[]" id="ACTUAL_VALUE_<?php echo e($key); ?>"  value="<?php echo e($row->ACTUAL_VALUE); ?>" class="form-control three-digits" maxlength="15"  autocomplete="off"   /></td>

                        <td><input disabled type="text" name="REMARKS[]"  class="form-control" value="<?php echo e($row->CHK_REMARKS); ?>"  autocomplete="off"   /></td>
                        </tr>
                      ...
                      <tbody>
                        ...
                        <?php $__currentLoopData = $CONSUMELIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr class="participantRow3">
                           ...
                           <td><input disabled type="text" name="SL_NO1_<?php echo e($key); ?>" id="SL_NO1_<?php echo e($key); ?>" class="form-control" autocomplete="off" readonly value="<?php echo e($key+1); ?>" readonly ></td>
                           <td><input disabled type="text" name="SPARE_PARTS_CONSUMED_<?php echo e($key); ?>" id="SPARE_PARTS_CONSUMED_<?php echo e($key); ?>" value="<?php echo e($row->SPARE_PART_NAME); ?>" class="form-control" autocomplete="off" ></td>
                         ...
                         <tr class="participantRow3">
                           ...
                           <td><input disabled type="text" name="SPARE_PARTS_CONSUMED_0" id="SPARE_PARTS_CONSUMED_0" value="<?php echo e($row->SPARE_PART_NAME); ?>" class="form-control" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button disabled type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button disabled type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
                   ...
                   <table id="example4" class="display nowrap table table-striped table-bordered itemlist"  style="height:auto !important; width:50%">
                    ...
                    <?php $__currentLoopData = $RETURNLIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr class="participantRow4">
                         <td><input disabled type="text" name="SL_NO2_<?php echo e($key); ?>" id="SL_NO2_<?php echo e($key); ?>" class="form-control" autocomplete="off" readonly value="<?php echo e($key+1); ?>" readonly ></td>
                           <td><input disabled type="text" name="SPARE_PART_NAME_<?php echo e($key); ?>" id="SPARE_PART_NAME_<?php echo e($key); ?>" value="<?php echo e($row->SPARE_PART_NAME); ?>" class="form-control" autocomplete="off" ></td>
                           <td><input disabled type="text" name="SPARE_RETURN_TO_<?php echo e($key); ?>" id="SPARE_RETURN_TO_<?php echo e($key); ?>" class="form-control" value="<?php echo e($row->SPARE_RETURN_TO); ?>" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button disabled type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button disabled type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
                         ...
                         <td><input disabled type="text" name="SL_NO2_0" id="SL_NO2_0" class="form-control" autocomplete="off" readonly value="1" readonly ></td>
                           <td><input disabled type="text" name="SPARE_PART_NAME_0" id="SPARE_PART_NAME_0" value="<?php echo e($row->SPARE_PART_NAME); ?>" class="form-control" autocomplete="off" ></td>
                           <td><input disabled type="text" name="SPARE_RETURN_TO_0" id="SPARE_RETURN_TO_0" class="form-control" value="<?php echo e($row->SPARE_RETURN_TO); ?>" autocomplete="off" ></td>
                           <td align="center" style="width: 100;">
                               <button  disabled type="button" class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                               <button disabled  type="button" class="btn remove" title="Delete" id="btnremove" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
                           </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\Preventive_Maintenance_Actual\trnfrm367view.blade.php ENDPATH**/ ?>