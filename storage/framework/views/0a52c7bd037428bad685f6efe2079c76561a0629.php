...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Serial No & Barcode (OUT)</a></div>
...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->BRCOID[0]) ? method_field('PUT') : ''); ?>
  ...
  <div class="container-fluid filter">
      ...
      <div class="col-lg-2 pl"><p>Doc No*</p></div>
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="BRC_OUT_NO" id="BRC_OUT_NO" value="<?php echo e(isset($objResponse->BRC_OUT_NO) && $objResponse->BRC_OUT_NO !=''?$objResponse->BRC_OUT_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
        </div>
			
              
        <div class="col-lg-2 pl"><p>Date*</p></div>
        <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="date" name="BRC_OUT_DT" id="BRC_OUT_DT" value="<?php echo e(isset($objResponse->BRC_OUT_DT) && $objResponse->BRC_OUT_DT !=''?$objResponse->BRC_OUT_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" >
        ...
        <div class="col-lg-2 pl">
          ...
          <option  value="SALES_CHALLAN" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='SALES_CHALLAN' ? 'selected':''); ?> >Sales Challan</option>
          <option  value="MISR" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='MISR' ? 'selected':''); ?> >Material Issue Slip against RPR</option>
          <option  value="JOB_WORK_CHALLAN" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='JOB_WORK_CHALLAN' ? 'selected':''); ?> >Job Work Challan</option>
          <option  value="RGP" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='RGP' ? 'selected':''); ?> >RGP</option>
          <option  value="PURCHASE_RETURN" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='PURCHASE_RETURN' ? 'selected':''); ?> >Purchase Return</option>
          <option  value="STTOSTTRANSAFER" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STTOSTTRANSAFER' ? 'selected':''); ?> >Stock To Stock Transfer</option>
          <option  value="MIS" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='MIS' ? 'selected':''); ?> >Material Issue Slip</option>
          <option  value="NRGP" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='NRGP' ? 'selected':''); ?> >NRGP</option>
          <option  value="STOCKADJUSTMENT" <?php echo e(isset($objResponse->SOURCE_TYPE) && $objResponse->SOURCE_TYPE=='STOCKADJUSTMENT' ? 'selected':''); ?> >Stock Adjustment</option>
        ...
        <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <td><input  type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("Main_popupITEMID_".$key); ?> id=<?php echo e("Main_popupITEMID_".$key); ?>  class="form-control"  autocomplete="off" value="<?php echo e($row->ICODE); ?>"  readonly/></td>
                          ...
                          <td><input type="text" <?php echo e($ActionStatus); ?> name=<?php echo e("Main_RECEIVED_QTY_".$key); ?> id=<?php echo e("Main_RECEIVED_QTY_".$key); ?>  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly value="<?php echo e($row->OUT_QTY); ?>"  /></td>
                          ...
                          <td hidden><input type="checkbox" name=<?php echo e("SERIAL_NO_".$key); ?> id=<?php echo e("SERIAL_NO_".$key); ?>  onclick="return false"  style="margin-left: 50%;"></td>
                          <td hidden><input type="checkbox" name=<?php echo e("BARCODE_".$key); ?> id=<?php echo e("BARCODE_".$key); ?>   onclick="return false" style="margin-left: 50%;"></td>
...
function validateForm(actionType,actionMsg){
  ...
  $('#material_item').find('.participantRow8').each(function(){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#BRC_OUT_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
/*================================== MATERIAL ITEM FUNCTION ==================================*/
          ...
          var recordid="<?php echo e($objResponse->BRCOID); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\BarcodeOut\trnfrm419edit.blade.php ENDPATH**/ ?>