...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[333,'index'])); ?>" class="btn singlebt">Service Purchase Invoice Register</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>SPI NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="SPIID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SPIID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objSPINo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SPIID); ?>" selected><?php echo e($Row->SPI_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                            
                            <div class="col-lg-3 pl"><p>SPO NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="SPOID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SPOID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objSPONo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SPOID); ?>" selected><?php echo e($Row->SPO_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[333,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SPIID  = [];
        $("select[name='SPIID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                SPIID.push(value7);
            }
        ...
        var SPOID  = [];
        $("select[name='SPOID[]']").each(function() {
            var value8 = $(this).val();
            if (value8) {
                SPOID.push(value8);
            }
        ...
        else if(SPOID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[333,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/purchase/SPI_Register/rptfrm333.blade.php ENDPATH**/ ?>