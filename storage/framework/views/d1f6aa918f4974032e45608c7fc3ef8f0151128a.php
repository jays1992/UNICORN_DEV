...
<div class="container-fluid purchase-order-view filter">     
  ...
  <div class="row">    
        ...
        <div class="col-lg-2 pl">
          <input disabled type="text" name="EMPCODE" id="EMPCODE" value="<?php echo e(isset($objResponse->EMPCODE) && $objResponse->EMPCODE !=''?$objResponse->EMPCODE:''); ?>" class="form-control" required autocomplete="off" maxlength="20" style="text-transform:uppercase" onkeypress="return AlphaNumaric(event,this)" readonly />
          <span class="text-danger" id="ERROR_EMPCODE"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Salutation</p></div>
        <div class="col-lg-2 pl">
          <select name="SAID_REF" id="SAID_REF" class="form-control" disabled>
        ...
        <div class="col-lg-2 pl">
        <input disabled type="text" name="FNAME" id="FNAME" value="<?php echo e(isset($objResponse->FNAME) && $objResponse->FNAME !=''?$objResponse->FNAME:''); ?>" class="form-control" autocomplete="off" required   maxlength="50" />
          <span class="text-danger" id="ERROR_FNAME"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Middle Name</p></div>
        <div class="col-lg-2 pl">
        <input disabled type="text" name="MNAME" id="MNAME" value="<?php echo e(isset($objResponse->MNAME) && $objResponse->MNAME !=''?$objResponse->MNAME:''); ?>" class="form-control" autocomplete="off"  maxlength="50"  />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input disabled type="text" name="LNAME" id="LNAME" value="<?php echo e(isset($objResponse->LNAME) && $objResponse->LNAME !=''?$objResponse->LNAME:''); ?>" class="form-control" autocomplete="off" maxlength="50"  />
          <span class="text-danger" id="ERROR_LNAME"></span> 
        </div>
          	
        <div class="col-lg-1 pl"><p>Old Ref No</p></div>
        <div class="col-lg-2 pl">
        <input disabled type="text" name="OLDREFNO" id="OLDREFNO" value="<?php echo e(isset($objResponse->OLDREFNO) && $objResponse->OLDREFNO !=''?$objResponse->OLDREFNO:''); ?>" class="form-control" autocomplete="off" maxlength="50" onkeypress="return isNumberKey(event,this)"  />
          <span class="text-danger" id="ERROR_OLDREFNO"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Gender</p></div>
        <div class="col-lg-2 pl">
          <select name="GID_REF" id="GID_REF" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
        <input disabled type="date" name="DOB" id="DOB" value="<?php echo e(isset($objResponse->DOB) && $objResponse->DOB !=''?date('Y-m-d',strtotime($objResponse->DOB)):''); ?>" class="form-control" autocomplete="off" required />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
        <input disabled type="text" name="DOBPLACE" id="DOBPLACE" value="<?php echo e(isset($objResponse->DOBPLACE) && $objResponse->DOBPLACE !=''?$objResponse->DOBPLACE:''); ?>" class="form-control" autocomplete="off" maxlength="100"  />
          <span class="text-danger" id="ERROR_DOBPLACE"></span> 
        </div>

        <div class="col-lg-1 pl"><p>Married Status</p></div>
        <div class="col-lg-2 pl">
          <select name="FATHERNAME" id="FATHERNAME" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="BGID_REF" id="BGID_REF" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="DESGID_REF" id="DESGID_REF" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="DEPID_REF" id="DEPID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="DIVID_REF" id="DIVID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="PLID_REF" id="PLID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
        <input disabled type="date" name="DOJ" id="DOJ" value="<?php echo e(isset($objResponse->DOJ) && $objResponse->DOJ !=''?date('Y-m-d',strtotime($objResponse->DOJ)):''); ?>" class="form-control" autocomplete="off" maxlength="200"  />
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select name="CATID_REF" id="CATID_REF" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="ETYPEID_REF" id="ETYPEID_REF" class="form-control" required disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="CCID_REF" id="CCID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
        ...
        <div class="col-lg-2 pl">
          <select name="GRADEID_REF" id="GRADEID_REF" class="form-control" disabled>
            <option value="" selected >Select</option>
     ...
     <div class="row"> 
        ...
        <div class="col-lg-2 pl"> 
          <input disabled type="checkbox" name="SALES_PERSON" id="SALES_PERSON" <?php echo e(isset($objResponse->SALES_PERSON) && $objResponse->SALES_PERSON =='1'?'checked':''); ?> value="1" >
          <span class="text-danger" id="ERROR_SALES_PERSON"></span>
        </div>
          
        <div class="col-lg-2 pl"><p>De-Activated</p></div>
        <div class="col-lg-1 pl pr">
        <input disabled type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?>
        ...
        <div class="col-lg-2 pl">
          <input disabled type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  />
        </div>
      </div>
        ...
        <div id="tab1" class="tab-pane fade in active">
          <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="CRESIDENCE" id="CRESIDENCE" <?php echo e(isset($objTab1->CRESIDENCE) && $objTab1->CRESIDENCE =='1'?'checked':''); ?> value="1" >
                <span class="text-danger" id="ERROR_CRESIDENCE"></span>
              </div>

              <div class="col-lg-2 "><p>Own / Parents Residence</p></div>
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="CROWN" id="CROWN" <?php echo e(isset($objTab1->CROWN) && $objTab1->CROWN =='1'?'checked':''); ?> value="1" onchange="getCParentRented('CROWN')" >
                <span class="text-danger" id="ERROR_CROWN"></span>
              </div>

              <div class="col-lg-1 "><p>Rented</p></div>
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="CRRENTED" id="CRRENTED" <?php echo e(isset($objTab1->CRRENTED) && $objTab1->CRRENTED =='1'?'checked':''); ?> value="1" onchange="getCParentRented('CRRENTED')" >
            ...
            <div class="row">
              ...
              <div class="col-lg-5 ">
                <textarea disabled name="CRADD1" id="CRADD1" class="form-control" autocomplete="off" ><?php echo e(isset($objTab1->CRADD1) && $objTab1->CRADD1 !=''?$objTab1->CRADD1:''); ?></textarea>
                <span class="text-danger" id="ERROR_CRADD1"></span>
              </div>

              <div class="col-lg-1 "><p>Add Line 2</p></div>
              <div class="col-lg-5 ">
                <textarea disabled name="CRADD2" id="CRADD2" class="form-control" autocomplete="off" ><?php echo e(isset($objTab1->CRADD2) && $objTab1->CRADD2 !=''?$objTab1->CRADD2:''); ?></textarea>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="CTRYID_REF_POPUP" id="CTRYID_REF_POPUP" value="<?php echo e(isset($objCountryName->CTRYCODE)?$objCountryName->CTRYCODE. ' - ':''); ?>  <?php echo e(isset($objCountryName->NAME)?$objCountryName->NAME:''); ?>" class="form-control" readonly />
              ...
              <div class="col-lg-2">
                  <input  disabled type="text" name="STID_REF_POPUP" id="STID_REF_POPUP" value="<?php echo e(isset($objStateName->STCODE)?$objStateName->STCODE. ' - ':''); ?>  <?php echo e(isset($objStateName->NAME)?$objStateName->NAME:''); ?>" class="form-control"  readonly/>
              ...
              <div class="col-lg-2">
                <input disabled type="text" name="CITYID_REF_POPUP" id="CITYID_REF_POPUP" value="<?php echo e(isset($objCityName->CITYCODE)?$objCityName->CITYCODE. ' - ':''); ?>  <?php echo e(isset($objCityName->NAME)?$objCityName->NAME:''); ?>" class="form-control" readonly tabindex="8" />
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <input disabled type="text" name="DISTID_REF_POPUP" id="DISTID_REF_POPUP" value="<?php echo e(isset($objDisticName->DISTCODE)?$objDisticName->DISTCODE. ' - ' :''); ?>  <?php echo e(isset($objDisticName->NAME)?$objDisticName->NAME:''); ?>" class="form-control" readonly tabindex="9" />
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="CRPIN" id="CRPIN" value="<?php echo e(isset($objTab1->CRPIN) && $objTab1->CRPIN !=''?$objTab1->CRPIN:''); ?>" class="form-control" autocomplete="off"  maxlength="10" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-1"><p>Landmark</p></div>
              <div class="col-lg-4">
                <input disabled type="text" name="CRLM" id="CRLM" value="<?php echo e(isset($objTab1->CRLM) && $objTab1->CRLM !=''?$objTab1->CRLM:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="PRRESIDENCE" id="PRRESIDENCE" <?php echo e(isset($objTab1->PRRESIDENCE) && $objTab1->PRRESIDENCE =='1'?'checked':''); ?>  value="1" >
                <span class="text-danger" id="ERROR_PRRESIDENCE"></span>
              </div>

              <div class="col-lg-2 "><p>Own / Parents Residence</p></div>
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="PROWN" id="PROWN" <?php echo e(isset($objTab1->PROWN) && $objTab1->PROWN =='1'?'checked':''); ?> value="1" onchange="getPParentRented('PROWN')" >
                <span class="text-danger" id="ERROR_PROWN"></span>
              </div>

              <div class="col-lg-1 "><p>Rented</p></div>
              <div class="col-lg-1 ">
                <input disabled type="checkbox" name="PRRENTED" id="PRRENTED" <?php echo e(isset($objTab1->PRRENTED) && $objTab1->PRRENTED =='1'?'checked':''); ?> value="1" onchange="getPParentRented('PRRENTED')" >
            ...
            <div class="row">
              <div class="col-lg-1 "><p>Add Line 1</p></div>
              <div class="col-lg-5 ">
                <textarea disabled name="PRADD1" id="PRADD1" class="form-control" autocomplete="off" maxlength="100" ><?php echo e(isset($objTab1->PRADD1) && $objTab1->PRADD1 !=''?$objTab1->PRADD1:''); ?></textarea>
                <span class="text-danger" id="ERROR_PRADD1"></span>
              </div>

              <div class="col-lg-1 "><p>Add Line 2</p></div>
              <div class="col-lg-5 ">
                <textarea disabled name="PRADD2" id="PRADD2" class="form-control" autocomplete="off" maxlength="100" ><?php echo e(isset($objTab1->PRADD2) && $objTab1->PRADD2 !=''?$objTab1->PRADD2:''); ?></textarea>
            ...
            <div class="row">
              <div class="col-lg-1"><p>Country</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="CTRYID_REF_POPUP1" id="CTRYID_REF_POPUP1" value="<?php echo e(isset($objCountryName->CTRYCODE)?$objCountryName->CTRYCODE. ' - ':''); ?>  <?php echo e(isset($objCountryName->NAME)?$objCountryName->NAME:''); ?>" class="form-control" readonly />
              ...
              <div class="col-lg-1"><p>State</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="STID_REF_POPUP1" id="STID_REF_POPUP1" value="<?php echo e(isset($objStateName->STCODE)?$objStateName->STCODE. ' - ':''); ?>  <?php echo e(isset($objStateName->NAME)?$objStateName->NAME:''); ?>" class="form-control" readonly/>
              ...
              <div class="col-lg-1"><p>City</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="CITYID_REF_POPUP1" id="CITYID_REF_POPUP1" value="<?php echo e(isset($objCityName->CITYCODE)?$objCityName->CITYCODE. ' - ':''); ?>  <?php echo e(isset($objCityName->NAME)?$objCityName->NAME:''); ?>" class="form-control" readonly />
            ...
            <div class="row">
              <div class="col-lg-1"><p>District</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="DISTID_REF_POPUP1" id="DISTID_REF_POPUP1" value="<?php echo e(isset($objDisticName->DISTCODE)?$objDisticName->DISTCODE. ' - ' :''); ?>  <?php echo e(isset($objDisticName->NAME)?$objDisticName->NAME:''); ?>" class="form-control" readonly  />
              ...
              <div class="col-lg-1"><p>Pincode</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="PRPIN" id="PRPIN" value="<?php echo e(isset($objTab1->PRPIN) && $objTab1->PRPIN !=''?$objTab1->PRPIN:''); ?>" class="form-control" autocomplete="off"  maxlength="10" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-1"><p>Landmark</p></div>
              <div class="col-lg-4">
                <input disabled type="text" name="PRLM" id="PRLM" value="<?php echo e(isset($objTab1->PRLM) && $objTab1->PRLM !=''?$objTab1->PRLM:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr  class="participantRow2">
                    <td><input disabled type="text" name="FAMILY_NAME_<?php echo e($key2); ?>" id ="FAMILY_NAME_<?php echo e($key2); ?>" value="<?php echo e(isset($tab2->NAME) && $tab2->NAME !=''?$tab2->NAME:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="date" name="FAMILY_DOB_<?php echo e($key2); ?>" id ="FAMILY_DOB_<?php echo e($key2); ?>" value="<?php echo e(isset($tab2->DOB) && $tab2->DOB !=''?date('Y-m-d',strtotime($tab2->DOB)):''); ?>"   class="form-control w-100" autocomplete="off" ></td>
                    
                    <td>
                    <select disabled name="FAMILY_GID_REF_<?php echo e($key2); ?>" id="FAMILY_GID_REF_<?php echo e($key2); ?>" class="form-control w-100" >
                    ...
                    <td>
                      <select disabled name="FAMILY_RSID_REF_<?php echo e($key2); ?>" id="FAMILY_RSID_REF_<?php echo e($key2); ?>" class="form-control w-100" >
                        <option value="" >Select</option>
                    ...
                    <td>
                      <select disabled name="FAMILY_EARNING_<?php echo e($key2); ?>" id="FAMILY_EARNING_<?php echo e($key2); ?>" class="form-control w-100" >
                        <option value="">Select</option>
                    ...
                    <td><input disabled type="text" name="FAMILY_CONTACTNO_<?php echo e($key2); ?>" id ="FAMILY_CONTACTNO_<?php echo e($key2); ?>" value="<?php echo e(isset($tab2->CONTACTNO) && $tab2->CONTACTNO !=''?$tab2->CONTACTNO:''); ?>"  maxlength="20" class="form-control w-100" autocomplete="off" onkeypress="return isNumberKey(event,this)"  ></td>
                    <td><input disabled type="text" name="FAMILY_EMAIL_<?php echo e($key2); ?>" id ="FAMILY_EMAIL_<?php echo e($key2); ?>" value="<?php echo e(isset($tab2->EMAIL) && $tab2->EMAIL !=''?$tab2->EMAIL:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                ...
                <?php else: ?>
                <tr  class="participantRow2">
                    <td><input disabled type="text" name="FAMILY_NAME_0" id ="FAMILY_NAME_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="date" name="FAMILY_DOB_0" id ="FAMILY_DOB_0"   class="form-control w-100" autocomplete="off" ></td>
                    
                    <td>
                    <select disabled name="FAMILY_GID_REF_0" id="FAMILY_GID_REF_0" class="form-control w-100" >
                      <option value="" >Select</option>
                      <?php $__currentLoopData = $getGender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td>
                      <select disabled name="FAMILY_RSID_REF_0" id="FAMILY_RSID_REF_0" class="form-control w-100" >
                        <option value="" >Select</option>
                        <?php $__currentLoopData = $getRelationShip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($val-> FID); ?>"><?php echo e($val-> FNAME); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td>
                      <select disabled name="FAMILY_EARNING_0" id="FAMILY_EARNING_0" class="form-control w-100" >
                        <option value="">Select</option>
                    ...
                    <td><input disabled type="text" name="FAMILY_CONTACTNO_0" id ="FAMILY_CONTACTNO_0"  maxlength="20" class="form-control w-100" autocomplete="off" onkeypress="return isNumberKey(event,this)" ></td>
                    <td><input disabled type="text" name="FAMILY_EMAIL_0" id ="FAMILY_EMAIL_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
            ...
            <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr  class="participantRow3">
                    <td><input disabled type="text" name="EDUCATION_DEGREE_<?php echo e($key3); ?>" id ="EDUCATION_DEGREE_<?php echo e($key3); ?>" value="<?php echo e(isset($tab3->DEGREE) && $tab3->DEGREE !=''?$tab3->DEGREE:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_YOP_<?php echo e($key3); ?>" id ="EDUCATION_YOP_<?php echo e($key3); ?>" value="<?php echo e(isset($tab3->YOP) && $tab3->YOP !=''?$tab3->YOP:''); ?>"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_UNIVERSITY_<?php echo e($key3); ?>" id ="EDUCATION_UNIVERSITY_<?php echo e($key3); ?>" value="<?php echo e(isset($tab3->UNIVERSITY) && $tab3->UNIVERSITY !=''?$tab3->UNIVERSITY:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_RESULT_<?php echo e($key3); ?>" id ="EDUCATION_RESULT_<?php echo e($key3); ?>" value="<?php echo e(isset($tab3->RESULT) && $tab3->RESULT !=''?$tab3->RESULT:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_REMARKS_<?php echo e($key3); ?>" id ="EDUCATION_REMARKS_<?php echo e($key3); ?>" value="<?php echo e(isset($tab3->REMARKS) && $tab3->REMARKS !=''?$tab3->REMARKS:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button disabled class="btn remove" title="Delete" data-toggle="tooltip" <?php echo e(isset($n3) && $n3 ==1?'disabled':''); ?>><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                <?php $n3++; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                <tr  class="participantRow3">
                    <td><input disabled type="text" name="EDUCATION_DEGREE_0" id ="EDUCATION_DEGREE_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_YOP_0" id ="EDUCATION_YOP_0"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_UNIVERSITY_0" id ="EDUCATION_UNIVERSITY_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_RESULT_0" id ="EDUCATION_RESULT_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EDUCATION_REMARKS_0" id ="EDUCATION_REMARKS_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
            ...
            <table id="example4" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr  class="participantRow4">
                    <td><input disabled type="text" name="EXPERIENCE_CNAME_<?php echo e($key4); ?>" id ="EXPERIENCE_CNAME_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->CNAME) && $tab4->CNAME !=''?$tab4->CNAME:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_FROMPD_<?php echo e($key4); ?>" id ="EXPERIENCE_FROMPD_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->FROMPD) && $tab4->FROMPD !=''?$tab4->FROMPD:''); ?>"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_TOPD_<?php echo e($key4); ?>" id ="EXPERIENCE_TOPD_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->TOPD) && $tab4->TOPD !=''?$tab4->TOPD:''); ?>"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_LASTDESIG_<?php echo e($key4); ?>" id ="EXPERIENCE_LASTDESIG_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->LASTDESIG) && $tab4->LASTDESIG !=''?$tab4->LASTDESIG:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_CTCPA_<?php echo e($key4); ?>" id ="EXPERIENCE_CTCPA_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->CTCPA) && $tab4->CTCPA !=''?$tab4->CTCPA:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_REMARKS_<?php echo e($key4); ?>" id ="EXPERIENCE_REMARKS_<?php echo e($key4); ?>" value="<?php echo e(isset($tab4->REMARKS) && $tab4->REMARKS !=''?$tab4->REMARKS:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button disabled class="btn remove" title="Delete" data-toggle="tooltip" <?php echo e(isset($n4) && $n4 ==1?'disabled':''); ?>><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                <?php $n4++; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                <tr  class="participantRow4">
                    <td><input disabled type="text" name="EXPERIENCE_CNAME_0" id ="EXPERIENCE_CNAME_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_FROMPD_0" id ="EXPERIENCE_FROMPD_0"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_TOPD_0" id ="EXPERIENCE_TOPD_0"  maxlength="30" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_LASTDESIG_0" id ="EXPERIENCE_LASTDESIG_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_CTCPA_0" id ="EXPERIENCE_CTCPA_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXPERIENCE_REMARKS_0" id ="EXPERIENCE_REMARKS_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" disabled><i class="fa fa-trash" ></i></button>
                    </td>
            ...
            <table id="example5" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr  class="participantRow5">
                    <td><input disabled type="text" name="REFERENCE_RNAME_<?php echo e($key5); ?>" id ="REFERENCE_RNAME_<?php echo e($key5); ?>" value="<?php echo e(isset($tab5->RNAME) && $tab5->RNAME !=''?$tab5->RNAME:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td>
                    <select disabled name="REFERENCE_GID_REF_<?php echo e($key5); ?>" id="REFERENCE_GID_REF_<?php echo e($key5); ?>" class="form-control w-100" >
                      <option value="" selected >Select</option>
                      <?php $__currentLoopData = $getGender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><input disabled type="text" name="REFERENCE_COMPANY_<?php echo e($key5); ?>" id ="REFERENCE_COMPANY_<?php echo e($key5); ?>" value="<?php echo e(isset($tab5->COMPANY) && $tab5->COMPANY !=''?$tab5->COMPANY:''); ?>"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_DESIG_<?php echo e($key5); ?>" id ="REFERENCE_DESIG_<?php echo e($key5); ?>" value="<?php echo e(isset($tab5->DESIG) && $tab5->DESIG !=''?$tab5->DESIG:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_MONO_<?php echo e($key5); ?>" id ="REFERENCE_MONO_<?php echo e($key5); ?>" value="<?php echo e(isset($tab5->MONO) && $tab5->MONO !=''?$tab5->MONO:''); ?>"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_EMAIL_<?php echo e($key5); ?>" id ="REFERENCE_EMAIL_<?php echo e($key5); ?>" value="<?php echo e(isset($tab5->EMAIL) && $tab5->EMAIL !=''?$tab5->EMAIL:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button disabled class="btn remove" title="Delete" data-toggle="tooltip" <?php echo e(isset($n5) && $n5 ==1?'disabled':''); ?>><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                <?php $n5++; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                <tr  class="participantRow5">
                    <td><input disabled type="text" name="REFERENCE_RNAME_0" id ="REFERENCE_RNAME_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td>
                    <select disabled name="REFERENCE_GID_REF_0" id="REFERENCE_GID_REF_0" class="form-control w-100" >
                      <option value="" selected >Select</option>
                      <?php $__currentLoopData = $getGender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($val-> FID); ?>"><?php echo e($val-> FNAME); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><input disabled type="text" name="REFERENCE_COMPANY_0" id ="REFERENCE_COMPANY_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_DESIG_0" id ="REFERENCE_DESIG_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_MONO_0" id ="REFERENCE_MONO_0"  maxlength="20" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="REFERENCE_EMAIL_0" id ="REFERENCE_EMAIL_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" disabled><i class="fa fa-trash" ></i></button>
                    </td>
            ...
            <table id="example6" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <?php $n6=1; ?>
                ...
                <tr  class="participantRow6">
                    <td><input disabled type="text" name="EXTRACUR_NAME_<?php echo e($key6); ?>" id ="EXTRACUR_NAME_<?php echo e($key6); ?>" value="<?php echo e(isset($tab6->NAME) && $tab6->NAME !=''?$tab6->NAME:''); ?>" maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_PERIOD_<?php echo e($key6); ?>" id ="EXTRACUR_PERIOD_<?php echo e($key6); ?>" value="<?php echo e(isset($tab6->PERIOD) && $tab6->PERIOD !=''?$tab6->PERIOD:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_LEVELS_<?php echo e($key6); ?>" id ="EXTRACUR_LEVELS_<?php echo e($key6); ?>" value="<?php echo e(isset($tab6->LEVELS) && $tab6->LEVELS !=''?$tab6->LEVELS:''); ?>"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_ACHIEVEMENT_<?php echo e($key6); ?>" id ="EXTRACUR_ACHIEVEMENT_<?php echo e($key6); ?>" value="<?php echo e(isset($tab6->ACHIEVEMENT) && $tab6->ACHIEVEMENT !=''?$tab6->ACHIEVEMENT:''); ?>" maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button disabled class="btn remove" title="Delete" data-toggle="tooltip" <?php echo e(isset($n6) && $n6 ==1?'disabled':''); ?>><i class="fa fa-trash" ></i></button>
                    </td>
                </tr>
                <?php $n6++; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                <tr  class="participantRow6">
                    <td><input disabled type="text" name="EXTRACUR_NAME_0" id ="EXTRACUR_NAME_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_PERIOD_0" id ="EXTRACUR_PERIOD_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_LEVELS_0" id ="EXTRACUR_LEVELS_0"  maxlength="50" class="form-control w-100" autocomplete="off" ></td>
                    <td><input disabled type="text" name="EXTRACUR_ACHIEVEMENT_0" id ="EXTRACUR_ACHIEVEMENT_0"  maxlength="100" class="form-control w-100" autocomplete="off" ></td>
                    <td align="center" >
                        <button disabled class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button>
                        <button class="btn remove" title="Delete" data-toggle="tooltip" disabled><i class="fa fa-trash" ></i></button>
                    </td>
        ...
        <div id="tab7" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="PANNO" id="PANNO" value="<?php echo e(isset($objTab7->PANNO) && $objTab7->PANNO !=''?$objTab7->PANNO:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>AADHAAR NO</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="AADHARNO" id="AADHARNO" value="<?php echo e(isset($objTab7->AADHARNO) && $objTab7->AADHARNO !=''?$objTab7->AADHARNO:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Election I Card No</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="ELECTIONCNO" id="ELECTIONCNO" value="<?php echo e(isset($objTab7->ELECTIONCNO) && $objTab7->ELECTIONCNO !=''?$objTab7->ELECTIONCNO:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="ELECTIONCPOI" id="ELECTIONCPOI" value="<?php echo e(isset($objTab7->ELECTIONCPOI) && $objTab7->ELECTIONCPOI !=''?$objTab7->ELECTIONCPOI:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="DLNO" id="DLNO" value="<?php echo e(isset($objTab7->DLNO) && $objTab7->DLNO !=''?$objTab7->DLNO:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="DLPOI" id="DLPOI" value="<?php echo e(isset($objTab7->DLPOI) && $objTab7->DLPOI !=''?$objTab7->DLPOI:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>Valid Upto</p></div>
              <div class="col-lg-2">
                <input disabled type="date" name="DLVALIDUPTO" id="DLVALIDUPTO" value="<?php echo e(isset($objTab7->DLVALIDUPTO) && $objTab7->DLVALIDUPTO !=''?date('Y-m-d',strtotime($objTab7->DLVALIDUPTO)):''); ?>" class="form-control"  autocomplete="off"  >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="PASSPORTNO" id="PASSPORTNO" value="<?php echo e(isset($objTab7->PASSPORTNO) && $objTab7->PASSPORTNO !=''?$objTab7->PASSPORTNO:''); ?>" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Place of Issue</p></div>
              <div class="col-lg-2"> 
                <input disabled type="text" name="PASSPORTPOI" id="PASSPORTPOI" value="<?php echo e(isset($objTab7->PASSPORTPOI) && $objTab7->PASSPORTPOI !=''?$objTab7->PASSPORTPOI:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>Valid Upto</p></div>
              <div class="col-lg-2">
                <input disabled type="date" name="PASSPORTVUPTO" id="PASSPORTVUPTO" value="<?php echo e(isset($objTab7->PASSPORTVUPTO) && $objTab7->PASSPORTVUPTO !=''?date('Y-m-d',strtotime($objTab7->PASSPORTVUPTO)):''); ?>" class="form-control"  autocomplete="off"  >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="PFNO" id="PFNO" value="<?php echo e(isset($objTab7->PFNO) && $objTab7->PFNO !=''?$objTab7->PFNO:''); ?>" class="form-control" autocomplete="off"  maxlength="30" >
              </div>

              <div class="col-lg-1"><p>ESI NO</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="ESINO" id="ESINO" value="<?php echo e(isset($objTab7->ESINO) && $objTab7->ESINO !=''?$objTab7->ESINO:''); ?>" class="form-control" autocomplete="off" maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Membership Name</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="MSHIPNAME" id="MSHIPNAME" value="<?php echo e(isset($objTab7->MSHIPNAME) && $objTab7->MSHIPNAME !=''?$objTab7->MSHIPNAME:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>No</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="MSHIPNO" id="MSHIPNO" value="<?php echo e(isset($objTab7->MSHIPNO) && $objTab7->MSHIPNO !=''?$objTab7->MSHIPNO:''); ?>" class="form-control"  autocomplete="off" maxlength="20" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="CONTRACTRNAME" id="CONTRACTRNAME" value="<?php echo e(isset($objTab7->CONTRACTRNAME) && $objTab7->CONTRACTRNAME !=''?$objTab7->CONTRACTRNAME:''); ?>" class="form-control" autocomplete="off" maxlength="100" >
              </div>

              <div class="col-lg-1"><p>Nominee Name</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="NOMINEENAME" id="NOMINEENAME" value="<?php echo e(isset($objTab7->NOMINEENAME) && $objTab7->NOMINEENAME !=''?$objTab7->NOMINEENAME:''); ?>" class="form-control" autocomplete="off" maxlength="100" >
              </div>

              <div class="col-lg-1"><p>Relationship</p></div>
              <div class="col-lg-2">
                <select disabled name="RSID_REF" id="RSID_REF" class="form-control" >
                  <option value="" >Select</option>
                  <?php $__currentLoopData = $getRelationShip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="BANK" id="BANK" value="<?php echo e(isset($objTab7->BANK) && $objTab7->BANK !=''?$objTab7->BANK:''); ?>" class="form-control" autocomplete="off"  maxlength="100" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="IFSC" id="IFSC" value="<?php echo e(isset($objTab7->IFSC) && $objTab7->IFSC !=''?$objTab7->IFSC:''); ?>" class="form-control" autocomplete="off"  maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Branch</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="BRANCH" id="BRANCH" value="<?php echo e(isset($objTab7->BRANCH) && $objTab7->BRANCH !=''?$objTab7->BRANCH:''); ?>" class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-1"><p>Account Type</p></div>
              <div class="col-lg-2">
                 
                  <select disabled name="ACTYPE" id="ACTYPE" class="form-control"  >
                    <option value="" selected >Select</option>
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="ACNO" id="ACNO" value="<?php echo e(isset($objTab7->ACNO) && $objTab7->ACNO !=''?$objTab7->ACNO:''); ?>" class="form-control" autocomplete="off"  maxlength="30" onkeypress="return isNumberKey(event,this)" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="BRANCHCODE" id="BRANCHCODE" value="<?php echo e(isset($objTab7->BRANCHCODE) && $objTab7->BRANCHCODE !=''?$objTab7->BRANCHCODE:''); ?>" class="form-control" autocomplete="off"  maxlength="30" >
              </div>
            </div>
        ...
        <div id="tab8" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="LLNO" id="LLNO" value="<?php echo e(isset($objTab8->LLNO) && $objTab8->LLNO !=''?$objTab8->LLNO:''); ?>" class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-2"><p>Cell No 1</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="MONO1" id="MONO1" value="<?php echo e(isset($objTab8->MONO1) && $objTab8->MONO1 !=''?$objTab8->MONO1:''); ?>"   class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>

              <div class="col-lg-2"><p>Cell No 2</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="MONO2" id="MONO2" value="<?php echo e(isset($objTab8->MONO2) && $objTab8->MONO2 !=''?$objTab8->MONO2:''); ?>"  class="form-control" autocomplete="off"  maxlength="20" onkeypress="return isNumberKey(event,this)" >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <input disabled type="text" name="EMAIL" id="EMAIL" value="<?php echo e(isset($objTab8->EMAIL) && $objTab8->EMAIL !=''?$objTab8->EMAIL:''); ?>"  class="form-control" autocomplete="off"  maxlength="50" >
              </div>

              <div class="col-lg-2"><p>Personal Email ID</p></div>
              <div class="col-lg-2">
                  <input disabled type="text" name="PEMAIL" id="PEMAIL" value="<?php echo e(isset($objTab8->PEMAIL) && $objTab8->PEMAIL !=''?$objTab8->PEMAIL:''); ?>"  class="form-control"  autocomplete="off" maxlength="50" >
              </div>

              <div class="col-lg-2"><p>Emergency Contact Person</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="EMERGCPNAME" id="EMERGCPNAME" value="<?php echo e(isset($objTab8->EMERGCPNAME) && $objTab8->EMERGCPNAME !=''?$objTab8->EMERGCPNAME:''); ?>"  class="form-control" autocomplete="off" maxlength="50" >
              </div>
            ...
            <div class="col-lg-2"><p>Cell No</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="EMERGCPMONO" id="EMERGCPMONO" value="<?php echo e(isset($objTab8->EMERGCPMONO) && $objTab8->EMERGCPMONO !=''?$objTab8->EMERGCPMONO:''); ?>"  class="form-control" autocomplete="off" maxlength="20" onkeypress="return isNumberKey(event,this)"   >
              </div>
            </div>
        ...
        <div id="tab9" class="tab-pane fade">
          <div class="table-wrapper-scroll-x" style="margin-top:10px;">
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                  <input disabled type="text" name="CRDISEASE1" id="CRDISEASE1" value="<?php echo e(isset($objTab9->CRDISEASE1) && $objTab9->CRDISEASE1 !=''?$objTab9->CRDISEASE1:''); ?>" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Current Disease 2</p></div>
              <div class="col-lg-5">
                <input disabled type="text" name="CRDISEASE2" id="CRDISEASE2" value="<?php echo e(isset($objTab9->CRDISEASE2) && $objTab9->CRDISEASE2 !=''?$objTab9->CRDISEASE2:''); ?>" class="form-control" autocomplete="off" maxlength="20" >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                <input disabled type="text" name="CRDISEASE3" id="CRDISEASE3" value="<?php echo e(isset($objTab9->CRDISEASE3) && $objTab9->CRDISEASE3 !=''?$objTab9->CRDISEASE3:''); ?>" class="form-control" autocomplete="off" maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Allergy</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="ALLERGY" id="ALLERGY" value="<?php echo e(isset($objTab9->ALLERGY) && $objTab9->ALLERGY !=''?$objTab9->ALLERGY:''); ?>" class="form-control" autocomplete="off" maxlength="20" >
              </div>
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="HEIGHT" id="HEIGHT" value="<?php echo e(isset($objTab9->HEIGHT) && $objTab9->HEIGHT !=''?$objTab9->HEIGHT:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Weight</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="WEIGHT" id="WEIGHT" value="<?php echo e(isset($objTab9->WEIGHT) && $objTab9->WEIGHT !=''?$objTab9->WEIGHT:''); ?>" class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Color</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="COLOR" id="COLOR" value="<?php echo e(isset($objTab9->COLOR) && $objTab9->COLOR !=''?$objTab9->COLOR:''); ?>" class="form-control" autocomplete="off" maxlength="15"   >
              </div>

              <div class="col-lg-1"><p>Religion</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="RELIGION" id="RELIGION" value="<?php echo e(isset($objTab9->RELIGION) && $objTab9->RELIGION !=''?$objTab9->RELIGION:''); ?>" class="form-control" autocomplete="off" maxlength="15"   >
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                  <input disabled type="text" name="NANTIONALITY" id="NANTIONALITY"  value="<?php echo e(isset($objTab9->NANTIONALITY) && $objTab9->NANTIONALITY !=''?$objTab9->NANTIONALITY:''); ?>"class="form-control" autocomplete="off"  maxlength="20" >
              </div>

              <div class="col-lg-1"><p>Hobbies</p></div>
              <div class="col-lg-2">
                <input disabled type="text" name="HOBBIES" id="HOBBIES" value="<?php echo e(isset($objTab9->HOBBIES) && $objTab9->HOBBIES !=''?$objTab9->HOBBIES:''); ?>" class="form-control" autocomplete="off" maxlength="30" >
              </div>

              <div class="col-lg-1"><p>Vegetarian</p></div>
              <div class="col-lg-2">
                <input disabled type="radio" name="VEGETARIAN" <?php echo e(isset($objTab9->VEGETARIAN) && $objTab9->VEGETARIAN =='1'?'checked':''); ?>  value="1"  >
              </div>

              <div class="col-lg-1"><p>Non-Veg</p></div>
              <div class="col-lg-2">
              <input disabled type="radio" name="VEGETARIAN" <?php echo e(isset($objTab9->VEGETARIAN) && $objTab9->VEGETARIAN =='0'?'checked':''); ?>    value="0"   >
              </div>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="dist_tab1" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody>
        <tr>
          <td ><input type="text" id="dist_codesearch" onkeyup="searchDistCode()"></td>
          <td><input type="text" id="dist_namesearch" onkeyup="searchDistName()"></td>
        </tr>
        </tbody>
      </table>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="country_tab21" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objCountryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$CountryList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr id="ctryidref1_<?php echo e($CountryList->CTRYID); ?>" class="cls_ctryidref1">
          <td width="50%"><?php echo e($CountryList->CTRYCODE); ?>
...
$('.cls_ctryidref').dblclick(function(){
  var id = $(this).attr('id');
...
function bindCityEvents(){
	$('.cls_cityidref').dblclick(function(){
...
function bindDistEvents(){
	$('.cls_distidref').dblclick(function(){
...
$('.cls_ctryidref1').dblclick(function(){
  var id = $(this).attr('id');
  var txtval =    $("#txt"+id+"").val();
  var texdesc =   $("#txt"+id+"").data("desc")
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EmployeeMaster\mstfrm179view.blade.php ENDPATH**/ ?>