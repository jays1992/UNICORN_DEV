...
<div class="row">
    <div class="col-lg-2">
    <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Team Master</a>
    </div>
      <div class="col-lg-10 topnav-pd">
        ...
        <button class="btn topnavbt" id="btnApprove" onclick="submitData('fnApproveData')" <?php echo e((isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?>><i class="fa fa-lock"></i> Approved</button>
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST"  > 
        <?php echo csrf_field(); ?>
        <?php echo e(isset($objResponse->TEAMMSTID) ? method_field('PUT') : ''); ?>

       <div class="inner-form">
             <div class="row">
               <div class="col-lg-2 pl"><p>Team Master Code*</p></div>
               <div class="col-lg-2 pl">
                   <input <?php echo e($ActionStatus); ?> type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e(isset($objResponse->TEAMMST_NO) && $objResponse->TEAMMST_NO !=''?$objResponse->TEAMMST_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                 <span class="text-danger" id="ERROR_DOC_NO"></span>
               </div>

               <div class="col-lg-2 pl"><p>Document Date*</p></div>
               <div class="col-lg-2 pl">
               <input <?php echo e($ActionStatus); ?> type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e(isset($objResponse->TEAMMST_DATE) && $objResponse->TEAMMST_DATE !=''?$objResponse->TEAMMST_DATE:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
               </div>               
             </div>
             ...
             <div class="row">
              <div class="col-lg-2 pl"><p>Team Head*</p></div>
               <div class="col-lg-2 pl">
                 <input <?php echo e($ActionStatus); ?> type="text" name="TEAMHEAD" id="TEAMHEAD" onclick="getTeamHead()" value="<?php echo e(isset($objResponse->EMPCODE) && $objResponse->EMPCODE !=''?$objResponse->EMPCODE:''); ?>" class="form-control mandatory" readonly/>
                 <input type="hidden" name="TEAMHEADID_REF" id="TEAMHEADID_REF" value="<?php echo e(isset($objResponse->EMPID) && $objResponse->EMPID !=''?$objResponse->EMPID:''); ?>" class="form-control" autocomplete="off" />
               </div>

               <div class="col-lg-2 pl"><p>Team Name</p></div>
               <div class="col-lg-2 pl">
                 <input <?php echo e($ActionStatus); ?> type="text" name="TEAMNAME" id="TEAMNAME" value="<?php echo e(isset($objResponse->FNAME) && $objResponse->FNAME !=''?$objResponse->FNAME:''); ?>" class="form-control mandatory" readonly/>
               </div>
             </div> 
...
function getTeamHead(){
   ...
   $.ajax({
       url:'<?php echo e(route("master",[$FormId,"getTeamHead"])); ?>',
       type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\TeamMaster\mstfrm504edit.blade.php ENDPATH**/ ?>