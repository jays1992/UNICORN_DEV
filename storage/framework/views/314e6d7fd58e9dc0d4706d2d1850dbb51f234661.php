    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl BRANCH_NAME">
            <input type="hidden"  name="BRANCH_ID"    id="BRANCH_ID" value="<?php echo e(Session::get('BRID_REF')); ?>"    class="form-control" autocomplete="off" >
            <input type="text"    name="BRANCH_NAME"  id="BRANCH_NAME" value="<?php echo e(Session::get('branch_name')); ?>"   class="form-control" autocomplete="off" readonly onclick="getBranch()" >
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockTransfer\trnfrm482add.blade.php ENDPATH**/ ?>