       ...
       <div class="inner-form">
             ...
             <div class="row">            
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="ASSTLCODE" id="ASSTLCODE" value="<?php echo e($HDR->ALCODE); ?>" class="form-control"  maxlength="100" disabled> 
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="ASSTLDES" id="ASSTLDES" value="<?php echo e($HDR->DESCRIPTIONS); ?>" class="form-control"  maxlength="100" disabled> 
               </div>                                
             </div>
           ...
           <div class="row">
             ...
             <div class="col-lg-2 pl">
               <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''); ?>" tabindex="3" disabled placeholder="dd/mm/yyyy"  />
             </div>
          </div>
                   ...
                   <tr>   
                     ...
                     <tbody>
                       ...
                       <tr  class="participantRow">
                         <td hidden><input type="hidden" name="ASLID" id="ASLID" value="<?php echo e($row->ASLID); ?>" disabled/></td>
                           <td><input  class="form-control" type="text" name="SUBLCODE[]"   id =<?php echo e("SUBLCODE_".$key); ?>  value="<?php echo e($row->ASLCODE); ?>" autocomplete="off" disabled></td>
                           <td><input  class="form-control" type="text" name="SUBLDES[]"   id =<?php echo e("SUBLDES_".$key); ?>    value="<?php echo e($row->DESCRIPTIONS); ?>" autocomplete="off" disabled></td>
                           <td><select  name="INACTIVE[]" id =<?php echo e("INACTIVE_".$key); ?> class="form-control mandatory" tabindex="4" disabled>
                             <option value="" selected >Select</option>
                             <option <?php echo e(isset($MAT->YESNO) && $MAT->YESNO == '1'?'selected="selected"':''); ?> value="1">Yes</option>
                             <option <?php echo e(isset($MAT->YESNO) && $MAT->YESNO == '0'?'selected="selected"':''); ?> value="0">No</option>                              
                           </select>
                           <td>
                           <input  class="form-control" type="date" name="INACTIVEDATE[]" id =<?php echo e("INACTIVEDATE_".$key); ?>  value="<?php echo e($row->MEMO); ?>" autocomplete="off" disabled>
                           <td align="center" >
...
$(function() { 
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetLocationSubLocation\mstfrm405view.blade.php ENDPATH**/ ?>