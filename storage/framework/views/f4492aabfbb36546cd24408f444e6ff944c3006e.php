...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[69,'index'])); ?>" class="btn singlebt">Service Purchase Order</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="SONO" id="SONO" value="<?php echo e(isset($objSO->SPO_NO)?$objSO->SPO_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="SODT" id="SODT" onchange="checkPeriodClosing(69,this.value,1)" value="<?php echo e(isset($objSO->SPO_DT)?$objSO->SPO_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="<?php echo e(isset($objsubglcode->VCODE)?$objsubglcode->VCODE:''); ?> <?php echo e(isset($objsubglcode->NAME)?$objsubglcode->NAME:''); ?>"  autocomplete="off" readonly/>
                                <input type="hidden" name="SLID_REF" id="SLID_REF" class="form-control" autocomplete="off"  value="<?php echo e(isset($objSO->VID_REF)?$objSO->VID_REF:''); ?>"/>
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSO->VALID_FR)?$objSO->VALID_FR:''); ?>" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>SPO Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objSO->VALID_TO)?$objSO->VALID_TO:''); ?>" >
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objSO->VENDOR_REFNO)?$objSO->VENDOR_REFNO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->CREDIT_DAYS)?$objSO->CREDIT_DAYS:''); ?>">
                            </div>
                            ...
                            <div class="col-lg-2 pl" id="div_billto">
                                ...
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->BILL_TO)?$objSO->BILL_TO:''); ?>" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                ...
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objSO->SHIP_TO)?$objSO->SHIP_TO:''); ?>" />
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="<?php echo e(isset($objSO->VENDOR_REFDT)?$objSO->VENDOR_REFDT:''); ?>" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 pl">
                                <textarea <?php echo e($ActionStatus); ?> class="form-control w-100" name="Delivery_Address" cols="40" rows="10" id="Delivery_Address" autocomplete="off" ><?php echo e(isset($objSO->Delivery_Address)?$objSO->Delivery_Address:''); ?></textarea>
                            </div>
                                            ...
                                            <?php if(!empty($objSOMAT)): ?>
                                                <?php $__currentLoopData = $objSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        <td hidden><input  class="form-control" type="hidden" name=<?php echo e("SOMATID_".$key); ?> id =<?php echo e("SOMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SPOMATID); ?>" autocomplete="off" style="width:130px;"   ></td>
                                                        <td style="text-align:center;" hidden>
                                                        <input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("txtSQ_popup_".$key); ?> id=<?php echo e("txtSQ_popup_".$key); ?> class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("SQA_".$key); ?> id=<?php echo e("SQA_".$key); ?> class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("SEQID_REF_".$key); ?> id=<?php echo e("SEQID_REF_".$key); ?> class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                          
                                                        <td  hidden><input type="text" name=<?php echo e("PIID_REF_".$key); ?> id=<?php echo e("PIID_REF_".$key); ?> class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("MRSID_REF_".$key); ?> id=<?php echo e("MRSID_REF_".$key); ?> class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("RFQID_REF_".$key); ?> id=<?php echo e("RFQID_REF_".$key); ?> class="form-control" value="" autocomplete="off" style="width:130px;" /></td>
                                                        ...
                                                        <td  hidden><input type="text" name=<?php echo e("ITEMID_REF_".$key); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->SERVICECODE); ?>" autocomplete="off" style="width:130px;" /></td>
                                                        
                                                        <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->SERVICE_DESC); ?>" autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SERVICE_SPECIFICATION_".$key); ?> id=<?php echo e("SERVICE_SPECIFICATION_".$key); ?> class="form-control" value="<?php echo e($row->SERVICE_SPECIFICATION); ?>" autocomplete="off" style="width:130px;" /></td>
                                                       
                                                        <td hidden><input type="text" name=<?php echo e("Itemspec_".$key); ?> id=<?php echo e("Itemspec_".$key); ?> class="form-control"  autocomplete="off" value="" style="width:130px;" /></td>
                                                        ...
                                                        <td hidden><input type="text" name=<?php echo e("SQMUOM_".$key); ?> id=<?php echo e("SQMUOM_".$key); ?> class="form-control"  autocomplete="off"  value="" readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name=<?php echo e("SQMUOMQTY_".$key); ?> id=<?php echo e("SQMUOMQTY_".$key); ?> class="form-control" maxlength="13" value="" autocomplete="off"  readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name=<?php echo e("SQAUOM_".$key); ?> id=<?php echo e("SQAUOM_".$key); ?> class="form-control"  autocomplete="off" value="" readonly style="width:130px;" /></td>
                                                        <td hidden><input type="text" name=<?php echo e("SQAUOMQTY_".$key); ?> id=<?php echo e("SQAUOMQTY_".$key); ?> class="form-control" maxlength="13" autocomplete="off" value=""  readonly style="width:130px;" /></td>
                                                        
                                                        <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  autocomplete="off"  value="<?php echo e($row->MAIN_UOM_CODE); ?>"  readonly disabled style="width:130px;" /></td>
                                                        ...
                                                        <td hidden><input type="text" name=<?php echo e("PENDING_QTY_".$key); ?> id=<?php echo e("PENDING_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="" autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SO_QTY_".$key); ?> id=<?php echo e("SO_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo number_format(floatVal($row->SPO_QTY),3,'.','');  ?>"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("SO_FQTY_".$key); ?> id=<?php echo e("SO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;"/></td>
                                                        
                                                        <td hidden><input type="text" name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("ALT_UOMID_REF_".$key); ?> id=<?php echo e("ALT_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" value=""  readonly disabled style="width:130px;text-align:right;" /></td>
                                                        <td hidden><input type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                                                        <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->SPO_RATE); ?>"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input <?php echo e($ActionStatus); ?> <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->DISCOUNT_PER); ?>"  autocomplete="off" style="width:130px;text-align:right;"  <?php echo e($AlpsStatus['disabled']); ?> /></td>
                                                        <td><input <?php echo e($ActionStatus); ?> <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DIS_AMT); ?>" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" <?php echo e($AlpsStatus['disabled']); ?> /></td>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$Ukey); ?>  id=<?php echo e("UDFSOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDF); ?>" autocomplete="off" /></td>
                                            ...
                                            <?php $__currentLoopData = $objUdfSOData2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$uindex); ?> id=<?php echo e("UDFSOID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->SRPOID); ?>" autocomplete="off"   /></td>
                                            ...
                                            <?php if(!empty($objSOCAL)): ?>
                                                <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td hidden style="text-align:center;"  ><input type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?> value=""  ></td>
                                                ...
                                                <tr  class="participantRow5">
                                                    ...
                                                    <td hidden style="text-align:center;"><input <?php echo e($ActionStatus); ?> type="checkbox" class="filter-none" name="calACTUAL_0" id="calACTUAL_0" value=""   ></td>
                                                    <td align="center" ><button class="btn add" title="add" data-toggle="tooltip" type="button" disabled><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" disabled><i class="fa fa-trash" ></i></button></td>
                                                </tr>
                                                <tr></tr>
                                            <?php endif; ?> 
    ...
    <input type="text" id="UDFSOIDnamesearch" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_<?php echo e($udfindex); ?>" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->SRPOID); ?>"/>
          </td>
      ...
      $(".clstncid").click(function(){
        ...
        if(customid!=''){
          ...
          // $('#tncbody').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"gettncdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"gettncdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                    $('#Row_Count2').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"gettncdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
      ...
      $(".clsctid").click(function(){
        ...
        if(customid!=''){
          ...
          $('#tbody_ctid').html('<tr><td colspan="2">Please wait..</td></tr>');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"getcalculationdetails2"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"getcalculationdetails3"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $('#Row_Count4').val(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"getcalculationdetails"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
...
function loadVendor(CODE,NAME){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[69,"getVendor"])); ?>',
    type:'POST',
            ...
            var customid = txtval;
              if(customid!=''){
                $("#CREDITDAYS").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getcreditdays"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#CREDITDAYS").val(data);                        
                ...
                $("#BILLTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getBillTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtBILLTO1").hide();
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getShipTo"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
                        $("#txtSHIPTO1").hide();
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getTDSApplicability"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data){
                        if(data == 1){
                          ...
                          $('#drpTDS').val('Yes');
                              ...
                              $.ajax({
                                  url:'<?php echo e(route("transaction",[69,"getTDSDetails"])); ?>',
                                  type:'POST',
                                  data:{'id':customid},
                                  success:function(data) {
                                    $("#tbody_tds").html('');
...
//------------------------
  ...
  $('#div_billto').on('click','#txtBILLTO',function(event){
        ...
        $("#tbody_BillTo").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getBillAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
...
//------------------------
  ...
  $('#div_shipto').on('click','#txtSHIPTO',function(event){
        ...
        $("#tbody_ShipTo").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getShipAddress"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {
  ...
  $('#Material').on('click','[id*="txtSQ_popup"]',function(event){
    ...
    if($.trim( $("#GLID_REF").val())=="" ){
       ...
       if($('#PO_BASED option:selected').val()=="Quotation"){
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[69,"getvqlist"])); ?>',
                  type:'POST',
                  data:{'id':customid},
                  success:function(data) {
                    $("#tbody_SQ").html(data);
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"getpilist"])); ?>',
                type:'POST',
                data:{'id':customid},
                success:function(data) {
                  $("#tbody_SQ").html(data);
...
function loadItem(taxstate,CODE,NAME,MUOM,GROUP,CTGRY,BUNIT,APART,CPART,OPART){
		...
		$.ajax({
      url:'<?php echo e(route("transaction",[69,"getItemDetails"])); ?>',
			type:'POST',
  ...
  $('#Material').on('click','[id*="popupITEMID"]',function(event){
        ...
        //             });
        //             $.ajax({
        //                 url:'<?php echo e(route("transaction",[69,"getItemDetailsVQwise"])); ?>',
        //                 type:'POST',
        ...
        // {
                ...
                $("#tbody_ItemID").html('Loading...');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getItemDetailswithoutQuotation"])); ?>',
                      type:'POST',
  ...
  $('#Material').on('keydown','[id*="popupAUOM"]',function(event){
        ...
        if(ItemID !=''){
                $("#tbody_altuom").html('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getAltUOM"])); ?>',
                      type:'POST',
                      data:{'id':ItemID},
                      success:function(data) {
      ...
      $(".clsaltuom").dblclick(function(){
        ...
        if(altuomid!=''){
              $('#'+txt_id4).val('');
                  ...
                  $.ajax({
                      url:'<?php echo e(route("transaction",[69,"getaltuomqty"])); ?>',
                      type:'POST',
  ...
  var Material = $("#Material").html(); 
    ...
    */
    ...
    $('#btnAdd').on('click', function() {
        var viewURL = '<?php echo e(route("transaction",[69,"add"])); ?>';
...
$("#btnApprove").click(function(){
  var formPurchaseOrder = $("#frm_trn_so");
  var checkAttachment = "<?php echo e($checkAttachment); ?>";
  if(formPurchaseOrder.valid()){
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[69,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[69,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[69,"index"])); ?>';
});
...
function getTaxStatus(customid){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[69,"getTaxStatus"])); ?>',
    type:'POST',
    data:{id:customid},
    success:function(data) {
      if(data =="1"){
  ...
  /*
  var TaxStatus = $.ajax({type: 'POST',url:'<?php echo e(route("transaction",[69,"getTaxStatus"])); ?>',async: false,dataType: 'json',data: {id:customid},done: function(response) {return response;}}).responseText;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\ServicePurchaseOrder\trnfrm69view.blade.php ENDPATH**/ ?>