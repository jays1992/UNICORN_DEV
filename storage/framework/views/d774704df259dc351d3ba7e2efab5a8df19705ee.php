  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <thead id="thead1">
            <tr>
                <th id="all-check" style="width:50px;"><input type="checkbox" class="js-selectall" data-target=".js-selectall1" data-docdate="<?php echo e(isset($val->ADSMDT) && $val->ADSMDT !='' && $val->ADSMDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ADSMDT)):''); ?>"  />Select</th>
                <th>Doc No</th>
                <th>Date</th>
                <th>Type</th>
                <th>Created Date</th>  
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->ADSMID); ?>" value="<?php echo e($val->ADSMID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->ADSMNO) && $val->ADSMNO !=''?$val->ADSMNO:''); ?></td>
                <td><?php echo e(isset($val->ADSMDT) && $val->ADSMDT !='' && $val->ADSMDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ADSMDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\AssemblingDissembling\trnfrm490.blade.php ENDPATH**/ ?>