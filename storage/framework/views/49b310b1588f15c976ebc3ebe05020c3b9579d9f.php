      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="JWRNO" id="JWRNO" value="<?php echo e(isset($DATA_HDR->JWRNO)?$DATA_HDR->JWRNO:NULL); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
          </div>
            
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWRDT" id="JWRDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($DATA_HDR->JWRDT)?$DATA_HDR->JWRDT:NULL); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-2 pl"><p>Vendor</p></div>
          <div class="col-lg-2 pl">
              <input type="text" name="txtVID_popup" id="txtVID_popup"  value="<?php echo e(isset($objsubglcode->VCODE)?$objsubglcode->VCODE:''); ?> - <?php echo e(isset($objsubglcode->NAME)?$objsubglcode->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="VENDOR_INVOICE_NO" id="VENDOR_INVOICE_NO" value="<?php echo e(isset($DATA_HDR->Vendor_Invoice_No)?$DATA_HDR->Vendor_Invoice_No:NULL); ?>" autocomplete="off" class="form-control" maxlength="200"  >
          </div>
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="VCL_NO" id="VCL_NO" value="<?php echo e(isset($DATA_HDR->VECHILE_NO)?$DATA_HDR->VECHILE_NO:NULL); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="<?php echo e(isset($DATA_HDR->TRANSPORTER_CODE)?$DATA_HDR->TRANSPORTER_CODE:NULL); ?> - <?php echo e(isset($DATA_HDR->TRANSPORTER_NAME)?$DATA_HDR->TRANSPORTER_NAME:NULL); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="<?php echo e(isset($DATA_HDR->DRIVER_NAME)?$DATA_HDR->DRIVER_NAME:NULL); ?>" autocomplete="off" class="form-control" maxlength="200"  >
          </div>

          <div class="col-lg-2 pl"><p>Purpose</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="PURPOSE" id="PURPOSE" value="<?php echo e(isset($DATA_HDR->PURPOSE)?$DATA_HDR->PURPOSE:NULL); ?>"  autocomplete="off" class="form-control mandatory" maxlength="200"  >
          </div>
        </div>
...
<td><input type="text" name="txtJWID_popup_<?php echo e($key); ?>" id="txtJWID_popup_<?php echo e($key); ?>" value="<?php echo e($row->JWINO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
...
<td><input type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" value="<?php echo e($row->RECV_QTY); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
...
<td><input type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input type="text"   name="GRNNO_<?php echo e($key); ?>" id="GRNNO_<?php echo e($key); ?>" value="<?php echo e($row->GRNNO); ?>" class="form-control"   autocomplete="off" style="width:150px;" readonly /></td>  

<td align="center"><a class="btn checkstore" onclick="getStore(this.id)"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
...
<td><input type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RETURN_QTY); ?>" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off" readonly  style="width:75px;" /></td>
<td><input type="text"   name="STORE_NAME_<?php echo e($key); ?>" id="STORE_NAME_<?php echo e($key); ?>" value="<?php echo e($row->STORE_NAME); ?>" class="form-control"   autocomplete="off" style="width:200px;" readonly /></td>  
...
<td><input type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_PUOM); ?>" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>" value="<?php echo e($TaxAmt); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input type="checkbox" value="<?php echo e($row->GST); ?>" name='flagtype_<?php echo e($key); ?>' id="flagtype_<?php echo e($key); ?>" <?php echo e($GST_FLAGE_CHECKED); ?> ></td>

<td><input type="text" name="IGST_<?php echo e($key); ?>" id="IGST_<?php echo e($key); ?>" value="<?php echo e($row->IGST); ?>" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="IGSTAMT_<?php echo e($key); ?>" id="IGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($IGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="CGST_<?php echo e($key); ?>" id="CGST_<?php echo e($key); ?>" value="<?php echo e($row->CGST); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="CGSTAMT_<?php echo e($key); ?>" id="CGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($CGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="SGST_<?php echo e($key); ?>" id="SGST_<?php echo e($key); ?>" value="<?php echo e($row->SGST); ?>" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="SGSTAMT_<?php echo e($key); ?>" id="SGSTAMT_<?php echo e($key); ?>"  value="<?php echo e($SGSTAMT); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="TGST_AMT_<?php echo e($key); ?>" id="TGST_AMT_<?php echo e($key); ?>" value="<?php echo e($TOTGST); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input type="text" name="TOT_AMT_<?php echo e($key); ?>" id="TOT_AMT_<?php echo e($key); ?>" value="<?php echo e($TOTAL); ?>" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                            ...
                                            <?php if(!empty($objSOCAL)): ?>
                                                <?php $__currentLoopData = $objSOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td style="text-align:center;"><input type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?>  ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkReturn\trnfrm360edit.blade.php ENDPATH**/ ?>