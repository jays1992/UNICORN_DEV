...
<form id="frm_trn_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
    ...
    <div class="inner-form" id="Header_Details" >
          ...
          <input type="hidden" name="PNMID" id="PNMID" value="<?php echo e(isset($objResponse)?$objResponse->PNMID:''); ?>" class="form-control" readonly  autocomplete="off"   >
				...
				<div class="col-lg-2 pl">
					<input <?php echo e($ActionStatus); ?> type="date" name="PNM_DT" id="PNM_DT" value="<?php echo e(isset($objResponse)?$objResponse->PNM_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
...
function GetByProduct(TYPE){
  ...
  $.ajax({
      ...
      type:'POST',
      data:{
        ITEMID_REF:ITEMID_REF,TYPE:TYPE,PNMID:PNMID,ACTION_TYPE:'disabled'
        },
      success:function(data) {
...
function GetAdditionalMaterial(TYPE){
  ...
  $.ajax({
      ...
      type:'POST',
      data:{
        ITEMID_REF:ITEMID_REF,PROID_REF:PROID_REF,PNMID:PNMID,TYPE:TYPE,ACTION_TYPE:'disabled'
        },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionMovement\trnfrm309view.blade.php ENDPATH**/ ?>