  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="ST_ST_DOCNO" id="ST_ST_DOCNO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
         
          <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
          <input type="text" name="ST_ST_DOCNO" id="ST_ST_DOCNO" value="<?php echo e(old('ST_ST_DOCNO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
          <?php else: ?>
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="ST_ST_DOCDT" id="ST_ST_DOCDT" value="<?php echo e(old('ST_ST_DOCDT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                ...
                <tr>
                    ...
                    <td><input type="text"  type="text" name="RATE_0" id="RATE_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;" /></td>
                    ...
                    <td><input type="text"  type="text" name="RATE_IN_0" id="RATE_IN_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockToStockTransafer_old\trnfrm378add.blade.php ENDPATH**/ ?>