          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <label> <?php echo e($objResponse->ASGCODE); ?> </label>
                    <input type="hidden" name="ASGID" id="ASGID" value="<?php echo e($objResponse->ASGID); ?>" />
                    <input type="hidden" name="ASGCODE" id="ASGCODE" value="<?php echo e($objResponse->ASGCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="ASGNAME" id="ASGNAME" class="form-control mandatory" value="<?php echo e(old('ASGNAME',$objResponse->ASGNAME)); ?>" maxlength="200" tabindex="1"  />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                      <select name="AGID_REF" id="AGID_REF" class="form-control mandatory" >
                        ...
                        <option <?php echo e(isset($objResponse->AGID_REF) && $objResponse->AGID_REF==$Ag->AGID?'selected="selected"':''); ?> value="<?php echo e($Ag->AGID); ?>"><?php echo e($Ag->AGCODE.' - '.$Ag->AGNAME); ?></option>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[128,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[128,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\AccountSubGroup\mstfrm128edit.blade.php ENDPATH**/ ?>