          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="EMPLOYEE_TARGETCODE" id="EMPLOYEE_TARGETCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="EMPLOYEE_TARGETNAME" id="EMPLOYEE_TARGETNAME" onclick="getEmpTargetName(this.id,'<?php echo e(route('master',[$FormId,'getEmpTargetName'])); ?>','Employee Target Details')" class="form-control mandatory" readonly />
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="FINALYEAR" id="FINALYEAR" onclick="getEmpTargetName(this.id,'<?php echo e(route('master',[$FormId,'getFinancialYearCode'])); ?>','Financial Year Details')" class="form-control mandatory"  autocomplete="off" readonly/>
                      ...
                      <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                          ...
                          <tbody>
                            ...
                            <?php for($i=1; $i<=12; $i++) { ?>
                              <td><input class='form-control txtCal' type="text" name="MONTH<?php echo e($i); ?>_AMT[]"   id ="MONTH<?php echo e($i); ?>_AMT_<?php echo e($i); ?>" onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                            <?php } ?>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <div id="Product" class="tab-pane fade in">
                        <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                          <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                            ...
                            <tbody>
                              <tr  class="participantRow">
                                <td><input  class="form-control" type="text" name="PRODCTCODE[]"   id ="PRODCTCODE_0" onclick="getEmpTargetName(this.id,'<?php echo e(route('master',[$FormId,'getProdctCode'])); ?>','Product Code Details')" autocomplete="off" readonly style="width: 99%"></td>
                                ...
                                <?php for($i=1; $i<=12; $i++) { ?>
                                <td><input  class="form-control" type="text" name="MONTH<?php echo e($i); ?>_QTY[]"   id ="MONTH1_QTY_<?php echo e($i); ?>"   onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                                <?php } ?>
                                <td align="center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\EmployeeTargetMaster\mstfrm435add.blade.php ENDPATH**/ ?>