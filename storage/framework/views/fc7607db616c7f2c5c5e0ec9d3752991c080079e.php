...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Salary Structure Master</a></div>
  ...
  <div class="multiple table-responsive  ">
    ...
    <thead id="thead1">
      ...
      <?php
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->SALARY_STRUCID); ?>" value="<?php echo e($val->SALARY_STRUCID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->SALARY_STRUC_NO) && $val->SALARY_STRUC_NO !=''?$val->SALARY_STRUC_NO:''); ?></td>
          <td><?php echo e(isset($val->SALARY_STRUC_DESC) && $val->SALARY_STRUC_DESC !=''?$val->SALARY_STRUC_DESC:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\SalaryStructureMaster\mstfrm197.blade.php ENDPATH**/ ?>