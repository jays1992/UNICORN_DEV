...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->RGPID); ?>" value="<?php echo e($val->RGPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->RGP_DT) && $val->RGP_DT !='' && $val->RGP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RGP_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->RGP_NO) && $val->RGP_NO !=''?$val->RGP_NO:''); ?></td>
                <td><?php echo e(isset($val->RGP_DT) && $val->RGP_DT !='' && $val->RGP_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->RGP_DT)):''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Returnable Gate Pass Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&RGPID='+ SONO + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\ReturnableGatePass\trnfrm157.blade.php ENDPATH**/ ?>