                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="SOSNO" id="SOSNO" value="<?php echo e(isset($objSOS->SOSNO)?$objSOS->SOSNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            </div>
                            <div class="col-lg-1 pl"><p>SOS Date</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing(41,this.value,1)" value="<?php echo e(isset($objSOS->SOSDT)?$objSOS->SOSDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>  

                            <div class="col-lg-1 pl"><p>Customer</p></div>
                            <div class="col-lg-2 pl">
                                  <input <?php echo e($InputStatus); ?> type="text" name="SubGl_popup" id="txtgl_popup" value="<?php echo e(isset($objsubglcode->SGLCODE)?$objsubglcode->SGLCODE:''); ?> <?php echo e(isset($objsubglcode->SLNAME)?'-'.$objsubglcode->SLNAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                                  <input type="hidden" name="GLID_REF" id="GLID_REF" value="<?php echo e(isset($objSOS->GLID_REF)?$objSOS->GLID_REF:''); ?>" class="form-control" autocomplete="off" />
                                  <input type="hidden" name="SLID_REF" id="SLID_REF"  value="<?php echo e(isset($objSOS->SLID_REF)?$objSOS->SLID_REF:''); ?>" class="form-control" autocomplete="off" />
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="OSOID_popup" id="OSOID_popup" class="form-control mandatory" value="<?php echo e(isset($objOSO->OSONO)?$objOSO->OSONO:''); ?>" autocomplete="off" readonly/>
                                <input type="hidden" name="OSOID_REF" id="OSOID_REF" class="form-control" value="<?php echo e(isset($objSOS->OSOID_REF)?$objSOS->OSOID_REF:''); ?>" autocomplete="off" />
                            </div>                   
                            ...
                            <div class="tab-content">
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <?php if(!empty($objSOSMAT)): ?>
                                                ...
                                                <tr class="participantRow">
                                                    <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("SOSMATID_".$key); ?> id =<?php echo e("SOSMATID_".$key); ?> maxlength="100" value="<?php echo e($row->SOSMATID); ?>" autocomplete="off"   >
                                                    </td>
                                                    ...
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->NAME); ?>"  autocomplete="off"  readonly/></td>
                                                    ...
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUOM_".$key); ?> id=<?php echo e("popupUOM_".$key); ?> class="form-control" value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"  autocomplete="off"  readonly/></td>
                                                    ...
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ITEMSPECI_".$key); ?> id=<?php echo e("ITEMSPECI_".$key); ?> class="form-control" maxlength="200" value="<?php echo e($row->ITEMSPECI); ?>" autocomplete="off" readonly  /></td>
                                                    <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATE); ?>"  autocomplete="off" readonly /></td>
                                ...
                                <div id="Schedule" class="tab-pane fade">
                                  <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                    ...
                                    <div class="col-lg-2 pl">
                                          <input <?php echo e($InputStatus); ?> type="text" name="SchITEM" id="SchITEM" class="form-control" value="<?php echo e(isset($objSOSSCH->ICODE)?$objSOSSCH->ICODE:''); ?>"   autocomplete="off"  readonly/>
                                    ...
                                    <div class="col-lg-2 pl">
                                          <input <?php echo e($InputStatus); ?> type="text" name="Sch_Item_Name" id="Sch_Item_Name" class="form-control" value="<?php echo e(isset($objSOSSCH->NAME)?$objSOSSCH->NAME:''); ?>"  autocomplete="off"  readonly/>
                                    </div>
                                  </div>
                                  <div class="row" style="margin-left:3px;" >	
                                    <div class="col-lg-1 pl"><p>UoM</p></div>
                                    <div class="col-lg-2 pl">
                                    <input <?php echo e($InputStatus); ?> type="text" name="SchUOM" id="SchUOM" class="form-control" value="<?php echo e(isset($objSOSSCH->UOMCODE)?$objSOSSCH->UOMCODE:''); ?> <?php echo e(isset($objSOSSCH->DESCRIPTIONS)?$objSOSSCH->DESCRIPTIONS:''); ?>"  autocomplete="off"  readonly/>
                                    ...
                                    <div class="col-lg-1 pl">
                                      <input <?php echo e($InputStatus); ?> type="text" name="Sch_SOQTY" id="Sch_SOQTY" class="form-control three-digits" value="<?php echo e(isset($objSOSSCH->SOQTY)?$objSOSSCH->SOQTY:''); ?>" autocomplete="off" />
                                    </div>
                                  </div>
                                  <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:60%;">
                                    ...
                                    <?php if(!empty($objSCHDET)): ?>
                                      ...
                                      <tr  class="participantRow3">
                                        <td> <input <?php echo e($InputStatus); ?> type="date" name=<?php echo e("SCHDT_".$skey); ?>  id=<?php echo e("SCHDT_".$skey); ?> class="form-control " autocomplete="off" value="<?php echo e($srow->SCHDT); ?>" placeholder="dd/mm/yyyy" > </td>
                                        <td> <input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SCHQTY_".$skey); ?> id=<?php echo e("SCHQTY_".$skey); ?>   class="form-control three-digits" value="<?php echo e($srow->SCHQTY); ?>" autocomplete="off" /> </td>
                                        <td>
                                          <input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("PopupSHIPTO_".$skey); ?> id=<?php echo e("PopupSHIPTO_".$skey); ?> class="form-control"  autocomplete="off" readonly  />
                                          
                                        </td>
                                        <td hidden><input type="hidden" name=<?php echo e("txtSHIPTO_".$skey); ?> id=<?php echo e("txtSHIPTO_".$skey); ?> class="form-control" value="<?php echo e($srow->SHIPTO); ?>"  autocomplete="off" /></td>
                                        <td align="center" >
...
$(document).ready(function(e) {
    ...
    $('#example3').find('.participantRow3').each(function(){
        ...
        if(id!=''){
          ...
          $.ajax({
              url:'<?php echo e(route("transaction",[41,"getShipAddressIDwise"])); ?>',
              type:'POST',
              data:{'id':id},
              success:function(data) {
                $('#'+txtid).val(data);                 
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[41,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[41,"Approve"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $("#btnApprove").show();  
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ScheduleOpenSalesOrder\trnfrm41edit.blade.php ENDPATH**/ ?>