...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-4"><a href="<?php echo e(route('report',[$FORM_ID,'index'])); ?>" class="btn singlebt">Lead Register Enquiry Master</a></div>
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Source Of Enquiriy</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                <select name="SOURCE_OF_ENQUIRY[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SOURCE_OF_ENQUIRY" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $SourceOfEnq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->ID); ?>" selected><?php echo e($val->SOURCE_OF_ENQ); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
$('#btnView').on('click', function() {
        ...
        var SOURCE_OF_ENQUIRY = [];
        $("select[name='SOURCE_OF_ENQUIRY[]']").each(function() {
            var value3 = $(this).val();
            if (value3) {
                SOURCE_OF_ENQUIRY.push(value3);
            }
        });
        ...
        else if(SOURCE_OF_ENQUIRY  == '')
        {
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Source Of Enquiriy.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\PreSales\LeadRegisterEnquiryMaster\rptfrm461.blade.php ENDPATH**/ ?>