...
<!-- <form id="frm_rpt_soc" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[248,'index'])); ?>" class="btn singlebt">Sales Order Summary City Wise</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl" id="div_city">
                                <select name="CITYID1[]" id="CITYID1" class="form-control selectpicker" multiple data-live-search="true"  >
                                </select>
                            </div>
                        </div>
                        <div class="row">
...
$(document).ready(function(e) {
   ...
   $('#To_Date').change(function(){
       ...
       if(From_Date != '' && To_Date != '')
       {
                ...
                $.ajax({
                    url:'<?php echo e(route("report",[248,"GetCity"])); ?>',
                    type:'POST',
                    ...
                    error:function(data){
                        ...
                        var TDSBody = $('#div_city').html();
                        $('#CITYID1').show();
                        $('#CITYID').hide();
                        $("#div_city").html(TDSBody);
                    },
                });
       }
       else
...
$('#btnView').on('click', function() {
        ...
        var CITYID  = [];
        $("select[name='CITYID[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                CITYID.push(value4);
            }
        ...
        else if(CITYID  == '')
        {
            ...
            var consultURL = '<?php echo e(route("report",[248,"ViewReport",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesOrderSummaryCitywise\rptfrm248.blade.php ENDPATH**/ ?>