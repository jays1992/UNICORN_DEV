    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tr>
                ...
                <th>Doc No</th>
                <th>Date</th>
                <th <?php echo e($AlpsStatus['hidden']); ?>><?php echo e(isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?'OUT '.$TabSetting->FIELD8:'Add. Info Part No'); ?></th>
                <th <?php echo e($AlpsStatus['hidden']); ?>><?php echo e(isset($TabSetting->FIELD8) && $TabSetting->FIELD8 !=''?'IN '.$TabSetting->FIELD8:'Add. Info Part No'); ?></th>
                <th>Type</th> 
                <th>Qty</th>
                <th>Created Date</th>    
                <th>Created By</th>           
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->ST_STID); ?>" value="<?php echo e($val->ST_STID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->ST_ST_DOCDT) && $val->ST_ST_DOCDT !='' && $val->ST_ST_DOCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ST_ST_DOCDT)):''); ?>" ></td>
                <td><?php echo e(isset($val->ST_ST_DOCNO) && $val->ST_ST_DOCNO !=''?$val->ST_ST_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->ST_ST_DOCDT) && $val->ST_ST_DOCDT !='' && $val->ST_ST_DOCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ST_ST_DOCDT)):''); ?></td>
                <td <?php echo e($AlpsStatus['hidden']); ?>><?php echo e(isset($val->OUT_ALPS_PART_NO) && $val->OUT_ALPS_PART_NO !=''?$val->OUT_ALPS_PART_NO:''); ?></td>
                <td <?php echo e($AlpsStatus['hidden']); ?>><?php echo e(isset($val->IN_ALPS_PART_NO) && $val->IN_ALPS_PART_NO !=''?$val->IN_ALPS_PART_NO:''); ?></td>
                <td><?php echo e(isset($val->ST_ST_TYPE) && $val->ST_ST_TYPE !=''?$val->ST_ST_TYPE:''); ?></td>
                <td><?php echo e(isset($val->QTY) && $val->QTY !=''?$val->QTY:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StockToStockTransafer\trnfrm378.blade.php ENDPATH**/ ?>