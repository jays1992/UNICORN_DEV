...
?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="IPO_NO" id="IPO_NO" value="<?php echo e($objHDR->IPO_NO); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
                  <input <?php echo e($ActionStatus); ?> type="date" name="IPO_DT" id="IPO_DT" value="<?php echo e($objHDR->IPO_DT); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor</p></div>
        <div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="txtvendor" id="txtvendor" class="form-control" value="<?php echo e($objPBVID->VCODE); ?>-<?php echo e($objPBVID->NAME); ?>" readonly  />
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SALE_ORDER_NO" id="SALE_ORDER_NO" value="<?php echo e($objHDR->SALE_ORDER_NO); ?>"  maxlength="30" class="form-control" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p> Document Type</p></div>
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="DOC_TYPE" id="DOC_TYPE" class="form-control" >
            <option value="">Select</option>
            <option <?php echo e(isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAF2"?'selected="selected"':''); ?> value="ZAF2">ZAF2</option>
            <option <?php echo e(isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAP0"?'selected="selected"':''); ?> value="ZAP0">ZAP0</option>
            <option <?php echo e(isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAP2"?'selected="selected"':''); ?> value="ZAP2">ZAP2</option>
            <option <?php echo e(isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAS0"?'selected="selected"':''); ?> value="ZAS0">ZAS0</option>
            <option <?php echo e(isset($objHDR->DOC_TYPE) && $objHDR->DOC_TYPE =="ZAS6"?'selected="selected"':''); ?> value="ZAS6">ZAS6</option>
          </select>
        </div>
        ...
        <div class="col-lg-2 pl" id="div_billto">
            <input <?php echo e($ActionStatus); ?> type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly  />
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            <input <?php echo e($ActionStatus); ?> type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e($objShpAddress[0]); ?>"  readonly  />
        ...
        <div class="col-lg-6 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="<?php echo e($objHDR->REMARKS); ?>" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtsubgl_popup" value="<?php echo e(isset($objsubglcode->SGLCODE)?$objsubglcode->SGLCODE:''); ?> <?php echo e(isset($objsubglcode->SLNAME)?'-'.$objsubglcode->SLNAME:''); ?>" class="form-control mandatory"   autocomplete="off" readonly/>
          <input type="hidden" name="SLID_REF" id="SLID_REF" value="<?php echo e($objHDR->SLID_REF); ?>" class="form-control" autocomplete="off" />
      ...
      <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="date" name="REQ_DELIVERY_DATE" id="REQ_DELIVERY_DATE" value="<?php echo e($objHDR->REQ_DELIVERY_DATE); ?>" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" >
      </div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<select <?php echo e($ActionStatus); ?>  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" >
				<option value="">Select</option>
		...
		<div class="col-lg-2 pl">
			<input <?php echo e($ActionStatus); ?> type="text" name="REF_NO" id="REF_NO" value="<?php echo e($objHDR->REF_NO); ?>" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="Credit_days" id="Credit_days" value="<?php echo e($objHDR->CREDIT_DAYS); ?>" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="<?php echo e($objHDR->DUE_DATE); ?>"  placeholder="dd/mm/yyyy"  />                        
        </div>
        ...
        <div hidden class="col-lg-2 pl">
            <input  <?php echo e($ActionStatus); ?> type="checkbox" name="GST_Reverse" id="GST_Reverse"    />                          
        </div>

        <div hidden class="col-lg-1 pl"><p>GST Input Not Avail</p></div>
        <div hidden class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="checkbox" name="GST_N_Avail" id="GST_N_Avail"    />
        </div>  
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  <thead id="thead1"  style="position: sticky;top: 0">           
                    <tr>
                      ...
                      <th rowspan="2">Item Code <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>" > </th>
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      ...
                      <tr  class="participantRow">
                        <td hidden><input type="text" name="txtSQ_popup_<?php echo e($key); ?>" id="txtSQ_popup_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly style="width:130px;text-align:right;" /></td>
                        <td hidden><input type="hidden" name="SQA_<?php echo e($key); ?>" id="SQA_<?php echo e($key); ?>" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td hidden><input type="hidden" name="SEQID_REF_<?php echo e($key); ?>" id="SEQID_REF_<?php echo e($key); ?>" class="form-control" autocomplete="off" style="width:130px;text-align:right;" /></td>
                        ...
                        <td <?php echo e($hidden); ?>><input type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" value="<?php echo e($row->ALPS_PART_NO); ?>" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        <td <?php echo e($hidden); ?>><input type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" value="<?php echo e($row->CUSTOMER_PART_NO); ?>" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        <td <?php echo e($hidden); ?>><input type="text" name="OEMpartno_<?php echo e($key); ?>" id="OEMpartno_<?php echo e($key); ?>" value="<?php echo e($row->OEM_PART_NO); ?>" class="form-control"  autocomplete="off" style="width:130px;text-align:right;" readonly  /></td>
                        ...
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e(floatval($row->IPO_MAIN_QTY) > 0 ?floatval($row->IPO_MAIN_QTY):'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'3')" class="form-control three-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        ...
                        <td><input <?php echo e($ActionStatus); ?> type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_ASP_MU); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'5')" class="form-control" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                        <td><input <?php echo e($ActionStatus); ?> <?php echo e($disabled); ?> type="text" name="DISC_PER_<?php echo e($key); ?>" id="DISC_PER_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                        <td><input <?php echo e($ActionStatus); ?> <?php echo e($disabled); ?> type="text" name="DISC_AMT_<?php echo e($key); ?>" id="DISC_AMT_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" onblur="getTextDec(this.id,'2')" class="form-control two-digits" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                    ...
                    <?php if(!empty($objPBPSLB)): ?>
                      <?php $__currentLoopData = $objPBPSLB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pkey => $Prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow6">
                              ...
                              <td align="center" style="min-width: 100px;" ><button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button <?php echo e($ActionStatus); ?> class="btn remove" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                          </tr>
                          <tr></tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                      <?php else: ?>
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example7" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  ...
                  ?>
                            ...
                            <td style="min-width: 100px;" ><button <?php echo e($ActionStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                            <button <?php echo e($ActionStatus); ?> class="btn remove" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                        </tr>
                        <tr></tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                    ...
                    <?php if(!empty($objPBUDF)): ?>
                      <?php $__currentLoopData = $objPBUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              ...
                              <td hidden><input type="hidden" name=<?php echo e("UDFPBID_REF_".$Ukey); ?>  id=<?php echo e("UDFPBID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->IPO_UDFID); ?>" autocomplete="off" /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/ImportPurchaseOrder/trnfrm299view.blade.php ENDPATH**/ ?>