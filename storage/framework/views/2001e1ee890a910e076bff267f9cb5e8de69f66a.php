<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->OTID); ?>" value="<?php echo e($val->OTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->OT_CODE) && $val->OT_CODE !=''?$val->OT_CODE:''); ?></td>
                <td><?php echo e(isset($val->OT_DESC) && $val->OT_DESC !=''?$val->OT_DESC:''); ?></td>
                <td><?php echo e(isset($val->OT_RATE) && $val->OT_RATE !=''?$val->OT_RATE:''); ?></td>
                <td><?php echo e(isset($val->OT_FACTOR) && $val->OT_FACTOR !=''?$val->OT_FACTOR:''); ?></td>
        ...
        <form id="masterForm193Print" action="<?php echo e(route('mastergetlist',[193,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[193,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[193,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[193,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[193,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[193,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\OverTime\mstfrm193.blade.php ENDPATH**/ ?>