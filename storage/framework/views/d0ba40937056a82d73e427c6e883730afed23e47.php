<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->ENERGYID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                    ...
                    <div class="col-lg-3 pl">
                      <input type="text" name="METER_DESC" id="METER_DESC" class="form-control mandatory" value="<?php echo e(old('METER_DESC',$objResponse->METER_DESC)); ?>" maxlength="200"  />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">                 
                      <input type="text" name="KWH" id="KWH" class="form-control mandatory" value="<?php echo e(old('KWH',$objResponse->KWH)); ?>"  autocomplete="off" maxlength="50"/>                 
                </div>
                  <div class="col-lg-2 pl"><p>Starting Meter Reading (KVARH)</p></div>
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="KVARH" id="KVARH" class="form-control " value="<?php echo e(old('KVARH',$objResponse->KVARH)); ?>"  autocomplete="off" maxlength="50" />                 
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="KVAH" id="KVAH" class="form-control " value="<?php echo e(old('KVAH',$objResponse->KVAH)); ?>"  autocomplete="off" maxlength="50" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Starting Meter Reading (MD)</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" name="MD" id="MD" class="form-control " value="<?php echo e(old('MD',$objResponse->MD)); ?>"  autocomplete="off" maxlength="50" />
                  </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">                 
                    <input type="text" name="POWER_FACTOR" id="POWER_FACTOR" class="form-control " value="<?php echo e(old('POWER_FACTOR',$objResponse->POWER_FACTOR)); ?>"   autocomplete="off" maxlength="100" />                 
                  </div>
                  <div class="col-lg-2 pl"><p>Date of Commissioning</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="DOCOMMISSION" class="form-control " id="DOCOMMISSION" value="<?php echo e(isset($objResponse->DOCOMMISSION) && $objResponse->DOCOMMISSION !="" && $objResponse->DOCOMMISSION !="1900-01-01" ? $objResponse->DOCOMMISSION:''); ?>"  placeholder="dd/mm/yyyy"  />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">                 
                  <input type="text" name="METER_COMPANY" id="METER_COMPANY" class="form-control " value="<?php echo e(old('METER_COMPANY',$objResponse->METER_COMPANY)); ?>"   autocomplete="off" maxlength="100" />                 
                </div>
                <div class="col-lg-2 pl"><p>Brand</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="BRAND" id="BRAND" class="form-control " value="<?php echo e(old('BRAND',$objResponse->BRAND)); ?>"  autocomplete="off" maxlength="100" />
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="MODEL" id="MODEL" class="form-control " value="<?php echo e(old('MODEL',$objResponse->MODEL)); ?>"  autocomplete="off" maxlength="100" />
              </div>
              <div class="col-lg-2 pl"><p>Serial No</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SERIAL_NO" id="SERIAL_NO" class="form-control "  value="<?php echo e(old('SERIAL_NO',$objResponse->SERIAL_NO)); ?>"   autocomplete="off" maxlength="20" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="SANCTION_LOAD" id="SANCTION_LOAD" class="form-control "  value="<?php echo e(old('SANCTION_LOAD',$objResponse->SANCTION_LOAD)); ?>"  autocomplete="off" maxlength="50" />
              </div>
              <div class="col-lg-2 pl"><p>Power Supply By</p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="SUPPLY_BY" id="SUPPLY_BY" class="form-control " value="<?php echo e(old('SUPPLY_BY',$objResponse->SUPPLY_BY)); ?>"  autocomplete="off" maxlength="100" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 pl">
                <input type="text" name="REMARKS" id="REMARKS" class="form-control "  value="<?php echo e(old('REMARKS',$objResponse->REMARKS)); ?>"  autocomplete="off" maxlength="100" />
              </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\EnergyMeter\mstfrm223edit.blade.php ENDPATH**/ ?>