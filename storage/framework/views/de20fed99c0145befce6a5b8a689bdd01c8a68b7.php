                   ...
                   <tr>                          
                     ...
                     <tbody>
                       <tr  class="participantRow">
                           ...
                           <td><input type="text" id="YRDESCRIPTION_0" value="<?php echo e($objFyDesList->YRDESCRIPTION); ?>" class="form-control"  maxlength="100" readonly ></td>
                           <td>
                           ...
                           <td><input  class="form-control" type="text" name="CAP_LIMIT[]" id ="CAP_LIMIT_0" value="<?php echo e($objResponse->CAP_LIMIT); ?>"  autocomplete="off" onkeypress="return onlyNumberKey(event)" style="width: 99%" ondrop="return false;oncopy="return false" oncut="return false" onpaste="return false"></td>
                           ...
                           <td><input type="checkbox"   name="DEACTIVATED[]"  id="CHKDEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1 ? "checked" : ""); ?> value='<?php echo e($objResponse->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2"  ></td>
                           <td><input type="date" name="DODEACTIVATED[]" class="form-control" id="DODEACTIVATED" <?php echo e($objResponse->DEACTIVATED == 1); ?> value="<?php echo e(isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\ESIRules\mstfrm294edit.blade.php ENDPATH**/ ?>