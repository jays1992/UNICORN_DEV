...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[262,'index'])); ?>" class="btn singlebt">Annual Sales Forecast Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_afs"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl"><p>AFS NO</p></div>
                            <div class="col-lg-3 pl">
                                <select name="AFSID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="AFSID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objAFSNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dindex=>$DRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($DRow->AFSID); ?>" selected><?php echo e($DRow->AFSNO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[262,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var AFSID  = [];
        $("select[name='AFSID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                AFSID.push(value7);
            }
        ...
        else if(AFSID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select AFS NO.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[262,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\Annual_Sales_Forecast_Register\rptfrm262.blade.php ENDPATH**/ ?>