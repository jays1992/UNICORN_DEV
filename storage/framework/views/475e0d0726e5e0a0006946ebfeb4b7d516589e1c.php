...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
            <input type="text" name="AR_DOC_NO" id="AR_DOC_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
            <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
        </div>
        <div class="col-lg-2 pl"><p>Debit/Credit Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="AR_DOC_DT" id="AR_DOC_DT" value="<?php echo e(old('AR_DOC_DT')); ?>" onchange='checkPeriodClosing(233,this.value,1),getDocNoByEvent("AR_DOC_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)'  class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
                ...
                <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <?php $__currentLoopData = $objUdfARData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr  class="participantRow4">
                          <td><input type="text" name=<?php echo e("popupUDF_ARID_".$uindex); ?> id=<?php echo e("popupUDF_ARID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
...
$.ajax({
    url:'<?php echo e(route("transaction",[233,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
function getBalanceGrid(bankid,fieldid){
  ...
  var TaxStatus = $.ajax({type: 'POST',
  url:'<?php echo e(route("transaction",[233,"getBalanceGrid"])); ?>',
  async: false,
  dataType: 'json',
  data: {id:bankid},
  done: function(response) {return response;}}).responseText;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ARDebitNote\trnfrm233add.blade.php ENDPATH**/ ?>