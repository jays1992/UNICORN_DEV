...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[350,'index'])); ?>" class="btn singlebt">Credit Note Register</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_scs"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                        <div class="col-lg-3 pl"><p>CSV NO</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="CSVID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="CSVID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objCSVNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Dindex=>$DRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($DRow->CSVID); ?>" selected><?php echo e($DRow->CSV_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[350,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var CSVID  = [];
        $("select[name='CSVID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                CSVID.push(value7);
            }
        ...
        else if(CSVID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[350,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\Credit_Note_Register\rptfrm350.blade.php ENDPATH**/ ?>