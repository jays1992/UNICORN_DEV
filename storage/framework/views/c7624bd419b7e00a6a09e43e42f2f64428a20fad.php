...
<?php $__env->startSection('content'); ?>    
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->VQID); ?>" value="<?php echo e($val->VQID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->VQ_DT) && $val->VQ_DT !='' && $val->VQ_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->VQ_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->VQ_NO) && $val->VQ_NO !=''?$val->VQ_NO:''); ?></td>
              <td><?php echo e(isset($val->VQ_DT) && $val->VQ_DT !='' && $val->VQ_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->VQ_DT)):''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Vendor Quotation Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ ITEMID + '&VQNo='+ ITEMID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\VendorQuotation\trnfrm61.blade.php ENDPATH**/ ?>