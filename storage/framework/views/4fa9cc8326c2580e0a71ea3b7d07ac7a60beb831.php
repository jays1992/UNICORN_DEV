...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Reset Password</a></div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <label for=""><?php echo e($UserDetails["USER_CODE"]); ?></label>
              </div>
            
            <div class="col-lg-2 pl"><p>User Name</p> </div>
            <div class="col-lg-2 pl">
            <label for=""><?php echo e($UserDetails["USER_NAME"]); ?></label>
            </div>
...
function validateForm(){
  ...
  //   return false;
  // }
  // if(CURRENT_PASSWORD !='<?php echo e($UserDetails["USER_PASSWORD"]); ?>'){
  //   $("#FocusId").val('CURRENT_PASSWORD');        
  //   $("#YesBtn").hide();
  //   $("#NoBtn").hide();
  //   $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserManagement\mstfrm530add.blade.php ENDPATH**/ ?>