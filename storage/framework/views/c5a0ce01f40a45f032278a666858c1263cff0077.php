          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->FYDESCRIPTION); ?> </label>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                      <label> <?php echo e($objResponse->FYSTMONTH); ?> </label>
                  </div>

                  <div class="col-lg-1 pl"><p>FY Start Year</p></div>
                  <div class="col-lg-1 pl">
                      <label> <?php echo e($objResponse->FYSTYEAR); ?> </label>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                      <label> <?php echo e($objResponse->FYENDMONTH); ?> </label>
                  </div>

                  <div class="col-lg-1 pl"><p>FY End Year</p></div>
                  <div class="col-lg-1 pl">
                      <label> <?php echo e($objResponse->FYENDYEAR); ?> </label>
                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\FinancialYear\mstfrm123view.blade.php ENDPATH**/ ?>