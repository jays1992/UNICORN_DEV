...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[94,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="Conditionmst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
...
<style>
  #custom_dropdown, #Conditionmst_filter {
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#btnExit').on('click', function() {
      var viewURL = '<?php echo e(route('home')); ?>';
        ...
        // Data table for serverside
         var mstconditionTable =  $('#Conditionmst').DataTable({
            ...
            initComplete: function() {
                      ...
                      $('.dataTables_filter input').bind('keyup', function(e){
                          ...
                          if (code == 13) { 
                            mstconditionTable.search(this.value).draw();
                          }
                      });
                   },
            "ajax":{

                     "url": "<?php echo e(route('mastergetlist',[94,'getconditiontemplate'])); ?>",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
      ...
      var htmlDD =  '<div id="custom_dropdown"><div id="calculationmst_dropdown" class="dataTables_filter">'
        +'<select id="filtercolumn" name="filtercolumn">'
        +'<option value="ALL" > All </option>'
        +'<option value="CTCODE" > Template Code </option>'
        +'<option value="CTDESCRIPTION"> Description </option>'
        +'<option value="DEACTIVATED"> De-Activated </option>'
        +'<option value="DODEACTIVATED"> Date of De-Activated </option>'
        +'<option value="STATUS"> Status</option>'
        +'</select></div></div>';
      
          $( htmlDD ).insertBefore( "#calculationmst_wrapper #calculationmst_filter" ); 
      ...
      $('#btnEdit').on('click', function() {
            ...
            var conditionIdsData = getSeletectedCBox();
            var seletedRecord = conditionIdsData.length;
            ...
            if(seletedRecord==0){
              ...
              var recordId = conditionIdsData[0];
                  var is_approve = $('#chkId'+recordId).data("rcdstatus");
                  console.log("is app=="+is_approve);  

                  if(is_approve==0){

                    var editURL = '<?php echo e(route("master",[94,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viweRecordId = conditionIdsData[0];
            var viewURL = '<?php echo e(route("master",[94,"view",":rcdId"])); ?>';
    ...
    $('#btnApprove').on('click', function() {
            var conditionIdsData = getSeletectedCBox();
            var seletedRecord = conditionIdsData.length;
            var conditionIdsDataID = getSeletectedCBoxID();
            ...
            if(seletedRecord==0){
              ...
              var recordId = conditionIdsDataID;
    ...
    $('#btnAttach').on('click', function() {
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[94,"attachment",":rcdId"])); ?>';
      ...
      function getSeletectedCBox(){       
        selectedIds=[];
            var checkedcollection = mstconditionTable.$(".js-selectall1:checked", { "page": "all" });
...
var recordId = conditionIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[94,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[94,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\Terms&ConditionTemplate\mstfrm94.blade.php ENDPATH**/ ?>