      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <div class="col-lg-12 pl">
            <input type="text" name="CTCODE" id="txtctcode" value="<?php echo e(old('CTCODE')); ?>" autocomplete="off" tabindex="1" class="form-control mandatory"  maxlength="30" style="text-transform:uppercase"  >
		...
		<div class="row">
			...
			<div class="col-lg-6 pl">
				<input type="text" name="CTDESCRIPTION" id="txtctdesc" value="<?php echo e(old('CTDESCRIPTION')); ?>" autocomplete="off" tabindex="2" class="form-control"  maxlength="200" >     
			</div>
		</div>	
		...
		<div class="row">
			...
			<div class="col-lg-1 pl">
				<input type="checkbox" name="DEACTIVATED" id="deactive" value="<?php echo e(old('DEACTIVATED')); ?>"  tabindex="3" disabled >
			</div>
			
			<div class="col-lg-2 pl col-md-offset-1"><p>Date of De-Activated</p></div>
			<div class="col-lg-2 pl">
			<div class="col-lg-8 pl">
			<input type="date" name="DODEACTIVATED" id="decativateddate" value="<?php echo e(old('DODEACTIVATED')); ?>" tabindex="4"  class="form-control datepicker" placeholder="dd/mm/yyyy" disabled>
			</div>
			</div>
		</div>
		<div class="row">
...
$(document).ready(function(e) {
  ...
  $('#btnAdd').on('click', function() {
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[1,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[1,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[1,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\CalculationTemplate\mstfrm1add.blade.php ENDPATH**/ ?>