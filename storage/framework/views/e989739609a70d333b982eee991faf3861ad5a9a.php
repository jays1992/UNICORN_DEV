		...
		<div class="inner-form">
          ...
          <?php if(!empty($objDD)): ?>
              <?php if($objDD->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="VCODE" id="VCODE" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              <?php endif; ?>
              <?php if($objDD->MANUAL_SR == "1"): ?>
                  <input type="text" name="VCODE" id="VCODE" value="<?php echo e(old('VCODE')); ?>" class="form-control mandatory"  maxlength="<?php echo e($objDD->MANUAL_MAXLENGTH); ?>" tabindex="1" autocomplete="off" style="text-transform:uppercase" autofocus >
              <?php endif; ?>
          <?php endif; ?>  
			...
			<div id="udf" class="tab-pane fade">
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:320px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <tbody>
                  <?php $__currentLoopData = $objUdfForVendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfkey => $udfrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr  class="participantRow">
                    <td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-body">
      ...
      <table id="cg_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        <tbody>
        <?php $__currentLoopData = $objVendorGroupList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$rowList1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <tr >
          <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_VGID_REF[]" id="cgidref_<?php echo e($rowList1->VGID); ?>" class="clscgidref" value="<?php echo e($rowList1->VGID); ?>" ></td>
          <td class="ROW2" style="width: 39%"><?php echo e($rowList1->VGCODE); ?>

          <input type="hidden" id="txtcgidref_<?php echo e($rowList1->VGID); ?>" data-desc="<?php echo e($rowList1->VGCODE); ?> - <?php echo e($rowList1->DESCRIPTIONS); ?>" value="<?php echo e($rowList1-> VGID); ?>"/>
          </td>
          <td class="ROW3" style="width: 39%"><?php echo e($rowList1->DESCRIPTIONS); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
//----------------------------
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[48,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "<?php echo e(route('master',[48,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorMaster\mstfrm48add.blade.php ENDPATH**/ ?>