    ...
    <div class="container-fluid purchase-order-view filter">     
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"><p>Doc Date*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="DOC_DT" id="DOC_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("DOC_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory" >
        </div> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesInvoiceAllocation\trnfrm499add.blade.php ENDPATH**/ ?>