...
<?php $helper = app('App\Helpers\Helper'); ?>        
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->RECEIPTID); ?>" value="<?php echo e($val->RECEIPTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->RECEIPT_DT) && $val->RECEIPT_DT !=''?$val->RECEIPT_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->RECEIPT_NO) && $val->RECEIPT_NO !=''?$val->RECEIPT_NO:''); ?></td>
                <td><?php echo e(isset($val->RECEIPT_DT) && $val->RECEIPT_DT !=''?$val->RECEIPT_DT:''); ?></td>
                <td><?php echo e(isset($val->RECEIPT_FOR) && $val->RECEIPT_FOR !=''?$val->RECEIPT_FOR:''); ?></td>                
                <td><?php echo e(isset($Name) && $Name !=''?$Name:''); ?></td>
                <td><?php echo e(isset($val->RECEIPT_TYPE) && $val->RECEIPT_TYPE !=''?$val->RECEIPT_TYPE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/ReceiptEntry/trnfrm302.blade.php ENDPATH**/ ?>