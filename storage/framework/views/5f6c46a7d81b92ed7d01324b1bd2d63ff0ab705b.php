...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->JWIID); ?>" value="<?php echo e($val->JWIID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->JWIDT) && $val->JWIDT !='' && $val->JWIDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWIDT)):''); ?>" ></td>
          <td><?php echo e(isset($val->JWINO) && $val->JWINO !=''?$val->JWINO:''); ?></td>
          <td><?php echo e(isset($val->JWIDT) && $val->JWIDT !='' && $val->JWIDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWIDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkInvoice\trnfrm359.blade.php ENDPATH**/ ?>