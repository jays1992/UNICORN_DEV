<?php $__env->startSection('content'); ?>
      ...
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
       ...
       <div class="inner-form">
             ...
             <div class="row">            
               ...
               <div class="col-lg-2 pl">
                 <input type="text" id="YRDESCRIPTION" value="<?php echo e($objFyDesList->YRDESCRIPTION); ?>" class="form-control"  maxlength="100" disabled> 
               </div>
               ...
               <div class="col-lg-2 pl">
                 <select name="GENDER" id="GENDER" class="form-control mandatory" tabindex="4" disabled>
                   <option value="" selected >Select</option>
                     ...
                     <option <?php echo e(isset($objResponse->GENDER) && $objResponse->GENDER == $val-> GID ?'selected="selected"':''); ?> value="<?php echo e($val-> GID); ?>"><?php echo e($val->DESCRIPTIONS); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
                   ...
                   <tr>                          
                     ...
                     <tbody>
                       ...
                       <tr  class="participantRow">
                           <td><input  class="form-control" type="text" name=<?php echo e("SALARY_FR_".$key); ?>   id =<?php echo e("SALARY_FR_".$key); ?>  value="<?php echo e($row->SALARY_FR); ?>" autocomplete="off"  onkeypress="return onlyNumberKey(event)"  disabled></td>
                           <td><input  class="form-control" type="text" name=<?php echo e("SALARY_TO_".$key); ?>   id =<?php echo e("SALARY_TO_".$key); ?>  value="<?php echo e($row->SALARY_TO); ?>" autocomplete="off"  onkeypress="return onlyNumberKey(event)" disabled></td>
                           <td><input  class="form-control" type="text" name=<?php echo e("TAX_RATE_".$key); ?>    id =<?php echo e("TAX_RATE_".$key); ?>    value="<?php echo e($row->TAX_RATE); ?>" autocomplete="off" onkeypress="return onlyNumberKey(event)" disabled></td>
                           <td><input  class="form-control " type="text" name=<?php echo e("CESS1_RATE_".$key); ?> id =<?php echo e("CESS1_RATE_".$key); ?>  value="<?php echo e($row->CESS1_RATE); ?>" autocomplete="off" onkeypress="return onlyNumberKey(event)" disabled></td>
                           <td><input  class="form-control" type="text" name=<?php echo e("CESS2_RATE_".$key); ?>  id =<?php echo e("CESS2_RATE_".$key); ?>  value="<?php echo e($row->CESS2_RATE); ?>" autocomplete="off"  onkeypress="return onlyNumberKey(event)" disabled></td>
                           <td><input  class="form-control" type="text" name=<?php echo e("REMARKS_".$key); ?>     id =<?php echo e("REMARKS_".$key); ?>     value="<?php echo e($row->REMARKS); ?>" autocomplete="off" disabled></td>
 ...
 $("#btnApprove").click(function() {        
   ...
   highlighFocusBtn('activeYes');
    ...
    window.fnSaveData = function (){
         ...
         $.ajax({
             url:'<?php echo e(route("mastermodify",[326,"update"])); ?>',
             type:'POST',
             data:formData,
             success:function(data) {
 ...
 window.fnApproveData = function (){
     ...
     $.ajax({
         url:'<?php echo e(route("mastermodify",[326,"Approve"])); ?>',
         type:'POST',
         data:formData,
         success:function(data) {
...
$(function() { 
 ...
 <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\TDSSlabs\mstfrm326view.blade.php ENDPATH**/ ?>