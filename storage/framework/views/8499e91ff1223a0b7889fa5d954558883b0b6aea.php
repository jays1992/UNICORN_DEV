<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MCKLISTID); ?>" value="<?php echo e($val->MCKLISTID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->MACHINE_NO) && $val->MACHINE_NO !=''?$val->MACHINE_NO:''); ?></td>
                <td><?php echo e(isset($val->MACHINE_DESC) && $val->MACHINE_DESC !=''?$val->MACHINE_DESC:''); ?></td>
                <td><?php echo e(isset($val->CHECKLIST_NO) && $val->CHECKLIST_NO !=''?$val->CHECKLIST_NO:''); ?></td>
                <td><?php echo e(isset($val->CHECKLIST_DESC) && $val->CHECKLIST_DESC !=''?$val->CHECKLIST_DESC:''); ?></td>
        ...
        <form id="masterForm228Print" action="<?php echo e(route('mastergetlist',[228,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
  ...
  $(document).ready(function(){
    ...
    $('#btnEdit').on('click', function() {
      ...
      if(seletedRecord==0){
        ...
        $("#OkBtn").hide();
        $("#OkBtn1").show();
        $("#AlertMessage").text('You can not select multiple records.');
        $("#alert").modal('show');
        $("#OkBtn1").focus();
        ...
        var recordId = resultIdsData[0];
            ...
            if(is_approve==0){
              ...
              var editURL = '<?php echo e(route("master",[228,"edit",":rcdId"])); ?>';
                ...
                $("#OkBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('You can not edit cancel record.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
            }else{
              ...
              $("#OkBtn").hide();
              $("#OkBtn1").show();
              $("#AlertMessage").text('You can not edit approved record.');
              $("#alert").modal('show');
              $("#OkBtn1").focus();
            } 
      }
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[228,"view",":rcdId"])); ?>';
    ...
    $('#btnApprove').on('click', function() {
            ...
            {
                $("#alert").modal('show');
                $("#AlertMessage").text('Atleast 1 record is either Aprove or Cancel. Can not proceed further.');
                $("#YesBtn").hide(); 
                $("#OkBtn").hide();
                $("#NoBtn").hide();  
                $("#OkBtn1").show();
              ...
              var recordId = resultIdsData[0];
                ...
                if(is_approve==0){
                  ...
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
                  $("#AlertMessage").text('You can not approve cancelled record.');
                  $("#alert").modal('show');
                  $("#OkBtn1").focus();
                }else{
                  $("#YesBtn").hide();
                  ...
                  $("#OkBtn").hide();
                  $("#OkBtn1").show();
                  $("#AlertMessage").text('You can not approve Approved record.');
                  $("#alert").modal('show');
                  $("#OkBtn1").focus();
            ...
            if(seletedRecord==0){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  var recordId = resultIdsData[0];
                  var is_approve = $('#chkId'+recordId).data("rcdstatus");
                 var attachmentURL = '<?php echo e(route("master",[228,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[228,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[228,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\MachineWiseChecklist\mstfrm228.blade.php ENDPATH**/ ?>