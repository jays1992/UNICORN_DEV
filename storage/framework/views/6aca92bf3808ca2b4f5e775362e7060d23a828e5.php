                     ...
                     <tbody>
                      ...
                      <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       ...
                       <tr  class="participantRow">
                         <td><input <?php echo e($ActionStatus); ?> class="form-control" type="text" name="SRNo[]"            id ="SRNo_<?php echo e(isset($row->SR_NO) && $row->SR_NO !=''?$row->SR_NO:''); ?>"              value="<?php echo e(isset($row->SR_NO) && $row->SR_NO !=''?$row->SR_NO:''); ?>"  autocomplete="off" readonly></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\EmployeeHierarchyMaster\mstfrm505view.blade.php ENDPATH**/ ?>