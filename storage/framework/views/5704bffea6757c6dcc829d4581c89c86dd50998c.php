...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[35,'index'])); ?>" class="btn singlebt">Sales Enquiry</a></div>
...
<form id="frm_trn_se"  method="POST">   
	...
	<div class="inner-form">
		<div class="row">
			...
			<div class="col-lg-2 pl">
				    <input <?php echo e($ActionStatus); ?> type="date" name="ENQDT" id="ENQDT" onchange="checkPeriodClosing(35,this.value,1)" value="<?php echo e(isset($objSE->ENQDT)?$objSE->ENQDT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesEnquiry\trnfrm35edit.blade.php ENDPATH**/ ?>