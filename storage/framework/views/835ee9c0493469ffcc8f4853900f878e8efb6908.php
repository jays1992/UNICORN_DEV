...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[452,'index'])); ?>" class="btn singlebt">Payslip</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="EMPID" data-hide-disabled="hide"  data-actions-box="true" id="EMPID" class="form-control selectpicker"  data-live-search="true"  >
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[452,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(EMPID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[452,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Payroll\Payslip\rptfrm452.blade.php ENDPATH**/ ?>