          ...
          <div class="inner-form">
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                        <input type="text" name="SGLCODE" id="SGLCODE" value="<?php echo e(old('SGLCODE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="2" style="text-transform:uppercase" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SLNAME" id="SLNAME" class="form-control mandatory" value="<?php echo e(old('SLNAME')); ?>" maxlength="200" tabindex="3"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SALIAS" id="SALIAS" class="form-control" value="<?php echo e(old('SALIAS')); ?>" maxlength="100" tabindex="4"  />
...
"use strict";
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[129,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[129,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[129,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\SubLedgerMaster\mstfrm129add.blade.php ENDPATH**/ ?>