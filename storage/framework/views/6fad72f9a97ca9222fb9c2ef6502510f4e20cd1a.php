      ...
      <table id="nor_tax_tab2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr class="clsinvoiceid">
          <td class="ROW1" style="width: 12%" align="center">
            ...
            <input type="checkbox" id="nor_taxidref_<?php echo e($TTList->TAXID); ?>" name="SELECT_TAXID_REF[]" value="<?php echo e($TTList->TAXID); ?>" class="js-selectall1 cls_nor_taxidref"  >
...
//----------------------------
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[144,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
    ...
    $("#OkBtn").click(function(){
        ...
        $(".text-danger").hide();
         //reload form
         window.location.href = "<?php echo e(route('master',[144,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\HSN\mstfrm144add.blade.php ENDPATH**/ ?>