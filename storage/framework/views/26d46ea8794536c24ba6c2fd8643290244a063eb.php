            ...
            <div class="container-fluid">
              ...
              <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:350px;width:50%;">
                <table id="udffietable" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                  ...
                  <?php $__currentLoopData = $objUdfForItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $udfkey => $udfrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr  class="participantRow">
                    <td>
                    ...
                    <td hidden>
                      <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDFITEMID); ?>" class="form-control" maxlength="100" />
                    </td>
  ...
  <div class="modal-dialog modal-md">
    ...
    <table id="udffieexample2345" class="display nowrap table  table-striped table-bordered" width="100%">
      ...
      <tr id="udffie_<?php echo e($UdffieRow->UDFITEMID); ?>" class="clsudffie">
        <td style="width: 50%"><?php echo e($UdffieRow->LABEL); ?>  <input type="hidden" id="txtudffie_<?php echo e($UdffieRow->UDFITEMID); ?>" value="<?php echo e($UdffieRow-> UDFITEMID); ?>"
 ...
 // $('#table3').on("dblclick",".clstouom",function(){
  ...
  //----------------------
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"codeduplicate"])); ?>',
            type:'POST',
            data:{'ICODE': codedata},
            success:function(data) {
                if(data.exists) {
    ...
    function checkDuplicateName(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"nameduplicate"])); ?>',
            type:'POST',
            data:{'NAME': namedata},
            success:function(data) {
                if(data.exists) {
     ...
     function checkDuplicateNameAlps(buid){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"nameduplicatealps"])); ?>',
            type:'POST',
...
$("#btnSaveItem").click(function(){
  ...
  window.fnSaveData = function (){
    ...
    $("#OkBtn").click(function(){
        ...
        window.location.href = "<?php echo e(route('master',[72,'add'])); ?>";
    }); ///ok button
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\ItemMasters\mstfrm72add.blade.php ENDPATH**/ ?>