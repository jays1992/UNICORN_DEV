      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="JWONO" id="JWONO" value="<?php echo e($objMstResponse->JWONO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
          ...
          <div class="col-lg-2 pl">
            <input type="date" name="JWODT" id="JWODT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($objMstResponse->JWODT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
                <input type="checkbox" name="DirectJWO" id="DirectJWO" class="form-checkbox" <?php echo e(isset($objMstResponse->DIRECTJWO) && $objMstResponse->DIRECTJWO == 1 ? 'checked' : ''); ?>  />
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td>       <input type="text"  name="txtPRO_popup_<?php echo e($key); ?>"  id="txtPRO_popup_<?php echo e($key); ?>"  value="<?php echo e($row->PRO_NO); ?>"    class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    <td hidden><input type="text"  name="PROID_REF_<?php echo e($key); ?>"     id="PROID_REF_<?php echo e($key); ?>"     value="<?php echo e($row->PROID_REF); ?>" class="form-control"  autocomplete="off" /></td>
										...
										<td><input type="text"   name="QTY_<?php echo e($key); ?>" 		id="QTY_<?php echo e($key); ?>" 		value="<?php echo e($row->PROD_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
                    ...
                    <td><input type="text"   name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>"  class="form-control three-digits"   value="<?php echo e($row->RATE_PUOM); ?>" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="rate_amount(this.id)"  /></td>
                    <td><input type="text"   name="TOT_AMT_<?php echo e($key); ?>"  id="TOT_AMT_<?php echo e($key); ?>"   class="form-control three-digits"   value="<?php echo e($TOT_AMT); ?>" readonly maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="rate_amount(this.id)"  /></td>
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <?php if(!empty($objSavedTNCHeader)): ?>
                                          <input type="text" name="txtTNCID_popup" id="txtTNCID_popup" value="<?php echo e($objSavedTNCHeader[0]->TNC_CODE); ?> - <?php echo e($objSavedTNCHeader[0]->TNC_DESC); ?>" class="form-control"  autocomplete="off"  readonly/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkOrder\trnfrm354edit.blade.php ENDPATH**/ ?>