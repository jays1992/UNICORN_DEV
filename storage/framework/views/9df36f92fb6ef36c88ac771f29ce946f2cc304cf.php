...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
      <a href="<?php echo e(route('master',[5,'index'])); ?>" class="btn singlebt">Customer / Dealer Master</a>
    </div>

    <div class="col-lg-10 topnav-pd">
      <a href="<?php echo e(route('master',[5,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Customer Master Print</p></div>
        <div class="row">
...
function load_country_data(limit, start){
  ...
  $.ajax({
    url:'<?php echo e(route("master",[5,"getListingData"])); ?>',
    method:"POST",
...
$(document).ready(function(){
  ...
  $('.js-selectall').on('change', function() {
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[5,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[5,"view",":rcdId"])); ?>';
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("master",[5,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
                            window.location.href=editURL;
                      }else if(is_approve==2){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[5,"attachment",":rcdId"])); ?>';
    ...
    var impURL =  '<?php echo e(route("master",[5,"importdata"])); ?>';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[5,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[5,"cancel"])); ?>',
                            type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'CID='+ ITEMID + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("master",[5,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            var ITEMID = soIdsData[0];            
            var Flag = 'H';
            var formData = 'SO='+ ITEMID + '&CID='+ ITEMID + '&Flag='+ Flag ;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                url:'<?php echo e(route("mastermodify",[5,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Sales/CUSTOMERMASTER/mstfrm5.blade.php ENDPATH**/ ?>