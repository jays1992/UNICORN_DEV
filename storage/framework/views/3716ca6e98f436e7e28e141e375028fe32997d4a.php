  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->SCHEMEID); ?>" value="<?php echo e($val->SCHEMEID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->SCHEME_NO) && $val->SCHEME_NO !=''?$val->SCHEME_NO:''); ?></td>
          <td><?php echo e(isset($val->SCHEME_DATE) && $val->SCHEME_DATE !=''?$val->SCHEME_DATE:''); ?></td>  
          <td><?php echo e(isset($val->SCHEME_NAME) && $val->SCHEME_NAME !=''?$val->SCHEME_NAME:''); ?></td>  
          <td><?php echo e(isset($val->SCHEME_TYPE) && $val->SCHEME_TYPE !=''?$val->SCHEME_TYPE:''); ?></td>
          <td><?php echo e(isset($val->EFF_FROM_DATE) && $val->EFF_FROM_DATE !='' && $val->EFF_FROM_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->EFF_FROM_DATE)):''); ?></td>
          <td><?php echo e(isset($val->EFF_TO_DATE) && $val->EFF_TO_DATE !='' && $val->EFF_TO_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->EFF_TO_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Sales/SchemeMaster/mstfrm498.blade.php ENDPATH**/ ?>