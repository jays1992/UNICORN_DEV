...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
            <?php if($objPBDOCNO): ?>
              <?php if($objPBDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="PII_NO" id="PII_NO" value="<?php echo e($objDataNo); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              <?php endif; ?>
              <?php if($objPBDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="PII_NO" id="PII_NO" value="<?php echo e(old('PII_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e($objPBDOCNO->MANUAL_MAXLENGTH); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
              <?php endif; ?>
            <?php else: ?>
                <input type="text" name="PII_NO" id="PII_NO" value="<?php echo e(old('PII_NO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus >
            <?php endif; ?>
        </div>
        <div class="col-lg-2 pl"><p>PII Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PII_DT" id="PII_DT" value="<?php echo e(old('PII_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="<?php echo e(old('VENDOR_INNO')); ?>" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p> Vendor Invoice Date</p></div>
        <div class="col-lg-2 pl">
                <input type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="<?php echo e(old('VENDOR_INDT')); ?>" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
	...
	<div class="row">
		...
		<div class="col-lg-2 pl">
			<input type="text" name="BOE_NO" id="BOE_NO" class="form-control" autocomplete="off" >
		</div>

		<div class="col-lg-2 pl"><p>BOE Date</p></div>
		<div class="col-lg-2 pl">
			<input type="date" name="BOE_DT" id="BOE_DT" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" >
		</div>
	</div>
      ...
      <div class="tab-content">
		...
		<div id="Material" class="tab-pane fade in active">
			<div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
              ...
              <th rowspan="2">UOM of Bill Qty</th>
					...
					<tbody>	
						<tr  class="participantRow">
							<td><input type="text" name="txtGRN_NO_0" id="txtGRN_NO_0" class="form-control"  autocomplete="off"  readonly style="width:120px;" /></td>
							<td hidden><input type="hidden" name="GRNID_REF_0" id="GRNID_REF_0" class="form-control" autocomplete="off" /></td>
							<td hidden><input type="hidden" name="IPO_ID_REF_0" id="IPO_ID_REF_0" class="form-control" autocomplete="off" /></td>
						  
							<td><input type="text" name="popupITEMID_0" id="popupITEMID_0" class="form-control"  autocomplete="off"  readonly readonly style="width:100px;"/></td>
							...
							<td><input type="text" name="Itemspec_0" id="Itemspec_0" class="form-control"  autocomplete="off" style="width:100px;" /></td>
							...
							<td><input type="text" name="SO_QTY_0" id="SO_QTY_0"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly  /></td>
              ...
              <td><input type="text" name="BILL_QTY_0" id="BILL_QTY_0" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
              <td><input type="text" name="UOM_OF_BILL_QTY_0" id="UOM_OF_BILL_QTY_0" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" readonly /></td>

              <td><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
							<td><input type="text" name="DISC_PER_0" id="DISC_PER_0" onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;" /></td>
							<td><input type="text" name="DISC_AMT_0" id="DISC_AMT_0" onkeyup="onChangeAmount(this.id,this.value)" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
							...
							<td><input type="text" name="FREIGHT_AMT_0"           id="FREIGHT_AMT_0"            onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
							<td><input type="text" name="INSURANCE_AMT_0"         id="INSURANCE_AMT_0"          onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
							<td><input type="text" name="ASSESSABLE_VALUE_0"      id="ASSESSABLE_VALUE_0"       class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="CUSTOME_DUTY_RATE_PER_0" id="CUSTOME_DUTY_RATE_PER_0"  class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="CUSTOME_DUTY_RATE_AMT_0" id="CUSTOME_DUTY_RATE_AMT_0"  class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="SWS_RATE_PER_0"          id="SWS_RATE_PER_0"           class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="SWS_RATE_AMT_0"          id="SWS_RATE_AMT_0"           class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="TOTAL_CUSTOME_DUTY_0"    id="TOTAL_CUSTOME_DUTY_0"     class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="TAXABLE_VALUE_0"         id="TAXABLE_VALUE_0"          class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="IGST_RATE_PER_0"         id="IGST_RATE_PER_0"               class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="IGST_RATE_AMT_0"         id="IGST_RATE_AMT_0"               class="form-control four-digits" readonly  autocomplete="off"/></td>
							<td><input type="text" name="VALUE_AFTER_GST_0"       id="VALUE_AFTER_GST_0"        class="form-control four-digits" readonly  autocomplete="off"/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoiceImport - Copy\trnfrm300add.blade.php ENDPATH**/ ?>