...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>	
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->MPPID); ?>" value="<?php echo e($val->MPPID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MPP_DOC_DT) && $val->MPP_DOC_DT !='' && $val->MPP_DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MPP_DOC_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->MPP_DOC_NO) && $val->MPP_DOC_NO !=''?$val->MPP_DOC_NO:''); ?></td>
              <td><?php echo e(isset($val->MPP_DOC_DT) && $val->MPP_DOC_DT !='' && $val->MPP_DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MPP_DOC_DT)):''); ?></td>
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("transaction",[220,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ManualProductionPlan\trnfrm229.blade.php ENDPATH**/ ?>