...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[260,'index'])); ?>" class="btn singlebt">Receipt Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_scs"  method="POST">   
            <?php echo csrf_field(); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                <?php $__currentLoopData = $objReceiptNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Rindex=>$RRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($RRow->RECEIPTID); ?>" selected><?php echo e($RRow->RECEIPT_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>    
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[260,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var RECEIPID = [];
        $("select[name='RECEIPID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                RECEIPID.push(value5);
            }
        });
        ...
        else if(RECEIPTID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[260,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\Receipt_Register\rptfrm260.blade.php ENDPATH**/ ?>