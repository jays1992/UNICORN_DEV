                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl"><p>Customer / Prospect</p></div>
                        <div class="col-lg-2 pl">
                          <select name="CUSTOMER" id="CUSTOMER" onchange="getCustomer(this.value)" class="form-control mandatory">
                            ...
                            <div class="col-lg-2 pl">
                                ...
                                <input type="hidden" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE" class="form-control" autocomplete="off" />
                            ...
                            <input type="hidden" name="QUOTATIONTYPE" id="QUOTATIONTYPE" value="" class="form-control" autocomplete="off" />                           
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <?php if(isset($objSQN->SYSTEM_GRSR) && $objSQN->SYSTEM_GRSR == "1"): ?>
                              <input type="text" name="SQNO" id="SQNO" value="<?php echo e(isset($objSQNO)?$objSQNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            <?php elseif(isset($objSQN->MANUAL_SR) && $objSQN->MANUAL_SR == "1"): ?>
                              <input type="text" name="SQNO" id="SQNO"  class="form-control mandatory" maxlength="<?php echo e(isset($objSQN->MANUAL_MAXLENGTH)?$objSQN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                            <?php else: ?>
                            ...
                            <div class="col-lg-2 pl">
                            <input type="hidden" id="LASTSQDT" value="<?php echo e(isset($objlastSQDT[0]->SQDT)?$objlastSQDT[0]->SQDT:''); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectSQ" id="DirectSQ" class="form-checkbox" onchange="direct()" >
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <td hidden><input type="hidden"  name="SCHEMEID_REF_0" id="SCHEMEID_REF_0" class="form-control" autocomplete="off" style="width:130px;"  /></td>
                                                  ...
                                                  <td hidden><input type="hidden" name="SCHEMEQTY_0" id="SCHEMEQTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:130px;text-align:right;"    /></td>
                                                    ...
                                                    <td ><input type="text" name="RATEPUOM_0" id="RATEPUOM_0" class="form-control five-digits blurRate"    onkeyup="dataCal(this.id),get_delear_customer_price(this.id,'change')"     maxlength="13"   /></td>
                                                    <td hidden><input type="text" name="COMMISSION_AMOUNT_0" id="COMMISSION_AMOUNT_0" /></td>
                                                    
                          
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCPER_0" id="DISCPER_0" onkeyup="dataCal(this.id)"  class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;" /></td>
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" onkeyup="dataCal(this.id)"  class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="TNCnamesearch" class="form-control"  autocomplete="off" onkeyup="TNCNameFunction()">
      ...
      <table id="TNCIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="tnc[]" id="tncidcode_<?php echo e($tncindex); ?>" class="clsleadid" value="<?php echo e($tncRow-> TNCID); ?>" ></td>
...
<div id="customer_popus" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        ...
        <td class="ROW2"><input type="text" id="customercodesearch" class="form-control"  autocomplete="off" onkeyup="CustomerCodeFunction('<?php echo e($FormId); ?>')"></td>
        <td class="ROW3"><input type="text" id="customernamesearch" class="form-control"  autocomplete="off" onkeyup="CustomerNameFunction('<?php echo e($FormId); ?>')"></td>
    </tr>
    </tbody>
    </table>
    ...
    <input type="text" id="UDFSOIDnamesearch"  autocomplete="off" onkeyup="UDFSOIDNameFunction()">
      ...
      <table id="UDFSOIDTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tr id="udfsoid_<?php echo e($udfindex); ?>" class="clsudfsoid">
          ...
          <input type="hidden" id="txtudfsoid_<?php echo e($udfindex); ?>" data-desc="<?php echo e($udfRow->LABEL); ?>"  value="<?php echo e($udfRow->UDFSQID); ?>"/>
          </td>
            ...
            if($(this).is(":checked") == true) {
              ...
              if($.trim($("#SCHEMEID_REF").val()) ==='' && jQuery.inArray(txtenqitem, SalesEnq2) !== -1){
                ...
                return false;
                      ...
                      var qtyrate =  parseFloat(txtmuomqty) * parseFloat(txtruom);
                      var distamt = parseFloat(qtyrate).toFixed(2);

                      $('#'+txtid).parent().parent().find('[id*="RATEPUOM"]').val(txtruom);
                      $('#'+txtid).parent().parent().find('[id*="DISAFTT_AMT"]').val(distamt);
                      $('#'+txtid).parent().parent().find('[id*="TOT_AMT"]').val(txttotamtatax);
                      $('#'+txtid).parent().parent().find('[id*="TGST_AMT"]').val(txttottaxamt);
                      if($('#Tax_State').val() == 'OutofState')
                        {
...
$.ajax({
    url:'<?php echo e(route("transaction",[36,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesQuotation_20221117\trnfrm36add.blade.php ENDPATH**/ ?>