            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" >
                                <select name="SLID_REF[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SLID_REF" class="form-control selectpicker" multiple data-live-search="true"  >
                                ...
                                <option value="<?php echo e($val->SLID_REF); ?>" selected><?php echo e($val->CCODE); ?> - <?php echo e($val->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$('#btnView').on('click', function() {
    ...
    var To_Date         = $('#To_Date').val();
        ...
        var SLID_REF = [];
        $("select[name='SLID_REF[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                SLID_REF.push(value4);
            }
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\PendingSalesOrderPRO\rptfrm510.blade.php ENDPATH**/ ?>