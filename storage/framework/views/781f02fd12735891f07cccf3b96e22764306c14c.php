...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Fixed Deposit</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->FDID); ?>" value="<?php echo e($val->FDID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->FD_DATE) && $val->FD_DATE !='' && $val->FD_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->FD_DATE)):''); ?>" ></td>
              <td><?php echo e(isset($val->FD_CODE) && $val->FD_CODE !=''?$val->FD_CODE:''); ?></td>
              <td><?php echo e(isset($val->FD_DATE) && $val->FD_DATE !='' && $val->FD_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->FD_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\FixedDeposit\trnfrm501.blade.php ENDPATH**/ ?>