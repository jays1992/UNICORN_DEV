...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">DG Usage & Fuel Fill </a>
        </div>
...
<form id="edit_trn_form" method="POST"  >
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
                ...
                <input type="text" name="DGUFF_NO" id="DGUFF_NO" value="<?php echo e($objResponse->DGUFF_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
            ...
            <div class="col-lg-2 pl">
                <input type="date" name="DGUFF_DATE" id="DGUFF_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($objResponse->DGUFF_DATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>      
         </div>
           ...
           <div class="row">
                  ...
                  <input type="text" name="Machinepopup" id="txtMachinepopup" class="form-control mandatory" value="<?php echo e($objResponse->MACHINE_NO); ?>"  autocomplete="off"  readonly/>
                    <input type="hidden" name="MACHINE_REF" id="MACHINE_REF" class="form-control" value="<?php echo e($objResponse->MACHINEID_REF); ?>" autocomplete="off" />
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="MACHINE_DESC" id="MACHINE_DESC" class="form-control mandatory" value="<?php echo e($objResponse->MACHINE_DESC); ?>" readonly maxlength="200"  />
            ...
            <div class="col-lg-2 pl"><p>Fuel Type</p></div>
              <div class="col-lg-2 pl">
              <input type="text" name="FuelType_popup" id="txtFuelType_popup" class="form-control mandatory" value="<?php echo e($objResponse->FUEL_CODE); ?>-<?php echo e($objResponse->FUEL_DESC); ?>"  autocomplete="off"  readonly/>
                    <input type="hidden" name="FUELTYPE_REF" id="FUELTYPE_REF" class="form-control" value="<?php echo e($objResponse->FUELID_REF); ?>" autocomplete="off" />
              </div>
                <div class="col-lg-2 pl"><p>Standard Consumption (Per Hour)		</p></div>
              <div class="col-lg-2 pl">
              <input type="text" name="CONSUMPTION_PER_HOUR" id="CONSUMPTION_PER_HOUR" class="form-control mandatory" value="<?php echo e($objResponse->STANDARD_CONSUMPTION_PH); ?>"  maxlength="200"  />
              </div>
            ...
            <div class="col-lg-2 pl"><p>UOM</p></div>
                ...
                <input type="text" name="UOM_popup" id="txtUOM_popup" class="form-control mandatory" value="<?php echo e($objResponse->UOMCODE); ?>-<?php echo e($objResponse->DESCRIPTIONS); ?>"  autocomplete="off"  readonly/>
            ...
            <div class="col-lg-1 pl">
                <input type="checkbox" name="TYPE" id="USAGE"  value="usage" <?php echo e(isset($objResponse) && $objResponse->USAGE=='1'?'checked':''); ?> />  
            </div>
            <div class="col-lg-1 pl"><p>Fuel Consumption</p></div>
            <div class="col-lg-1 pl">
                <input type="checkbox" name="TYPE" id="FUEL_CONSUMPTION" value="fuel_consumption" <?php echo e(isset($objResponse) && $objResponse->FUEL_CONSUMPTION=='1'?'checked':''); ?>  />
            </div>     
            <div class="col-lg-1 pl"><p>Both</p></div>
            <div class="col-lg-1 pl">
                <input type="checkbox" name="TYPE" id="BOTH" value="both"  <?php echo e(isset($objResponse) && $objResponse->BOTH=='1'?'checked':''); ?> />
            </div>     
        </div>
          ...
          <div class="col-lg-2 pl"><p>From Date</p></div>
            <div class="col-lg-2 pl">
              <input type="date" name="FROMDATE" id="FROMDATE" value="<?php echo e($objResponse->USAGE_FROMDATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            <div class="col-lg-2 pl"><p>Opening Fuel</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="OPENDING_FUEL" id="OPENDING_FUEL" class="form-control "  autocomplete="off" value="<?php echo e($objResponse->OPENING_FUEL); ?>" maxlength="50" />
            </div>
          ...
          <div class="col-lg-2 pl"><p>From time</p></div>
            <div class="col-lg-2 pl">
            <input type="time" name="FROMTIME" id="FROMTIME" class="form-control mandatory" value="<?php echo e($FROMTIME); ?>"  autocomplete="off"  />
            </div>
            <div class="col-lg-2 pl"><p>Filled Fuel</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="FILLED_FUEL" id="FILLED_FUEL" class="form-control " value="<?php echo e($objResponse->FILLED_FUEL); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>To Date</p></div>
            <div class="col-lg-2 pl">
            <input type="date" name="TODATE" id="TODATE" value="<?php echo e($objResponse->USAGE_TODATE); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            <div class="col-lg-2 pl"><p>Closing Fuel</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="CLOSING_FUEL" id="CLOSING_FUEL" readonly class="form-control " value="<?php echo e($objResponse->CLOSING_FUEL); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>To Time</p></div>
            <div class="col-lg-2 pl">
            <input type="time" name="TOTIME" id="TOTIME" class="form-control mandatory" value="<?php echo e($TOTIME); ?>"  autocomplete="off"  />
            </div>
            <div class="col-lg-2 pl"><p>Fuel Filled by</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="FUEL_FILLED_BY" id="FUEL_FILLED_BY" class="form-control " value="<?php echo e($objResponse->FUEL_FILLEDBY); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>Genset Started by</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="GENSET_STARTED_BY" id="GENSET_STARTED_BY" class="form-control " value="<?php echo e($objResponse->GENSET_STARTEDBY); ?>"  autocomplete="off" maxlength="20" />
            </div>
            <div class="col-lg-2 pl"><p>Remarks</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="CONSUMPTION_REMARKS" id="CONSUMPTION_REMARKS" class="form-control " value="<?php echo e($objResponse->FUEL_REMARKS); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>Genset Stopped by</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="GENSET_STOPPED_BY" id="GENSET_STOPPED_BY" class="form-control " value="<?php echo e($objResponse->GENSET_STOPPEDBY); ?>"  autocomplete="off" maxlength="20" />
            </div>
            <div class="col-lg-2 pl"><p>Meter (KWH) Started reading</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="KWH_START_CONSUMPTION" id="KWH_START_CONSUMPTION" class="form-control " value="<?php echo e($objResponse->FUEL_READING_START_KWH); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>Meter (KWH) Start reading</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="KWH_START_USAGE" id="KWH_START_USAGE" class="form-control " value="<?php echo e($objResponse->USAGE_READING_START_KWH); ?>"  autocomplete="off" maxlength="20" />
            </div>
            <div class="col-lg-2 pl"><p>Meter (KWH) Ended Reading</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="KWH_END_CONSUMPTION" id="KWH_END_CONSUMPTION" class="form-control " value="<?php echo e($objResponse->FUEL_READING_END_KWH); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
          <div class="col-lg-2 pl"><p>Meter (KWH) End Reading</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="KWH_END_USAGE" id="KWH_END_USAGE" class="form-control " value="<?php echo e($objResponse->USAGE_READING_END_KWH); ?>" autocomplete="off" maxlength="20" />
            </div>
            <div class="col-lg-2 pl"><p>Observation</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="OBSERVATION" id="OBSERVATION" class="form-control " value="<?php echo e($objResponse->OBSERVATION); ?>"  autocomplete="off" maxlength="50" />
            </div>       
          </div>
          <div class="row">
            ...
            <div class="col-lg-6 pl">
              <input type="text" name="REMARKS" id="REMARKS" class="form-control "  value="<?php echo e($objResponse->USAGE_REMARKS); ?>" autocomplete="off" maxlength="50" />
            </div>       
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\DGUsageFuelFill\trnfrm369edit.blade.php ENDPATH**/ ?>