  ...
  <div class="multiple table-responsive  ">
    <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->BUGID); ?>" value="<?php echo e($val->BUGID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->BUG_NO) && $val->BUG_NO !=''?$val->BUG_NO:''); ?></td>
          <td><?php echo e(isset($val->BUG_DATE) && $val->BUG_DATE !='' && $val->BUG_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BUG_DATE)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\BudgetMaster\mstfrm503.blade.php ENDPATH**/ ?>