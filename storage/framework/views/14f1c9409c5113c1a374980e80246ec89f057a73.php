          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->EARNING_HEAD_DESC); ?> </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>Earning Head Type</p></div>
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->EARNING_TYPECODE.'-'.$objResponse->EARNING_TYPE_DESC); ?> </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>GL Name</p></div>
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->GLCODE.'-'.$objResponse->GLNAME); ?> </label>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EarningHead\mstfrm186view.blade.php ENDPATH**/ ?>