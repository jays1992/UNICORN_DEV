...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Entitlement Master</a></div>
  ...
  <div class="multiple table-responsive  ">
    ...
    <thead id="thead1">
      ...
      if($val->MNAME){
        ...
        $EMPLOYEE_NAME=ucwords(strtolower($val->FNAME.' '.$middle_name.$val->LNAME)); 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->ENTITLEMENT_ID); ?>" value="<?php echo e($val->ENTITLEMENT_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
          <td><?php echo e(isset($val->ENTITLEMENT_NO) && $val->ENTITLEMENT_NO !=''?$val->ENTITLEMENT_NO:''); ?></td>
          <td><?php echo e(isset($val->ENTITLEMENT_DT) && $val->ENTITLEMENT_DT !=''?$val->ENTITLEMENT_DT:''); ?></td>
          <td><?php echo e(isset($val->EMPCODE) && $val->EMPCODE !=''?$val->EMPCODE:''); ?></td>
          <td><?php echo e(isset($EMPLOYEE_NAME) && $EMPLOYEE_NAME !=''?$EMPLOYEE_NAME:''); ?></td>
...
$(document).ready(function(){  
  ...
  var DataTable =  $('#listingmst').DataTable({}); 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\EntitlementMaster\mstfrm200.blade.php ENDPATH**/ ?>