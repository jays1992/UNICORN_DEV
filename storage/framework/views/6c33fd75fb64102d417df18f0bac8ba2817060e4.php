<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[144,'index'])); ?>" class="btn singlebt">HSN Master</a>
                </div><!--col-2-->

                <div class="col-lg-10 topnav-pd">
                        <a href="<?php echo e(route('master',[144,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
                        ...
                        <button class="btn topnavbt" id="btnApprove" <?php echo e((isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
              ...
              ?>
              <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->HSNID); ?>" value="<?php echo e($val->HSNID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->HSNCODE) && $val->HSNCODE !=''?$val->HSNCODE:''); ?></td>
                <td><?php echo e(isset($val->HSNDESCRIPTION) && $val->HSNDESCRIPTION !=''?$val->HSNDESCRIPTION:''); ?></td>
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[144,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[144,"view",":rcdId"])); ?>';
  ...
  $('#btnAmendment').on('click', function() {                
    ...
    if(seletedRecord==0){
      ...
      if(is_approve==1){
        ...
        var editURL = '<?php echo e(route("master",[144,"amendment",":rcdId"])); ?>';
            editURL = editURL.replace(":rcdId",recordId);
            window.location.href=editURL;
      }else if(is_approve==2){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[144,"attachment",":rcdId"])); ?>';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[144,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[144,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\HSN\mstfrm144.blade.php ENDPATH**/ ?>