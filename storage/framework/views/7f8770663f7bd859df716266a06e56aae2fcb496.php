...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="text" name="MJV_NO" id="MJV_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
              <script>docMissing(<?php echo json_encode($docarray['FY_FLAG'], 15, 512) ?>);</script>
        </div>
        <div class="col-lg-1 pl"><p>MJV Date </p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="MJV_DT" id="MJV_DT" value="<?php echo e(old('MJV_DT')); ?>" onchange='checkPeriodClosing(415,this.value,1),getDocNoByEvent("MJV_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory"  placeholder="dd/mm/yyyy" <?php if(isset($DOC_TYPE) && $DOC_TYPE !=''){?> onchange='getDocNoByEvent("MJV_NO",this,<?php echo json_encode($doc_req);?>)' <?php } ?> />
        </div>
        ...
        <div class="col-lg-2 pl">
                  <input type="date" name="REVERSE_DT" id="REVERSE_DT" value="<?php echo e(old('MJV_DT')); ?>" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    <div class="row">
...
$.ajax({
    url:'<?php echo e(route("transaction",[415,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ManualJournalVoucher\trnfrm415add.blade.php ENDPATH**/ ?>