...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[344,'index'])); ?>" class="btn singlebt">Production Order Register</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_ipo"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                        <div class="col-lg-3 pl"><p>Sale Order No</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="SALE_ORDER_ID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="SALE_ORDER_ID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objSONo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->SOID); ?>" selected><?php echo e($Row->SONO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>                          
                            <div class="col-lg-3 pl"><p>Production Order No</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="PRODUCTION_ORDER_ID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="PRODUCTION_ORDER_ID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objPRONo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($Row->PROID); ?>" selected><?php echo e($Row->PRO_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>   
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[344,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var SALE_ORDER_ID  = [];
        $("select[name='SALE_ORDER_ID[]']").each(function() {
            var value7 = $(this).val();
            if (value7) {
                SALE_ORDER_ID.push(value7);
            }
        });
        var PRODUCTION_ORDER_ID  = [];
        $("select[name='PRODUCTION_ORDER_ID[]']").each(function() {
            var value8 = $(this).val();
            if (value8) {
                PRODUCTION_ORDER_ID.push(value8);
            }
        });
        ...
        else if(SALE_ORDER_ID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Sale Order No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else if(PRODUCTION_ORDER_ID  == '')
        {
            $("#YesBtn").hide();
            $("#NoBtn").hide();
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Production Order No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[344,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\Production_Order_Register\rptfrm344.blade.php ENDPATH**/ ?>