        ...
        // Data table for serverside
         var mstudfforListTable =  $('#udfforlistingmst').DataTable({
            ...
            "ajax":{
                     ...
                     "url": "<?php echo e(route('mastergetlist',[56,'getListing'])); ?>",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
          ...
          var udflistIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '<?php echo e(route("master",[56,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[56,"attachment",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[56,"edit",":rcdId"])); ?>';
...
var recordId = udflistIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[56,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[56,"cancel"])); ?>',
                            type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\UDFSCHABLPO\mstfrm56.blade.php ENDPATH**/ ?>