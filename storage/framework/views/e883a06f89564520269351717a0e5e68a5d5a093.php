             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="<?php echo e($HDR->PGB_CODE); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus  disabled>
                 <span class="text-danger" id="ERROR_PROVISION_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PROVISION_DT" id="PROVISION_DT" value="<?php echo e($HDR->PGB_DATE); ?>" class="form-control"  maxlength="100" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>Bonus </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="BONUS" id="BNSGRTYLE" value="1" <?php echo e(isset($HDR->BONUS) && $HDR->BONUS =='1'?'checked':''); ?> onchange="getBonusName(this.value)" disabled> 
                 </div>
               </div>
               ...
               <div class="row">
                 <div class="col-lg-2 pl"><p>Gratuity </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="GRTUITY" id="BNSGRTYLE" value="1" <?php echo e(isset($HDR->GRTUITY) && $HDR->GRTUITY =='1'?'checked':''); ?> onchange="getGratuityName(this.value)" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>Leave Encashment </p></div>
                   <div class="col-lg-2 pl">
                   <input type="checkbox" name="LEAVE_ENCASH" id="BNSGRTYLE" value="1" <?php echo e(isset($HDR->LEAVE_ENCASH) && $HDR->LEAVE_ENCASH =='1'?'checked':''); ?> onchange="getLeaveEntName(this.value)" disabled> 
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Generate </p></div>
                   <div class="col-lg-2 pl">
                   <input type="radio" name="GENERATE" id="GENERATE" value="1" <?php echo e(isset($HDR->GENERATE) && $HDR->GENERATE =='1'?'checked':''); ?> disabled > 
                 </div>

                 <div class="col-lg-2 pl"><p>Head </p></div>
                   <div class="col-lg-2 pl">
                   <input type="text" name="HEAD" id="HEAD" value="<?php echo e($HDR->HEADID_REF); ?>" class="form-control" disabled > 
                     ...
                     <tbody>
                      ...
                      <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr  class="participantRow">
                         <td>
                           <select name="EMPCODE_REF[]" id =<?php echo e("EMPCODE_REF_".$key); ?> onchange="getEmpCodeName(this.id,this.value)" class="form-control mandatory" tabindex="4" disabled >
                           <option value="" selected="">Select</option>
                         ...
                         <td><input type="text" id =<?php echo e("EMPCODE_NAME_".$key); ?> value="<?php echo e($row->FNAME); ?>" class="form-control" readonly  maxlength="100" disabled></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\ProvisionOfBonusGratuityLeaveEncashment\trnfrm416view.blade.php ENDPATH**/ ?>