...
<div class="container-fluid topnav">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->DOC_ID); ?>" value="<?php echo e($val->DOC_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->DOC_NO) && $val->DOC_NO !=''?$val->DOC_NO:''); ?></td>
                <td><?php echo e(isset($val->DOC_DT) && $val->DOC_DT !='' && $val->DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DOC_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\UserBranchMapping\mstfrm204.blade.php ENDPATH**/ ?>