...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Calculation Basis</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive">
            ...
            ?>            
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->CAL_BASISID); ?>" value="<?php echo e($val->CAL_BASISID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->BASIS_DOC_NO) && $val->BASIS_DOC_NO !=''?$val->BASIS_DOC_NO:''); ?></td>
                <td><?php echo e(isset($val->BASIS_DOC_DT) && $val->BASIS_DOC_DT !='' && $val->BASIS_DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BASIS_DOC_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\Calculation_Basis\mstfrm199.blade.php ENDPATH**/ ?>