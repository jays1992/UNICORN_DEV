        ...
        <div class="inner-form">
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="GRATUITY_CODE" id="GRATUITY_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                ...
                <div class="col-lg-5 pl">
                    <input type="text" name="GRATUITY_DESC" id="GRATUITY_DESC" class="form-control mandatory" value="<?php echo e(old('GRATUITY_DESC')); ?>" maxlength="200" tabindex="2" />
            ...
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="GRATUITY_RATE" id="GRATUITY_RATE" value="<?php echo e(old('GRATUITY_RATE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
                ...
                <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="MIN_YEAR" id="MIN_YEAR" value="<?php echo e(old('MIN_YEAR')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
                ...
                <div class="col-lg-1 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="MAX_GRATUITY" id="MAX_GRATUITY" value="<?php echo e(old('MAX_GRATUITY')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
            ...
            <div class="row" style="margin-left: 244px;">
                ...
                <div class="col-lg-1 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="GRATUITY_DAYS" id="GRATUITY_DAYS" value="<?php echo e(old('GRATUITY_DAYS')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" />
            ...
            <div class="row" style="margin-left: 221px;">
                ...
                <div class="col-lg-1 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="GRATUITY_FIX" id="GRATUITY_FIX" value="<?php echo e(old('GRATUITY_FIX')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="width: 93px; margin-left: 21px;" />
    ...
    $(document).ready(function(){
     ...
     var formResponseMst = $( "#frm_mst_add" );
        ...
        function checkDuplicateCode(){
            ...
            $.ajax({
                url:'<?php echo e(route("master",[196,"codeduplicate"])); ?>',
                type:'POST',
                data:formData,
       ...
       window.fnSaveData = function (){
            ...
            $.ajax({
                url:'<?php echo e(route("master",[196,"save"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
       ...
       window.fnUndoYes = function (){
          ...
          //reload form
          window.location.href = "<?php echo e(route('master',[196,'add'])); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\GratuityMaster\mstfrm196add.blade.php ENDPATH**/ ?>