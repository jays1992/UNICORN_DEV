...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
              ...
              <input type="text" name="AFSNO" id="AFSNO" value="<?php echo e($objSE->AFP_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="AFSDT" id="AFSDT" onchange="checkPeriodClosing(220,this.value,1)" value="<?php echo e($objSE->AFP_DT); ?>" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
          </div>
    
    <div class="col-lg-1 pl"><p> Department	</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="DEPTID_NAME" id="DEPTID_NAME" value="<?php echo e($objSE->NAME); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
    ...
    <div class="col-lg-2 pl">
    <input type="text" name="FYID_NAME" id="FYID_NAME" value="<?php echo e($objSE->FYDESCRIPTION); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\AnnualForecastPurchase\trnfrm220edit.blade.php ENDPATH**/ ?>