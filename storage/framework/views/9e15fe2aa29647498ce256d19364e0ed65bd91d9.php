<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[48,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label> <?php echo e($objMst->VID); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objMst->VID); ?>" class="form-control" maxlength="50" >
			</div>
                            ...
                            <?php
                              ...
                              if(isset($row->FILESNAME) && !empty($row->FILESNAME)){
                                ...
                                if(in_array(strtolower(end($fileExt)), $viewArr) ){
                                  ...
                                  $docpath         =   "docs/company".Auth::user()->CYID_REF."/vendormst/".$row->FILESNAME;     
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorMaster\mstfrm48attachment.blade.php ENDPATH**/ ?>