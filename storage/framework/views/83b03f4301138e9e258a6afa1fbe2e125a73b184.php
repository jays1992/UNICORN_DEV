            ...
            <div id="TaskAllocation" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  <input type="hidden" name="TASKID_REF" id="TASK_REF" value="<?php echo e(isset($TASKALL->TASKID_REF) && $TASKALL->TASKID_REF !=''?$TASKALL->TASKID_REF:''); ?>" class="form-control mandatory" autocomplete="off" readonly>
                </div>
                ...
                <div class="col-lg-2 pl"><p>Assigned To*</p></div>
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="ASSIGNTOID_REF" id="ASSIGN_TO_REF_ID" value="<?php echo e(isset($TASKALL->TASK_ASSIGNTO_REF) && $TASKALL->TASK_ASSIGNTO_REF !=''?$TASKALL->TASK_ASSIGNTO_REF:''); ?>" class="form-control mandatory" autocomplete="off" readonly>                           
                  </div>
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="PRIORITYID_REF" id="PRIORITY_REF" value="<?php echo e(isset($TASKALL->PRIORITYID_REF) && $TASKALL->PRIORITYID_REF !=''?$TASKALL->PRIORITYID_REF:''); ?>" class="form-control mandatory" autocomplete="off" readonly>                           
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input <?php echo e($ActionStatus); ?> type="date" name="DUEDATE" id="DUE_DATE_ID" value="<?php echo e(isset($TASKALL->DUE_DATE) && $TASKALL->DUE_DATE !=''?$TASKALL->DUE_DATE:''); ?>" class="form-control mandatory" autocomplete="off">  
                  </div>
          
                  <div class="col-lg-2 pl"><p>Status*</p></div>
                    <div class="col-lg-2 pl">
                      <select <?php echo e($ActionStatus); ?> name="STATUSNAME" id="STATUS" class="form-control">
                    ...
                    <div class="col-lg-2 pl">
                      <input <?php echo e($ActionStatus); ?> type="date" name="REMINDERDATE" id="REMINDER" value="<?php echo e(isset($TASKALL->TASK_REMINDER_DATE) && $TASKALL->TASK_REMINDER_DATE !=''?$TASKALL->TASK_REMINDER_DATE:''); ?>" class="form-control mandatory" autocomplete="off"> 
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <textarea <?php echo e($ActionStatus); ?> class="form-control" name="TASKSUBJECT" id="TASK_SUBJECT" value="<?php echo e(isset($TASKALL->SUBJECT) && $TASKALL->SUBJECT !=''?$TASKALL->SUBJECT:''); ?>" style="width: 398px; height: 45px;"><?php echo e(isset($TASKALL->SUBJECT) && $TASKALL->SUBJECT !=''?$TASKALL->SUBJECT:''); ?></textarea>
                    </div>
      
                    <div class="col-lg-2 pl" style="margin-left: 206px;"><p>Task Detail*</p></div>
                    <div class="col-lg-2 pl">
                      <textarea <?php echo e($ActionStatus); ?> class="form-control" name="TASKDETAILS" id="TASK_DETAILS" value="<?php echo e(isset($TASKALL->TASK_DETAIL) && $TASKALL->TASK_DETAIL !=''?$TASKALL->TASK_DETAIL:''); ?>" style="width: 403px;height: 45px;"><?php echo e(isset($TASKALL->TASK_DETAIL) && $TASKALL->TASK_DETAIL !=''?$TASKALL->TASK_DETAIL:''); ?></textarea>
                    </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PreSales\TaskAllocation\trnfrm484edit.blade.php ENDPATH**/ ?>