...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_so_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("transactionmodify",[38,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> <?php echo e($objSalesorder->SONO); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objSalesorder->SOID); ?>" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> <?php echo e(date("d/m/Y", strtotime($objSalesorder->INDATE) )); ?> </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='<?php echo e(date("Y-m-d", strtotime($objSalesorder->INDATE))); ?>'   />
              ...
              <th width="15%">View / Download</th>
						...
						<tbody>
                            ...
                            <tr  class="participantRow">
                              ...
                              <?php else: ?>     
                              <td align="center" ><?php echo e($viewfile); ?><a class="btn" title="download" data-toggle="tooltip" data-docpath="<?php echo e(asset($docpath)); ?>" onclick="downloadfile($(this).data('docpath'))"><i class="fa fa-download"></i></a></td>
                              <?php endif; ?>
                            </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/SalesOrder/trnfrm38attachment.blade.php ENDPATH**/ ?>