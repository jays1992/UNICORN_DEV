...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Job Work GRN</a>
        </div>
      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="GRNNO" id="GRNNO" value="<?php echo e($objMstResponse->GRNNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <input type="hidden" name="GRJID" id="GRJID" value="<?php echo e($objMstResponse->GRJID); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
              
          <div class="col-lg-2 pl"><p>GRN Date</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="date" name="GRNDT" id="GRNDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($objMstResponse->GRNDT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-2 pl"><p>GE No</p></div>
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="TEXT_GEJWOID_REF_DATA" id="TEXT_GEJWOID_REF_DATA" value="<?php echo e($objMstResponse->GENO); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GEJWOID_REF" id="GEJWOID_REF" value="<?php echo e($objMstResponse->GEJWOID_REF); ?>" class="form-control" autocomplete="off" />
          </div> 
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="txtvendor_popup" id="txtvendor_popup" value="<?php echo e($objvendorcode2->VCODE); ?> - <?php echo e($objvendorcode2->NAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_CHALLAN_NO" id="VENDOR_CHALLAN_NO" value="<?php echo e($objMstResponse->VENDOR_CHALLANNO); ?>" class="form-control"  autocomplete="off" readonly  />
          </div>

          <div class="col-lg-2 pl"><p>Vendor Bill No</p></div>
          <div class="col-lg-2 pl">
              <input <?php echo e($ActionStatus); ?> type="text" name="VENDOR_BILL_NO" id="VENDOR_BILL_NO" value="<?php echo e($objMstResponse->VENDOR_BILLNO); ?>" class="form-control"  autocomplete="off" readonly  />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input <?php echo e($ActionStatus); ?> type="text" name="REMARKS" id="REMARKS" value="<?php echo e($objMstResponse->REMARKS); ?>" class="form-control"  autocomplete="off" />
          </div>
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="txtJWCID_popup_<?php echo e($key); ?>"   id="txtJWCID_popup_<?php echo e($key); ?>" value="<?php echo e($row->JWCNO); ?>" class="form-control" autocomplete="off" readonly style="width:130px;" /></td>
                    ...
                    <td hidden><input type="text"  name="PROID_REF_<?php echo e($key); ?>" id="PROID_REF_<?php echo e($key); ?>"value="<?php echo e($row->PROID_REF); ?>" class="form-control" autocomplete="off" /></td>
										...
										<td><input <?php echo e($ActionStatus); ?>	type="text"	name="popupMUOM_<?php echo e($key); ?>"	id="popupMUOM_<?php echo e($key); ?>"	value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"	class="form-control"  autocomplete="off"  readonly style="width:130px;" /></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="VENDOR_BATCHNO_<?php echo e($key); ?>" id="VENDOR_BATCHNO_<?php echo e($key); ?>" value="<?php echo e($row->VENDOR_BATCHNO); ?>" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="OURLOT_NO_<?php echo e($key); ?>" id="OURLOT_NO_<?php echo e($key); ?>" value="<?php echo e($row->OURLOT_NO); ?>" class="form-control"   autocomplete="off" style="width:130px;"   /></td>


                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="QTY_<?php echo e($key); ?>" id="QTY_<?php echo e($key); ?>" value="<?php echo e($row->JWC_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:130px;text-align:right;"  /></td>
                    
                    <td align="center"><a <?php echo e($ActionStatus); ?> class="btn checkstore" onclick="getStore(this.id)"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
                    <td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_QTY); ?>" ></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="PD_OR_QTY_<?php echo e($key); ?>" id="PD_OR_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  onKeyup="get_materital_item()" style="width:130px;text-align:right;"  /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="BL_SOQTY_<?php echo e($key); ?>" id="BL_SOQTY_<?php echo e($key); ?>" value="<?php echo e(floatval($row->SHORT_QTY)); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:130px;text-align:right;"  /></td>

                    <td ><input <?php echo e($ActionStatus); ?> type="text"   name="ITEMRATE_<?php echo e($key); ?>" id="ITEMRATE_<?php echo e($key); ?>" class="form-control five-digits" value="<?php echo e($row->RATE); ?>" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                    <td ><input <?php echo e($ActionStatus); ?> type="text"   name="ITEMAMT_<?php echo e($key); ?>" id="ITEMAMT_<?php echo e($key); ?>" class="form-control two-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>

                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="STORE_NAME_<?php echo e($key); ?>" id="STORE_NAME_<?php echo e($key); ?>" value="<?php echo e($row->STORE_NAME); ?>" class="form-control"   autocomplete="off" style="width:200px;" readonly /></td>
                       
                    <td ><input <?php echo e($ActionStatus); ?> type="text"   name="JWRATE_<?php echo e($key); ?>" id="JWRATE_<?php echo e($key); ?>" class="form-control five-digits" value="<?php echo e($row->JWRATE); ?>" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"   /></td>
                    <td ><input <?php echo e($ActionStatus); ?> type="text"   name="JWAMT_<?php echo e($key); ?>" id="JWAMT_<?php echo e($key); ?>" class="form-control two-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>

                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e($row->REMARKS); ?>" class="form-control"   autocomplete="off" style="width:130px;"   /></td>
                    <td ><input <?php echo e($ActionStatus); ?> type="text"   name="TOT_AMT_<?php echo e($key); ?>" id="TOT_AMT_<?php echo e($key); ?>" class="form-control three-digits"   value="0.00" readonly maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>

                    <td hidden><input type="text"   name="MAINTROWID_<?php echo e($key); ?>" id="MAINTROWID_<?php echo e($key); ?>" class="form-control " value="<?php echo e($mitem_id); ?>"   /></td>
                      ...
                      <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                          ...
                          <tbody>
                            ...
                            <tr  class="participantRow4">
                              ...
                              <td hidden>
                                <input type="text" name='<?php echo e("udffie_".$udfkey); ?>' id='<?php echo e("hdnudffie_popup_".$udfkey); ?>' value="<?php echo e($udfrow->UDFGRJID); ?>" class="form-control" maxlength="100" />
                              </td>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
      ...
      <table id="SECOND_GEJWOID_REF_TABLE" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody>
        <?php $__currentLoopData = $objGEList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_GEJWOID_REF[]" id="ROW_GEJWOID_REF_ID_<?php echo e($key); ?>" class="CLASS_GEJWOID_REF_ID" value="<?php echo e($val-> DOC_ID); ?>" ></td>   
          <td class="ROW2"><?php echo e($val-> DOC_CODE); ?> <input type="hidden" id="txtROW_GEJWOID_REF_ID_<?php echo e($key); ?>" data-desc="<?php echo e($val-> DOC_CODE); ?>" data-desc2="<?php echo e($val-> VID_REF); ?>" data-desc3="<?php echo e($val-> SGLCODE); ?> - <?php echo e($val-> SLNAME); ?>" data-desc4="<?php echo e($val-> VENDOR_CHALLANNO); ?>" data-desc5="<?php echo e($val-> VENDOR_BILLNO); ?>"  value="<?php echo e($val-> DOC_ID); ?>"/></td>
...
function validateForm(saveAction){
  ...
  if(GRNNO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#GRNDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkGrn\trnfrm357edit.blade.php ENDPATH**/ ?>