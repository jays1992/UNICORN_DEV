...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("mastermodify",[198,"update"])); ?>',
      type:'POST',
      data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\RoleMaster\mstfrm198edit.blade.php ENDPATH**/ ?>