...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="text" name="JV_NO" id="JV_NO" value="<?php echo e($objJV->JV_NO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
         </div>
        <div class="col-lg-1 pl col-md-offset-1"><p>JV Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="<?php echo e($objJV->JV_DT); ?>" onchange="checkPeriodClosing(169,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-1 pl"><p> Reverse	</p></div> 
        <div class="col-lg-1 pl">
                  <input type="checkbox" name="REVERSE" id="REVERSE" <?php echo e($objJV->REVERSE == 1 ? 'checked' : ''); ?> />
        </div>
        <div class="col-lg-1 pl"><p>Reverse Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="REVERSE_DT" id="REVERSE_DT" value="<?php echo e($objJV->REVERSE_DT); ?>" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    <div class="row">
        <div class="col-lg-1 pl"><p>Remarks</p></div>
        <div class="col-lg-5 pl">
            <input type="text" name="REMARKS" id="REMARKS" class="form-control" value="<?php echo e($objJV->REMARKS); ?>"  autocomplete="off"   />
        </div>
        <div class="col-lg-1 pl"><p>Source Doc No</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="SOURCE_DOCNO" id="SOURCE_DOCNO" class="form-control"  value="<?php echo e($objJV->SOURCE_DOCNO); ?>"   autocomplete="off" disabled  />
        </div>
        
        <div class="col-lg-1 pl"><p>Source Doc Date</p></div>
        <div class="col-lg-2 pl">
            <input type="date" name="SOURCE_DOCDT" id="SOURCE_DOCDT" autocomplete="off"  value="<?php echo e($objJV->SOURCE_DOCDT); ?>"  class="form-control"disabled  >
        </div>
    </div>
    <div class="row">
          <div class="col-lg-1 pl"><p>Common Narration</p></div>
          <div class="col-lg-5 pl">
              <input type="text" name="NARRATION" id="NARRATION" class="form-control"  value="<?php echo e($objJV->NARRATION); ?>"   autocomplete="off"  />                          
          </div>                            
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\JournalVoucher\trnfrm169amendment.blade.php ENDPATH**/ ?>