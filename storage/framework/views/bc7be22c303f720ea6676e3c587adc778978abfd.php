    ...
    // $('[id*="txtlabel"]').blur(function(){
     $('#example2').on('blur','[id*="txtlabel"]',function(){
      ...
      if(LABEL ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[114,"checkLabel"])); ?>',
            type:'POST',
            data:formData,
...
//add row
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[114,'add'])); ?>";
...
$.ajax({
    url:'<?php echo e(route("master",[114,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\UDFQID\mstfrm114add.blade.php ENDPATH**/ ?>