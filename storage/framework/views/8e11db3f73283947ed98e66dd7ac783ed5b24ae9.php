          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-7 pl">
                        <input type="text" name="FYCODE" id="FYCODE" value="<?php echo e(old('FYCODE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="6" tabindex="1" style="text-transform:uppercase" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 pl">
                    <input type="text" name="FYDESCRIPTION" id="FYDESCRIPTION" class="form-control mandatory" value="<?php echo e(old('FYDESCRIPTION')); ?>" maxlength="30" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                      ...
                      <select name="FYSTMONTH" id="FYSTMONTH" class="form-control mandatory" tabindex="3">
                        ...
                        <option value="<?php echo e($MonthList->MTCODE); ?>"><?php echo e($MonthList->MTCODE); ?></option>
                  ...
                  <div class="col-lg-1 pl">
                      ...
                      <select name="FYSTYEAR" id="FYSTYEAR" class="form-control mandatory" tabindex="4">
                        ...
                        <option value="<?php echo e($YearList->YRCODE); ?>"><?php echo e($YearList->YRCODE); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[123,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[123,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[123,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\FinancialYear\mstfrm123add.blade.php ENDPATH**/ ?>