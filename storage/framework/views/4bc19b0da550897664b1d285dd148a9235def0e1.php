      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="JWCNO" id="JWCNO" value="<?php echo e($objMstResponse->JWCNO); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <input disabled type="hidden" name="JWCID" id="JWCID" value="<?php echo e($objMstResponse->JWCID); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
              
          <div class="col-lg-2 pl"><p>JWO Date</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="date" name="JWCDT" id="JWCDT" value="<?php echo e($objMstResponse->JWCDT); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input disabled type="text" name="txtJWOID_popup_<?php echo e($key); ?>"   id="txtJWOID_popup_<?php echo e($key); ?>" value="<?php echo e($row->JWONO); ?>" class="form-control" autocomplete="off" readonly style="width:100px;" /></td>
                    ...
                    <td hidden><input type="text"  name="SOID_REF_<?php echo e($key); ?>"  id="SOID_REF_<?php echo e($key); ?>" value="<?php echo e($row->SOID_REF); ?>" class="form-control" autocomplete="off" /></td>   
										...
										<td hidden><input disabled  type="text" name="ITEMID_REF_<?php echo e($key); ?>"  id="ITEMID_REF_<?php echo e($key); ?>"  value="<?php echo e($row->ITEMID_REF); ?>" class="form-control" autocomplete="off" /></td>
										...
										<td><input disabled type="text"   name="QTY_<?php echo e($key); ?>" 		id="QTY_<?php echo e($key); ?>" 		value="<?php echo e($row->JW_PRODUCE_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input disabled type="text"   name="BL_SOQTY_<?php echo e($key); ?>" 	id="BL_SOQTY_<?php echo e($key); ?>" value="<?php echo e($row->JW_PRODUCE_QTY); ?>"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input disabled type="text"   name="PD_OR_QTY_<?php echo e($key); ?>" 	id="PD_OR_QTY_<?php echo e($key); ?>" value="<?php echo e($row->JW_PRODUCE_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="<?php echo e($mitem_id); ?>" onKeyup="get_materital_item()"  /></td>
                    ...
                    <td hidden><input disabled type="text"   name="MAINTROWID_<?php echo e($key); ?>" id="MAINTROWID_<?php echo e($key); ?>" class="form-control " value="<?php echo e($mitem_id); ?>" style="width:100px;"  /></td>
                  ...
                  <?php
                      ...
                      <tr>
                        ...
                        echo '<td hidden ><input type="hidden" name="TotalHiddenQty_'.$index.'" id="TotalHiddenQty_'.$index.'" value="'.$row_data['JWC_QTY'].'"  ></td>';
                        echo '<td hidden ><input type="hidden" name="HiddenRowId_'.$index.'" id="HiddenRowId_'.$index.'"  value="'.$row_data['BATCH_QTY_REF'].'" ></td>';

                        echo '<td hidden><input    type="text" name="REQ_JWC_QTY_'.$index.'" id="REQ_STD_BOM_QTY_'.$index.'" value="'.$row_data['STD_BOM_QTY'].'"   class="form-control" readonly /></td>';
...
$('#btnPdf').on('click', function() {
  var JWCID = objSO.JWCID;
  var Flag = 'P';
  var formData = 'SO='+ JWCID + '&JWCID='+ JWCID + '&Flag='+ Flag ;
  var consultURL = '<?php echo e(route("transaction",[355,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[355,"ViewReport"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkChallan\trnfrm355view.blade.php ENDPATH**/ ?>