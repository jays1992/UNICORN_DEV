...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Quality Inspection (QI)</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QIGNO" id="QIGNO" VALUE="<?php echo e(isset($HDR->QIGNO)?$HDR->QIGNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>Quality Inspection Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="QIGDT" id="QIGDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" VALUE="<?php echo e(isset($HDR->QIGDT)?$HDR->QIGDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>

            <div class="col-lg-2 pl"><p>QC Process By</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="QC_PROCESS_BY_popup" id="txtQC_PROCESS_BY_popup" VALUE="<?php echo e(isset($HDR->EMP_CODE_DES)?$HDR->EMP_CODE_DES:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl"><p>External Lab Name</p></div>
			      <div class="col-lg-2 pl">
              <input type="text" name="EXT_LABNAME" id="EXT_LABNAME" VALUE="<?php echo e(isset($HDR->EXT_LABNAME)?$HDR->EXT_LABNAME:''); ?>" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>Ref Doc No</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REF_DOCNO" id="REF_DOCNO" VALUE="<?php echo e(isset($HDR->REF_DOCNO)?$HDR->REF_DOCNO:''); ?>" class="form-control"  autocomplete="off"/>
			      </div>

            <div class="col-lg-2 pl"><p>GRN No</p></div>
            <div class="col-lg-2 pl">
            <input type="text" name="TEXT_GRNID_REF_DATA" id="TEXT_GRNID_REF_DATA" VALUE="<?php echo e(isset($HDR->GRN_NO)?$HDR->GRN_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="popupITEMID" id="popupITEMID" VALUE="<?php echo e(isset($HDR->ITEM_CODE_NAME)?$HDR->ITEM_CODE_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="GRN_REC_QTY" id="GRN_REC_QTY" VALUE="<?php echo e(isset($HDR->GRN_REC_QTY)?$HDR->GRN_REC_QTY:''); ?>" class="form-control"  autocomplete="off" readonly />
          </div>

          <div class="col-lg-2 pl"><p>UOM</p></div>
          <div class="col-lg-2 pl">
            <input type="text" name="TEXT_UOMID_REF_DATA" id="TEXT_UOMID_REF_DATA" VALUE="<?php echo e(isset($HDR->UOM_CODE_DES)?$HDR->UOM_CODE_DES:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QI_PICK_QTY" id="QI_PICK_QTY" VALUE="<?php echo e(isset($HDR->QI_PICK_QTY)?$HDR->QI_PICK_QTY:''); ?>" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Rejected Qty</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REJECTED_QTY" id="REJECTED_QTY" VALUE="<?php echo e(isset($HDR->REJECTED_QTY)?$HDR->REJECTED_QTY:''); ?>" class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="REJECTED_STID_REF_popup" id="REJECTED_STID_REF_popup" VALUE="<?php echo e(isset($HDR->REJECTED_STORE)?$HDR->REJECTED_STORE:''); ?>" class="form-control mandatory"  autocomplete="off" readonly onclick="store('REJECTED_STID_REF');" />
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QC_OK_QTY" id="QC_OK_QTY" VALUE="<?php echo e(isset($HDR->QC_OK_QTY)?$HDR->QC_OK_QTY:''); ?>"  class="form-control"  autocomplete="off" onkeyup="validateQty(this.id)" onkeypress="return isNumberDecimalKey(event,this)" />
            </div>

            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="QC_OK_STID_REF_popup" id="QC_OK_STID_REF_popup" VALUE="<?php echo e(isset($HDR->QC_OK_STORE)?$HDR->QC_OK_STORE:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('QC_OK_STID_REF');" />
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="PENDING_QC_QTY" id="PENDING_QC_QTY" VALUE="<?php echo e(isset($HDR->PENDING_QC_QTY)?$HDR->PENDING_QC_QTY:''); ?>"  class="form-control"  autocomplete="off" readonly />
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl"><p>Store</p></div>
            <div class="col-lg-2 pl">
              <input type="text" name="PENDING_QC_STID_REF_popup" id="PENDING_QC_STID_REF_popup" VALUE="<?php echo e(isset($HDR->PENDING_QC_STORE)?$HDR->PENDING_QC_STORE:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly onclick="store('PENDING_QC_STID_REF');" />
...
function validateForm(saveAction){
  ...
  if(parseFloat(QI_PICK_QTY) > parseFloat(GRN_REC_QTY)){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#QIGDT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Quality\QualityInspection\trnfrm362edit.blade.php ENDPATH**/ ?>