    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-8 topnav-pd">
                        ...
                        <a href="<?php echo e(route('master',[4,'index'])); ?>" class="btn topnavbt"><i class="fa fa-print"></i> Print</a>
                        <a href="<?php echo e(route('master',[4,'show',212])); ?>" class="btn topnavbt"><i class="fa fa-undo"></i> Undo</a>
                        <a href="<?php echo e(route('master',[5,'index'])); ?>" class="btn topnavbt"><i class="fa fa-times"></i> Cancel</a>
                        <a href="<?php echo e(route('master',[5,'show',222])); ?>" class="btn topnavbt"><i class="fa fa-thumbs-o-up"></i> Approved</a>
        ...
        // Data table for serverside
         var mstcountryTable =  $('#countrymst').DataTable({
            ...
            "ajax":{
                     ...
                     "url": "<?php echo e(route('masters.getcountries')); ?>",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\country.blade.php ENDPATH**/ ?>