  ...
  <form id="frm_mst_edit" method="POST"  > 
    ...
    <div class="inner-form">
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="QICDT" id="QICDT" value="<?php echo e(isset($HDR->QICDT)?$HDR->QICDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
        
        <div class="col-lg-1 pl"><p>Item</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="popupITEMID" id="popupITEMID" value="<?php echo e(isset($HDR->ICODE)?$HDR->ICODE:''); ?> <?php echo e(isset($HDR->ITEM_NAME)? ' - '.$HDR->ITEM_NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
...
function checkDuplicateCode(){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[361,"checkduplicate"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Quality\QualityInspectionMaster_17082022\mstfrm361edit.blade.php ENDPATH**/ ?>