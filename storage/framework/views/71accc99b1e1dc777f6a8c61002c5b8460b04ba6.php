  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <?php if(!empty($objDataList)): ?>           
            ...
            ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->BDSL_ID); ?>" value="<?php echo e($val->BDSL_ID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->BDSL_DATE) && $val->BDSL_DATE !='' && $val->BDSL_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BDSL_DATE)):''); ?>" ></td>
          <td><?php echo e(isset($val->BDSL_NO) && $val->BDSL_NO !=''?$val->BDSL_NO:''); ?></td>
          <td><?php echo e(isset($val->BDSL_DATE) && $val->BDSL_DATE !='' && $val->BDSL_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BDSL_DATE)):''); ?></td>
          <td><?php echo e(isset($val->BDCL_NO) && $val->BDCL_NO !=''?$val->BDCL_NO:''); ?></td>
          <td><?php echo e(isset($val->BDCL_DATE) && $val->BDCL_DATE !='' && $val->BDCL_DATE !='1900-01-01' ? date('d-m-Y',strtotime($val->BDCL_DATE)):''); ?></td>
          <td><?php echo e(isset($val->BREAKDOWN_STATUS) && $val->BREAKDOWN_STATUS !=''?$val->BREAKDOWN_STATUS:''); ?></td>
          <td><?php echo e(isset($val->COMPLAINT_BY) && $val->COMPLAINT_BY !=''?$val->COMPLAINT_BY:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\Break_down_Solution\trnfrm365.blade.php ENDPATH**/ ?>