      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <select <?php echo e($ActionStatus); ?> name="REGCITYID_REF" id="REGCITYID_REF" class="form-control mandatory">
            <option <?php echo e(isset($HDR->REGCITYID_REF) && $HDR->REGCITYID_REF == $HDR->REGCITYID_REF?'selected="selected"':''); ?> value="<?php echo e($HDR->REGCITYID_REF); ?>"><?php echo e($HDR->CITNAME); ?></option>
          </select> 
        </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <select <?php echo e($ActionStatus); ?> name="CORPCITYID_REF" id="CORPCITYID_REF" class="form-control mandatory">
                    <option <?php echo e(isset($MAT->CORPCITYID_REF) && $MAT->CORPCITYID_REF == $MAT->CORPCITYID_REF?'selected="selected"':''); ?> value="<?php echo e($MAT->CORPCITYID_REF); ?>"><?php echo e($MAT->CORCITNAME); ?></option>
                  </select> 
                </div>
...
$(document).ready(function(){
  ...
  getstate('<?php echo e(isset($MAT->CORPCTRYID_REF)?$MAT->CORPCTRYID_REF:''); ?>','CORPSTID_REF','CORPCITYID_REF','<?php echo e(isset($MAT->CORPSTID_REF)?$MAT->CORPSTID_REF:''); ?>');
  getcity('<?php echo e(isset($MAT->CORPSTID_REF)?$MAT->CORPSTID_REF:''); ?>','CORPCITYID_REF','<?php echo e(isset($MAT->CORPCITYID_REF)?$MAT->CORPCITYID_REF:''); ?>');
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\ProspectMaster\mstfrm441edit.blade.php ENDPATH**/ ?>