            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="SODT" id="SODT" onchange='checkPeriodClosing(156,this.value,1),getDocNoByEvent("SONO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" onkeyup="getDueDate(this.id,this.value)" autocomplete="off"/>
                            </div>       
                        </div>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr  class="participantRow">
                                                    ...
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCPER_0" id="DISCPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;"  onkeypress="return isNumberDecimalKey(event,this)"/></td>
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISCOUNT_AMT_0" id="DISCOUNT_AMT_0" style="width:130px;text-align:right;" class="form-control two-digits" maxlength="15"  autocomplete="off"  onkeypress="return isNumberDecimalKey(event,this)" /></td>
    ...
    //to check the label duplicacy
     $('#SONO').focusout(function(){
      ...
      if(SONO ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[156,"checkso"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
...
//SO Date Check
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('transaction',[156,'add'])); ?>";
...
$.ajax({
    url:'<?php echo e(route("transaction",[156,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesServiceInvoice\trnfrm156add.blade.php ENDPATH**/ ?>