              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <?php if($objDD->SYSTEM_GRSR == "1"): ?>
                        <input type="text" name="ICODE" id="ICODE" value="<?php echo e($objDOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="10" autocomplete="off" readonly style="text-transform:uppercase"   >
                    
                    <?php elseif($objDD->MANUAL_SR == "1"): ?>
                        <input type="text" name="ICODE" id="ICODE" value="<?php echo e(old('ICODE')); ?>" class="form-control mandatory"  maxlength="<?php echo e($objDD->MANUAL_MAXLENGTH); ?>" tabindex="1" autocomplete="off" style="text-transform:uppercase"   >
                    <?php else: ?>
...
$( "#btnSaveItem" ).click(function() {
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\ItemMasters\mstfrm72copy.blade.php ENDPATH**/ ?>