<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Task Type</a>
                </div>
          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> <?php echo e($objResponse->TASK_TYPECODE); ?> </label>
                    <input type="hidden" name="TASK_TYPECODE" id="TASK_TYPECODE" value="<?php echo e($objResponse->ID); ?>" />
                    <input type="hidden" name="TASK_TYPECODE" id="TASK_TYPECODE" value="<?php echo e($objResponse->TASK_TYPECODE); ?>" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input <?php echo e($ActionStatus); ?> type="text" name="TASK_TYPENAME" id="TASK_TYPENAME" class="form-control mandatory" value="<?php echo e(old('TASK_TYPENAME',$objResponse->TASK_TYPENAME)); ?>" maxlength="200" tabindex="1"  />
                  </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\TaskType\mstfrm434edit.blade.php ENDPATH**/ ?>