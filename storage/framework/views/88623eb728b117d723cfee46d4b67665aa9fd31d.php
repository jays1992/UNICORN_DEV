            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                            <div class="col-lg-2 pl">
                                ...
                                <input <?php echo e($ActionStatus); ?> type="text" name="DOCNO" id="DOCNO" value="<?php echo e(isset($objPSE->PSENO)?$objPSE->PSENO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                                                                              
                       
                            </div>


                    <input type="hidden" name="PSEID" value="<?php echo e(isset($objPSE->PSEID)?$objPSE->PSEID:''); ?>">

          
                    <div class="col-lg-2 pl"><p>Date</p></div>
                    <div class="col-lg-2 pl">
                    <input type="hidden" id="objlastPSEDT"  value="<?php echo e(isset($objPSE->PSEDT)?$objPSE->PSEDT:''); ?>">
                                <input <?php echo e($ActionStatus); ?> type="date" name="PSEDT" id="PSEDT" onchange="checkPeriodClosing(311,this.value,1)" value="<?php echo e(old('PSEDT')); ?>" value="<?php echo e(isset($objPSE->PSEDT)?$objPSE->PSEDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>

                    <div class="col-lg-2 pl"><p>Time</p></div>
        <div class="col-lg-2 pl">
          <input type="time" name="TIME" id="TIME" <?php echo e($ActionStatus); ?> value="<?php echo e($TIME); ?>" class="form-control mandatory"  placeholder="" >
          <span class="text-danger" id="ERROR_TIME"></span>
                ...
                <div class="col-lg-2 pl"><p>From Store</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="FromStore_popup" id="txtFromStore_popup" class="form-control mandatory"  autocomplete="off" value="<?php echo e(isset($objPSE->STCODE)?$objPSE->STCODE:''); ?>-<?php echo e(isset($objPSE->NAME)?$objPSE->NAME:''); ?>"  readonly/>
                                <input type="hidden" name="FROMSTOREID_REF" id="FROMSTOREID_REF" value="<?php echo e(isset($objPSE->STID_REF)?$objPSE->STID_REF:''); ?>" class="form-control" autocomplete="off" />
                            </div>  
                ...
                <div class="col-lg-2 pl"><p>Actual Physical Stock taking By</p></div>
                            ...
                            <input type="text" <?php echo e($ActionStatus); ?> name="TAKING_BY" id="TAKING_BY" value="<?php echo e(isset($objPSE->ACTUAL_STOCK_TAKEN_BY)?$objPSE->ACTUAL_STOCK_TAKEN_BY:''); ?>" class="form-control mandatory"  autocomplete="off" >
                            </div>  
            ...
            <div class="col-lg-2 pl"><p>Item Group</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" <?php echo e($ActionStatus); ?> name="ItemGID_popup" id="txtItemGID_popup" value="<?php echo e(isset($objPSE->GROUPCODE)?$objPSE->GROUPCODE:''); ?>-<?php echo e(isset($objPSE->GROUPNAME)?$objPSE->GROUPNAME:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                                <input type="hidden" name="ITEMGID_REF" id="ITEMGID_REF" value="<?php echo e(isset($objPSE->ITEMGID_REF)?$objPSE->ITEMGID_REF:''); ?>" class="form-control" autocomplete="off" />
                            ...
                            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height: 380px; margin-top: 10px;">
                                <table id="example3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height: auto !important;">
                                    <thead id="thead2" style="position: sticky; top: 0;">
                                        <tr>
                                        <th>Item Code <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e(count($objPSEMAT)); ?>"></th>
                                            <th>Item Name</th>
                                            <th>UOM</th>
                                    ...
                                    <tbody>
                                    <?php if(!empty($objPSEMAT)): ?>
                                    <?php $__currentLoopData = $objPSEMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$objPSEMAT_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <?php
                      $variance= number_format($objPSEMAT_list->PHYSICAL_STOCK_QTY-$objPSEMAT_list->STOCK_IN_HAND_QTY,2, '.', '');
                                    

                                    ?>                           

                                        <tr class="participantRow1">
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name="MainItemCode1_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->ICODE); ?>" id="MainItemCode1_<?php echo e($key); ?>"  class="form-control" autocomplete="off" readonly /></td>
                                            <td hidden><input type="hidden" name="MainItemId1_Ref_<?php echo e($key); ?>" id="MainItemId1_Ref_<?php echo e($key); ?>" class="form-control" value="<?php echo e($objPSEMAT_list->ITEMID_REF); ?>" autocomplete="off" />
                                            <input type="text" name="rowscount1[]" /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name="MainItemName1_<?php echo e($key); ?>" id="MainItemName1_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->NAME); ?>" class="form-control" autocomplete="off" readonly /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name="UOM_<?php echo e($key); ?>" id="UOM_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->UOMCODE); ?>-<?php echo e($objPSEMAT_list->DESCRIPTIONS); ?>"  class="form-control" readonly autocomplete="off" /></td>
                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($objPSEMAT_list->ALPS_PART_NO)?$objPSEMAT_list->ALPS_PART_NO:''); ?>" readonly/></td>
                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off" value="<?php echo e(isset($objPSEMAT_list->CUSTOMER_PART_NO)?$objPSEMAT_list->CUSTOMER_PART_NO:''); ?>" readonly/></td>
                                            <td <?php echo e($AlpsStatus['hidden']); ?>><input type="text" name="OEMpartno_<?php echo e($key); ?>"  id="OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  value="<?php echo e(isset($objPSEMAT_list->OEM_PART_NO)?$objPSEMAT_list->OEM_PART_NO:''); ?>" readonly/></td>
                                            <td hidden><input type="text" name="UOM_REF_<?php echo e($key); ?>" id="UOM_REF_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->UOMID_REF); ?>" maxlength="12" class="form-control" readonly autocomplete="off" /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name="STOCK_IN_HAND_<?php echo e($key); ?>" id="STOCK_IN_HAND_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->STOCK_IN_HAND_QTY); ?>"  maxlength="20" readonly class="form-control" autocomplete="off" /></td>
                                            <td><input type="text" <?php echo e($ActionStatus); ?> name="PHYSICAL_<?php echo e($key); ?>" id="PHYSICAL_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->PHYSICAL_STOCK_QTY); ?>" class="form-control" maxlength="20" autocomplete="off"  /></td>
                                            <td><input type="text" <?php echo e($ActionStatus); ?> name="VARIANCE_<?php echo e($key); ?>" id="VARIANCE_<?php echo e($key); ?>" value="<?php echo e($variance); ?>" class="form-control" maxlength="20" autocomplete="off"  /></td>
                                            <td><input <?php echo e($ActionStatus); ?> type="text" name="REASON_<?php echo e($key); ?>" id="REASON_<?php echo e($key); ?>" value="<?php echo e($objPSEMAT_list->REASON_DISCREPANCY); ?>" class="form-control"  autocomplete="off" /></td>
                                            <td align="center">
 ...
 if(intRegex.test(variance)){
  ...
  $("#VARIANCE_"+rowids).val(''); 
    ...
    $(document).ready(function(e) {
      ...
      // $('#PSEDT').val(today);
      //$objPSE->PSEDT
      var lastdt = <?php echo json_encode($objPSE->PSEDT); ?>;
      var pse = <?php echo json_encode($objPSE); ?>;
      var today = new Date(); 
      var sodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
        if(lastdt < pse.PSEDT)
        {
        $('#PSEDT').attr('min',lastdt);
        }
        else
        {
          $('#PSEDT').attr('min',pse.PSEDT);
        }
        $('#PSEDT').attr('max',sodate);     
...
event.preventDefault();
  ...
  $.ajax({
      url:'<?php echo e(route("transactionmodify",[311,"Approve"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
        $("#btnApprove").show();  
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[311,"update"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
          $(".buttonload").hide(); 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\PhysicalStockEntry\trnfrm311edit.blade.php ENDPATH**/ ?>