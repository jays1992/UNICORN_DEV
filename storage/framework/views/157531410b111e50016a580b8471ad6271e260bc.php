<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnExit" <?php echo e(isset($objRights->ATTECHMENT) && $objRights->ATTECHMENT != 1 ? 'disabled' : ''); ?>><i class="fa fa-power-off"></i> Exit</button>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <tr>
                ...
                <td><?php echo e(isset($val->EMPLOYEE_TARGETCODE) && $val->EMPLOYEE_TARGETCODE !=''?$val->EMPLOYEE_TARGETCODE:''); ?></td>
                <td><?php echo e(isset($val->EMPCODE) && $val->EMPCODE !=''?$val->EMPCODE:''); ?>-<?php echo e(isset($val->FNAME) && $val->FNAME !=''?$val->FNAME:''); ?></td>
                <td><?php echo e(isset($val->EMPLOYEE_TYPE) && $val->EMPLOYEE_TYPE !=''?$val->EMPLOYEE_TYPE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PreSales\EmployeeTargetMaster\mstfrm435.blade.php ENDPATH**/ ?>