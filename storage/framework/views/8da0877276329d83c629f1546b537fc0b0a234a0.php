<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[16,'index'])); ?>" class="btn singlebt">Priority</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="prioritymst" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->PRIORITYID); ?>" value="<?php echo e($val->PRIORITYID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->PRIORITYCODE) && $val->PRIORITYCODE !=''?$val->PRIORITYCODE:''); ?></td>
        ...
        <form id="masterForm16Print" action="<?php echo e(route('mastergetlist',[16,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<style>
  #custom_dropdown, #prioritymst_filter {
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[16,"add"])); ?>';
  ...
  $(document).ready(function(){
        ...
        // Data table for serverside
         var mstresultTable =  $('#prioritymst').DataTable({
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[16,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[16,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[16,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[16,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                            window.location.href="<?php echo e(route('master',[16,'index'])); ?>";
                        }               
                    },
                    error:function(data){
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[16,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\Priority\mstfrm16.blade.php ENDPATH**/ ?>