...
<form id="frm_trn_edit"  method="POST">   
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="RGP_NO" id="RGP_NO" value="<?php echo e(isset($objResponse->RGP_NO) && $objResponse->RGP_NO !=''?$objResponse->RGP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="RGP_DT" id="RGP_DT" value="<?php echo e(isset($objResponse->RGP_DT) && $objResponse->RGP_DT !=''?$objResponse->RGP_DT:''); ?>" class="form-control mandatory" >
      </div>
    ...
    <div class="row">
      <div class="col-lg-1 pl"><p>Issue Type</p></div>
			<div class="col-lg-2 pl">
        <select <?php echo e($ActionStatus); ?> name="ISSUE_TYPE" id="ISSUE_TYPE" class="form-control"  autocomplete="off" >
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\ReturnableGatePass\trnfrm157view.blade.php ENDPATH**/ ?>