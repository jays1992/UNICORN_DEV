<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Asset Category</a>
                </div><!--col-2-->
...
//dd($objResponse);
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->ALID) ? method_field('PUT') : ''); ?>
                ...
                <div class="row">            
                  ...
                  <div class="col-lg-2 pl">
                    <select name="ASGID_REF" id="ASGID_REF" class="form-control mandatory" tabindex="4">
                      ...
                      <?php $__currentLoopData = $objAsetGrpCode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option <?php echo e(isset($objResponse->ASGID_REF) && $objResponse->ASGID_REF == $val-> ASGID ?'selected="selected"':''); ?> value="<?php echo e($val-> ASGID); ?>"><?php echo e($val->ASGCODE); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select> 
                    <input  class="form-control" type="hidden" name="ASCATID" name="ASCATID"  value="<?php echo e($objResponse->ASCATID); ?>" autocomplete="off">
                  ...
                  <div class="col-lg-2 pl">
                    <select name="ASTID_REF" id="ASTID_REF" class="form-control mandatory" tabindex="4">
                      <option value="" selected="">Select</option>
                      <?php $__currentLoopData = $objAsetType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option <?php echo e(isset($objResponse->ASTID_REF) && $objResponse->ASTID_REF == $val-> ASTID ?'selected="selected"':''); ?> value="<?php echo e($val-> ASTID); ?>"><?php echo e($val->ASSETTYPE); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>                                
                </div>
                      ...
                      <tr>   
                        ...
                        <tbody>
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input  class="form-control" type="text" name="SUBLCODE[]"   id =<?php echo e("SUBLCODE_0"); ?>  value="<?php echo e($HDRR->CATEGORY); ?>" autocomplete="off" style="width: 98%"></td>
                              <td><input  class="form-control" type="text" name="SUBLDES[]"   id =<?php echo e("SUBLDES_0"); ?>    value="<?php echo e($HDRR->DESCRIPTIONS); ?>" autocomplete="off" style="width: 98%"></td>
                              <td><select  name="INACTIVE[]" id =<?php echo e("INACTIVE_0"); ?> class="form-control mandatory" tabindex="4">
                                <option value="" selected >Select</option>
                                <option <?php echo e(isset($HDRR->ACTIVE) && $HDRR->ACTIVE == '1'?'selected="selected"':''); ?> value="1">Yes</option>
                                <option <?php echo e(isset($HDRR->ACTIVE) && $HDRR->ACTIVE == '0'?'selected="selected"':''); ?> value="0">No</option>                              
                              </select>
                              <td>
                              <input  class="form-control" type="date" name="INACTIVEDATE[]" id =<?php echo e("INACTIVEDATE_0"); ?>  value="<?php echo e($HDRR->ACTIVEDATE); ?>" autocomplete="off">
                              <td align="center" >
...
<script type="text/javascript">
  ...
  $(function() { 
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetCategory\mstfrm407edit.blade.php ENDPATH**/ ?>