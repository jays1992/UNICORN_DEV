          ...
          <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                      <div class="col-lg-10 pl">
                          <input type="text" name="AC_SET_CODE" id="AC_SET_CODE" onkeypress="return AlphaNumaric(event,this)"  value="<?php echo e(old('AC_SET_CODE')); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" required/>
                    ...
                    <div class="col-lg-4 pl">
                      <input type="text" name="AC_SET_DESC" id="AC_SET_DESC" class="form-control mandatory" value="<?php echo e(old('AC_SET_DESC')); ?>" maxlength="50" tabindex="4"  />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[167,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[167,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[167,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\PurchaseAccountSet\mstfrm167add.blade.php ENDPATH**/ ?>