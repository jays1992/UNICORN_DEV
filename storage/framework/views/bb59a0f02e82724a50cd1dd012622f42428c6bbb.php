...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Import Purchase Order(IPO)</a></div>
...
<div class="container-fluid purchase-order-view filter">     
  <form id="frm_import" method="post" enctype="multipart/form-data" action='<?php echo e(route("transactionmodify",[$FormId,"importexcelindb"])); ?>' > 
    <?php echo csrf_field(); ?>
    ...
    <div class="inner-form">
      ...
      <div class="col-lg-4 pl">
        <a href="<?php echo e(route("transactionmodify",[$FormId,"downloadExcelFormate"])); ?>"  >download</a>              
      </div>             
    </div>
    ...
    <?php endif; ?>
		...
		<div class="row">
			<div class="col-lg-6 pl">
                ...
                <input type="hidden" name="allow_max_size" id="allow_filesize" value='10'   />
...
<script>  
    ...
    function ValidateSize(file) {
                ...
                var allowSize = configAllowSize * 1024 * 1024;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\ImportPurchaseOrder\trnfrm299import.blade.php ENDPATH**/ ?>