...
<?php $__env->startSection('content'); ?>
    ...
    <form id="frm_trn_edit"  method="POST"> 
      <?php echo csrf_field(); ?>
      <?php echo e(isset($objHDR->IPO_ID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                <input disabled type="text" name="PII_NO" id="PII_NO" value="<?php echo e($objHDR->PII_NO); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
        </div>
        <div class="col-lg-2 pl"><p>IPO Date</p></div>
        <div class="col-lg-2 pl">
                  <input disabled type="date" name="PII_DT" id="PII_DT" value="<?php echo e($objHDR->PII_DT); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>

        <div class="col-lg-2 pl"><p>Vendor</p></div>
        <div class="col-lg-2 pl">
                <input disabled type="text" name="txtvendor" id="txtvendor" class="form-control" value="<?php echo e($objPBVID->VCODE); ?>-<?php echo e($objPBVID->NAME); ?>" readonly  />
                <input type="hidden" name="VID_REF" id="VID_REF"  class="form-control" value="<?php echo e($objHDR->VID_REF); ?>" />
        </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
          <input disabled type="checkbox" name="SOFC" id="SOFC" class="form-checkbox" <?php echo e($objHDR->FC == 1 ? 'checked' : ''); ?> >
      </div>
      
      <div class="col-lg-2 pl"><p>Currency</p></div>
      <div class="col-lg-2 pl" id="divcurrency" >
          <?php if(count($objsocurrency) > 0): ?>
          <input disabled type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off" value="<?php echo e($objsocurrency[0]); ?>" readonly   />
          <?php else: ?>
          <input disabled type="text" name="CRID_popup" id="txtCRID_popup" class="form-control"  autocomplete="off"   disabled/>
          <?php endif; ?>
          <input type="hidden" name="CRID_REF" id="CRID_REF" class="form-control" autocomplete="off"   value="<?php echo e($objHDR->CRID_REF); ?>" />
          
      </div>
      
      <div class="col-lg-2 pl"><p>Conversion Factor</p></div>
      <div class="col-lg-2 pl">
          <input disabled type="text" name="CONVFACT" id="CONVFACT" class="form-control" maxlength="100" autocomplete="off" value="<?php echo e($objHDR->CONV_FACTOR); ?>" />
      </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
                <input disabled type="text" name="VENDOR_INNO" id="VENDOR_INNO" value="<?php echo e($objHDR->VENDOR_INVOICE_NO); ?>" maxlength="30" class="form-control" autocomplete="off" />
        </div>
        <div class="col-lg-2 pl"><p>Vendor Invoice Date</p></div>
        <div class="col-lg-2 pl">
                <input disabled type="date" name="VENDOR_INDT" id="VENDOR_INDT" value="<?php echo e($objHDR->VENDOR_INVOICE_DT); ?>" class="form-control"  placeholder="dd/mm/yyyy"  />
        </div>
        <div class="col-lg-2 pl"><p>Bill To </p></div>
        <div class="col-lg-2 pl" id="div_billto">
            <input disabled type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e($objBillAddress[0]); ?>" readonly  />
            <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e($objHDR->BILL_TO); ?>" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl" id="div_shipto">
            <input disabled type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e($objShpAddress[0]); ?>"  readonly  />
            <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e($objHDR->SHIP_TO); ?>" />
            <input type="hidden" name="Tax_State" id="Tax_State" class="form-control" value="<?php echo e($TAXSTATE[0]); ?>" autocomplete="off" />
        </div>

        <div class="col-lg-2 pl"><p>Remarks</p></div>
        <div class="col-lg-6 pl">
            <input disabled type="text" name="REMARKS" id="REMARKS" autocomplete="off" class="form-control" value="<?php echo e($objHDR->REMARKS); ?>" maxlength="200"  >
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 pl">
        <select  disabled name="FOB" id="FOB" class="form-control" autocomplete="off" >
          <option <?php echo e(isset($objHDR) && $objHDR->FOB == "NO"?'selected="selected"':''); ?> value="NO">NO</option>
          <option <?php echo e(isset($objHDR) && $objHDR->FOB == "YES"?'selected="selected"':''); ?> value="YES">YES</option>
        </select>
      </div>

      <div class="col-lg-2 pl"><p>BOE No</p></div>
      <div class="col-lg-2 pl">
        <input disabled type="text" name="BOE_NO" id="BOE_NO" value="<?php echo e($objHDR->BOE_NO); ?>" class="form-control" autocomplete="off" >
      </div>

      <div class="col-lg-2 pl"><p>BOE Date</p></div>
      <div class="col-lg-2 pl">
        <input disabled type="date" name="BOE_DT" id="BOE_DT" value="<?php echo e($objHDR->BOE_DT); ?>" class="form-control" autocomplete="off"  placeholder="dd/mm/yyyy" >
      </div>
	</div>
  ...
  <div class="row">	
		...
		<div class="col-lg-2 pl">
			<select disabled  name="IMPORT_DUTYID_REF" id="IMPORT_DUTYID_REF" class="form-control" autocomplete="off" >
				...
				<option <?php echo e(isset($objHDR) && $objHDR->IMPORT_DUTYID_REF == $val->IMPORT_DUTYID?'selected="selected"':''); ?>  value="<?php echo e($val->IMPORT_DUTYID); ?>"><?php echo e($val->IMPORT_DUTY_CODE); ?></option>
		...
		<div class="col-lg-2 pl">
			<input disabled type="text" name="REF_NO" id="REF_NO" value="<?php echo e($objHDR->REF_NO); ?>" class="form-control" maxlength="100" autocomplete="off" >
		</div>
		
        <div class="col-lg-2 pl"><p>Credit Days</p></div>
        <div class="col-lg-2 pl">
            <input disabled type="text" name="Credit_days" id="Credit_days" value="<?php echo e($objHDR->CREDIT_DAYS); ?>" onkeyup="getDueDate()" maxlength="200" class="form-control"  autocomplete="off"   />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input disabled type="date" name="DUE_DATE" id="DUE_DATE" class="form-control" value="<?php echo e($objHDR->DUE_DATE); ?>"  placeholder="dd/mm/yyyy"  />                        
        </div>

        <div class="col-lg-2 pl"><p>Total Amount</p></div>
        <div class="col-lg-2 pl">
            <input disabled type="text" name="tot_amt" id="tot_amt" class="form-control"  autocomplete="off" readonly  />
        </div>

        <div  class="col-lg-2 pl"><p>Reverse GST</p></div>
        <div  class="col-lg-1 pl">
            <input disabled type="checkbox" name="GST_Reverse" id="GST_Reverse"  <?php echo e($objHDR->REVERSE_GST == 1 ? 'checked' : ''); ?>    />                          
        </div>
    ...
    <div class="row">
        ...
        <div  class="col-lg-1 pl">
            <input disabled type="checkbox" name="GST_N_Avail" id="GST_N_Avail"  <?php echo e($objHDR->GST_INPUT_NOT_AVAIL == 1 ? 'checked' : ''); ?>   />
        </div> 
    </div>
      ...
      <div class="tab-content">
        ...
        <div id="Material" class="tab-pane fade in active">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                  ...
                  <tr>
                    <th rowspan="2">GRN No <input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objCount1); ?>" ></th>
                  ...
                  <tr>
                    ...
                    <?php if(!empty($objPBMAT)): ?>
                      <?php $__currentLoopData = $objPBMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><input disabled type="text" name="txtGRN_NO_<?php echo e($key); ?>" id="txtGRN_NO_<?php echo e($key); ?>" value="<?php echo e($row->GRN_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:120px;" /></td>
                        <td hidden><input type="hidden" name="GRNID_REF_<?php echo e($key); ?>" id="GRNID_REF_<?php echo e($key); ?>" value="<?php echo e($row->GRNID_REF); ?>" class="form-control" autocomplete="off" /></td>
                        <td hidden><input type="hidden" name="IPO_ID_REF_<?php echo e($key); ?>" id="IPO_ID_REF_<?php echo e($key); ?>" value="<?php echo e($row->IPO_ID_REF); ?>" class="form-control" autocomplete="off" /></td>
                      
                        <td><input disabled type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        ...
                        <td><input disabled type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_NAME); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="Itemspec_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off"  /></td>
                        
                        <td><input disabled type="text" name="popupMUOM_<?php echo e($key); ?>" id="popupMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="MAIN_UOMID_REF_<?php echo e($key); ?>" id="MAIN_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->MAIN_UOMID_REF); ?>" class="form-control"  autocomplete="off" /></td>
                        <td><input disabled type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e($row->RECEIVED_MAIN_QTY); ?>"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control three-digits" maxlength="13"  autocomplete="off" readonly  /></td>
                        <td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="popupAUOM_<?php echo e($key); ?>" id="popupAUOM_<?php echo e($key); ?>" value="<?php echo e($row->AULT_UOM_CODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name="ALT_UOMID_REF_<?php echo e($key); ?>" id="ALT_UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->ALT_UOMID_REF); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="ALT_UOMID_QTY_<?php echo e($key); ?>" id="ALT_UOMID_QTY_<?php echo e($key); ?>"  class="form-control three-digits" maxlength="13" autocomplete="off"  readonly/></td>
                      
                        <td><input disabled type="text" name="BILL_QTY_<?php echo e($key); ?>" id="BILL_QTY_<?php echo e($key); ?>" value="<?php echo e($row->BILL_QTY); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
                        <td><input disabled type="text" name="UOM_OF_BILL_QTY_<?php echo e($key); ?>" id="UOM_OF_BILL_QTY_<?php echo e($key); ?>"  value="<?php echo e($row->MAIN_UOM_CODE); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" readonly /></td>

                        <td><input disabled type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->RATE_ASP_MU); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control" maxlength="13"  autocomplete="off" /></td>
                        <td><input disabled type="text" name="DISC_PER_<?php echo e($key); ?>" id="DISC_PER_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_PER) > 0 ? $row->DISC_PER:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width: 50px;" /></td>
                        <td><input disabled type="text" name="DISC_AMT_<?php echo e($key); ?>" id="DISC_AMT_<?php echo e($key); ?>" value="<?php echo e(intval($row->DISC_AMT) > 0 ? $row->DISC_AMT:'0.00'); ?>" onkeyup="onChangeAmount(this.id,this.value)" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                        <td><input disabled type="text" name="DISAFTT_AMT_<?php echo e($key); ?>" id="DISAFTT_AMT_<?php echo e($key); ?>"  class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                        
                        <td><input disabled type="text" name="FREIGHT_AMT_<?php echo e($key); ?>"           id="FREIGHT_AMT_<?php echo e($key); ?>"            value="<?php echo e(intval($row->FREIGHT_AMT) > 0 ? $row->FREIGHT_AMT:'0.00'); ?>"      onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
                        <td><input disabled type="text" name="INSURANCE_AMT_<?php echo e($key); ?>"         id="INSURANCE_AMT_<?php echo e($key); ?>"          value="<?php echo e(intval($row->INSURANCE_AMT) > 0 ? $row->INSURANCE_AMT:'0.00'); ?>"  onkeyup="onChangeAmount(this.id,this.value)" class="form-control four-digits"   autocomplete="off"/></td>
                        <td><input disabled type="text" name="ASSESSABLE_VALUE_<?php echo e($key); ?>"      id="ASSESSABLE_VALUE_<?php echo e($key); ?>"       value="<?php echo e($row->ASSESSABLE_VALUE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_PER_<?php echo e($key); ?>"  value="<?php echo e($row->CUSTOME_DUTY_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>" id="CUSTOME_DUTY_RATE_AMT_<?php echo e($key); ?>"  value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="SWS_RATE_PER_<?php echo e($key); ?>"          id="SWS_RATE_PER_<?php echo e($key); ?>"           value="<?php echo e($row->SWS_RATE); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="SWS_RATE_AMT_<?php echo e($key); ?>"          id="SWS_RATE_AMT_<?php echo e($key); ?>"           value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"    id="TOTAL_CUSTOME_DUTY_<?php echo e($key); ?>"     value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="TAXABLE_VALUE_<?php echo e($key); ?>"         id="TAXABLE_VALUE_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="IGST_RATE_PER_<?php echo e($key); ?>"         id="IGST_RATE_PER_<?php echo e($key); ?>"          value="<?php echo e($row->IGST); ?>"  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="IGST_RATE_AMT_<?php echo e($key); ?>"         id="IGST_RATE_AMT_<?php echo e($key); ?>"          value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>
                        <td><input disabled type="text" name="VALUE_AFTER_GST_<?php echo e($key); ?>"       id="VALUE_AFTER_GST_<?php echo e($key); ?>"        value=""  class="form-control four-digits" readonly  autocomplete="off"/></td>

                        <td align="center" ><button disabled class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button> <button disabled class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                  ...
                  <?php if(!empty($objPBCAL)): ?>
                    <?php $__currentLoopData = $objPBCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr  class="participantRow5">
                            ...
                            <td style="text-align:center;" ><input disabled type="checkbox" class="filter-none" name=<?php echo e("calGST_".$Ckey); ?> id=<?php echo e("calGST_".$Ckey); ?> <?php echo e($Crow->GST == 1 ? 'checked' : ''); ?>   ></td>
                            
                            <td><input disabled type="text" name=<?php echo e("calIGST_".$Ckey); ?> id=<?php echo e("calIGST_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->IGST); ?>" readonly/></td>
                      <?php
                          $IGSTAMT=number_format((($Crow->VALUE*$Crow->IGST)/100),2, '.', '');
                      ?>        
                            <td><input disabled type="text" name=<?php echo e("AMTIGST_".$Ckey); ?> id=<?php echo e("AMTIGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($IGSTAMT); ?>"  readonly/></td>
                            <td><input disabled type="text" name=<?php echo e("calCGST_".$Ckey); ?> id=<?php echo e("calCGST_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->CGST); ?>" readonly/></td>
                      <?php
                          $CGSTAMT=number_format((($Crow->VALUE*$Crow->CGST)/100),2, '.', '');
                      ?>       
                            <td><input disabled type="text" name=<?php echo e("AMTCGST_".$Ckey); ?> id=<?php echo e("AMTCGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($CGSTAMT); ?>" readonly/></td>
                            <td><input  disabled type="text" name=<?php echo e("calSGST_".$Ckey); ?> id=<?php echo e("calSGST_".$Ckey); ?> class="form-control four-digits" maxlength="8" autocomplete="off" value="<?php echo e($Crow->SGST); ?>" readonly/></td>
                      <?php
                          $SGSTAMT=number_format((($Crow->VALUE*$Crow->SGST)/100),2, '.', '');
                      ?>
                            <td><input disabled type="text" name=<?php echo e("AMTSGST_".$Ckey); ?> id=<?php echo e("AMTSGST_".$Ckey); ?> class="form-control two-digits" maxlength="15" autocomplete="off" value="<?php echo e($SGSTAMT); ?>" readonly/></td>
                      <?php
                          $TOTGSTAMT=number_format(($IGSTAMT+$CGSTAMT+$SGSTAMT),2, '.', '');
                      ?>      
                            <td><input disabled type="text" name=<?php echo e("TOTGSTAMT_".$Ckey); ?> id=<?php echo e("TOTGSTAMT_".$Ckey); ?> class="form-control two-digits"  maxlength="15" autocomplete="off" value="<?php echo e($TOTGSTAMT); ?>" readonly/></td>
                            <td style="text-align:center;"><input disabled type="checkbox" class="filter-none" name=<?php echo e("calACTUAL_".$Ckey); ?> id=<?php echo e("calACTUAL_".$Ckey); ?>  <?php echo e($Crow->ACTUAL == 1 ? 'checked' : ''); ?> /></td>
                    ...
                    <tr  class="participantRow5">
                        ...
                        <td style="text-align:center;" ><input disabled type="checkbox" class="filter-none" name="calGST_0" id="calGST_0" value="" ></td>
                        <td><input disabled type="text" name="calIGST_0" id="calIGST_0" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="AMTIGST_0" id="AMTIGST_0" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="calCGST_0" id="calCGST_0" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="AMTCGST_0" id="AMTCGST_0" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="calSGST_0" id="calSGST_0" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="AMTSGST_0" id="AMTSGST_0" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                        <td><input disabled type="text" name="TOTGSTAMT_0" id="TOTGSTAMT_0" class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                    ...
                    <?php if(!empty($objPBPSLB)): ?>
                      <?php $__currentLoopData = $objPBPSLB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pkey => $Prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow6">
                              <td> <input disabled type="text" class="form-control" id=<?php echo e("PAY_DAYS_".$Pkey); ?> name=<?php echo e("PAY_DAYS_".$Pkey); ?> value="<?php echo e($Prow->PAY_DAYS); ?>" autocomplete="off"  /> </td>
                              <td> <input disabled type="text" class="form-control four-digits" id=<?php echo e("DUE_".$Pkey); ?> name=<?php echo e("DUE_".$Pkey); ?> value="<?php echo e($Prow->DUE); ?>" maxlength="8" autocomplete="off" /> </td>
                              <td> <input disabled type="text" class="form-control" id=<?php echo e("PSREMARKS_".$Pkey); ?> name=<?php echo e("PSREMARKS_".$Pkey); ?> value="<?php echo e($Prow->REMARKS); ?>" autocomplete="off"  /> </td>
                              <td> <input disabled type="text" class="form-control" id=<?php echo e("DUE_DATE_".$Pkey); ?> name=<?php echo e("DUE_DATE_".$Pkey); ?> value="<?php echo e($Prow->DUE_DATE); ?>" autocomplete="off"  /> </td>
                              
                              <td align="center" style="min-width: 100px;" ><button disabled class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button disabled class="btn remove" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                          </tr>
                          <tr></tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                      <?php else: ?>
                      <tr  class="participantRow6">
                              <td> <input disabled type="text" class="form-control" id="PAY_DAYS_0" name="PAY_DAYS_0"  autocomplete="off" /> </td>
                              <td> <input disabled type="text" class="form-control four-digits" id="DUE_0" name="DUE_0"  maxlength="8" autocomplete="off" /> </td>
                              <td> <input disabled type="text" class="form-control" id="PSREMARKS_0" name="PSREMARKS_0" autocomplete="off"  /> </td>
                              <td> <input disabled type="date" class="form-control" id="DUE_DATE_0" name="DUE_DATE_0" autocomplete="off"  readonly /> </td>
                              <td align="center" style="min-width: 100px;" ><button disabled class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button disabled class="btn remove" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                          </tr>
                      <tr></tr>
                    <?php endif; ?>
        ...
        <div id="TDS" class="tab-pane fade">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <select disabled name="drpTDS" id="drpTDS" class="form-control">
                      <option value=""></option>    
                      <option <?php echo e(isset($objHDR->TDS) && $objHDR->TDS =='1'?'selected="selected"':''); ?> value="Yes">Yes</option>
                      <option <?php echo e(isset($objHDR->TDS) && $objHDR->TDS =='0'?'selected="selected"':''); ?> value="No">No</option>
                  </select>
                </div>
            </div>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                    ...
                    <?php if(!empty($objPBTDS)): ?>
                      <?php $__currentLoopData = $objPBTDS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tkey => $trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr  class="participantRow7">
                            ...
                            <input disabled type="text" name=<?php echo e("txtTDS_".$tkey); ?> id=<?php echo e("txtTDS_".$tkey); ?> class="form-control" value="<?php echo e($trow->CODE); ?>" autocomplete="off"  readonly/></td>
                            ...
                            <td><input disabled type="text" name=<?php echo e("TDSLedger_".$tkey); ?> id=<?php echo e("TDSLedger_".$tkey); ?> class="form-control" value="<?php echo e($trow->CODE_DESC); ?>" autocomplete="off"  readonly/></td>
                            <td  align="center" style="text-align:center;" ><input type="checkbox" name=<?php echo e("TDSApplicable_".$tkey); ?> id=<?php echo e("TDSApplicable_".$tkey); ?> <?php echo e(isset($trow->TDS_APPLICABLE) && $trow->TDS_APPLICABLE == 1?'checked' : ''); ?>/></td>
                            <td><input disabled type="text" name=<?php echo e("ASSESSABLE_VL_TDS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_TDS_".$tkey); ?> class="form-control two-digits" value="<?php echo e($trow->ASSESSABLE_VL_TDS); ?>" maxlength="15"  autocomplete="off"  /></td>
                            <td><input disabled type="text" name=<?php echo e("TDS_RATE_".$tkey); ?> id=<?php echo e("TDS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->TDS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input disabled type="text" name=<?php echo e("TDS_AMT_".$tkey); ?> id=<?php echo e("TDS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15"  autocomplete="off"  value="<?php echo e($trow->TDS_AMT); ?>" readonly/></td>
                            <td><input disabled type="text" name=<?php echo e("ASSESSABLE_VL_SURCHARGE_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_SURCHARGE_".$tkey); ?> class="form-control two-digits" value="<?php echo e($trow->ASSESSABLE_VL_SURCHARGE); ?>" maxlength="15"  autocomplete="off" /></td>
                            <td><input disabled type="text" name=<?php echo e("SURCHARGE_RATE_".$tkey); ?> id=<?php echo e("SURCHARGE_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->SURCHARGE_RATE); ?>"  autocomplete="off"  /></td>
                            ...
                            <td><input disabled type="text" name=<?php echo e("SURCHARGE_AMT_".$tkey); ?> id=<?php echo e("SURCHARGE_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->SURCHARGE_AMT); ?>" autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name=<?php echo e("ASSESSABLE_VL_CESS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_CESS_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->ASSESSABLE_VL_CESS); ?>" autocomplete="off" /></td>
                            <td><input disabled type="text" name=<?php echo e("CESS_RATE_".$tkey); ?> id=<?php echo e("CESS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->CESS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input disabled type="text" name=<?php echo e("CESS_AMT_".$tkey); ?> id=<?php echo e("CESS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->CESS_AMT); ?>" autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name=<?php echo e("ASSESSABLE_VL_SPCESS_".$tkey); ?> id=<?php echo e("ASSESSABLE_VL_SPCESS_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->ASSESSABLE_VL_SPCESS); ?>"  autocomplete="off" /></td>
                            <td><input disabled type="text" name=<?php echo e("SPCESS_RATE_".$tkey); ?> id=<?php echo e("SPCESS_RATE_".$tkey); ?> class="form-control four-digits" maxlength="12" value="<?php echo e($trow->SPCESS_RATE); ?>" autocomplete="off"  /></td>
                            ...
                            <td><input disabled type="text" name=<?php echo e("SPCESS_AMT_".$tkey); ?> id=<?php echo e("SPCESS_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($trow->SPCESS_AMT); ?>"  autocomplete="off"  readonly/></td>
                  <?php
                    $TotalTDS=number_format(($trow->TDS_AMT+$trow->SURCHARGE_AMT+$trow->CESS_AMT+$trow->SPCESS_AMT),2, '.', '');
                  ?>
                            <td><input disabled type="text" name=<?php echo e("TOT_TD_AMT_".$tkey); ?> id=<?php echo e("TOT_TD_AMT_".$tkey); ?> class="form-control two-digits" maxlength="15" value="<?php echo e($TotalTDS); ?>"  autocomplete="off"  readonly/></td>
                            <td style="min-width: 100px;" ><button  disabled class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                            <button disabled class="btn remove" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                        </tr>
                        <tr></tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <tr  class="participantRow7">
                            <td style="text-align:center;" >
                            <input disabled type="text" name="txtTDS_0" id="txtTDS_0" class="form-control"  autocomplete="off"  readonly/></td>
                            <td hidden><input type="hidden" name="TDSID_REF_0" id="TDSID_REF_0" class="form-control" autocomplete="off" /></td>
                            <td><input disabled type="text" name="TDSLedger_0" id="TDSLedger_0" class="form-control"  autocomplete="off"  readonly/></td>
                            <td  align="center" style="text-align:center;" ><input type="checkbox" name="TDSApplicable_0" id="TDSApplicable_0" /></td>
                            <td><input disabled type="text" name="ASSESSABLE_VL_TDS_0" id="ASSESSABLE_VL_TDS_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  /></td>
                            <td><input disabled type="text" name="TDS_RATE_0" id="TDS_RATE_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="TDS_EXEMPT_0" id="TDS_EXEMPT_0" class="form-control two-digits" /></td>
                            <td><input disabled type="text" name="TDS_AMT_0" id="TDS_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name="ASSESSABLE_VL_SURCHARGE_0" id="ASSESSABLE_VL_SURCHARGE_0" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input disabled type="text" name="SURCHARGE_RATE_0" id="SURCHARGE_RATE_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="SURCHARGE_EXEMPT_0" id="SURCHARGE_EXEMPT_0" class="form-control two-digits" /></td>
                            <td><input disabled type="text" name="SURCHARGE_AMT_0" id="SURCHARGE_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name="ASSESSABLE_VL_CESS_0" id="ASSESSABLE_VL_CESS_0" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input disabled type="text" name="CESS_RATE_0" id="CESS_RATE_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="CESS_EXEMPT_0" id="CESS_EXEMPT_0" class="form-control two-digits" /></td>
                            <td><input disabled type="text" name="CESS_AMT_0" id="CESS_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name="ASSESSABLE_VL_SPCESS_0" id="ASSESSABLE_VL_SPCESS_0" class="form-control two-digits" maxlength="15"  autocomplete="off" /></td>
                            <td><input disabled type="text" name="SPCESS_RATE_0" id="SPCESS_RATE_0" class="form-control four-digits" maxlength="12"  autocomplete="off"  /></td>
                            <td hidden><input type="hidden" name="SPCESS_EXEMPT_0" id="SPCESS_EXEMPT_0" class="form-control two-digits" /></td>
                            <td><input disabled type="text" name="SPCESS_AMT_0" id="SPCESS_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                            <td><input disabled type="text" name="TOT_TD_AMT_0" id="TOT_TD_AMT_0" class="form-control two-digits" maxlength="15"  autocomplete="off"  readonly/></td>
                    ...
                    <?php if(!empty($objPBUDF)): ?>
                      <?php $__currentLoopData = $objPBUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input disabled type="text" name=<?php echo e("popupUDFPBID_".$Ukey); ?> id=<?php echo e("popupUDFPBID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDFPBID_REF_".$Ukey); ?>  id=<?php echo e("UDFPBID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->PII_UDFID); ?>" autocomplete="off" /></td>
                      ...
                      <?php if($objUdfPBData): ?>
                        <?php $__currentLoopData = $objUdfPBData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow4">
                              <td><input disabled type="text" name=<?php echo e("popupUDFPBID_".$uindex); ?> id=<?php echo e("popupUDFPBID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                              <td hidden><input type="hidden" name=<?php echo e("UDFPBID_REF_".$uindex); ?> id=<?php echo e("UDFPBID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFPIIID); ?>" autocomplete="off"   /></td>
                        ...
                        <?php else: ?>
                          <tr  class="participantRow4">
                              <td><input disabled type="text" name="popupUDFPBID_0" id="popupUDFPBID_0" class="form-control" value="" autocomplete="off"  readonly/></td>
...
<div id="GRNpopup" class="modal" role="dialog"  data-backdrop="static">
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
        <th class="ROW1"><span class="check_th">&#10004;</span></th>
        <td class="ROW2"><input type="text" id="GRNcodesearch" class="form-control" onkeyup="GRNCodeFunction()"></td>
        <td class="ROW3"><input type="text" id="GRNnamesearch" class="form-control" onkeyup="GRNNameFunction()"></td>
      </tr>
    </tbody>
    </table>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tbody>
      ...
      <table id="CurrencyTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr >
          <td class="ROW1"> <input type="checkbox" name="SELECT_CRID_REF[]" id="cridcode_<?php echo e($crindex); ?>" class="clscrid" value="<?php echo e($crRow-> CRID); ?>" ></td>
          <td class="ROW2"><?php echo e($crRow-> CRCODE); ?> <input type="hidden" id="txtcridcode_<?php echo e($crindex); ?>" data-desc="<?php echo e($crRow-> CRCODE); ?>"  value="<?php echo e($crRow-> CRID); ?>"/></td>
...
function bindTNCDetailsEvents(){
        $('.clstncdet').dblclick(function(){
            ...
            if(chkvaltype=='date'){
              ...
              strinp = '<input disabled type="date" placeholder="dd/mm/yyyy" name="'+dynamicid+ '" id="'+dynamicid+'" class="form-control" /> ';       

            }else if(chkvaltype=='time'){
              strinp= '<input disabled type="time" placeholder="h:i" name="'+dynamicid+ '" id="'+dynamicid+'" class="form-control" /> ';

            }else if(chkvaltype=='numeric'){
              strinp = '<input disabled type="text" name="'+dynamicid+ '" id="'+dynamicid+'" class="form-control" /> ';
...
var objlastdt = <?php echo json_encode($objHDR->PII_DT); ?>;
var ardate    = <?php echo json_encode($objHDR->PII_DT); ?>;
...
//------------------------
  ...
  function CurrencyNameFunction() {
      ...
      function getConversionFactor(CONVFACT,CRID_REF){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[$FormId,"getConversionFactor"])); ?>',
            type:'POST',
...
if(VID_REF ===""){
  ...
  $.ajax({
    ...
    type:'POST',
    data:{'taxstate':taxstate,'IMPORT_DUTYID_REF':IMPORT_DUTYID_REF,'VID_REF':VID_REF,'GRNID_REF':GRNID_REF},
    success:function(data) {
      $('#item_loader').hide();
...
$('.js-selectall').change(function(){
      ...
      $('#ItemIDTable2').find('.clsitemid').each(function(){
        ...
        var insurance_amount    = item_disc_amt;
        ...
        if($(this).find('[id*="chkId"]').is(":checked") == true){
          ...
          if( $('#hdn_ItemID').val() == '' && item_id != ''){
            ...
            $clone.find('[id*="popupITEMID_0"]').val(item_code);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\PurchaseInvoiceImport - Copy\trnfrm300view.blade.php ENDPATH**/ ?>