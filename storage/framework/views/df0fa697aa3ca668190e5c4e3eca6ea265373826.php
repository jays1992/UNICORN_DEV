    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody>               
              ...
              ?>
              <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->SPECIFICATIONID); ?>" value="<?php echo e($val->SPECIFICATIONID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->SPECIFICATIONCODE) && $val->SPECIFICATIONCODE !=''?$val->SPECIFICATIONCODE:''); ?></td>
                <td><?php echo e(isset($val->SPECIFICATIONNAME) && $val->SPECIFICATIONNAME !=''?$val->SPECIFICATIONNAME:''); ?></td>
        ...
        <form id="masterForm383Print" action="<?php echo e(route('mastergetlist',[383,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[383,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[383,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[383,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
  ...
  $.ajax({
      url:'<?php echo e(route("master",[383,"MultiApprove"])); ?>',
      type:'POST',
      dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[383,"cancel"])); ?>',
                            type:'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\SpecificationMaster\mstfrm383.blade.php ENDPATH**/ ?>