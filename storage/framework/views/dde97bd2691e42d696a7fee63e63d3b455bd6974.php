...
<?php $helper = app('App\Helpers\Helper'); ?> 
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              ...
              <?php if(isset($objRCPTDOCNO->SYSTEM_GRSR) && $objRCPTDOCNO->SYSTEM_GRSR == "1"): ?>
                  <input type="text" name="RECEIPT_NO" id="RECEIPT_NO" value="<?php echo e(isset($objDataNo)?$objDataNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
              <?php elseif(isset($objRCPTDOCNO->MANUAL_SR) &&  $objRCPTDOCNO->MANUAL_SR == "1"): ?>
                  <input type="text" name="RECEIPT_NO" id="RECEIPT_NO" value="<?php echo e(old('RECEIPT_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objPBDOCNO->MANUAL_MAXLENGTH)?$objPBDOCNO->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
            <?php else: ?>
                <input type="text" name="RECEIPT_NO" id="RECEIPT_NO" value="<?php echo e(old('RECEIPT_NO')); ?>" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase"  >
            <?php endif; ?>
        </div>
        <div class="col-lg-1 pl"><p>Receipt Date*</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="RECEIPT_DT" id="RECEIPT_DT" value="<?php echo e(old('RECEIPT_DT')); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
...
//------------------------
  ...
  $('#Account').on('click','[id*="popupAccount_"]',function(event){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[302,"getglsl"])); ?>',
            type:'POST',
...
function getBalance(bankid,fieldid,fieldidshow){
  ...
  url:'<?php echo e(route("transaction",[302,"getBalance"])); ?>',
  async: false,
  dataType: 'json',
  data: {id:bankid},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/ReceiptEntry/trnfrm302add.blade.php ENDPATH**/ ?>