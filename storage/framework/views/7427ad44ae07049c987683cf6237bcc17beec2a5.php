  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->PNMID); ?>" value="<?php echo e($val->PNMID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PNM_DT) && $val->PNM_DT !='' && $val->PNM_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PNM_DT)):''); ?>" ></td>
          <td><?php echo e(isset($val->PNM_NO) && $val->PNM_NO !=''?$val->PNM_NO:''); ?></td>
          <td><?php echo e(isset($val->PNM_DT) && $val->PNM_DT !='' && $val->PNM_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PNM_DT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ProductionMovement\trnfrm309.blade.php ENDPATH**/ ?>