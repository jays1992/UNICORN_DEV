                      ...
                      <table id="table3" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php if(!empty($objItemUOMConv)): ?>
                          <?php $__currentLoopData = $objItemUOMConv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iokey => $iorow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                              <input name=<?php echo e("touom_popup_".$iokey); ?> id=<?php echo e("txttouom_popup_".$iokey); ?> class="form-control" autocomplete="off" value="<?php echo e($iorow->TO_UOMID_REF); ?>"  readonly />
                            </td>
                            <td hidden>
                            ...
                            <td><input  class="form-control w-100 rightalign" type="text" name=<?php echo e("TO_QTY_".$iokey); ?> id=<?php echo e("TXT_TO_QTY_".$iokey); ?> value="<?php echo e($iorow->TO_QTY); ?>" autocomplete="off" ></td>
                            <td align="center" ><button class="btn add" title="add" data-toggle="tooltip"><i class="fa fa-plus"></i></button><button class="btn remove" title="Delete" data-toggle="tooltip" type="button" <?php if( ($loop->iteration-1)==0): ?> disabled <?php endif; ?>><i class="fa fa-trash" ></i></button></td>
                            </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                        <?php endif; ?> 
...
$("#btnApprove").click(function(){
  ...
  window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[72,"update"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\ItemMasters\mstfrm72edit.blade.php ENDPATH**/ ?>