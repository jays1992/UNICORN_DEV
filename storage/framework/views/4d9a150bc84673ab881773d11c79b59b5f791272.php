                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    <?php if(!empty($objAPDRCRACC)): ?>
                      ...
                      ?>
                            ...
                            <td>                                 
                            <select name=<?php echo e("TYPE_".$key); ?> id=<?php echo e("TYPE_".$key); ?>  class="form-control" style="width: 85px;">
...
let strtid = "#adjustmentTable";
  ...
  $.ajaxSetup({
   ...
   $.ajax({
                ...
                type:'POST',
                data:{EMPID_REF:EMPID_REF,PAYMENTID_REF:PAYMENTID_REF,ADJUSTMENT_AMOUNT:ADJUSTMENT_AMOUNT,ACTION_TYPE:'EDIT',RawID:RawID,APDRCRID:APDRCRID},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\APDebitNote\trnfrm235edit.blade.php ENDPATH**/ ?>