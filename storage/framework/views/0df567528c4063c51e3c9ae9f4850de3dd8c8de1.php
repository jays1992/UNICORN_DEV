...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Job Work GRN</a></div>
  ...
  <div class="multiple table-responsive  ">
    <table id="production_order_listing" class="display nowrap table table-striped table-bordered" width="100%">
      ...
      <tbody> 
        ...
        ?>
        <tr>
          <td><input type="checkbox" id="chkId<?php echo e($val->GRJID); ?>" value="<?php echo e($val->GRJID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->GRNDT) && $val->GRNDT !='' && $val->GRNDT !='1900-01-01' ? date('d-m-Y',strtotime($val->GRNDT)):''); ?>" ></td>
          <td><?php echo e(isset($val->GRNNO) && $val->GRNNO !=''?$val->GRNNO:''); ?></td>
          <td><?php echo e(isset($val->GRNDT) && $val->GRNDT !='' && $val->GRNDT !='1900-01-01' ? date('d-m-Y',strtotime($val->GRNDT)):''); ?></td>
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[357,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[357,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkGrn\trnfrm357.blade.php ENDPATH**/ ?>