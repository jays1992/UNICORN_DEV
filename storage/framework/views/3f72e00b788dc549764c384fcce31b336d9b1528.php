...
<?php $__env->startSection('content'); ?>
	...
	<div class="inner-form">
        ...
        <input type="text" name="MPPDOCNO" id="MPPDOCNO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <span class="text-danger" id="ERROR_MPPDOCNO"></span> 
            ...
            <input type="date" name="MPPDT" id="MPPDT" onchange='checkPeriodClosing(229,this.value,1),getDocNoByEvent("MPPDOCNO",this,<?php echo json_encode($doc_req, 15, 512) ?>)'  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        ...
        <select class="form-control" name="MONTH_DT" id="MONTH_DT">
          ...
          <?php $__currentLoopData = $objMonths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($mrow->MTID); ?>"><?php echo e($mrow->MTDESCRIPTION); ?></option>
...
window.fnUndoYes = function (){
    //reload form
  window.location.href = "<?php echo e(route('transaction',[229,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
    url:'<?php echo e(route("transaction",[229,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[229,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
                if(data.exists) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\ManualProductionPlan\trnfrm229add.blade.php ENDPATH**/ ?>