...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->GEID); ?>" value="<?php echo e($val->GEID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->GE_DT) && $val->GE_DT !='' && $val->GE_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->GE_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->GE_NO) && $val->GE_NO !=''?$val->GE_NO:''); ?></td>
                <td><?php echo e(isset($val->GE_DT) && $val->GE_DT !='' && $val->GE_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->GE_DT)):''); ?></td>
                <td><?php echo e(isset($val->TYPE) && $val->TYPE !=''?$val->TYPE:''); ?></td>
                <td>
                  <?php
                ...
                <td><?php echo e(isset($val->VENDOR_BILLNO) && $val->VENDOR_BILLNO !=''?$val->VENDOR_BILLNO:''); ?></td>
                <td><?php echo e(isset($val->INVOICE_NO) && $val->INVOICE_NO !=''?$val->INVOICE_NO:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Gate Entry Print</p></div>
        <div class="row">
...
$('#btnPdf').on('click', function() {
      ...
      {
            var GRNID = soIdsData[0];
            var Flag = 'P';
            var formData = 'GRN='+ GRNID + '&GEID='+ GRNID + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[92,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[92,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\GateEntry_1\trnfrm92.blade.php ENDPATH**/ ?>