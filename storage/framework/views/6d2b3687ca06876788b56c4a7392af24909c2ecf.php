...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[384,'index'])); ?>" class="btn singlebt">Manual Transaction Close</a>
                </div><!--col-2-->
    ...
    $('#tran_type').on('click',function(event){
        ...
        if(tran_type!='')
        {
          $("#tbody_Transaction").html('');
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[384,"getTransactionNo"])); ?>',
                type:'POST',
...
$(document).ready(function(e) {
    ...
    window.fnSaveData = function (){
      ...
      $.ajax({
          url:'<?php echo e(route("transaction",[384,"save"])); ?>',
          type:'POST',
          data:formData,
          success:function(data) {
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('transaction',[384,'add'])); ?>";
...
$("#OkBtn").click(function(){
    ...
    $("#OkBtn").hide();
    $(".text-danger").hide();
    window.location.href = '<?php echo e(route("transaction",[384,"index"])); ?>';
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Common/ManualTransactionClose/trnfrm384.blade.php ENDPATH**/ ?>