            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                    ...
                    <input type="hidden" id="objlastSTSDT"  value="<?php echo e(isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''); ?>">
                                <input <?php echo e($ActionStatus); ?> type="date" name="STSDT" id="STSDT" onchange="checkPeriodClosing(270,this.value,1)" value="<?php echo e(isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\StoretoStoreTransafer\trnfrm270edit.blade.php ENDPATH**/ ?>