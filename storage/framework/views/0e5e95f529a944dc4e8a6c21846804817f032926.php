...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[345,'index'])); ?>" class="btn singlebt">Request Against PRO Register</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_rpt_dpp"  method="POST">   
            <?php echo csrf_field(); ?>
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            <div class="col-lg-3 pl"><p>Request Against PRO No</p></div>
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                <select name="RPR_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="RPR_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjRPRNO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gindex=>$GRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($GRow->RPRID); ?>" selected><?php echo e($GRow->RPR_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>               
                            <div class="col-lg-3 pl"><p>Production Order No</p></div>
                            <div class="col-lg-3 pl" id="div_PRO_NO">
                                <select name="PRO_NO[]" data-hide-disabled="hide" multiple data-actions-box="true" id="PRO_NO" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjProductionOrer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Iindex=>$IRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($IRow->PROID); ?>" selected><?php echo e($IRow->PRO_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[345,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var RPR_NO = [];
        $("select[name='RPR_NO[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                RPR_NO.push(value5);
            }
        ...
        var PRO_NO  = [];
        $("select[name='PRO_NO[]']").each(function() {
            var value6 = $(this).val();
            if (value6) {
                PRO_NO.push(value6);
            }
        ...
        else if(RPR_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Request Against PRO No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else if(PRO_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Production Order.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[345,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\production\RequestAPRO\rptfrm345.blade.php ENDPATH**/ ?>