...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[63,'index'])); ?>" class="btn singlebt">Purchase Order Amendment</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
      ...
      <form id="frm_trn_po"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objPO->POID[0]) ? method_field('PUT') : ''); ?>
                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                          <input type="text" name="POANO" id="POANO" value="<?php echo e(isset($MAXANO)?$MAXANO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                          <input type="hidden" name="POID_REF" id="POID_REF" value="<?php echo e(isset($objPO->POID)?$objPO->POID:''); ?>" class="form-control" maxlength="15"  autofocus readonly >
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="PONO" id="PONO" value="<?php echo e(isset($objPO->PO_NO)?$objPO->PO_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>PO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="PODT" id="PODT" onchange="checkPeriodClosing(63,this.value,1)" value="<?php echo e(isset($objPO->PO_DT)?$objPO->PO_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy"  readonly>
                            </div>
                            
                            <div class="col-lg-2 pl"><p>From Department*</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="DEPT_popup" id="txtdept_popup" class="form-control mandatory" value="<?php echo e(isset($objdeptcode2->DCODE)?$objdeptcode2->DCODE:''); ?> <?php echo e(isset($objdeptcode2->NAME)?'-'.$objdeptcode2->NAME:''); ?>"  autocomplete="off" readonly disabled/>
                            <input type="hidden" name="DEPT_REF" id="DEPT_REF" class="form-control" autocomplete="off" value="<?php echo e(isset($objPO->DEPID_REF)?$objPO->DEPID_REF:''); ?>" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="VENDOR_popup" id="txtvendor_popup" class="form-control mandatory" value="<?php echo e(isset($objvendorcode->VCODE)?$objvendorcode->VCODE:''); ?> <?php echo e(isset($objvendorcode->NAME)?'-'.$objvendorcode->NAME:''); ?>"  autocomplete="off" readonly disabled/>
                                <input type="hidden" name="VENDORID_REF" id="VENDORID_REF" class="form-control" autocomplete="off"  value="<?php echo e(isset($objPO->VID_REF)?$objPO->VID_REF:''); ?>"/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVFDT" id="OVFDT" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" value="<?php echo e(isset($objPO->PO_VRF)?$objPO->PO_VRF:''); ?>" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>PO Validity To*</p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="OVTDT" id="OVTDT" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy" value="<?php echo e(isset($objPO->PO_VTO)?$objPO->PO_VTO:''); ?>" >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REFNO" id="REFNO" class="form-control" maxlength="100" value="<?php echo e(isset($objPO->VENDOR_REF_NO)?$objPO->VENDOR_REF_NO:''); ?>" autocomplete="off" style="text-transform:uppercase">
                            </div>

                            <div class="col-lg-2 pl"><p>Credit Days</p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="CREDITDAYS" id="CREDITDAYS" class="form-control" autocomplete="off" value="<?php echo e(isset($objPO->CREDIT_DAYS)?$objPO->CREDIT_DAYS:''); ?>" readonly /> 
                            </div>


                            <div class="col-lg-2 pl"><p>Bill To </p></div>
                            <div class="col-lg-2 pl" id="div_billto">
                                <input type="text" name="txtBILLTO" id="txtBILLTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objBillAddress[0])?$objBillAddress[0]:''); ?>" readonly disabled />
                                <input type="hidden" name="BILLTO" id="BILLTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objPO->BILLTO)?$objPO->BILLTO:''); ?>" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl" id="div_shipto">
                                <input type="text" name="txtSHIPTO" id="txtSHIPTO" class="form-control"  autocomplete="off" value="<?php echo e(isset($objBillAddress[0])?$objBillAddress[0]:''); ?>" readonly disabled />
                                <input type="hidden" name="SHIPTO" id="SHIPTO" class="form-control" autocomplete="off" value="<?php echo e(isset($objPO->SHIPTO)?$objPO->SHIPTO:''); ?>" />
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VENDOR_REF_DT" id="VENDOR_REF_DT" class="form-control " value="<?php echo e(isset($objPO->VENDOR_REF_DT)?$objPO->VENDOR_REF_DT:''); ?>" autocomplete="off" placeholder="dd/mm/yyyy"  >
                            </div> 


                            <div class="col-lg-2 pl"><p>Direct PO Order</p></div>
                            <div class="col-lg-2 pl">
                                  <input type="checkbox" name="DirectPO" id="DirectPO" class="form-checkbox"  <?php if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Direct"): ?>  checked="checked" <?php endif; ?>  disabled>                                  
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <select name="PO_BASED" id="PO_BASED" class="form-control"  <?php if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Direct"): ?>  disabled <?php endif; ?> disabled>
                                <option value="" selected="selected">--Please select--</option>
                                <option value="PI" <?php if(isset($objPO->PO_BASED) && $objPO->PO_BASED=="PI"): ?> selected="selected" <?php endif; ?>>PI</option>
                                <option value="Quotation" <?php if( isset($objPO->PO_BASED) && $objPO->PO_BASED=="Quotation"): ?> selected="selected" <?php endif; ?> >Quotation</option>
                              </select>
                              <input type="hidden" name="HDNPO_BASED" id="HDNPO_BASED" value="<?php echo e(isset($objPO->PO_BASED)?$objPO->PO_BASED:''); ?>" class="form-control">                              
                            </div>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" maxlength="200" value="<?php echo e(isset($objPO->REMARKS)?$objPO->REMARKS:''); ?>" autocomplete="off" disabled />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 pl"><p>Delivery Address</p></div>
                            <div class="col-lg-6 pl">
                                <textarea class="form-control w-100" name="Delivery_Address" cols="40" rows="10" id="Delivery_Address" autocomplete="off" disabled><?php echo e(isset($objPO->Delivery_Address)?$objPO->Delivery_Address:''); ?></textarea>
                            </div>

                            <div class="col-lg-2 pl"><p>Reverse GST</p></div>
                            <div class="col-lg-2 pl">
                              <input type="checkbox" name="GST_Reverse" id="GST_Reverse" <?php echo e(isset($objPO->REVERSE_GST) && $objPO->REVERSE_GST =='1' ?'checked':''); ?>   />                          
                            </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2 pl">
                            <input type="checkbox" name="GST_N_Avail" id="GST_N_Avail" <?php echo e(isset($objPO->GST_INPUT) && $objPO->GST_INPUT =='1' ?'checked':''); ?>   />
                          </div> 
                            ...
                            <div class="tab-content">
                                  ...
                                  <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                    <div class="table-responsive table-wrapper-scroll-y" style="height:400px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                            <?php if(!empty($objPOMAT)): ?>
                                                <?php $__currentLoopData = $objPOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow">
                                                        <td hidden>
                                                        <input  class="form-control" type="hidden" name=<?php echo e("SOMATID_".$key); ?> id =<?php echo e("SOMATID_".$key); ?> maxlength="100" value="<?php echo e($row->POMATID); ?>" autocomplete="off" style="width:130px;"   >
                                                        </td>
                                                        <td style="text-align:center;" >
                                                        <input type="text" name=<?php echo e("txtPIVQ_popup_".$key); ?> id=<?php echo e("txtPIVQ_popup_".$key); ?> class="form-control"   autocomplete="off"   readonly style="width:130px;" /></td>
                                                       
                                                        <td  hidden><input type="text" name=<?php echo e("VQPINO_".$key); ?> id=<?php echo e("VQPINO_".$key); ?> class="form-control" value="<?php echo e($row->RFQPINO); ?>" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name=<?php echo e("DYNAMICID_REF_".$key); ?> id=<?php echo e("DYNAMICID_REF_".$key); ?> class="form-control" value="<?php echo e($row->RFQPINO); ?>" autocomplete="off" style="width:130px;" /></td>
                                                          
                                                        <td  hidden><input type="text" name="PIID_REF_0" id="PIID_REF_0" class="form-control" value="<?php echo e($row->PIID_REF); ?>" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name="MRSID_REF_0" id="MRSID_REF_0" class="form-control" value="<?php echo e($row->MRSID_REF); ?>" autocomplete="off" style="width:130px;" /></td>
                                                        <td  hidden><input type="text" name="RFQID_REF_0" id="RFQID_REF_0" class="form-control" value="<?php echo e($row->RFQID_REF); ?>" autocomplete="off" style="width:130px;" /></td>
                                                    
                                                       
                                                        <td><input type="text" name=<?php echo e("popupITEMID_".$key); ?> id=<?php echo e("popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly style="width:130px;"/></td>
                                                        <td  hidden><input type="text" name=<?php echo e("ITEMID_REF_".$key); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->ITEMID_REF); ?>" autocomplete="off" style="width:130px;" /></td>
                                                        <td><input type="text" name=<?php echo e("ItemName_".$key); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEM_NAME); ?>"  readonly style="width:130px;"/></td>
                                                        <td><input type="text" name=<?php echo e("Itemspec_".$key); ?> id=<?php echo e("Itemspec_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEMSPECI); ?>" style="width:130px;" /></td>
                                                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" name=<?php echo e("Alpspartno_".$key); ?> id=<?php echo e("Alpspartno_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALPS_PART_NO); ?>" readonly style="width:130px;"/></td>
                                                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" name=<?php echo e("Custpartno_".$key); ?> id=<?php echo e("Custpartno_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->CUSTOMER_PART_NO); ?>" readonly style="width:130px;"/></td>
                                                        <td <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" name=<?php echo e("OEMpartno_".$key); ?> id=<?php echo e("OEMpartno_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->OEM_PART_NO); ?>" readonly style="width:130px;"/></td>
                                                        
                                                        <td><input type="text" name=<?php echo e("PI_VQMUOM_".$key); ?> id=<?php echo e("PI_VQMUOM_".$key); ?> class="form-control"  autocomplete="off"  value="<?php echo e($row->MUOM_DESC); ?>" readonly style="width:130px;"/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQMUOMQTY_".$key); ?> id=<?php echo e("PI_VQMUOMQTY_".$key); ?> class="form-control" maxlength="13" value="<?php echo e($row->MUOM_QTY); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQAUOM_".$key); ?> id=<?php echo e("PI_VQAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALTUOM_DESC); ?>" readonly style="width:130px;"/></td>
                                                        <td><input type="text" name=<?php echo e("PI_VQAUOMQTY_".$key); ?> id=<?php echo e("PI_VQAUOMQTY_".$key); ?> class="form-control" maxlength="13" autocomplete="off" value="<?php echo e($row->ALTUOM_QTY); ?>"  readonly style="width:130px;text-align:right;"/></td>
                                                       
                                                        <td><input type="text" name=<?php echo e("popupMUOM_".$key); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->MAIN_UOM_CODE); ?>"  readonly style="width:130px;"/></td>
                                                        ...
                                                        <td ><input type="text" name=<?php echo e("PENDING_QTY_".$key); ?> id=<?php echo e("PENDING_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e($row->CAL_PENDING_QTY); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("PO_QTY_".$key); ?> id=<?php echo e("PO_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo number_format(floatVal($row->PO_QTY),3,'.','');  ?>"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("PO_FQTY_".$key); ?> id=<?php echo e("PO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off"   readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("NOOFUNITS_".$key); ?> id=<?php echo e("NOOFUNITS_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo number_format(floatVal($row->NOOFUNITS),3,'.','');  ?>"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                                                        <td><input type="text" name=<?php echo e("popupAUOM_".$key); ?> id=<?php echo e("popupAUOM_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->AULT_UOM_CODE); ?>"  readonly style="width:130px;"/></td>
                                                        <td hidden><input type="hidden" name=<?php echo e("ALT_UOMID_REF_".$key); ?> id=<?php echo e("ALT_UOMID_REF_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ALTUOMID_REF); ?>"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("ALT_UOMID_QTY_".$key); ?> id=<?php echo e("ALT_UOMID_QTY_".$key); ?> class="form-control three-digits" maxlength="13" value="<?php echo e(($row->PO_QTY*$row->TO_QTY)/$row->FROM_QTY); ?>"  autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("LASTPRICE_".$key); ?> id=<?php echo e("LASTPRICE_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATEP_UOM1); ?>"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input type="text" name=<?php echo e("RATEPUOM_".$key); ?> id=<?php echo e("RATEPUOM_".$key); ?> class="form-control five-digits" maxlength="13" value="<?php echo e($row->RATEP_UOM); ?>"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCPER_".$key); ?> id=<?php echo e("DISCPER_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->DISCOUNT_PER); ?>"  autocomplete="off" style="width:130px;text-align:right;"  <?php echo e($AlpsStatus['disabled']); ?>  /></td>
                                                        <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name=<?php echo e("DISCOUNT_AMT_".$key); ?> id=<?php echo e("DISCOUNT_AMT_".$key); ?> class="form-control two-digits" value="<?php echo e($row->DIS_AMT); ?>" maxlength="15"  autocomplete="off" style="width:130px;text-align:right;" <?php echo e($AlpsStatus['disabled']); ?>  /></td>
                                                        <td><input type="text" name=<?php echo e("DISAFTT_AMT_".$key); ?> id=<?php echo e("DISAFTT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("IGST_".$key); ?> id=<?php echo e("IGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->IGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name=<?php echo e("IGSTAMT_".$key); ?> id=<?php echo e("IGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("CGST_".$key); ?> id=<?php echo e("CGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->CGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name=<?php echo e("CGSTAMT_".$key); ?> id=<?php echo e("CGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("SGST_".$key); ?> id=<?php echo e("SGST_".$key); ?> class="form-control four-digits" maxlength="8" value="<?php echo e($row->SGST); ?>" autocomplete="off"  readonly style="width:130px;text-align:right;" onkeyup="taxGstCalculation(this.id,this.value)" /></td>
                                                        <td><input type="text" name=<?php echo e("SGSTAMT_".$key); ?> id=<?php echo e("SGSTAMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("TGST_AMT_".$key); ?> id=<?php echo e("TGST_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                                        <td><input type="text" name=<?php echo e("TOT_AMT_".$key); ?> id=<?php echo e("TOT_AMT_".$key); ?> class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:130px;text-align:right;"/></td>
                                ...
                                <div id="TC" class="tab-pane fade">
                                    ...
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <?php if(!empty($objPOTNC)): ?>
                                         <input type="hidden" name="TNCID_REF" id="TNCID_REF" class="form-control" value="<?php echo e($objPOTNC[0]->TNCID_REF); ?>" autocomplete="off" />
                                         <?php else: ?>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:240px;width:50%;">
                                        ...
                                        <table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody id="tncbody">
                                            <?php if(!empty($objPOTNC)): ?>
                                                <?php $__currentLoopData = $objPOTNC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Tkey => $Trow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div id="udf" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                        <?php if(!empty($objPOUDF)): ?>
                                            <?php $__currentLoopData = $objPOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    <td><input type="text" name=<?php echo e("popupUDFPOID_".$Ukey); ?> id=<?php echo e("popupUDFPOID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFPOID_REF_".$Ukey); ?>  id=<?php echo e("UDFPOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDF); ?>" autocomplete="off" /></td>
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                            <?php else: ?>
                                            <?php $__currentLoopData = $objUdfPOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name=<?php echo e("popupUDFPOID_".$uindex); ?> id=<?php echo e("popupUDFPOID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFPOID_REF_".$uindex); ?> id=<?php echo e("UDFPOID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFID); ?>" autocomplete="off"   /></td>
                                ...
                                <div id="CT" class="tab-pane fade">
                                    <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                        ...
                                        <?php if(!empty($objPOCAL)): ?>
                                         <input type="hidden" name="CTID_REF" id="CTID_REF" class="form-control" value="<?php echo e($objPOCAL[0]->CTID_REF); ?>" autocomplete="off" />
                                         <?php else: ?>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y" style="height:240px;margin-top:10px;" >
                                        <table id="example5" class="display nowrap table table-striped table-bordered itemlist " width="100%" style="height:auto !important;">
                                            ...
                                            <tbody id="tbody_ctid">
                                            <?php if(!empty($objPOCAL)): ?>
                                                <?php $__currentLoopData = $objPOCAL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ckey => $Crow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div id="PaymentSlabs" class="tab-pane fade">
                                    <div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
                                        <table id="example6" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <tbody>
                                            <?php if(!empty($objPOPSLB)): ?>
                                                <?php $__currentLoopData = $objPOPSLB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pkey => $Prow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr  class="participantRow6">
                                                        <td hidden> <input type="text" class="form-control" id=<?php echo e("PSLBID_".$Pkey); ?> name=<?php echo e("PSLBID_".$Pkey); ?> value="<?php echo e($Prow->PSLBID); ?>" autocomplete="off"  /> </td>
                                                        <td> <input type="text" class="form-control" id=<?php echo e("PAY_DAYS_".$Pkey); ?> name=<?php echo e("PAY_DAYS_".$Pkey); ?> value="<?php echo e($Prow->PAY_DAYS); ?>" autocomplete="off"  /> </td>
                                                        <td> <input type="text" class="form-control four-digits" id=<?php echo e("DUE_".$Pkey); ?> name=<?php echo e("DUE_".$Pkey); ?> value="<?php echo e($Prow->DUE); ?>" maxlength="8" autocomplete="off" /> </td>
                                                        <td> <input type="text" class="form-control" id=<?php echo e("PSREMARKS_".$Pkey); ?> name=<?php echo e("PSREMARKS_".$Pkey); ?> value="<?php echo e($Prow->REMARKS); ?>" autocomplete="off"  /> </td>
                                                        <td> <input type="date" class="form-control" id=<?php echo e("DUE_DATE_".$Pkey); ?> name=<?php echo e("DUE_DATE_".$Pkey); ?>  value="<?php echo e($Prow->DUE_DATE); ?>" autocomplete="off"  readonly /> </td>
                                  ...
                                  <div class="row" style="margin-top:10px;margin-left:3px;" >	
                                      ...
                                      <div class="col-lg-2 pl">
                                        <select <?php echo e($ActionStatus); ?> name="drpTDS" id="drpTDS" class="form-control">
                                            <option value=""></option>    
                                            <option <?php echo e(isset($objPO->TDS) && $objPO->TDS =='1'?'selected="selected"':''); ?> value="Yes">Yes</option>
                                            <option <?php echo e(isset($objPO->TDS) && $objPO->TDS =='0'?'selected="selected"':''); ?> value="No">No</option>
                                        </select>
                                      </div>
                                  </div>
...
$.ajax({
    url:'<?php echo e(route("transactionmodify",[63,"saveamendment"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
      $(".buttonload").hide(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseOrder\PurchaseOrder\trnfrm63amendment.blade.php ENDPATH**/ ?>