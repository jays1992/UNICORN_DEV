...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->MISID); ?>" value="<?php echo e($val->MISID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->MIS_DT) && $val->MIS_DT !='' && $val->MIS_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MIS_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->MIS_NO) && $val->MIS_NO !=''?$val->MIS_NO:''); ?></td>
                <td><?php echo e(isset($val->MIS_DT) && $val->MIS_DT !='' && $val->MIS_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->MIS_DT)):''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Material Issue Slip Print</p></div>
        <div class="row">
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&MISID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[89,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[89,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialIssueSlip\trnfrm89.blade.php ENDPATH**/ ?>