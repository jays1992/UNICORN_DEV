...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->DSVID); ?>" value="<?php echo e($val->DSVID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->DSV_DT) && $val->DSV_DT !='' && $val->DSV_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DSV_DT)):''); ?>" ></td>
                <td><?php echo e(isset($val->DSV_NO) && $val->DSV_NO !=''?$val->DSV_NO:''); ?></td>
                <td><?php echo e(isset($val->DSV_DT) && $val->DSV_DT !='' && $val->DSV_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DSV_DT)):''); ?></td>
                <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !=''?$val->SLNAME:''); ?></td>
                <td><?php echo e(isset($val->REASON_DR_NOTE) && $val->REASON_DR_NOTE !=''?$val->REASON_DR_NOTE:''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\DebitNoteDsv\trnfrm307.blade.php ENDPATH**/ ?>