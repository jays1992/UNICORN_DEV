...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->PSEID); ?>" value="<?php echo e($val->PSEID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PSEDT) && $val->PSEDT !=''?$val->PSEDT:''); ?>" ></td>
                <td style="text-transform:uppercase"><?php echo e(isset($val->PSENO) && $val->PSENO !=''?$val->PSENO:''); ?></td>
                <td><?php echo e(isset($val->PSEDT) && $val->PSEDT !=''?$val->PSEDT:''); ?></td>
        ...
        <form id="transactionForm311Print" action="<?php echo e(route('transactiongetlist',[311,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[311,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("transaction",[311,"view",":rcdId"])); ?>';
    ...
    $('#btnApprove').on('click', function() {
            ...
            /*
              ...
              $("#YesBtn").hide();
                ...
                $("#OkBtn").hide();
                $("#OkBtn1").show();
                $("#AlertMessage").text('Oops! Multi approval feature is not applicable.');
                $("#alert").modal('show');
                $("#OkBtn1").focus();
                return false;
          ...
          var resultIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  else if(checkPeriodClosing(311,$('#chkId'+recordId).data("docdate"),0) ==0){
                    $("#YesBtn").hide();
                    $("#NoBtn").hide();
                    $("#OkBtn").hide();
                    $("#OkBtn1").show();
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[311,"attachment",":rcdId"])); ?>';
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[311,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[311,"cancel"])); ?>',
                            type:'POST',
    ...
    $('#btnPrint').on('click', function() {
          ...
          if(seletedRecord==0){
              ...
              var recordsIds = resultIdsData;
               ...
               $("#transactionForm311Print").submit()
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\PhysicalStockEntry\trnfrm311.blade.php ENDPATH**/ ?>