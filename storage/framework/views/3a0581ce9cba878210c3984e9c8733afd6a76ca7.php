<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->DEDUCTION_HEADID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="DEDUCTION_HEADID" id="DEDUCTION_HEADID" value="<?php echo e($objResponse->DEDUCTION_HEADID); ?>" />
                    <input type="hidden" name="DEDUCTION_HEADCODE" id="DEDUCTION_HEADCODE" value="<?php echo e($objResponse->DEDUCTION_HEADCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="DEDUCTION_HEAD_DESC" id="DEDUCTION_HEAD_DESC" class="form-control mandatory" value="<?php echo e(old('DEDUCTION_HEAD_DESC',$objResponse->DEDUCTION_HEAD_DESC)); ?>" maxlength="200" tabindex="1"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="DEDUCTION_TYPEID_REF_POPUP" id="DEDUCTION_TYPEID_REF_POPUP" readonly  value="<?php echo e(old('DEDUCTION_TYPE_DESC',$objResponse->DEDUCTION_TYPECODE.'-'.$objResponse->DEDUCTION_TYPE_DESC)); ?>" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
                        <input type="hidden" name="DEDUCTION_TYPEID_REF" id="DEDUCTION_TYPEID_REF"  value="<?php echo e(old('DEDUCTION_TYPEID_REF',$objResponse->DEDUCTION_TYPEID_REF)); ?>" />
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[188,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[188,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\DeductionHead\mstfrm188edit.blade.php ENDPATH**/ ?>