<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  <a href="<?php echo e(route('master',[155,'add'])); ?>" id="btnSelectedRows" class="btn topnavbt" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?>><i class="fa fa-plus"></i> Add</a>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->EMPCODEDEFIID); ?>" value="<?php echo e($val->EMPCODEDEFIID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->MANUAL_SR) && $val->MANUAL_SR==1?'Yes':''); ?></td>
                <td><?php echo e(isset($val->SYSTEM_GRSR) && $val->SYSTEM_GRSR==1?'Yes':''); ?></td>
                <td><?php echo e(isset($val->INDATE) && $val->INDATE !='' && $val->INDATE !='1900-01-01' ? date('d-m-Y',strtotime($val->INDATE)):''); ?></td>
                <td><?php echo e(isset($val->DEACTIVATE) && $val->DEACTIVATE == 1 ? 'Yes' : 'No'); ?></td>
                <td><?php echo e(isset($val->DODEACTIVATE) && $val->DODEACTIVATE !='' && $val->DODEACTIVATE !='1900-01-01' ? date('d-m-Y',strtotime($val->DODEACTIVATE)):''); ?></td>
        ...
        <form id="masterForm<?php echo e($FormId); ?>Print" action="<?php echo e(route('mastergetlist',[$FormId,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\EmployeeCodingDefinition\mstfrm155.blade.php ENDPATH**/ ?>