...
<form id="frm_trn_si" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >    
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Sales Invoice (SI)</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <?php if(isset($objSIN->SYSTEM_GRSR) && $objSIN->SYSTEM_GRSR == "1"): ?>
                                <input type="text" name="SINO" id="SINO" value="<?php echo e(isset($objSINO)?$objSINO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                            <?php elseif(isset($objSIN->MANUAL_SR) && $objSIN->MANUAL_SR == "1"): ?>
                                <input type="text" name="SINO" id="SINO"  class="form-control mandatory" maxlength="<?php echo e(isset($objSIN->MANUAL_MAXLENGTH)?$objSIN->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase" autofocus >
                            <?php else: ?>
                                        ...
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            ...
                                            <tbody>
                                                <tr class="participantRow">
                                                    ...
                                                    <td><input <?php echo e($AlpsStatus['readonly']); ?> type="text" name="SIMAIN_QTY_0" id="SIMAIN_QTY_0" class="form-control three-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                    ...
                                                    <td><input <?php echo e($AlpsStatus['readonly']); ?> type="text" name="RATEPUOM_0" id="RATEPUOM_0" class="form-control five-digits" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                                    <td><input <?php echo e($AlpsStatus['disabled']); ?> type="text" name="DISPER_0" id="DISPER_0" class="form-control four-digits" maxlength="8"  autocomplete="off" style="width:130px;text-align:right;" /></td>
                                        ...
                                        <table id="example4" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                                            ...
                                            <?php $__currentLoopData = $objUdfSIData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  <td><input type="text" name=<?php echo e("popupUDFSIID_".$uindex); ?> id=<?php echo e("popupUDFSIID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
            ...
            var customid = txtval;
              if(customid!=''){
                ...
                $("#SHIPTO1").val('');
                  ...
                  $.ajax({
                  url:'<?php echo e(route("transaction",[44,"getTDSApplicability"])); ?>',
                  type:'POST',
                  data:{'id':customid},
                  success:function(data) {
                  if(data == 1)
                  {
                    ...
                    $.ajax({
                      url:'<?php echo e(route("transaction",[44,"getTDSDetails"])); ?>',
                      type:'POST',
                      data:{'id':customid},
                      success:function(data) {                        
                      $("#tbody_tds").html('');
    ...
    //to check the label duplicacy
     $('#SINO').focusout(function(){
      ...
      if(SINO ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("transaction",[$FormId,"checksi"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
               if(data.exists) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/SalesInvoice/trnfrm44add.blade.php ENDPATH**/ ?>