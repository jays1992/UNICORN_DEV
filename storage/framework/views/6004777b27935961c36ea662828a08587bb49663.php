...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd" id="btndiv">
                        ...
                        <button class="btn topnavbt" id="btnAmendment"  <?php echo e(isset($objRights->AMENDMENT) && $objRights->AMENDMENT != 1 ? 'disabled' : ''); ?> ><i class="fa fa-tasks"></i> Amendment</button>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->POID); ?>" value="<?php echo e($val->POID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->PO_DT) && $val->PO_DT !='' && $val->PO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PO_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->PO_NO) && $val->PO_NO !=''?$val->PO_NO:''); ?></td>
              ...
              <td><?php echo e(isset($val->PO_VRF) && $val->PO_VRF !='' && $val->PO_VRF !='1900-01-01' ? date('d-m-Y',strtotime($val->PO_VRF)):''); ?></td>
              <td><?php echo e(isset($val->PO_VTO) && $val->PO_VTO !='' && $val->PO_VTO !='1900-01-01' ? date('d-m-Y',strtotime($val->PO_VTO)):''); ?></td>
          ...
          var poIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '<?php echo e(route("transaction",[63,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[63,"attachment",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[63,"edit",":rcdId"])); ?>';
          ...
          if(seletedRecord==0){
              ...
              highlighFocusBtn('activeOk1');
                ...
                if(is_approve==1){
                  ...
                  var editURL = '<?php echo e(route("transaction",[63,"amendment",":rcdId"])); ?>';
                      editURL = editURL.replace(":rcdId",recordId);
...
var recordId = poIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[63,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[63,"cancel"])); ?>',
                            type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[63,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[63,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseOrder\PurchaseOrder\trnfrm63.blade.php ENDPATH**/ ?>