    ...
    // $('[id*="txtlabel"]').blur(function(){
     $('#example2').on('blur','[id*="txtlabel"]',function(){
      ...
      if(LABEL ===""){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[214,"checkLabel"])); ?>',
            type:'POST',
            data:formData,
...
//add row
    ...
    window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[214,'add'])); ?>";
...
$.ajax({
    url:'<?php echo e(route("master",[214,"save"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Accounts\UDFBPV\mstfrm214add.blade.php ENDPATH**/ ?>