          ...
          <div class="inner-form">
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                ...
                <input type="text" name="SPSCODE" id="SPSCODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="SPECIFICATIONNAME" id="SPECIFICATIONNAME" class="form-control mandatory" value="<?php echo e(old('SPECIFICATIONNAME')); ?>" maxlength="200" tabindex="2"  />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="SPECIFICATIONDESC" id="SPECIFICATIONDESC" class="form-control mandatory" value="<?php echo e(old('SPECIFICATIONDESC')); ?>" maxlength="200" tabindex="2"  />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[383,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){      
      //reload form
      window.location.href = "<?php echo e(route('master',[383,'add'])); ?>";
   }//fnUndoYes
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\SpecificationMaster\mstfrm383add.blade.php ENDPATH**/ ?>