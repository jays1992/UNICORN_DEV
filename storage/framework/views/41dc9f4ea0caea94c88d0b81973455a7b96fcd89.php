...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="frm_trn_so" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SOID); ?>" value="<?php echo e($val->SOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SODT) && $val->SODT !='' && $val->SODT !='1900-01-01' ? date('d-m-Y',strtotime($val->SODT)):''); ?>" ></td>
              <td><?php echo e(isset($val->SONO) && $val->SONO !=''?$val->SONO:''); ?></td>
              ...
              <td><?php echo e(isset($val->CUSTOMERPONO) && $val->CUSTOMERPONO !=''?$val->CUSTOMERPONO:''); ?></td>
              <td><?php echo e(isset($val->OVFDT) && $val->OVFDT !='' && $val->OVFDT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVFDT)):''); ?></td>
              <td><?php echo e(isset($val->OVTDT) && $val->OVTDT !='' && $val->OVTDT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVTDT)):''); ?></td>
    ...
    $('#btnExit').on('click', function() {
      var viewURL = '<?php echo e(route('home')); ?>';
        ...
        // Data table for serverside
         var trnfrmsoTable =  $('#frm_trn_so').DataTable({
          ...
          var soIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '<?php echo e(route("transaction",[38,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[38,"attachment",":rcdId"])); ?>';
      ...
      $('#btnCancel').on('click', function() {
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  else if(checkPeriodClosing(38,$('#chkId'+recordId).data("docdate"),0) ==0){
                    $("#YesBtn").hide();
                    $("#NoBtn").hide();
                    $("#OkBtn").hide();
                    $("#OkBtn1").show();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[38,"edit",":rcdId"])); ?>';
          ...
          if(seletedRecord==0){
              ...
              highlighFocusBtn('activeOk1');
                ...
                if(is_approve==1){
                  ...
                  var editURL = '<?php echo e(route("transaction",[38,"amendment",":rcdId"])); ?>';
                      editURL = editURL.replace(":rcdId",recordId);
...
var recordId = soIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[38,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[38,"cancel"])); ?>',
                            type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&SONO='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[38,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[38,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/sales/SalesOrder/trnfrm38.blade.php ENDPATH**/ ?>