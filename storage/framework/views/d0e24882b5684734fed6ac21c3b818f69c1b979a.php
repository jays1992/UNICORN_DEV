                ...
                <div class="col-lg-2 pl"><p>State *</p></div>
                  <div class="col-lg-2 pl">
                    <select name="STID_REF" id="STID_REF" class="form-control mandatory" tabindex="4">
                      ...
                      <option value="<?php echo e($val->STID); ?>"><?php echo e($val->NAME); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
$(document).ready(function(e) {
 ...
 var formResponseMst = $( "#frm_mst_add" );
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[285,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LabourWelfareFundsSlabs\mstfrm285add.blade.php ENDPATH**/ ?>