...
<form id="form_data"  method="POST"  > 
      <?php echo csrf_field(); ?> 
      <?php echo e(isset($objMstResponse->PIID) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
        ...
        <input <?php echo e($ActionStatus); ?> type="text" name="PI_NO" id="PI_NO" value="<?php echo e(isset($objMstResponse->PI_NO)?$objMstResponse->PI_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			</div>
			
			<div class="col-lg-2 pl"><p>PI Date*</p></div>
			<div class="col-lg-2 pl">
				    <input <?php echo e($ActionStatus); ?> type="date" name="PI_DT" id="PI_DT"  class="form-control mandatory" value="<?php echo e(isset($objMstResponse->PI_DT)?$objMstResponse->PI_DT:''); ?>"  placeholder="dd-mm-yyyy" >
      </div>
			
			<div class="col-lg-2 pl"><p>From Store*</p></div>
			<div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="store_popup" id="txtstore_popup" class="form-control mandatory" value="<?php echo e(isset($objstorecode2->STCODE)?$objstorecode2->STCODE:''); ?> <?php echo e(isset($objstorecode2->NAME)?'-'.$objstorecode2->NAME:''); ?>" autocomplete="off" readonly/>
                <input type="hidden" name="STID_REF" id="STID_REF"  value="<?php echo e(isset($objMstResponse->STID_REF)?$objMstResponse->STID_REF:''); ?>"  class="form-control" autocomplete="off" />
			</div>
    ...
    <div class="col-lg-2 pl"><p>To Department*</p></div>
			<div class="col-lg-2 pl">
                <input <?php echo e($ActionStatus); ?> type="text" name="dept_popup" id="txtdept_popup" value="<?php echo e(isset($objdeptcode2->DCODE)?$objdeptcode2->DCODE:''); ?>  <?php echo e(isset($objdeptcode2->NAME)?'-'.$objdeptcode2->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="col-lg-2 pl"><p>Direct PI</p></div>
        <div class="col-lg-2 pl">
        <input <?php echo e($ActionStatus); ?> type="checkbox" name="DIRECT_PI" id="DIRECT_PI" value='<?php echo e(isset($objMstResponse->DIRECT_PI) && $objMstResponse->DIRECT_PI == 1 ? 1 : 0); ?>' <?php echo e(isset($objMstResponse->DIRECT_PI) && $objMstResponse->DIRECT_PI == 1 ? "checked" : ""); ?> />
      </div>
			...
			<div class="tab-content">
					...
					<div class="table-responsive table-wrapper-scroll-y" style="height:500px;margin-top:10px;" >
						<table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
							<thead id="thead1"  style="position: sticky;top: 0">
								  <tr>
									<th>MRS No<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1" value="<?php echo e($objList1Count); ?>"></th>
									<th>Item Code</th>
									<th>Item Name</th>
									<th>UOM</th>
                ...
                <?php if(!empty($ObjItem2)): ?>
                  ...
                  ?>
                    ...
                    <td hidden><input type="text" name="MrsID_<?php echo e($key); ?>" id="HDNMrsID_<?php echo e($key); ?>" value="<?php echo e(( is_null($row->MRSNO) || $row->MRSNO==0 ) ? '' : $row->MRSNO); ?>"  class="form-control" autocomplete="off" /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="MRS_popup_<?php echo e($key); ?>" id="txtMRS_popup_<?php echo e($key); ?>" value="<?php echo e($row->MRS_NO); ?>" class="form-control"  autocomplete="off" <?php echo e(( is_null($row->MRSNO) || $row->MRSNO==0 ) ? 'disabled' : ''); ?>  readonly/></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="STOCK_QTY_<?php echo e($key); ?>" id="txtSTOCK_QTY_<?php echo e($key); ?>" value="<?php echo e($row->STOCK_QTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly /></td>
                    <td ><input <?php echo e($ActionStatus); ?> type="text" name="BAL_MRSQTY_<?php echo e($key); ?>" id="BAL_MRSQTY_<?php echo e($key); ?>" value="<?php echo e($row->BAL_MRSQTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly/></td>

                    <td ><input <?php echo e($ActionStatus); ?> type="text" name="INDENT_QTY_<?php echo e($key); ?>" id="INDENT_QTY_<?php echo e($key); ?>" value="<?php echo e($row->INDENT_QTY); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  /></td>

                    <td ><input <?php echo e($ActionStatus); ?> type="date" name="EDA_<?php echo e($key); ?>" id="EDA_<?php echo e($key); ?>" value="<?php echo e($row->EDA); ?>"  class="form-control" placeholder="dd-mm-yyyy" /></td>

                    <td ><input <?php echo e($ActionStatus); ?> type="text" name="APPROX_VAL_<?php echo e($key); ?>" id="APPROX_VAL_<?php echo e($key); ?>" value="<?php echo e($row->APPROX_VL); ?>"  class="form-control three-digits" maxlength="13"  autocomplete="off"  /></td>
...
$(document).ready(function(e) {
  ...
  var lastPI_DT = <?php echo json_encode(isset($objMstResponse->PI_DT)?$objMstResponse->PI_DT:''); ?>;
  var mrsdate   = <?php echo json_encode(isset($objMstResponse->PI_DT)?$objMstResponse->PI_DT:''); ?>;

  $('#PI_DT').attr('min',lastPI_DT);
  $('#PI_DT').attr('max',mrsdate);

 // $('#PI_DT').val(mrsdate);
 
  $('#EDA_0').attr('min',mrsdate);
  $('#EDA_0').val(mrsdate);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\PurchaseIndent\trnfrm59view.blade.php ENDPATH**/ ?>