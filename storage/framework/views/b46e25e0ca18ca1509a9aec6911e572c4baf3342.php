          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="ATTID" id="ATTID" value="<?php echo e($objResponse->ATTID); ?>" />
                    <input type="hidden" name="ATTCODE" id="ATTCODE" value="<?php echo e($objResponse->ATTCODE); ?>" autocomplete="off"  maxlength="20"   />
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objDataResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow">
                            <td>
                            <input class="form-control w-100" type="text" name=<?php echo e("VALUE_".$key); ?> id =<?php echo e("txtvalue_".$key); ?>  value="<?php echo e($row->VALUE); ?>" maxlength="100" autocomplete="off" style="text-transform:uppercase;width:100%;" onkeypress="return AlphaNumaricSpace(event,this)" >
                            <input  type="hidden" name=<?php echo e("ATTVID_".$key); ?> id =<?php echo e("txtattvid_".$key); ?>  value="<?php echo e($row->ATTVID); ?>" >
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[71,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[71,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\AttributeMaster\mstfrm71edit.blade.php ENDPATH**/ ?>