                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GL[]" id="GL" class="form-control selectpicker" multiple data-live-search="true"  >
                                    <?php $__currentLoopData = $objGL; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$gRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($gRow->GLID); ?>" selected><?php echo e($gRow->GLCODE); ?>-<?php echo e($gRow->GLNAME); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesEnquiryRegister\rptfrm254.blade.php ENDPATH**/ ?>