...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->GRNID); ?>" value="<?php echo e($val->GRNID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->GRN_DT) && $val->GRN_DT !='' && $val->GRN_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->GRN_DT)):''); ?>" ></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Goods Receipt Note Against GE Print</p></div>
        <div class="row">
  ...
  $(document).ready(function(){  
    ...
    $('#btnApprove').on('click', function() {
            ...
            if(seletedRecord==0){
              ...
              $("#alert").modal('show');
              $("#AlertMessage").text('Multiple selection not allow. Please select single record.');
              $("#YesBtn").hide(); 
              $("#OkBtn").hide();
              $("#NoBtn").hide();  
              $("#OkBtn1").show();
    ...
    $('#btnCancel').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'GRN='+ GRNID + '&GRNID='+ GRNID + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("transaction",[159,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[159,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/inventory/GrnGateEntry/trnfrm159.blade.php ENDPATH**/ ?>