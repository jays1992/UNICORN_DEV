<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
      <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
        <?php echo csrf_field(); ?>
        <?php echo e(isset($objResponse->HEAD_VAID) ? method_field('PUT') : ''); ?>

       <div class="inner-form">              
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e($HDR->HEADVA_DOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e($HDR->HEADVA_DOCDT); ?>" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <select name="ADJUSTMENT_TYPE" id="ADJUSTMENT_TYPE" onchange="getEarHeadName(this.id,this.value)" class="form-control mandatory">
                     <option value="" selected="">Select</option>
                     <option <?php echo e(isset($MATDATA->ADJUSTMENT_TYPE) && $MATDATA->ADJUSTMENT_TYPE == 'Earning Head'?'selected="selected"':''); ?> value="Earning Head">Earning Head</option>
                     <option <?php echo e(isset($MATDATA->ADJUSTMENT_TYPE) && $MATDATA->ADJUSTMENT_TYPE == 'Deduction Head'?'selected="selected"':''); ?> value="Deduction Head">Deduction Head</option>
                    </select>
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   <select name="EARNIGHEAD_REF" id="EARNIGHEAD_REF" class="form-control mandatory">
                     ...
                     <option <?php echo e(isset($MATDATA->EARNING_HEADID_REF) && $MATDATA->EARNING_HEADID_REF == $val-> EARNING_HEADID ?'selected="selected"':''); ?> value="<?php echo e($val-> EARNING_HEADID); ?>"><?php echo e($val->EARNING_HEADCODE); ?></option>
                     <?php }else{?>
                      ...
                      <option <?php echo e(isset($MATDATA->EARNING_HEADID_REF) && $MATDATA->EARNING_HEADID_REF == $val-> DEDUCTION_HEADID ?'selected="selected"':''); ?> value="<?php echo e($val-> DEDUCTION_HEADID); ?>"><?php echo e($val->DEDUCTION_HEADCODE); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php }?>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                   </select>                            
                         ...
                         <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                           ...
                           <tbody>
                            ...
                            <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             ...
                             <td><input type="text" name="txtEMPID[]" id=<?php echo e("txtEMPID_".$key); ?> value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                             <td hidden><input type="hidden" name="EMPID_REF[]" id=<?php echo e("EMPID_REF_".$key); ?> value="<?php echo e($row->EMPID); ?>" class="form-control" autocomplete="off" /></td>
                               ...
                               <td><input  class="form-control" type="text" name="DESGCODE[]"    id=<?php echo e("DESGCODE_".$key); ?>   value="<?php echo e($row->DESGCODE); ?>"      autocomplete="off" style="width: 99%" readonly></td>
                               <td><input  class="form-control" type="text" name="DCODE[]"       id=<?php echo e("DCODE_".$key); ?>      value="<?php echo e($row->DCODE); ?>"         autocomplete="off" style="width: 99%" readonly></td>
                               <td><input  class="form-control" type="text" name="AMOUNTPLUS[]"  id=<?php echo e("AMOUNTPLUS_".$key); ?> value="<?php echo e($row->AMT_PLUS); ?>"      onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                               <td><input  class="form-control" type="text" name="AMOUNTSUB[]"   id=<?php echo e("AMOUNTSUB_".$key); ?>  value="<?php echo e($row->AMT_SUBTRACT); ?>"  onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
...
window.fnSaveData = function (){
     ...
     $.ajax({
        url:'<?php echo e(route("transactionmodify",[421,"update"])); ?>',
         type:'POST',
         data:formData,
         success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AdjustmentVoucherHeadwise\trnfrm421edit.blade.php ENDPATH**/ ?>