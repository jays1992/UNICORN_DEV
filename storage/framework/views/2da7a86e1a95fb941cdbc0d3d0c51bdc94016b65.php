            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl"><p>Team</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                <option value="<?php echo e($val->EMPID); ?>" selected><?php echo e($val->EMPCODE); ?> - <?php echo e($val->EMPNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
$('#btnView').on('click', function() {
        ...
        else if(EMPID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Team.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\PreSales\LeadConvertedToOpportunityTeamWise\rptfrm474.blade.php ENDPATH**/ ?>