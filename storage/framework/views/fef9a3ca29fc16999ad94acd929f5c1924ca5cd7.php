         ...
         <form id="frm_mst_edit" method="POST"  > 
          ...
          <div class="inner-form">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 pl">
                <input type="text" name="SHIFT_NAME" id="SHIFT_NAME" class="form-control mandatory" value="<?php echo e(old('SHIFT_NAME',$objResponse->SHIFT_NAME)); ?>" maxlength="200" tabindex="2" disabled/>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  ?>
                  <input type="time" name="START_TIME" id="START_TIME" class="form-control mandatory" value="<?php echo e(isset($starr[0]) ? $starr[0] : ''); ?>"  tabindex="3"  required disabled/> 
            ...
            <div class="row">
                ...
                <div class="col-lg-2 pl">
                  ...
                  ?>
                  <input type="time" name="END_TIME" id="END_TIME" class="form-control mandatory" value="<?php echo e(isset($endarr[0]) ? $endarr[0] : ''); ?>" tabindex="4" required disabled/>                        
          ...
          <div class="row">
            ...
            <label class="radio-inline">
                <input   type="radio" name="SHIFT_DTCHANGE_YES" id="RADIO_SHIFT_DTCHANGE_YES" value="1" tabindex="14" <?php echo e($objResponse->SHIFT_DTCHANGE_YES == 1 ? "checked" : ""); ?> disabled/>    Yes
            </label>
            <label class="radio-inline">
                <input   type="radio" name="SHIFT_DTCHANGE_YES" id="RADIO_SHIFT_DTCHANGE_NO" value="0" tabindex="14" <?php echo e($objResponse->SHIFT_DTCHANGE_YES == 0 ? "checked" : ""); ?>disabled/>   No
            </label>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-1 pl">
              ...
              ?>
              <input type="time" name="START_TIME_OT" id="START_TIME_OT" value="<?php echo e(isset($otarr[0]) ? $otarr[0] : ''); ?>" class="form-control " tabindex="15" disabled/>   
            </div>
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\ShiftMaster\mstfrm180view.blade.php ENDPATH**/ ?>