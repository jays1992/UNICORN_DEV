...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
              <table id="frm_trn_ro" class="display nowrap table table-striped table-bordered" width="100%">
            <thead id="thead1">
            <tr>
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->ROID); ?>" value="<?php echo e($val->ROID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->RODT) && $val->RODT !='' && $val->RODT !='1900-01-01' ? date('d-m-Y',strtotime($val->RODT)):''); ?>" ></td>
              <td><?php echo e(isset($val->RONO) && $val->RONO !=''?$val->RONO:''); ?></td>
              <td><?php echo e(isset($val->RODT) && $val->RODT !='' && $val->RODT !='1900-01-01' ? date('d-m-Y',strtotime($val->RODT)):''); ?></td>
              <td><?php echo e(isset($val->SLNAME) && $val->SLNAME !=''?$val->SLNAME:''); ?></td>
              <td><?php echo e(isset($val->OVFRM_DT) && $val->OVFRM_DT !='' && $val->OVFRM_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVFRM_DT)):''); ?></td>
              <td><?php echo e(isset($val->OVTOM_DT) && $val->OVTOM_DT !='' && $val->OVTOM_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVTOM_DT)):''); ?></td>
    ...
    $('#btnExit').on('click', function() {
      var viewURL = '<?php echo e(route('home')); ?>';
        ...
        // Data table for serverside
         var trnfrmsoTable =  $('#frm_trn_ro').DataTable({
      ...
      $('#btnView').on('click', function() {
          var ROIDsData = getSeletectedCBox();
            var seletedRecord = ROIDsData.length;
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var recordId = ROIDsData[0];
                  var viewURL = '<?php echo e(route("transaction",[315,"view",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("transaction",[315,"attachment",":rcdId"])); ?>';
      ...
      $('#btnCancel').on('click', function() {
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  else if(checkPeriodClosing(315,$('#chkId'+recordId).data("docdate"),0) ==0){
                    $("#YesBtn").hide();
                    $("#NoBtn").hide();
                    $("#OkBtn").hide();
                    $("#OkBtn1").show();
      ...
      $('#btnEdit').on('click', function() {
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("transaction",[315,"edit",":rcdId"])); ?>';
        ...
        $('#btnApprove').on('click', function() {
          ...
          var ROIDsData = getSeletectedCBox();
          var seletedRecord = ROIDsData.length;
          var ROIDsDataID = getSeletectedCBoxID();
          ...
          if(seletedRecord==0){
              ...
              highlighFocusBtn('activeOk1');
                ...
                if(is_approve==1){
                  ...
                  var editURL = '<?php echo e(route("transaction",[315,"amendment",":rcdId"])); ?>';
                      editURL = editURL.replace(":rcdId",recordId);
...
var recordId = ROIDsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("transaction",[315,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("transactionmodify",[315,"cancel"])); ?>',
                            type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&ROID='+ SONO + '&Flag='+ Flag ;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\ReleaseOrder\trnfrm315.blade.php ENDPATH**/ ?>