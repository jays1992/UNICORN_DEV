...
<div class="container-fluid purchase-order-view">
  <form id="frm_mst_edit" method="POST"  > 
    <?php echo csrf_field(); ?>
    <?php echo e(isset($objResponse->ETYPEID) ? method_field('PUT') : ''); ?>
                ...
                <div class="inner-form">
                    <div class="row">
                        ...
                        <div class="col-lg-2 pl">
                          ...
                          <input type="text" name="LOB_NO" id="LOB_NO" value="<?php echo e(isset($objAutoGenNo)?$objAutoGenNo:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                      <?php elseif(isset($objSON->MANUAL_SR) && $objSON->MANUAL_SR == "1"): ?>
                          <input type="text" name="LOB_NO" id="LOB_NO" value="<?php echo e(old('LOB_NO')); ?>" class="form-control mandatory" maxlength="<?php echo e(isset($objSON->MANUAL_MAXLENGTH)?$objSON->MANUAL_MAXLENGTH:''); ?>" autocomplete="off" style="text-transform:uppercase"  >
                      <?php else: ?>
                          <input type="text" name="LOB_NO" id="LOB_NO" value="<?php echo e(isset($HDR->LOB_NO)?$HDR->LOB_NO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                          <?php endif; ?>
                        </div>
                        <div class="col-lg-2 pl"><p>LOB Date*</p></div>
                        <div class="col-lg-2 pl">
                            <input <?php echo e($InputStatus); ?> type="date" name="LOB_DT" id="LOB_DT" value="<?php echo e(isset($HDR->LOB_DT)?$HDR->LOB_DT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="LEAVE_OPBLID" id="LEAVE_OPBLID" value="<?php echo e($HDR->LEAVE_OPBLID); ?>" class="form-control" autocomplete="off" /></td>
                          </div>                              
                        <div class="col-lg-2 pl"><p>Financial Year*</p></div>
                        <div class="col-lg-2 pl">
                          <select <?php echo e($InputStatus); ?> name="FYID_REF" id="FYID_REF" class="form-control mandatory" tabindex="4">
                            <?php if(isset($objYearList) && !empty($objYearList)): ?>
                            ...
                            <option <?php echo e(isset($HDR->YRCODE) && $HDR->YRCODE ==$YearList->YRID?'selected="selected"':''); ?> value="<?php echo e($YearList->YRCODE); ?>"><?php echo e($YearList->YRCODE); ?></option>
                                        ...
                                        ?>
                                          <?php if(isset($objMAT) && !empty($objMAT)): ?>
                                            ...
                                            <tr  class="participantRow">
                                                <td><input <?php echo e($InputStatus); ?> type="text" name="popupEMPLYID_<?php echo e($key); ?>" id="popupEMPLYID_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="EMPLY_REF_<?php echo e($key); ?>" id="EMPLY_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="LEAVE_OPBLID_REF_<?php echo e($key); ?>" id="LEAVE_OPBLID_REF_<?php echo e($key); ?>" value="<?php echo e($row->LEAVE_OPBLID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="EMPID_REF_<?php echo e($key); ?>" id="EMPID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="LTID_REF_<?php echo e($key); ?>" id="LTID_REF_<?php echo e($key); ?>" value="<?php echo e($row->LTID_REF); ?>" class="form-control" autocomplete="off" /></td>
                                                <td><input <?php echo e($InputStatus); ?> type="text" name="EMPLYSPECI_<?php echo e($key); ?>" id="EMPLYSPECI_<?php echo e($key); ?>" value="<?php echo e($row->FNAME); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                <td><input <?php echo e($InputStatus); ?> type="text" name="EMPLYDES_<?php echo e($key); ?>" id="EMPLYDES_<?php echo e($key); ?>"  value="<?php echo e($row->DESGCODE); ?>" class="form-control"  autocomplete="off"  readonly/></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="UOMID_REF_<?php echo e($key); ?>" id="UOMID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off" /></td>
                                                
                                                <td><input <?php echo e($InputStatus); ?> type="text" name="EmplyName_<?php echo e($key); ?>" id="EmplyName_<?php echo e($key); ?>" value="<?php echo e($row->DCODE); ?>" class="form-control" maxlength="200" autocomplete="off" readonly /></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="DEPID_REF_<?php echo e($key); ?>" id="DEPID_REF_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control"  autocomplete="off" /></td>
                                                
                                                <td><input <?php echo e($InputStatus); ?> name="leavetypecode_popup_<?php echo e($key); ?>" id="leavetypecode_popup_<?php echo e($key); ?>" value="<?php echo e($row->LEAVETYPE_CODE); ?>" class="form-control" autocomplete="off"  readonly/></td>
                                                <td hidden><input <?php echo e($InputStatus); ?> type="text" name="hdnleavetypecode_popup_<?php echo e($key); ?>" id="hdnleavetypecode_popup_<?php echo e($key); ?>" value="<?php echo e($row->LTID); ?>" class="form-control" /> </td>

                                                <td><input <?php echo e($InputStatus); ?> class="form-control w-100" type="text" name="leavetypedesciption_<?php echo e($key); ?>" id="txtleavetypedesciption_<?php echo e($key); ?>" value="<?php echo e($row->LEAVETYPE_DESC); ?>"  maxlength="50" readonly></td>
                                                                                                    
                                                <td hidden><input <?php echo e($InputStatus); ?> type="hidden" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->EMPCODE); ?>" class="form-control" maxlength="13"  autocomplete="off" /></td>
                                                <td><input <?php echo e($InputStatus); ?> type="text" name="OPNGBALANCE_<?php echo e($key); ?>" id="OPNGBALANCE_<?php echo e($key); ?>" value="<?php echo e($row->LEAVE_OPBL); ?>" class="form-control" maxlength="13"  autocomplete="off" /></td>

                                                <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add material" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button>
                                                  <button <?php echo e($InputStatus); ?> class="btn remove dmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
...
<table id="leavetypecodetable" class="display nowrap table  table-striped table-bordered" width="100%">
  ...
  <tbody>
  <?php $__currentLoopData = $ObjMstleavetype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$Rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr >
    <td class="ROW1" style="width: 12%" align="center"> <input type="checkbox" name="SELECT_ATTID_REF[]"  id="leavetypecode_<?php echo e($Rows->LTID); ?>" class="clsleavetypecode" value="<?php echo e($Rows->LTID); ?>" /></td>
    <td class="ROW2" style="width: 39%"><?php echo e($Rows->LEAVETYPE_CODE); ?>

      <input type="hidden" id="txtleavetypecode_<?php echo e($Rows->LTID); ?>" data-desc="<?php echo e($Rows->LEAVETYPE_CODE); ?>" value="<?php echo e($Rows->LTID); ?>" data-leavetypedesc="<?php echo e($Rows->LEAVETYPE_DESC); ?>" value="<?php echo e($Rows->LEAVETYPE_DESC); ?>"  />
    </td>
    <td class="ROW3" style="width: 39%"><?php echo e($Rows->LEAVETYPE_DESC); ?></td>
  </tr>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </tbody>
  </table>
...
window.fnUndoYes = function (){
  //reload form
  window.location.href = "<?php echo e(route('master',[390,'add'])); ?>";
}//fnUndoYes
...
$.ajax({
url:'<?php echo e(route("master",[390,"update"])); ?>',
type:'POST',
data:formData,
success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveOpeningBalance\mstfrm390view.blade.php ENDPATH**/ ?>