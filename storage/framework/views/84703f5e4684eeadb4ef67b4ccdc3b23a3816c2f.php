<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[148,'index'])); ?>" class="btn singlebt">Price List Standard Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->PLID); ?>" value="<?php echo e($val->PLID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
              <td><?php echo e(isset($val->PL_NO) && $val->PL_NO !=''?$val->PL_NO:''); ?></td>
              <td><?php echo e(isset($val->PL_DT) && $val->PL_DT !='' && $val->PL_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PL_DT)):''); ?></td>
              <td><?php echo e(isset($val->PL_TITLE) && $val->PL_TITLE !=''?$val->PL_TITLE:''); ?></td>
              <td><?php echo e(isset($val->MRP_APPLICABLE) && $val->MRP_APPLICABLE =='1'?'Yes':'No'); ?></td>
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[148,"edit",":rcdId"])); ?>';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[148,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[148,"attachment",":rcdId"])); ?>';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[148,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[148,"cancel"])); ?>',
                            type:'POST',
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[148,"add"])); ?>';
      window.location.href=viewURL;
  });
</script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Sales/PriceList/mstfrm148.blade.php ENDPATH**/ ?>