...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Customer-Branch Mapping</a>
        </div>
...
<div class="container-fluid purchase-order-view filter">     
  ...
  <?php echo csrf_field(); ?>
  <?php echo e(isset($objResponse->CBRMID) ? method_field('PUT') : ''); ?>
            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input type="checkbox" name="CID_REF[<?php echo e($key); ?>]" <?php echo e($row->CID ==$row->CID_REF?'checked':''); ?> value="<?php echo e($row->CID); ?>" class="checkbox" ></td>
                    <td><input type="text" name="CUSTOMER_CODE_<?php echo e($key); ?>" id="CUSTOMER_CODE_<?php echo e($key); ?>" value="<?php echo e($row->CCODE); ?>" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                    <td><input  type="text" id ="CUSTOMER_NAME_<?php echo e($key); ?>"  id ="CUSTOMER_NAME_<?php echo e($key); ?>" value="<?php echo e($row->CUSTOMER_LEGAL_NAME); ?>" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/masters/Sales/CustomerBranchMapping/mstfrm130edit.blade.php ENDPATH**/ ?>