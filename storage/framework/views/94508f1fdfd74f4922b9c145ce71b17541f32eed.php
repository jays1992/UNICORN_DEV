...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[320,'index'])); ?>" class="btn singlebt">General Ledger Trail Balance</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_gl">
                                ...
                                <?php $__currentLoopData = $ObjGeneralLedger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->GLID); ?>" selected><?php echo e($cRow->GLCODE); ?>-<?php echo e($cRow->GLNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" id="div_ag">
                                ...
                                <?php $__currentLoopData = $ObjAccountGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->AGID); ?>" selected><?php echo e($cRow->AGCODE); ?>-<?php echo e($cRow->AGNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-3 pl"><p>Account Sub Group</p></div>
                            <div class="col-lg-3 pl" id="div_ag">
                                <select name="ASGID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="ASGID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $ObjAccountSubGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->ASGID); ?>" selected><?php echo e($cRow->ASGCODE); ?>-<?php echo e($cRow->ASGNAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[320,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
		...
		var ASGID = [];
        $("select[name='ASGID[]']").each(function() {
            var value4 = $(this).val();
            if (value4) {
                ASGID.push(value4);
            }
		...
		else if(ASGID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Account Sub Group.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
		else if(LEVELID ==="")
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[320,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\TrailBalance\rptfrm320.blade.php ENDPATH**/ ?>