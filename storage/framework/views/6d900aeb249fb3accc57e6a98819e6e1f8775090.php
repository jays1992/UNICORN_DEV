             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input   type="text" name="DOC_NO" id="DOC_NO" value="<?php echo e($HDR->DOCNO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" readonly autocomplete="off" style="text-transform:uppercase" autofocus >
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="DOC_DT" id="DOC_DT" value="<?php echo e($HDR->DOCDATE); ?>" class="form-control"  maxlength="100" > 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" id="PAY_PERIOD_DESC" value="<?php echo e($HDR->PAY_PERIOD_DESC); ?>" class="form-control" readonly  maxlength="100" > 
                 </div>
                 <div class="col-lg-2 pl"><p>Shift *</p></div>
                    <div class="col-lg-2 pl">
                    <input type="text" name="TXTSHIFT" id="TXTSHIFT" value="<?php echo e($HDR->SHIFT_NAME); ?>"  class="form-control mandatory"  autocomplete="off" readonly/>
                    ...
                    <div class="col-lg-2 pl">
                      <input type="time" id="DEFROMTIME" name="DEFROMTIME" value="<?php echo e($DEF_TIME_FROM); ?>"  class="form-control" readonly  maxlength="100" > 
                    </div>           
             </div>
             <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="time" id="DEFTOTIME" name="DEFTOTIME" value="<?php echo e($DEF_TIME_TO); ?>" class="form-control" readonly  maxlength="100" > 
                </div>
             </div>
                            ...
                            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                              ...
                              <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr  class="participantRow">
                                  <td><input  class="form-control" type="text" name="txtEMPID[]"    id=<?php echo e("txtEMPID_".$key); ?>   value="<?php echo e($row->EMPCODE); ?>"  autocomplete="off" readonly onclick="getEmployee(this.id)"/></td>
                                  ...
                                  <td><input  class="form-control" type="text" name="FNAME[]"       id =<?php echo e("FNAME_".$key); ?>     value="<?php echo e($row->FNAME); ?>"   autocomplete="off" style="width: 99%" readonly></td>
                                  <td><input  class="form-control" type="time" name="FROMTIME[]"    id =<?php echo e("FROMTIME_".$key); ?>  value="<?php echo e($TIME_FROM); ?>" autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input  class="form-control" type="time" name="TOTIME[]"      id =<?php echo e("TOTIME_".$key); ?>    value="<?php echo e($TIME_TO); ?>" autocomplete="off" style="width: 99%" onchange="getFromTime(this.id)"></td>
                                  <td><input  class="form-control" type="text" name="TOTALHOURS[]"  id =<?php echo e("TOTALHOURS_".$key); ?> value="<?php echo e($TOTALHOURS); ?>" autocomplete="off" style="width: 99%" readonly></td>
                                  
                                  <td><select name="ASID_REF[]" id=<?php echo e("ASID_REF_".$key); ?> class="form-control mandatory">
                                    <option value="" selected="">Select</option>
                                  ...
                                  <td><input  class="form-control" type="text" name="REMARKS[]"     id =<?php echo e("REMARKS_".$key); ?>   value="<?php echo e($row->REMARKS); ?>"  autocomplete="off" style="width: 99%"></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\AttendanceTimeWiseDateWise\AttendanceTimeWiseDateWise\trnfrm425edit.blade.php ENDPATH**/ ?>