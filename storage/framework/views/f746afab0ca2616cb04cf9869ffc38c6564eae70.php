...
<?php $helper = app('App\Helpers\Helper'); ?>  
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Journal Voucher(JV)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->JVID); ?>" value="<?php echo e($val->JVID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->JV_DT) && $val->JV_DT !=''?$val->JV_DT:''); ?>" ></td>
                <td><?php echo e(isset($val->JV_NO) && $val->JV_NO !=''?$val->JV_NO:''); ?></td>
                <td><?php echo e(isset($val->JV_DT) && $val->JV_DT !=''?$val->JV_DT:''); ?></td>
                <td><?php echo e(isset($val->REVERSE_DT) && $val->REVERSE_DT !=''?$val->REVERSE_DT:''); ?></td>
				        <td><?php echo e(isset($val->NARRATION) && $val->NARRATION !=''?$val->NARRATION:''); ?></td>
                <td><?php echo e(isset($Name) && $Name !=''?$Name:''); ?></td>
                <td><?php echo e(isset($val->SOURCE_DOCNO) && $val->SOURCE_DOCNO !=''?$val->SOURCE_DOCNO:''); ?></td>
                <td><?php echo e(isset($val->SOURCE_DOCDT) && $val->SOURCE_DOCDT !='' && $val->SOURCE_DOCDT !='1900-01-01' ? date('d-m-Y',strtotime($val->SOURCE_DOCDT)):''); ?></td>
                <td><?php echo e(isset($val->REFERENCE_NO) && $val->REFERENCE_NO !=''?$val->REFERENCE_NO:''); ?></td>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:50%; height:60%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Journal Voucher Print</p></div>
        <div class="row">
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("transaction",[169,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
...
$('#btnPdf').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'PO='+ POID + '&JVID='+ POID + '&Flag='+ Flag ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/transactions/Accounts/JournalVoucher/trnfrm169.blade.php ENDPATH**/ ?>