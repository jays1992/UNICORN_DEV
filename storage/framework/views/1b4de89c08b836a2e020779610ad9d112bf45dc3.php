  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="text" name="GE_NO" id="GE_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
              <input type="date" name="GE_DT" id="GE_DT" value="<?php echo e(old('GE_DT')); ?>" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("GE_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory" autocomplete="off" >
        </div>

        <div class="col-lg-1 pl"><p>GE Time</p></div>
        <div class="col-lg-1 pl">
              <input type="time" name="GE_TM" id="GE_TM" value="<?php echo e(date('H:i',strtotime(date('H:i:s'))+strtotime('05:30:00'))); ?>" class="form-control mandatory"  autocomplete="off"  >
        </div>
            ...
            <div class="row">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    <td><input type="text" name=<?php echo e("popupSEID_".$uindex); ?> id=<?php echo e("popupSEID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFGEID); ?>" autocomplete="off"   /></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\GateEntry_1\trnfrm92add.blade.php ENDPATH**/ ?>