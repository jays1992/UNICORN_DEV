<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('master',[$FormId,'index'])); ?>" class="btn singlebt">Item Coding Definition</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
          ...
          <input type="hidden" name="ITEMCODEDEFIID" id="ITEMCODEDEFIID" value="<?php echo e(isset($objResponse->ITEMCODEDEFIID) && $objResponse->ITEMCODEDEFIID !=''?$objResponse->ITEMCODEDEFIID:''); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Common\ItemCodingDefinition\mstfrm152view.blade.php ENDPATH**/ ?>