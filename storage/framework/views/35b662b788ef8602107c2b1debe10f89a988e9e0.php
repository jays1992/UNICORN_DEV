          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                    ...
                    <input type="hidden" name="CTRYID" id="CTRYID" value="<?php echo e($objCountry->CTRYID); ?>" />
                    <input type="hidden" name="CTRYCODE" id="CTRYCODE" value="<?php echo e($objCountry->CTRYCODE); ?>" autocomplete="off" minlength="3"  maxlength="3"   />
                  ...
                  <div class="col-lg-4 pl">
                    <input type="text" name="COUNTRY_NAME" id="COUNTRY_NAME" class="form-control mandatory" value="<?php echo e(old('NAME',$objCountry->NAME)); ?>" maxlength="100" tabindex="2"  />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <div class="col-lg-8 pl">
                    <input type="text" name="ISDCODE" id="ISDCODE" class="form-control" value="<?php echo e(old('ISDCODE',$objCountry->ISDCODE)); ?>" maxlength="4"  tabindex="3" >
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <input type="text" name="CONTINENTAL" id="CONTINENTAL" class="form-control" value="<?php echo e(old('CONTINENTAL', $objCountry->CONTINENTAL)); ?>" maxlength="50" style="width:285px;" tabindex="5" >
                </div>
              ...
              <div class="row">
                ...
                <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($objCountry->DEACTIVATED == 1 ? "checked" : ""); ?>
                 ...
                 value='<?php echo e($objCountry->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="7"  >
                </div>
                ...
                <?php echo e($objCountry->DEACTIVATED == 1 ? "" : "disabled"); ?>
                   ...
                   tabindex="8" value="<?php echo e((is_null($objCountry->DODEACTIVATED) || $objCountry->DODEACTIVATED=='1900-01-01' )?'':
...
<script>
 ...
 var formCountryMst = $( "#frm_mst_country" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[4,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[4,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\country\mstfrm4edit.blade.php ENDPATH**/ ?>