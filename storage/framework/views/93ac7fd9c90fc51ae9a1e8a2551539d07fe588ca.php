...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Additional Material Issue (AMI)</a>
        </div>
...
<form id="trn_frm_mis"  method="POST">   
    <?php echo csrf_field(); ?>
    <?php echo e(isset($objResponse->MISPID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="MIS_NO" id="MIS_NO" value="<?php echo e(isset($objResponse->MISP_NO) && $objResponse->MISP_NO !=''?$objResponse->MISP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      </div>
			
			<div class="col-lg-1 pl"><p>AMI Date*</p></div>
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MIS_DT" id="MIS_DT" value="<?php echo e(isset($objResponse->MISP_DT) && $objResponse->MISP_DT !=''?$objResponse->MISP_DT:''); ?>" class="form-control mandatory" >
      </div>
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> style="width:100px;" type="text" name="txtRGP_popup_<?php echo e($key); ?>" id="txtRGP_popup_<?php echo e($key); ?>" value="<?php echo e($row->MRSP_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                  <td><input type="text" name="PRO_NO_<?php echo e($key); ?>" id="PRO_NO_<?php echo e($key); ?>" value="<?php echo e($row->PRO_NO); ?>" class="form-control" autocomplete="off" style="width:130px;" readonly   /></td>
                  <td hidden><input type="hidden" name="RGP_NO_<?php echo e($key); ?>" id="RGP_NO_<?php echo e($key); ?>" value="<?php echo e($row->MRSPID_REF); ?>"  class="form-control" autocomplete="off" /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SE_QTY_".$key); ?> id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" readonly onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="<?php echo e($row->MRSP_QTY_BL); ?>" autocomplete="off"  /></td>
...
$('#btnPdf').on('click', function() {
  var SONO = objSO.MISPID;
  var Flag = 'P';
  var formData = 'SO='+ SONO + '&MISPID='+ SONO + '&Flag='+ Flag ;
  var consultURL = '<?php echo e(route("transaction",[387,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
    ...
    $.ajax({
        url:'<?php echo e(route("transaction",[387,"ViewReport"])); ?>',
        type:'POST',
        data:formData,
        success:function(data) {
            $('#ReportView').show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\AdditionalMaterialIssue\trnfrm387view.blade.php ENDPATH**/ ?>