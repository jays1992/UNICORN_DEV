  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="BRC_OUT_NO" id="BRC_OUT_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BRC_OUT_DT" id="BRC_OUT_DT" value="<?php echo e(old('BRC_OUT_DT')); ?>" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("BRC_OUT_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' class="form-control mandatory"  placeholder="dd/mm/yyyy" >
                  ...
                  <th <?php echo e($AlpsStatus['hidden']); ?> ><?php echo e(isset($TabSetting->FIELD10) && $TabSetting->FIELD10 !=''?$TabSetting->FIELD10:'Add. Info OEM Part No.'); ?></th>
                   ...
                   <th <?php echo e($checkCompany==''? '':'hidden'); ?>>Alt Qty (MU)</th>           
                         ...
                         <td><input  type="text" name="Main_popupITEMID_0" id="Main_popupITEMID_0" class="form-control"  autocomplete="off"  readonly/></td>
                          ...
                          <td <?php echo e($checkCompany==''? '':'hidden'); ?>><input type="text" name="Alt_RECEIVED_QTY_0" id="Alt_RECEIVED_QTY_0" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" onchange="get_materital_item();" maxlength="13"  autocomplete="off"   /></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\BarcodeOut\trnfrm419add.blade.php ENDPATH**/ ?>