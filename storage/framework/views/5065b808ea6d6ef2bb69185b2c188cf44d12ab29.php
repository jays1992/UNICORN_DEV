<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          <?php echo csrf_field(); ?>
          <?php echo e(isset($objResponse->ITEMGID) ? method_field('PUT') : ''); ?>
          ...
          <div class="inner-form">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="hidden" name="ITEMGID" id="ITEMGID" value="<?php echo e($objResponse->ITEMGID); ?>" />
                    <input type="hidden" name="GROUPCODE" id="GROUPCODE" value="<?php echo e($objResponse->GROUPCODE); ?>" autocomplete="off"  maxlength="20"   />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="GROUPNAME" id="GROUPNAME" class="form-control mandatory" value="<?php echo e(old('GROUPNAME',$objResponse->GROUPNAME)); ?>" maxlength="200" tabindex="1"  />
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        <?php $__currentLoopData = $objDataResponse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr  class="participantRow">
                              <td><input <?php echo e(isset($row->ISGCODE) && $row->ISGCODE !=""?'readonly':''); ?>  class="form-control w-100" type="text" name=<?php echo e("ISGCODE_".$key); ?> id =<?php echo e("txtisgcode_".$key); ?>  value="<?php echo e($row->ISGCODE); ?>" maxlength="20" autocomplete="off" style="text-transform:uppercase;width:100%;" onkeypress="return AlphaNumaric(event,this)" ></td>
                              <td>
                              <input  class="form-control w-100" type="text" name=<?php echo e("DESCRIPTIONS_".$key); ?> id =<?php echo e("txtdesc_".$key); ?> value="<?php echo e($row->DESCRIPTIONS); ?>" maxlength="200" autocomplete="off" style="width:100%;" >
                              </td>
...
$('#btnAdd').on('click', function() {
 ...
 var formDataMst = $( "#frm_mst_edit" );
    ...
    window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[74,"update"])); ?>',
            type:'POST',
            data:formData,
    ...
    window.fnApproveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("mastermodify",[74,"singleapprove"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\ItemGroupAndSubGroup\mstfrm74edit.blade.php ENDPATH**/ ?>