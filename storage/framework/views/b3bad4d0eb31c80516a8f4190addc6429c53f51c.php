<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_import" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[48,"importexcelindb"])); ?>' > 
          <?php echo csrf_field(); ?>
          ...
          <div class="inner-form">
            ...
            <div class="col-lg-4 pl">
              <a href="<?php echo e(route("mastermodify",[48,"downloadexcelsamplefile"])); ?>"  >download</a>              
            </div>            
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorMaster\mstfrm48importexcel.blade.php ENDPATH**/ ?>