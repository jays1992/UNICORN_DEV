<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label> <?php echo e($objResponse->REIMBURSE_DOCNO); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objResponse->REIMBURSEID); ?>" class="form-control" maxlength="50" >
			</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\FullAndFinalSettlement\trnfrm417attachment.blade.php ENDPATH**/ ?>