...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[341,'index'])); ?>" class="btn singlebt">Receipt Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                <?php $__currentLoopData = $objCashBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cindex=>$cRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cRow->BID); ?>" selected><?php echo e($cRow->BCODE); ?>-<?php echo e($cRow->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>                            
                            <div class="col-lg-3 pl"><p>Receipt For</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="RECEIPTFOR[]" data-hide-disabled="hide"  data-actions-box="true" id="RECEIPTFOR" class="form-control selectpicker"  data-live-search="true"  >
                        ...
                        <div class="row">                           
                            <div class="col-lg-3 pl"><p>Receipt No</p></div>
                            <div class="col-lg-3 pl" id="">
                                <select name="RECEIPTID[]" data-hide-disabled="hide" multiple data-actions-box="true" id="RECEIPTID" class="form-control selectpicker" multiple data-live-search="true"  >
                                <?php $__currentLoopData = $objReceiptNo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pindex=>$PRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($PRow->RECEIPTID); ?>" selected><?php echo e($PRow->RECEIPT_NO); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[341,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        var RECEIPTFOR = [];
        $("select[name='RECEIPTFOR[]']").each(function() {
            var value6 = $(this).val();
            if (value6) {
                RECEIPTFOR.push(value6);
            }
        });
        
        var RECEIPTID = [];
        $("select[name='RECEIPTID[]']").each(function() {
            var value5 = $(this).val();
            if (value5) {
                RECEIPTID.push(value5);
            }
        });
        ...
        else if(RECEIPTFOR  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select RECEIPT For.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else if(RECEIPTID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select RECEIPT No.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[341,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\Receipt_Report\rptfrm341.blade.php ENDPATH**/ ?>