...
<div class="container-fluid topnav">
  <div class="row">
      ...
      <div class="col-lg-10 topnav-pd">
        ...
        <button class="btn topnavbt" id="btnSaveLOBAttachment" ><i class="fa fa-floppy-o"></i> Save</button>
...
<!-- multiple table-responsive table-wrapper-scroll-y my-custom-scrollbar -->
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_se_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("mastermodify",[390,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> <?php echo e($objLeaveOpeningBalance->LOB_NO); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objLeaveOpeningBalance->LEAVE_OPBLID); ?>" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> <?php echo e(date("d/m/Y", strtotime($objLeaveOpeningBalance->INDATE) )); ?> </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='<?php echo e(date("Y-m-d", strtotime($objLeaveOpeningBalance->INDATE))); ?>'   />
...
<script>  
 ...
 var formSOMst = $( "#frm_se_attachment" );
    ...
    //validate
    $( "#btnSaveLOBAttachment" ).click(function() {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Payroll\LeaveOpeningBalance\mstfrm390attachment.blade.php ENDPATH**/ ?>