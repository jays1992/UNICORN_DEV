    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input disabled type="text" name="QIJNO" id="QIJNO" VALUE="<?php echo e(isset($HDR->QIJNO)?$HDR->QIJNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>QIJ Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="QIJDT" id="QIJDT" VALUE="<?php echo e(isset($HDR->QIJDT)?$HDR->QIJDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
            <input disabled type="text" name="TEXT_GRJID_REF_DATA" id="TEXT_GRJID_REF_DATA" VALUE="<?php echo e(isset($HDR->GRNNO)?$HDR->GRNNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GRJID_REF" id="GRJID_REF" VALUE="<?php echo e(isset($HDR->GRJID_REF)?$HDR->GRJID_REF:''); ?>" class="form-control" autocomplete="off" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
              ...
              <input type="hidden"  name="GEJWOID_REF"  id="GEJWOID_REF" VALUE="<?php echo e(isset($HDR->GEJWOID_REF)?$HDR->GEJWOID_REF:''); ?>"  class="form-control" autocomplete="off" />
              <input type="hidden"  name="JWCID_REF"    id="JWCID_REF"   VALUE="<?php echo e(isset($HDR->JWCID_REF)?$HDR->JWCID_REF:''); ?>"   class="form-control" autocomplete="off" />
              <input type="hidden"  name="JWOID_REF"    id="JWOID_REF"   VALUE="<?php echo e(isset($HDR->JWOID_REF)?$HDR->JWOID_REF:''); ?>"  class="form-control" autocomplete="off" />
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="GRJ_REC_QTY" id="GRJ_REC_QTY" VALUE="<?php echo e(isset($HDR->GRJ_REC_QTY)?$HDR->GRJ_REC_QTY:''); ?>" class="form-control"  autocomplete="off" readonly />
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\QualityInspection\trnfrm358view.blade.php ENDPATH**/ ?>