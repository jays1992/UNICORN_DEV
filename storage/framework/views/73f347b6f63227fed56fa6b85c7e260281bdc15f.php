...
<div class="container-fluid topnav">
	<div class="row">
		<div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Requisition against PRO</a></div>
...
<form id="production_order_edit" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >  
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="RPRID" id="RPRID" value="<?php echo e(isset($objResponse)?$objResponse->RPRID:''); ?>" class="form-control" readonly  autocomplete="off"   >
					<input <?php echo e($ActionStatus); ?> type="text" name="RPRO_NO" id="RPRO_NO" value="<?php echo e(isset($objResponse)?$objResponse->RPR_NO:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
					<span class="text-danger" id="ERROR_RPRO_NO"></span>
				</div>
					  
				<div class="col-lg-2 pl"><p>RPR Date</p></div>
				<div class="col-lg-2 pl">
					<input <?php echo e($ActionStatus); ?> type="date" name="RPR_DT" id="RPR_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse)?$objResponse->RPR_DT:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="pro_popup" id="txtpro_popup" class="form-control mandatory"  value="<?php echo e($objPRO2->PRO_NO); ?>" autocomplete="off" disabled readonly/>
          <input type="hidden" name="PROID_REF" value="<?php echo e($objPRO2->PROID); ?>" id="PROID_REF" class="form-control" autocomplete="off" />           
        </div>
        <div class="col-lg-2 pl"><p>PRO Title</p></div>
        <div class="col-lg-4 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="TITLE" id="TITLE" class="form-control" value="<?php echo e($objPRO2->PRO_TITLE); ?>"  autocomplete="off" readonly>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="stage_popup" id="txtpstage_popup" value="<?php echo e($objPStage2->PSTAGE_CODE); ?>-<?php echo e($objPStage2->DESCRIPTIONS); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          <input type="hidden" name="PSTAGEID_REF" id="PSTAGEID_REF" value="<?php echo e($objPStage2->PSTAGEID); ?>" class="form-control"  />           
        </div>       
        <div class="col-lg-2 pl"><p>Store</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="store_popup" id="txtstore_popup" value="<?php echo e($objStore2->STCODE); ?>-<?php echo e($objStore2->NAME); ?>"  class="form-control mandatory"  autocomplete="off" readonly/>
          <input type="hidden" name="STID_REF" id="STID_REF" value="<?php echo e($objStore2->STID); ?>"  class="form-control"  />           
        </div>       
        <div class="col-lg-2 pl"><p>Requested By</p></div>
        <div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="employee_popup" id="txtemployee_popup" value="<?php echo e($objEmployee2->EMPCODE); ?>-<?php echo e($objEmployee2->FNAME); ?> <?php echo e($objEmployee2->LNAME); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
          <input type="hidden" name="EMPID_REF" id="EMPID_REF"  value="<?php echo e($objEmployee2->EMPID); ?>" class="form-control"  />           
        </div>       
      </div>  
			...
			<div class="row">
				...
				<div class="tab-content">
						...
						<div class="table-responsive table-wrapper-scroll-y" style="margin-top:10px;" >
							<table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
								<thead id="thead1"  style="position: sticky;top: 0">
									<tr>
										<th  hidden><input class="form-control" type="text" name="Row_Count1" id ="Row_Count1" value="<?php echo e(count($objMAT)); ?>" style="width: 50px;"></th>
                  ...
                  ?>
                    ...
                    <td><input <?php echo e($ActionStatus); ?>  type="text"   name="popupFGI_<?php echo e($key); ?>" id="popupFGI_<?php echo e($key); ?>" value="<?php echo e($row->MAINITEM_CODE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?> type="text"    name="FGIName_<?php echo e($key); ?>" id="FGIName_<?php echo e($key); ?>" value="<?php echo e($row->MAINITEM_NAME); ?>"  class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text" name="popupMAINITEMUOM_<?php echo e($key); ?>" id="popupMAINITEMUOM_<?php echo e($key); ?>" value="<?php echo e($row->MAINITEM_UOMCODE); ?>-<?php echo e($row->MAINITEM_UOMDESC); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;"/></td>
                    ...
                    <td><input <?php echo e($ActionStatus); ?>	type="text"	name="popupMUOM_<?php echo e($key); ?>"	id="popupMUOM_<?php echo e($key); ?>"	value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>"	class="form-control"  autocomplete="off"  readonly style="width:100px;"/></td>
										...
										<td><input <?php echo e($ActionStatus); ?> type="text"   name="QTY_<?php echo e($key); ?>" 		id="QTY_<?php echo e($key); ?>" 		value="<?php echo e($row->BAL_CHANGES_PD_OR_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="REQ_QTY_<?php echo e($key); ?>" id="REQ_QTY_<?php echo e($key); ?>"  value="<?php echo e(number_format($row->REQ_QTY,3,".","")); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" onKeyup="change_production_order(this.id,this.value)"  /></td>
                    <td><input type="text" name="STOCK_INHAND_<?php echo e($key); ?>" id="STOCK_INHAND_<?php echo e($key); ?>"  value="<?php echo e(isset($row->TOTAL_STOCK) ? $row->TOTAL_STOCK:'0.00'); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                    <td><input <?php echo e($ActionStatus); ?> type="text"   name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e($row->REMARKS); ?>" class="form-control" maxlength="200"  autocomplete="off" style="width:200px;" /></td>
					...
					<div class="table-responsive table-wrapper-scroll-y " style="margin-top:10px;height:280px;width:50%;">
						<table id="example3" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
							...
							<tr  class="participantRow3">
								<td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("popupSEID_".$uindex); ?> id=<?php echo e("popupSEID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFRPRID_REF); ?>" autocomplete="off"  readonly/></td>
								<td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFRPRID_REF); ?>" autocomplete="off"   /></td>
								<td hidden><input type="hidden" name=<?php echo e("UDFismandatory_".$uindex); ?> id=<?php echo e("UDFismandatory_".$uindex); ?> value="<?php echo e($uRow->UDFRPRID_REF); ?>" class="form-control"   autocomplete="off" /></td>
    ...
    <tr>
      ...
      <table id="ProdStageTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tr >
          ...
          <td class="ROW2"><?php echo e($pstage_Row-> PSTAGE_CODE); ?>

          <input type="hidden" id="txtpstage_<?php echo e($index); ?>" data-desc="<?php echo e($pstage_Row->PSTAGE_CODE); ?>-<?php echo e($pstage_Row->DESCRIPTIONS); ?>"  value="<?php echo e($pstage_Row->PSTAGEID); ?>"/>
          </td>
        ...
        <tr>
          ...
          <table id="storeTable2" class="display nowrap table  table-striped table-bordered">
            ...
            <td class="ROW1"> <input type="checkbox" name="SELECT_STID_REF[]" id="store_<?php echo e($index); ?>" class="clsstore" value="<?php echo e($store_Row->STID); ?>" ></td>
              <td class="ROW2"><?php echo e($store_Row->STCODE); ?>

              <input type="hidden" id="txtstore_<?php echo e($index); ?>" data-desc="<?php echo e($store_Row->STCODE); ?>-<?php echo e($store_Row->NAME); ?>"  value="<?php echo e($store_Row->STID); ?>"/>
              </td>
          ...
          <table id="FGITable" class="display nowrap table  table-striped table-bordered" style="width:100%" >
            ...
            <tbody>
              <tr>
                ...
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="fgiItemAPNsearch" class="form-control" onkeyup="FGIItemAPNFunction(event)"></td>
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="fgiItemCPNsearch" class="form-control" onkeyup="FGIItemCPNFunction(event)"></td>
                <td style="width:8%;" <?php echo e($AlpsStatus['hidden']); ?> ><input type="text" id="fgiItemOEMPNsearch" class="form-control" onkeyup="FGIItemOEMPNFunction(event)"></td>
...
function validateForm(actionType,actionMsg){
  ...
  if(RPRO_NO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#RPR_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\RequisitionAgainstPRO\trnfrm273edit.blade.php ENDPATH**/ ?>