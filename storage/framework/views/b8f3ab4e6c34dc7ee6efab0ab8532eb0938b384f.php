            ...
            <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">     
                              ...
                              <input type="hidden" id="BOMID_COPY" value="<?php echo e(isset($objBOM->BOMID)?$objBOM->BOMID:''); ?>">
                              <input type="hidden" id="STATUS" value="<?php echo e(isset($objBOM->STATUS)?$objBOM->STATUS:''); ?>">    
                                                      
                                <input <?php echo e($InputStatus); ?> type="text" name="BOMNO" id="BOMNO" class="form-control mandatory" value="<?php echo e(isset($objBOM->BOM_NO)?$objBOM->BOM_NO:''); ?>" readonly  autocomplete="off" style="text-transform:uppercase" >
                       
                            </div>
                            <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="date" name="BOM_DT" id="BOM_DT" class="form-control mandatory" autocomplete="off" value="<?php echo e(isset($objBOM->BOM_DT)?$objBOM->BOM_DT:''); ?>" placeholder="dd/mm/yyyy" >
                               
                            </div>    
                            <div class="col-lg-2 pl"><p>Product Code</p></div>
                            <div class="col-lg-2 pl">
                            <input <?php echo e($InputStatus); ?> type="text" name="ITEM_popup" id="txtitem_popup"  class="form-control mandatory" value="<?php echo e(isset($objBOM->ICODE)?$objBOM->ICODE:''); ?>"   autocomplete="off" readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <input <?php echo e($InputStatus); ?> type="text" name="DESCRIPTION" id="DESCRIPTION" class="form-control mandatory" value="<?php echo e(isset($objBOM->NAME)?$objBOM->NAME:''); ?>" readonly  autocomplete="off"  >
                            </div>       
                            <div class="col-lg-2 pl"><p>UOM	 </p></div>
                            <div class="col-lg-2 pl">
                            <input <?php echo e($InputStatus); ?> type="text" name="UOMID_REF_DESC" id="UOMID_REF_DESC" value="<?php echo e(isset($objBOM->UOMCODE)?$objBOM->UOMCODE:''); ?> <?php echo e(isset($objBOM->DESCRIPTIONS)?'-'.$objBOM->DESCRIPTIONS:''); ?>"  class="form-control mandatory" readonly  autocomplete="off"  >
                            <input type="hidden" name="UOMID_REF" id="UOMID_REF" value="<?php echo e(isset($objBOM->UOMID_REF)?$objBOM->UOMID_REF:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  >
                            </div>      
                            <div class="col-lg-2 pl"><p>Produce Qty	 </p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="PRODUCEQTY" id="PRODUCEQTY" value="<?php echo e(isset($objBOM->PRODUCE_QTY)?$objBOM->PRODUCE_QTY:''); ?>" class="form-control"  autocomplete="off"   />
                             </div>                  
                        ...
                        <div class="col-lg-2 pl"><p>Alt Qty	 </p></div>
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="PRODUCTION_STAGE_POPUP" id="PRODUCTION_STAGE_POPUP" value="<?php echo e(isset($objBOM->PSTAGE_CODE)?$objBOM->PSTAGE_CODE:''); ?> <?php echo e(isset($objBOM->PSTAGE_NAME)?'-'.$objBOM->PSTAGE_NAME:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="DESIGNNO" id="DESIGNNO" class="form-control" value="<?php echo e(isset($objBOM->DESIGN_NO)?$objBOM->DESIGN_NO:''); ?>"  autocomplete="off" style="text-transform:uppercase"  />
                            </div>
                        ...
                        <div class="col-lg-2 pl"><p>Drawing No </p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($InputStatus); ?> type="text" name="DRAWINGNO" id="DRAWINGNO" class="form-control" value="<?php echo e(isset($objBOM->DRAWING_NO)?$objBOM->DRAWING_NO:''); ?>" maxlength="100" autocomplete="off" style="text-transform:uppercase">
                            </div>

                          <div class="col-lg-2 pl"><p>Part No </p></div>
                          <div class="col-lg-2 pl">
                              <input <?php echo e($InputStatus); ?> type="text" name="PART_NO" id="PART_NO" class="form-control" value="<?php echo e(isset($objBOM->PARTNO)?$objBOM->PARTNO:''); ?>" autocomplete="off" readonly>
                          </div>
                     
                                               
                            <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl" >
                                <input <?php echo e($InputStatus); ?> type="text" name="REMARKS" id="REMARKS" class="form-control" value="<?php echo e(isset($objBOM->REMARKS)?$objBOM->REMARKS:''); ?>"  autocomplete="off"  />
                ...
                <div class="col-lg-2 pl">
                <input <?php echo e($InputStatus); ?> type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e(isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? "checked" : ""); ?> value='<?php echo e(isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2"  >
                </div>
                
                <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
                <div class="col-lg-2 pl">
                  <input <?php echo e($InputStatus); ?> type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e(isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($objBOM->DODEACTIVATED) && $objBOM->DODEACTIVATED !="" && $objBOM->DODEACTIVATED !="1900-01-01" ? $objBOM->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  />
                </div>
             </div>
                    ...
                    <?php if(!empty($objOSOMAT)): ?>
                      <?php $__currentLoopData = $objOSOMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
                        ...
                        <input  class="form-control" type="hidden" name=<?php echo e("BOM_MATID_".$key); ?> id =<?php echo e("BOM_MATID_".$key); ?> maxlength="100" value="<?php echo e($row->BOM_MATID); ?>" autocomplete="off"   >
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupITEMID_".$key); ?> id =<?php echo e("popupITEMID_".$key); ?> class="form-control" value="<?php echo e($row->ICODE); ?>"  autocomplete="off"  readonly/></td>
                            ...
                            <input <?php echo e($InputStatus); ?> type="text" name="rowscount1[]"  />
                            </td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemName_".$key); ?> id =<?php echo e("ItemName_".$key); ?>  value="<?php echo e($row->NAME); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemPartno_".$key); ?> id =<?php echo e("ItemPartno_".$key); ?>  value="<?php echo e($row->PARTNO); ?>"  class="form-control" maxlength="200" readonly autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUOM_".$key); ?> id =<?php echo e("popupUOM_".$key); ?>  value="<?php echo e($row->UOMCODE.'-'.$row->DESCRIPTIONS); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("ItemStockih_".$key); ?> id=<?php echo e("ItemStockih_".$key); ?> value="<?php echo e(isset($row->STOCK_IN_HAND) && $row->STOCK_IN_HAND !=''?$row->STOCK_IN_HAND:0); ?>"  class="form-control"  autocomplete="off"  readonly/></td>

                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("CONSUMEQTY_".$key); ?> id =<?php echo e("CONSUMEQTY_".$key); ?>  value="<?php echo e($row->CONSUME_QTY); ?>"  class="form-control" maxlength="200" autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("PRODUCTIONQTY_".$key); ?> id =<?php echo e("PRODUCTIONQTY_".$key); ?>  value="<?php echo e($row->LOSS_PRODUCTION_QTY); ?>" class="form-control" maxlength="200" autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SCRAPQTY_".$key); ?> id =<?php echo e("SCRAPQTY_".$key); ?>  value="<?php echo e($row->WASTEAGE_SCRAP_QTY); ?>"  class="form-control" maxlength="200" autocomplete="off"  /></td>
							<td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("REMARKS_".$key); ?> id =<?php echo e("REMARKS_".$key); ?>  value="<?php echo e($row->REMARKS); ?>"  class="form-control" maxlength="200" autocomplete="off"  /></td>
                    ...
                    <?php if(!empty($objSUB)): ?>
                      <?php $__currentLoopData = $objSUB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
                        ...
                        <input  class="form-control" type="hidden" name=<?php echo e("BOM_SUBID_".$key); ?> id =<?php echo e("BOM_SUBID_".$key); ?> maxlength="100" value="<?php echo e($row->BOM_SUBID); ?>" autocomplete="off"   >
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemCode_".$key); ?> id =<?php echo e("MainItemCode_".$key); ?> value="<?php echo e($row->ICODE2); ?>"  onclick="get_item($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <input <?php echo e($InputStatus); ?> type="text" name="rowscount2[]"  />
                            </td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemName_".$key); ?> id =<?php echo e("MainItemName_".$key); ?> value="<?php echo e($row->NAME2); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemCode1_".$key); ?> id =<?php echo e("MainItemCode1_".$key); ?> value="<?php echo e($row->ICODE); ?>"  onclick="get_item_substitute($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemName1_".$key); ?> id =<?php echo e("MainItemName1_".$key); ?> value="<?php echo e($row->NAME); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                                                             
                           
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemPartno1_".$key); ?> id =<?php echo e("MainItemPartno1_".$key); ?> value="<?php echo e($row->PARTNO); ?>"  class="form-control"  autocomplete="off"  readonly/></td> 

                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("MainItemuom1_".$key); ?> id =<?php echo e("MainItemuom1_".$key); ?> value="<?php echo e($row->UOMCODE.'-'.$row->DESCRIPTIONS); ?>"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("CONSUMEQTY1_".$key); ?> id =<?php echo e("CONSUMEQTY1_".$key); ?> value="<?php echo e($row->CONSUME_QTY); ?>" class="form-control"  autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("PRODUCTION1_".$key); ?> id =<?php echo e("PRODUCTION1_".$key); ?> value="<?php echo e($row->LOSS_PRODUCTION_QTY); ?>"  class="form-control"  autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("SCRAP1_".$key); ?> id =<?php echo e("SCRAP1_".$key); ?> value="<?php echo e($row->WASTEAGE_SCRAP_QTY); ?>"  class="form-control"  autocomplete="off"  /></td>
                            <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button <?php echo e($InputStatus); ?> class="btn remove smaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                        ...
                        <tr  class="participantRow1">
                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemCode_0" id="MainItemCode_0" onclick="get_item($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            <td hidden><input type="hidden" name="MainItemId_Ref_0" id="MainItemId_Ref_0" class="form-control" autocomplete="off" />
                            <input <?php echo e($InputStatus); ?> type="text" name="rowscount2[]"  />
                            </td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemName_0" id="MainItemName_0" class="form-control"  autocomplete="off"  readonly/></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemCode1_0" id="MainItemCode1_0" onclick="get_item_substitute($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            <td hidden><input type="hidden" name="MainItemId1_Ref_0" id="MainItemId1_Ref_0" class="form-control" autocomplete="off" /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemName1_0" id="MainItemName1_0" class="form-control"  autocomplete="off"  readonly/></td>
                                                              
                            
                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemPartno1_0" id="MainItemPartno1_0" class="form-control"  autocomplete="off"  readonly/></td> 

                            <td><input <?php echo e($InputStatus); ?> type="text" name="MainItemuom1_0" id="MainItemuom1_0" class="form-control"  autocomplete="off"  readonly/></td>
                            <td hidden><input type="hidden" name="Mainuom_ref1_0" id="Mainuom_ref1_0" class="form-control"  autocomplete="off" /></td>
                    
                            <td><input <?php echo e($InputStatus); ?> type="text" name="CONSUMEQTY1_0" id="CONSUMEQTY1_0" class="form-control"  autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name="PRODUCTION1_0" id="PRODUCTION1_0" class="form-control"  autocomplete="off"  /></td>
                            <td><input <?php echo e($InputStatus); ?> type="text" name="SCRAP1_0" id="SCRAP1_0" class="form-control"  autocomplete="off"  /></td>
                            <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button <?php echo e($InputStatus); ?> class="btn remove smaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                ...
                <table id="example5" class="display nowrap table table-striped table-bordered itemlist" style="height:auto !important;">
                    ...
                    <?php if(!empty($objOSOUDF)): ?>
                        ...
                        <input  class="form-control" type="hidden" name=<?php echo e("BOM_UDFID_".$Ukey); ?> id =<?php echo e("BOM_UDFID_".$Ukey); ?> maxlength="100" value="<?php echo e($Urow->BOM_UDFID); ?>" autocomplete="off"   >
                                   ...
                                   <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUDFBOMID_".$Ukey); ?> id=<?php echo e("popupUDFBOMID_".$Ukey); ?>  class="form-control"  autocomplete="off"  readonly/></td>
                      ...
                      <tr  class="participantRow3">
                          <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("popupUDFBOMID_".$uindex); ?> id=<?php echo e("popupUDFBOMID_".$uindex); ?> class="form-control" value="<?php echo e($uRow->LABEL); ?>" autocomplete="off"  readonly/></td>
...
<div id="direct_cost" class="tab-pane fade">
                    ...
                    <?php if(!empty($objOTH)): ?>
                      <?php $__currentLoopData = $objOTH; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                        ...
                        <input  class="form-control" type="hidden" name=<?php echo e("BOM_OTHID_".$key); ?> id =<?php echo e("BOM_OTHID_".$key); ?> maxlength="100" value="<?php echo e($row->BOM_OTHID); ?>" autocomplete="off"   >
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("Componentname_".$key); ?> id =<?php echo e("Componentname_".$key); ?> value="<?php echo e($row->CCOMPONENT_CODE.'-'.$row->DESCRIPTIONS); ?>"   onclick="get_item_component($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <td><input <?php echo e($InputStatus); ?> type="text" name=<?php echo e("value_".$key); ?> id =<?php echo e("value_".$key); ?> maxlength="100" value="<?php echo e($row->VALUE); ?>"  class="form-control"  autocomplete="off"  /></td>
                            <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add dcmaterial" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button <?php echo e($InputStatus); ?> class="btn remove dcmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
                        ...
                        <tr  class="participantRow10">
                            <td><input <?php echo e($InputStatus); ?> type="text" name="Componentname_0" id="Componentname_0" onclick="get_item_component($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            <td hidden><input type="hidden" name="Componentid_0" id="Componentid_0" class="form-control" autocomplete="off" />
                            <input type="text" name="rowscount5[]"  />
                            </td>
                           
                     
                            <td><input <?php echo e($InputStatus); ?> type="text" name="value_0" id="value_0" class="form-control"  autocomplete="off"  /></td>
                            <td align="center" ><button <?php echo e($InputStatus); ?> class="btn add dcmaterial" title="add" data-toggle="tooltip" type="button"><i class="fa fa-plus"></i></button><button <?php echo e($InputStatus); ?> class="btn remove dcmaterial" title="Delete" data-toggle="tooltip" type="button"><i class="fa fa-trash" ></i></button></td>
        ...
        <div id="instruction" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
           <textarea <?php echo e($InputStatus); ?> name="instruction" id="instruction" cols="85" rows="8"><?php echo e(isset($objBOM->SPECIAL_INSTRUCTION)?$objBOM->SPECIAL_INSTRUCTION:''); ?></textarea>
            </div>
        </div>
...
if(BOMNO ===""){
 ...
 else if(getExistProductCode("<?php echo e(isset($objBOM->BOMID)?$objBOM->BOMID:''); ?>",PRODUCT_CODE) > 0){
     $("#FocusId").val('txtitem_popup');
     $("#ProceedBtn").focus();
     $("#YesBtn").hide();
     $("#NoBtn").hide();
...
$.ajax({
    url:'<?php echo e(route("mastermodify",[202,"update"])); ?>',
    type:'POST',
    data:formData,
    success:function(data) {
...
if(STATUS=='C'){
  ...
  return false;
        ...
        var copyURL = '<?php echo e(route("master",[202,"copy",":rcdId"])); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\BillofMaterial\mstfrm202edit.blade.php ENDPATH**/ ?>