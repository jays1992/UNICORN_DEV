          ...
          <div class="inner-form">
           ...
           <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    ...
                    <input type="text" name="METER_CODE" id="METER_CODE" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="METER_DESC" id="METER_DESC" class="form-control mandatory" value="<?php echo e(old('METER_DESC')); ?>" maxlength="200"  />
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[223,"codeduplicate"])); ?>',
            type:'POST',
            data:formData,
   ...
   window.fnSaveData = function (){
        ...
        $.ajax({
            url:'<?php echo e(route("master",[223,"save"])); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "<?php echo e(route('master',[223,'add'])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\PlantMaintenance\EnergyMeter\mstfrm223add.blade.php ENDPATH**/ ?>