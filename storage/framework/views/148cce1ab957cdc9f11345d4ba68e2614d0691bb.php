...
<!-- <form id="frm_trn_so" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Credit Note (Stock & Value)<br/> CSV</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
            <?php echo csrf_field(); ?>
            <?php echo e(isset($objSO->CSVID[0]) ? method_field('PUT') : ''); ?>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="CSV_NO" id="CSV_NO" value="<?php echo e(isset($objSO->CSV_NO)?$objSO->CSV_NO:''); ?>" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>CSV Date</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="date" name="CSV_DT" id="CSV_DT" value="<?php echo e(isset($objSO->CSV_DT)?$objSO->CSV_DT:''); ?>" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>

                            <div class="col-lg-2 pl"><p>Customer</p></div>
                            <div class="col-lg-2 pl">
                                <input <?php echo e($ActionStatus); ?> type="text" name="SubGl_popup" id="txtgl_popup" value="<?php echo e(isset($objsubglcode->CCODE)?$objsubglcode->CCODE:''); ?><?php echo e(isset($objsubglcode->NAME)?'-'.$objsubglcode->NAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input <?php echo e($ActionStatus); ?> type="text" name="REASONOFSR" id="REASONOFSR" value="<?php echo e(isset($objSO->REASON_CR_NOTE)?$objSO->REASON_CR_NOTE:''); ?>" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="col-lg-2 pl"><p>Direct</p></div>
                            <div class="col-lg-2 pl">
                              <input <?php echo e($ActionStatus); ?> type="checkbox" name="Direct" id="Direct" autocomplete="off" onchange="direct()" value="1" <?php echo e(isset($objSO->DIRECTCSV) && $objSO->DIRECTCSV =='1'?'checked':''); ?>  />
                            </div>
...
<tr  class="participantRow">
  ...
  <td ><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("txtSQ_popup_".$key); ?> id=<?php echo e("txtSQ_popup_".$key); ?> class="form-control" value="<?php echo e($row->SINO); ?>" autocomplete="off"   readonly style="width:100px;" /></td>
  ...
  <td><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOM_<?php echo e($key); ?>" id="SQMUOM_<?php echo e($key); ?>" value="<?php echo e($row->UOMCODE); ?>-<?php echo e($row->DESCRIPTIONS); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  <td><input <?php echo e($ActionStatus); ?> type="text" name="SQMUOMQTY_<?php echo e($key); ?>" id="SQMUOMQTY_<?php echo e($key); ?>" value="<?php echo e($row->SI_QTY); ?>" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
  <td><input <?php echo e($ActionStatus); ?> type="text" name="SI_RATE_<?php echo e($key); ?>" id="SI_RATE_<?php echo e($key); ?>" value="<?php echo e($row->SI_RATE); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
  ...
  <td><input <?php echo e($ActionStatus); ?> type="text" name="SO_QTY_<?php echo e($key); ?>" id="SO_QTY_<?php echo e($key); ?>" value="<?php echo e(isset($row->CR_NOTE_QTY) && $row->CR_NOTE_QTY !=''?$row->CR_NOTE_QTY:'0.00'); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:75px;"  /></td>
  <td hidden><input type="hidden" name="SO_FQTY_<?php echo e($key); ?>" id="SO_FQTY_<?php echo e($key); ?>" value="<?php echo e($row->CR_NOTE_QTY); ?>" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
  ...
  <td  hidden><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->CR_NOTE_QTY); ?>" ></td>
  ...
  <td><input <?php echo e($ActionStatus); ?> type="text" name="RATEPUOM_<?php echo e($key); ?>" id="RATEPUOM_<?php echo e($key); ?>" value="<?php echo e($row->CR_NOTE_RATE); ?>"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
                                        ...
                                        <?php if(!empty($objSOUDF)): ?>
                                            <?php $__currentLoopData = $objSOUDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ukey => $Urow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr  class="participantRow4">
                                                    ...
                                                    <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$Ukey); ?>  id=<?php echo e("UDFSOID_REF_".$Ukey); ?> class="form-control" value="<?php echo e($Urow->UDFCRVID_REF); ?>" autocomplete="off" /></td>
                                            ...
                                            <?php $__currentLoopData = $objUdfSOData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <tr  class="participantRow4">
                                                  ...
                                                  <td hidden><input type="hidden" name=<?php echo e("UDFSOID_REF_".$uindex); ?> id=<?php echo e("UDFSOID_REF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFCRVID); ?>" autocomplete="off"   /></td>
...
function validateForm(saveAction){
  ...
  if(CSV_NO ===""){
    ...
    else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#CSV_DT").val(),0) ==0){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn").hide();
      $("#OkBtn1").show();
...
function getTransactionType(){
  ...
  $.ajaxSetup({
      ...
      $.ajax({
        url:'<?php echo e(route("transaction",[$FormId,"getCSVNo"])); ?>',
        type:'POST',
        data:{dataval:value},
        success:function(data) {
            $("#CSV_NO").val(data);                
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\CreditNoteCsv\trnfrm306view.blade.php ENDPATH**/ ?>