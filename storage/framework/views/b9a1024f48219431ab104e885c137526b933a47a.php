...
<div class="container-fluid filter">
    ...
    <?php echo csrf_field(); ?>  
    <?php echo e(isset($objMstResponse->MRPID) ? method_field('PUT') : ''); ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="hidden" name="MRP_NO" id="MRP_NO" value="<?php echo e($objMstResponse->MRP_NO); ?>" class="form-control mandatory" maxlength="15" tabindex="1" required>
        </div>			
        <div class="col-lg-2 pl"><p>MRP Date</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="MRP_DT" id="MRP_DT" value="<?php echo e((!is_null($objMstResponse->MRP_DT) && $objMstResponse->MRP_DT!='1900-01-01')? \Carbon\Carbon::parse($objMstResponse->MRP_DT)->format('d/m/Y') : ''); ?>"  class="form-control mandatory" tabindex="2" readonly > 
        </div>			
        <div class="col-lg-2 pl"><p>With Effective Date</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="EFFECTIVE_DT" id="EFFECTIVE_DT" value="<?php echo e((!is_null($objMstResponse->EFFECTIVE_DT) && $objMstResponse->EFFECTIVE_DT!='1900-01-01') ? \Carbon\Carbon::parse($objMstResponse->EFFECTIVE_DT)->format('d/m/Y') : ''); ?>"  class="form-control mandatory"  tabindex="3" readonly>  
        </div>
      </div>
      ...
      <div class="row">			
        ...
        <div class="col-lg-4 pl">
          <input type="text" name="MRP_TITLE" id="MRP_TITLE" class="form-control" value="<?php echo e($objMstResponse->MRP_TITLE); ?>" maxlength="200" autocomplete="off"   tabindex="4">
        </div>
      </div>
      ...
      <div class="row">
        ...
        value='<?php echo e($objMstResponse->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="3">
        </div>
              ...
              <table id="table3" class="display nowrap table table-striped table-bordered itemlist itemlistscroll w-200" style="height:auto !important;">
                ...
                <tbody>
                  ...
                  <tr  class="participantRow">
                    <td>
                      <input  class="form-control w-100" type="text" name="ITEMID_REF_<?php echo e($key); ?>" id="TXT_ITEMID_REF_POPUP_<?php echo e($key); ?>" value="<?php echo e($row->ICODE); ?>"  maxlength="20" readonly>
                    </td>
                    <td hidden>
                    ...
                    <td>
                      <input  class="form-control w-100" type="text" name="ITEMNAME_<?php echo e($key); ?>" id="ITEMNAME_<?php echo e($key); ?>" autocomplete="off" value="<?php echo e($row->NAME); ?>"  readonly >
                    </td>
                    <td hidden>
                    ...
                    <td >
                      <input  class="form-control" style="width: 70px" type="text" name="UOM_<?php echo e($key); ?>" id="UOM_<?php echo e($key); ?>" autocomplete="off" value="<?php echo e($row->UOMCODE); ?>" readonly >
                    </td>
                    <td>
                      <input  class="form-control w-100" type="text" name="ITEM_SPEC_<?php echo e($key); ?>" id="ITEM_SPEC_<?php echo e($key); ?>" maxlength="200" value="<?php echo e($row->ITEMSPECI); ?>"  autocomplete="off"  >
                    </td>
                    <td>
                    ...
                    <td>
                      <input  class="form-control " type="text" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" maxlength="200" autocomplete="off" value="<?php echo e($row->REMARKS); ?>" >
                    </td>
                    <td align="center" >
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'<?php echo e(route("master",[30,"update"])); ?>',
        type:'POST',
        data:formData,
...
window.fnApproveData = function (){
  ...
  $.ajax({
      url:'<?php echo e(route("master",[30,"singleapprove"])); ?>',
      type:'POST',
      data:formData,
      success:function(data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Sales\MaximumRetailPrice\mstfrm30edit.blade.php ENDPATH**/ ?>