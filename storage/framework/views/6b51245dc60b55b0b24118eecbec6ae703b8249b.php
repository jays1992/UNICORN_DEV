...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Break Down Complaint Log</a></div>
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="BDCL_DOCNO" id="BDCL_DOCNO"  value="<?php echo e(isset($objResponse->BDCL_NO) && $objResponse->BDCL_NO !=''?$objResponse->BDCL_NO:''); ?>" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase" autofocus >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="BDCL_DATE" id="BDCL_DATE" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->BDCL_DATE) && $objResponse->BDCL_DATE !=''?$objResponse->BDCL_DATE:''); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
          <span class="text-danger" id="ERROR_BDCL_DATE"></span>
        </div>

        <div class="col-lg-2 pl"><p>Time</p></div>
        <div class="col-lg-2 pl">
          <input type="time" name="TIME" id="TIME" value="<?php echo e(isset($TIME) && $TIME !=''?$TIME:''); ?>" class="form-control mandatory"  placeholder="" >
      ...
      <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Complaint By</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_BY" id="COMPLAINT_BY" maxlength="50" value="<?php echo e(isset($objResponse->COMPLAINT_BY) && $objResponse->COMPLAINT_BY !=''?$objResponse->COMPLAINT_BY:''); ?>" class="form-control mandatory"  placeholder="" >
               <span class="text-danger" id="ERROR_COMPLAINT_BY"></span>
                </div>  

                <div class="col-lg-2 pl"><p>Department</p></div>
                <div class="col-lg-2 pl">
                    <input type="text" name="Department_popup" id="txtDepartment_popup" value="<?php echo e(isset($objResponse->DEPARTMENT_CODE) && $objResponse->DEPARTMENT_CODE !=''?$objResponse->DEPARTMENT_CODE.'-'.$objResponse->DEPARTMENT_NAME:''); ?>"  class="form-control mandatory"  autocomplete="off"  readonly/>
                    <input type="hidden" name="DEPARTMENTID_REF" id="DEPARTMENTID_REF" value="<?php echo e(isset($objResponse->DEPID_REF) && $objResponse->DEPID_REF !=''?$objResponse->DEPID_REF:''); ?>" class="form-control" autocomplete="off" />
                ...
                <div class="col-lg-2 pl">
                    <input type="text" name="Priority_popup" id="txtPriority_popup" value="<?php echo e(isset($objResponse->PRIORITYCODE) && $objResponse->PRIORITYCODE !=''?$objResponse->PRIORITYCODE.'-'.$objResponse->PRIORITY_DESC:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
               ...
               <div class="col-lg-2 pl"><p>Complaint To</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="COMPLAINT_TO" id="COMPLAINT_TO" value="<?php echo e(isset($objResponse->COMPLAINT_TO) && $objResponse->COMPLAINT_TO !=''?$objResponse->COMPLAINT_TO:''); ?>" maxlength="50"  class="form-control mandatory"  placeholder="" >
              ...
              <input type="checkbox" name="COMPLAINT_FOR"  id="chk_Machine"  <?php echo e(isset($objResponse) && $objResponse->MACHINE=='1'?'checked':''); ?> value="Machine"  />&nbsp;&nbsp;<label>   Machine </label>
              </div>
              <div class="col-lg-2 pl">
                    <input type="checkbox" name="COMPLAINT_FOR" id="chk_Generator" value="Genset" <?php echo e(isset($objResponse) && $objResponse->GENERATOR=='1'?'checked':''); ?>      /> &nbsp;&nbsp;<label>   Generator </label>
              </div>    
        ...
        <div class="row">
               <div class="col-lg-2 pl"><p>Machine / Genset  Code</p></div>
                <div class="col-lg-2 pl">
                <input type="text" name="Machinepopup" id="txtMachinepopup" value="<?php echo e(isset($objResponse->MACHINE_NO) && $objResponse->MACHINE_NO !=''?$objResponse->MACHINE_NO.'-'.$objResponse->MACHINE_DESC:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                    <input type="hidden" name="MACHINE_REF" id="MACHINE_REF" value="<?php echo e(isset($objResponse->MACHINEID_REF) && $objResponse->MACHINEID_REF !=''?$objResponse->MACHINEID_REF:''); ?>" class="form-control" autocomplete="off" />
                    <span class="text-danger" id="ERROR_txtMachinepopup"></span>
                </div>  

                <div class="col-lg-2 pl"><p>Problem Log Detail </p></div>
                <div class="col-lg-6 pl">
                <input type="text" name="PROBLEM_LOG_DET" id="PROBLEM_LOG_DET" maxlength="50" value="<?php echo e(isset($objResponse->PLOG_DETAILS) && $objResponse->PLOG_DETAILS !=''?$objResponse->PLOG_DETAILS:''); ?>" class="form-control mandatory"  placeholder="" >
        ...
        <div class="row">
                ...
                <div class="col-lg-2 pl">
                    <input type="text" name="Reasoncode1_popup" id="txtReasoncode1_popup" value="<?php echo e(isset($objResponse->REASON1_CODE) && $objResponse->REASON1_CODE !=''?$objResponse->REASON1_CODE:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                    <input type="hidden" name="REASONCODE1_REF" id="REASONCODE1_REF" value="<?php echo e(isset($objResponse->BD_REASONID_REF1) && $objResponse->BD_REASONID_REF1 !=''?$objResponse->BD_REASONID_REF1:''); ?>" class="form-control" autocomplete="off" />
                    <span class="text-danger" id="ERROR_Reasoncode1"></span>
                </div>  
                <div class="col-lg-2 pl"><p>Breakdown Reason Description 1</p></div>
                <div class="col-lg-6 pl">
                    <input type="text" name="BREAKDOWN1_REASON_DESC" id="BREAKDOWN1_REASON_DESC" value="<?php echo e(isset($objResponse->REASON1_DESC) && $objResponse->REASON1_DESC !=''?$objResponse->REASON1_DESC:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
        ...
        <div class="col-lg-2 pl"><p>Breakdown Reason Code 2</p></div>
                <div class="col-lg-2 pl">
                    <input type="text" name="Reasoncode2_popup" id="txtReasoncode2_popup" value="<?php echo e(isset($objResponse->REASON2_CODE) && $objResponse->REASON2_CODE !=''?$objResponse->REASON2_CODE:''); ?>" class="form-control mandatory"  autocomplete="off"  readonly/>
                    <input type="hidden" name="REASONCODE2_REF" id="REASONCODE2_REF" value="<?php echo e(isset($objResponse->BD_REASONID_REF2) && $objResponse->BD_REASONID_REF2 !=''?$objResponse->BD_REASONID_REF2:''); ?>" class="form-control" autocomplete="off" />
                    <span class="text-danger" id="ERROR_Reasoncode2"></span>
                </div>  
                <div class="col-lg-2 pl"><p>Breakdown Reason Description 2</p></div>
                <div class="col-lg-6 pl">
                    <input type="text" name="BREAKDOWN2_REASON_DESC" value="<?php echo e(isset($objResponse->REASON2_DESC) && $objResponse->REASON2_DESC !=''?$objResponse->REASON2_DESC:''); ?>" id="BREAKDOWN2_REASON_DESC" class="form-control mandatory"  autocomplete="off"  readonly/>
                ...
                <div class="col-lg-4 pl">
                    <input type="text" name="REMARKS1" id="REMARKS1" class="form-control mandatory" value="<?php echo e(isset($objResponse->REMARKS_1) && $objResponse->REMARKS_1 !=''?$objResponse->REMARKS_1:''); ?>" autocomplete="off"  />
                ...
                <div class="col-lg-4 pl">
                    <input type="text" name="REMARKS2" id="REMARKS2" class="form-control mandatory" value="<?php echo e(isset($objResponse->REMARKS_2) && $objResponse->REMARKS_2 !=''?$objResponse->REMARKS_2:''); ?>" autocomplete="off"  />
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Departmentnamesearch" class="form-control" onkeyup="DepartmentNameFunction()">
      ...
      <table id="DepartmentTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody >     
        <?php $__currentLoopData = $objDepartment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$objDepartmentRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="department[]" id="departmentidcode_<?php echo e($index); ?>" class="clsspid_department"  value="<?php echo e($objDepartmentRow->DEPID); ?>" ></td>



          <td style="width:30%"><?php echo e($objDepartmentRow->DCODE); ?>

          <input type="hidden" id="txtdepartmentidcode_<?php echo e($index); ?>" data-desc="<?php echo e($objDepartmentRow->DCODE); ?> - <?php echo e($objDepartmentRow-> NAME); ?>"  value="<?php echo e($objDepartmentRow->DEPID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($objDepartmentRow-> NAME); ?> </td>
        </tr>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Prioritynamesearch" class="form-control" onkeyup="PriorityNameFunction()">
      ...
      <table id="PriorityTable2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody >     
        <?php $__currentLoopData = $objPriority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$PriorityRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="priority[]" id="priorityidcode_<?php echo e($index); ?>" class="clsspid_priority"  value="<?php echo e($PriorityRow->PRIORITYID); ?>" ></td>



          <td style="width:30%"><?php echo e($PriorityRow->PRIORITYCODE); ?>

          <input type="hidden" id="txtpriorityidcode_<?php echo e($index); ?>" data-desc="<?php echo e($PriorityRow->PRIORITYCODE); ?> - <?php echo e($PriorityRow-> DESCRIPTIONS); ?>"  value="<?php echo e($PriorityRow->PRIORITYID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($PriorityRow-> DESCRIPTIONS); ?> </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Reasoncode1namesearch" class="form-control" onkeyup="Reasoncode1NameFunction()">
      ...
      <table id="Reasoncode1Table2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <tbody >     
        <?php $__currentLoopData = $objReason; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$objReasonRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="reason1[]" id="reasoncode1code_<?php echo e($index); ?>" class="clsspid_reasoncode1"  value="<?php echo e($objReasonRow->BD_REASONID); ?>" ></td>



          <td style="width:30%"><?php echo e($objReasonRow->BD_REASON_CODE); ?>

          <input type="hidden" id="txtreasoncode1code_<?php echo e($index); ?>" data-desc=" <?php echo e($objReasonRow->BD_REASON_DESC); ?>" data-code="<?php echo e($objReasonRow-> BD_REASON_CODE); ?>" value="<?php echo e($objReasonRow->BD_REASONID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($objReasonRow-> BD_REASON_DESC); ?> </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
        </tbody>
      </table>
   ...
   <td style="width:30%;"> 
    ...
    <input type="text" id="Reasoncode2namesearch" class="form-control" onkeyup="Reasoncode2NameFunction()">
      ...
      <table id="Reasoncode2Table2" class="display nowrap table  table-striped table-bordered" width="100%">
        ...
        <?php $__currentLoopData = $objReason; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$objReasonRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr >
        <td style="text-align:center; width:10%"> <input type="checkbox" name="reason2[]" id="reasoncode2code_<?php echo e($index); ?>" class="clsspid_reasoncode2"  value="<?php echo e($objReasonRow->BD_REASONID); ?>" ></td>



          <td style="width:30%"><?php echo e($objReasonRow->BD_REASON_CODE); ?>

          <input type="hidden" id="txtreasoncode2code_<?php echo e($index); ?>" data-desc=" <?php echo e($objReasonRow->BD_REASON_DESC); ?>" data-code="<?php echo e($objReasonRow-> BD_REASON_CODE); ?>" value="<?php echo e($objReasonRow->BD_REASONID); ?>"/>
          </td>
          <td style="width:60%"><?php echo e($objReasonRow-> BD_REASON_DESC); ?> </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
...
function validateForm(actionType,actionMsg){
  ...
  else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#BDCL_DATE").val(),0) ==0){
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn").hide();
    $("#OkBtn1").show();
  ...
  $('#txtMachinepopup').on('click',function(event){  
    var MACHINE_TYPE=$('[name="COMPLAINT_FOR"]:checked').val();
                ...
                $("#Machineresult").html('');
                  ...
                  $("#item_seach").show();
                  $.ajax({
                      url:'<?php echo e(route("transaction",[364,"get_machine_details"])); ?>',
                      type:'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\PlantMaintenance\BreakdownComplaintLog\trnfrm364edit.blade.php ENDPATH**/ ?>