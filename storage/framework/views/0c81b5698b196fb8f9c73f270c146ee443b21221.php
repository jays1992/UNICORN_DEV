...
<div class="container-fluid topnav">
        <div class="row">
            <div class="col-lg-2">
            <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Material Issue Slip (MIS)</a>
            </div>
...
<form id="trn_frm_mis"  method="POST">   
    <?php echo csrf_field(); ?>
    <?php echo e(isset($objResponse->MISID[0]) ? method_field('PUT') : ''); ?>
	...
	<div class="inner-form">
		...
		<div class="row">
			...
			<div class="col-lg-1 pl"><p>MIS No <strong>*</strong></p></div>
			<div class="col-lg-2 pl">
          <input <?php echo e($ActionStatus); ?> type="text" name="MIS_NO" id="MIS_NO" value="<?php echo e(isset($objResponse->MIS_NO) && $objResponse->MIS_NO !=''?$objResponse->MIS_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      </div>
			
			<div class="col-lg-1 pl"><p>MIS Date <strong>*</strong></p></div>
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="MIS_DT" id="MIS_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->MIS_DT) && $objResponse->MIS_DT !=''?$objResponse->MIS_DT:''); ?>" class="form-control mandatory" >
      </div>
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              <?php $__currentLoopData = $objMAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> style="width:100px;" type="text" name="txtRGP_popup_<?php echo e($key); ?>" id="txtRGP_popup_<?php echo e($key); ?>" value="<?php echo e($row->MRS_NO); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                  <td hidden><input type="hidden" name="RGP_NO_<?php echo e($key); ?>" id="RGP_NO_<?php echo e($key); ?>" value="<?php echo e($row->MRSID_REF); ?>"  class="form-control" autocomplete="off" /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("Itemspec_".$key); ?> id=<?php echo e("Itemspec_".$key); ?> value="<?php echo e($row->ITEM_SPECI); ?>" class="form-control"  autocomplete="off"    /></td>
                  
                  <td align="center"><a <?php echo e($ActionStatus); ?> class="btn checkstore"  id="<?php echo e($key); ?>" ><i class="fa fa-clone"></i></a></td>
                  <td hidden ><input type="hidden" name="TotalHiddenQty_<?php echo e($key); ?>" id="TotalHiddenQty_<?php echo e($key); ?>" value="<?php echo e($row->ISSUED_QTY); ?>" ></td>
                  ...
                  <td hidden><input type="text" name="PO_PENDING_QTY_<?php echo e($key); ?>" id="PO_PENDING_QTY_<?php echo e($key); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  /></td>
                         

                  <td><input <?php echo e($ActionStatus); ?> type="text" name=<?php echo e("SE_QTY_".$key); ?> id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" readonly onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="<?php echo e($row->MRS_QTY_BL); ?>" autocomplete="off"  /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="STOCK_INHAND_<?php echo e($key); ?>" id="STOCK_INHAND_<?php echo e($key); ?>" value="<?php echo e($row->STOCK_INHAND); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" readonly  autocomplete="off"   /></td>
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="RECEIVED_QTY_MU_<?php echo e($key); ?>" id="RECEIVED_QTY_MU_<?php echo e($key); ?>" value="<?php echo e($row->ISSUED_QTY); ?>" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"   /></td>
                  ...
                  <td hidden><input type="text" name="SHORT_QTY_<?php echo e($key); ?>" id="SHORT_QTY_<?php echo e($key); ?>"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off"  readonly  /></td>
                  ...
                  <td><input <?php echo e($ActionStatus); ?> type="text" name="REASON_SHORT_QTY_<?php echo e($key); ?>" id="REASON_SHORT_QTY_<?php echo e($key); ?>" value="<?php echo e($row->REASON_SHORT_QTY); ?>" class="form-control"   autocomplete="off"   /></td>
    ...
    <tr>
      ...
      <table id="DpCodeTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <td class="ROW1"> <input type="checkbox" name="SELECT_DEPID_REF[]" id="dpidcode_<?php echo e($key); ?>" class="clsdpid" value="<?php echo e($val-> DEPID); ?>" ></td>
          <td class="ROW2"><?php echo e($val-> DCODE); ?>

          <input type="hidden" id="txtdpidcode_<?php echo e($key); ?>" data-desc="<?php echo e($val-> DCODE); ?> - <?php echo e($val-> NAME); ?>"  value="<?php echo e($val-> DEPID); ?>"/>
          </td>
...
// var lastdt = <?php echo json_encode(isset($objResponse->MIS_DT)?$objResponse->MIS_DT:''); ?>;
// var today = new Date(); 
// var sodate = <?php echo json_encode(isset($objResponse->MIS_DT)?$objResponse->MIS_DT:''); ?>;
...
var lastdt = <?php echo json_encode($objlastdt[0]->MIS_DT); ?>;
  ...
  if(lastdt < mis.MIS_DT)
  {
	$('#MIS_DT').attr('min',lastdt);
  }
  else
  {
	  $('#MIS_DT').attr('min',mis.MIS_DT);
  }
  $('#MIS_DT').attr('max',sodate);
 ...
 if(MIS_NO ===""){
    ...
    // }
      ...
      highlighFocusBtn('activeOk');
        ...
        else if(checkPeriodClosing('<?php echo e($FormId); ?>',$("#MIS_DT").val(),0) ==0){
          $("#YesBtn").hide();
          $("#NoBtn").hide();
          $("#OkBtn").hide();
          $("#OkBtn1").show();
...
$('#Material').on('click','[id*="txtRGP_popup"]',function(event){
  ...
  if(DEPID_REF ===""){
    ...
    $(this).parent().parent().find('[id*="STOCK_INHAND"]').val('');
    $(this).parent().parent().find('[id*="RECEIVED_QTY_MU"]').val('');
    $(this).parent().parent().find('[id*="popupALTUOM"]').val('');
    $(this).parent().parent().find('[id*="ALT_UOMID_REF"]').val('');
    $(this).parent().parent().find('[id*="REASON_SHORT_QTY"]').val('');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\MaterialIssueSlip\trnfrm89edit.blade.php ENDPATH**/ ?>