    ...
    <div class="container-fluid purchase-order-view filter">     
          <div class="inner-form">       
                ...
                <div class="row">
                  ...
                  <div class="col-lg-1 pl">
                    <label> <?php echo e($objResponse->SPECIFICATIONNAME); ?> </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>Specification Description</p></div>
                  <div class="col-lg-4 pl">
                    <label> <?php echo e($objResponse->SPECIFICATIONDESC); ?> </label>
                  </div>
                </div>                
              <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\inventory\SpecificationMaster\mstfrm383view.blade.php ENDPATH**/ ?>