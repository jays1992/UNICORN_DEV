       ...
       <div class="inner-form">
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Asset Code*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASSETCODE" id="ASSETCODE" value="<?php echo e($HDR->ASSETCODE); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" disabled>
                 ...
                 <div class="col-lg-2 pl">
                   <input type="text" name="ASTDESCRIPTIONS" id="ASTDESCRIPTIONS" value="<?php echo e($HDR->ASTDESCRIPTIONS); ?>" class="form-control"  maxlength="100" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>Asset Category</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATEGORY" id="ASSETCAT" value="<?php echo e($HDR->CATEGORY); ?>" class="form-control mandatory"  autocomplete="off" disabled readonly/>
                   <input type="hidden" name="ASCATID_REF" id="ASCATID_REF" value="<?php echo e($HDR->ASCATID); ?>" class="form-control" autocomplete="off" disabled/>
                 </div>
             </div> 
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Category Description</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="CATDESCRIPTIONS" id="CATADESCRIPTIONS" value="<?php echo e($HDR->CATDESCRIPTIONS); ?>"  class="form-control" readonly  maxlength="100" disabled>  
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   ...
                   <input type="hidden" name="ASGID_REF" id="ASGID_REF" value="<?php echo e($HDR->ASGID); ?>" class="form-control" readonly  maxlength="100" disabled> 
                 </div>
                 ...
                 <div class="col-lg-2 pl">
                   ...
                   <input type="hidden" name="ASTID_REF" id="ASTID_REF" value="<?php echo e($HDR->ASTID); ?>" class="form-control" readonly  maxlength="100" disabled> 
                 </div>
             </div>
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Company Act</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" <?php echo e(isset($HDR) && $HDR->DMETHOD_INCOMETAX =='1'?'checked':''); ?> value="1" class="enable_tb" disabled>
                 </div>

               <div class="col-lg-2 pl"><p>Salvage Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input name="SALAVERATE" id="SALAVERATE" value="<?php echo e($HDR->SALAVERATE); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" type="text" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>Life of Asset (in Years)</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="LOASSET" id="LOASSET" value="<?php echo e($HDR->LOASSET); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" disabled> 
                 </div>                   
             </div>
             <div class="row">
               <div class="col-lg-2 pl"><p>WDV Method</p></div>
                 <div class="col-lg-2 pl">
                   <input type="radio" NAME="DMETHOD_INCOMETAX" <?php echo e(isset($HDR) && $HDR->DMETHOD_INCOMETAX =='2'?'checked':''); ?> value="2" disabled> 
                 </div>

               <div class="col-lg-2 pl"><p>WDV Rate</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="WDVRATE" id="WDVRATE" value="<?php echo e($HDR->WDVRATE); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  maxlength="100" disabled> 
                 </div>
             </div>
             <br>
             <div class="row">
                   ...
                   <tbody>
                    ...
                    <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr  class="participantRow">
                        <td hidden><input type="hidden" name="ASSETID_REF" id="ASSETID_REF" value="<?php echo e($row->ASSETID_REF); ?>" disabled /></td>
                        <td><input type="text" name=<?php echo e("popupITEMID[]"); ?> id=<?php echo e("popupITEMID_".$key); ?> value="<?php echo e($row->ICODE); ?>" class="form-control"  autocomplete="off" disabled  readonly/></td>
                        <td hidden><input type="hidden" name=<?php echo e("ITEMID_REF[]"); ?> id=<?php echo e("ITEMID_REF_".$key); ?> class="form-control"  value="<?php echo e($row->ITEMID_REF); ?>" disabled autocomplete="off" /></td>
                        <td><input type="text" name=<?php echo e("ItemName[]"); ?> id=<?php echo e("ItemName_".$key); ?> class="form-control" value="<?php echo e($row->NAME); ?>"  autocomplete="off" disabled  readonly/></td>
                        <td><input type="text" name=<?php echo e("Itemspec[]"); ?> id=<?php echo e("Itemspec_".$key); ?> class="form-control"  autocomplete="off" value="<?php echo e($row->ITEM_SPECI); ?>" disabled readonly  /></td>
                        <td><input type="text" name=<?php echo e("popupMUOM[]"); ?> id=<?php echo e("popupMUOM_".$key); ?> class="form-control" value="<?php echo e($row->UOMCODE); ?> <?php echo e($row->DESCRIPTIONS); ?>"  disabled autocomplete="off"  readonly/></td>
                        <td hidden><input type="hidden" name=<?php echo e("UOMID_REF[]"); ?> id=<?php echo e("UOMID_REF_".$key); ?>  class="form-control" value="<?php echo e($row->UOMID_REF); ?>" disabled  autocomplete="off" /></td>
                        <td hidden><input type="hidden" name=<?php echo e("SE_QTY[]"); ?> id=<?php echo e("SE_QTY_".$key); ?> class="form-control three-digits" maxlength="13" autocomplete="off" disabled  /></td>
                        <td hidden><input type="hidden" name=<?php echo e("SO_FQTY[]"); ?> id=<?php echo e("SO_FQTY_".$key); ?> class="form-control three-digits" maxlength="13"  autocomplete="off" disabled readonly/></td>
                        <td hidden><input type="hidden" name=<?php echo e("PRIORITYID[]"); ?> id=<?php echo e("PRIORITYID_".$key); ?> class="form-control"  autocomplete="off" disabled readonly/></td>
                        <td hidden><input type="hidden" name=<?php echo e("PTID_REF[]"); ?> id=<?php echo e("PTID_REF_".$key); ?> class="form-control"  autocomplete="off" disabled readonly/></td>
                        <td hidden><input class="form-control w-100" type="hidden" name=<?php echo e("EDD[]"); ?> id=<?php echo e("EDD_".$key); ?> placeholder="dd/mm/yyyy" disabled></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Asset\AssetMaster\mstfrm409view.blade.php ENDPATH**/ ?>