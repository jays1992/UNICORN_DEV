...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <button class="btn topnavbt" id="btnPrint_costing" ><i class="fa fa-print"></i> Costing</button>
                ...
                <button class="btn topnavbt" id="btnAmendment"<?php echo e(isset($objRights->AMENDMENT) && $objRights->AMENDMENT != 1 ? 'disabled' : ''); ?>> Amendment</button>
                ...
                <button class="btn topnavbt" id="btnImport" <?php echo e(isset($objRights->ADD) && $objRights->ADD != 1 ? 'disabled' : ''); ?> > <i class="fa fa-file"></i> Import</button>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            <?php
              ...
              ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->BOMID); ?>" value="<?php echo e($val->BOMID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td style="text-transform:uppercase"><?php echo e(isset($val->BOM_NO) && $val->BOM_NO !=''?$val->BOM_NO:''); ?></td>
                <td><?php echo e(isset($val->BOM_DT) && $val->BOM_DT !=''?$val->BOM_DT:''); ?></td>
                <td><?php echo e(isset($val->ITEM_CODE_NAME) && $val->ITEM_CODE_NAME !=''?$val->ITEM_CODE_NAME:''); ?></td>
        ...
        <form id="masterForm202Print" action="<?php echo e(route('mastergetlist',[202,'printdata'])); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<div id="ReportView" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    ...
    <div class="modal-body">
	  <div class="tablename"><p>Bill of Material Print</p></div>
        <div class="row">
...
<!-- Print costing -->
<div id="ReportView_costing" class="modal" role="dialog"  data-backdrop="static"  >
  <div class="modal-dialog modal-md" style="width:90%; height:90%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" id='ReportViewclosePopup_costing' >&times;</button>          
      </div>
    <div class="modal-body">
	  <div class="tablename"><p>Bill of Material Costing Print</p></div>
        <div class="row">
          <div class="frame-container col-lg-12 pl text-center" >
                <button class="btn topnavbt" id="btnReport_costing">
                    Print
                </button>
                <button class="btn topnavbt" id="btnPdf_costing">
                    PDF
                </button>
                <button class="btn topnavbt" id="btnExcel_costing">
                    Excel
                </button>
          </div>
        </div>
	  ...
	  <div class="single single-select table-responsive  table-wrapper-scroll-y my-custom-scrollbar">
          <div class="inner-form">
              <div class="row">
                  <div class="frame-container col-lg-12 pl " >                      
                      <iframe id="iframe_rpt_costing" width="100%" height="1500" >
                      </iframe>
                  </div>
              </div>
          </div>
...
$('#btnAdd').on('click', function() {
      var viewURL = '<?php echo e(route("master",[202,"add"])); ?>';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[202,"edit",":rcdId"])); ?>';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '<?php echo e(route("master",[202,"copy",":rcdId"])); ?>';
                        editURL = editURL.replace(":rcdId",recordId);
                        window.location.href=editURL;
                  }else if(is_approve==2){
                      ...
                      $("#OkBtn").hide();
                      $("#OkBtn1").show();
                      $("#AlertMessage").text('You cannot copy cancelled record.');
                      $("#alert").modal('show');
                      $("#OkBtn1").focus();
                  }else{
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '<?php echo e(route("master",[202,"view",":rcdId"])); ?>';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '<?php echo e(route("master",[202,"attachment",":rcdId"])); ?>';
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '<?php echo e(route("master",[202,"amendment",":rcdId"])); ?>';
                            editURL = editURL.replace(":rcdId",recordId);
                            window.location.href=editURL;
                      }else if(is_approve==2){
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'<?php echo e(route("master",[202,"MultiApprove"])); ?>',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'<?php echo e(route("mastermodify",[202,"cancel"])); ?>',
                            type:'POST',
    ...
    $('#btnPrint').on('click', function() {
          ...
          if(seletedRecord==0){
              ...
              var recordsIds = resultIdsData;
               ...
               $("#masterForm202Print").submit()

          }

    });//print function

    $('#btnPrint_costing').on('click', function() {
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&BOMID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("master",[202,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("master",[202,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
$('#btnPdf_costing').on('click', function() {
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&BOMID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '<?php echo e(route("master",[202,"ViewReport_costing",":rcdId"])); ?>';
            consultURL = consultURL.replace(":rcdId",formData);
            window.location.href=consultURL;
            event.preventDefault();
      }
...
$('#btnExcel_costing').on('click', function() {
    var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
...
$('#btnPrint_costing').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("master",[202,"ViewReport_costing"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView_costing').show();
                    var localS = data;
                    document.getElementById('iframe_rpt_costing').src = "data:text/html;charset=utf-8," + escape(localS);
                    $('#btnPdf_costing').show();
                    $('#btnExcel_costing').show();
                    $('#btnPrint_costing').show();
                },
                error:function(data){
                    console.log("Error: Something went wrong.");
                    var localS = "";
                    document.getElementById('iframe_rpt_costing').src = "data:text/html;charset=utf-8," + escape(localS);
                    $('#btnPdf_costing').hide();
                    $('#btnExcel_costing').hide();
                    $('#btnPrint_costing').hide();
                },
            });
            event.preventDefault();
        }
  ...
  $('#btnReport_costing').on('click', function() {
   var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
  ...
  $("#ReportViewclosePopup_costing").click(function(event){
        $("#ReportView_costing").hide();
        event.preventDefault();
      });
...
$('#btnImport').on('click', function(){
  window.location.href='<?php echo e(route("master",[202,"importdata"])); ?>';
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Production\BillofMaterial\mstfrm202.blade.php ENDPATH**/ ?>