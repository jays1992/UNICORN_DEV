          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl"><p>Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LEAVE_APP_DT" id="LEAVE_APP_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" class="form-control"  maxlength="100" > 
                    </div>
                  ...
                  <div class="col-lg-2 pl">
                    <select name="ASTSUBLOCTION" id="ASTSUBLOCTION" class="form-control mandatory" tabindex="4">
                      ...
                      <option value="<?php echo e($val->ASLID); ?>"><?php echo e($val->ASLCODE); ?></option>
                  ...
                  <div class="col-lg-2 pl">
                    <select name="ASTSUBLTION" id="ASTSUBLTION" class="form-control mandatory" tabindex="4">
                      <option value="" selected="">Select</option>
                      <?php $__currentLoopData = $objDataList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($val->ASLID); ?>"><?php echo e($val->DESCRIPTIONS); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  <input type="hidden" id="focusid" >
                  <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Asset\AssetTransfer\trnfrm411add.blade.php ENDPATH**/ ?>