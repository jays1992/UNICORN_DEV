        ...
        <form id="form_report"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                        ...
                        <div class="row"> 
                        <div class="col-lg-3 pl"><p>Vendor Name</p></div>
                            <div class="col-lg-3 pl" >
                                ...
                                <?php $__currentLoopData = $VendorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->SLID_REF); ?>" selected><?php echo e($val->VCODE); ?> - <?php echo e($val->NAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views/reports/purchase/PurchaseStatusReport/rptfrm496.blade.php ENDPATH**/ ?>