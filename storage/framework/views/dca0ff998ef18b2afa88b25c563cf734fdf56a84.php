  ...
  <div class="container-fluid purchase-order-view">    
    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            ...
            <?php else: ?>
                <input type="text" name="VIINFONO" id="VIINFONO" value="<?php echo e(isset($HDR->VIINFONO)?$HDR->VIINFONO:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                <input type="hidden" name="VIINFOID" id="VIINFOID" value="<?php echo e(isset($HDR->VIINFOID)?$HDR->VIINFOID:''); ?>"  class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                <?php endif; ?>
          ...
          <div class="col-lg-2 pl">
              <input type="text" name="txtvendor_popup" id="txtvendor_popup" value="<?php echo e(isset($HDR->SGLCODE)?$HDR->SGLCODE:''); ?> <?php echo e(isset($HDR->SLNAME)?'-'.$HDR->SLNAME:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
      ...
      <div class="row">
        ...
        <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" <?php echo e($HDR->DEACTIVATED == 1 ? "checked" : ""); ?>

         value='<?php echo e($HDR->DEACTIVATED == 1 ? 1 : 0); ?>' tabindex="2"  >
        </div>
        
        <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
        <div class="col-lg-2 pl">
          <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" <?php echo e($HDR->DEACTIVATED == 1 ? "" : "disabled"); ?> value="<?php echo e(isset($HDR->DODEACTIVATED) && $HDR->DODEACTIVATED !="" && $HDR->DODEACTIVATED !="1900-01-01" ? $HDR->DODEACTIVATED:''); ?>" tabindex="3" placeholder="dd/mm/yyyy"  />
        </div>
     </div>
            ...
            <div id="Material" class="tab-pane fade in active">
              <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                    <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                      ...
                      <tr>
                          <th>Item Group <input type="hidden" name="Row_Count1" id="Row_Count1" value="<?php echo e(count($MAT)); ?>" > </th>
                          <th>Item Code</th>
                          <th>Item Name</th>
                          <th>UOM</th>
                          <th>EOQ</th>
              ...
              <?php $__currentLoopData = $MAT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow">                   
                    ...
                    <input type="text" name="txtIG_popup_<?php echo e($key); ?>" id="txtRFQ_popup_<?php echo e($key); ?>" value="<?php echo e(isset($row['GROUPCODE'])?$row['GROUPCODE']:''); ?> <?php echo e(isset($row['GROUPNAME'])?'-'.$row['GROUPNAME']:''); ?>" class="form-control CLS_RFQ"  autocomplete="off"  readonly style="width:100px;" /></td>
                    ...
                    <td><input type="text" name="popupITEMID_<?php echo e($key); ?>" id="popupITEMID_<?php echo e($key); ?>" value="<?php echo e(isset($row['ICODE'])?$row['ICODE']:''); ?>" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                    <td hidden><input type="text" name="ITEMID_REF_<?php echo e($key); ?>" id="ITEMID_REF_<?php echo e($key); ?>" value="<?php echo e(isset($row['ITEMID_REF'])?$row['ITEMID_REF']:''); ?>" class="form-control" autocomplete="off" /></td>
                    
                    <td><input type="text" name="ItemName_<?php echo e($key); ?>" id="ItemName_<?php echo e($key); ?>" value="<?php echo e(isset($row['NAME'])?$row['NAME']:''); ?>" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    <td><input type="text" name="ItemUom_<?php echo e($key); ?>" id="ItemUom_<?php echo e($key); ?>" value="<?php echo e(isset($row['UOMCODE'])?$row['UOMCODE']:''); ?> <?php echo e(isset($row['DESCRIPTIONS'])?'-'.$row['DESCRIPTIONS']:''); ?>" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    <td hidden><input type="text" name="ItemuomText_<?php echo e($key); ?>" id="ItemuomText_<?php echo e($key); ?>" value="<?php echo e(isset($row['UOMID_REF'])?$row['UOMID_REF']:''); ?>" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
                    
                    
                    <td hidden><input type="text" name="UOMID_REF_<?php echo e($key); ?>" id="Itemspec_<?php echo e($key); ?>" value="<?php echo e(isset($row['UOMCODE'])?$row['UOMCODE']:''); ?> <?php echo e(isset($row['DESCRIPTIONS'])?'-'.$row['DESCRIPTIONS']:''); ?>" class="form-control" readonly autocomplete="off"  /></td>
                    <td <?php if(strpos($objCOMPANY->NAME,"ALPS") == false): ?>  hidden <?php endif; ?>  ><input type="text" name="Alpspartno_<?php echo e($key); ?>" id="Alpspartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly  /></td>
                    <td <?php if(strpos($objCOMPANY->NAME,"ALPS") == false): ?>  hidden <?php endif; ?>  ><input type="text" name="Custpartno_<?php echo e($key); ?>" id="Custpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly  /></td>
                    <td <?php if(strpos($objCOMPANY->NAME,"ALPS") == false): ?>  hidden <?php endif; ?>  ><input type="text" name="OEMpartno_<?php echo e($key); ?>" id="OEMpartno_<?php echo e($key); ?>" class="form-control"  autocomplete="off"  readonly /></td>
                    
              
                    <td><input type="text" name="EOQ_<?php echo e($key); ?>" id="EOQ_<?php echo e($key); ?>" value="<?php echo e(isset($row['EOQ'])?$row['EOQ']:''); ?>" class="form-control" onkeypress="return onlyNumberKey(event)"  autocomplete="off" style="width:100px;"/></td>
                    <td hidden><input type="text" name="EOQID_<?php echo e($key); ?>" id="EOQID_<?php echo e($key); ?>" value="<?php echo e(isset($row['EOQ'])?$row['EOQ']:''); ?>" class="form-control"  autocomplete="off" style="width:100px;"/></td>
                    
                    <td><input type="text" name="LEADDAYS_<?php echo e($key); ?>" id="LEADDAYS_<?php echo e($key); ?>" value="<?php echo e(isset($row['LEADDAYS'])?$row['LEADDAYS']:''); ?>" class="form-control" onkeypress="return onlyNumberKey(event)" autocomplete="off"  style="width:100px;"/></td>
                    <td hidden><input type="text" name="LEADDAYSID_<?php echo e($key); ?>" id="LEADDAYSID_<?php echo e($key); ?>" value="<?php echo e(isset($row['LEADDAYS'])?$row['LEADDAYS']:''); ?>" class="form-control" autocomplete="off"  style="width:100px;"/></td>
                    
                    <td><input type="text" name="REMARKS_<?php echo e($key); ?>" id="REMARKS_<?php echo e($key); ?>" value="<?php echo e(isset($row['REMARKS'])?$row['REMARKS']:''); ?>" class="form-control"  autocomplete="off"  style="width:100px;"/></td>
                    <td hidden><input type="text" name="REMARKSID_<?php echo e($key); ?>" id="REMARKSID_<?php echo e($key); ?>" value="<?php echo e(isset($row['REMARKS'])?$row['REMARKS']:''); ?>" class="form-control"  autocomplete="off"  style="width:100px;"/></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\masters\Purchase\VendorItemInfo\mstfrm51edit.blade.php ENDPATH**/ ?>