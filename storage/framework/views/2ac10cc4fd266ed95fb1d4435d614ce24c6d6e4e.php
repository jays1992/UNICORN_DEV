        ...
        <div class="inner-form">
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="text" name="LEAVE_APP_NO" id="LEAVE_APP_NO" VALUE="<?php echo e(isset($objResponse->LEAVE_APP_NO)?$objResponse->LEAVE_APP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  disabled>
                  <span class="text-danger" id="ERROR_LEAVE_APP_NO"></span> 
                </div>

                <div class="col-lg-2 pl"><p>LA Date*</p></div>
                  <div class="col-lg-2 pl">
                    <input type="date" name="LEAVE_APP_DT" id="LEAVE_APP_DT" value="<?php echo e($objResponse->LEAVE_APP_DT); ?>" class="form-control"  maxlength="100" disabled > 
                  </div>
                ...
                <div class="col-lg-2 pl"><p>Name</p></div>
                  <div class="col-lg-2 pl">
                    <input type="text" id="FNAME" value="<?php echo e($objEmpName->FNAME); ?>" class="form-control" readonly maxlength="100" disabled> 
                  </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl">
                  <input type="date" name="LEAVE_APP_FRDT"  id="LEAVE_APP_FRDT" value="<?php echo e($objResponse->LEAVE_APP_FRDT); ?>" onchange="leaveFromDate(this.id)" class="form-control"  maxlength="100" disabled> 
                </div>
              
                <div class="col-lg-2 pl"><p>LA To Date *</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="LEAVE_APP_TODT" id="LEAVE_APP_TODT" value="<?php echo e($objResponse->LEAVE_APP_TODT); ?>" onchange="leaveFromDate(this.id)" class="form-control"  maxlength="100" disabled>
                <input type="hidden" id="focusid" >
                <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <input type="text" name="REASON_LEAVE" id="REASON_LEAVE" value="<?php echo e($objResponse->REASON_LEAVE); ?>" class="form-control"  maxlength="100" disabled> 
              </div>
            
              <div class="col-lg-2 pl"><p>Address During the leave  </p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="ADDRESS_LEAVE" id="ADDRESS_LEAVE" value="<?php echo e($objResponse->ADDRESS_LEAVE); ?>" class="form-control"  maxlength="100" disabled> 
              <input type="hidden" id="focusid" >
              <span class="text-danger" id="ERROR_EMPID_REF"></span>                             
            </div>
            ...
            <div class="col-lg-2 pl"><p>Contact no During the leave 1 </p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="MONO_INLEAVE1" id="MONO_INLEAVE1" value="<?php echo e($objResponse->MONO_INLEAVE1); ?>" onkeypress="return onlyNumberKey(event)" class="form-control"  maxlength="100" disabled> 
              </div>
            </div>
            <div class="row">
              <div class="col-lg-2 pl"><p>Contact no During the leave 2 </p></div>
              <div class="col-lg-2 pl">
                <input type="text" name="MONO_INLEAVE2" id="MONO_INLEAVE2" value="<?php echo e($objResponse->MONO_INLEAVE2); ?>" onkeypress="return onlyNumberKey(event)" class="form-control"  maxlength="100" disabled> 
              </div>
            </div>
        </div>
      </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\LeaveApply\trnfrm402view.blade.php ENDPATH**/ ?>