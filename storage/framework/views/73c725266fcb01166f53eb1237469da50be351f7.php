  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="RPRO_NO" id="RPRO_NO" value="<?php echo e($docarray['DOC_NO']); ?>" <?php echo e($docarray['READONLY']); ?> class="form-control" maxlength="<?php echo e($docarray['MAXLENGTH']); ?>" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="RPR_DT" id="RPR_DT" onchange='checkPeriodClosing("<?php echo e($FormId); ?>",this.value,1),getDocNoByEvent("RPRO_NO",this,<?php echo json_encode($doc_req, 15, 512) ?>)' value="<?php echo e(old('RPR_DT')); ?>" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
          ...
          <div id="udf" class="tab-pane fade">
              ...
              <?php $__currentLoopData = $objUdfData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uindex=>$uRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr  class="participantRow3">
                    ...
                    <td hidden><input type="hidden" name=<?php echo e("UDF_".$uindex); ?> id=<?php echo e("UDF_".$uindex); ?> class="form-control" value="<?php echo e($uRow->UDFRPRID); ?>" autocomplete="off"   /></td>
  ...
  <div class="modal-dialog modal-md column3_modal">
    ...
    <tr>
      ...
      <table id="ProdNoTable2" class="display nowrap table  table-striped table-bordered" >
        ...
        <tbody>
        <?php $__currentLoopData = $objPRO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$prono_Row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr> 
        <td class="ROW1"> <input type="checkbox" name="SELECT_PROID_REF[]" id="prono_<?php echo e($index); ?>" class="clsprono" value="<?php echo e($prono_Row->PROID); ?>" ></td>
          <td class="ROW2"><?php echo e($prono_Row-> PRO_NO); ?>

          <input type="hidden" id="txtprono_<?php echo e($index); ?>" data-desc="<?php echo e($prono_Row->PRO_NO); ?>"  value="<?php echo e($prono_Row->PROID); ?>" data-title="<?php echo e($prono_Row->PRO_TITLE); ?>"/>
          </td>
          <td class="ROW3"><?php echo e($prono_Row-> PRO_DT); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
      </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Production\RequisitionAgainstPRO\trnfrm273add.blade.php ENDPATH**/ ?>