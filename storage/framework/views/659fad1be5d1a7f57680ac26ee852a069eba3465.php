	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input <?php echo e($ActionStatus); ?> type="text" name="NRGP_NO" id="NRGP_NO" value="<?php echo e(isset($objResponse->NRGP_NO) && $objResponse->NRGP_NO !=''?$objResponse->NRGP_NO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input <?php echo e($ActionStatus); ?> type="date" name="NRGP_DT" id="NRGP_DT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" value="<?php echo e(isset($objResponse->NRGP_DT) && $objResponse->NRGP_DT !=''?$objResponse->NRGP_DT:''); ?>" class="form-control mandatory" >
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\inventory\NonReturnableGatePass\trnfrm91edit.blade.php ENDPATH**/ ?>