...
<?php $__env->startSection('content'); ?>    
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                  <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Service Purchase Order</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
              <td><input type="checkbox" id="chkId<?php echo e($val->SPOID); ?>" value="<?php echo e($val->SPOID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->SPO_DT) && $val->SPO_DT !='' && $val->SPO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SPO_DT)):''); ?>" ></td>
              <td><?php echo e(isset($val->SPO_NO) && $val->SPO_NO !=''?$val->SPO_NO:''); ?></td>
              ...
              <td><?php echo e(isset($val->VALID_FR) && $val->VALID_FR !='' && $val->VALID_FR !='1900-01-01' ? date('d-m-Y',strtotime($val->VALID_FR)):''); ?></td>
              <td><?php echo e(isset($val->VALID_TO) && $val->VALID_TO !='' && $val->VALID_TO !='1900-01-01' ? date('d-m-Y',strtotime($val->VALID_TO)):''); ?></td>
...
$('#btnPdf').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '<?php echo e(route("transaction",[69,"ViewReport",":rcdId"])); ?>';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'<?php echo e(route("transaction",[69,"ViewReport"])); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Purchase\ServicePurchaseOrder\trnfrm69.blade.php ENDPATH**/ ?>