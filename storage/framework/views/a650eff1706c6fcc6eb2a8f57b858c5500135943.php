            ...
            <div class="container-fluid filter">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 pl"><p>Module Name</p></div>
                            <div class="col-lg-3 pl" >
                                <select name="MODULEID" data-hide-disabled="hide" data-actions-box="true" id="MODULEID" class="form-control selectpicker" data-live-search="true"  >
								<option value="" selected>select</option>
                                <?php $__currentLoopData = $ObjMODULE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->MODULEID); ?>" ><?php echo e($val->MODULENAME); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
							<div class="col-lg-3 pl"><p>Form Name</p></div>
                            <div class="col-lg-3 pl" id="div_form2">
                                <select name="VTID" id="VTID" class="form-control mandatory">
...
$('#MODULEID').on('change', function() {
	   if($(this).val() !== '')
	   {
				var MODULEID = $(this).val();
                  ...
                  $.ajax({
                      url:'<?php echo e(route("report",[$FORM_ID,"getFormname"])); ?>',
                      type:'POST',
...
$('#btnView').on('click', function() {
		...
		else if(VTID  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Form Name.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\Accounts\AuditTrial\rptfrm524.blade.php ENDPATH**/ ?>