       ...
       <div class="inner-form">
             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="CLAIM_DOC_NO" id="CLAIM_DOC_NO" value="<?php echo e($objResponse->CLAIM_DOC_NO); ?>" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" readonly style="text-transform:uppercase" autofocus disabled>
                 <span class="text-danger" id="ERROR_CLAIM_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="CLAIM_DOC_DT" id="CLAIM_DOC_DT" value="<?php echo e($objResponse->CLAIM_DOC_DT); ?>" class="form-control" maxlength="100" disabled>
                 </div>
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="<?php echo e($objLvDesList->FNAME); ?>" class="form-control" readonly  maxlength="100" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>Period From Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PERIOD_FR_DT" id="PERIOD_FR_DT" value="<?php echo e($objResponse->PERIOD_FR_DT); ?>" class="form-control"  maxlength="100" disabled> 
                 </div>

                 <div class="col-lg-2 pl"><p>To Date</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="PERIOD_TO_DT" id="PERIOD_TO_DT" value="<?php echo e($objResponse->PERIOD_TO_DT); ?>" class="form-control"  maxlength="100" disabled> 
                 </div>
             </div>
             ...
             <div class="col-lg-2 pl"><p>Department*</p></div>
               ...
               <div class="col-lg-2 pl"><p>Designation</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="DESGID_REF" id="DESGID_REF" value="<?php echo e($objDptList->NAME); ?>" class="form-control" readonly  maxlength="100" disabled> 
                 </div>
             </div>
                     ...
                     <tbody>
                      ...
                      ?>
                       <tr  class="participantRow">
                           <td><select  name=<?php echo e("GLID_REF_".$key); ?> id =<?php echo e("GLID_REF_".$key); ?>  onchange="getGlCodeName(this.id,this.value)" class="form-control mandatory" style="width: 150px;" disabled>
                             <option value="" selected="">Select</option>
                           ...
                           <td><input  class="form-control" type="text" name=<?php echo e("GLCODE_DESC_".$key); ?>    id =<?php echo e("GLCODE_DESC_".$key); ?>   value="<?php echo e($row->GLNAME); ?>"     readonly  maxlength="100" disabled> </td>
                           ...
                           <td><input  class="form-control" type="text" name=<?php echo e("CLAIM_AMT_".$key); ?>      id =<?php echo e("CLAIM_AMT_".$key); ?>     value="<?php echo e($row->CLAIM_AMT); ?>"    onkeypress="return onlyNumberKey(event)"  autocomplete="off" style="width: 99%" disabled></td>
                           <td><input  class="form-control" type="text" name=<?php echo e("SANCTION_AMT_".$key); ?>   id =<?php echo e("SANCTION_AMT_".$key); ?>  value="<?php echo e($row->SANCTION_AMT); ?>"  onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%" disabled></td>
                           <td><select name=<?php echo e("ANY_ATTACHMENT_".$key); ?>  id =<?php echo e("ANY_ATTACHMENT_".$key); ?> onchange="getAttDocType(this)" class="form-control" disabled>
                            ...
                            <td><input  class="form-control" type="file" name="FILENAME[]" id =<?php echo e("ATTDOCFILE_".$key); ?> value="<?php echo e($row->FILE_NAMES); ?>" disabled></td>
                           <td align="center">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Payroll\ClaimForm\trnfrm412view.blade.php ENDPATH**/ ?>