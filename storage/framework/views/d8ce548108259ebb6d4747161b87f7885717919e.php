...
<div class="container-fluid topnav">
  <div class="row">
      ...
      <button class="btn topnavbt" id="btnCancel" <?php echo e((isset($objRights->APPROVAL1) || isset($objRights->APPROVAL2) || isset($objRights->APPROVAL3) || isset($objRights->APPROVAL4) || isset($objRights->APPROVAL5)) &&  ($objRights->APPROVAL1||$objRights->APPROVAL2||$objRights->APPROVAL3||$objRights->APPROVAL4||$objRights->APPROVAL5) == 1 ? '' : 'disabled'); ?> ><i class="fa fa-times"></i> Cancel</button>
      ...
      <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->TRYID); ?>" value="<?php echo e($val->TRYID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>"></td>
                <td><?php echo e(isset($val->TRYDOC_NO) && $val->TRYDOC_NO !=''?$val->TRYDOC_NO:''); ?></td>
                <td><?php echo e(isset($val->DOC_DT) && $val->DOC_DT !=''?$val->DOC_DT:''); ?></td> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\PROJECTS\UNICORN_DEV\resources\views/masters/PreSales/TerritoryMaster/mstfrm557.blade.php ENDPATH**/ ?>