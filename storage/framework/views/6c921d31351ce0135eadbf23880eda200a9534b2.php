...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="<?php echo e(route('report',[240,'index'])); ?>" class="btn singlebt">Sales Order Report</a>
                </div><!--col-2-->
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="GroupBy" id="GroupBy" data-hide-disabled="hide"  data-actions-box="true" class="form-control selectpicker"  data-live-search="true"  >
                            ...
                            <div class="col-lg-3 pl">
                                <select name="OrderBy" id="OrderBy" data-hide-disabled="hide"  data-actions-box="true" class="form-control selectpicker"  data-live-search="true"  >
                                    <option value="Date" selected>Sales Order Date</option>
                                    <option value="Customer" >Customer Name</option>
                                    <option value="Sales Person" >Sales Person</option>
                                    <option value="Item Group" >Item Group</option>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="Quantity" id="Quantity" data-hide-disabled="hide"  data-actions-box="true" class="form-control selectpicker"  data-live-search="true" >
                            ...
                            <div class="col-lg-3 pl">
                                <select name="STATUS" id="STATUS" data-hide-disabled="hide"  data-actions-box="true" class="form-control selectpicker"  data-live-search="true">
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '<?php echo e(route("report",[240,"ViewReport",":rcdId"])); ?>';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'<?php echo e(route("report",[240,"ViewReport"])); ?>',
                    type:'POST',
                    data:formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\reports\sales\SalesOrderRpt\rptfrm240.blade.php ENDPATH**/ ?>