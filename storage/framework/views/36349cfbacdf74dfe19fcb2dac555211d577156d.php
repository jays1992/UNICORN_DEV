...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_trn_attachment" method="post" enctype="multipart/form-data" action='<?php echo e(route("transactionmodify",[235,"docuploads"])); ?>' > 
          <?php echo csrf_field(); ?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='<?php echo e($objMstVoucherType[0]->VTID); ?>' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> <?php echo e($objResponse->AP_DOC_NO); ?> </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="<?php echo e($objResponse->APDRCRID); ?>" class="form-control" maxlength="50" >
			</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\Accounts\APDebitNote\trnfrm235attachment.blade.php ENDPATH**/ ?>