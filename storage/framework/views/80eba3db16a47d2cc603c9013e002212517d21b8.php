...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2">
   <a href="javascript:void(0)" onclick="return  window.location.reload()" class="btn singlebt">Eway Bill<?php echo e(isset($EwayBillDetails["EWAY_NO"]) ? '- '.$EwayBillDetails["EWAY_NO"]:""); ?> </a>

    </div>
    <div class="col-lg-10 topnav-pd">
      <button class="btn topnavbt"  id="btnSave" <?php echo e(!empty($InvoiceDetails)?'disabled':''); ?>><i class="fa fa-plus"></i> Generate Eway Bill</button>
    ...
    <div id="DocumentSummary" class="tab-pane fade in active">
        <div class="inner-form" style="margin-top:10px;">
          <div class="row">
            ...
            <span> <?php echo e(isset($InvoiceDetails->TransId) ? $InvoiceDetails->TransId:""); ?> </span>
            </div>
            <div class="col-lg-2 pl"><p>Transaction Name</p></div>
            <div class="col-lg-6 pl">
            <span> <?php echo e(isset($InvoiceDetails->TransName) ? $InvoiceDetails->TransName:""); ?> </span>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->TransDocNo) ? $InvoiceDetails->TransDocNo:""); ?>  </span>
            </div>
            <div class="col-lg-2 pl"><p>Tranport Doc Date</p></div>
            <div class="col-lg-6 pl">
            <span> <?php echo e(isset($InvoiceDetails->TransDocDt) && $InvoiceDetails->TransDocDt !='' && $InvoiceDetails->TransDocDt !='1900-01-01' ? date('d-m-Y',strtotime($InvoiceDetails->TransDocDt)):''); ?></span>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->VehNo) ? $InvoiceDetails->VehNo:""); ?>  </span>
            
            </div>
            <div class="col-lg-2 pl"><p>Vehicle Type</p></div>
            <div class="col-lg-6 pl">
            <span>  <?php echo e($TRANSPORT_MODE); ?> </span>
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($EwayBillDetails["EWAY_NO"]) ? $EwayBillDetails["EWAY_NO"]:""); ?>   </span>
            </div>
            <div class="col-lg-2 pl"><p> Irn</p></div>
            <div class="col-lg-6 pl">
            <span> <?php echo e(isset($InvoiceDetails->Irn) ? $InvoiceDetails->Irn:""); ?> </span>
            </div> 
          </div>    
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span><?php echo e(isset($EwayBillDetails["EWAYBILLDT"]) ? $EwayBillDetails["EWAYBILLDT"]:""); ?> </span>
            </div>
            <div class="col-lg-2 pl"><p>Eway Bill Status</p></div>
            <div class="col-lg-6 pl">
            <span> <?php echo e(isset($EwayBillDetails["STATUS"]) ? $EwayBillDetails["STATUS"]:""); ?>  </span>
            </div> 
          </div>  
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($EwayBillDetails["EWAYBILL_VALIDTO"]) ? $EwayBillDetails["EWAYBILL_VALIDTO"]:""); ?>  </span>
            </div>
           <div class="col-lg-2 pl"><p>Distance</p></div>
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->Distance) ? $InvoiceDetails->Distance:""); ?> </span>
            </div>
          </div>
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->ExpShipDtls->Addr1) ? $InvoiceDetails->ExpShipDtls->Addr1:""); ?> </span>
            </div>
           <div class="col-lg-2 pl"><p>Dispatch Address</p></div>
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->DispDtls->Addr1) ? $InvoiceDetails->DispDtls->Addr1:""); ?></span>
            </div>
          </div>
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->ExpShipDtls->Loc) ? $InvoiceDetails->ExpShipDtls->Loc:""); ?> </span>
            </div>
           <div class="col-lg-2 pl"><p>Dispatch Location</p></div>
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->DispDtls->Loc) ? $InvoiceDetails->DispDtls->Loc:""); ?></span>
            </div>
          </div>
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->ExpShipDtls->Stcd) ? $InvoiceDetails->ExpShipDtls->Stcd:""); ?> </span>
            </div>
           <div class="col-lg-2 pl"><p>Dispatch State Code</p></div>
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->DispDtls->Stcd) ? $InvoiceDetails->DispDtls->Stcd:""); ?></span>
            </div>
          </div>        
          ...
          <div class="row">                    
            ...
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->ExpShipDtls->Pin) ? $InvoiceDetails->ExpShipDtls->Pin:""); ?> </span>
            </div>
           <div class="col-lg-2 pl"><p>Dispatch Pincode</p></div>
            <div class="col-lg-2 pl">
            <span> <?php echo e(isset($InvoiceDetails->DispDtls->Pin) ? $InvoiceDetails->DispDtls->Pin:""); ?></span>
            </div>
          </div>
          </div>  
         ...
         <div class="inner-form">
                   <div class="row">
                      ...
                      <div class="col-lg-3 pl">
                        <input type="text" name="TRANSPORTID" id="TRANSPORTID" class="form-control mandatory" value="<?php echo e(old('TRANSPORTID')); ?>" required maxlength="200"   />
                      </div>
                      <div class="col-lg-2 pl"><p>Transport Name</p></div>
                      <div class="col-lg-3 pl">
                        <input type="text" name="TRANSPORT_NAME" id="TRANSPORT_NAME" class="form-control mandatory" value="<?php echo e(old('TRANSPORT_NAME')); ?>" required maxlength="200"   />
                      </div>   
                   </div>    
                   <div class="row">
                    <div class="col-lg-2 pl"><p>Transport Doc Date</p></div>
                      <div class="col-lg-3 pl">
                        <input type="date" name="TRANSPORT_DOCDT" id="TRANSPORT_DOCDT" class="form-control mandatory" value="<?php echo e(old('TRANSPORT_DOCDT')); ?>" required maxlength="200"   />
                      </div>  
                      <div class="col-lg-2 pl"><p>Transport Doc No</p></div>
                      <div class="col-lg-3 pl">
                        <input type="text" name="TRANSPORT_DOCNO" id="TRANSPORT_DOCNO" class="form-control mandatory" value="<?php echo e(old('TRANSPORT_DOCNO')); ?>" maxlength="200" required  />
                      </div>
                   </div>    
                   <div class="row">
                      <div class="col-lg-2 pl"><p>Vehicle No</p></div>
                        <div class="col-lg-3 pl">
                          <input type="text" name="VEHICLENO" id="VEHICLENO" class="form-control mandatory" value="<?php echo e(old('VEHICLENO')); ?>" required maxlength="200"   />
                        </div>
                      <div class="col-lg-2 pl"><p>VehType</p></div>
                        <div class="col-lg-3 pl">
                          <input type="hidden" NAME="IRN" value="<?php echo e($IRN_NO); ?>">
                     ...
                     <div class="row">
                      ...
                      <div class="col-lg-3 pl">
                        <select name="SHIPCTRYID_REF" id="SHIPCTRYID_REF" required onchange="getstate(this.value,'SHIPSTID_REF','SHIPCITYID_REF','')" class="form-control mandatory">
                          ...
                          <option value="<?php echo e($val->CTRYID); ?>"><?php echo e($val->CTRYCODE); ?> - <?php echo e($val->NAME); ?></option>
...
function GenerateEway(id){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"GenerateEway"])); ?>',
    type:'POST',
    data:formData,
...
function CancelEway(id){
  ...
  $.ajax({
    url:'<?php echo e(route("transaction",[$FormId,"cancelEway"])); ?>',
    type:'POST',
    data:{ewaybillno:'<?php echo e(isset($EwayBillDetails["EWAY_NO"]) ? $EwayBillDetails["EWAY_NO"]:""); ?>',id:'<?php echo e($id); ?>'},
    success:function(data) {               
      if(data.errors) {
...
function PrintEway(){
  var EwayBillNo        = '<?php echo e(isset($EwayBillDetails["EWAY_NO"]) ? $EwayBillDetails["EWAY_NO"]:""); ?> ';
  var path              = '<?php echo e(route("transaction",[$FormId,"PrintEway",":ewayno"])); ?>';
...
var formResponseMst = $( "#frm_mst_add" );
    ...
    var editURL = '<?php echo e(route("transaction",[$FormId,"invoice",":rcdId"])); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\sales\SalesServiceInvoice\trnfrm156ewaybill.blade.php ENDPATH**/ ?>