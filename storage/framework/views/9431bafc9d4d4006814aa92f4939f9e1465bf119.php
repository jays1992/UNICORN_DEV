  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            ?>
            <tr>
                <td><input type="checkbox" id="chkId<?php echo e($val->JWRID); ?>" value="<?php echo e($val->JWRID); ?>" class="js-selectall1" data-rcdstatus="<?php echo e($app_status); ?>" data-docdate="<?php echo e(isset($val->JWRDT) && $val->JWRDT !='' && $val->JWRDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWRDT)):''); ?>" ></td>
                <td><?php echo e(isset($val->JWRNO) && $val->JWRNO !=''?$val->JWRNO:''); ?></td>
                <td><?php echo e(isset($val->JWRDT) && $val->JWRDT !='' && $val->JWRDT !='1900-01-01' ? date('d-m-Y',strtotime($val->JWRDT)):''); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\JobWorkReturn\trnfrm360.blade.php ENDPATH**/ ?>