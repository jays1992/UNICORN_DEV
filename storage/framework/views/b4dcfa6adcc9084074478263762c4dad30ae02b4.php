...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="<?php echo e(route('transaction',[$FormId,'index'])); ?>" class="btn singlebt">Quality Inspection against </br/> GRJ (QIJ)</a>
        </div>
    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input type="text" name="QIJNO" id="QIJNO" VALUE="<?php echo e(isset($HDR->QIJNO)?$HDR->QIJNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>QIJ Date</p></div>
            <div class="col-lg-2 pl">
                <input type="date" name="QIJDT" id="QIJDT" onchange="checkPeriodClosing('<?php echo e($FormId); ?>',this.value,1)" VALUE="<?php echo e(isset($HDR->QIJDT)?$HDR->QIJDT:''); ?>" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
            <input type="text" name="TEXT_GRJID_REF_DATA" id="TEXT_GRJID_REF_DATA" VALUE="<?php echo e(isset($HDR->GRNNO)?$HDR->GRNNO:''); ?>" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="GRJ_REC_QTY" id="GRJ_REC_QTY" VALUE="<?php echo e(isset($HDR->GRJ_REC_QTY)?$HDR->GRJ_REC_QTY:''); ?>" class="form-control"  autocomplete="off" readonly />
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\bsquareappfordemo.com\UNICORN\resources\views\transactions\JobWork\QualityInspection\trnfrm358edit.blade.php ENDPATH**/ ?>