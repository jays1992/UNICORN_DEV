...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[282,'index'])}}" class="btn singlebt">NRGP Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objNRGPNo as $Dindex=>$DRow)
                                        <option value="{{$DRow->NRGPID}}" selected>{{$DRow->NRGP_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[282,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(NRGPID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[282,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
