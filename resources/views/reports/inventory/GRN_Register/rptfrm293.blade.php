...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[293,'index'])}}" class="btn singlebt">GRN Register against GE</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[293,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(GRNID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[293,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
