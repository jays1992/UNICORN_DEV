...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[322,'index'])}}" class="btn singlebt">Gate Entry Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjVendorGrp as $Gindex=>$GRow)
                                        <option value="{{$GRow->VGID}}" selected>{{$GRow->VGCODE}}-{{$GRow->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl" id="div_GETYPE">
                                ...
                                @foreach($ObjGETYPE as $Iindex=>$IRow)
                                        <option value="{{$IRow->GETYPE}}" selected>{{$IRow->GETYPE}}</option>
                                @endforeach
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[322,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(GETYPE  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[322,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
