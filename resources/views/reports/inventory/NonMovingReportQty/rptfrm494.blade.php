                    ...
                    <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" >
                                ...
                                @foreach($ItemSubGroupList as $key=>$val)
                                <option value="{{$val->ISGID}}" selected>{{$val->ISGCODE}} - {{$val->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 pl"><p>Item Category</p></div>
                            <div class="col-lg-3 pl" >
                                ...
                                @foreach($ItemCatList as $key=>$val)
                                <option value="{{$val->ICID}}" selected>{{$val->ICCODE}} - {{$val->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        <div class="col-lg-3 pl"><p>Store Name</p></div>
                            <div class="col-lg-3 pl" >
                                ...
                                <option value="{{$val->STID}}" selected>{{$val->STCODE}} - {{$val->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
