...
<!-- <form id="frm_rpt_pos" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[288,'index'])}}" class="btn singlebt">MRS Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>MRS NO</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($objMRS as $cindex=>$cRow)
                                        <option value="{{$cRow->MRSID}}" selected>{{$cRow->MRS_NO}}</option>
                                @endforeach
                                </select>
                            </div>  
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[288,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[288,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
