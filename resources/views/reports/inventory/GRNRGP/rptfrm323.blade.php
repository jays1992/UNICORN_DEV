...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[323,'index'])}}" class="btn singlebt">Goods Receipt Note Against Returnable Gate Pass</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjGRN as $vindex=>$vRow)
                                        <option value="{{$vRow->GRN_NO}}" selected>{{$vRow->GRN_NO}}</option>
                                @endforeach
                                </select>
                            </div>  
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[323,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(GRN_NO  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[323,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
