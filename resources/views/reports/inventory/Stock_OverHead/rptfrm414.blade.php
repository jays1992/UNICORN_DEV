...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[414,'index'])}}" class="btn singlebt">Stock Over Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
						...
						<div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemcat">
                                ...
                                @foreach($ObjItemCat as $Cindex=>$CRow)
										<option value="{{$CRow->ICID}}" selected>{{$CRow->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemsubgrp">
                                ...
                                @foreach($ObjItemSubGrp as $Sindex=>$SRow)
                                        <option value="{{$SRow->ISGID}}" selected>{{$SRow->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
						...
						<div class="row">
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($ObjStore as $Gindex=>$GRow)
                                        <option value="{{$GRow->STID}}" selected>{{$GRow->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[414,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(STOREID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[414,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
