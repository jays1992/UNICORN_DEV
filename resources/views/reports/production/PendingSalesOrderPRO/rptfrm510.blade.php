                    ...
                    <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" >
                                ...
                                @foreach($ItemGroupList as $key=>$val)
                                <option value="{{$val->ITEMGID}}" selected>{{$val->GROUPCODE}} - {{$val->GROUPNAME}}</option>
                                @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" >
                                ...
                                <option value="{{$val->SLID_REF}}" selected>{{$val->CCODE}} - {{$val->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
