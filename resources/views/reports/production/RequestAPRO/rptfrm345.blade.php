...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[345,'index'])}}" class="btn singlebt">Request Against PRO Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjRPRNO as $Gindex=>$GRow)
                                        <option value="{{$GRow->RPRID}}" selected>{{$GRow->RPR_NO}}</option>
                                @endforeach
                                </select>
                            </div>               
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[345,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[345,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
