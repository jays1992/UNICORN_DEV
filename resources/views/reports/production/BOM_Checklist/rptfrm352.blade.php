...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[352,'index'])}}" class="btn singlebt">Bill of Material Checklist</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objBOMNo as $Bindex=>$BRow)
                                        <option value="{{$BRow->BOMID}}" selected>{{$BRow->BOM_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[352,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(BOMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[352,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
