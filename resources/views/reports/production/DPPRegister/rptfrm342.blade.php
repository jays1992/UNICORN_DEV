...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[342,'index'])}}" class="btn singlebt">Daily Production Plan Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjDailyProductionPlan as $Gindex=>$GRow)
                                        <option value="{{$GRow->DPPID}}" selected>{{$GRow->DPP_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
                        <div class="row">                          
                            ...
                            <div class="col-lg-3 pl" id="div_sono">
                                ...
                                @foreach($ObjSalesOrer as $Iindex=>$IRow)
                                        <option value="{{$IRow->SOID}}" selected>{{$IRow->SONO}}</option>
                                @endforeach
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[342,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[342,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
