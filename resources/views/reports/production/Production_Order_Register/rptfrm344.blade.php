...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[344,'index'])}}" class="btn singlebt">Production Order Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>Sale Order No</p></div>
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($objSONo as $index=>$Row)
                                        <option value="{{$Row->SOID}}" selected>{{$Row->SONO}}</option>
                                @endforeach
                                </select>
                            </div>                          
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($objPRONo as $index=>$Row)
                                        <option value="{{$Row->PROID}}" selected>{{$Row->PRO_NO}}</option>
                                @endforeach
                                </select>
                            </div>   
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[344,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(PRODUCTION_ORDER_ID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[344,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
