...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[348,'index'])}}" class="btn singlebt">Production & Movement Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjPNMNO as $Gindex=>$GRow)
                                        <option value="{{$GRow->PNMID}}" selected>{{$GRow->PNM_NO}}</option>
                                @endforeach
                                </select>
                            </div>               
                            ...
                            <div class="col-lg-3 pl" id="div_PRO_NO">
                                ...
                                @foreach($ObjProductionOrer as $Iindex=>$IRow)
                                        <option value="{{$IRow->PROID}}" selected>{{$IRow->PRO_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[348,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[348,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
