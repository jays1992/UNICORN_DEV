...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[346,'index'])}}" class="btn singlebt">Material Issues Slip Against RPR Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objMISNo as $index=>$Row)
                                        <option value="{{$Row->MISID}}" selected>{{$Row->MIS_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objMRSNo as $index=>$Row)
                                        <option value="{{$Row->MRSID}}" selected>{{$Row->MRS_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[346,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(MRSID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[346,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
