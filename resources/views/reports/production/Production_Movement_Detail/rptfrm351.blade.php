...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[351,'index'])}}" class="btn singlebt">Production Movement Detail</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjCustomer as $vindex=>$vRow)
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[351,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[351,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
