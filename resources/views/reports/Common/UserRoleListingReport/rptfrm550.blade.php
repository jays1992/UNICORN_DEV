...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                    <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">User Role Listing Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjModule as $cindex=>$cRow)
                                    <option value="{{$cRow->MODULEID}}" selected>{{$cRow->MODULECODE}}-{{$cRow->MODULENAME}}</option>
                                @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjUser as $cindex=>$cRow)
                                    <option value="{{$cRow->USERID}}" selected>{{$cRow->UCODE}}-{{$cRow->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
