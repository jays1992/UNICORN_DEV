...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[332,'index'])}}" class="btn singlebt">Purchase Bill Register</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[332,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(QUANTITY  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $.ajax({
                    url:'{{route("report",[332,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
