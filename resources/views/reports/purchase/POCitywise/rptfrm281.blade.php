...
<!-- <form id="frm_rpt_poscw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[281,'index'])}}" class="btn singlebt">Purchase Order Summary City Wise</a>
                </div><!--col-2-->
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl">
                                <select name="CITY[]" id="CITY" class="form-control selectpicker" multiple data-live-search="true"  >
                                    @foreach($objCity as $index=>$Row)
                                        <option value="{{$Row->CITYID}}" selected>{{$Row->CITYCODE}}-{{$Row->NAME}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
//                 });
//                 $.ajax({
//                     url:'{{route("report",[281,"GetPurchaseOrder"])}}',
//                     type:'POST',
...
$('#btnView').on('click', function() {
    var From_Date       = $('#From_Date').val();
        ...
        else if(CITY  == '')
        {
            ...
            var consultURL = '{{route("report",[281,"ViewReport",":rcdId"]) }}';
