...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[335,'index'])}}" class="btn singlebt">Import Purchase Invoice Register</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_itemid">
                                ...
                                @foreach($objVendor as $Iindex=>$IRow)
                                        <option value="{{$IRow->SGLID}}" selected>{{$IRow->SGLCODE}}-{{$IRow->SLNAME}}</option>
                                @endforeach
                                </select>
                            </div>      
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[335,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[335,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
