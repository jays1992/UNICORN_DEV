...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[371,'index'])}}" class="btn singlebt">Service Purchase Invoice Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SPI_NO" id="SPI_NO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjSPI as $index=>$Row)
                                        <option value="{{$Row->SPI_NO}}" >{{$Row->SPI_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[371,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[371,"ViewReport"])}}',
                type:'POST',
                data:formData,
