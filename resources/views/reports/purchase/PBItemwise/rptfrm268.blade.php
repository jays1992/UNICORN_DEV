...
<!-- <form id="frm_rpt_pbsitw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[268,'index'])}}" class="btn singlebt">Purchase Bill Summary Item Wise</a>
                </div><!--col-2-->
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-lg-2 pl">
                                <select name="ITEMGRP[]" id="ITEMGRP" class="form-control selectpicker" multiple data-live-search="true"  >
                                    @foreach($objItemGroup as $index=>$Row)
...
//                 });
//                 $.ajax({
//                     url:'{{route("report",[268,"GetPurchaseOrder"])}}',
//                     type:'POST',
