...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[493,'index'])}}" class="btn singlebt">Purchase Order Register With Status</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[493,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(SGLID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[493,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
