...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[285,'index'])}}" class="btn singlebt">Purchase Indent Print</a>
                </div><!--col-2-->
                            ...
                            <div class="col-lg-3 pl">
                                <select name="PI_NO" id="PI_NO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjPI as $index=>$Row)
                                        <option value="{{$Row->PIID}}" >{{$Row->PI_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[285,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[285,"ViewReport"])}}',
                type:'POST',
                data:formData,
