...
<!-- <form id="frm_rpt_positw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-3">
                <a href="{{route('report',[253,'index'])}}" class="btn singlebt">Purchase Indent Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_store">
                                ...
                                @foreach($ObjPINO as $cindex=>$cRow)
                                        <option value="{{$cRow->PIID}}" selected>{{$cRow->PI_NO}}</option>
                                @endforeach
                                </select>
                            </div>                            
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[253,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[253,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
