...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[333,'index'])}}" class="btn singlebt">Service Purchase Invoice Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objSPINo as $index=>$Row)
                                        <option value="{{$Row->SPIID}}" selected>{{$Row->SPI_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objSPONo as $index=>$Row)
                                        <option value="{{$Row->SPOID}}" selected>{{$Row->SPO_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[333,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(SPOID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[333,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
