...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[370,'index'])}}" class="btn singlebt">Service Purchase Order Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SPO_NO" id="SPO_NO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjSPO as $index=>$Row)
                                        <option value="{{$Row->SPO_NO}}" >{{$Row->SPO_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[370,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[370,"ViewReport"])}}',
                type:'POST',
                data:formData,
