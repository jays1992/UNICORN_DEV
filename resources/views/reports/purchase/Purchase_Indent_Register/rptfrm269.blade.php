...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[269,'index'])}}" class="btn singlebt">Purchase Indent Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objPINo as $Dindex=>$DRow)
                                        <option value="{{$DRow->PIID}}" selected>{{$DRow->PI_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnView').on('click', function() {
        ...
        else if(PIID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[269,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
