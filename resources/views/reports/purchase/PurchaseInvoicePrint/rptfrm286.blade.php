...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[286,'index'])}}" class="btn singlebt">Purchase Invoice Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="PB_DOCNO" id="PB_DOCNO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjPI as $index=>$Row)
                                        <option value="{{$Row->PBID}}" >{{$Row->PB_DOCNO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[286,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[286,"ViewReport"])}}',
                type:'POST',
                data:formData,
