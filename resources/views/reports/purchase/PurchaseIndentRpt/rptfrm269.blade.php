...
<!-- <form id="frm_rpt_positw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-3">
                <a href="{{route('report',[269,'index'])}}" class="btn singlebt">Purchase Indent Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_store">
                                ...
                                @foreach($ObjStore as $cindex=>$cRow)
                                        <option value="{{$cRow->STID}}" selected>{{$cRow->STCODE}}-{{$cRow->NAME}}</option>
                                @endforeach
                                </select>
                            </div>                            
                            ...
                            <div class="col-lg-3 pl" id="div_dept">
                                ...
                                @foreach($ObjDepartment as $Gindex=>$GRow)
                                        <option value="{{$GRow->DEPID}}" selected>{{$GRow->DCODE}}-{{$GRow->NAME}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
