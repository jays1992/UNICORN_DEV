...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[262,'index'])}}" class="btn singlebt">Annual Sales Forecast Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                     
                            ...
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objAFSNo as $Dindex=>$DRow)
                                        <option value="{{$DRow->AFSID}}" selected>{{$DRow->AFSNO}}</option>
                                @endforeach
                                </select>
                            </div> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[262,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(AFSID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[262,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
