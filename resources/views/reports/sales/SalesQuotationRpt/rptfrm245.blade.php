...
<!-- <form id="frm_rpt_sislw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-3">
                <a href="{{route('report',[245,'index'])}}" class="btn singlebt">Sales Quotation Report</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[245,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(OrderBy  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[245,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
