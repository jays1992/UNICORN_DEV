...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[375,'index'])}}" class="btn singlebt">Sales Service Order Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SSO_NO" id="SSO_NO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjSSO as $index=>$Row)
                                        <option value="{{$Row->SSOID}}" >{{$Row->SSO_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[375,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[375,"ViewReport"])}}',
                type:'POST',
                data:formData,
