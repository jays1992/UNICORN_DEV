...
<!-- <form id="frm_rpt_sop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[378,'index'])}}" class="btn singlebt">Open Sales Order Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="OSONO" id="OSONO" class="form-control mandatory">
                                    ...
                                    @foreach($objOSO as $index=>$Row)
                                        <option value="{{$Row->OSOID}}" >{{$Row->OSONO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[378,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[378,"ViewReport"])}}',
                type:'POST',
                data:formData,
