...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[252,'index'])}}" class="btn singlebt">Sales Service Invoice Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_ssiid">
                                ...
                                @foreach($ObjSSINO as $Gindex=>$GRow)
                                        <option value="{{$GRow->SSIID}}" selected>{{$GRow->SSI_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[252,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
