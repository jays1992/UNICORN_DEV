...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[376,'index'])}}" class="btn singlebt">Sales Service Invoice Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SSI_NO" id="SSI_NO" class="form-control mandatory">
                                    ...
                                    @foreach($ObjSSI as $index=>$Row)
                                        <option value="{{$Row->SSIID}}" >{{$Row->SSI_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[376,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[376,"ViewReport"])}}',
                type:'POST',
                data:formData,
