...
<!-- <form id="frm_rpt_sep" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[294,'index'])}}" class="btn singlebt">Sales Enquiry Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="ENQNO" id="ENQNO" class="form-control mandatory">
                                    ...
                                    @foreach($objENQNO as $index=>$Row)
                                        <option value="{{$Row->SEQID}}" >{{$Row->ENQNO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[294,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[294,"ViewReport"])}}',
                type:'POST',
                data:formData,
