...
<!-- <form id="frm_rpt_sos" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[252,'index'])}}" class="btn singlebt">Sales Order Summary State Wise</a>
                </div><!--col-2-->
...
$('#btnView').on('click', function() {
        ...
        else if(STID  == '')
        {
            ...
            var consultURL = '{{route("report",[252,"ViewReport",":rcdId"]) }}';
