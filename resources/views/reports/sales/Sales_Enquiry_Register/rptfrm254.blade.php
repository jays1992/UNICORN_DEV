                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_gl">
                                ...
                                @foreach($ObjGeneralLedger as $GLindex=>$GLRow)
                                        <option value="{{$GLRow->GLID}}" selected>{{$GLRow->GLCODE}}-{{$GLRow->GLNAME}}</option>
                                @endforeach
                                </select>
                            </div>                            
                        ...
                        <div class="col-lg-3 pl"><p>SEQ NO</p></div>
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objSENo as $Sindex=>$SRow)
                                        <option value="{{$SRow->SEQID}}" selected>{{$SRow->ENQNO}}</option>
                                @endforeach
                                </select>
                            </div> 
