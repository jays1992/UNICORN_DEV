...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[251,'index'])}}" class="btn singlebt">Daily Sales Plan Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjDailySalesPlan as $Gindex=>$GRow)
                                        <option value="{{$GRow->DSPID}}" selected>{{$GRow->DSPNO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[251,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
