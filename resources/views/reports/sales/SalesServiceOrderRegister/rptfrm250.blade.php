...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[250,'index'])}}" class="btn singlebt">Sales Service Order Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_ssoid">
                                ...
                                @foreach($ObjSSONO as $Gindex=>$GRow)
                                        <option value="{{$GRow->SSOID}}" selected>{{$GRow->SSO_NO}}</option>
                                @endforeach
                                </select>
                            </div>                            
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[250,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
