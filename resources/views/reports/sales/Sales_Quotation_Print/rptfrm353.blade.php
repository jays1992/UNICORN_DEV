...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[353,'index'])}}" class="btn singlebt">Sales Quotation Print</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">  
                        ...
                        <div class="row">    
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($ObjSQNO as $Sindex=>$SRow)
                                        <option value="{{$SRow->SQID}}" selected>{{$SRow->SQNO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[353,"ViewReport",":rcdId"]) }}';
  ...
  var SQID=$("#SQID").val(); 
        ...
        if(SQID ==="")
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[353,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
