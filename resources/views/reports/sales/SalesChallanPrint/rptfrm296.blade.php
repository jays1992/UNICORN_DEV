...
<!-- <form id="frm_rpt_sc" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[296,'index'])}}" class="btn singlebt">Sales Challan Print</a>
                </div><!--col-2-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 pl">
                                <select name="SCNO" id="SCNO" class="form-control mandatory">
                                    ...
                                    @foreach($objSCNO as $index=>$Row)
                                        <option value="{{$Row->SCID}}" >{{$Row->SCNO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[296,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[296,"ViewReport"])}}',
                type:'POST',
                data:formData,
