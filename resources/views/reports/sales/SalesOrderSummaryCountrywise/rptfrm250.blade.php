...
<!-- <form id="frm_rpt_soc" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[250,'index'])}}" class="btn singlebt">Sales Order Summary Country Wise</a>
                </div><!--col-2-->
...
$(document).ready(function(e) {
   ...
   $('#To_Date').change(function(){
       ...
       if(From_Date != '' && To_Date != '')
       {
                ...
                $.ajax({
                    url:'{{route("report",[250,"GetCountry"])}}',
                    type:'POST',
...
$('#btnView').on('click', function() {
        ...
        else if(CTRYID  == '')
        {
            ...
            var consultURL = '{{route("report",[250,"ViewReport",":rcdId"]) }}';
