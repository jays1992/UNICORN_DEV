...
<!-- <form id="frm_rpt_sic" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[249,'index'])}}" class="btn singlebt">Dispatch Summary City Wise</a>
                </div><!--col-2-->
...
$('#btnView').on('click', function() {
        ...
        else if(CITYID  == '')
        {
            ...
            var consultURL = '{{route("report",[249,"ViewReport",":rcdId"]) }}';
