...
<!-- <form id="frm_rpt_sospw" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[246,'index'])}}" class="btn singlebt">Sales Order Summary Sales Person Wise</a>
                </div><!--col-2-->
...
$('#btnView').on('click', function() {
        ...
        else if(SPID  == '')
        {
            ...
            var consultURL = '{{route("report",[246,"ViewReport",":rcdId"]) }}';
