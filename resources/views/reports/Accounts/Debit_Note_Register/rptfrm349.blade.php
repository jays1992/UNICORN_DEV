...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[349,'index'])}}" class="btn singlebt">Debit Note Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>DSV NO</p></div>
                            <div class="col-lg-3 pl">
                                ...
                                @foreach($objDSVNo as $Dindex=>$DRow)
                                        <option value="{{$DRow->DSVID}}" selected>{{$DRow->DSV_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[349,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(DSVID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[349,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
