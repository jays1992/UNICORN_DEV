...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[350,'index'])}}" class="btn singlebt">Credit Note Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>CSV NO</p></div>
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($objCSVNo as $Dindex=>$DRow)
                                        <option value="{{$DRow->CSVID}}" selected>{{$DRow->CSV_NO}}</option>
                                @endforeach
                                </select>
                            </div> 
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[350,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(CSVID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[350,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
