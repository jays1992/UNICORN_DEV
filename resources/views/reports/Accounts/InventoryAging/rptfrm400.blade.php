...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[400,'index'])}}" class="btn singlebt">Inventory Aging Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        <div class="row">     
                            ...
                            <div class="col-lg-3 pl">
                                <input type="date" name="DATEASON" id="DATEASON" value="{{ old('DATEASON') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
                            </div>                                                       
                        </div>
                        <div class="row"> 
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[400,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(ITEMID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[400,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
