...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[555,'index'])}}" class="btn singlebt">Bank Reconcilation Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_bank">
                                ...
                                @foreach($ObjBank as $cindex=>$cRow)
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[555,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
		...
		else if(RECONCILE  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[555,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
