...
<!-- <form id="frm_rpt_pop" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('report',[374,'index'])}}" class="btn singlebt">Journal Entry Print</a>
                </div><!--col-2-->
        ...
        <form id="frm_rpt_pop"  method="POST">   
            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        <div class="row">
                            <div class="col-lg-3 pl"><p>Journal Entry Number</p></div>
                            <div class="col-lg-3 pl">
                                <select name="JV_NO" id="JV_NO" class="form-control mandatory">
                                    <option value="">select</option>
                                    @foreach($ObjJV as $index=>$Row)
                                        <option value="{{$Row->JVID}}" >{{$Row->JV_NO}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function(e) {
   ...
   $('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[374,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        if(JV_NO  == '')
        {
            ...
            $("#OkBtn").hide();
            $("#OkBtn1").show();
            $("#AlertMessage").text('Please Select Journal Entry.');
            $("#alert").modal('show');
            $("#OkBtn1").focus();
            return false;
        }
        else
        {
            ...
            $(".buttonload").show();
            $.ajax({
                url:'{{route("report",[374,"ViewReport"])}}',
                type:'POST',
                data:formData,
