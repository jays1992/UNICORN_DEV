...
<!-- <form id="frm_rpt_ledger" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[380,'index'])}}" class="btn singlebt">Vendor Ledger Summary Document Wise</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>Vendor</p></div>
                            <div class="col-lg-3 pl" id="div_vdg">
                                ...
                                @foreach($ObjVendor as $cindex=>$Row)
                                        <option value="{{$Row->SGLID}}" selected>{{$Row->SGLCODE}}-{{$Row->SLNAME}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[380,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(VD  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[380,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
