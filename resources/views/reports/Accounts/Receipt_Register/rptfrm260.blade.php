...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[260,'index'])}}" class="btn singlebt">Receipt Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($objReceiptNo as $Rindex=>$RRow)
                                        <option value="{{$RRow->RECEIPTID}}" selected>{{$RRow->RECEIPT_NO}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>    
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[260,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(RECEIPTID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[260,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
