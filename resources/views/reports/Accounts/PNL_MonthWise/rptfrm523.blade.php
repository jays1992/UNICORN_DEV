...
<!-- <form id="frm_rpt_sis" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[523,'index'])}}" class="btn singlebt">Month Wise Profit & Loss</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
						...
						<div class="row">
                            ...
                            <div class="col-lg-3 pl" id="div_ag">
                                ...
                                @foreach($ObjAccountSubGroup as $cindex=>$cRow)
                                        <option value="{{$cRow->ASGID}}" selected>{{$cRow->ASGCODE}}-{{$cRow->ASGNAME}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[523,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
		...
		else if(LEVELID ==="")
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[523,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
