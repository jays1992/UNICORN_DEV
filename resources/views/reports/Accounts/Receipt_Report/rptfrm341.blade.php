...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[341,'index'])}}" class="btn singlebt">Receipt Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">                           
                            ...
                            <div class="col-lg-3 pl" id="">
                                ...
                                @foreach($objReceiptNo as $Pindex=>$PRow)
                                        <option value="{{$PRow->RECEIPTID}}" selected>{{$PRow->RECEIPT_NO}}</option>
                                @endforeach
                                </select>
                            </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[341,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(RECEIPTID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[341,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
