...
<!-- <form id="frm_rpt_ledger" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[1392,'index'])}}" class="btn singlebt">Section Wise TDS Report</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>Section</p></div>
                            <div class="col-lg-3 pl" id="div_vdg">
                                ...
                                @foreach($ObjSection as $bindex=>$bRow)
                                        <option value="{{$bRow->SECTIONID}}" selected>{{$bRow->SECTION_CODE}}-{{$bRow->SECTION_NAME}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[1392,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(SECTION  == '')
        {
            ...
            $.ajaxSetup({
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[1392,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
