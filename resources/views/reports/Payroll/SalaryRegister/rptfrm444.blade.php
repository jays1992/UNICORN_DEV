...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[444,'index'])}}" class="btn singlebt">Salary Register</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl">
                                <select name="PAYPERIODID" data-hide-disabled="hide"  data-actions-box="true" id="PAYPERIODID"  class="form-control selectpicker"  data-live-search="true"  >
                                    @foreach($ObjPayPeriod as $ppindex=>$ppRow)
                                        <option value="{{$ppRow->PAYPERIODID}}" selected>{{$ppRow->PAY_PERIOD_DESC}}</option>
                                    @endforeach
                                </select>
                            </div>                            
                        ...
                        <div class="row">              
                            ...
                            <div class="col-lg-3 pl" id="div_itemgrp">
                                ...
                                @foreach($ObjDesignation as $index=>$Row)
                                        <option value="{{$Row->DESGID}}" selected>{{$Row->DESCRIPTIONS}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[444,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(EMPID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[444,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
