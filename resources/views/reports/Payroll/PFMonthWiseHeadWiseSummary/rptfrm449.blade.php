...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[449,'index'])}}" class="btn singlebt">PF Month Wise Head Wise Summary</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                     ...
                     <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjEarningHead as $index=>$Row)
                                        <option value="{{$Row->EARNING_HEADID}}" selected>{{$Row->EARNING_HEADCODE}}-{{$Row->EARNING_HEAD_DESC}}</option>
                                @endforeach
                                </select>
                            </div>                            
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[449,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(EARNING_HEADID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[449,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
