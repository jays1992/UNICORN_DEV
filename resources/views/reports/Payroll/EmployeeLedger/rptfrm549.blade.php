...
<!-- <form id="frm_rpt_pbs" onsubmit="return validateForm()"  method="POST" class="needs-validation"  >     -->
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                    <a href="{{route('report',[$FormId,'index'])}}" class="btn singlebt">Employee Ledger</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjCompany as $cindex=>$cRow)
                                    <option value="{{$cRow->CYID}}" selected>{{$cRow->CYCODE}}-{{$cRow->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjEmployee as $cindex=>$cRow)
                                    <option value="{{$cRow->EMPID}}" selected>{{$cRow->EMPCODE}}-{{$cRow->FNAME}} {{$cRow->MNAME}} {{$cRow->LNAME}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjType as $cindex=>$cRow)
                                    <option value="{{$cRow->TYPE}}" selected>{{$cRow->TYPE}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
