...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[451,'index'])}}" class="btn singlebt">TDS Deduction Summary</a>
                </div><!--col-2-->
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[451,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(GRADEID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[451,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
