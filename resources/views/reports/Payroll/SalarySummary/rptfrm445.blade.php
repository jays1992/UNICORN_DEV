...
@section('content')
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-4">
                <a href="{{route('report',[445,'index'])}}" class="btn singlebt">Salary Summary</a>
                </div><!--col-2-->
                    ...
                    <div class="inner-form">
                        ...
                        <div class="col-lg-3 pl"><p>Leave Type</p></div>
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($ObjLeaveType as $index=>$Row)
                                        <option value="{{$Row->LTID}}" selected>{{$Row->LEAVETYPE_CODE}}-{{$Row->LEAVETYPE_DESC}}</option>
                                @endforeach
                                </select>
                            </div>                          
...
$('#btnPdf').on('click', function() {
    ...
    var consultURL = '{{route("report",[445,"ViewReport",":rcdId"]) }}';
...
$('#btnView').on('click', function() {
        ...
        else if(LTID  == '')
        {
            ...
            var formData = trnsoForm.serialize();
                ...
                $(".buttonload").show();
                $.ajax({
                    url:'{{route("report",[445,"ViewReport"])}}',
                    type:'POST',
                    data:formData,
