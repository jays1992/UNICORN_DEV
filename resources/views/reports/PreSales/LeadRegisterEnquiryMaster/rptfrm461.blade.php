...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-4"><a href="{{route('report',[$FORM_ID,'index'])}}" class="btn singlebt">Lead Register Enquiry Master</a></div>
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-3 pl" id="div_cust">
                                ...
                                @foreach($SourceOfEnq as $key=>$val)
                                <option value="{{$val->ID}}" selected>{{$val->SOURCE_OF_ENQ}}</option>
                                @endforeach
                                </select>
                            </div>
