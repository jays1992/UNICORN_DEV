        ...
        <form method="POST"  id="loginForm" onsubmit="return validateForm()"  >
            @csrf
			 ...
			 <i class="fa fa-lock icon"></i> 
              ...
              <input id="PASSWORD" type="PASSWORD" class="form-control control @error('PASSWORD') is-invalid @enderror" name="PASSWORD" autocomplete="current-PASSWORD" placeholder="Password"  tabindex="2"  >
