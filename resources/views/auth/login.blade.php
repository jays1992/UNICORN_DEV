        ...
        <div class="row">
                <div class="form-container">
                    ...
                    <div class="right-content">
                        <h3 class="form-title"><img src="{{ asset('img/logo.png') }}"  /></h3>
                        <form method="POST" class="form-horizontal"  id="loginForm" onsubmit="return validateForm()"  >
                        @csrf
                        <div class="form-group input-icons">
                        <!-- <i class="fa fa-user icon"></i>  -->
                        <input id="UCODE" type="text" class="form-control control" name="UCODE" value="{{ old('UCODE') }}" autocomplete="off" placeholder="User ID" onfocusout="getCompany()" tabindex="1" >
                        ...
                        <input id="PASSWORD" type="PASSWORD" class="form-control control @error('PASSWORD') is-invalid @enderror" onfocusout="getCompany()" name="PASSWORD" autocomplete="current-PASSWORD" placeholder="Password"  tabindex="2"  >
