       ...
       <div class="inner-form">
             ...
             <div class="row">            
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="ASSTLCODE" id="ASSTLCODE" value="{{ $HDR->ALCODE }}" class="form-control"  maxlength="100" disabled> 
               ...
               <div class="col-lg-2 pl">
                 <input type="text" name="ASSTLDES" id="ASSTLDES" value="{{ $HDR->DESCRIPTIONS }}" class="form-control"  maxlength="100" disabled> 
               </div>                                
             </div>
           ...
           <div class="row">
             ...
             <div class="col-lg-2 pl">
               <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" {{$objResponse->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objResponse->DODEACTIVATED) && $objResponse->DODEACTIVATED !="" && $objResponse->DODEACTIVATED !="1900-01-01" ? $objResponse->DODEACTIVATED:''}}" tabindex="3" disabled placeholder="dd/mm/yyyy"  />
             </div>
          </div>
                   ...
                   <tr>   
                     ...
                     <tbody>
                       ...
                       <tr  class="participantRow">
                         <td hidden><input type="hidden" name="ASLID" id="ASLID" value="{{ $row->ASLID }}" disabled/></td>
                           <td><input  class="form-control" type="text" name="SUBLCODE[]"   id ={{"SUBLCODE_".$key}}  value="{{ $row->ASLCODE }}" autocomplete="off" disabled></td>
                           <td><input  class="form-control" type="text" name="SUBLDES[]"   id ={{"SUBLDES_".$key}}    value="{{ $row->DESCRIPTIONS }}" autocomplete="off" disabled></td>
                           <td><select  name="INACTIVE[]" id ={{"INACTIVE_".$key}} class="form-control mandatory" tabindex="4" disabled>
                             <option value="" selected >Select</option>
                             <option {{isset($MAT->YESNO) && $MAT->YESNO == '1'?'selected="selected"':''}} value="1">Yes</option>
                             <option {{isset($MAT->YESNO) && $MAT->YESNO == '0'?'selected="selected"':''}} value="0">No</option>                              
                           </select>
                           <td>
                           <input  class="form-control" type="date" name="INACTIVEDATE[]" id ={{"INACTIVEDATE_".$key}}  value="{{ $row->MEMO }}" autocomplete="off" disabled>
                           <td align="center" >
