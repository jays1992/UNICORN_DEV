...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_import" method="post" enctype="multipart/form-data" action='{{route("mastermodify",[48,"importexcelindb"])}}' > 
          @CSRF
          ...
          <div class="inner-form">
            ...
            <div class="col-lg-4 pl">
              <a href="{{ route("mastermodify",[48,"downloadexcelsamplefile"]) }}"  >download</a>              
            </div>            
          </div>
