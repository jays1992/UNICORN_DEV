		...
		<div class="inner-form">
          ...
          <span class="text-danger" id="ERROR_VENDOR_LEGAL_NAME"></span>
			...
			<div class="row">
			  ...
			  <div class="col-lg-2 pl">
				<input type="text" name="GLID_REF_POPUP" id="GLID_REF_POPUP" class="form-control mandatory" value="{{ isset($objOldGlList->GLCODE) ?  $objOldGlList->GLCODE.'-'.$objOldGlList->GLNAME :''}}" required readonly tabindex="6" />
                <input type="hidden" name="GLID_REF" id="GLID_REF"  value="{{ isset($objOldGlList->GLID) ? $objOldGlList->GLID:'' }}"/>
