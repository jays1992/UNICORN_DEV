...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[51,'index'])}}" class="btn singlebt">Vendor - Item Info</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
                ...
                @endphp
                <tr>
                  <td><input type="checkbox" id="chkId{{$val->VIINFOID}}" value="{{$val->VIINFOID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                  <td>{{isset($val->VIINFONO) && $val->VIINFONO !=''?$val->VIINFONO:''}}</td>
                  <td>{{isset($val->VIINFODT) && $val->VIINFODT !='' && $val->VIINFODT !='1900-01-01' ? date('d-m-Y',strtotime($val->VIINFODT)):''}}</td>
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[51,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[51,"view",":rcdId"]) }}';
              ...
              $.ajax({
                  ...
                  success:function(data) {               
                        ...
                        if(data.approve) {                   
                            ...
                            $("#alert").modal('show');
                            $("#OkBtn").focus();
                           // window.location.href="{{ route('master',[51,'index']) }}";
                        }               
                    },
                    error:function(data){
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[51,"attachment",":rcdId"]) }}';
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[51,"cancel"])}}',
                            type:'POST',
