    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody>               
              ...
              @endphp
              <tr>
                <td><input type="checkbox" id="chkId{{$val->INSTRUMENT_METHOD_ID}}" value="{{$val->INSTRUMENT_METHOD_ID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->INSTRUMENT_METHOD_CODE) && $val->INSTRUMENT_METHOD_CODE !=''?$val->INSTRUMENT_METHOD_CODE:''}}</td>
                <td>{{isset($val->INSTRUMENT_METHOD_NAME) && $val->INSTRUMENT_METHOD_NAME !=''?$val->INSTRUMENT_METHOD_NAME:''}}</td>
        ...
        <form id="masterForm385Print" action="{{ route('mastergetlist',[385,'printdata'])}}" method="POST" >
            @csrf
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[385,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[385,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[385,"attachment",":rcdId"]) }}';
...
var recordId = resultIdsDataID;
  ...
  $.ajax({
      url:'{{ route("master",[385,"MultiApprove"])}}',
      type:'POST',
      dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[385,"cancel"])}}',
                            type:'POST',
