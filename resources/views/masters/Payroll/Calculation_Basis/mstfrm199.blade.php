...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Calculation Basis</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive">
            ...
            @endphp            
            <tr>
                <td><input type="checkbox" id="chkId{{$val->CAL_BASISID}}" value="{{$val->CAL_BASISID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->BASIS_DOC_NO) && $val->BASIS_DOC_NO !=''?$val->BASIS_DOC_NO:''}}</td>
                <td>{{isset($val->BASIS_DOC_DT) && $val->BASIS_DOC_DT !='' && $val->BASIS_DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BASIS_DOC_DT)):''}}</td>
