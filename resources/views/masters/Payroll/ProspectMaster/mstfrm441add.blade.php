  ...
  <form id="master_form" method="POST"> 
    ...
    <div class="inner-form">
      <div class="row">
        ...
        <input type="text" name="PCODE" id="PCODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
