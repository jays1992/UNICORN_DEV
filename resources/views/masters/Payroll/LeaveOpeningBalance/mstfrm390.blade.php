...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive">
            ...
            @endphp
            <tr>
              <td><input type="checkbox" id="chkId{{$val->LEAVE_OPBLID}}" value="{{$val->LEAVE_OPBLID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
              <td>{{isset($val->LOB_NO) && $val->LOB_NO !=''?$val->LOB_NO:''}}</td>
              <td>{{isset($val->LOB_DT) && $val->LOB_DT !='' && $val->LOB_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->LOB_DT)):''}}</td>
          ...
          var osoIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '{{route("master",[390,"view",":rcdId"]) }}';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[390,"attachment",":rcdId"]) }}';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[390,"edit",":rcdId"]) }}';
...
var recordId = osoIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[390,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[390,"cancel"])}}',
                            type:'POST',
