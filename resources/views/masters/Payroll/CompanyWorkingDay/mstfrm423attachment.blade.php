     ...
     <div class="inner-form">
      <div class="row">
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label> {{$objCondition->COMPANY_WORKING_CODE}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objCondition->CP_WORKINGID}}" class="form-control" maxlength="50" >
			</div>
