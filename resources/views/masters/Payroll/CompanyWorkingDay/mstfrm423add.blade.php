...
@section('content')
  ...
  <div class="container-fluid purchase-order-view filter">     
    ...
    <div class="row">
      ...
      <input type="text" name="COMPANY_WORK_CODE" id="COMPANY_WORK_CODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
