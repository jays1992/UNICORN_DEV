          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> {{$objResponse->DEDUCTION_HEAD_DESC}} </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>Deduction Head Type</p></div>
                  <div class="col-lg-4 pl">
                  <label> {{ old('DEDUCTION_TYPE_DESC',$objResponse->DEDUCTION_TYPECODE.'-'.$objResponse->DEDUCTION_TYPE_DESC) }} </label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> {{ old('GLNAME',$objResponse->GLCODE.'-'.$objResponse->GLNAME) }}</label>
                  </div>
                </div>
