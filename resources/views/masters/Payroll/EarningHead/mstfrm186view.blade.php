          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 pl">
                    <label> {{$objResponse->EARNING_HEAD_DESC}} </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>Earning Head Type</p></div>
                  <div class="col-lg-4 pl">
                    <label> {{$objResponse->EARNING_TYPECODE.'-'.$objResponse->EARNING_TYPE_DESC}} </label>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-2 pl"><p>GL Name</p></div>
                  <div class="col-lg-4 pl">
                    <label> {{$objResponse->GLCODE.'-'.$objResponse->GLNAME}} </label>
                  </div>
                </div>
