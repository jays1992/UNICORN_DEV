...
@section('content')
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[268,'index'])}}" class="btn singlebt">Terms & Condition Template</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_calculation_attachment" method="post" enctype="multipart/form-data" action='{{route("mastermodify",[268,"docuploads"])}}' > 
          @CSRF
...
?>
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label> {{$objCondition->COMPANY_HOLIDAY_CODE}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objCondition->CP_HOLIDAYID}}" class="form-control" maxlength="50" >
			</div>
