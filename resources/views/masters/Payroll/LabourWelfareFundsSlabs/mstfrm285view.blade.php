                   ...
                   <tr>                          
                     ...
                     <tbody>
                       ...
                       <tr  class="participantRow">
                           ...
                           <td><input  class="form-control" type="text" name={{"TAX_RATE_".$key}}    id ={{"TAX_RATE_".$key}}    value="{{ $row->TAX_RATE }}" autocomplete="off" onkeypress="return onlyNumberKey(event)" disabled style="width: 99%"></td>
                           <td><input  class="form-control" type="text" name={{"LWF_AMOUNT_".$key}}  id ={{"LWF_AMOUNT_".$key}}  value="{{ $row->LWF_AMOUNT }}" autocomplete="off" onkeypress="return onlyNumberKey(event)" disabled style="width: 99%"></td>
                           <td></td>

                           <td><input  class="form-control" type="text" name={{"REMARKS_".$key}}     id ={{"REMARKS_".$key}}     value="{{ $row->REMARKS }}" autocomplete="off" disabled style="width: 99%"></td>
