...
<div class="container-fluid topnav">
  <div class="row">
    <div class="col-lg-2"><a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Salary Structure Master</a></div>
  ...
  <div class="multiple table-responsive  ">
    ...
    <thead id="thead1">
      ...
      @php
        ...
        @endphp
        <tr>
          <td><input type="checkbox" id="chkId{{$val->SALARY_STRUCID}}" value="{{$val->SALARY_STRUCID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
          <td>{{isset($val->SALARY_STRUC_NO) && $val->SALARY_STRUC_NO !=''?$val->SALARY_STRUC_NO:''}}</td>
          <td>{{isset($val->SALARY_STRUC_DESC) && $val->SALARY_STRUC_DESC !=''?$val->SALARY_STRUC_DESC:''}}</td>
