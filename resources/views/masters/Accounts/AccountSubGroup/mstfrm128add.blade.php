          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                        <input type="text" name="ASGCODE" id="ASGCODE" value="{{ old('ASGCODE') }}" class="form-control mandatory" autocomplete="off" maxlength="20" tabindex="1" style="text-transform:uppercase" />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input type="text" name="ASGNAME" id="ASGNAME" class="form-control mandatory" value="{{ old('ASGNAME') }}" maxlength="100" tabindex="2"  />
                  ...
                  <div class="col-lg-2 pl">
                    <div class="col-lg-11 pl">
                      <select name="AGID_REF" id="AGID_REF" class="form-control mandatory" >
                        ...
                        <option value="{{$Ag->AGID}}">{{$Ag->AGCODE.' - '.$Ag->AGNAME}}</option>
                        @endforeach
                      </select>
...
<script>
 ...
 var formResponseMst = $( "#frm_mst_add" );
    ...
    function checkDuplicateCode(){
        ...
        $.ajax({
            url:'{{route("master",[128,"codeduplicate"])}}',
            type:'POST',
            data:formData,
   ...
   window.fnUndoYes = function (){
      ...
      //reload form
      window.location.href = "{{route('master',[128,'add'])}}";
