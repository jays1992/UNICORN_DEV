...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_data_attachment" method="post" enctype="multipart/form-data" action='{{route("mastermodify",[129,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objResponse->SGLID}}" class="form-control" maxlength="50" >
			</div>
