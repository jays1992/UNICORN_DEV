    ...
    {{isset($objMstResponse->HSNID) ? method_field('PUT') : '' }}
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="HSN_NO" id="HSN_NO" value="{{ isset($MAXHSN_NO)?$MAXHSN_NO:'' }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase"  readonly >
          <input type="hidden" name="HSNID_REF" id="HSNID_REF" value="{{ isset($objHSN->HSNID)?$objHSN->HSNID:'' }}" class="form-control" maxlength="15"   readonly >
        </div>

        <div class="col-lg-2 pl"><p>HSN Date*</p></div>
          <div class="col-lg-2 pl">
          <input type="date" name="HSN_DT" id="HSN_DT"  value="{{date('Y-m-d')}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="CUSTOMERAREFNO" id="CUSTOMERAREFNO" class="form-control " autocomplete="off" maxlength="20"  >
			...
			<div class="row">
				...
				<div class="col-lg-2 pl">
					<input type="text" name="HSNCODE" id="HSNCODE" class="form-control mandatory" value="{{ $objMstResponse->HSNCODE }}" maxlength="20" tabindex="1" autocomplete="off" readonly>
					<span class="text-danger" id="ERROR_HSNCODE"></span>
				</div>			
			
				<div class="col-lg-2 pl"><p>HSN Description</p></div>
				<div class="col-lg-4 pl">
					<input type="text" name="HSNDESCRIPTION" id="HSNDESCRIPTION" value="{{ $objMstResponse->HSNDESCRIPTION }}" class="form-control mandatory" maxlength="200" tabindex="2" autocomplete="off" readonly>
...
window.fnSaveData = function (){
    ...
    $.ajax({
        url:'{{route("mastermodify",[144,"saveamendment"])}}',
        type:'POST',
        data:formData,
        success:function(data) {
