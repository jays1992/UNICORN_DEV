                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 pl">
                        <div class="col-lg-12 pl">
                          <input type="text" name="TNC_CODE" id="txttnccode" class="form-control mandatory" value="{{ $objCondition->TNC_CODE }}"  maxlength="15"   autocomplete="off" tabindex="1" style="text-transform:uppercase" readonly >
                        </div>
                      </div>
                    </div>
