        ...
        // Data table for serverside
         var mstudfforListTable =  $('#udfforlistingmst').DataTable({
            ...
            "ajax":{
                     ...
                     "url": "{{ route('mastergetlist',[102,'getListing']) }}",
                     "dataType": "json",
                     "type": "POST",
                      "data": function ( d ) {
                                  d._token= "{{csrf_token()}}";
          ...
          var udflistIdsData = getSeletectedCBox();
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  var viewURL = '{{route("master",[102,"view",":rcdId"]) }}';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[102,"attachment",":rcdId"]) }}';
            ...
            if(seletedRecord==0){
                ...
                highlighFocusBtn('activeOk1');
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[102,"edit",":rcdId"]) }}';
...
var recordId = udflistIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[102,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[102,"cancel"])}}',
                            type:'POST',
