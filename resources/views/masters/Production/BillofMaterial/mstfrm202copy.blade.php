        ...
        <form id="frm_mst_bom"  method="POST">   
            ...
            <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">         
                                ...
                                @elseif(isset($objDD->MANUAL_SR) && $objDD->MANUAL_SR == "1")
                                    <input type="text" name="BOMNO" id="BOMNO"  class="form-control mandatory"  maxlength="{{$objDD->MANUAL_MAXLENGTH}}" tabindex="1" autocomplete="off" style="text-transform:uppercase"  />
                                @else
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="BOM_DT" id="BOM_DT" value="{{date('Y-m-d')}}" class="form-control mandatory" autocomplete="off" value="" placeholder="dd/mm/yyyy" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <input type="text" name="DESCRIPTION" id="DESCRIPTION" class="form-control mandatory" value="{{ isset($objBOM->NAME)?$objBOM->NAME:'' }}"  autocomplete="off" readonly >
                            </div>       
                            <div class="col-lg-2 pl"><p>UOM	 </p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="UOMID_REF_DESC" id="UOMID_REF_DESC" value="{{ isset($objBOM->UOMCODE)?$objBOM->UOMCODE:''}} {{ isset($objBOM->DESCRIPTIONS)?'-'.$objBOM->DESCRIPTIONS:''}}"  class="form-control mandatory" readonly  autocomplete="off" readonly >
                            <input type="hidden" name="UOMID_REF" id="UOMID_REF" value="{{ isset($objBOM->UOMID_REF)?$objBOM->UOMID_REF:'' }}" class="form-control mandatory" readonly  autocomplete="off" readonly >
                            </div>      
