...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_mst_bom"  method="POST">   
            ...
            <div class="row">
                <div class="col-lg-2 pl"><p>BOMA No</p></div>
                ...
                <input type="hidden" id="BOMID_COPY" value="{{ isset($objBOM->BOMID)?$objBOM->BOMID:'' }}">
                          ...
                          <input type="text" name="BOMANO" id="BOMANO" value="{{ $ANumber  }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                          <input type="hidden" name="BOMID_REF" id="BOMID_REF" value="{{ isset($objBOM->BOMID)?$objBOM->BOMID:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
                      
              
                  
                </div>
                
                <div class="col-lg-2 pl"><p>BOMA Date</p></div>
                <div class="col-lg-2 pl">
                      <input type="date" name="BOMADT" id="BOMADT" value="" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" >
                      </div>
                
            
                
                <div class="col-lg-2 pl"><p>Reason to amend BOM</p></div>
                <div class="col-lg-2 pl">
                
                  <input type="text" name="REASON_BOMA" id="REASON_BOMA" value="" class="form-control mandatory"  autocomplete="off"    >
                </div>
              </div>
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">         
                                ...
                                <input type="text" name="BOMNO" id="BOMNO" class="form-control mandatory" value="{{ isset($objBOM->BOM_NO)?$objBOM->BOM_NO:'' }}" readonly  autocomplete="off" style="text-transform:uppercase" autofocus >
                       
                            </div>
                            <div class="col-lg-2 pl"><p>Order Validity From </p></div>
                            <div class="col-lg-2 pl">
                                <input type="date" name="BOM_DT" id="BOM_DT" class="form-control mandatory" autocomplete="off" value="{{ isset($objBOM->BOM_DT)?$objBOM->BOM_DT:'' }}" placeholder="dd/mm/yyyy" >
                               
                            </div>    
                            <div class="col-lg-2 pl"><p>Product Code</p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="ITEM_popup" id="txtitem_popup"  class="form-control mandatory" value="{{ isset($objBOM->ICODE)?$objBOM->ICODE:'' }}"   autocomplete="off" readonly/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                            <input type="text" name="DESCRIPTION" id="DESCRIPTION" class="form-control mandatory" value="{{ isset($objBOM->NAME)?$objBOM->NAME:'' }}" readonly autocomplete="off"  >
                            </div>       
                            <div class="col-lg-2 pl"><p>UOM	 </p></div>
                            <div class="col-lg-2 pl">
                            <input type="text" name="UOMID_REF_DESC" id="UOMID_REF_DESC" value="{{ isset($objBOM->UOMCODE)?$objBOM->UOMCODE:''}} {{ isset($objBOM->DESCRIPTIONS)?'-'.$objBOM->DESCRIPTIONS:''}}" class="form-control mandatory" readonly  autocomplete="off"  >
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="PRODUCEQTY" id="PRODUCEQTY" value="{{ isset($objBOM->PRODUCE_QTY)?$objBOM->PRODUCE_QTY:'' }}" class="form-control"  autocomplete="off"   />
                             </div>                  
                        ...
                        <div class="col-lg-2 pl"><p>Alt Qty	 </p></div>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="PRODUCTION_STAGE_POPUP" id="PRODUCTION_STAGE_POPUP" value="{{ isset($objBOM->PSTAGE_CODE)?$objBOM->PSTAGE_CODE:''}} {{isset($objBOM->PSTAGE_NAME)?'-'.$objBOM->PSTAGE_NAME:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" name="DESIGNNO" id="DESIGNNO" class="form-control" value="{{ isset($objBOM->DESIGN_NO)?$objBOM->DESIGN_NO:'' }}"  autocomplete="off" style="text-transform:uppercase"  />
                            </div>
                        ...
                        <div class="col-lg-2 pl"><p>Drawing No </p></div>
                            <div class="col-lg-2 pl">
                                <input type="text" name="DRAWINGNO" id="DRAWINGNO" class="form-control" value="{{ isset($objBOM->DRAWING_NO)?$objBOM->DRAWING_NO:'' }}" maxlength="100" autocomplete="off" style="text-transform:uppercase">
                            </div>

                          <div class="col-lg-2 pl"><p>Part No </p></div>
                          <div class="col-lg-2 pl">
                              <input type="text" name="PART_NO" id="PART_NO" class="form-control" value="{{ isset($objBOM->PARTNO)?$objBOM->PARTNO:'' }}" autocomplete="off" readonly>
                          </div>
                                          
                          <div class="col-lg-2 pl"><p>Remarks</p></div>
                            <div class="col-lg-2 pl" >
                                <input type="text" name="REMARKS" id="REMARKS" class="form-control" value="{{ isset($objBOM->REMARKS)?$objBOM->REMARKS:'' }}"  autocomplete="off"  />
                        ...
                        <div class="row" >
                          ...
                          <div class="col-lg-2 pl">
                          <input type="checkbox"   name="DEACTIVATED"  id="deactive-checkbox_0" {{isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? "checked" : ""}}
                          value='{{isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? 1 : 0}}' tabindex="2"  >
                          </div>
                          
                          <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
                          <div class="col-lg-2 pl">
                            <input type="date" name="DODEACTIVATED" class="form-control" id="DODEACTIVATED" {{isset($objBOM->DEACTIVATED) && $objBOM->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objBOM->DODEACTIVATED) && $objBOM->DODEACTIVATED !="" && $objBOM->DODEACTIVATED !="1900-01-01" ? $objBOM->DODEACTIVATED:''}}" tabindex="3" placeholder="dd/mm/yyyy"  />
                          </div>
                      </div>
...
<div class="row">
    <ul class="nav nav-tabs">
        ...
        <li><a data-toggle="tab" href="#Subtitute">Subsitute</a></li>
        <li><a data-toggle="tab" href="#ByProduct">By Product</a></li>
        <li><a data-toggle="tab" href="#udf">UDF</a></li>
        <li><a data-toggle="tab" href="#direct_cost">Other Direct Cost	</a></li>
        <li><a data-toggle="tab" href="#instruction">Special Production Instructions</a></li>
    </ul>
                    ...
                    @if(!empty($objOSOMAT))
                      @foreach($objOSOMAT as $key => $row)     
                        ...
                        <input  class="form-control" type="hidden" name={{"BOM_MATID_".$key}} id ={{"BOM_MATID_".$key}} maxlength="100" value="{{ $row->BOM_MATID }}" autocomplete="off"   >
                            ...
                            <td><input type="text" name={{"ItemName_".$key}} id ={{"ItemName_".$key}}  value="{{ $row->NAME }}"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name={{"ItemPartno_".$key}} id ={{"ItemPartno_".$key}}  value="{{ $row->PARTNO }}"  class="form-control" maxlength="200" readonly autocomplete="off"  /></td>
                            <td><input type="text" name={{"popupUOM_".$key}} id ={{"popupUOM_".$key}}  value="{{ $row->UOMCODE.'-'.$row->DESCRIPTIONS }}"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name={{"ItemStockih_".$key}} id={{"ItemStockih_".$key}} value="{{isset($row->STOCK_IN_HAND) && $row->STOCK_IN_HAND !=''?$row->STOCK_IN_HAND:0}}"  class="form-control"  autocomplete="off"  readonly/></td>
                            
                            <td><input type="text" name={{"CONSUMEQTY_".$key}} id ={{"CONSUMEQTY_".$key}}  value="{{ $row->CONSUME_QTY }}"  class="form-control" maxlength="200" autocomplete="off"  /></td>
                            <td><input type="text" name={{"PRODUCTIONQTY_".$key}} id ={{"PRODUCTIONQTY_".$key}}  value="{{ $row->LOSS_PRODUCTION_QTY }}" class="form-control" maxlength="200" autocomplete="off"  /></td>
                            <td><input type="text" name={{"SCRAPQTY_".$key}} id ={{"SCRAPQTY_".$key}}  value="{{ $row->WASTEAGE_SCRAP_QTY }}"  class="form-control" maxlength="200" autocomplete="off"  /></td>
							<td><input type="text" name={{"REMARKS_".$key}} id ={{"REMARKS_".$key}}  value="{{ $row->REMARKS }}"  class="form-control" maxlength="200" autocomplete="off"  /></td>
							<td><input type="text" name={{"REMARKS_".$key}} id ={{"REMARKS_".$key}}  value="{{ $row->REMARKS }}"  class="form-control" maxlength="200" autocomplete="off"  /></td>
                    ...
                    @if(!empty($objSUB))
                      @foreach($objSUB as $key => $row)     
                        ...
                        <input  class="form-control" type="hidden" name={{"BOM_SUBID_".$key}} id ={{"BOM_SUBID_".$key}} maxlength="100" value="{{ $row->BOM_SUBID }}" autocomplete="off"   >
                            ...
                            <td><input type="text" name={{"MainItemCode_".$key}} id ={{"MainItemCode_".$key}} value="{{ $row->ICODE2 }}"  onclick="get_item($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <td><input type="text" name={{"MainItemName_".$key}} id ={{"MainItemName_".$key}} value="{{ $row->NAME2 }}"  class="form-control"  autocomplete="off"  readonly/></td>
                            <td><input type="text" name={{"MainItemCode1_".$key}} id ={{"MainItemCode1_".$key}} value="{{ $row->ICODE }}"  onclick="get_item_substitute($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <td><input type="text" name={{"MainItemPartno1_".$key}} id ={{"MainItemPartno1_".$key}} value="{{ $row->PARTNO }}"  class="form-control"  autocomplete="off"  readonly/></td> 

                            <td><input type="text" name={{"MainItemuom1_".$key}} id ={{"MainItemuom1_".$key}} value="{{ $row->UOMCODE.'-'.$row->DESCRIPTIONS }}"  class="form-control"  autocomplete="off"  readonly/></td>
                            ...
                            <td><input type="text" name={{"CONSUMEQTY1_".$key}} id ={{"CONSUMEQTY1_".$key}} value="{{ $row->CONSUME_QTY }}" class="form-control"  autocomplete="off"  /></td>
                            <td><input type="text" name={{"PRODUCTION1_".$key}} id ={{"PRODUCTION1_".$key}} value="{{ $row->LOSS_PRODUCTION_QTY }}"  class="form-control"  autocomplete="off"  /></td>
                            <td><input type="text" name={{"SCRAP1_".$key}} id ={{"SCRAP1_".$key}} value="{{ $row->WASTEAGE_SCRAP_QTY }}"  class="form-control"  autocomplete="off"  /></td>
                    ...
                    @if(!empty($objOSOUDF))
                      @foreach($objOSOUDF as $Ukey => $Urow)
                        <tr  class="participantRow3">
                          ...
                          <td><input type="text" name={{"popupUDFBOMID_".$Ukey}} id={{"popupUDFBOMID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
...
<div id="direct_cost" class="tab-pane fade">
                    ...
                    @if(!empty($objOTH))
                      @foreach($objOTH as $key => $row)  
                        ...
                        <input  class="form-control" type="hidden" name={{"BOM_OTHID_".$key}} id ={{"BOM_OTHID_".$key}} maxlength="100" value="{{ $row->BOM_OTHID }}" autocomplete="off"   >
                            ...
                            <td><input type="text" name={{"Componentname_".$key}} id ={{"Componentname_".$key}} value="{{ $row->CCOMPONENT_CODE.'-'.$row->DESCRIPTIONS }}"   onclick="get_item_component($(this).attr('id'))" class="form-control"  autocomplete="off"  readonly/></td>                                                
                            ...
                            <td><input type="text" name={{"value_".$key}} id ={{"value_".$key}} maxlength="100" value="{{ $row->VALUE }}"  class="form-control"  autocomplete="off"  /></td>
        ...
        <div id="instruction" class="tab-pane fade">
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="margin-top:10px;height:280px;width:50%;">
           <textarea name="instruction" id="instruction" cols="85" rows="8">{{ isset($objBOM->SPECIAL_INSTRUCTION)?$objBOM->SPECIAL_INSTRUCTION:'' }}</textarea>
            </div>
        </div>
...
var REASON_BOMA     =   $.trim($("#REASON_BOMA").val());
...
if(BOMNO ===""){
    ...
    $("#FocusId").val('REASON_BOMA');
    $("#ProceedBtn").focus();
    $("#YesBtn").hide();
    $("#NoBtn").hide();
    $("#OkBtn1").show();
    $("#AlertMessage").text('Please enter value in  BOMA reason.');
    $("#alert").modal('show');
    $("#OkBtn1").focus();
    return false;
}
...
$.ajax({
    url:'{{ route("mastermodify",[202,"saveamendment"])}}',
    type:'POST',
    data:formData,
    success:function(data) {
