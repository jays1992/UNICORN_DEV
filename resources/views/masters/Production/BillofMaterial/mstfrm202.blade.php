    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            @php
              ...
              @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->BOMID}}" value="{{$val->BOMID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td style="text-transform:uppercase">{{isset($val->BOM_NO) && $val->BOM_NO !=''?$val->BOM_NO:''}}</td>
                <td>{{isset($val->BOM_DT) && $val->BOM_DT !=''?$val->BOM_DT:''}}</td>
                <td>{{isset($val->ITEM_CODE_NAME) && $val->ITEM_CODE_NAME !=''?$val->ITEM_CODE_NAME:''}}</td>
        ...
        <form id="masterForm202Print" action="{{ route('mastergetlist',[202,'printdata'])}}" method="POST" >
            @csrf
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[202,"edit",":rcdId"]) }}';
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[202,"copy",":rcdId"]) }}';
                        editURL = editURL.replace(":rcdId",recordId);
                        window.location.href=editURL;
                  }else if(is_approve==2){
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[202,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[202,"attachment",":rcdId"]) }}';
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '{{route("master",[202,"amendment",":rcdId"]) }}';
                            editURL = editURL.replace(":rcdId",recordId);
                            window.location.href=editURL;
                      }else if(is_approve==2){
...
var recordId = resultIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[202,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[202,"cancel"])}}',
                            type:'POST',
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var consultURL = '{{route("master",[202,"ViewReport",":rcdId"])}}';
...
$('#btnPrint').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'{{route("master",[202,"ViewReport"])}}',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#ReportView').show();
  ...
  var soIdsData = getSeletectedCBox();
    var seletedRecord = soIdsData.length;
      ...
      }else if(seletedRecord==1)
      {
            ...
            var Flag = 'P';
            var formData = 'SO='+ SONO + '&BOMID='+ SONO + '&Flag='+ Flag ;
            var consultURL = '{{route("master",[202,"ViewReport_costing",":rcdId"])}}';
            consultURL = consultURL.replace(":rcdId",formData);
            window.location.href=consultURL;
            event.preventDefault();
      }
...
$('#btnPrint_costing').on('click', function() {
      ...
      }else if(seletedRecord==1)
      {
            ...
            $.ajax({
                url:'{{route("master",[202,"ViewReport_costing"])}}',
                type:'POST',
                data:formData,
                success:function(data) {
...
$('#btnImport').on('click', function(){
  window.location.href='{{route("master",[202,"importdata"]) }}';
});
</script>
@endpush
