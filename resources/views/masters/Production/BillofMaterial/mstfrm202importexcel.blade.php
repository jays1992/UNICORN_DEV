...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_import" method="post" enctype="multipart/form-data" action='{{route("mastermodify",[202,"importexcelindb"])}}' > 
          @CSRF
          ...
          <div class="inner-form">
            ...
            <div class="col-lg-2 pl">
              <label> {{isset($objMstVoucherType[0]->VCODE) ? $objMstVoucherType[0]->VCODE :"" }} </label>
              <input type="hidden" name="VTID_REF" class="form-control" value='{{isset($objMstVoucherType[0]->VTID) ? $objMstVoucherType[0]->VTID: "" }}' />
            </div>
            <div class="col-lg-2 pl"><p>Excel Sample File</p></div>
            <div class="col-lg-4 pl">
              <a href="{{ route("mastermodify",[202,"downloadExcelFormate"]) }}"  >download</a>              
            </div>            
          </div>
