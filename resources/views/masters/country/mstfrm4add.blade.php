         ...
         <form id="frm_mst_country" method="POST"  > 
          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <input type="text" name="CTRYCODE" id="CTRYCODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
              ...
              <div class="row">
                ...
                <div class="col-lg-2 pl ">
                  <input type="text" name="LANG" id="LANG" class="form-control" value="{{ old('LANG') }}"  maxlength="50" style="width:285px;" tabindex="4" >
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 pl">
                  <input type="text" name="CONTINENTAL" id="CONTINENTAL" class="form-control" value="{{ old('CONTINENTAL') }}" maxlength="50" style="width:285px;" tabindex="5" >
                </div>
                
                <div class="col-lg-1 pl col-md-offset-1"><p>Capital</p></div>
                <div class="col-lg-3 pl">
                  <input type="text" name="CAPITAL" id="CAPITAL" class="form-control"  value="{{ old('CAPITAL') }}"   maxlength="50" style="width:285px;" tabindex="6" >
                </div>
              </div>
