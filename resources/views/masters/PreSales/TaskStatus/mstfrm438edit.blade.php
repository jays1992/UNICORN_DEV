...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Task Status</a>
                </div>
          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <label> {{$objResponse->TASK_STATUSCODE}} </label>
                    <input type="hidden" name="TASK_STATUSCODE" id="TASK_STATUSCODE" value="{{ $objResponse->ID }}" />
                    <input type="hidden" name="TASK_STATUSCODE" id="TASK_STATUSCODE" value="{{ $objResponse->TASK_STATUSCODE }}" autocomplete="off"  maxlength="20"   />
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 pl">
                    <input {{$ActionStatus}} type="text" name="TASK_STATUSNAME" id="TASK_STATUSNAME" class="form-control mandatory" value="{{ old('TASK_STATUSNAME',$objResponse->TASK_STATUSNAME) }}" maxlength="200" tabindex="1"  />
                  </div>
                </div>
