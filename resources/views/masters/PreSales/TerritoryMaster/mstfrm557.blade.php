  ...
  <div class="row">
      ...
      <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->TRYID}}" value="{{$val->TRYID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->TRYDOC_NO) && $val->TRYDOC_NO !=''?$val->TRYDOC_NO:''}}</td>
                <td>{{isset($val->DOC_DT) && $val->DOC_DT !=''?$val->DOC_DT:''}}</td> 
