         ...
         <form id="frm_mst_add" method="POST"> 
          ...
          <div class="inner-form">
                <div class="row">
                  ...
                  <input type="text" name="TRYDOC_NO" id="TRYDOC_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
