            ...
            <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
              ...
              <tbody>
                ...
                <tr class="participantRow">
                    <td><input disabled type="checkbox" name="CID_REF[{{$key}}]" {{$row->CID ==$row->CID_REF?'checked':''}} value="{{$row->CID}}" class="checkbox" ></td>
                    <td><input disabled type="text" name="CUSTOMER_CODE_{{$key}}" id="CUSTOMER_CODE_{{$key}}" value="{{$row->CCODE}}" class="form-control showEmp" readonly  style="width:100%;"  /></td>
                    <td><input  disabled type="text" id ="CUSTOMER_NAME_{{$key}}"  id ="CUSTOMER_NAME_{{$key}}" value="{{$row->CUSTOMER_LEGAL_NAME}}" class="form-control w-100" maxlength="200" readonly style="width:100%;" ></td>
