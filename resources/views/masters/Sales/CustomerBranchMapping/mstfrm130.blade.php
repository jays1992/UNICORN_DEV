...
<div class="container-fluid topnav">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->CBRMID}}" value="{{$val->CBRMID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->DOC_NO) && $val->DOC_NO !=''?$val->DOC_NO:''}}</td>
                <td>{{isset($val->DOC_DT) && $val->DOC_DT !='' && $val->DOC_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->DOC_DT)):''}}</td>
