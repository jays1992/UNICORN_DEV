...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[30,'index'])}}" class="btn singlebt">Maximum Retail Price Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody> 
              ...
              @endphp
              <tr>
                <td><input type="checkbox" id="chkId{{$val->MRPID}}" value="{{$val->MRPID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->MRP_NO) && $val->MRP_NO !=''?$val->MRP_NO:''}}</td>
                <td>{{isset($val->MRP_DT) && $val->MRP_DT !=''?$val->MRP_DT:''}}</td>
                <td>{{isset($val->MRP_TITLE) && $val->MRP_TITLE !=''?$val->MRP_TITLE:''}}</td>
...
<script>
  ...
  $(document).ready(function(){
        ...
        $('#btnAdd').on('click', function() {
          var viewURL = '{{route("master",[30,"add"])}}';
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[30,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[30,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[30,"attachment",":rcdId"]) }}';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[30,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[30,"cancel"])}}',
                            type:'POST',
