      ...
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control " value="{{ $objMstCust->REGPIN }}" onkeyup="bind_country_state_city_pincode()"   maxlength="10" tabindex="12"  autocomplete="off" readonly >
			</div>
