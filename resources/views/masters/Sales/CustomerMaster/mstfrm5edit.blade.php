      ...
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-1 pl">
				<input type="text" name="REGPIN" id="REGPIN" class="form-control " value="{{ $objMstCust->REGPIN }}" onkeyup="bind_country_state_city_pincode()"   maxlength="10" tabindex="12"  autocomplete="off" >
			</div>
...
function checkDuplicateName(){
	var NAME  = $("#NAME").val();
  var CID   = @json($objMstCust->CID);
  var EXISTING_MOBILE   = @json($objMstCust->OUR_CODE_INCBOOK);
  var company_check   = '{{$checkCompany}}';
	...
	$.ajax({
		url:'{{route("master",[5,"nameduplicate"])}}',
		type:'POST',
              ...
              if($("#TDS_APPLICABLE").prop("checked") == true &&  $.trim($("#ASSESSEEID_REF").val()) ===''){
                ...
                if(jQuery.inArray("true", allblank12) !== -1){
                      ...
                      return false;
                        ...
                        highlighFocusBtn('activeOk1');
                        return false;
                      }else if($("#OUR_CODE").val()== "" && '{{$checkCompany}}'==""){
                        $("#alert").modal('show');
