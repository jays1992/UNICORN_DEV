         ...
         <form id="frm_mst_transporter" method="POST"  > 
          ...
          <div class="inner-form">
              <div class="row">
                  ...
                  <input type="text" name="TRANSPORTER_CODE" id="TRANSPORTER_CODE" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
