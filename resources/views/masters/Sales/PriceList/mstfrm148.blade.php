...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[148,'index'])}}" class="btn singlebt">Price List Standard Master</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tr>
              ...
              <td>{{isset($val->PL_NO) && $val->PL_NO !=''?$val->PL_NO:''}}</td>
              <td>{{isset($val->PL_DT) && $val->PL_DT !='' && $val->PL_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->PL_DT)):''}}</td>
            ...
            if(seletedRecord==0){
              ...
              var recordId = countryIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[148,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[148,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[148,"attachment",":rcdId"]) }}';
...
var recordId = forApprIdsDataID;
            $.ajaxSetup({
              ...
              $.ajax({
                  url:'{{ route("master",[148,"MultiApprove"])}}',
                  type:'POST',
                  dataType: 'json',
      ...
      window.fnCancelData = function (){
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[148,"cancel"])}}',
                            type:'POST',
...
$('#btnAdd').on('click', function() {
      var viewURL = '{{route("master",[148,"add"])}}';
      window.location.href=viewURL;
  });
</script>
