          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  @foreach($objMAT as $key => $row)
                    ...
                    <td><input {{$ActionStatus}} type="text"  name="QTY[]" id="QTY_{{$key}}" value="{{ $row->ITEM_QTY }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" /></td>
