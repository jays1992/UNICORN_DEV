         ...
         <form id="frm_mst_edit" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          ...
          {{isset($objMstHeader->MCKLISTID) ? method_field('PUT') : '' }}
              ...
              <div class="row">
                ...
                value='{{$objMstHeader->DEACTIVATED == 1 ? 1 : 0}}'  disabled>
                </div>
                
                <div class="col-lg-2 pl"><p>Date of De-Activated</p></div>
                <div class="col-lg-2 pl">
                  <input type="date" name="HDR_DODEACTIVATED" class="form-control" id="HDR_DODEACTIVATED" {{$objMstHeader->DEACTIVATED == 1 ? "" : "disabled"}} value="{{isset($objMstHeader->DODEACTIVATED) && $objMstHeader->DODEACTIVATED !="" && $objMstHeader->DODEACTIVATED !="1900-01-01" ? $objMstHeader->DODEACTIVATED:''}}" placeholder="dd/mm/yyyy" disabled />
                </div>
              </div>
            {{-- deactive row end --}}
                      ...
                      <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                        ...
                        @foreach($objResponse as $key => $row)
                          ...
                          <tr  class="participantRow">
                              ...
                              <td><input type="text" name={{"txtFORM_popup_".$key}} id={{"txtFORM_popup_".$key}} class="form-control" value="{{ $row->MP_CODE }}"  autocomplete="off"  readonly style="width:100%;" disabled /></td>
                              <td  hidden><input type="text" name={{"FORMID_".$key}} id={{"hdnFORMID_".$key}} class="form-control" value="{{ $row->MPID_REF }}"  autocomplete="off" /></td>
                              <td><input  class="form-control" style="width: 100%" type="text" name={{"FORMNAME_".$key}} id ={{"FORMNAME_".$key}} value="{{ $row->MP_DESC }}"   autocomplete="off" readonly disabled></td>
                              ...
                              <td><input type="text" name={{"txtLISTPOP1_popup_".$key}} id={{"txtLISTPOP1_popup_".$key}}  value="{{ $row->MSP_CODE }}" class="form-control "  autocomplete="off"  readonly style="width:100%;" disabled/></td>
                              <td><input  class="form-control w-100" type="text" name={{"DESC2_".$key}}       id ={{"DESC2_".$key}}  value="{{ $row->MSP_DESC }}"  style="width:100%;"  autocomplete="off" readonly disabled></td>
                              <td><input  class="form-control" style="width: 100%" type="text" name={{"STANDARD_VAL_".$key}} id ={{"STANDARDID_VAL_".$key}} value="{{ $row->VALUE }}" maxlength="200" autocomplete="off" disabled></td>                            
