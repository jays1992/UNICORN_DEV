...
@section('content')
    ...
    <div class="container-fluid topnav">
            ...
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('master',[$FormId,'index'])}}" class="btn singlebt">Specification Master</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view filter">     
        ...
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objResponse->SPECIFICATIONID}}" class="form-control" maxlength="50" >
			</div>			
