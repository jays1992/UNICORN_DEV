    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <tbody>               
              ...
              @endphp
              <tr>
                <td><input type="checkbox" id="chkId{{$val->SPECIFICATIONID}}" value="{{$val->SPECIFICATIONID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->SPECIFICATIONCODE) && $val->SPECIFICATIONCODE !=''?$val->SPECIFICATIONCODE:''}}</td>
                <td>{{isset($val->SPECIFICATIONNAME) && $val->SPECIFICATIONNAME !=''?$val->SPECIFICATIONNAME:''}}</td>
        ...
        <form id="masterForm383Print" action="{{ route('mastergetlist',[383,'printdata'])}}" method="POST" >
            @csrf
            ...
            if(seletedRecord==0){
              ...
              var recordId = resultIdsData[0];
                  ...
                  if(is_approve==0){
                    ...
                    var editURL = '{{route("master",[383,"edit",":rcdId"]) }}';
    ...
    $('#btnView').on('click', function() {
      ...
      if(seletedRecord==0){
          ...
          $("#OkBtn1").focus();
            ...
            var viewURL = '{{route("master",[383,"view",":rcdId"]) }}';
              ...
              $("#OkBtn1").focus();
                 ...
                 $("#OkBtn1").focus();
                  ...
                  if(is_approve==2){
                    ...
                    var attachmentURL = '{{route("master",[383,"attachment",":rcdId"]) }}';
...
var recordId = resultIdsDataID;
  ...
  $.ajax({
      url:'{{ route("master",[383,"MultiApprove"])}}',
      type:'POST',
      dataType: 'json',
...
event.preventDefault();
            ...
            $.ajaxSetup({
                          ...
                          $.ajax({
                            url:'{{ route("mastermodify",[383,"cancel"])}}',
                            type:'POST',
