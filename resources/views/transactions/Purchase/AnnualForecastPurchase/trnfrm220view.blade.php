...
<div class="inner-form">
  ...
  <div class="row">
    ...
    <div class="col-lg-1 pl">
              ...
              <input type="text" name="AFSNO" id="AFSNO" value="{{ $objSE->AFP_NO  }}" class="form-control mandatory"  autocomplete="off" readonly disabled="disabled" style="text-transform:uppercase" autofocus >
    ...
    <div class="col-lg-2 pl">
          <input type="date" name="AFSDT" id="AFSDT" value="{{ $objSE->AFP_DT }}" class="form-control mandatory AFSDT"  placeholder="dd/mm/yyyy" disabled="disabled">
          </div>
    
    <div class="col-lg-1 pl"><p> Department	</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="DEPTID_NAME" id="DEPTID_NAME" value="{{ $objSE->NAME }}" disabled="disabled" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="DEPID_REF" id="DEPID_REF" value="{{ $objSE->DEPID_REF }}" disabled="disabled" class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
    
    <div class="col-lg-1 pl"><p>Financial Year</p></div>
    <div class="col-lg-2 pl">
    <input type="text" name="FYID_NAME" id="FYID_NAME" value="{{ $objSE->FYDESCRIPTION }}"  disabled="disabled" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
      <input type="hidden" name="FYID_REF" id="FYID_REF" value="{{ $objSE->FYID_REF }}"  disabled="disabled"class="form-control mandatory"  autocomplete="off"  style="text-transform:uppercase" autofocus >
    </div>
  </div>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="tab-content">
                         ...
                         <input type="text" name={{"BUID_REF_".$key}} id={{"BUID_REF_".$key}}  value="{{$row->BUCODE}}" onClick="get_section($(this).attr('id'))" class="form-control mandatory" style="width:91px" readonly disabled="disabled" tabindex="1" />
                         ...
                         <td hidden> <input type="text" name={{"REF_BUID_".$key}} id={{"REF_BUID_".$key}} value="{{$row->BUID_REF}}" /></td>
                                                 ...
                                                 <!-- <td style="text-align:center;" >
                                                  ...
                                                  -->
                                                  <td><input type="text" name={{"popupITEMID_".$key}} id={{"popupITEMID_".$key}}  class="form-control" value="{{$row->ICODE}}"  autocomplete="off"  readonly disabled="disabled"/></td>
    ...
    <td><input type="text" name={{"Itemspec_".$key}} id={{"Itemspec_".$key}}  class="form-control"  value="{{$row->ITEMSPECI}}" autocomplete="off" disabled="disabled" /></td>
  ...
  <td><input type="text" name={{"MONTH1_AP_".$key}} id={{"MONTH1_AP_".$key}} class="form-control three-digits" value="{{$row->MONTH1_AP}}"   disabled="disabled"       maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH1_RT_".$key}} id={{"MONTH1_RT_".$key}} class="form-control five-digits"  value="{{$row->MONTH1_RT}}" disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH2_AP_".$key}}  id={{"MONTH2_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH2_AP}}"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH2_RT_".$key}}  id={{"MONTH2_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH2_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH3_AP_".$key}}  id={{"MONTH3_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH3_AP}}"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH3_RT_".$key}}  id={{"MONTH3_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH3_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH4_AP_".$key}}  id={{"MONTH4_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH4_AP}}"     disabled="disabled"                        maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH4_RT_".$key}}  id={{"MONTH4_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH4_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH5_AP_".$key}}  id={{"MONTH5_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH5_AP}}"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH5_RT_".$key}}  id={{"MONTH5_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH5_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH6_AP_".$key}}  id={{"MONTH6_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH6_AP}}"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH6_RT_".$key}}  id={{"MONTH6_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH6_RT}}"   disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH7_AP_".$key}}  id={{"MONTH7_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH7_AP}}"     disabled="disabled"                        maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH7_RT_".$key}}  id={{"MONTH7_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH7_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH8_AP_".$key}}  id={{"MONTH8_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH8_AP}}"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH8_RT_".$key}}  id={{"MONTH8_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH8_RT}}"   disabled="disabled" maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH9_AP_".$key}}  id={{"MONTH9_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH9_AP}}"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  <td><input type="text" name={{"MONTH9_TP_".$key}}  id={{"MONTH9_TP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH9_TP}}"   disabled="disabled"   readonly  style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH9_RT_".$key}}  id={{"MONTH9_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH9_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH10_AP_".$key}}  id={{"MONTH10_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH10_AP}}"  disabled="disabled"                           maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH10_RT_".$key}}  id={{"MONTH10_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH10_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH11_AP_".$key}}  id={{"MONTH11_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH11_AP}}"   disabled="disabled"                          maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH11_RT_".$key}}  id={{"MONTH11_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH11_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH12_AP_".$key}}  id={{"MONTH12_AP_".$key}}  class="form-control three-digits"  value="{{$row->MONTH12_AP}}"    disabled="disabled"                         maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
  ...
  <td><input type="text" name={{"MONTH12_RT_".$key}}  id={{"MONTH12_RT_".$key}}  class="form-control five-digits"   value="{{$row->MONTH12_RT}}"  disabled="disabled"  maxlength="13" style="width: 100px;" autocomplete="off"  /></td>
