            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="date" name="VQ_DT" id="VQ_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("VQ_NO",this,@json($doc_req))'  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
