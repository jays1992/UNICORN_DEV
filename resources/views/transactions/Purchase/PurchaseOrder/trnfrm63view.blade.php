                                            ...
                                            @if(!empty($objPOMAT))
                                                @foreach($objPOMAT as $key => $row)
                                                    ...
                                                    <tr  class="participantRow">
                                                        ...
                                                        <td><input {{$ActionStatus}} type="text" name={{"NOOFUNITS_".$key}} id={{"NOOFUNITS_".$key}} class="form-control three-digits" maxlength="13" value="@php echo number_format(floatVal($row->NOOFUNITS),3,'.','');  @endphp"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
