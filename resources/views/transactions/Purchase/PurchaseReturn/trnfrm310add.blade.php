    ...
    <div class="container-fluid filter">
      <div class="inner-form" id="Header_Form">
        ...
        <div class="row">
          ...
          <input type="text" name="PRR_NO" id="PRR_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
          </div>
                              
          <div class="col-lg-2 pl"><p>PRR Date</p></div>
          <div class="col-lg-2 pl">
              <input type="date" name="PRR_DT" id="PRR_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("PRR_NO",this,@json($doc_req))' value="{{ old('PRR_DT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
