      ...
      <div class="inner-form" id="Header_Form" >
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
              <input disabled type="text" name="PRR_NO" id="PRR_NO" value="{{ $objSO->PRR_NO }}" class="form-control mandatory" maxlength="15" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
          </div>
            
            <div class="col-lg-2 pl"><p>PRR Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="PRR_DT" id="PRR_DT" value="{{ $objSO->PRR_DT }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
            ...
            <div class="col-lg-2 pl">
                <input disabled type="text" name="SubGl_popup" id="txtsubgl_popup"  value="{{$objsubglcode->VCODE}} - {{$objsubglcode->NAME}}" class="form-control mandatory"  autocomplete="off" readonly/>
                <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{ $objSO->VID_REF }}" class="form-control" autocomplete="off" />
                <input type="hidden" name="hdnmaterial" id="hdnmaterial" class="form-control" autocomplete="off" />                                                                
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input disabled type="text" name="VCL_NO" id="VCL_NO" value="{{ $objSO->VCL_NO }}" autocomplete="off" class="form-control mandatory" maxlength="200"  >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input disabled type="text" name="txt_TRASPORTER_popup" id="txt_TRASPORTER_popup" value="{{ isset($objSO)?$objSO->TRANSPORTER_CODE:'' }} - {{ isset($objSO)?$objSO->TRANSPORTER_NAME:'' }}" class="form-control mandatory"  autocomplete="off" readonly/>
                                <input type="hidden" name="TRASPORTER_NAME" id="TRASPORTER_NAME" value="{{ $objSO->TRASPORTER_NAME }}" class="form-control" autocomplete="off" />                                                              
                            </div>

                            <div class="col-lg-2 pl"><p>Driver Name</p></div>
                            <div class="col-lg-2 pl">
                              <input disabled type="text" name="DRIVER_NAME" id="DRIVER_NAME" value="{{ $objSO->DRIVER_NAME }}" autocomplete="off" class="form-control" maxlength="200"  >
                            </div>
...
<td><input disabled type="text" name="txtSQ_popup_{{$key}}" id="txtSQ_popup_{{$key}}" value="{{ $row->PB_DOCNO }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text" name="popupITEMID_{{$key}}" id="popupITEMID_{{$key}}" value="{{ $row->ICODE }}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text" name="ItemName_{{$key}}" id="ItemName_{{$key}}" value="{{ $row->ITEM_NAME }}" class="form-control"  autocomplete="off"  readonly style="width:200px;" /></td>
...
<td><input disabled type="text" name="SQMUOM_{{$key}}" id="SQMUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input disabled type="text" name="SQMUOMQTY_{{$key}}" id="SQMUOMQTY_{{$key}}" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
...
<td><input disabled type="text" name="SQAUOM_{{$key}}" id="SQAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
<td><input disabled type="text" name="SQAUOMQTY_{{$key}}" id="SQAUOMQTY_{{$key}}" value="<?php echo (($row->RETURN_QTY_MU*$row->TO_QTY)/$row->FROM_QTY); ?>" class="form-control" autocomplete="off"  readonly/></td>


<td><input disabled type="text" name="popupMUOM_{{$key}}" id="popupMUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ $row->RETURN_QTY_MU }}" class="form-control" maxlength="13" onkeypress="return isNumberDecimalKey(event,this)"  autocomplete="off"  style="width:75px;" /></td>
...
<td><input disabled type="text" name="popupAUOM_{{$key}}" id="popupAUOM_{{$key}}" class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
...
<td><input disabled type="text" name="ALT_UOMID_QTY_{{$key}}" id="ALT_UOMID_QTY_{{$key}}" value="{{ $row->RETURN_QTY_AU }}"  class="form-control three-digits"  autocomplete="off"   style="width:75px;" readonly /></td>

<td style="text-align:center;" ><a disabled class="btn checkstore" id="store_{{$key}}" ><i class="fa fa-clone"></i></a></td>
...
<td><input disabled type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->RATEPUOM_MU }}" class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
<td><input disabled type="text" name="DISAFTT_AMT_{{$key}}" id="DISAFTT_AMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>

<td style="text-align:center;" ><input disabled type="checkbox" value="{{$row->TAX_IMPACT}}" name='flagtype_{{$key}}' id="flagtype_{{$key}}" {{$GST_FLAGE_CHECKED}} ></td>


<td><input disabled type="text" name="IGST_{{$key}}" id="IGST_{{$key}}" value="{{ $row->IGST_RATE }}" class="form-control four-digits" maxlength="8"  autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="IGSTAMT_{{$key}}" id="IGSTAMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGST_{{$key}}" id="CGST_{{$key}}" value="{{ $row->CGST_RATE }}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="CGSTAMT_{{$key}}" id="CGSTAMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGST_{{$key}}" id="SGST_{{$key}}" value="{{ $row->SGST_RATE }}" class="form-control four-digits" maxlength="8" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="SGSTAMT_{{$key}}" id="SGSTAMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TGST_AMT_{{$key}}" id="TGST_AMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
<td><input disabled type="text" name="TOT_AMT_{{$key}}" id="TOT_AMT_{{$key}}" class="form-control two-digits" maxlength="15" autocomplete="off"  readonly style="width:75px;" /></td>
                                        ...
                                        @if(!empty($objSOUDF))
                                            @foreach($objSOUDF as $Ukey => $Urow)
                                                <tr  class="participantRow4">
                                                    ...
                                                    -->
                                                    <td><input disabled type="text" name={{"popupUDFSOID_".$Ukey}} id={{"popupUDFSOID_".$Ukey}}  class="form-control"  autocomplete="off"  readonly/></td>
                                            ...
                                            @foreach($objUdfSOData as $uindex=>$uRow)
                                              <tr  class="participantRow4">
                                                  ...
                                                  -->
                                                  <td><input disabled type="text" name={{"popupUDFSOID_".$uindex}} id={{"popupUDFSOID_".$uindex}} class="form-control" value="{{$uRow->LABEL}}" autocomplete="off"  readonly/></td>
                                            ...
                                            @if(!empty($objSOCAL))
                                                @foreach($objSOCAL as $Ckey => $Crow)
                                                    <tr  class="participantRow5">
                                                        ...
                                                        <td><input disabled type="text" name={{"AMTIGST_".$Ckey}} id={{"AMTIGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input disabled type="text" name={{"AMTCGST_".$Ckey}} id={{"AMTCGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        ...
                                                        <td><input disabled type="text" name={{"AMTSGST_".$Ckey}} id={{"AMTSGST_".$Ckey}} class="form-control two-digits" maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td><input disabled type="text" name={{"TOTGSTAMT_".$Ckey}} id={{"TOTGSTAMT_".$Ckey}} class="form-control two-digits"  maxlength="15" autocomplete="off"  readonly/></td>
                                                        <td style="text-align:center;"><input disabled type="checkbox" class="filter-none" name={{"calACTUAL_".$Ckey}} id={{"calACTUAL_".$Ckey}}  ></td>
