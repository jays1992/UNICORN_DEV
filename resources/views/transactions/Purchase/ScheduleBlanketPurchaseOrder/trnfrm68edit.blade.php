            ...
            <div class="container-fluid filter">
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($objSOS->SBP_DT)?$objSOS->SBP_DT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>                            
