      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="CINV_NO" id="CINV_NO" value="{{isset($HDR->CINV_NO)?$HDR->CINV_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
                            
          <div class="col-lg-1 pl"><p>DOC Date*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="CINV_DT" id="CINV_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($HDR->CINV_DT)?$HDR->CINV_DT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
                            
          <div class="col-lg-1 pl"><p>IPO No*</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="IPO_NO" id="IPO_NO" value="{{isset($HDR->IPO_NO)?$HDR->IPO_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input  type="hidden" name="IPO_ID_REF" id="IPO_ID_REF" value="{{isset($HDR->IPO_ID_REF)?$HDR->IPO_ID_REF:''}}" class="form-control" autocomplete="off" />  
          </div>
          
          <div class="col-lg-1 pl"><p>IPO Date</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="IPO_DATE" id="IPO_DATE" value="{{isset($HDR->IPO_DT)?$HDR->IPO_DT:''}}" class="form-control mandatory" autocomplete="off" readonly />
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" id="SUPPLIER_NAME" value="{{isset($HDR->SLNAME)?$HDR->SLNAME:''}}" class="form-control mandatory" autocomplete="off" readonly />
          </div>

          <div class="col-lg-1 pl"><p>Commercial Status</p></div>
          <div class="col-lg-2 pl">
            <select {{$ActionStatus}}  name="CINV_STATUS" id="CINV_STATUS" class="form-control mandatory" autocomplete="off" >
              <option value="">Select</option>
              <option  {{isset($HDR->CINV_STATUS) && $HDR->CINV_STATUS ==='OPEN'?'selected="selected"':''}}  value="OPEN">OPEN</option>
              <option  {{isset($HDR->CINV_STATUS) && $HDR->CINV_STATUS ==='CLOSED'?'selected="selected"':''}} value="CLOSED">CLOSED</option>
          ...
          <div class="col-lg-5 pl">
            <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" value="{{isset($HDR->REMARKS)?$HDR->REMARKS:''}}" class="form-control mandatory" autocomplete="off" />
          </div>
        </div> 
...
function saveAction(action){
  if(formTrans.valid()){
    ...
    if(action ==='approve' && "{{$checkAttachment}}" =='0' ){
      $("#YesBtn").hide();
      $("#NoBtn").hide();
      $("#OkBtn1").show();
