            ...
            <div class="container-fluid filter">
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="VQ_DT" id="VQ_DT"  value="{{ isset($objMstResponse->BPO_DT)?$objMstResponse->BPO_DT:'' }}"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
