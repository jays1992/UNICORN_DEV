...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
            ...
            @csrf
            {{isset($objMstResponse->BPOID) ? method_field('PUT') : '' }}
                    ...
                    <div class="inner-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="text" name="VQ_NO" id="VQ_NO" value="{{ isset($objMstResponse->BPO_NO)?$objMstResponse->BPO_NO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                              <input type="hidden" name="VQID" id="VQID" value="{{ isset($objMstResponse->BPOID)?$objMstResponse->BPOID:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                              <input type="hidden" name="hdnattachment" id="hdnattachment" class="form-control" autocomplete="off" value="{{$objCountAttachment}}" /> 
                            </div>
                            
                            <div class="col-lg-2 pl"><p>BPO Date*</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="date" name="VQ_DT" id="VQ_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  value="{{ isset($objMstResponse->BPO_DT)?$objMstResponse->BPO_DT:'' }}"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>
                            
                            <div class="col-lg-2 pl"><p>From Department*</p></div> 
                            <div class="col-lg-2 pl">
                            <input {{$ActionStatus}} type="text" name="GLID_popup" id="txtgl_popup" value="{{ isset($objglcode2->DCODE)?$objglcode2->DCODE:'' }} {{ isset($objglcode2->NAME)?'-'.$objglcode2->NAME:'' }}" class="form-control mandatory"  autocomplete="off" readonly/>
                            <input type="hidden" name="GLID_REF" id="GLID_REF" value="{{ isset($objglcode2->DEPID)?$objglcode2->DEPID:'' }}" class="form-control" autocomplete="off" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="Vendor_popup" id="txtvendor_popup"  value="{{ isset($objvendorcode2->VCODE)?$objvendorcode2->VCODE:'' }} {{ isset($objvendorcode2->NAME)?'-'.$objvendorcode2->NAME:'' }}" class="form-control mandatory"  autocomplete="off" readonly/>
                          ...
                          <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="date" name="VFRDT" id="VFRDT"  value="{{ isset($objMstResponse->BPO_VFR)?$objMstResponse->BPO_VFR:'' }}"  class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy"  >
                          </div>
                          
                          <div class="col-lg-2 pl"><p>BPO Validity To*</p></div>
                          <div class="col-lg-2 pl">
                              <input {{$ActionStatus}} type="date" name="VTODT" id="VTODT" value="{{ isset($objMstResponse->BPO_VTO)?$objMstResponse->BPO_VTO:'' }}" class="form-control mandatory" autocomplete="off"  placeholder="dd/mm/yyyy"  >
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$ActionStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS"  value="{{ isset($objMstResponse->CREDIT_DAYS)?$objMstResponse->CREDIT_DAYS:'' }}" class="form-control mandatory" autocomplete="off" value="0"/>
                            </div>
                        ...
                        <div class="row" hidden>
                            ...
                            <div class="col-lg-2 pl">
                                  <input {{$ActionStatus}} type="checkbox" name="DIRECT_VQ" id="DIRECT_VQ" class="form-checkbox" value="1" checked >
                            </div>
                                    ...
                                    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="height:280px;margin-top:10px;" >
                                        <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                                            <thead id="thead1"  style="position: sticky;top: 0">
                                              <th>Item Code<input class="form-control" type="hidden" name="Row_Count1" id ="Row_Count1"  value="{{$objList1Count}}" ></th>
                                              <th>Item Name</th>
                                              <th>UoM</th>
                                            ...
                                            <tbody>
                                              ...
                                              @foreach($objList1 as $key => $row)
                                                <tr  class="participantRow">
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name="popupUOM_{{ $key }}" id="popupUOM_{{ $key }}" value="{{ $row->UOMCODE }} - {{ $row->DESCRIPTIONS }}"  class="form-control"  autocomplete="off"  readonly/></td>
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name="ITEMSPECI_{{ $key }}" id="ITEMSPECI_{{ $key }}" value="{{ $row->ITEMSPECI }}"  class="form-control" maxlength="200" autocomplete="off"  /></td>
                                                  ...
                                                  <td><input {{$ActionStatus}} type="text" name="RATEPUOM_{{ $key }}" id="RATEPUOM_{{ $key }}" value="{{ $row->RATEP_UOM }}"  class="form-control five-digits" maxlength="13"  autocomplete="off" /></td>
                                                  <td align="center" >
...
$(document).ready(function(){   
    ...
    var bpo = <?php echo json_encode($objMstResponse); ?>;
    var today = new Date(); 
    var bodate = today.getFullYear() + "-" + ("0" + (today.getMonth() + 1)).slice(-2) + "-" + ('0' + today.getDate()).slice(-2);
    if(lastdt < bpo.BPO_DT)
    {
    $('#VQ_DT').attr('min',lastdt);
    }
    else
    {
      $('#VQ_DT').attr('min',bpo.BPO_DT);
    }
    $('#VQ_DT').attr('max',bodate);
