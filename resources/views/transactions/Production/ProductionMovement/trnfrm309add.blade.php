  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="PNM_NO" id="PNM_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PNM_DT" id="PNM_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("PNM_NO",this,@json($doc_req))' value="{{ old('PNM_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
