	...
	<div class="container-fluid filter">
		<div class="inner-form">
          ...
          <input type="hidden" name="PROID" id="PROID" value="{{ isset($objResponse)?$objResponse->PROID:'' }}" class="form-control" readonly  autocomplete="off"   >
				...
				<div class="col-lg-2 pl">
					<input {{$ActionStatus}} type="date" name="PRO_DT" id="PRO_DT" value="{{ isset($objResponse)?$objResponse->PRO_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
