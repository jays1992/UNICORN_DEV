  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="RPRO_NO" id="RPRO_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="RPR_DT" id="RPR_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("RPRO_NO",this,@json($doc_req))' value="{{ old('RPR_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
