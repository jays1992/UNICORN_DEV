...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Production Return</a>
        </div>
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input {{$ActionStatus}} type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="{{isset($objResponse->PRR_NO) && $objResponse->PRR_NO !=''?$objResponse->PRR_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			  ...
			  <div class="col-lg-2 pl">
			    <input {{$ActionStatus}} type="date" name="PRR_DT" id="PRR_DT" value="{{isset($objResponse->PRR_DT) && $objResponse->PRR_DT !=''?$objResponse->PRR_DT:''}}" class="form-control mandatory" >
        </div>
