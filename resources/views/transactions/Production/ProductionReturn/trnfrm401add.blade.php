  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="PRR_DOCNO" id="PRR_DOCNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="PRR_DT" id="PRR_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("PRR_DOCNO",this,@json($doc_req))' value="{{ old('PRR_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
