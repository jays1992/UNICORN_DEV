...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[301,'index'])}}" class="btn singlebt">Payment Entry</a>
                </div><!--col-2-->
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_trn_attachment" method="post" enctype="multipart/form-data" action='{{route("transactionmodify",[301,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> {{$objResponse->PAYMENT_NO}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objResponse->PAYMENTID}}" class="form-control" maxlength="50" >
			</div>
...
$(document).ready(function() {
  $('#btnAdd').on('click', function() {
      var viewURL = '{{route("transaction",[301,"add"])}}';
