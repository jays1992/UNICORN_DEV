    ...
    <div class="row" id="divcust1"  style="display:none">
        ...
        <div class="col-lg-2 pl">
            @if(isset($objPAYHDR->CUSTMER_VENDOR_ID) && $objPAYHDR->CUSTMER_VENDOR_ID != '')
               <input {{$ActionStatus}} type="text" name="txtcustomer" id="txtcustomer" class="form-control" value="{{isset($objPAYCUSTVNDR->CODE) && $objPAYCUSTVNDR->CODE !=''?$objPAYCUSTVNDR->CODE:''}} {{isset($objPAYCUSTVNDR->NAME) && $objPAYCUSTVNDR->NAME !=''?'- '.$objPAYCUSTVNDR->NAME:''}}" readonly  />
            @else
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="INSTRUMENT_TYPE" id="INSTRUMENT_TYPE" class="form-control">
                ...
                <option value="CASH" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'CASH' ? 'selected' : ''}} >CASH</option>
                <option value="IMPS" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'IMPS' ? 'selected' : ''}} >IMPS</option>
                <option value="UPI" {{ isset($objPAYHDR->INSTRUMENT_TYPE) && $objPAYHDR->INSTRUMENT_TYPE == 'UPI' ? 'selected' : ''}} >UPI</option>
            </select>                        
        </div>
      ...
      <div class="tab-content">
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist" width="100%" style="height:auto !important;">
                    ...
                    @if(!empty($objPAYINV))
                      @foreach($objPAYINV as $key => $row)
                          <tr  class="participantRow2">
                              ...
                              <td><input {{$ActionStatus}} type="text" name={{"Supplier_InvoiceNo_".$key}} id={{"Supplier_InvoiceNo_".$key}} class="form-control"  autocomplete="off" value="{{$row->SUPPLIERINVOICE}}" readonly/></td>
                    ...
                    @else
                          <tr  class="participantRow2">
                              ...
                              <td><input {{$ActionStatus}} type="text" name="Supplier_InvoiceNo_0" id="Supplier_InvoiceNo_0" class="form-control"  autocomplete="off"  readonly/></td>
        ...
        <div id="Account" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-1 pl">
                    <input type="checkbox" name="SubGL" id="SubGL" {{isset($objPAYHDR->SUB_LEDGER) && $objPAYHDR->SUB_LEDGER == 1 ? 'checked' : ''}}  disabled />
                  ...
                  @if(!empty($objPAYACCOUNT))
                    @foreach($objPAYACCOUNT as $gkey => $grow)
                      <tr  class="participantRow3">
                          <td><input {{$ActionStatus}} type="text" name={{"popupAccount_".$gkey}} id={{"popupAccount_".$gkey}} class="form-control" value="{{isset($grow->GLCODE) && $grow->GLCODE !=''?$grow->GLCODE:''}} {{isset($grow->SGLCODE) && $grow->SGLCODE !=''?$grow->SGLCODE:''}}" autocomplete="off" readonly/></td>
                          ...
                          <td><input {{$ActionStatus}} type="text" name={{"AccountName_".$gkey}} id={{"AccountName_".$gkey}} class="form-control"  autocomplete="off" value="{{isset($grow->GLNAME) && $grow->GLNAME !=''?$grow->GLNAME:''}} {{isset($grow->SLNAME) && $grow->SLNAME !=''?$grow->SLNAME:''}}" readonly/></td>
                          ...
                          <td hidden><input type="hidden" name={{"SLGL_TYPE_".$gkey}} id={{"SLGL_TYPE_".$gkey}} value="{{$grow->SLGL_TYPE}}" class="form-control" autocomplete="off" /></td>
                      ...
                      @endphp
                          ...
                          <td align="center" ><button {{$ActionStatus}} class="btn add aaccount" title="add" data-toggle="tooltip" type="button" ><i class="fa fa-plus"></i></button><button {{$ActionStatus}} class="btn remove daccount" title="Delete" data-toggle="tooltip" type="button" ><i class="fa fa-trash" ></i></button></td>
                      </tr>
                      <tr></tr>
                    @endforeach
                  @else
                      <tr  class="participantRow3">
                          ...
                          <td>                                 
                            <select {{$ActionStatus}} name="TYPE_0" id="TYPE_0" class="form-control" style="width: 85px;">
