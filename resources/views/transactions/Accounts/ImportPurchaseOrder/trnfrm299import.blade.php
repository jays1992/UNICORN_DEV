...
<div class="container-fluid topnav">
  <div class="row">
      <div class="col-lg-2"><a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Import Purchase Order(IPO)</a></div>
...
<div class="container-fluid purchase-order-view filter">     
  <form id="frm_import" method="post" enctype="multipart/form-data" action='{{route("transactionmodify",[$FormId,"importexcelindb"])}}' > 
    @CSRF
    ...
    <div class="inner-form">
      ...
      <div class="col-lg-4 pl">
        <a href="{{ route("transactionmodify",[$FormId,"downloadExcelFormate"]) }}"  >download</a>              
      </div>             
    </div>
    ...
    <div class="row">
      <div class="col-lg-4 pl">
        <span style="font-weight: bold;color:#ff0000;">Data insertion error Please check log file : </span><a href="{{ asset(session("logerror")) }}" target="_blank" >View</a>
      </div>            
    </div>
    @endif
