    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="INSTRUMENT_TYPE" id="INSTRUMENT_TYPE" class="form-control">
                ...
                <option value="CASH" {{ isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'CASH' ? 'selected' : ''}} >CASH</option>
                <option value="IMPS" {{ isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'IMPS' ? 'selected' : ''}} >IMPS</option>
                <option value="UPI" {{ isset($objRCPTHDR->INSTRUMENT_TYPE) && $objRCPTHDR->INSTRUMENT_TYPE == 'UPI' ? 'selected' : ''}} >UPI</option>
            </select>                        
        </div>
      ...
      <div class="tab-content">
        ...
        <div id="Account" class="tab-pane fade in">
            <div class="row" style="margin-top:10px;margin-left:3px;" >	
                ...
                <div class="col-lg-2 pl">
                  <input {{$ActionStatus}} type="text" name="BANK_AMOUNT" id="BANK_AMOUNT" value="{{isset($objRCPTHDR->BANK_AMOUNT)?$objRCPTHDR->BANK_AMOUNT:'' }}" class="form-control"  readonly autocomplete="off"  />
                </div>
                ...
                <div class="col-lg-1 pl">
                    <input type="checkbox" name="SubGL" id="SubGL" {{isset($objRCPTHDR->SUB_LEDGER) && $objRCPTHDR->SUB_LEDGER == 1 ? 'checked' : ''}} disabled />
