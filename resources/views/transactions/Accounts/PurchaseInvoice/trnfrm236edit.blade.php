...
<div class="container-fluid filter">
    ...
    <div class="row">	
      ...
      <div class="col-lg-2 pl">
      <input {{$ActionStatus}} type="text"   name="ROUNDOFF_GLCODE_NAME"  id="ROUNDOFF_GLCODE_NAME" value="{{isset($objPBHDR->GLCODE)?$objPBHDR->GLCODE:''}}{{isset($objPBHDR->GLNAME)?'-'.$objPBHDR->GLNAME:''}}"  class="form-control mandatory"  autocomplete="off"  readonly/>
      <input type="hidden" name="ROUNDOFF_GLID_REF"     id="ROUNDOFF_GLID_REF"    value="{{isset($objPBHDR->ROUNDOFF_GLID_REF)?$objPBHDR->ROUNDOFF_GLID_REF:''}}" class="form-control" autocomplete="off" />
      <input type="hidden" name="ROUNDOFF_TOTAL_AMT"    id="ROUNDOFF_TOTAL_AMT"   value="{{isset($objPBHDR->ROUNDOFF_TOTAL_AMT)?$objPBHDR->ROUNDOFF_TOTAL_AMT:''}}" class="form-control"  autocomplete="off" readonly />
      </div>       

      <div class="col-lg-2 pl"><p>Round of Amount</p></div>
      <div class="col-lg-2 pl">
      <input {{$ActionStatus}} type="text" name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" value="{{isset($objPBHDR->ROUNDOFF_AMT)?number_format($objPBHDR->ROUNDOFF_AMT, 2, '.', ''):''}}" class="form-control"  autocomplete="off" onkeyup="round_calculation()" onkeypress="return isNumberDecimalKey(event,this)"   />
      </div>
      ...
      <select {{$ActionStatus}} name="ROUNDOFF_MODE" id="ROUNDOFF_MODE" class="form-control" onchange="round_calculation()" >
        <option {{isset($objPBHDR->ROUNDOFF_MODE) && $objPBHDR->ROUNDOFF_MODE =="Positive"?"selected='selected'":''}} value="Positive">Debit</option>
        <option {{isset($objPBHDR->ROUNDOFF_MODE) && $objPBHDR->ROUNDOFF_MODE =="Negative"?"selected='selected'":''}} value="Negative">Credit</option>
      </select>                                  
      </div>
    </div>
