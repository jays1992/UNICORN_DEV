...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
              <input type="text" name="JV_NO" id="JV_NO" value="{{ isset($objJV->JV_NO)?$objJV->JV_NO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
         </div>
        <div class="col-lg-1 pl col-md-offset-1"><p>JV Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="{{ isset($objJV->JV_DT)?$objJV->JV_DT:'' }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-lg-1 pl"><p> Reverse	</p></div> 
        <div class="col-lg-1 pl">
                  <input type="checkbox" name="REVERSE" id="REVERSE" {{isset($objJV->REVERSE) && $objJV->REVERSE == 1 ? 'checked' : ''}} />
        </div>
        <div class="col-lg-1 pl"><p>Reverse Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="REVERSE_DT" id="REVERSE_DT" value="{{ isset($objJV->REVERSE_DT)?$objJV->REVERSE_DT:'' }}" class="form-control"  placeholder="dd/mm/yyyy" disabled >
        </div>
		</div>
    <div class="row">
        <div class="col-lg-1 pl"><p>Remarks</p></div>
        <div class="col-lg-5 pl">
            <input type="text" name="REMARKS" id="REMARKS" class="form-control" value="{{ isset($objJV->REMARKS)?$objJV->REMARKS:'' }}"  autocomplete="off"   />
        </div>
        <div class="col-lg-1 pl"><p>Source Doc No</p></div>
        <div class="col-lg-2 pl">
            <input type="text" name="SOURCE_DOCNO" id="SOURCE_DOCNO" class="form-control"  value="{{ isset($objJV->SOURCE_DOCNO)?$objJV->SOURCE_DOCNO:'' }}"   autocomplete="off" disabled  />
        </div>
        
        <div class="col-lg-1 pl"><p>Source Doc Date</p></div>
        <div class="col-lg-2 pl">
            <input type="date" name="SOURCE_DOCDT" id="SOURCE_DOCDT" autocomplete="off"  value="{{ isset($objJV->SOURCE_DOCDT)?$objJV->SOURCE_DOCDT:'' }}"  class="form-control"disabled  >
        </div>
    </div>
    <div class="row">
          <div class="col-lg-1 pl"><p>Common Narration</p></div>
          <div class="col-lg-5 pl">
              <input type="text" name="NARRATION" id="NARRATION" class="form-control"  value="{{ isset($objJV->NARRATION)?$objJV->NARRATION:'' }}"   autocomplete="off"  />                          
          </div>                            
