...
@section('content')
	...
	<div class="inner-form">
        ...
        <div class="col-lg-2 pl">
                  <input type="date" name="JV_DT" id="JV_DT" value="{{ $objJV->JV_DT}}" onchange="checkPeriodClosing(169,this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
