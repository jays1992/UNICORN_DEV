        ...
        <div class="col-lg-2 pl">
            @if($objPBDOCNO)
              @if($objPBDOCNO->SYSTEM_GRSR == "1")
                  <input type="text" name="PII_NO" id="PII_NO" value="{{ $objDataNo }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus >
              @endif
              @if($objPBDOCNO->MANUAL_SR == "1")
                  <input type="text" name="PII_NO" id="PII_NO" value="{{ old('PII_NO') }}" class="form-control mandatory" maxlength="{{$objPBDOCNO->MANUAL_MAXLENGTH}}" autocomplete="off" style="text-transform:uppercase" autofocus >
              @endif
            @else
                <input type="text" name="PII_NO" id="PII_NO" value="{{ old('PII_NO') }}" class="form-control mandatory" maxlength="30" autocomplete="off" style="text-transform:uppercase" autofocus >
            @endif
        </div>
        <div class="col-lg-2 pl"><p>PII Date</p></div>
        <div class="col-lg-2 pl">
                  <input type="date" name="PII_DT" id="PII_DT" value="{{ old('PII_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" />
        </div>
