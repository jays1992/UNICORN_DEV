...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            @endphp
            <tr>
            <td><input type="checkbox" id="chkId{{$val->PII_ID}}" value="{{$val->PII_ID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
            ...
            <td>{{isset($val->VID_REF) && $val->VID_REF !=''?$val->VCODE:''}}</td>
