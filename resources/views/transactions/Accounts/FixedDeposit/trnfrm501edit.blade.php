  ...
  <div class="container-fluid filter">
    <div class="inner-form">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="FD_DATE" id="FD_DATE" value="{{isset($HDR->FD_DATE)?$HDR->FD_DATE:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)"  class="form-control" autocomplete="off" placeholder="dd/mm/yyyy" >
        </div>
      </div>
