...
<form id="transaction_form" method="POST" >
  ...
  <div class="container-fluid filter">
    <div class="inner-form">
      ...
      @if(isset($HDR->MATURE_TYPE) && $HDR->MATURE_TYPE =='PRE MATURITY')
      <div class="row">
        <div class="col-lg-2 pl"><p>Mature Type</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="MATURE_TYPE" id="MATURE_TYPE" value="{{isset($HDR->MATURE_TYPE)?$HDR->MATURE_TYPE:''}}" class="form-control" autocomplete="off" readonly  />
        </div>
      </div> 
      ...
      <div class="row">
        <div class="col-lg-2 pl"><p>Maturity Date</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="PRE_MATURITY_DATE" id="PRE_MATURITY_DATE" value="{{isset($HDR->PRE_MATURITY_DATE)?$HDR->PRE_MATURITY_DATE:''}}" class="form-control" autocomplete="off" onchange="getMatureType()" />
        </div>

        <div class="col-lg-2 pl"><p>Interest calculator</p></div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="INTEREST_CALCULATOR" id="INTEREST_CALCULATOR" value="{{isset($HDR->INTEREST_CALCULATOR)?$HDR->INTEREST_CALCULATOR:''}}" class="form-control" autocomplete="off" onkeyup="getGrossFdValue()" />
        </div>

        <div class="col-lg-2 pl"><p>Gross FD Value</div>
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="text" name="GROSS_FD_VALUE" id="GROSS_FD_VALUE" value="{{isset($HDR->GROSS_FD_VALUE)?$HDR->GROSS_FD_VALUE:''}}" class="form-control" autocomplete="off" readonly />
        </div>
      </div>
      @endif
