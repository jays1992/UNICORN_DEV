    ...
    <div class="container-fluid topnav">
            <div class="row">
                ...
                <div class="col-lg-10 topnav-pd">
                  ...
                  <button class="btn topnavbt"  id="btnApprove"><i class="fa fa-thumbs-o-up"></i> Approved</button>
...
<div class="container-fluid purchase-order-view filter">     
  ...
  <div class="row">
    ...
    <div class="col-lg-2 pl">
      <textarea {{$ActionStatus}} name="REMARKS" id="REMARKS" value="{{ isset($HDR->REMARK)?$HDR->REMARKS:'' }}" style="width: 192px;" class="form-control"></textarea>
    </div>
  </div>
