...
@section('content')
  ...
  <div class="row">	
    ...
    <div class="row">
        ...
        <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="tot_amt" id="tot_amt" value="{{isset($objHDR->NET_TOTAL)?$objHDR->NET_TOTAL:''}}" class="form-control"  autocomplete="off" readonly  />
        </div>
    ...
    <div class="row">	
      ...
      <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="text" name="GLpopup" id="txtGLpopup" value="{{isset($objHDR->GLCODE)?$objHDR->GLCODE:''}}{{isset($objHDR->GLNAME)?'-'.$objHDR->GLNAME:''}}" class="form-control mandatory"  autocomplete="off"  readonly/>
        <input type="hidden" name="ROUNDOFF_GLID_REF" id="ROUNDOFF_GLID_REF" value="{{isset($objHDR->ROUNDOFF_GLID_REF)?$objHDR->ROUNDOFF_GLID_REF:''}}" class="form-control" autocomplete="off" />
        <input type="hidden" name="tot_amt1" id="tot_amt1" value="{{isset($objHDR->ROUNDOFF_TOTAL_AMT)?$objHDR->ROUNDOFF_TOTAL_AMT:''}}" class="form-control"  autocomplete="off" readonly />
      </div>       

      <div class="col-lg-2 pl"><p>Round of Amount</p></div>
      <div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="text" name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" value="{{isset($objHDR->ROUNDOFF_AMT)?number_format($objHDR->ROUNDOFF_AMT, 2, '.', ''):''}}" class="form-control"  autocomplete="off" onkeyup="round_calculation()" onkeypress="return isNumberDecimalKey(event,this)"   />
      </div>

      <div class="col-lg-2 pl"><p>Round of Mode</p></div>
      <div class="col-lg-2 pl">
        <select {{$ActionStatus}} name="ROUNDOFF_MODE" id="ROUNDOFF_MODE" class="form-control" onchange="round_calculation()" >
          <option {{isset($objHDR->ROUNDOFF_MODE) && $objHDR->ROUNDOFF_MODE =="Positive"?"selected='selected'":''}} value="Positive">Debit</option>
          <option {{isset($objHDR->ROUNDOFF_MODE) && $objHDR->ROUNDOFF_MODE =="Negative"?"selected='selected'":''}} value="Negative">Credit</option>
        </select>                                  
      </div>
    </div>
