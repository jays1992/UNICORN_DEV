...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="GRN_NO" id="GRN_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="GRN_DT" id="GRN_DT" value="{{ old('GRN_DT') }}" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("GRN_NO",this,@json($doc_req))' class="form-control mandatory"  placeholder="dd/mm/yyyy" >
            </div>
