  ...
  $('#KnowkOff').find('.participantRow').each(function(){
    if($(this).find('[id*="RECONCIL_AMT_"]').val() != ''){
      ...
      if($(this).find('[id*="DOC_TYPE_"]').val() == 'PURCHASE_INVOICE' 
		  ...
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'PAYMENT' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'CUSTOMER'
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'RECEIPT' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'VENDOR'
		  ...
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'OPENING_BALANCE_CR' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'VENDOR'
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'OPENING_BALANCE_DR' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'CUSTOMER'
        )
      {
        totalvalue = parseFloat(parseFloat(totalvalue) + parseFloat(tvalue)).toFixed(2);
          ...
          || $(this).find('[id*="DOC_TYPE_"]').val() == 'DSV'
          || $(this).find('[id*="DOC_TYPE_"]').val() == 'SALES_RETURN'
          || $(this).find('[id*="DOC_TYPE_"]').val() == 'AR_CREDIT_NOTE'
          || $(this).find('[id*="DOC_TYPE_"]').val() == 'CSV'
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'PAYMENT' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'VENDOR'
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'RECEIPT' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'CUSTOMER'
		  ...
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'OPENING_BALANCE_CR' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'CUSTOMER'
		  || $(this).find('[id*="DOC_TYPE_"]').val() == 'OPENING_BALANCE_DR' && $('input[name="VENDOR_CUSTOMER"]:checked').val() == 'VENDOR'
        )
      {
        totalvalue = parseFloat(parseFloat(totalvalue) - parseFloat(tvalue)).toFixed(2);
      }
