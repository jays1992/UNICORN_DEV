...
<div class="container-fluid topnav">
  <div class="row">
    ...
    <div class="col-lg-10 topnav-pd">
      ...
      <button class="btn topnavbt" id="btnBarcode" {{isset($objRights->VIEW) && $objRights->VIEW != 1 ? 'disabled' : ''}} ><i class="fa fa-barcode"></i> Barcode</button>
...
$('#btnBarcode').on('click', function(){
  ...
  if(seletedRecord==0){
    ...
    $("#OkBtn1").focus();
      ...
      var viweRecordId = resultIdsData[0];
      var viewURL = '{{route("transaction",[$FormId,"barcode",":rcdId"]) }}';
          viewURL = viewURL.replace(":rcdId",viweRecordId);
          window.location.href=viewURL;
  }
});
