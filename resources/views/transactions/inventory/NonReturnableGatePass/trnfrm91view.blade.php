	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input {{$ActionStatus}} type="text" name="NRGP_NO" id="NRGP_NO" value="{{isset($objResponse->NRGP_NO) && $objResponse->NRGP_NO !=''?$objResponse->NRGP_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			...
			<div class="col-lg-2 pl">
			    <input {{$ActionStatus}} type="date" name="NRGP_DT" id="NRGP_DT" value="{{isset($objResponse->NRGP_DT) && $objResponse->NRGP_DT !=''?$objResponse->NRGP_DT:''}}" class="form-control mandatory" >
      </div>
