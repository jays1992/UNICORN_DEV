...
<form id="frm_trn_edit"  method="POST">   
	...
	<div class="inner-form">
		...
		<div class="row">
          ...
          <input {{$ActionStatus}} type="text" name="NRGP_NO" id="NRGP_NO" value="{{isset($objResponse->NRGP_NO) && $objResponse->NRGP_NO !=''?$objResponse->NRGP_NO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
      </div>
			
			<div class="col-lg-1 pl"><p>NRGP Date</p></div>
			<div class="col-lg-2 pl">
			    <input {{$ActionStatus}} type="date" name="NRGP_DT" id="NRGP_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->NRGP_DT) && $objResponse->NRGP_DT !=''?$objResponse->NRGP_DT:''}}" class="form-control mandatory" >
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-1 pl"><p>Direct</p></div>
			<div class="col-lg-2 pl">
        <input {{$ActionStatus}} type="checkbox" id="NRGP_STATUS" {{isset($objResponse->NRGP_STATUS) && $objResponse->NRGP_STATUS =='0'?'checked':''}} value='0' onchange="direct()" disabled >
        <input type="hidden" name="NRGP_STATUS" value="{{isset($objResponse->NRGP_STATUS)?$objResponse->NRGP_STATUS:''}}" >
		...
		<div class="row">
			...
			<div class="tab-content">
              ...
              @foreach($objMAT as $key => $row)
                  ...
                  <td hidden ><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->NRGP_QTY}}" ></td>
                  <td hidden ><input type="hidden" name="HiddenRowId_{{$key}}" id="HiddenRowId_{{$key}}" value="{{ $row->BATCH_QTY_REF}}" ></td>
                  
                  <td><input {{$ActionStatus}} type="text" name={{"SE_QTY_".$key}} id={{"SE_QTY_".$key}} class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13" value="{{ $row->NRGP_QTY}}" autocomplete="off"  /></td>
                  ...
                  <td><input {{$ActionStatus}} type="text" name="REMARKS_{{$key}}" id="REMARKS_{{$key}}" value="{{ $row->REASON_FOR_NRGP }}" class="form-control w-100" autocomplete="off" ></td>
                  <td align="center" >
