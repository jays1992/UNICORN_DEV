...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="NRGP_NO" id="NRGP_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="NRGP_DT" id="NRGP_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("NRGP_NO",this,@json($doc_req))' value="{{ old('NRGP_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>
