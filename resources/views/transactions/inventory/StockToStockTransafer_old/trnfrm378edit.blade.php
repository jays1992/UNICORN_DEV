        ...
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                ...
                <tr>                                   
                  <th colspan="8">Out Stock</th>
                  <th colspan="8">In Stock</th>
                  <th colspan="3"></th>
                </tr>
                  ...
                  @foreach($objMAT as $key => $row)
                    ...
                    <td hidden ><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="" ></td>
                    ...
                    <td><input {{$ActionStatus}} type="text" style="width:100px;" type="text" name="RATE_{{$key}}" id="RATE_{{$key}}" value="{{ $row->RATE }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
                    ...
                    <td><input {{$ActionStatus}} type="text" style="width:100px;" type="text" name="RATE_IN_{{$key}}" id="RATE_IN_{{$key}}" value="{{ $row->RATE_IN }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:130px;text-align:right;"  /></td>
