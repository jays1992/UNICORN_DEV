...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="MIS_NO" id="MIS_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
			...
			<div class="col-lg-2 pl">
				    <input type="date" name="MIS_DT" id="MIS_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("MIS_NO",this,@json($doc_req))' value="{{ old('MIS_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
            </div>
