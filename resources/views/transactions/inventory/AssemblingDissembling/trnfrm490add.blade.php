...
<form id="frm_trn_add" onsubmit="return validateForm()"  method="POST" class="needs-validation" >  
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DATE" id="DOC_DATE" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("DOC_NO",this,@json($doc_req))' class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
