  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="DOC_NO" id="DOC_NO" value="{{isset($objResponse->ADSMNO)?$objResponse->ADSMNO:''}}" class="form-control mandatory" readonly  autocomplete="off"  style="text-transform:uppercase"  >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DATE" id="DOC_DATE" value="{{isset($objResponse->ADSMDT)?$objResponse->ADSMDT:''}}" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
        </div>
        ...
        <div class="col-lg-2 pl">
          <input type="text"    name="MAIN_ITEMID_NAME" id="MAIN_ITEMID_NAME" value="{{isset($objResponse->ICODE)?$objResponse->ICODE:''}}" class="form-control" readonly >
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_UOM" id="MAIN_UOM" value="{{isset($objResponse->UOMCODE)?$objResponse->UOMCODE:''}}{{isset($objResponse->DESCRIPTIONS)?'-'.$objResponse->DESCRIPTIONS:''}}" class="form-control" readonly >
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="MAIN_QTY" id="MAIN_QTY" value="{{isset($objResponse->QTY)?$objResponse->QTY:''}}" class="form-control" onkeypress="return isNumberKey(event,this)" >
        </div>

        <div class="col-lg-1 pl"><p>Store</p></div>
        <div class="col-lg-2 pl">
          <input type="text" name="STID_REF_NAME" id="STID_REF_NAME" value="{{isset($objResponse->STCODE)?$objResponse->STCODE:''}}{{isset($objResponse->STNAME)?'-'.$objResponse->STNAME:''}}" onclick="modal('show')" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="REMARKS" id="REMARKS" value="{{isset($objResponse->REMARKS)?$objResponse->REMARKS:''}}" class="form-control" >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="text" name="AMOUNT" id="AMOUNT" value="{{isset($objResponse->AMOUNT)?$objResponse->AMOUNT:''}}" class="form-control" readonly >
        </div>
      </div>
    </div>
