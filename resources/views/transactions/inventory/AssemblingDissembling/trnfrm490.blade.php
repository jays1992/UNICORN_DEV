  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            <thead id="thead1">
            <tr>
                <th id="all-check" style="width:50px;"><input type="checkbox" class="js-selectall" data-target=".js-selectall1" data-docdate="{{isset($val->ADSMDT) && $val->ADSMDT !='' && $val->ADSMDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ADSMDT)):''}}"  />Select</th>
                <th>Doc No</th>
                <th>Date</th>
                <th>Type</th>
                <th>Created Date</th>  
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->ADSMID}}" value="{{$val->ADSMID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}"></td>
                <td>{{isset($val->ADSMNO) && $val->ADSMNO !=''?$val->ADSMNO:''}}</td>
                <td>{{isset($val->ADSMDT) && $val->ADSMDT !='' && $val->ADSMDT !='1900-01-01' ? date('d-m-Y',strtotime($val->ADSMDT)):''}}</td>
