...
<div class="container-fluid topnav">
    <div class="row">
        <div class="col-lg-2">
        <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Stock Adjustment</a>
        </div>
  ...
  <div class="container-fluid filter">
	  <div class="inner-form">
          ...
          <input {{$ActionStatus}} type="text" name="ST_ADJUST_DOCNO" id="ST_ADJUST_DOCNO" value="{{isset($objResponse->ST_ADJUST_DOCNO) && $objResponse->ST_ADJUST_DOCNO !=''?$objResponse->ST_ADJUST_DOCNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
			  ...
			  <div class="col-lg-2 pl">
			    <input {{$ActionStatus}} type="date" name="ST_ADJUST_DOCDT" id="ST_ADJUST_DOCDT" value="{{isset($objResponse->ST_ADJUST_DOCDT) && $objResponse->ST_ADJUST_DOCDT !=''?$objResponse->ST_ADJUST_DOCDT:''}}" class="form-control mandatory" >
        </div>
          ...
          <li class="active"><a data-toggle="tab" href="#Material">Material</a></li>
			  ...
			  <div class="tab-content">
                  ...
                  @foreach($objMAT as $key => $row)
                    ...
                    <td><input {{$ActionStatus}} type="text" style="width:100px;" type="text" name="RATE_{{$key}}" id="RATE_{{$key}}" value="{{ $row->RATE }}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly style="width:130px;text-align:right;" /></td>
