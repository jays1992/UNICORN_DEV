            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                    ...
                    <input type="hidden" id="objlastSTSDT"  value="{{isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''}}">
                                <input {{$ActionStatus}} type="date" name="STSDT" id="STSDT" onchange="checkPeriodClosing(270,this.value,1)" value="{{isset($objSTORETOTSOTE->STTOST_DOCDT)?$objSTORETOTSOTE->STTOST_DOCDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
