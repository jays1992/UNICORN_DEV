            ...
            <div class="inner-form">
                ...
                <div class="col-lg-2 pl"><p>Doc No</p></div>
                    ...
                    <input type="hidden" id="objlastSTSDT"  value="{{$objlastSTSDT[0]->STTOST_DOCDT}}">
                                <input type="date" name="STSDT" id="STSDT" onchange='checkPeriodClosing(270,this.value,1),getDocNoByEvent("DOCNO",this,@json($doc_req))' value="{{ old('STSDT') }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
