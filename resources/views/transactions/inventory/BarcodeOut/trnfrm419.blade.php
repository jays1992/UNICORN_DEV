  ...
  <div class="row">
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->BRCOID}}" value="{{$val->BRCOID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->BRC_OUT_DT) && $val->BRC_OUT_DT !='' && $val->BRC_OUT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BRC_OUT_DT)):''}}" ></td>
                <td>{{isset($val->BRC_OUT_NO) && $val->BRC_OUT_NO !=''?$val->BRC_OUT_NO:''}}</td>
                <td>{{isset($val->BRC_OUT_DT) && $val->BRC_OUT_DT !='' && $val->BRC_OUT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->BRC_OUT_DT)):''}}</td>
