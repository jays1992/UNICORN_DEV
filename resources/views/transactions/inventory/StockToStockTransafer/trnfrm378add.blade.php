  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          ...
          <input type="text" name="ST_ST_DOCNO" id="ST_ST_DOCNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="ST_ST_DOCDT" id="ST_ST_DOCDT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("ST_ST_DOCNO",this,@json($doc_req))' value="{{ old('ST_ST_DOCDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
