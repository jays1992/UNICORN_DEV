    ...
    <div class="container-fluid filter">
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DOC_DT" id="DOC_DT" value="{{ isset($HDR->STDT)?$HDR->STDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_EXIST" {{isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='EXIST'?"checked":""}} value='EXIST' checked onchange="getCustomerType('exist')" >
          </div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_NEW" {{isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='NEW'?"checked":""}} value='NEW' onchange="getCustomerType('new')" disabled >
          </div>
