      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="DOC_NO" id="DOC_NO" value="{{ isset($HDR->STNO)?$HDR->STNO:'' }}" class="form-control" autocomplete="off" style="text-transform:uppercase" readonly >
            <input type='hidden' name="VTID_REF" id="VTID_REF" value="{{ isset($HDR->VTID_REF2)?$HDR->VTID_REF2:'' }}" >
          </div>
                              
          <div class="col-lg-1 pl"><p>DOC Date</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="date" name="DOC_DT" id="DOC_DT" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{ isset($HDR->STDT)?$HDR->STDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>

          <div class="col-lg-1 pl"><p>Nature</p></div>
          <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="NATURE" id="NATURE" autocomplete="off" class="form-control" onchange="getNature(this.value)" >
              <option value="">Select</option>
              <option {{isset($HDR->NATURE) && $HDR->NATURE ==='Stock Transfer'?"selected='selected'":""}} value="Stock Transfer">Stock Transfer</option>
              <option {{isset($HDR->NATURE) && $HDR->NATURE ==='Donation'?"selected='selected'":""}} value="Donation">Donation</option>
              <option {{isset($HDR->NATURE) && $HDR->NATURE ==='Sales Promotion'?"selected='selected'":""}} value="Sales Promotion">Sales Promotion</option>
              <option {{isset($HDR->NATURE) && $HDR->NATURE ==='Sample'?"selected='selected'":""}} value="Sample">Sample</option>
              <option {{isset($HDR->NATURE) && $HDR->NATURE ==='FOC'?"selected='selected'":""}} value="FOC">FOC</option>
            </select>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <select {{$ActionStatus}} name="TRANSFER_TYPE" id="TRANSFER_TYPE" autocomplete="off" class="form-control" onchange="getTransferType(this.value)" {{isset($HDR->NATURE) && $HDR->NATURE =='Stock Transfer'?'':'disabled'}}  >
              <option value="">Select</option>
              <option {{isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='IN'?"selected='selected'":""}} value="IN">IN</option>
              <option {{isset($HDR->TRNF_TYPE) && $HDR->TRNF_TYPE ==='OUT'?"selected='selected'":""}} value="OUT">OUT</option>
            </select>
          </div>

          <div class="col-lg-1 pl"><p>Existing Customer</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_EXIST" {{isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='EXIST'?"checked":""}} value='EXIST'  onchange="getCustomerType('exist')" >
          </div>

          <div class="col-lg-1 pl"><p>New Customer</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="radio" name="CUSTOMER_TYPE" id="CUSTOMER_TYPE_NEW" {{isset($HDR->CUSTOMER_TYPE) && $HDR->CUSTOMER_TYPE ==='NEW'?"checked":""}} value='NEW' onchange="getCustomerType('new')" >
          </div>

          <div class="col-lg-1 pl txtgl_popup"><p class="CUSTOMER_VENDOR_LABEL">Customer</p></div>
          <div class="col-lg-2 pl txtgl_popup">
            <input {{$ActionStatus}} type="text" name="SubGl_popup" id="txtgl_popup" value="{{isset($HDR->CUSTOMER_NAME)?$HDR->CUSTOMER_NAME:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
            <input type="hidden" name="GLID_REF" id="GLID_REF" class="form-control" autocomplete="off" /> 
            <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{isset($HDR->SLID_REF)?$HDR->SLID_REF:''}}" class="form-control" autocomplete="off" />
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl BRANCH_NAME">
            <input type="hidden"  name="BRANCH_ID"    id="BRANCH_ID" value="{{isset($HDR->BRID)?$HDR->BRID:''}}"    class="form-control" autocomplete="off" >
            <input {{$ActionStatus}} type="text"    name="BRANCH_NAME"  id="BRANCH_NAME" value="{{isset($HDR->BRANCH_NAME)?$HDR->BRANCH_NAME:''}}"  class="form-control" autocomplete="off" readonly onclick="getBranch()" >
          </div>

          <div class="col-lg-1 pl"><p>Transfer Out No</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="TRANSFER_OUT_NO_ID" id="TRANSFER_OUT_NO_ID" value="{{isset($HDR->TRNSFR_OUT_NO)?$HDR->TRNSFR_OUT_NO:''}}" class="form-control" autocomplete="off" >
            <input {{$ActionStatus}} type="text"    name="TRANSFER_OUT_NO"    id="TRANSFER_OUT_NO"  value="{{isset($HDR->TRANSFER_OUT_NO)?$HDR->TRANSFER_OUT_NO:''}}"   class="form-control" autocomplete="off" readonly {{isset($HDR->TRNSFR_OUT_NO) && $HDR->TRNSFR_OUT_NO !=''?'':'disabled'}}  onclick="getTransferOutNo()" >
          </div>
                                
          <div class="col-lg-1 pl"><p>Address</p></div>
          <div class="col-lg-2 pl" >
            <input {{$ActionStatus}} type="text"  name="ADDRESS"  id="ADDRESS" value="{{isset($HDR->CUST_ADDRESS)?$HDR->CUST_ADDRESS:''}}"  class="form-control" autocomplete="off" readonly > 
          </div>

          <div class="col-lg-1 pl"><p>GST No</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text"  name="GST_NO" id="GST_NO" value="{{isset($HDR->GSTIN_NO)?$HDR->GSTIN_NO:''}}" class="form-control" autocomplete="off" readonly > 
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="hidden"  name="COUNTRY_ID"    id="COUNTRY_ID" value="{{isset($HDR->CTRYID_REF)?$HDR->CTRYID_REF:''}}"   class="form-control" autocomplete="off">
            <input {{$ActionStatus}} type="text"    name="COUNTRY_NAME"  id="COUNTRY_NAME" value="{{isset($HDR->COUNTRY_NAME)?$HDR->COUNTRY_NAME:''}}"  class="form-control" autocomplete="off" readonly disabled onclick="getCountry()" >
          </div>

          <div class="col-lg-1 pl"><p>State</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="STATE_ID"    id="STATE_ID" value="{{isset($HDR->STID_REF)?$HDR->STID_REF:''}}"   class="form-control" autocomplete="off">
            <input {{$ActionStatus}} type="text"    name="STATE_NAME"  id="STATE_NAME" value="{{isset($HDR->STATE_NAME)?$HDR->STATE_NAME:''}}"  class="form-control" autocomplete="off" readonly disabled onclick="getState()" > 
          </div>

          <div class="col-lg-1 pl"><p>City</p></div>
          <div class="col-lg-2 pl">
            <input type="hidden"  name="CITY_ID"    id="CITY_ID" value="{{isset($HDR->CITYID_REF)?$HDR->CITYID_REF:''}}"    class="form-control" autocomplete="off">
            <input {{$ActionStatus}} type="text"    name="CITY_NAME"  id="CITY_NAME" value="{{isset($HDR->CITY_NAME)?$HDR->CITY_NAME:''}}"  class="form-control" autocomplete="off" readonly disabled onclick="getCity()" > 
          </div>

          <div class="col-lg-1 pl"><p>Remarks</p></div>
          <div class="col-lg-2 pl">
            <input {{$ActionStatus}} type="text" name="REMARKS" id="REMARKS" value="{{isset($HDR->REMARKS)?$HDR->REMARKS:''}}" class="form-control" autocomplete="off"  maxlength="200" >
          </div>
        </div>
                ...
                <table id="example2" class="display nowrap table table-striped table-bordered itemlist w-200" width="100%" style="height:auto !important;">
                  ...
                  <tbody>
                    ...
                    <tr  class="participantRow">
                      ...
                      <td hidden><input {{$ActionStatus}} type="text" name={{"txtSQ_popup_".$key}} id={{"txtSQ_popup_".$key}} class="form-control"  autocomplete="off"   readonly style="width:100px;" /></td>
                      <td hidden><input type="hidden" name={{"SQA_".$key}} id={{"SQA_".$key}} class="form-control"  autocomplete="off" /></td>
                      <td hidden><input type="hidden" name={{"SEQID_REF_".$key}} id={{"SEQID_REF_".$key}} class="form-control"  autocomplete="off" /></td>
                      ...
                      <td hidden><input {{$ActionStatus}} type="text" name="SQMUOM_{{$key}}" id="SQMUOM_{{$key}}"  class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                      <td hidden><input {{$ActionStatus}} type="text" name="SQMUOMQTY_{{$key}}" id="SQMUOMQTY_{{$key}}" class="form-control" maxlength="13"  autocomplete="off"  readonly/></td>
                      <td hidden><input {{$ActionStatus}} type="text" name="SI_RATE_{{$key}}" id="SI_RATE_{{$key}}"  class="form-control"  autocomplete="off"  readonly style="width:100px;" /></td>
                      ...
                      <td><input {{$ActionStatus}} type="text" name="SO_QTY_{{$key}}" id="SO_QTY_{{$key}}" value="{{ isset($row->ST_QTY) && $row->ST_QTY !=''?$row->ST_QTY:'0.00' }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  style="width:75px;"  /></td>
                      <td hidden><input type="hidden" name="SO_FQTY_{{$key}}" id="SO_FQTY_{{$key}}" value="{{ $row->ST_QTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  readonly style="width:75px;" /></td>
                      ...
                      <td  hidden><input type="hidden" name="TotalHiddenQty_{{$key}}" id="TotalHiddenQty_{{$key}}" value="{{ $row->ST_QTY }}" ></td>
                      ...
                      <td><input {{$ActionStatus}} type="text" name="RATEPUOM_{{$key}}" id="RATEPUOM_{{$key}}" value="{{ $row->RATEPUOM }}"  class="form-control five-digits blurRate" maxlength="13"  autocomplete="off"  style="width:75px;" /></td>
