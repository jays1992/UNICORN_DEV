...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->SSOID}}" value="{{$val->SSOID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->SSO_DT) && $val->SSO_DT !='' && $val->SSO_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->SSO_DT)):''}}" ></td>
                <td>{{isset($val->SSO_NO) && $val->SSO_NO !=''?$val->SSO_NO:''}}</td>
                ...
                <td>{{isset($val->OVF_DT) && $val->OVF_DT !='' && $val->OVF_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVF_DT)):''}}</td>
                <td>{{isset($val->OVT_DT) && $val->OVT_DT !='' && $val->OVT_DT !='1900-01-01' ? date('d-m-Y',strtotime($val->OVT_DT)):''}}</td>
