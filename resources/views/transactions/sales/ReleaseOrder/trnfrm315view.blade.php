              ...
              <div class="inner-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pl">
                        <input {{$InputStatus}} type="text" name="RONO" id="RONO" value="{{ isset($objRO->RONO)?$objRO->RONO:'' }}" class="form-control mandatory" maxlength="150" autocomplete="off" style="text-transform:uppercase" autofocus readonly >
                    </div>
                    
                    <div class="col-lg-2 pl"><p>Release Order Date</p></div>
                    <div class="col-lg-2 pl">
                        <input {{$InputStatus}} type="date" name="RODT" id="RODT" value="{{ isset($objRO->RODT)?$objRO->RODT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                    </div>
