...
<form id="frm_trn_edit"  method="POST">   
  ...
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input {{$ActionStatus}} type="date" name="DC_DATE" id="DC_DATE" onchange="checkPeriodClosing('{{$FormId}}',this.value,1)" value="{{isset($objResponse->DC_DATE)?$objResponse->DC_DATE:''}}" class="form-control mandatory"  placeholder="dd/mm/yyyy" readonly >
        </div>
