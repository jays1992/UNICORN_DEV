...
<form id="trn_form" onsubmit="return validateForm(actionType)" method="POST"  class="needs-validation"> 
  <div class="container-fluid filter">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl">
          <input type="date" name="DOC_DT" id="DOC_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("DOC_NO",this,@json($doc_req))' value="{{ old('DOC_DT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" maxlength="10" >
