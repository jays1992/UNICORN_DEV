                    ...
                    <div class="inner-form">
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="text" name="SOSNO" id="SOSNO" value="{{ isset($objSOS->SOSNO)?$objSOS->SOSNO:'' }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
                            </div>
                            <div class="col-lg-1 pl"><p>SOS Date</p></div>
                            <div class="col-lg-2 pl">
                                <input {{$InputStatus}} type="date" name="SOSDT" id="SOSDT" onchange="checkPeriodClosing(41,this.value,1)" value="{{ isset($objSOS->SOSDT)?$objSOS->SOSDT:'' }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
                            </div>  
