      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="DSPNO" id="DSPNO" value="{{ $objMstResponse->DSPNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" autofocus disabled>
          </div>
          
          <div class="col-lg-2 pl "><p>Daily Sales Plan Date*</p></div>
          <div class="col-lg-2 pl">
                <input type="date" name="DSPDT" id="DSPDT" value="{{ $objMstResponse->DSPDT }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" disabled>
          </div>
          <div class="col-lg-2 pl"><p>Customer*</p></div>
          <div class="col-lg-2 pl">
                    <input type="text" name="SubGl_popup" id="txtsubgl_popup" class="form-control mandatory" value="{{ $objslcode2->SGLCODE }} - {{ $objslcode2->SLNAME }}"  autocomplete="off" readonly/>
                    <input type="hidden" name="SLID_REF" id="SLID_REF" value="{{ $objMstResponse->SLID_REF }}" class="form-control" autocomplete="off" />
                    <input type="hidden" name="GLID_REF" id="GLID_REF"  value="{{ $objMstResponse->GLID_REF }}" class="form-control" autocomplete="off" />
                  ...
                  <tbody>
                    @if(!empty($objList1))
                      ...
                      <tr  class="participantRow">
                        <td hidden><input type="text" name="recordId_{{ $key }}" id="txtrecordId_{{ $key }}" class="form-control" value="{{ $CustomId }}"  autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="SOrd_popup_{{ $key }}" id="txtSOrd_popup_{{ $key }}" value="{{ $row->SONO }}" class="form-control"  autocomplete="off"  disabled/></td>
                        <td hidden><input type="text" name="SOrdID_{{ $key }}" id="HDNSOrdID_{{ $key }}" value="{{ $row->SOID_REF }}" class="form-control" autocomplete="off" /></td>
                        <td><input type="text" name="popupITEMID_{{ $key }}" id="popupITEMID_{{ $key }}" value="{{ $row->ICODE }}" class="form-control"  autocomplete="off"  disabled/></td>                    
                        ...
                        <td><input type="text" name="ItemName_{{ $key }}" id="ItemName_{{ $key }}" class="form-control" value="{{ $row->NAME }}"   autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="popupMUOM_{{ $key }}" id="popupMUOM_{{ $key }}" value="{{ $row->UOMCODE }} - {{ $row->DESCRIPTIONS }}"  class="form-control"  autocomplete="off"  disabled/></td>
                        ...
                        <td><input type="text" name="Itemspec_{{ $key }}" id="Itemspec_{{ $key }}" value="{{ $row->ITEMSPECI }}"  class="form-control"  autocomplete="off"  disabled /></td>
                        <td><input type="text" name="SO_QTY_{{ $key }}" id="SO_QTY_{{ $key }}" value="{{ $row->SO_QTY }}"  class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled /></td>
                        <td ><input type="text" name="BAL_SOQTY_{{ $key }}" id="BAL_SOQTY_{{ $key }}" value="{{ $row->BAL_SOQTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled/></td>
                        <td ><input type="text" name="EXP_DIS_QTY_{{ $key }}" id="EXP_DIS_QTY_{{ $key }}" value="{{ $row->EXPDPQTY }}" class="form-control three-digits" maxlength="13"  autocomplete="off"  disabled/></td>
