...
@section('content')
	...
	<div class="inner-form">
		...
		<div class="row">
            ...
            <input type="text" name="DSPNO" id="DSPNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
			</div>
			
			<div class="col-lg-2 pl "><p>Daily Sales Plan Date*</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="DSPDT" id="DSPDT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("DSPNO",this,@json($doc_req))'  class="form-control mandatory"  placeholder="dd-mm-yyyy" >
            </div>
