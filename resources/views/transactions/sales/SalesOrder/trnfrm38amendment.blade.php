                        ...
                        <div class="col-lg-2 pl"><p>Total Value</p></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4 pl">
                              <textarea disabled {{$ActionStatus}} name="SHIPPING_INSTRUCTION" id="SHIPPING_INSTRUCTION" autocomplete="off" class="form-control" style="height:60px;" >{{ isset($objSO->SHIPPING_INSTRUCTION)?$objSO->SHIPPING_INSTRUCTION:'' }}</textarea>
                            </div> 
                            
                            <div class="col-lg-2 pl"><p>Delivery Address</p></div>
                            <div class="col-lg-4 pl">
                              <textarea disabled {{$ActionStatus}} name="DELIVERY_ADDRESS" id="DELIVERY_ADDRESS" autocomplete="off" class="form-control" style="height:60px;" >{{ isset($objSO->DELIVERY_ADDRESS)?$objSO->DELIVERY_ADDRESS:'' }}</textarea>
                            </div>
                          </div>
</div>
