...
@section('content')
    ...
    <div class="container-fluid purchase-order-view filter">     
        <form id="frm_so_attachment" method="post" enctype="multipart/form-data" action='{{route("transactionmodify",[38,"docuploads"])}}' > 
          @CSRF
        ...
        <input type="hidden" name="VTID_REF" class="form-control" value='{{$objMstVoucherType[0]->VTID}}' />
			...
			<div class="col-lg-2 pl">
         <label style="text-transform:uppercase"> {{$objSalesorder->SONO}} </label>
        <input type="hidden" name="ATTACH_DOCNO" id="ATTACH_DOCNO" value="{{$objSalesorder->SOID}}" class="form-control" maxlength="50" >
			</div>
			
			<div class="col-lg-1 pl"><p>Document Date</p></div>
			<div class="col-lg-2 pl">
      <label> {{ date("d/m/Y", strtotime($objSalesorder->INDATE) )}} </label> 
        <input type="hidden" name="ATTACH_DOCDT" id="ATTACH_DOCDT" value='{{date("Y-m-d", strtotime($objSalesorder->INDATE))}}'   />
              ...
              <th width="15%">View / Download</th>
						...
						<tbody>
                            ...
                            <tr  class="participantRow">
                              ...
                              @else     
                              <td align="center" >{{$viewfile}}<a class="btn" title="download" data-toggle="tooltip" data-docpath="{{asset($docpath)}}" onclick="downloadfile($(this).data('docpath'))"><i class="fa fa-download"></i></a></td>
                              @endif
                            </tr>
                            @endforeach
                        </tbody>    
