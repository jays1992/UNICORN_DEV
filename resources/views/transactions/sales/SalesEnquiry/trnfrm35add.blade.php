...
@section('content')
	...
	<div class="inner-form">
		<div class="row">
            ...
            <input type="text" name="ENQNO" id="ENQNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
			</div>
			<div class="col-lg-2 pl"><p>Sales Enquiry Date *</p></div>
			<div class="col-lg-2 pl">
				    <input type="date" name="ENQDT" id="ENQDT" onchange='checkPeriodClosing(35,this.value,1),getDocNoByEvent("ENQNO",this,@json($doc_req))' value="{{ old('ENQDT') }}" class="form-control mandatory"  placeholder="dd/mm/yyyy" >
      </div>			
