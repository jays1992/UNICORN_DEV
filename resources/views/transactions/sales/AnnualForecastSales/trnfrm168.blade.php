...
@section('content')
    ...
    <div class="container-fluid topnav">
            <div class="row">
                <div class="col-lg-2">
                <a href="{{route('transaction',[$FormId,'index'])}}" class="btn singlebt">Annual Forecast Sales(AFS)</a>
                </div>
    ...
    <div class="container-fluid purchase-order-view">
        ...
        <table id="listingmst" class="display nowrap table table-striped table-bordered" width="100%">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->AFSID}}" value="{{$val->AFSID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->AFSDT) && $val->AFSDT !=''?$val->AFSDT:''}}" ></td>
                <td>{{isset($val->AFSNO) && $val->AFSNO !=''?$val->AFSNO:''}}</td>
                <td>{{isset($val->AFSDT) && $val->AFSDT !=''?$val->AFSDT:''}}</td>
                ...
                if(seletedRecord==0){
                    ...
                    highlighFocusBtn('activeOk1');
                      ...
                      if(is_approve==1){
                        ...
                        var editURL = '{{route("transaction",[168,"amendment",":rcdId"]) }}';
                            editURL = editURL.replace(":rcdId",recordId);
