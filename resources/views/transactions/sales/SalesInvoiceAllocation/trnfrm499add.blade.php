    ...
    <div class="container-fluid purchase-order-view filter">     
      ...
      <div class="row">
        ...
        <div class="col-lg-2 pl"><p>Doc Date*</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="DOC_DT" id="DOC_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("DOC_NO",this,@json($doc_req))' class="form-control mandatory" >
        </div> 
