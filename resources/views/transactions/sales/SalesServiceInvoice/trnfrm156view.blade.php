    ...
    <div class="container-fluid purchase-order-view">
        <form id="frm_trn_edit"  method="POST">   
                    ...
                    <div class="inner-form">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input  {{$InputStatus}} type="text" name="CREDITDAYS" id="CREDITDAYS" value="{{ isset($objSO->CREDIT_DAYS)?$objSO->CREDIT_DAYS:'' }}" class="form-control" onkeyup="getDueDate(this.id,this.value)" autocomplete="off"/>
                            </div>
                        </div>
						...
						<div class="row">
                            ...
                            <div class="col-lg-2 pl">
                                <input type="text" {{$InputStatus}} name="NARRATION" id="NARRATION" class="form-control" autocomplete="off" value="{{ isset($objSO->NARRATION)?$objSO->NARRATION:'' }}"/>
                            </div>
						</div>
            ...
            <div class="row">	
              ...
              <div class="col-lg-2 pl">
              <input {{$InputStatus}} type="text"   name="ROUNDOFF_GLCODE_NAME"  id="ROUNDOFF_GLCODE_NAME" value="{{isset($objSO->GLCODE)?$objSO->GLCODE:''}}{{isset($objSO->GLNAME)?'-'.$objSO->GLNAME:''}}"  class="form-control mandatory"  autocomplete="off"  readonly/>
              <input type="hidden" name="ROUNDOFF_GLID_REF"     id="ROUNDOFF_GLID_REF"    value="{{isset($objSO->ROUNDOFF_GLID_REF)?$objSO->ROUNDOFF_GLID_REF:''}}" class="form-control" autocomplete="off" />
              <input type="hidden" name="ROUNDOFF_TOTAL_AMT"    id="ROUNDOFF_TOTAL_AMT"   value="{{isset($objSO->ROUNDOFF_TOTAL_AMT)?$objSO->ROUNDOFF_TOTAL_AMT:''}}" class="form-control"  autocomplete="off" readonly />
              </div>       

              <div class="col-lg-2 pl"><p>Round of Amount</p></div>
              <div class="col-lg-2 pl">
              <input {{$InputStatus}} type="text" name="ROUNDOFF_AMT" id="ROUNDOFF_AMT" value="{{isset($objSO->ROUNDOFF_AMT)?number_format($objSO->ROUNDOFF_AMT, 2, '.', ''):''}}" class="form-control"  autocomplete="off" onkeyup="round_calculation()" onkeypress="return isNumberDecimalKey(event,this)"   />
              </div>

              <div class="col-lg-2 pl"><p>Round of Mode</p></div>
              <div class="col-lg-2 pl">
              <select {{$InputStatus}} name="ROUNDOFF_MODE" id="ROUNDOFF_MODE" class="form-control" onchange="round_calculation()" >
                <option {{isset($objSO->ROUNDOFF_MODE) && $objSO->ROUNDOFF_MODE =="Positive"?"selected='selected'":''}} value="Positive">Debit</option>
                <option {{isset($objSO->ROUNDOFF_MODE) && $objSO->ROUNDOFF_MODE =="Negative"?"selected='selected'":''}} value="Negative">Credit</option>
              </select>                                  
              </div>
            </div>
