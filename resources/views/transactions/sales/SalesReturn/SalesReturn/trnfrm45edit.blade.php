                            ...
                            <div class="tab-content">
                                ...
                                <div class="row"><div class="col-lg-4" style="padding-left: 15px;">Note:- 1 row mandatory in Material Tab </div></div>
                                    ...
                                    <tr  class="participantRow">
                                      ...
                                      <td  hidden><input type="hidden" name="HiddenRowId_{{$key}}" id="HiddenRowId_{{$key}}" value="{{isset($row->STORE_MATID_REF) && $row->STORE_MATID_REF !=''?$row->STORE_MATID_REF:''}} {{isset($row->RETURN_QTYM) && $row->RETURN_QTYM !=''?'-'.$row->RETURN_QTYM:''}}" ></td>
