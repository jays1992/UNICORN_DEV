...
@section('content')
    ...
    <div class="container-fluid purchase-order-view">
        <div class="multiple table-responsive  ">
            ...
            @endphp
            <tr>
                <td><input type="checkbox" id="chkId{{$val->SRID}}" value="{{$val->SRID}}" class="js-selectall1" data-rcdstatus="{{$app_status}}" data-docdate="{{isset($val->SRDT) && $val->SRDT !='' && $val->SRDT !='1900-01-01' ? date('d-m-Y',strtotime($val->SRDT)):''}}" ></td>
                <td>{{isset($val->SRNO) && $val->SRNO !=''?$val->SRNO:''}}</td>
                ...
                <td>{{isset($val->REASONOFSR) && $val->REASONOFSR !=''?$val->REASONOFSR:''}}</td>
