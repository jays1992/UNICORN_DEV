      ...
      <div class="inner-form" id="Header_Form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input type="text" name="JWRNO" id="JWRNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
          <script>docMissing(@json($docarray['FY_FLAG']));</script>
          </div>
                              
          <div class="col-lg-2 pl"><p>JWR Date</p></div>
          <div class="col-lg-2 pl">
            <input type="date" name="JWRDT" id="JWRDT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("JWRNO",this,@json($doc_req))' class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
