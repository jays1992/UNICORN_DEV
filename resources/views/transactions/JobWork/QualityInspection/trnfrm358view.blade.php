    ...
    <div class="container-fluid filter">
      ...
      <div class="row">
            ...
            <div class="col-lg-2 pl">
              <input disabled type="text" name="QIJNO" id="QIJNO" VALUE="{{isset($HDR->QIJNO)?$HDR->QIJNO:''}}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase" >
            </div>
            
            <div class="col-lg-2 pl"><p>QIJ Date</p></div>
            <div class="col-lg-2 pl">
                <input disabled type="date" name="QIJDT" id="QIJDT" VALUE="{{isset($HDR->QIJDT)?$HDR->QIJDT:''}}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 pl">
            <input disabled type="text" name="TEXT_GRJID_REF_DATA" id="TEXT_GRJID_REF_DATA" VALUE="{{isset($HDR->GRNNO)?$HDR->GRNNO:''}}" class="form-control mandatory"  autocomplete="off" readonly/>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="GRJ_REC_QTY" id="GRJ_REC_QTY" VALUE="{{isset($HDR->GRJ_REC_QTY)?$HDR->GRJ_REC_QTY:''}}" class="form-control"  autocomplete="off" readonly />
          </div>
