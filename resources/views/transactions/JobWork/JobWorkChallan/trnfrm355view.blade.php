      ...
      <div class="inner-form">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 pl">
            <input disabled type="text" name="JWCNO" id="JWCNO" value="{{ $objMstResponse->JWCNO }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
            <input disabled type="hidden" name="JWCID" id="JWCID" value="{{ $objMstResponse->JWCID }}" class="form-control mandatory"  autocomplete="off" readonly style="text-transform:uppercase"  >
          </div>
              
          <div class="col-lg-2 pl"><p>JWO Date</p></div>
          <div class="col-lg-2 pl">
            <input disabled type="date" name="JWCDT" id="JWCDT" value="{{ $objMstResponse->JWCDT }}" class="form-control mandatory" autocomplete="off" placeholder="dd/mm/yyyy" >
          </div>
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="Material" class="tab-pane fade in active">
                    ...
                    <td><input disabled type="text" name="txtJWOID_popup_{{$key}}"   id="txtJWOID_popup_{{$key}}" value="{{$row->JWONO}}" class="form-control" autocomplete="off" readonly style="width:100px;" /></td>
                    ...
                    <td hidden><input type="text"  name="SOID_REF_{{$key}}"  id="SOID_REF_{{$key}}" value="{{$row->SOID_REF}}" class="form-control" autocomplete="off" /></td>   
										...
										<td hidden><input disabled  type="text" name="ITEMID_REF_{{$key}}"  id="ITEMID_REF_{{$key}}"  value="{{$row->ITEMID_REF}}" class="form-control" autocomplete="off" /></td>
										...
										<td><input disabled type="text"   name="QTY_{{$key}}" 		id="QTY_{{$key}}" 		value="{{$row->JW_PRODUCE_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input disabled type="text"   name="BL_SOQTY_{{$key}}" 	id="BL_SOQTY_{{$key}}" value="{{$row->JW_PRODUCE_QTY}}"  class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" readonly  style="width:100px;"  /></td>
										<td><input disabled type="text"   name="PD_OR_QTY_{{$key}}" 	id="PD_OR_QTY_{{$key}}" value="{{$row->JW_PRODUCE_QTY}}" class="form-control three-digits" onkeypress="return isNumberDecimalKey(event,this)" maxlength="13"  autocomplete="off" style="width:100px;" data-mainitem="{{$mitem_id}}" onKeyup="get_materital_item()"  /></td>
										
                    <td><input disabled type="date"   name="EDA_{{$key}}"      id="EDA_{{$key}}"       class="form-control"                value="{{$row->EDA}}" autocomplete="off"    /></td>
               
                    <td hidden><input disabled type="text"   name="MAINTROWID_{{$key}}" id="MAINTROWID_{{$key}}" class="form-control " value="{{$mitem_id}}" style="width:100px;"  /></td>
