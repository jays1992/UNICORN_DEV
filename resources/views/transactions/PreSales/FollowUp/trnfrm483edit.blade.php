          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl"><p>Additonal Member Visit*</p></div>
                <div class="col-lg-2 pl">
                  <input type="text" name="ADDMEMBER_VISIT" id="ADDMEMBER_VISIT" onclick="getData('{{route('transaction',[$FormId,'getAddMemberVisitCode'])}}','Additonal Member Visit','ADDMEMBER_VISIT_REF')" value="{{isset($objResponse->EMPCODE) && $objResponse->EMPCODE !=''?$objResponse->EMPCODE:''}} - {{$objResponse->FNAME}} {{$objResponse->MNAME}} {{$objResponse->LNAME}}" class="form-control mandatory" autocomplete="off" readonly>
                  <input type="hidden" name="ADDMEMBERVISIT_REF" id="ADDMEMBER_VISIT_REF" value="{{isset($objResponse->EMPID) && $objResponse->EMPID !=''?$objResponse->EMPID:''}}" class="form-control mandatory">                              
                </div>
