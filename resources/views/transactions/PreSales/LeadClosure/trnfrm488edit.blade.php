        ...
        <div id="LeadClosure" class="tab-pane fade in active" style="margin-left: 16px; margin-top: 10px; width: 97%;">
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl">
                <select {{$ActionStatus}} name="LEAD_FINALSTATUS" id="LEAD_FINALSTATUS" class="form-control">
                  <option {{isset($objResponse->LEAD_FINALSTATUS) && $objResponse->LEAD_FINALSTATUS == 'Lost'?'selected="selected"':''}} value="Lost">Lost</option>
                  <option {{isset($objResponse->LEAD_FINALSTATUS) && $objResponse->LEAD_FINALSTATUS == 'Hold'?'selected="selected"':''}} value="Hold">Hold</option>
                  <option {{isset($objResponse->LEAD_FINALSTATUS) && $objResponse->LEAD_FINALSTATUS == 'Won'?'selected="selected"':''}} value="Won">Won</option>
                  </select>
              </div>                
              </div>            
