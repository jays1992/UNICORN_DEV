         ...
         <form id="frm_mst_add" method="POST" onsubmit="return validateForm()" class="needs-validation"  > 
          ...
          <div class="inner-form">              
                <div class="row">
                  ...
                  <input type="text" name="PROVISION_DOC_NO" id="PROVISION_DOC_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="PROVISION_DT" id="PROVISION_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("PROVISION_DOC_NO",this,@json($doc_req))' class="form-control"  maxlength="100" > 
                    </div>
