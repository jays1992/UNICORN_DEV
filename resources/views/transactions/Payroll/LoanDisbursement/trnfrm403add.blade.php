          ...
          <div class="inner-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 pl">
                    <input type="text" name="LOAN_DISB_DOCNO" id="LOAN_DISB_DOCNO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
                  ...
                  <div class="col-lg-2 pl"><p>LD Date*</p></div>
                    <div class="col-lg-2 pl">
                      <input type="date" name="LOAN_DISB_DOCDT" id="LOAN_DISB_DOCDT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("LOAN_DISB_DOCNO",this,@json($doc_req))' class="form-control"  maxlength="100" > 
                    </div>
