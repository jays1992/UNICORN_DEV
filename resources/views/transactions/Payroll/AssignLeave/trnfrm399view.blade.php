       ...
       <div class="inner-form">
             ...
             <div class="row">
               ...
               <div class="col-lg-2 pl"><p>Name</p></div>
                 <div class="col-lg-2 pl">
                   <input type="text" name="FNAME" id="FNAME" value="{{ $objEmpName->FNAME }}" class="form-control"  maxlength="100" disabled> 
                 </div>
             </div>
                      ...
                      @foreach($objDataResponse as $key => $row)
                       <tr  class="participantRow">
                         <td hidden><input type="hidden" name="ASSIGN_LDID" id="ASSIGN_LDID" value="{{ $row->ASSIGN_LDID }}" /></td>
                           <td><input  class="form-control" type="date" name={{"ASSIGN_DT_".$key}}   id ={{"ASSIGN_DT_".$key}}  value="{{ $row->ASSIGN_DT }}" autocomplete="off" style="width: 99%" disabled></td>
                           <td><select name={{"ASSIGN_AS_".$key}}   id ={{"ASSIGN_AS_".$key}} class="form-control mandatory" disabled tabindex="4">
                            <option value="" selected="">Select</option>
                           ...
                           <td><select name={{"LTID_REF_".$key}}   id ={{"LTID_REF_".$key}} onchange="getLeaveTyName(this.id,this.value)" class="form-control mandatory" tabindex="4" disabled>
                             <option value="" selected="">Select</option>
                           ...
                           <td><input type="text" id ={{"LEAVETYPE_DESC_".$key}} value="{{ $row->LEAVETYPE_DESC }}" class="form-control" readonly  maxlength="100" disabled> </td>
                           <td><input  class="form-control" type="text" name={{"REASON_LEAVE_".$key}}   id ={{"REASON_LEAVE_".$key}}  value="{{ $row->REASON_LEAVE }}" autocomplete="off" style="width: 99%" disabled></td>
