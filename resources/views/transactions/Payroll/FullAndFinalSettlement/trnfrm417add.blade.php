          ...
          <div class="inner-form">              
                <div class="row">
                  <div class="col-lg-2 pl"><p>Doc No*</p></div>
                    ...
                    <input type="text" name="CLAIMFINALSETLMT_DOC_NO" id="CLAIMFINALSETLMT_DOC_NO" value="{{$docarray['DOC_NO']}}" {{$docarray['READONLY']}} class="form-control" maxlength="{{$docarray['MAXLENGTH']}}" autocomplete="off" style="text-transform:uppercase" >
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="CLAIMFINALSETLMT_DT" id="CLAIMFINALSETLMT_DT" onchange='checkPeriodClosing("{{$FormId}}",this.value,1),getDocNoByEvent("CLAIMFINALSETLMT_DOC_NO",this,@json($doc_req))' class="form-control"  maxlength="100" > 
                    </div>
