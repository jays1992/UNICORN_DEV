          ...
          <div class="inner-form">              
                <div class="row">
                  ...
                  <script>docMissing(@json($docarray['FY_FLAG']));</script>
                    ...
                    <div class="col-lg-2 pl">
                      <input type="date" name="REMB_DT" id="REMB_DT" onchange='checkPeriodClosing(413,this.value,1),getDocNoByEvent("CLAIM_DOC_NO",this,@json($doc_req))' class="form-control"  maxlength="100" > 
                    </div>
