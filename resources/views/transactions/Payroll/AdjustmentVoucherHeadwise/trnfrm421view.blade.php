             ...
             <div class="row">
               <div class="col-lg-2 pl"><p>Doc No*</p></div>
                 <div class="col-lg-2 pl">
                  <input type="text" name="DOC_NO" id="DOC_NO" value="{{ $HDR->EMPVA_DOCNO }}" class="form-control mandatory" tabindex="1" maxlength="100" autocomplete="off" style="text-transform:uppercase" autofocus disabled>
                 <span class="text-danger" id="ERROR_DOC_NO_REF"></span>                             
                 </div>

                 <div class="col-lg-2 pl"><p>Date*</p></div>
                 <div class="col-lg-2 pl">
                   <input type="date" name="REMB_DT" id="REMB_DT" value="{{ $HDR->EMPVA_DOCDT }}" class="form-control"  maxlength="100" disabled> 
                 </div>
               ...
               <div class="row">
                 ...
                 <div class="col-lg-2 pl">
                 <input type="text" name="EMPID_REF" id="txtitem_popup" value="{{ $HDR->EMPCODE }}"  class="form-control mandatory" disabled  autocomplete="off" readonly />
                           ...
                           <tbody>
                            ...
                            @foreach($MAT as $key => $row)
                             <tr  class="participantRow">
                               <td><select name="ADJUSTMENT_TYPE[]" id={{"ADJUSTMENT_TYPE_".$key}} onchange="getEarHeadName(this.id,this.value)" class="form-control mandatory" disabled>
                               ...
                               <td><select name="EARNIGHEAD_REF[]" id={{"EARNIGHEAD_REF_".$key}} class="form-control mandatory" disabled>
                                 <option value="" selected="">Select</option>
                               ...
                               <td><input  class="form-control" type="text" name="FNAME[]"       id={{"FNAME_".$key}}      value="{{$row->FNAME}}"         disabled   autocomplete="off" style="width: 99%" readonly></td>
                               <td><input  class="form-control" type="text" name="DESGCODE[]"    id={{"DESGCODE_".$key}}   value="{{$row->DESGCODE}}"      disabled   autocomplete="off" style="width: 99%" readonly></td>
                               <td><input  class="form-control" type="text" name="DCODE[]"       id={{"DCODE_".$key}}      value="{{$row->DCODE}}"         disabled   autocomplete="off" style="width: 99%" readonly></td>
                               <td><input  class="form-control" type="text" name="AMOUNTPLUS[]"  id={{"AMOUNTPLUS_".$key}} value="{{$row->AMT_PLUS}}"      disabled   onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                               <td><input  class="form-control" type="text" name="AMOUNTSUB[]"   id={{"AMOUNTSUB_".$key}}  value="{{$row->AMT_SUBTRACT}}"  disabled   onkeypress="return onlyNumberKey(event)" autocomplete="off" style="width: 99%"></td>
                               <td><input  class="form-control" type="text" name="REMARKS[]"     id={{"REMARKS_".$key}}    value="{{$row->REMARKS}}"       disabled   autocomplete="off" style="width: 99%"></td>
